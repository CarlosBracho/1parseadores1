...
$cDia=loteriaHoyAdmin($diahoy);
$query_Recordset2 = "/* PARSEADORES1 distri_lot\distri_devolucion_lot.php - QUERY 1 */ SELECT id_signo, nom_corto FROM signos ORDER BY id_signo";
$Recordset2 = mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
$row_Recordset2 = mysqli_fetch_assoc($Recordset2);
$totalRows_Recordset2 = mysqli_num_rows($Recordset2);
$query_Recordset3 =  sprintf("/* PARSEADORES1 distri_lot\distri_devolucion_lot.php - QUERY 2 */ SELECT so.id_sorteo, so.nom_sorteo
...
$query_Recordset4 =  sprintf("/* PARSEADORES1 distri_lot\distri_devolucion_lot.php - QUERY 3 */ SELECT ag.cod_agencia, ag.nom_agencia 
