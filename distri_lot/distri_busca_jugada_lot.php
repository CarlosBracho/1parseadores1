...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 distri_lot\distri_busca_jugada_lot.php - QUERY 1 */ SELECT 
	ta.nom_taquilla,
	ve.fec_venta_lot,
	ve.hor_venta_lot,
	ve.ticket_lot,
	...
	ba.hor_cierre,
	CASE lt.tip_loteria  
		WHEN 3 THEN (/* PARSEADORES1 distri_lot\distri_busca_jugada_lot.php - QUERY 2 */ SELECT sor.nom_corto FROM signos sor WHERE sor.id_signo = ve.id_signo LIMIT 1)
		WHEN 4 THEN (/* PARSEADORES1 distri_lot\distri_busca_jugada_lot.php - QUERY 3 */ SELECT ani.nom_corto FROM animales ani WHERE ani.id_animal = ve.id_signo LIMIT 1)
		ELSE ''
	END AS nsigno
	FROM 
		venta_lot ve,
