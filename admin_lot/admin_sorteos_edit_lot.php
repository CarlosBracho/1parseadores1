...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 1 */ UPDATE sorteos 
				SET
				nom_sorteo=%s, 
				hor_sorteo=%s,
				tur_sorteo=%s, 
    ...
    if (isset($_POST['nom_loteria'])&&isset($_POST['let_loteria'])&&isset($_POST['tip_loteria'])&&isset($_POST['est_loteria'])&&
        ...
        foreach ($_POST['nom_loteria'] as $nom_loteria) {
            $query_Recordset2 =  sprintf(
                "/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 2 */ SELECT 
            ...
            if ($acceso==1) {
                $insertSQL1 = sprintf(
                    "/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 3 */ INSERT 
				INTO loterias 
                ...
                if ($tip_loteria[$cta]==1 or $tip_loteria[$cta]==3) {
                    ...
                    $insertSQL2 = sprintf(
                        "/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 4 */ INSERT 
					INTO loterias 
                    ...
                    $insertSQL1 = sprintf(
                        "/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 5 */ UPDATE loterias 
							SET
							id_terminal=%s 
							WHERE id_loteria=%s",
                ...
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 6 */ SELECT hor_sorteo, lun, mar, mie, jue, vie, sab, dom 
					FROM sorteos 
                ...
                $query_Recordset4 = sprintf("/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 7 */ SELECT id_banca FROM bancaloterias GROUP BY id_banca");
                ...
                if ($totalRows_Recordset4>0) {
                    ...
                    do {
                        $insertSQL1 = sprintf(
                            "/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 8 */ INSERT 
						INTO bancaloterias 
                        ...
                        if ($tip_loteria[$cta]==1 or $tip_loteria[$cta]==3) {
                            $insertSQL2 = sprintf(
                                "/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 9 */ INSERT 
							INTO bancaloterias 
                    ...
                    $query_Recordset5 = sprintf("/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 10 */ SELECT id_agencia FROM agencialoterias GROUP BY id_agencia");
                    ...
                    if ($totalRows_Recordset5>0) {
                        do {
                            if ($tip_loteria[$cta]==1 or $tip_loteria[$cta]==3) {
                                $insertSQL3 = sprintf(
                                    "/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 11 */ INSERT 
                            ...
                            $insertSQL3 = sprintf(
                                "/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 12 */ INSERT 
							INTO agencialoterias 
							(id_agencia, id_loteria, est_agelot, top_ventaage, lun_loteria, mar_loteria, 
							mie_loteria, jue_loteria, vie_loteria, sab_loteria, dom_loteria) 
							VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
    ...
    if (isset($_POST['id_loteria']) && isset($_POST['cambio'])) {
        ...
        foreach ($_POST['cambio'] as $valor) {
            if ($valor==1) {
                $menPrin="&nbsp;&nbsp; DATOS DE SORTEO GUARDADOS CORRECTAMENTE &nbsp;&nbsp;";
                $insertSQL1 = sprintf(
                    "/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 13 */ UPDATE loterias 
						SET
						est_loteria=%s 
						WHERE id_loteria=%s",
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 14 */ SELECT 
...
$query_Recordset2 =  sprintf(
    "/* PARSEADORES1 admin_lot\admin_sorteos_edit_lot.php - QUERY 15 */ SELECT 
