...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 admin_lot\admin_lot\admin_grupos_edit_lot.php - QUERY 1 */ UPDATE grupo_loterias 
		SET
		est_grupo_lot=%s 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 admin_lot\admin_lot\admin_grupos_edit_lot.php - QUERY 2 */ SELECT 
