...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $_POST['tip_usuario']="U";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 admin_lot\admin_usuario_ven_add_lot.php - QUERY 1 */ INSERT 
		INTO usuario 
...
$query_Recordset2 = "/* PARSEADORES1 admin_lot\admin_usuario_ven_add_lot.php - QUERY 2 */ SELECT ta.cod_taquilla, ta.nom_taquilla, ag.nom_agencia FROM taquilla ta, agencia ag, agencialoterias al 
