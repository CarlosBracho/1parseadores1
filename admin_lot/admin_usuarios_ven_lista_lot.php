...
if ($MM_authorizedUsers=="D") {
    $query_Recordset1 =  sprintf("/* PARSEADORES1 admin_lot\admin_usuarios_ven_lista_lot.php - QUERY 1 */ SELECT 
    ...
    $query_Recordset1 =  sprintf("/* PARSEADORES1 admin_lot\admin_usuarios_ven_lista_lot.php - QUERY 2 */ SELECT 
			us.id_usuario, us.nom_usuario, ta.nom_taquilla, ta.tel_taquilla, ag.nom_agencia,
			CASE us.est_usuario 
				WHEN 0 THEN '<font color=red>INACTIVO</font>' 
				WHEN 1 THEN 'ACTIVO' 
