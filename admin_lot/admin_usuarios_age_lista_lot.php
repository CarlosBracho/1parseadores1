...
if ($MM_authorizedUsers=="D") {
    $query_Recordset1 =  sprintf(
        "/* PARSEADORES1 admin_lot\admin_usuarios_age_lista_lot.php - QUERY 1 */ SELECT 
    ...
    $query_Recordset1 =  sprintf("/* PARSEADORES1 admin_lot\admin_usuarios_age_lista_lot.php - QUERY 2 */ SELECT 
			us.id_usuario, us.nom_usuario, ag.nom_agencia, ag.tel_agencia, ba.nom_banca,
			CASE us.est_usuario 
				WHEN 0 THEN '<font color=red>INACTIVO</font>' 
				WHEN 1 THEN 'ACTIVO' 
