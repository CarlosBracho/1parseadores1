...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $_POST['tip_usuario']="G";
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 admin_lot\admin_usuario_age_add_lot.php - QUERY 1 */ INSERT 
		INTO usuario 
...
$query_Recordset2 = "/* PARSEADORES1 admin_lot\admin_usuario_age_add_lot.php - QUERY 2 */ SELECT ag.cod_agencia, ag.nom_agencia FROM agencia ag, agencialoterias al 
