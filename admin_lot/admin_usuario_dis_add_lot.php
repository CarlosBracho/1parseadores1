...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $_POST['tip_usuario']="D";
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 admin_lot\admin_usuario_dis_add_lot.php - QUERY 1 */ INSERT 
		INTO usuario 
...
$query_Recordset2 = "/* PARSEADORES1 admin_lot\admin_usuario_dis_add_lot.php - QUERY 2 */ SELECT ba.cod_banca, ba.nom_banca FROM banca ba, bancaloterias bl 
