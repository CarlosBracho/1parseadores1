...
$query_Recordset18D =  sprintf(
    "/* PARSEADORES1 logros\WiningBet.php - QUERY 1 */ SELECT  
*
...
if($row_Recordset18D['Swicht']==0){
    function verificarjuego($codWiningBet, $horajuego)
    {
        ...
        $query_Recordset1 = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 2 */ SELECT Id_p2juegosp2, idequipo1p2, idequipo2p2, pichee1p2, pichee2p2, codWiningBet_empate
        FROM p2juegos 
        WHERE  
        iniciodtp2 > %s AND
        codWiningBet = %s ",
    ...
    if($totalRows_Recordset1>0)
    {
        ...
        $updateSQL = sprintf("/* PARSEADORES1 logros\WiningBet.php - QUERY 3 */ UPDATE p2juegos SET p2vecesactualizado=p2vecesactualizado+1, iniciodtp2 = %s
        WHERE  
        iniciodtp2 > %s AND
        codWiningBet = %s AND
        Id_p2juegosp2 = %s ",
    ...
    function updatepiche($matches10px, $todox, $equipo)
    {
        ...
        if ($equipo==1) {
            ...
            $datetime=$FechaTxt.' '.$horaTxt;
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 logros\WiningBet.php - QUERY 4 */ UPDATE p2juegos  
    SET pichee1p2=%s			
    WHERE 
    iniciodtp2 > %s AND
    codWiningBet=%s",
        ...
        if ($equipo==2) {
            ...
            $datetime=$FechaTxt.' '.$horaTxt;
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 logros\WiningBet.php - QUERY 5 */ UPDATE p2juegos  
    SET pichee2p2=%s			
    WHERE 
    iniciodtp2 > %s AND
    codWiningBet=%s",
    ...
    function updatelogro($todolo1, $todolo2, $Id_p3logrosp3, $tipojugadap7, $equipop7, $Id_p1equiposp7, $idjuegop7)
    {
        ...
        $datetime=$FechaTxt.' '.$horaTxt;
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 6 */ UPDATE p3logros 
        ...
        $Result1 = mysqli_query($conexionbanca, $insertSQL1) or die(mysqli_error($conexionbanca));
          ...
          $insertSQL = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 7 */ INSERT 
        INTO p7histolg
    ...
    function insertlogro($Id_p2juegosp2in, $Id_p1equiposp1in, $equipoin, $todoin1, $todoin2, $datetimein, $todoin3)
    {
        ...
        $datetime=$FechaTxt.' '.$horaTxt;
        $insertSQL = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 8 */ INSERT 
    INTO p3logros
    ...
    VALUES (%s, %s, %s, %s, %s, %s, %s)",
        ...
        $insertSQL = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 9 */ INSERT 
        INTO p7histolg
        (idjuegop7, Id_p1equiposp7, tipojugadap7, logrop7, equipop7, logroABoRLp7, actxp7) 
        VALUES (%s, %s, %s, %s, %s, %s, %s)",
        ...
        function verificarjuego($codWiningBet, $horajuego)
        {
            ...
            $datetime=$FechaTxt.' '.$horaTxt;
            $query_Recordset1 = sprintf(
                "/* PARSEADORES1 logros\WiningBet.php - QUERY 10 */ SELECT Id_p2juegosp2, idequipo1p2, idequipo2p2, pichee1p2, pichee2p2, codWiningBet_empate
            FROM p10juegos 
            WHERE  
            iniciodtp2 > %s AND
            codWiningBet = %s ",
        ...
        if($totalRows_Recordset1>0)
        {
            ...
            $updateSQL = sprintf("/* PARSEADORES1 logros\WiningBet.php - QUERY 11 */ UPDATE p10juegos SET p2vecesactualizado=p2vecesactualizado+1, iniciodtp2 = %s
            WHERE  
            iniciodtp2 > %s AND
            codWiningBet = %s AND
            Id_p2juegosp2 = %s ",
        ...
        function updatepiche($matches10px, $todox, $equipo)
        {
            ...
            if ($equipo==1) {
                ...
                $datetime=$FechaTxt.' '.$horaTxt;
                $insertSQL1 = sprintf(
                    "/* PARSEADORES1 logros\WiningBet.php - QUERY 12 */ UPDATE p10juegos  
        SET pichee1p2=%s			
        WHERE 
        iniciodtp2 > %s AND
        codWiningBet=%s",
            ...
            if ($equipo==2) {
                ...
                $datetime=$FechaTxt.' '.$horaTxt;
                $insertSQL1 = sprintf(
                    "/* PARSEADORES1 logros\WiningBet.php - QUERY 13 */ UPDATE p10juegos  
        SET pichee2p2=%s			
        WHERE 
        iniciodtp2 > %s AND
        codWiningBet=%s",
        ...
        function updatelogro($todolo1, $todolo2, $Id_p3logrosp3, $tipojugadap7, $equipop7, $Id_p1equiposp7, $idjuegop7)
        {
            ...
            $datetime=$FechaTxt.' '.$horaTxt;
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 logros\WiningBet.php - QUERY 14 */ UPDATE p10logros 
              SET logrop3=%s, logroABoRLp3=%s		
              WHERE 
              logrodtp3>%s AND
              Id_p3logrosp3=%s",
            ...
            $Result1 = mysqli_query($conexionbanca, $insertSQL1) or die(mysqli_error($conexionbanca));
              ...
              $insertSQL = sprintf(
                "/* PARSEADORES1 logros\WiningBet.php - QUERY 15 */ INSERT 
            INTO p7histolg
            (idjuegop7, Id_p1equiposp7, tipojugadap7, logrop7, equipop7, logroABoRLp7, actxp7) 
            VALUES (%s, %s, %s, %s, %s, %s, %s)",
        ...
        function insertlogro($Id_p2juegosp2in, $Id_p1equiposp1in, $equipoin, $todoin1, $todoin2, $datetimein, $todoin3)
        {
            ...
            $datetime=$FechaTxt.' '.$horaTxt;
            $insertSQL = sprintf(
                "/* PARSEADORES1 logros\WiningBet.php - QUERY 16 */ INSERT 
        INTO p10logros
        (idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
        VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($Id_p2juegosp2in, "int"),
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 logros\WiningBet.php - QUERY 17 */ INSERT 
            INTO p7histolg
            (idjuegop7, Id_p1equiposp7, tipojugadap7, logrop7, equipop7, logroABoRLp7, actxp7) 
            VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
if($row_Recordset18D['Swicht']==0){
    $query_RecordsetLG =  sprintf(
        "/* PARSEADORES1 logros\WiningBet.php - QUERY 18 */ SELECT
      Id_p3logrosp3, idjuegop3, equipop3, tipojugadap3, logroABoRLp3, logrop3
      FROM  
      p3logros
      WHERE logrodtp3 >= %s AND actxp3 = 0 AND Id_p3logrosp3 >= 0 ORDER BY Id_p3logrosp3 ASC",
    ...
    $query_RecordsetAJ =  sprintf(
        "/* PARSEADORES1 logros\WiningBet.php - QUERY 19 */ SELECT
    ...
    if ($resultAJ = mysqli_query($conexionbanca, $query_RecordsetAJ) or die(mysqli_error($conexionbanca))) {
        ...
        $query_RecordsetLG =  sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 20 */ SELECT
          Id_p3logrosp3, idjuegop3, equipop3, tipojugadap3, logroABoRLp3, logrop3
          FROM  
          p10logros
          WHERE logrodtp3 >= %s AND actxp3 = 0 AND Id_p3logrosp3 >= 0 ORDER BY Id_p3logrosp3 ASC",
        ...
        $query_RecordsetAJ =  sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 21 */ SELECT
          Id_p2juegosp2, idequipo1p2, idequipo2p2, deportep2, competicionp2, iniciodtp2, codWiningBet_empate, codWiningBet, pichee1p2, pichee2p2
          FROM  
          p10juegos
          WHERE 
...
if(strpos($datoscurl, 'Plataforma')){ 
    $updateSQL = sprintf("/* PARSEADORES1 logros\WiningBet.php - QUERY 22 */ UPDATE alertas SET contadoralerta=contadoralerta+1, fec_alerta=%s, hor_alerta=%s , contadorfallos=0
    WHERE idalertas=%s",
...
///*
  ...
  $query_Recordset21 = sprintf(
    "/* PARSEADORES1 logros\WiningBet.php - QUERY 23 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
...
if ($totalRows_Recordset21==0) {
    ...
    echo " . . .";
    $insertSQL = sprintf(
        "/* PARSEADORES1 logros\WiningBet.php - QUERY 24 */ INSERT 
INTO p1equipos
...
VALUES (%s, %s, %s, %s, %s)",
    ...
    $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 logros\WiningBet.php - QUERY 25 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
        GetSQLValueString($e1, "text")
...
$query_Recordset22 = sprintf(
  "/* PARSEADORES1 logros\WiningBet.php - QUERY 26 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
...
if ($totalRows_Recordset22==0) {
  ...
  echo " . . .";
  $insertSQL = sprintf(
      "/* PARSEADORES1 logros\WiningBet.php - QUERY 27 */ INSERT 
INTO p1equipos
(nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
VALUES (%s, %s, %s, %s, %s)",
      GetSQLValueString($e2, "text"),
  ...
  $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
  $query_Recordset22 = sprintf(
      "/* PARSEADORES1 logros\WiningBet.php - QUERY 28 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
      GetSQLValueString($e2, "text")
...
list($totaltotalRows, $Id_p2juegosp2, $idequipo1p2, $idequipo2p2, $pichee1p2, $pichee2p2)=verificarjuego( $codWiningBet, $horajuego);
...
if ($totaltotalRows==0) {
    ...
    if ($totaltotalRows==0) {
        ...
        if($row_Recordset18D['Swicht']==0){
        $insertSQL = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 29 */ INSERT 
INTO p2juegos
...
VALUES (%s, %s, %s, %s, %s)",
        ...
        $insertSQL = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 30 */ INSERT 
INTO p10juegos
(idequipo1p2, idequipo2p2, deportep2, codWiningBet, iniciodtp2) 
VALUES (%s, %s, %s, %s, %s)",
            GetSQLValueString($row_Recordset21['Id_p1equiposp1'], "int"),
...
if(strpos($datoscurl2, '2.ZZ.img.ZZ.srcassetsparlaydeportesfut')){ echo ' Futbol '; $ja++;
  ...
  $query_Recordset21 = sprintf(
    "/* PARSEADORES1 logros\WiningBet.php - QUERY 31 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
GetSQLValueString($e1, "text"));
...
if ($totalRows_Recordset21==0) {
    ...
    echo " . . .";
    $insertSQL = sprintf(
        "/* PARSEADORES1 logros\WiningBet.php - QUERY 32 */ INSERT 
INTO p1equipos
(nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
VALUES (%s, %s, %s, %s, %s)",
        GetSQLValueString($e1, "text"),
    ...
    $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 logros\WiningBet.php - QUERY 33 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
        GetSQLValueString($e1, "text")
...
$query_Recordset22 = sprintf(
  "/* PARSEADORES1 logros\WiningBet.php - QUERY 34 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
GetSQLValueString($e2, "text"));
...
if ($totalRows_Recordset22==0) {
  ...
  echo " . . .";
  $insertSQL = sprintf(
      "/* PARSEADORES1 logros\WiningBet.php - QUERY 35 */ INSERT 
INTO p1equipos
(nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
VALUES (%s, %s, %s, %s, %s)",
      GetSQLValueString($e2, "text"),
  ...
  $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
  $query_Recordset22 = sprintf(
      "/* PARSEADORES1 logros\WiningBet.php - QUERY 36 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
      GetSQLValueString($e2, "text")
...
list($totaltotalRows, $Id_p2juegosp2, $idequipo1p2, $idequipo2p2, $pichee1p2, $pichee2p2)=verificarjuego($datoscurl3[3][0], $horajuego);
...
if ($totaltotalRows==0) {
    ...
    if ($totaltotalRows==0) {
        ...
        if($row_Recordset18D['Swicht']==0){
        $insertSQL = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 37 */ INSERT 
INTO p2juegos
(idequipo1p2, idequipo2p2, deportep2, codWiningBet, iniciodtp2) 
VALUES (%s, %s, %s, %s, %s)",
            GetSQLValueString($row_Recordset21['Id_p1equiposp1'], "int"),
        ...
        $insertSQL = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 38 */ INSERT 
INTO p10juegos
(idequipo1p2, idequipo2p2, deportep2, codWiningBet, iniciodtp2) 
VALUES (%s, %s, %s, %s, %s)",
            GetSQLValueString($row_Recordset21['Id_p1equiposp1'], "int"),
...
if(strpos($datoscurl2, '2.ZZ.img.ZZ.srcassetsparlaydeportesnfl')){ echo ' futbol americano '; $ja++;
    ...
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 logros\WiningBet.php - QUERY 39 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
    GetSQLValueString($e1, "text"));
    ...
    if ($totalRows_Recordset21==0) {
        ...
        echo " . . .";
        $insertSQL = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 40 */ INSERT 
    INTO p1equipos
    (nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
    VALUES (%s, %s, %s, %s, %s)",
            GetSQLValueString($e1, "text"),
        ...
        $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset21 = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 41 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
            GetSQLValueString($e1, "text")
    ...
    $query_Recordset22 = sprintf(
      "/* PARSEADORES1 logros\WiningBet.php - QUERY 42 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
    GetSQLValueString($e2, "text"));
    ...
    if ($totalRows_Recordset22==0) {
      ...
      echo " . . .";
      $insertSQL = sprintf(
          "/* PARSEADORES1 logros\WiningBet.php - QUERY 43 */ INSERT 
    INTO p1equipos
    (nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
    VALUES (%s, %s, %s, %s, %s)",
          GetSQLValueString($e2, "text"),
      ...
      $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
      $query_Recordset22 = sprintf(
          "/* PARSEADORES1 logros\WiningBet.php - QUERY 44 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
          GetSQLValueString($e2, "text")
    ...
    if ($totaltotalRows==0) {
        ...
        if ($totaltotalRows==0) {
            ...
            if($row_Recordset18D['Swicht']==0){
            $insertSQL = sprintf(
                "/* PARSEADORES1 logros\WiningBet.php - QUERY 45 */ INSERT 
    INTO p2juegos
    (idequipo1p2, idequipo2p2, deportep2, codWiningBet, iniciodtp2) 
    VALUES (%s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset21['Id_p1equiposp1'], "int"),
        ...
        $insertSQL = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 46 */ INSERT 
INTO p10juegos
(idequipo1p2, idequipo2p2, deportep2, codWiningBet, iniciodtp2) 
VALUES (%s, %s, %s, %s, %s)",
            GetSQLValueString($row_Recordset21['Id_p1equiposp1'], "int"),
...
if(strpos($datoscurl2, '2.ZZ.img.ZZ.srcassetsparlaydeportesnba')){ echo ' Baloncesto '; $ja++;
    ...
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 logros\WiningBet.php - QUERY 47 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
    GetSQLValueString($e1, "text"));
    ...
    if ($totalRows_Recordset21==0) {
        ...
        echo " . . .";
        $insertSQL = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 48 */ INSERT 
    INTO p1equipos
    (nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
    VALUES (%s, %s, %s, %s, %s)",
            GetSQLValueString($e1, "text"),
        ...
        $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset21 = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 49 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
            GetSQLValueString($e1, "text")
    ...
    $query_Recordset22 = sprintf(
      "/* PARSEADORES1 logros\WiningBet.php - QUERY 50 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
    GetSQLValueString($e2, "text"));
    ...
    if ($totalRows_Recordset22==0) {
      ...
      echo " . . .";
      $insertSQL = sprintf(
          "/* PARSEADORES1 logros\WiningBet.php - QUERY 51 */ INSERT 
    INTO p1equipos
    (nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
    VALUES (%s, %s, %s, %s, %s)",
          GetSQLValueString($e2, "text"),
      ...
      $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
      $query_Recordset22 = sprintf(
          "/* PARSEADORES1 logros\WiningBet.php - QUERY 52 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
          GetSQLValueString($e2, "text")
    ...
    if ($totaltotalRows==0) {
        ...
        if ($totaltotalRows==0) {
            ...
            if($row_Recordset18D['Swicht']==0){
            $insertSQL = sprintf(
                "/* PARSEADORES1 logros\WiningBet.php - QUERY 53 */ INSERT 
    INTO p2juegos
    (idequipo1p2, idequipo2p2, deportep2, codWiningBet, iniciodtp2) 
    VALUES (%s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset21['Id_p1equiposp1'], "int"),
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 logros\WiningBet.php - QUERY 54 */ INSERT 
    INTO p10juegos
    (idequipo1p2, idequipo2p2, deportep2, codWiningBet, iniciodtp2) 
    VALUES (%s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset21['Id_p1equiposp1'], "int"),
...
if(strpos($datoscurl2, '2.ZZ.img.ZZ.srcassetsparlaydeportesnhl')){ echo ' Hoskey <br>'; $ja++;
   // var_dump($datoscurl2);
    ...
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 logros\WiningBet.php - QUERY 55 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
    GetSQLValueString($e1, "text"));
    ...
    if ($totalRows_Recordset21==0) {
        ...
        echo " . . .";
        $insertSQL = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 56 */ INSERT 
    INTO p1equipos
    (nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
    VALUES (%s, %s, %s, %s, %s)",
            GetSQLValueString($e1, "text"),
        ...
        $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset21 = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 57 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
            GetSQLValueString($e1, "text")
    ...
    $query_Recordset22 = sprintf(
        "/* PARSEADORES1 logros\WiningBet.php - QUERY 58 */ SELECT Id_p1equiposp1
      FROM p1equipos
      WHERE  
      nomwinningbet = %s",
      GetSQLValueString($e2, "text"));
      ...
      if ($totalRows_Recordset22==0) {
        ...
        echo " . . .";
        $insertSQL = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 59 */ INSERT 
      INTO p1equipos
      (nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
      VALUES (%s, %s, %s, %s, %s)",
            GetSQLValueString($e2, "text"),
        ...
        $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset22 = sprintf(
            "/* PARSEADORES1 logros\WiningBet.php - QUERY 60 */ SELECT Id_p1equiposp1
      FROM p1equipos
      WHERE  
      nomwinningbet = %s",
            GetSQLValueString($e2, "text")
      ...
      if ($totaltotalRows==0) {
          ...
          if ($totaltotalRows==0) {
            ...
            if($row_Recordset18D['Swicht']==0){
              $insertSQL = sprintf(
                  "/* PARSEADORES1 logros\WiningBet.php - QUERY 61 */ INSERT 
      INTO p2juegos
      (idequipo1p2, idequipo2p2, deportep2, codWiningBet, iniciodtp2) 
      VALUES (%s, %s, %s, %s, %s)",
                  GetSQLValueString($row_Recordset21['Id_p1equiposp1'], "int"),
              ...
              $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
                ...
                $insertSQL = sprintf(
                    "/* PARSEADORES1 logros\WiningBet.php - QUERY 62 */ INSERT 
        INTO p10juegos
        (idequipo1p2, idequipo2p2, deportep2, codWiningBet, iniciodtp2) 
        VALUES (%s, %s, %s, %s, %s)",
                    GetSQLValueString($row_Recordset21['Id_p1equiposp1'], "int"),
...
$query_Recordset17 = sprintf(
    "/* PARSEADORES1 logros\WiningBet.php - QUERY 63 */ SELECT p2juegos.Id_p2juegosp2, p2juegos.idequipo1p2, p2juegos.idequipo2p2, p2juegos.pichee1p2, 
...
$insertSQL1 = sprintf(
    "/* PARSEADORES1 logros\WiningBet.php - QUERY 64 */ UPDATE p2juegos 
  SET competicionp2=%s		
  WHERE 
  Id_p2juegosp2=%s",
...
$query_Recordset1111 = sprintf(
    "/* PARSEADORES1 logros\WiningBet.php - QUERY 65 */ SELECT p3logros.idjuegop3, p1equipos.nomequipop1
...
if($ja <>0) {
    ...
    $msj='Winni BD'.$BD.' Se act '.$ja.' jue y '.$la.' lg t '.$tiempo.' Subio ' .$envia.' V3.4';
    $msjx=utf8_encode($msj);
    $post=[
      'chat_id'=>-576782283,
      'text'=>$msjx,
...
if($ja <>0) {
    ...
    $fechahora5 = date('Y-m-d H:i:s', $fechahora5);
      foreach ($juegosarray as $clave=>$valor2) {
        $siestajuego=0;
      
        foreach ($codWiningBetArray as $clave5=>$valor5) {
          if($valor2["codWiningBet"]==$valor5["codWiningBetEsta"])  { 
      echo $valor2["codWiningBet"].' 1 --'.$valor2["deportep2"].' si esta juego en winni<br>';  $siestajuego=1;
          }
        }
        if($siestajuego==0 && $valor2["iniciodtp2"]>$fechahora){ echo $valor2["Id_p2juegosp2"].'No esta en winni<br>';
    ...
    echo 'se cierra<br>';
    $msj='Winni 7777 no tiene el siguiente juego por lo tanto se cerrara'.$valor2["Id_p2juegosp2"];
    $msjx=utf8_encode($msj);
    $post=[
      'chat_id'=>-576782283,
      'text'=>$msjx,
    ...
    if($row_Recordset18D['Swicht']==0){
        $insertSQL24 = sprintf(
          "/* PARSEADORES1 logros\WiningBet.php - QUERY 66 */ UPDATE p2juegos 
    SET iniciodtp2 = %s			
    WHERE 
    Id_p2juegosp2 = %s", 
          ...
          GetSQLValueString($valor2["Id_p2juegosp2"], "int")
      );
      //$Result1 = mysqli_query($conexionbanca, $insertSQL1) or die(mysqli_error($conexionbanca));
      $Result24 = mysqli_query($conexionbanca, $insertSQL24);
        ...
        $insertSQL24 = sprintf(
          "/* PARSEADORES1 logros\WiningBet.php - QUERY 67 */ UPDATE p10juegos 
    SET iniciodtp2 = %s			
    WHERE 
    Id_p2juegosp2 = %s", 
