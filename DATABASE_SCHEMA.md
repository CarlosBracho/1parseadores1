...
- **Verificación 2026-05-22 (5)**: Se modificó la consulta principal en `admin/alertas_lista.php` para ordenar las alertas de forma descendente por la última fecha de ejecución (`ultima_ejecucion DESC`), mostrando las de ejecución más reciente primero.
- **Verificación 2026-05-22 (6)**: Se eliminaron del listado administrativo `admin/alertas_lista.php` los formularios/botones de "INICIAR" y "PAUSAR" (columna Acciones), manteniendo intacta la columna `pausa` en base de datos.
