...
$query_Recordset1 = sprintf(
    '/* PARSEADORES1 multidistri_hnac\distri_usuarios_ag_lista_hnac.php - QUERY 1 */ SELECT usuario.nom_usuario, usuario.id_usuario, usuario.est_usuario, agencia.nom_agencia
	FROM 
		banca, 
		agencia,
		usuario
