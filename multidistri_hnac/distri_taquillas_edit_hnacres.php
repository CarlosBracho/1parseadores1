...
$query_Recordset11 =  sprintf(
    "/* PARSEADORES1 multidistri_hnac\distri_taquillas_edit_hnacres.php - QUERY 1 */ SELECT  
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 multidistri_hnac\distri_taquillas_edit_hnacres.php - QUERY 2 */ UPDATE taquilla 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 multidistri_hnac\distri_taquillas_edit_hnacres.php - QUERY 5 */ SELECT  
	ta.nom_taquilla,
...
$query_Recordset2 =  sprintf(
    "/* PARSEADORES1 multidistri_hnac\distri_taquillas_edit_hnacres.php - QUERY 6 */ SELECT * FROM taquilla_opc_hnac
	WHERE cod_taquilla = %s",
    GetSQLValueString($xCodigo, "int"),
...
if ($totalRows_Recordset2==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            ...
            $query_Recordset2 =  sprintf(
                "/* PARSEADORES1 multidistri_hnac\distri_taquillas_edit_hnacres.php - QUERY 7 */ SELECT * 
				FROM  
				taquilla_opc_hnac 
				WHERE 
				cod_taquilla = %s",
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 multidistri_hnac\distri_taquillas_edit_hnacres.php - QUERY 8 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
