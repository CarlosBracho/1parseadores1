...
$query_Recordset12 = sprintf("/* PARSEADORES1 ventaslotan\ventas_ver_ultimo_lot.php - QUERY 1 */ SELECT ticket_lot FROM venta_lot WHERE id_usuario = %s AND fec_venta_lot = %s AND est_ticket_lot >= 0 AND est_ticket_lot <= 1 AND tip_loteria_lot >= 4
...
$query_Recordset11 = sprintf(
    "/* PARSEADORES1 ventaslotan\ventas_ver_ultimo_lot.php - QUERY 2 */ SELECT ser_ticket_lot, est_ticket_lot, mon_apuesta_lot,
