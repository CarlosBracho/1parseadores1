...
$query_Recordset1771 = sprintf(
    "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 1 */ SELECT *
FROM variables 
WHERE  
variablenom = %s ",
...
if(strlen($datoscurl)>100){
    ...
    $query_Recordset177 = sprintf(
        "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 2 */ SELECT Id_p2juegosp2, idequipo1p2, idequipo2p2, pichee1p2, pichee2p2, codWiningBet_empate, deportep2
    FROM p2juegos 
    WHERE  
    iniciodtp2 > %s AND
    iniciodtp2 < %s AND
...
if($totalRows_Recordset177==1){
    if($deportep2=='futbol'){ echo ' Futbol '; $ja++; echo '# '.$ja.' '.strlen($datoscurl2);
       ...
       // /*
                ...
                $query_Recordset14 = sprintf(
                    "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 3 */ SELECT * FROM p5resultadosj WHERE 
                        juegop5 = %s",
                ...
                if ($totalRows_Recordset14==0) {
                    if ($row_Recordset177['Id_p2juegosp2']>0) {
                        ...
                        $insertSQL155 = sprintf(
                            "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 4 */ INSERT INTO p5resultadosj  
            ...
            %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                    ...
                    $insertSQL155 = sprintf(
                        "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 5 */ UPDATE p5resultadosj  SET 
       ...
       $query_Recordset14 = sprintf(
        "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 6 */ SELECT * FROM p5resultadosj WHERE 
            juegop5 = %s",
        GetSQLValueString($row_Recordset177['Id_p2juegosp2'], "int")
    );
    $Recordset14 = mysqli_query($conexionbanca, $query_Recordset14) or die(mysqli_error($conexionbanca));
    ...
    if ($totalRows_Recordset14==0) {
        if ($row_Recordset177['Id_p2juegosp2']>0) {
            echo 'creando';
            $insertSQL155 = sprintf(
                "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 7 */ INSERT INTO p5resultadosj  
(deportep5, juegop5, equipo1p5, equipo2p5, anotaprimerop5, iniciodtp5, tiemposjugadosp5,
 r1p5, r2p5, r3p5, r4p5, r5p5, r6p5, r7p5, r8p5, r9p5, r10p5, 
 r11p5, r12p5, r13p5, r14p5, r15p5, r16p5, r17p5, r18p5, r19p5, r20p5, 
 r21p5, r22p5, r23p5, r24p5, r25p5, r26p5, r27p5, r28p5, r29p5, r30p5, quienmete)
...
%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        $insertSQL155 = sprintf(
            "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 8 */ UPDATE p5resultadosj  SET 
deportep5=%s, equipo1p5=%s, equipo2p5=%s, anotaprimerop5=%s, tiemposjugadosp5=%s, iniciodtp5=%s,
r1p5=%s, r2p5=%s, r3p5=%s, r4p5=%s, r5p5=%s, r6p5=%s, r7p5=%s, r8p5=%s, r9p5=%s, r10p5=%s, r11p5=%s, r12p5=%s, r13p5=%s, r14p5=%s, r15p5=%s, r16p5=%s, r17p5=%s, r18p5=%s, r19p5=%s, r20p5=%s, r21p5=%s, r22p5=%s, r23p5=%s, r24p5=%s, r25p5=%s, r26p5=%s, r27p5=%s, r28p5=%s, r29p5=%s, r30p5=%s
WHERE juegop5=%s",
                GetSQLValueString("beisbol", "text"),
...
if($deportep2=='beisbol'){ echo ' Beisbol '; $ja++; 
   ...
   $query_Recordset14 = sprintf(
    "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 9 */ SELECT * FROM p5resultadosj WHERE 
        juegop5 = %s",
    GetSQLValueString($row_Recordset177['Id_p2juegosp2'], "int")
);
$Recordset14 = mysqli_query($conexionbanca, $query_Recordset14) or die(mysqli_error($conexionbanca));
...
if ($totalRows_Recordset14==0) {
    if ($row_Recordset177['Id_p2juegosp2']>0) {
        echo 'creando';
        $insertSQL155 = sprintf(
            "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 10 */ INSERT INTO p5resultadosj  
(deportep5, juegop5, equipo1p5, equipo2p5, anotaprimerop5, iniciodtp5, tiemposjugadosp5,
r1p5, r2p5, r3p5, r4p5, r5p5, r6p5, r7p5, r8p5, r9p5, r10p5, 
r11p5, r12p5, r13p5, r14p5, r15p5, r16p5, r17p5, r18p5, r19p5, r20p5, 
r21p5, r22p5, r23p5, r24p5, r25p5, r26p5, r27p5, r28p5, r29p5, r30p5, quienmete)
...
%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
    ...
    $insertSQL155 = sprintf(
        "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 11 */ UPDATE p5resultadosj  SET 
deportep5=%s, equipo1p5=%s, equipo2p5=%s, anotaprimerop5=%s, tiemposjugadosp5=%s, iniciodtp5=%s,
r1p5=%s, r2p5=%s, r3p5=%s, r4p5=%s, r5p5=%s, r6p5=%s, r7p5=%s, r8p5=%s, r9p5=%s, r10p5=%s, r11p5=%s, r12p5=%s, r13p5=%s, r14p5=%s, r15p5=%s, r16p5=%s, r17p5=%s, r18p5=%s, r19p5=%s, r20p5=%s, r21p5=%s, r22p5=%s, r23p5=%s, r24p5=%s, r25p5=%s, r26p5=%s, r27p5=%s, r28p5=%s, r29p5=%s, r30p5=%s
WHERE juegop5=%s",
            GetSQLValueString("beisbol", "text"),
...
///*
        ...
        $Resultadotp2=$datoscurl3[9][0]-$datoscurl3[10][0];
              ...
              $query_Recordset14 = sprintf(
                  "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 12 */ SELECT * FROM p5resultadosj WHERE 
                      juegop5 = %s",
                  GetSQLValueString($row_Recordset177['Id_p2juegosp2'], "int")
              );
              $Recordset14 = mysqli_query($conexionbanca, $query_Recordset14) or die(mysqli_error($conexionbanca));
              ...
              if ($totalRows_Recordset14==0) {
                  if ($row_Recordset177['Id_p2juegosp2']>0) {
                      echo 'creando';
                      $insertSQL155 = sprintf(
                          "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 13 */ INSERT INTO p5resultadosj  
          (deportep5, juegop5, equipo1p5, equipo2p5, anotaprimerop5, iniciodtp5, tiemposjugadosp5,
           r1p5, r2p5, r3p5, r4p5, r5p5, r6p5, r7p5, r8p5, r9p5, r10p5, 
           r11p5, r12p5, r13p5, r14p5, r15p5, r16p5, r17p5, r18p5, r19p5, r20p5, 
           r21p5, r22p5, r23p5, r24p5, r25p5, r26p5, r27p5, r28p5, r29p5, r30p5, quienmete)
          ...
          %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                  ...
                  $insertSQL155 = sprintf(
                      "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 14 */ UPDATE p5resultadosj  SET 
          deportep5=%s, equipo1p5=%s, equipo2p5=%s, anotaprimerop5=%s, tiemposjugadosp5=%s, iniciodtp5=%s,
          r1p5=%s, r2p5=%s, r3p5=%s, r4p5=%s, r5p5=%s, r6p5=%s, r7p5=%s, r8p5=%s, r9p5=%s, r10p5=%s, r11p5=%s, r12p5=%s, r13p5=%s, r14p5=%s, r15p5=%s, r16p5=%s, r17p5=%s, r18p5=%s, r19p5=%s, r20p5=%s, r21p5=%s, r22p5=%s, r23p5=%s, r24p5=%s, r25p5=%s, r26p5=%s, r27p5=%s, r28p5=%s, r29p5=%s, r30p5=%s
          WHERE juegop5=%s",
                          GetSQLValueString("baloncesto", "text"),
...
///*
        ...
        $Resultadotp2=$datoscurl3[9][0]-$datoscurl3[10][0];
              ...
              $query_Recordset14 = sprintf(
                  "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 15 */ SELECT * FROM p5resultadosj WHERE 
                      juegop5 = %s",
                  GetSQLValueString($row_Recordset177['Id_p2juegosp2'], "int")
              );
              $Recordset14 = mysqli_query($conexionbanca, $query_Recordset14) or die(mysqli_error($conexionbanca));
              ...
              if ($totalRows_Recordset14==0) {
                  if ($row_Recordset177['Id_p2juegosp2']>0) {
                      echo 'creando';
                      $insertSQL155 = sprintf(
                          "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 16 */ INSERT INTO p5resultadosj  
          (deportep5, juegop5, equipo1p5, equipo2p5, anotaprimerop5, iniciodtp5, tiemposjugadosp5,
           r1p5, r2p5, r3p5, r4p5, r5p5, r6p5, r7p5, r8p5, r9p5, r10p5, 
           r11p5, r12p5, r13p5, r14p5, r15p5, r16p5, r17p5, r18p5, r19p5, r20p5, 
           r21p5, r22p5, r23p5, r24p5, r25p5, r26p5, r27p5, r28p5, r29p5, r30p5, quienmete)
          ...
          %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                  ...
                  $insertSQL155 = sprintf(
                      "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 17 */ UPDATE p5resultadosj  SET 
          deportep5=%s, equipo1p5=%s, equipo2p5=%s, anotaprimerop5=%s, tiemposjugadosp5=%s, iniciodtp5=%s,
          r1p5=%s, r2p5=%s, r3p5=%s, r4p5=%s, r5p5=%s, r6p5=%s, r7p5=%s, r8p5=%s, r9p5=%s, r10p5=%s, r11p5=%s, r12p5=%s, r13p5=%s, r14p5=%s, r15p5=%s, r16p5=%s, r17p5=%s, r18p5=%s, r19p5=%s, r20p5=%s, r21p5=%s, r22p5=%s, r23p5=%s, r24p5=%s, r25p5=%s, r26p5=%s, r27p5=%s, r28p5=%s, r29p5=%s, r30p5=%s
          WHERE juegop5=%s",
                          GetSQLValueString("futbolamericano", "text"),
    ...
    if($deportep2=='hockey'){ echo ' hockey '; $ja++; echo '# '.$ja.' '.strlen($datoscurl2);
       ...
       // /*
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 18 */ SELECT * FROM p5resultadosj WHERE 
                juegop5 = %s",
            GetSQLValueString($row_Recordset177['Id_p2juegosp2'], "int")
        );
        $Recordset14 = mysqli_query($conexionbanca, $query_Recordset14) or die(mysqli_error($conexionbanca));
        ...
        if ($totalRows_Recordset14==0) {
            if ($row_Recordset177['Id_p2juegosp2']>0) {
                echo 'creando';
                $insertSQL155 = sprintf(
                    "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 19 */ INSERT INTO p5resultadosj  
    (deportep5, juegop5, equipo1p5, equipo2p5, anotaprimerop5, iniciodtp5, tiemposjugadosp5,
     r1p5, r2p5, r3p5, r4p5, r5p5, r6p5, r7p5, r8p5, r9p5, r10p5, 
     r11p5, r12p5, r13p5, r14p5, r15p5, r16p5, r17p5, r18p5, r19p5, r20p5, 
     r21p5, r22p5, r23p5, r24p5, r25p5, r26p5, r27p5, r28p5, r29p5, r30p5, quienmete)
    ...
    %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            ...
            $insertSQL155 = sprintf(
                "/* PARSEADORES1 logrosresultados\WiningBetresultadosMejorado.php - QUERY 20 */ UPDATE p5resultadosj  SET 
    deportep5=%s, equipo1p5=%s, equipo2p5=%s, anotaprimerop5=%s, tiemposjugadosp5=%s, iniciodtp5=%s,
    r1p5=%s, r2p5=%s, r3p5=%s, r4p5=%s, r5p5=%s, r6p5=%s, r7p5=%s, r8p5=%s, r9p5=%s, r10p5=%s, r11p5=%s, r12p5=%s, r13p5=%s, r14p5=%s, r15p5=%s, r16p5=%s, r17p5=%s, r18p5=%s, r19p5=%s, r20p5=%s, r21p5=%s, r22p5=%s, r23p5=%s, r24p5=%s, r25p5=%s, r26p5=%s, r27p5=%s, r28p5=%s, r29p5=%s, r30p5=%s
    WHERE juegop5=%s",
                    GetSQLValueString("hockey", "text"),
