...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 reparacion20202.php - QUERY 1 */ SELECT numticket, Idbalancecli, monto, saldoactualc, cod_taquilla, hor_venta
...
do {
    ...
    if ($row_Recordset1['cod_taquilla']==$taquilla) {
        ...
        $insertSQL15 = sprintf(
            "/* PARSEADORES1 reparacion20202.php - QUERY 2 */ UPDATE balanceclientes
				SET
