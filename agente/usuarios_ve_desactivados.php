...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 agente\usuarios_ve_desactivados.php - QUERY 1 */ UPDATE taquilla 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 agente\usuarios_ve_desactivados.php - QUERY 2 */ SELECT
ta.taq_vende_ame,
ta.taq_por_ame,
ta.taq_vende_parley,
ta.taq_por_parley,
...
$query_Recordset94 =  sprintf(
  "/* PARSEADORES1 agente\usuarios_ve_desactivados.php - QUERY 3 */ SELECT
ag.sinoclaves
FROM  taquilla ta, agencia ag
WHERE ta.cod_taquilla = %s AND ag.cod_agencia = ta.cod_agencia LIMIT 1",
  GetSQLValueString($xCodigo, "int")
...
$est_taquilla=$row_Recordset1['est_taquilla']/1;
    ...
    $taq_cob_hnac=$row_Recordset1['taq_cob_hnac']/1;
        ...
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 agente\usuarios_ve_desactivados.php - QUERY 4 */ SELECT * FROM usuario 
	WHERE tip_usuario='U' 
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 agente\usuarios_ve_desactivados.php - QUERY 5 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
