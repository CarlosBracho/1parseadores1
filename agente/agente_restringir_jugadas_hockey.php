...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 agente\agente_restringir_jugadas_hockey.php - QUERY 1 */ SELECT  
...
$query_Recordset4 =  sprintf(
    "/* PARSEADORES1 agente\agente_restringir_jugadas_hockey.php - QUERY 2 */ SELECT  
*
...
if ($totalRows_Recordset4==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            $query_Recordset4 =  sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_hockey.php - QUERY 3 */ SELECT  
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        if ($_POST['existe']==1) {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_hockey.php - QUERY 4 */ UPDATE taquilla_opc_parley
					SET
                    hockey_ml=%s,
                    hockey_alta=%s,
                    hockey_baja=%s,
                ...
                GetSQLValueString($_POST['hockey_ml'], "int"),
                GetSQLValueString($_POST['hockey_alta'], "int"),
                GetSQLValueString($_POST['hockey_baja'], "int"),
                GetSQLValueString($_POST['hockey_runline'], "int"),         
...
if ($_POST['hockey_ml']<>$row_Recordset4['hockey_ml'] or $_POST['hockey_alta']<>$row_Recordset4['hockey_alta'] or $_POST['hockey_baja']<>$row_Recordset4['hockey_baja'] or $_POST['hockey_runline']<>$row_Recordset4['hockey_runline']){
                ...
                if ($_POST['hockey_ml']<>$row_Recordset4['hockey_ml'] ) {
                    if($_POST['hockey_ml']==1){
                    $msj.= " MONEYLINE: DESACTIVADO \n";}else{$msj.= " MONEYLINE: ACTIVADO \n";}}
    
                if ($_POST['hockey_alta']<>$row_Recordset4['hockey_alta'] ) {
                    if($_POST['hockey_alta']==1){
                    $msj.= " ALTA: DESACTIVADO \n";}else{$msj.= " ALTA: ACTIVADO \n";}}
    
                if ($_POST['hockey_baja']<>$row_Recordset4['hockey_baja'] ) {
                    if($_POST['hockey_baja']==1){
                    $msj.= " BAJA: DESACTIVADO \n";}else{$msj.= " BAJA: ACTIVADO \n";}}
    
                if ($_POST['hockey_runline']<>$row_Recordset4['hockey_runline'] ) {
                    if($_POST['hockey_runline']==1){
...
/*/
            ...
            echo "/* PARSEADORES1 agente\agente_restringir_jugadas_hockey.php - QUERY 5 */ insert";
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_hockey.php - QUERY 6 */ INSERT 
			INTO 
			taquilla_opc_parley 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_hockey.php - QUERY 7 */ SELECT  
tp.apu_minparley, tp.apu_maxparley, tp.comb_minparley, tp.comb_maxparley
	...
	LIMIT 1",
            ...
            if ($apuestasminimaausar > $row_Recordset22['apu_minparley']) {
                $insertSQL11 = sprintf(
                    "/* PARSEADORES1 agente\agente_restringir_jugadas_hockey.php - QUERY 8 */ UPDATE taquilla_opc_parley
					SET
					apu_minparley=%s
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 agente\agente_restringir_jugadas_hockey.php - QUERY 9 */ SELECT ta.cod_taquilla, ta.nom_taquilla
FROM taquilla ta, taquilla_opc_parley tp
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
	...
	<div style="padding:70px 10px 20px 10px; text-align:left; font-size:18px; height: auto">
        ...
        <input type="hidden" name="cod_taquilla" value="<?php echo $row_Recordset1['cod_taquilla']; ?>">
          ...
          <select name="hockey_ml" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['hockey_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['hockey_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  ...
                  <td>
                  <select name="hockey_alta" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['hockey_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['hockey_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="hockey_baja" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['hockey_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['hockey_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  ...
                  <td>
                  <select name="hockey_runline" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['hockey_runline']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['hockey_runline']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
