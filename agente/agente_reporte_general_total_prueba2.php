...
$query_Recordset555 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_prueba2.php - QUERY 1 */ SELECT * FROM tasadecambio WHERE Idtasadecambio = 1");
...
$query_Recordset6 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_prueba2.php - QUERY 2 */ SELECT cod_banca FROM agencia 
        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_usuario']!="todos") {
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_prueba2.php - QUERY 3 */ SELECT
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && isset($_POST['id_usuario']) && $_POST['id_usuario']=="todos") || (!isset($_POST["MM_update"]))) {
    $query_Recordset3 = sprintf(
        "/* PARSEADORES1 agente\agente_reporte_general_total_prueba2.php - QUERY 4 */ SELECT
		ta.cod_taquilla, ta.nom_taquilla, ag.agen_por_ame, ag.agen_cob_hnac, ag.agen_por_parley
	FROM
		agencia ag, taquilla ta
	WHERE 
...
$query_Recordset4 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_prueba2.php - QUERY 5 */ SELECT cod_taquilla, nom_taquilla FROM taquilla 
...
$query_Recordset5 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_prueba2.php - QUERY 6 */ SELECT info1,info11,info2,info22,info3,info33,info4,info44,info5,info55 FROM banca 
...
<?php
$query_Recordset44 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_prueba2.php - QUERY 7 */ SELECT 
	me.mensaje
        ...
        if ($totalRows_Recordset3>0) {
            do {
                ...
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_prueba2.php - QUERY 8 */ SELECT
                ...
                $query_Recordset2 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_prueba2.php - QUERY 9 */ SELECT
...
USE INDEX(id_us_fe_fe)
                ...
                $query_Recordset50 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_prueba2.php - QUERY 10 */ SELECT 
                ...
                //PARLEY BS
                $porTaquillaP=$row_Recordset50['taq_por_parley'];
                ...
                $query_Recordset7 =  sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_prueba2.php - QUERY 11 */ SELECT id_usuario
					FROM  
					cobro_hnac
					WHERE 
					cod_taquilla = %s AND
                ...
                $query_Recordset7 =  sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_prueba2.php - QUERY 12 */ SELECT id_usuario
					FROM  
					cobro_hnac
					WHERE 
					cod_taquilla = %s AND
...
echo "x".$totalRows_Recordset7.")";
$totalpagosistema=$corbro*$totalRows_Recordset7;
}
?>					
<font color="red"><?php
if ($totVentaTaq==0) {
