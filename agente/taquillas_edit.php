...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 agente\taquillas_edit.php - QUERY 1 */ UPDATE taquilla 
...
if (($apuestasminimaausar > $row_Recordset22['apu_mingan']) OR (($apuestasminimaausar*10) < $row_Recordset22['apu_mingan'] ) )
{
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 agente\taquillas_edit.php - QUERY 2 */ SELECT
ta.taq_vende_ame,
ta.taq_por_ame,
ta.taq_vende_parley,
ta.taq_por_parley,
...
$query_Recordset94 =  sprintf(
  "/* PARSEADORES1 agente\taquillas_edit.php - QUERY 3 */ SELECT
ag.sinoclaves,
ag.sinomoneda
FROM  taquilla ta, agencia ag
WHERE ta.cod_taquilla = %s AND ag.cod_agencia = ta.cod_agencia LIMIT 1",
...
$est_taquilla=$row_Recordset1['est_taquilla']/1;
    ...
    $taq_cob_hnac=$row_Recordset1['taq_cob_hnac']/1;
        ...
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 agente\taquillas_edit.php - QUERY 4 */ SELECT * FROM usuario 
	WHERE tip_usuario='U' 
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 agente\taquillas_edit.php - QUERY 5 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
...
<?php
                if ($row_Recordset94['sinomoneda']==0){
                  ?>            
												<tr>
                  <td height="85" colspan="5" align="center" valign="middle" nowrap bgcolor="#5EAEFF" 
                  	style="color:#FFF; font-size:24px; font-weight: bold;">
                  	SELECIONE TIPO DE MONEDA DE ESTA TAQUILLA</br></br>RECUERDE QUE DEBE AJUSTAR LOS VALORES </br></br>MINIMOS Y MAXIMOS AL REALIZAR UN CAMBIO DE MONEDA
                  </td>
                </tr>  
				<tr>
...
<?php
                if ($row_Recordset94['sinomoneda']==1){
                  ?>            
												<tr>
                  <td height="85" colspan="5" align="center" valign="middle" nowrap bgcolor="#5EAEFF" 
                  	style="color:#FFF; font-size:24px; font-weight: bold;">
...
?>
    ...
    echo "SELECTED";
                    ...
                    onKeyUp="return handleEnter(this, event)" tabindex="8" required max="100"/>
                  	%
										     <br/> <a href='../agente/agente_taquillas_edit_ame.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'class="btn btn-info"> EDITAR MODULO <br/>HIPISMO INTERNACIONAL</a>
    ...
    echo "SELECTED";
                    ...
                    onKeyUp="return handleEnter(this, event)" tabindex="8" required max="100"/>
										     <br/> <a href='../agente_hnac/agente_taquillas_edit_hnac.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'class="btn btn-info"> EDITAR MODULO <br/>HIPISMO NACIONAL</a>
    ...
    echo "SELECTED";
                    ...
                    onKeyUp="return handleEnter(this, event)" tabindex="8" required max="100"/>
                  	%
										     <br/> <a href='../agente/agente_taquillas_edit_parley.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'class="btn btn-info"> EDITAR MODULO <br/>PARLEY</a>
        ...
        <?php do { ?>
          ...
          <tr class="brillo">
            <td align="left"><?php echo $row_Recordset11['nom_usuario']; ?></td>
						<td align="left"><?php
            if ($row_Recordset94['sinoclaves']==1){
