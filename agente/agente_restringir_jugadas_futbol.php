...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 agente\agente_restringir_jugadas_futbol.php - QUERY 1 */ SELECT  
...
$query_Recordset4 =  sprintf(
    "/* PARSEADORES1 agente\agente_restringir_jugadas_futbol.php - QUERY 2 */ SELECT  
*
...
if ($totalRows_Recordset4==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            $query_Recordset4 =  sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_futbol.php - QUERY 3 */ SELECT  
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        if ($_POST['existe']==1) {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_futbol.php - QUERY 4 */ UPDATE taquilla_opc_parley
					SET
                    futbol_ml=%s,
                    futbol_alta=%s,
                    futbol_baja=%s,
                ...
                GetSQLValueString($_POST['futbol_ml'], "int"),
                GetSQLValueString($_POST['futbol_alta'], "int"),
                GetSQLValueString($_POST['futbol_baja'], "int"),
                GetSQLValueString($_POST['futbol_empate'], "int"),
                GetSQLValueString($_POST['futbol_mj_ml'], "int"),
                GetSQLValueString($_POST['futbol_mj_alta'], "int"),
                GetSQLValueString($_POST['futbol_mj_baja'], "int"),
                GetSQLValueString($_POST['futbol_mj_empate'], "int"),          
...
if ($_POST['futbol_ml']<>$row_Recordset4['futbol_ml'] or $_POST['futbol_alta']<>$row_Recordset4['futbol_alta'] or $_POST['futbol_baja']<>$row_Recordset4['futbol_baja'] or $_POST['futbol_runline']<>$row_Recordset4['futbol_runline'] or $_POST['futbol_mj_ml']<>$row_Recordset4['futbol_mj_ml'] or $_POST['futbol_mj_alta']<>$row_Recordset4['futbol_mj_alta'] or $_POST['futbol_mj_baja']<>$row_Recordset4['futbol_mj_baja'] or $_POST['futbol_mj_rl']<>$row_Recordset4['futbol_mj_rl']){
                ...
                if ($_POST['futbol_ml']<>$row_Recordset4['futbol_ml'] ) {
                    if($_POST['futbol_ml']==1){
                    $msj.= " MONEYLINE: DESACTIVADO \n";}else{$msj.= " MONEYLINE: ACTIVADO \n";}}
    
                if ($_POST['futbol_alta']<>$row_Recordset4['futbol_alta'] ) {
                    if($_POST['futbol_alta']==1){
                    $msj.= " ALTA: DESACTIVADO \n";}else{$msj.= " ALTA: ACTIVADO \n";}}
    
                if ($_POST['futbol_baja']<>$row_Recordset4['futbol_baja'] ) {
                    if($_POST['futbol_baja']==1){
                    $msj.= " BAJA: DESACTIVADO \n";}else{$msj.= " BAJA: ACTIVADO \n";}}
    
                if ($_POST['futbol_runline']<>$row_Recordset4['futbol_runline'] ) {
                    if($_POST['futbol_runline']==1){
                    $msj.= " RUNLINE: DESACTIVADO \n";}else{$msj.= " RUNLINE: ACTIVADO \n";}}
    
                if ($_POST['futbol_mj_ml']<>$row_Recordset4['futbol_mj_ml'] ) {
                    if($_POST['futbol_mj_ml']==1){
                    $msj.= " MITAD DE JUEGO MONEYLINE: DESACTIVADO \n";}else{$msj.= "MITAD DE JUEGO MONEYLINE: ACTIVADO \n";}}
    
                if ($_POST['futbol_mj_alta']<>$row_Recordset4['futbol_mj_alta'] ) {
                    if($_POST['futbol_mj_alta']==1){
                    $msj.= " MITAD DE JUEGO ALTA: DESACTIVADO \n";}else{$msj.= "MITAD DE JUEGO ALTA: ACTIVADO \n";}}
            
                if ($_POST['futbol_mj_baja']<>$row_Recordset4['futbol_mj_baja'] ) {
                    if($_POST['futbol_mj_baja']==1){
                    $msj.= " MITAD DE JUEGO BAJA: DESACTIVADO \n";}else{$msj.= "MITAD DE JUEGO BAJA: ACTIVADO \n";}}
    
                if ($_POST['futbol_mj_rl']<>$row_Recordset4['futbol_mj_rl'] ) {
        ...
        curl_close ($ch);
            ...
            echo "/* PARSEADORES1 agente\agente_restringir_jugadas_futbol.php - QUERY 5 */ insert";
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_futbol.php - QUERY 6 */ INSERT 
			INTO 
			taquilla_opc_parley 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_futbol.php - QUERY 7 */ SELECT  
tp.apu_minparley, tp.apu_maxparley, tp.comb_minparley, tp.comb_maxparley
	...
	LIMIT 1",
            ...
            if ($apuestasminimaausar > $row_Recordset22['apu_minparley']) {
                $insertSQL11 = sprintf(
                    "/* PARSEADORES1 agente\agente_restringir_jugadas_futbol.php - QUERY 8 */ UPDATE taquilla_opc_parley
					SET
					apu_minparley=%s
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 agente\agente_restringir_jugadas_futbol.php - QUERY 9 */ SELECT ta.cod_taquilla, ta.nom_taquilla
FROM taquilla ta, taquilla_opc_parley tp
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
	...
	<div style="padding:70px 10px 20px 10px; text-align:left; font-size:18px; height: auto">
        ...
        <input type="hidden" name="cod_taquilla" value="<?php echo $row_Recordset1['cod_taquilla']; ?>">
          ...
          <select name="futbol_ml" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbol_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbol_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  ...
                  <td>
                  <select name="futbol_alta" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red"  value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbol_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbol_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="futbol_baja" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red"  value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbol_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbol_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  ...
                  <td>
                  <select name="futbol_empate" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbol_empate']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbol_empate']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="futbol_mj_ml" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red"  value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbol_mj_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbol_mj_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  <td nowrap align="left">ALTA:</td>
                  <td>
                  <select name="futbol_mj_alta" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbol_mj_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbol_mj_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="futbol_mj_baja" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbol_mj_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbol_mj_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  <td nowrap align="left">EMPATE:</td>
                  <td>
                  <select name="futbol_mj_empate" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red"  value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbol_mj_empate']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbol_mj_empate']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
              ...
              <table width="924" align="center">
                <tr valign="baseline">
                  ...
                  <a href='../agente/agente_taquillas_edit_parley.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'
