...
$query_Recordset555 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_prueba.php - QUERY 1 */ SELECT * FROM tasadecambio WHERE Idtasadecambio = 1");
...
$query_Recordset6 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_prueba.php - QUERY 2 */ SELECT cod_banca FROM agencia 
        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_usuario']!="todos") {
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_prueba.php - QUERY 3 */ SELECT
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && isset($_POST['id_usuario']) && $_POST['id_usuario']=="todos") || (!isset($_POST["MM_update"]))) {
    $query_Recordset3 = sprintf(
        "/* PARSEADORES1 agente\agente_reporte_general_total_prueba.php - QUERY 4 */ SELECT
		ta.cod_taquilla, ta.nom_taquilla, ag.agen_por_ame, ag.agen_cob_hnac, ag.agen_por_parley
	FROM
		agencia ag, taquilla ta
	WHERE 
...
$query_Recordset4 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_prueba.php - QUERY 5 */ SELECT cod_taquilla, nom_taquilla FROM taquilla 
...
$query_Recordset5 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_prueba.php - QUERY 6 */ SELECT info1,info11,info2,info22,info3,info33,info4,info44,info5,info55 FROM banca 
...
<?php
$query_Recordset44 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_prueba.php - QUERY 7 */ SELECT 
	me.mensaje
	   ...
	   <div>
		<table width="100%" border="0" style="color:#000; font-size:12px;" cellpadding="0" cellspacing="0">
				...
				<td width="32%" colspan="-2" bgcolor="#333" style="color:#FFF"><br/>
                    ...
                    NACIONALES: <?php echo number_format($row_Recordset3['agen_cob_hnac'], 2, ",", ".")." Bs/dia<br/>"; ?>
        ...
        if ($totalRows_Recordset3>0) {
            do {
                ...
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_prueba.php - QUERY 8 */ SELECT
                ...
                $query_Recordset2 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_prueba.php - QUERY 9 */ SELECT
...
USE INDEX(id_us_fe_fe)
                ...
                $query_Recordset50 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_prueba.php - QUERY 10 */ SELECT 
                ...
                $query_Recordset7 =  sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_prueba.php - QUERY 11 */ SELECT id_usuario
					FROM  
					cobro_hnac
					WHERE 
					cod_taquilla = %s AND
                ...
                $query_Recordset7 =  sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_prueba.php - QUERY 12 */ SELECT id_usuario
					FROM  
					cobro_hnac
					WHERE 
					cod_taquilla = %s AND
...
if ($totVentaTaq==0) {
echo "AM(".number_format($porTaquilla, 1, ",", ".")."%)";
echo "NA(".number_format($row_Recordset3['agen_cob_hnac'], 2, ",", ".");
echo "x".$totalRows_Recordset7.")";
$totalpagosistema=$row_Recordset3['agen_cob_hnac']*$totalRows_Recordset7;
}
?>					
<font color="red"><?php
if ($totVentaTaq==0) {
       ...
       if ($totVentaTaqPUSD!=0 or $totPremiTaqPUSD!=0 or $totAnulaTaqPUSD!=0 or $totTaquillaPUSD!=0 or $totPTaqPpagPUSD!=0 or
                $porPagarEliTaqPUSD!=0 or $totGanPerTaqPUSD!=0) {?>
                  <tr onmouseover="cambiacolor_over1(this)" onmouseout="cambiacolor_out3(this)" height="20" 
                    ...
                    $totalusd=$totVentaTaqPUSD-$totAnulaTaqPUSD-$porPagarEliTaqPUSD;
 ...
 if ($subTotVentasol!=0 or $subTotPremisol!=0 or $subTotAnulasol!=0 or $subTotTaquillasol!=0 or $subPTaqPpagsol!=0 or
     ...
     ?>
            ...
            $totalPagarSistemasol=($totSistemasol*($porcentaje/100));
                        ...
                        $cambiosolabss=$totalPagarSistemasol*$row_Recordset555['solabss']+$parleypagoCOP;
                        
                        $totalapagar=$totalPagarSistema+$cambiousdabss+$cambiocopabss+$cambiosolabss+$totalPagarSistemaN+$totalPagarSist;
...
document.getElementById('totalanacionales').innerHTML = "<?php echo " <br> NACIONALES >> ". number_format($totalPagarSistemaN, 2, ",", ".")."&nbsp;BSS<br/>"; ?>";
