...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 agente\agente_restringir_jugadas_baloncesto.php - QUERY 1 */ SELECT  
...
$query_Recordset4 =  sprintf(
    "/* PARSEADORES1 agente\agente_restringir_jugadas_baloncesto.php - QUERY 2 */ SELECT  
*
...
if ($totalRows_Recordset4==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            $query_Recordset4 =  sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_baloncesto.php - QUERY 3 */ SELECT  
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        if ($_POST['existe']==1) {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_baloncesto.php - QUERY 4 */ UPDATE taquilla_opc_parley
					SET
                    baloncesto_ml=%s,
                    baloncesto_alta=%s,
                    baloncesto_baja=%s,
                    baloncesto_runline=%s,
                    baloncesto_mj_ml=%s,
                    baloncesto_mj_alta=%s,
                    baloncesto_mj_baja=%s,
                    baloncesto_mj_rl=%s
					WHERE cod_taopcparley=%s",
                GetSQLValueString($_POST['baloncesto_ml'], "int"),
                GetSQLValueString($_POST['baloncesto_alta'], "int"),
                GetSQLValueString($_POST['baloncesto_baja'], "int"),
                GetSQLValueString($_POST['baloncesto_runline'], "int"),
                GetSQLValueString($_POST['baloncesto_mj_ml'], "int"),
                GetSQLValueString($_POST['baloncesto_mj_alta'], "int"),
                GetSQLValueString($_POST['baloncesto_mj_baja'], "int"),
                GetSQLValueString($_POST['baloncesto_mj_rl'], "int"),          
...
if ($_POST['baloncesto_ml']<>$row_Recordset4['baloncesto_ml'] or $_POST['baloncesto_alta']<>$row_Recordset4['baloncesto_alta'] or $_POST['baloncesto_baja']<>$row_Recordset4['baloncesto_baja'] or $_POST['baloncesto_runline']<>$row_Recordset4['baloncesto_runline'] or $_POST['baloncesto_mj_ml']<>$row_Recordset4['baloncesto_mj_ml'] or $_POST['baloncesto_mj_alta']<>$row_Recordset4['baloncesto_mj_alta'] or $_POST['baloncesto_mj_baja']<>$row_Recordset4['baloncesto_mj_baja'] or $_POST['baloncesto_mj_rl']<>$row_Recordset4['baloncesto_mj_rl']){
                ...
                $msj.= " DEPORTE: BALONCESTO \n";
    
                if ($_POST['baloncesto_ml']<>$row_Recordset4['baloncesto_ml'] ) {
                    if($_POST['baloncesto_ml']==1){
                    $msj.= " MONEYLINE: DESACTIVADO \n";}else{$msj.= " MONEYLINE: ACTIVADO \n";}}
    
                if ($_POST['baloncesto_alta']<>$row_Recordset4['baloncesto_alta'] ) {
                    if($_POST['baloncesto_alta']==1){
                    $msj.= " ALTA: DESACTIVADO \n";}else{$msj.= " ALTA: ACTIVADO \n";}}
    
                if ($_POST['baloncesto_baja']<>$row_Recordset4['baloncesto_baja'] ) {
                    if($_POST['baloncesto_baja']==1){
                    $msj.= " BAJA: DESACTIVADO \n";}else{$msj.= " BAJA: ACTIVADO \n";}}
    
                if ($_POST['baloncesto_runline']<>$row_Recordset4['baloncesto_runline'] ) {
                    if($_POST['baloncesto_runline']==1){
                    $msj.= " RUNLINE: DESACTIVADO \n";}else{$msj.= " RUNLINE: ACTIVADO \n";}}
    
                if ($_POST['baloncesto_mj_ml']<>$row_Recordset4['baloncesto_mj_ml'] ) {
                    if($_POST['baloncesto_mj_ml']==1){
                    $msj.= " MITAD DE JUEGO MONEYLINE: DESACTIVADO \n";}else{$msj.= "MITAD DE JUEGO MONEYLINE: ACTIVADO \n";}}
    
                if ($_POST['baloncesto_mj_alta']<>$row_Recordset4['baloncesto_mj_alta'] ) {
                    if($_POST['baloncesto_mj_alta']==1){
                    $msj.= " MITAD DE JUEGO ALTA: DESACTIVADO \n";}else{$msj.= "MITAD DE JUEGO ALTA: ACTIVADO \n";}}
            
                if ($_POST['baloncesto_mj_baja']<>$row_Recordset4['baloncesto_mj_baja'] ) {
                    if($_POST['baloncesto_mj_baja']==1){
                    $msj.= " MITAD DE JUEGO BAJA: DESACTIVADO \n";}else{$msj.= "MITAD DE JUEGO BAJA: ACTIVADO \n";}}
    
                if ($_POST['baloncesto_mj_rl']<>$row_Recordset4['baloncesto_mj_rl'] ) {
                    if($_POST['baloncesto_mj_rl']==1){
        ...
        curl_close ($ch);
            ...
            echo "/* PARSEADORES1 agente\agente_restringir_jugadas_baloncesto.php - QUERY 5 */ insert";
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_baloncesto.php - QUERY 6 */ INSERT 
			INTO 
			taquilla_opc_parley 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_baloncesto.php - QUERY 7 */ SELECT  
tp.apu_minparley, tp.apu_maxparley, tp.comb_minparley, tp.comb_maxparley
	...
	LIMIT 1",
            ...
            if ($apuestasminimaausar > $row_Recordset22['apu_minparley']) {
                $insertSQL11 = sprintf(
                    "/* PARSEADORES1 agente\agente_restringir_jugadas_baloncesto.php - QUERY 8 */ UPDATE taquilla_opc_parley
					SET
					apu_minparley=%s
        ...
        $insertGoTo = "../agente/agente_taquillas_edit_parley.php?recordID=".$row_Recordset1['cod_taquilla'];
        if (isset($_SERVER['QUERY_STRING'])) {
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 agente\agente_restringir_jugadas_baloncesto.php - QUERY 9 */ SELECT ta.cod_taquilla, ta.nom_taquilla
FROM taquilla ta, taquilla_opc_parley tp
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
	...
	<div style="padding:70px 10px 20px 10px; text-align:left; font-size:18px; height: auto">
        ...
        <input type="hidden" name="cod_taquilla" value="<?php echo $row_Recordset1['cod_taquilla']; ?>">
          ...
          <select name="baloncesto_ml" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['baloncesto_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['baloncesto_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  ...
                  <td>
                  <select name="baloncesto_alta" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['baloncesto_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['baloncesto_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="baloncesto_baja" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['baloncesto_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['baloncesto_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  ...
                  <td>
                  <select name="baloncesto_runline" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['baloncesto_runline']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['baloncesto_runline']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="baloncesto_mj_ml" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['baloncesto_mj_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['baloncesto_mj_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  <td nowrap align="left">ALTA:</td>
                  <td>
                  <select name="baloncesto_mj_alta" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['baloncesto_mj_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['baloncesto_mj_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="baloncesto_mj_baja" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['baloncesto_mj_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['baloncesto_mj_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  <td nowrap align="left">RUNLINE:</td>
                  <td>
                  <select name="baloncesto_mj_rl" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['baloncesto_mj_rl']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['baloncesto_mj_rl']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                ...
                <tr valign="baseline">
                  <td height="26" colspan="5" align="center" valign="middle" nowrap bgcolor="#5EAEFF"></td>
                </tr>
