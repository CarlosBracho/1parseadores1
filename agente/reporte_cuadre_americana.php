...
$query_Recordset2 = sprintf("/* PARSEADORES1 agente\reporte_cuadre_americana.php - QUERY 1 */ SELECT usuario.nom_usuario, usuario.id_usuario, taquilla.nom_taquilla 
    FROM usuario, taquilla, agencia 
	WHERE agencia.cod_agencia = %s AND usuario.tip_usuario='U' 
...
$taquillaV=$row_Recordset2['nom_taquilla'];
    ...
    $query_Recordset3 = sprintf("/* PARSEADORES1 agente\reporte_cuadre_americana.php - QUERY 2 */ SELECT usuario.nom_usuario, taquilla.nom_taquilla 
    FROM usuario, taquilla, agencia 
...
<script language="JavaScript">document.write("Microsoft Internet Explorer"==navigator.appName||GetIEVersion()>0?'<body onload="javascript:document.all.cmdPrint.focus();">':"<body>");</script>
   ...
   <div style="background:#333; width:100%;float:left; padding:5px 0px 5px 0px;" id="noprint4">
          ...
          <a href="../agente_hnac/reporte_cuadre_hnac.php" style="font-size:11px;margin:0px 10px 0px 0px;line-height:12px;" 
