...
$query_Recordset3 =  sprintf(
  "/* PARSEADORES1 agente\taquillas_add.php - QUERY 1 */ SELECT * 
FROM 
agencia
WHERE cod_agencia = %s",
...
$query_Recordset94 =  sprintf(
  "/* PARSEADORES1 agente\taquillas_add.php - QUERY 2 */ SELECT
sinomoneda
FROM agencia
WHERE cod_agencia = %s",
 GetSQLValueString($_SESSION['MM_cod_agente'], "int")
...
if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
    if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
        ...
        $query_Recordset4 =  sprintf(
            "/* PARSEADORES1 agente\taquillas_add.php - QUERY 3 */ SELECT  
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==30) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 agente\taquillas_add.php - QUERY 4 */ INSERT 
				INTO taquilla 
...
moneda,
        ...
        $query_RecT = "/* PARSEADORES1 agente\taquillas_add.php - QUERY 5 */ SELECT cod_taquilla FROM taquilla ORDER BY cod_taquilla DESC LIMIT 1";
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 agente\taquillas_add.php - QUERY 6 */ INSERT 
		INTO usuario 
...
$query_Recordset3 = "/* PARSEADORES1 agente\taquillas_add.php - QUERY 7 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
