...
$query_Recordset6 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total2.php - QUERY 1 */ SELECT cod_banca FROM agencia 
        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_usuario']!="todos") {
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total2.php - QUERY 2 */ SELECT
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && isset($_POST['id_usuario']) && $_POST['id_usuario']=="todos") || (!isset($_POST["MM_update"]))) {
    $query_Recordset3 = sprintf(
        "/* PARSEADORES1 agente\agente_reporte_general_total2.php - QUERY 3 */ SELECT
		ta.cod_taquilla, ta.nom_taquilla, ag.por_agencia, ag.cob_agencia_hnac
	FROM
		agencia ag, taquilla ta
	WHERE 
...
$query_Recordset4 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total2.php - QUERY 4 */ SELECT cod_taquilla, nom_taquilla FROM taquilla 
...
$query_Recordset5 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total2.php - QUERY 5 */ SELECT info1,info11,info2,info22,info3,info33,info4,info44,info5,info55 FROM banca 
        ...
        if ($totalRows_Recordset3>0) {
            do {
                ...
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total2.php - QUERY 6 */ SELECT
                ...
                $query_Recordset2 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total2.php - QUERY 7 */ SELECT
...
USE INDEX(id_us_fe_fe)
                ...
                $query_Recordset7 =  sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total2.php - QUERY 8 */ SELECT id_usuario
					FROM  
					cobro_hnac
					WHERE 
					cod_taquilla = %s AND
