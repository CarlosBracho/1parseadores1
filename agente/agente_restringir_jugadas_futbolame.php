...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 agente\agente_restringir_jugadas_futbolame.php - QUERY 1 */ SELECT  
...
$query_Recordset4 =  sprintf(
    "/* PARSEADORES1 agente\agente_restringir_jugadas_futbolame.php - QUERY 2 */ SELECT  
*
...
if ($totalRows_Recordset4==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            $query_Recordset4 =  sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_futbolame.php - QUERY 3 */ SELECT  
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        if ($_POST['existe']==1) {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_futbolame.php - QUERY 4 */ UPDATE taquilla_opc_parley
					SET
                    futbolame_ml=%s,
                    futbolame_alta=%s,
                    futbolame_baja=%s,
                ...
                GetSQLValueString($_POST['futbolame_ml'], "int"),
                GetSQLValueString($_POST['futbolame_alta'], "int"),
                GetSQLValueString($_POST['futbolame_baja'], "int"),
                GetSQLValueString($_POST['futbolame_runline'], "int"),
                GetSQLValueString($_POST['futbolame_mj_ml'], "int"),
                GetSQLValueString($_POST['futbolame_mj_alta'], "int"),
                GetSQLValueString($_POST['futbolame_mj_baja'], "int"),
                GetSQLValueString($_POST['futbolame_mj_rl'], "int"),          
...
if ($_POST['futbolame_ml']<>$row_Recordset4['futbolame_ml'] or $_POST['futbolame_alta']<>$row_Recordset4['futbolame_alta'] or $_POST['futbolame_baja']<>$row_Recordset4['futbolame_baja'] or $_POST['futbolame_runline']<>$row_Recordset4['futbolame_runline'] or $_POST['futbolame_mj_ml']<>$row_Recordset4['futbolame_mj_ml'] or $_POST['futbolame_mj_alta']<>$row_Recordset4['futbolame_mj_alta'] or $_POST['futbolame_mj_baja']<>$row_Recordset4['futbolame_mj_baja'] or $_POST['futbolame_mj_rl']<>$row_Recordset4['futbolame_mj_rl']){
                ...
                $msj.= " DEPORTE: FUTBOL AMERICANO \n";
    
                if ($_POST['futbolame_ml']<>$row_Recordset4['futbolame_ml'] ) {
                    if($_POST['futbolame_ml']==1){
                    $msj.= " MONEYLINE: DESACTIVADO \n";}else{$msj.= " MONEYLINE: ACTIVADO \n";}}
    
                if ($_POST['futbolame_alta']<>$row_Recordset4['futbolame_alta'] ) {
                    if($_POST['futbolame_alta']==1){
                    $msj.= " ALTA: DESACTIVADO \n";}else{$msj.= " ALTA: ACTIVADO \n";}}
    
                if ($_POST['futbolame_baja']<>$row_Recordset4['futbolame_baja'] ) {
                    if($_POST['futbolame_baja']==1){
                    $msj.= " BAJA: DESACTIVADO \n";}else{$msj.= " BAJA: ACTIVADO \n";}}
    
                if ($_POST['futbolame_runline']<>$row_Recordset4['futbolame_runline'] ) {
                    if($_POST['futbolame_runline']==1){
                    $msj.= " RUNLINE: DESACTIVADO \n";}else{$msj.= " RUNLINE: ACTIVADO \n";}}
    
                if ($_POST['futbolame_mj_ml']<>$row_Recordset4['futbolame_mj_ml'] ) {
                    if($_POST['futbolame_mj_ml']==1){
                    $msj.= " MITAD DE JUEGO MONEYLINE: DESACTIVADO \n";}else{$msj.= "MITAD DE JUEGO MONEYLINE: ACTIVADO \n";}}
    
                if ($_POST['futbolame_mj_alta']<>$row_Recordset4['futbolame_mj_alta'] ) {
                    if($_POST['futbolame_mj_alta']==1){
                    $msj.= " MITAD DE JUEGO ALTA: DESACTIVADO \n";}else{$msj.= "MITAD DE JUEGO ALTA: ACTIVADO \n";}}
            
                if ($_POST['futbolame_mj_baja']<>$row_Recordset4['futbolame_mj_baja'] ) {
                    if($_POST['futbolame_mj_baja']==1){
                    $msj.= " MITAD DE JUEGO BAJA: DESACTIVADO \n";}else{$msj.= "MITAD DE JUEGO BAJA: ACTIVADO \n";}}
    
                if ($_POST['futbolame_mj_rl']<>$row_Recordset4['futbolame_mj_rl'] ) {
                    if($_POST['futbolame_mj_rl']==1){
...
/*/
            ...
            echo "/* PARSEADORES1 agente\agente_restringir_jugadas_futbolame.php - QUERY 5 */ insert";
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_futbolame.php - QUERY 6 */ INSERT 
			INTO 
			taquilla_opc_parley 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 agente\agente_restringir_jugadas_futbolame.php - QUERY 7 */ SELECT  
tp.apu_minparley, tp.apu_maxparley, tp.comb_minparley, tp.comb_maxparley
	...
	LIMIT 1",
            ...
            if ($apuestasminimaausar > $row_Recordset22['apu_minparley']) {
                $insertSQL11 = sprintf(
                    "/* PARSEADORES1 agente\agente_restringir_jugadas_futbolame.php - QUERY 8 */ UPDATE taquilla_opc_parley
					SET
					apu_minparley=%s
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 agente\agente_restringir_jugadas_futbolame.php - QUERY 9 */ SELECT ta.cod_taquilla, ta.nom_taquilla
FROM taquilla ta, taquilla_opc_parley tp
...
<div class="container">
	...
	<div style="padding:70px 10px 20px 10px; text-align:left; font-size:18px; height: auto">
        ...
        <input type="hidden" name="cod_taquilla" value="<?php echo $row_Recordset1['cod_taquilla']; ?>">
              ...
              <table width="919" align="center" border="0" cellpadding="0" cellspacing="0" style="line-height:13px">
                <tr valign="baseline">
                  <td height="44" colspan="5" align="center" valign="middle" nowrap bgcolor="#333333" 
                  	...
                  	BLOQUEAR JUGADAS FUTBOL AMERICANO
                  </td>
          ...
          <select name="futbolame_ml" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbolame_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbolame_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  ...
                  <td>
                  <select name="futbolame_alta" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbolame_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbolame_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="futbolame_baja" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbolame_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbolame_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  ...
                  <td>
                  <select name="futbolame_runline" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbolame_runline']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbolame_runline']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="futbolame_mj_ml" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbolame_mj_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbolame_mj_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  <td nowrap align="left">ALTA:</td>
                  <td>
                  <select name="futbolame_mj_alta" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbolame_mj_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbolame_mj_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="futbolame_mj_baja" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbolame_mj_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbolame_mj_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  <td nowrap align="left">RUNLINE:</td>
                  <td>
                  <select name="futbolame_mj_rl" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option style="color:red" value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['futbolame_mj_rl']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['futbolame_mj_rl']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
