...
$query_Recordset555 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_angel.php - QUERY 1 */ SELECT * FROM tasadecambio WHERE Idtasadecambio = 1");
...
$query_Recordset6 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_angel.php - QUERY 2 */ SELECT cod_banca FROM agencia 
        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_usuario']!="todos") {
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_angel.php - QUERY 3 */ SELECT
					ta.cod_taquilla, ta.taq_por_ame, ta.taq_cob_hnac, ta.taq_por_parley, ta.nom_taquilla, ag.agen_por_ame, ag.agen_cob_hnac, ag.agen_por_parley
				FROM
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && isset($_POST['id_usuario']) && $_POST['id_usuario']=="todos") || (!isset($_POST["MM_update"]))) {
    $query_Recordset3 = sprintf(
        "/* PARSEADORES1 agente\agente_reporte_general_total_angel.php - QUERY 4 */ SELECT
...
$query_Recordset4 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_angel.php - QUERY 5 */ SELECT cod_taquilla, nom_taquilla FROM taquilla 
...
$query_Recordset5 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_angel.php - QUERY 6 */ SELECT info1,info11,info2,info22,info3,info33,info4,info44,info5,info55 FROM banca 
...
$agen_por_parley=$row_Recordset3['taq_por_parley'];
...
<?php
$query_Recordset44 = sprintf("/* PARSEADORES1 agente\agente_reporte_general_total_angel.php - QUERY 7 */ SELECT 
	me.mensaje
	   ...
	   <div>
		<table width="100%" border="0" style="color:#000; font-size:12px;" cellpadding="0" cellspacing="0">
				...
				<td width="32%" colspan="-2" bgcolor="#333" style="color:#FFF"><br/>
                    AMERICANAS: <?php echo number_format($row_Recordset3['taq_por_ame'], 2, ",", ".")."%<br/>"; ?>
                    NACIONALES: <?php echo number_format($row_Recordset3['taq_cob_hnac'], 2, ",", ".")." Bs/dia<br/>"; ?>
      ...
      <div style="background: #333; width:915px; float:left; padding:12px 13px 2px 12px;
       ...
       <table width="100%" border="0" style="color:#000; font-size:11px" bordercolor="#F5F5F5" cellpadding="0" cellspacing="0">
        ...
        if ($totalRows_Recordset3>0) {
            do {
                $porcentaje=$row_Recordset3['taq_por_ame'];
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_angel.php - QUERY 8 */ SELECT
                ...
                $query_Recordset2 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_angel.php - QUERY 9 */ SELECT
...
USE INDEX(id_us_fe_fe)
                ...
                $query_Recordset50 = sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_angel.php - QUERY 10 */ SELECT 
                ...
                $query_Recordset7 =  sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_angel.php - QUERY 11 */ SELECT id_usuario
					FROM  
					cobro_hnac
					WHERE 
					cod_taquilla = %s AND
                ...
                $query_Recordset7 =  sprintf(
                    "/* PARSEADORES1 agente\agente_reporte_general_total_angel.php - QUERY 12 */ SELECT id_usuario
					FROM  
					cobro_hnac
					WHERE 
					cod_taquilla = %s AND
