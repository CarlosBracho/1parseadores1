...
if (isset($_GET["recordID"])) {
    $xCodigo_taquilla = $_GET["recordID"];
}
$xCodigo = "-1";
if (isset($_GET["recordID"])) {
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 agente\usuarios_ve_edit.php - QUERY 1 */ SELECT * 
	FROM 
	usuario, taquilla 
	WHERE 
	usuario.id_usuario = %s AND
	taquilla.cod_taquilla = usuario.cod_taquilla LIMIT 1",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $_POST['tip_usuario']="U";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 agente\usuarios_ve_edit.php - QUERY 2 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
				est_usuario=%s, 
...
function salFoco() {
	if (document.getElementById("pas_usuario").value == "")
    document.getElementById("pas_usuario").value = "**********";
}
</script>
</head>
        ...
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>"  onsubmit="return chequearEnvio();">
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              <table width="919" align="center">
                ...
                <tr valign="baseline">
                  <td height="26" colspan="5" align="center" valign="middle" nowrap bgcolor="#5EAEFF">DATOS Y OPCIONES DE USUARIO</td>
                </tr>
              </table>
	      ...
	      <tr width="123" align="left" valign="middle">
                ...
                <tr valign="baseline">
                  ...
                  <td width="212">
                    ...
                    placeholder="contraseña" pattern="[A-Z a-z0-9]{4,20}" maxlength="20" style="height: auto" required="required"
                    value="<?php echo htmlentities($row_Recordset1['pas_usuario'], ENT_COMPAT, 'utf-8'); ?>" 
                    tabindex="33" onKeyUp="return handleEnter(this, event)"
                     onfocus="entFoco()" onblur="salFoco()" onclick="ocultaDiv('Info34')"/>
    ...
    echo "SELECTED";
              ...
              <table width="920" border="0">
                ...
                <tr valign="baseline" style="font-size:12px">
                  ...
                  <td width="69" align="center" valign="bottom">LUNES</td>
                  <td align="center" valign="bottom">MARTES</td>
                  <td align="center" valign="bottom">MIÉRCOLES</td>
                  <td width="69" align="center" valign="bottom">JUEVES</td>
                  <td width="69" align="center" valign="bottom">VIERNES</td>
                  <td width="69" align="center" valign="bottom">SÁBADO</td>
                  <td width="69" align="center" valign="bottom">DOMINGO</td>
                ...
                <tr valign="baseline">
                  ...
                  <td width="69" align="center"><input type="checkbox" name="dia2" class="textboxsmal" tabindex="44"
                  ...
                  <td colspan="2" align="left">
					<select name="ini_programa" style="width:auto; height: auto" class="textbox" tabindex="4"> 
                      <option value="0"<?php if (!(strcmp(0, htmlentities($row_Recordset1['ini_programa'], ENT_COMPAT, 'utf-8')))) {
                                echo "SELECTED";
                            } ?>>SELECCIÓN</option>
                      <option value="1"<?php if (!(strcmp(1, htmlentities($row_Recordset1['ini_programa'], ENT_COMPAT, 'utf-8')))) {
                                echo "SELECTED";
                            } ?>>AMERICANAS</option>
                      <option value="2"<?php if (!(strcmp(2, htmlentities($row_Recordset1['ini_programa'], ENT_COMPAT, 'utf-8')))) {
                                echo "SELECTED";
                            } ?>>NACIONALES</option>
                 	</select>
                  </td>
