...
$query_mensajesyalertas = sprintf(
    "/* PARSEADORES1 agente\agente_mensajesyalertas.php - QUERY 1 */ SELECT me.tipo, me.para, me.mensaje, me.mostrarhasta, me.Id_mensajesyalertas, ta.cod_agencia FROM mensajesyalertas me, taquilla ta
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 agente\agente_mensajesyalertas.php - QUERY 2 */ UPDATE mensajesyalertas 
...
if ($row_mensajesyalertas['tipo']==1) {
    $query_Recordset4 = sprintf(
        "/* PARSEADORES1 agente\agente_mensajesyalertas.php - QUERY 3 */ SELECT ta.nom_taquilla FROM taquilla ta, agencia ag
