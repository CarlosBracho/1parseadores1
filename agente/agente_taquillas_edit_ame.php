...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 agente\agente_taquillas_edit_ame.php - QUERY 1 */ SELECT  
...
$query_Recordset4 =  sprintf(
    "/* PARSEADORES1 agente\agente_taquillas_edit_ame.php - QUERY 2 */ SELECT  
    ...
    tp.div_pdes2, tp.div_phas2, tp.pag_pdiv2, tp.opc_ame2, tp.redondeo_ame, tp.limit_ticket_ame
...
if ($totalRows_Recordset4==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            ...
            $query_Recordset4 =  sprintf(
                "/* PARSEADORES1 agente\agente_taquillas_edit_ame.php - QUERY 3 */ SELECT  
				...
				tp.est_impresion, tp.anu_regalia, tp.tic_caduca, tp.tip_ticket, tp.tie_reclamo, tp.ver_porpagar, tp.def_regdiv1, tp.div_pdes1, tp.div_phas1,
                 tp.pag_pdiv1, tp.opc_ame, tp.div_pdes2, tp.div_phas2, tp.pag_pdiv2, tp.opc_ame2, tp.redondeo_ame, tp.limit_ticket_ame
				FROM  taquilla ta, taquilla_opc_ame tp 
				WHERE ta.cod_taquilla = %s AND tp.cod_taquilla = ta.cod_taquilla
				LIMIT 1",
    ...
    $redondeo_ame=$row_Recordset4['redondeo_ame'];
    $limit_ticket_ame=$row_Recordset4['limit_ticket_ame'];
}
    ...
    if ($graba==31) {
        if (isset($row_Recordset4['reg_gan'])) {
            if ($_POST['reg_gan']<>$row_Recordset4['reg_gan'] or $_POST['reg_pla']<>$row_Recordset4['reg_pla'] or $_POST['pag_codigo']<>$row_Recordset4['pag_codigo']) {
                ...
                $insertSQL2 = sprintf(
                    "/* PARSEADORES1 agente\agente_taquillas_edit_ame.php - QUERY 4 */ INSERT 
					INTO bitacora 
        ...
        if ($_POST['existe']==1) {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 agente\agente_taquillas_edit_ame.php - QUERY 5 */ UPDATE taquilla_opc_ame
					SET
					pag_codigo=%s, 
					apu_maxgan=%s, 
					apu_maxpla=%s, 
                ...
                GetSQLValueString($_POST['redondeo_ame'], "int"),
                GetSQLValueString($_POST['limit_ticket_ame'], "int"),
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 agente\agente_taquillas_edit_ame.php - QUERY 6 */ SELECT  
tp.apu_mingan
	...
	LIMIT 1",
            ...
            if ($apuestasminimaausar > $row_Recordset22['apu_mingan']) {
                $insertSQL11 = sprintf(
                    "/* PARSEADORES1 agente\agente_taquillas_edit_ame.php - QUERY 7 */ UPDATE taquilla_opc_ame
					SET
					apu_mingan=%s
            ...
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 agente\agente_taquillas_edit_ame.php - QUERY 8 */ INSERT 
			INTO 
			taquilla_opc_ame 
            ...
            opc_ame,    div_pdes2,
            div_phas2, 
            pag_pdiv2,  opc_ame2, redondeo_ame, limit_ticket_ame) 
			VALUES 
			(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, 
			 %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, 
			 %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 agente\agente_taquillas_edit_ame.php - QUERY 9 */ SELECT  
tp.apu_mingan
	FROM  taquilla_opc_ame tp 
	WHERE tp.cod_taquilla = %s
	LIMIT 1",
            ...
            if ($apuestasminimaausar > $row_Recordset22['apu_mingan']) {
                $insertSQL11 = sprintf(
                    "/* PARSEADORES1 agente\agente_taquillas_edit_ame.php - QUERY 10 */ UPDATE taquilla_opc_ame
					SET
					apu_mingan=%s
					WHERE cod_taquilla=%s",
        ...
        if($_POST['def_regdiv1']==1 && $_POST['def_regdiv1']<>$row_Recordset4['def_regdiv1']){
            $msj=' SE HA ACTIVADO LAS REGLAS AMERICANAS'.' DE LA TAQUILLA '.$row_Recordset1['nom_taquilla']. "\n";

            $msj.= "DEL AGENTE: " . $row_Recordset1['nom_agencia'] . "\n";
        }

        if($_POST['redondeo_ame']==0 && $_POST['redondeo_ame']<>$row_Recordset4['redondeo_ame']){
            $msj=' SE HA DESACTIVADO EL REDONDEO AMERICANO'.' DE LA TAQUILLA '.$row_Recordset1['nom_taquilla']. "\n";
            $msj.= "DEL AGENTE: " . $row_Recordset1['nom_agencia'] . "\n";
        }
        if($_POST['redondeo_ame']==1 && $_POST['redondeo_ame']<>$row_Recordset4['redondeo_ame']){
            $msj=' EL REDONDEO'.' DE LA TAQUILLA '.$row_Recordset1['nom_taquilla'] .' HA CAMBIADO A REDONDEO HACIA ABAJO EN AMERICANAS'. "\n";
            $msj.= "DEL AGENTE: " . $row_Recordset1['nom_agencia'] . "\n";

        }
        if($_POST['redondeo_ame']==2 && $_POST['redondeo_ame']<>$row_Recordset4['redondeo_ame']){
            $msj=' EL REDONDEO'.' DE LA TAQUILLA '.$row_Recordset1['nom_taquilla'] .' HA CAMBIADO A REDONDEO CONVENCIONAL EN AMERICANAS'. "\n";
            $msj.= "DEL AGENTE: " . $row_Recordset1['nom_agencia'] . "\n";
        }
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 agente\agente_taquillas_edit_ame.php - QUERY 11 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
              ...
              <table width="920" align="center" border="0"  style="line-height:11px" cellpadding="0" cellspacing="0">
                ...
                <tr valign="baseline">
                  ...
                  <td colspan="2" align="left" valign="top" style="font-size:12px">Monto máximo por ejemplar:
                    <input type="text" name="mon_maxejemplar" class="textboxsmal" style="height:15px; width:120px"
                ...
                <tr valign="baseline">
                  ...
                  <td>&nbsp;</td>
                  <td colspan="2" align="right"  valign="top" style="font-size:12px;color:#F00">
                  	Tiempo para impresión<br/>de ticket duplicados 
                </td>
                  <td colspan="2" align="left" valign="top">
					<select name="limit_ticket_ame" style="width:auto; height: auto" class="textbox" tabindex="4"> 
                      <option value="0" <?php if (!(strcmp(0, htmlentities($limit_ticket_ame, ENT_COMPAT, 'utf-8')))) {
                                    echo "SELECTED";
                                } ?>>5 Seg</option>
                      <option value="1" <?php if (!(strcmp(1, htmlentities($limit_ticket_ame, ENT_COMPAT, 'utf-8')))) {
                                    echo "SELECTED";
                                } ?>>15 Seg</option>
                     <option value="2" <?php if (!(strcmp(2, htmlentities($limit_ticket_ame, ENT_COMPAT, 'utf-8')))) {
                                    echo "SELECTED";
                                } ?>>30 Seg</option>
                      <option value="3" <?php if (!(strcmp(3, htmlentities($limit_ticket_ame, ENT_COMPAT, 'utf-8')))) {
                                    echo "SELECTED";
                                } ?>>60 Seg</option>
                      <option value="4" <?php if (!(strcmp(4, htmlentities($limit_ticket_ame, ENT_COMPAT, 'utf-8')))) {
                                    echo "SELECTED";
                                } ?>>120 Seg</option>                               
                 	</select>                  
                  </td>
                ...
                <tr valign="baseline">
                  ...
                  <td>&nbsp;</td>
                  <td colspan="2" align="right"  valign="top" style="font-size:12px;color:#F00">
                  REDONDEO DE DIVIDENDO:<br/>
                  </td>
                  <td colspan="2" align="left" valign="top">
					<select name="redondeo_ame" style="width:120px; height: 35px" class="textbox" tabindex="4"> 
                    <option value="0" 
					<?php if (!(strcmp(0, htmlentities($redondeo_ame, ENT_COMPAT, 'utf-8')))) {
                                    echo "SELECTED";
                                } ?>>SIN REDONDEO</option>
                    <option value="1" 
					<?php if (!(strcmp(1, htmlentities($redondeo_ame, ENT_COMPAT, 'utf-8')))) {
                                    echo "SELECTED";
                                } ?>>REDONDEO HACIA ABAJO</option>
                    <option value="2" 
					<?php if (!(strcmp(2, htmlentities($redondeo_ame, ENT_COMPAT, 'utf-8')))) {
                                    echo "SELECTED";
                ...
                <tr valign="baseline">
                  ...
                  <td colspan="2" align="left" valign="top">
                  <a href='hipodromos_agen.php?recordID=<?php echo $xCodigo; ?>'class="btn btn-info"
                style="height:25px; width:100px; font-size:12px; text-decoration:none; color:#000;">HIPÓDROMOS</a>                
                  </td>
