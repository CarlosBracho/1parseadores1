...
$query_Recordset12 = sprintf("/* PARSEADORES1 ventashnac_mie\ventas_ver_ultimo.php - QUERY 1 */ SELECT ticket_hnac FROM venta_hnac WHERE id_usuario = %s AND fec_venta_hnac = %s AND est_ticket_hnac >= 0 AND est_ticket_hnac <= 1
...
$query_Recordset11 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\ventas_ver_ultimo.php - QUERY 2 */ SELECT 
