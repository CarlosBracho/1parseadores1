...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\ventas_configurar_ticket.php - QUERY 1 */ SELECT taquilla_opc_hnac.tip_ticket_hnac, taquilla_opc_hnac.lar_ticket_hnac, 
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    $updateSQL = sprintf(
        "/* PARSEADORES1 ventashnac_mie\ventas_configurar_ticket.php - QUERY 2 */ UPDATE taquilla_opc_hnac 
			SET 
