...
if ($nomb=="") {
    $query_Recordset3 = sprintf("/* PARSEADORES1 ventashnac_mie\ventas_reporte_jugadas_hnac.php - QUERY 1 */ SELECT nom_usuario FROM usuario WHERE usuario.id_usuario = %s AND tip_usuario='U' 
	LIMIT 1", GetSQLValueString($codigoUsuario, "int"));
    $Recordset3 = mysqli_query($conexionbanca, $query_Recordset3) or die(mysqli_error($conexionbanca));
    $row_Recordset3 = mysqli_fetch_assoc($Recordset3);
    $nomb=strtoupper($row_Recordset3['nom_usuario']);
}
$query_Recordset2 = sprintf("/* PARSEADORES1 ventashnac_mie\ventas_reporte_jugadas_hnac.php - QUERY 2 */ SELECT usuario.nom_usuario, usuario.id_usuario, taquilla.nom_taquilla FROM usuario, taquilla 
