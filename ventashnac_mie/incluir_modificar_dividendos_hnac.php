...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && isset($_POST['fecha_inicio'])) {
    ...
    $query_Recordset10 = sprintf(
        "/* PARSEADORES1 ventashnac_mie\incluir_modificar_dividendos_hnac.php - QUERY 1 */ SELECT 
		ca.cod_carrera_hnac, 
    ...
    $query_Recordset10 = sprintf(
        "/* PARSEADORES1 ventashnac_mie\incluir_modificar_dividendos_hnac.php - QUERY 2 */ SELECT 
		ca.cod_carrera_hnac, 
		ca.can_caballos_hnac, 
		ca.num_carrera_hnac,
		ca.hor_carrera_hnac,
...
if ((isset($_POST["MM_update2"]))) {
    ...
    if ($add_Edit1==0 && $_POST["eje1_c".$j]!="" && $_POST["div1g_c".$j]!="" && $_POST["eje1_c".$j]>0 && $_POST["div1g_c".$j]>0) {
        ...
        $insertSQL = sprintf(
            "/* PARSEADORES1 ventashnac_mie\incluir_modificar_dividendos_hnac.php - QUERY 3 */ INSERT INTO resultados_hnac (
			fec_resultado_hnac, 
			cod_carrera_hnac, 
			num_caballo_hnac, 
			div_pago_hnac, 
    ...
    if ($add_Edit3==0) {
        if ($_POST["eje2_c".$j]!="" && $_POST["eje2_c".$j]>0 && $_POST["div2g_c".$j]!="" && $_POST["div2g_c".$j]>0) {
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 ventashnac_mie\incluir_modificar_dividendos_hnac.php - QUERY 4 */ INSERT INTO resultados_hnac (
				fec_resultado_hnac, 
				cod_carrera_hnac, 
				num_caballo_hnac, 
				div_pago_hnac, 
    ...
    if ($add_Edit1==1 && $_POST["codResul1".$j]!=0 && $_POST["mod_divid_hnac"]==1 && $_POST["eje1_c".$j]!="" && $_POST["div1g_c".$j]!="" && $_POST["eje1_c".$j]>0 && $_POST["div1g_c".$j]>0) {
        ...
        $_POST["eje1_c".$j]=$_POST["eje1_c".$j]*1;
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 ventashnac_mie\incluir_modificar_dividendos_hnac.php - QUERY 5 */ UPDATE resultados_hnac 
				SET 
				num_caballo_hnac=%s, 
				div_pago_hnac=%s 
    ...
    if ($add_Edit3==1 && $_POST["codResul3".$j]!=0 && $_POST["mod_divid_hnac"]==1) {
        if ($_POST["eje2_c".$j]!="" && $_POST["eje2_c".$j]>0 && $_POST["div2g_c".$j]!="" && $_POST["div2g_c".$j]>0) {
            ...
            $_POST["eje2_c".$j]=$_POST["eje2_c".$j]*1;
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 ventashnac_mie\incluir_modificar_dividendos_hnac.php - QUERY 6 */ UPDATE resultados_hnac 
					SET 
					num_caballo_hnac=%s, 
					div_pago_hnac=%s 
					WHERE cod_resultado_hnac=%s",
    ...
    if ($calc==1) {
        ...
        $query_Recordset1 = sprintf(
            "/* PARSEADORES1 ventashnac_mie\incluir_modificar_dividendos_hnac.php - QUERY 7 */ SELECT 
        ...
        if ($totalRows_Recordset1>0) {
            ...
            $montoapagar=0;
            $query_Recordset13 = sprintf("/* PARSEADORES1 ventashnac_mie\incluir_modificar_dividendos_hnac.php - QUERY 8 */ SELECT num_caballo_hnac FROM resultados_hnac WHERE 
            ...
            if ($totalRows_Recordset13>0) {
                ...
                do {
                    $updateSQL3 = sprintf(
                        "/* PARSEADORES1 ventashnac_mie\incluir_modificar_dividendos_hnac.php - QUERY 9 */ UPDATE venta_hnac 
...
$query_Recordset16 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\incluir_modificar_dividendos_hnac.php - QUERY 10 */ SELECT 
