...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1") {
    ...
    $query_Recordset7 = sprintf(
        "/* PARSEADORES1 ventashnac_mie\incluir_modificar_preciofijo_hnac22.php - QUERY 1 */ SELECT
    ...
    $query_Recordset11 = sprintf(
        "/* PARSEADORES1 ventashnac_mie\incluir_modificar_preciofijo_hnac22.php - QUERY 2 */ SELECT 
		max_eje_hnac,
		max_jugtic_hnac,
		min_jugtic_hnac 
		FROM 
    ...
    if ($graba==30) {
        ...
        $insertSQL = sprintf(
            "/* PARSEADORES1 ventashnac_mie\incluir_modificar_preciofijo_hnac22.php - QUERY 3 */ INSERT INTO precio_fijo_hnac (
				fec_carrera_hnac, 
				cod_carrera_hnac, 
				cod_inscrito_hnac, 
				cod_taquilla, 
...
$query_Recordset10 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\incluir_modificar_preciofijo_hnac22.php - QUERY 4 */ SELECT 
	ca.cod_carrera_hnac, 
