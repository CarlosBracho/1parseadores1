...
function ObtenerMontoEjeTaq($codT, $fecV, $numE, $codC, $codA)
{
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 1 */ SELECT SUM(mon_venta_hnac) AS total FROM venta_hnac 
	WHERE 
	cod_taquilla = %s AND
...
if(isset($_SESSION['Hora'])){
    ...
    $query_Recordset180 = sprintf(
        "/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 2 */ SELECT  mon_venta_hnac
        FROM venta_hnac
    WHERE 
...
$query_Recordset180D = sprintf(
    "/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 3 */ SELECT  tp.limit_ticket, us.cod_taquilla
...
$query_Recordset6 = sprintf("/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 4 */ SELECT 
...
$query_Recordset4 = "/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 5 */ SELECT * FROM mensaje WHERE cod_mensaje = 1";
...
$query_Recordset44 = sprintf("/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 6 */ SELECT 
	me.mensaje
...
$query_Recordset7 = sprintf("/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 7 */ SELECT * FROM ctrol_ventpag_global_hnac WHERE cod_ctrol_ventpag_global_hnac = 1");
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1" && isset($_POST["cod_carrera"]) && $_POST["cod_carrera"]!=-1 && $est_control_ventas==0) {
    ...
    $maxCa="";
    $numerotiket2="";
    $query_Recordset1 = sprintf("/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 8 */ SELECT can_caballos_hnac, hor_carrera_hnac, fec_carrera_hnac, est_carrera_hnac, pau_ventas_hnac
...
if($apta==$_SESSION['Ejemplar'] && $monto[$f]==$_SESSION['Monto'] && $_POST['cod_carrera']==$_SESSION['Carrera'] && $_POST['efectivoOn']==$_SESSION['Tipomoneda'] && $timeticket > $horaTxt){
    ...
    $permisos=0;
                ...
                $insertSQL = sprintf(
                    "/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 9 */ INSERT INTO venta_hnac (ser_venta_hnac, ticket_hnac, fec_venta_hnac, 
    ...
    $_SESSION['Tipomoneda']=$_POST['efectivoOn'];
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 10 */ INSERT INTO venta_hnac (ser_venta_hnac, ticket_hnac, fec_venta_hnac, 
                hor_venta_hnac, cod_tventa_hnac, num_caballo_hnac, mon_venta_hnac, cod_carrera_hnac, id_usuario, est_ticket_hnac,
                can_ticket_hnac, ip_venta_hnac, lin_ticket_hnac, efectivoOn) 
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($serial, "text"),
...
$query_Recordset15 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 11 */ SELECT ta.est_taquilla, tn.puedecerrar
		FROM 
			usuario us, 
			taquilla ta, 
			taquilla_opc_ame tp, 
...
$query_Recordset5 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 12 */ SELECT 
	ta.nom_taquilla,
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 13 */ SELECT
...
$query_Recordset51 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\index_datos.php - QUERY 14 */ SELECT 
	CONCAT(hi.nom_hipodromo_hnac, ' Carr...', ca.num_carrera_hnac) AS carrera,
	ca.cod_carrera_hnac,
	ca.num_carrera_hnac
	FROM 
