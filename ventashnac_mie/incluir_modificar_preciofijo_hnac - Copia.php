...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1") {
    ...
    $query_Recordset7 = sprintf(
        "/* PARSEADORES1 ventashnac_mie\incluir_modificar_preciofijo_hnac - Copia.php - QUERY 1 */ SELECT
    ...
    if ($graba==30) {
        ...
        $insertSQL = sprintf(
            "/* PARSEADORES1 ventashnac_mie\incluir_modificar_preciofijo_hnac - Copia.php - QUERY 2 */ INSERT INTO precio_fijo_hnac (
				fec_carrera_hnac, 
				cod_carrera_hnac, 
				cod_inscrito_hnac, 
				cod_taquilla, 
...
$query_Recordset10 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\incluir_modificar_preciofijo_hnac - Copia.php - QUERY 3 */ SELECT 
