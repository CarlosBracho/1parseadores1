...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\pag_tic_sincodigo_hnac.php - QUERY 1 */ SELECT tp.tic_caduca_hnac, us.id_usuario, ve.ticket_hnac, ve.ser_venta_hnac, 
...
$query_Recordset2 = sprintf("/* PARSEADORES1 ventashnac_mie\pag_tic_sincodigo_hnac.php - QUERY 2 */ SELECT tp.pag_codigo_hnac FROM taquilla_opc_hnac tp, usuario us
...
$query_Recordset7 = sprintf("/* PARSEADORES1 ventashnac_mie\pag_tic_sincodigo_hnac.php - QUERY 3 */ SELECT est_control_pagos_hnac FROM ctrol_ventpag_global_hnac WHERE cod_ctrol_ventpag_global_hnac =1");
