...
function ObtenerMontoEjeTaq($codT, $fecV, $numE, $codC, $codA)
{
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 1 */ SELECT SUM(mon_venta_hnac) AS total FROM venta_hnac 
	WHERE 
	cod_taquilla = %s AND
...
if(isset($_SESSION['Hora'])){
    ...
    $query_Recordset180 = sprintf(
        "/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 2 */ SELECT  mon_venta_hnac
        FROM venta_hnac
    WHERE 
    id_usuario=%s ORDER BY num_ticket_hnac DESC LIMIT 1 ",
...
$query_Recordset180D = sprintf(
    "/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 3 */ SELECT  tp.limit_ticket, us.cod_taquilla
    FROM taquilla_opc_hnac tp, usuario us
WHERE 
...
$query_Recordset6 = sprintf("/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 4 */ SELECT 
	tn.est_taquilla_hnac, tp.est_venta_ame, ta.tra_codigo, ta.moneda, ta.saldoactual, ta.tipotaquilla, ta.tipo_pago, ta.cod_agencia, ag.tipo_pagoa, us.hor_inicio, us.hor_fin, us.24hr 
...
$query_Recordset4 = "/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 5 */ SELECT * FROM mensaje WHERE cod_mensaje = 1";
...
$query_Recordset44 = sprintf("/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 6 */ SELECT 
	me.mensaje
...
$query_Recordset7 = sprintf("/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 7 */ SELECT * FROM ctrol_ventpag_global_hnac WHERE cod_ctrol_ventpag_global_hnac = 1");
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1" && isset($_POST["cod_carrera"]) && $_POST["cod_carrera"]!=-1 && $est_control_ventas==0) {
    ...
    $maxCa="";
    $numerotiket2="";
    $query_Recordset1 = sprintf("/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 8 */ SELECT can_caballos_hnac, hor_carrera_hnac, fec_carrera_hnac, est_carrera_hnac, pau_ventas_hnac
...
//****************************************************************************************************************************
  ...
  //Ingreso de ticket              
                if(isset($_SESSION['Carrera'])){
                    $permisos=1;
if($apta==$_SESSION['Ejemplar'] && $monto[$f]==$_SESSION['Monto'] && $_POST['cod_carrera']==$_SESSION['Carrera'] && $_POST['efectivoOn']==$_SESSION['Tipomoneda'] && $timeticket > $horaTxt){
   
    $permisos=0;

                    }else{
                $insertSQL = sprintf(
                    "/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 9 */ INSERT INTO venta_hnac (ser_venta_hnac, ticket_hnac, fec_venta_hnac, 
            ...
            $insertGoTo = "t_imprimeticketP.php?recordID=$numerotiket2&uVenta=$usuarioVenta&xIndex=$xindex";
            if (isset($_SERVER['QUERY_STRING'])) {
    ...
    $_SESSION['Tipomoneda']=$_POST['efectivoOn'];

}}else{

            $insertSQL = sprintf(
                "/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 10 */ INSERT INTO venta_hnac (ser_venta_hnac, ticket_hnac, fec_venta_hnac, 
                hor_venta_hnac, cod_tventa_hnac, num_caballo_hnac, mon_venta_hnac, cod_carrera_hnac, id_usuario, est_ticket_hnac,
                can_ticket_hnac, ip_venta_hnac, lin_ticket_hnac, efectivoOn) 
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($serial, "text"),
...
$_SESSION['Tipomoneda']=$_POST['efectivoOn'];
    ...
    /*/if (isset($Mensajeticket) && $Mensajeticket==1) {
        $iR=1;
        $_SESSION['MM_mensaje3']="Ticket posiblemente duplicado porfavor esperar 15 segundos para realizarlo";
    }/*/
...
$query_Recordset15 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 11 */ SELECT ta.est_taquilla, tn.puedecerrar
		FROM 
			usuario us, 
			taquilla ta, 
			taquilla_opc_ame tp, 
...
$query_Recordset5 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 12 */ SELECT 
	ta.nom_taquilla,
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 13 */ SELECT
...
$query_Recordset51 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\index_datos2.php - QUERY 14 */ SELECT 
	CONCAT(hi.nom_hipodromo_hnac, ' Carr...', ca.num_carrera_hnac) AS carrera,
	ca.cod_carrera_hnac,
	ca.num_carrera_hnac
	FROM 
