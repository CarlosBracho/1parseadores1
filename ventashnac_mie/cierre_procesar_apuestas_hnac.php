...
$query_Recordset8 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\cierre_procesar_apuestas_hnac.php - QUERY 1 */ SELECT cod_taquilla
	FROM usuario 
...
if ($totalRows_Recordset8>0 && isset($_POST["idUs"]) && isset($_POST["idCa"])) {
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 ventashnac_mie\cierre_procesar_apuestas_hnac.php - QUERY 2 */ SELECT 
    ...
    if ($totalRows_Recordset1>0) {
        $montoapagar=0;
        $query_Recordset13 = sprintf("/* PARSEADORES1 ventashnac_mie\cierre_procesar_apuestas_hnac.php - QUERY 3 */ SELECT num_caballo_hnac FROM resultados_oficiales_hnac WHERE 
        ...
        if ($totalRows_Recordset13>0) {
            ...
            do {
                $updateSQL = sprintf(
                    "/* PARSEADORES1 ventashnac_mie\cierre_procesar_apuestas_hnac.php - QUERY 4 */ UPDATE venta_hnac 
