...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\pag_tic_hnac.php - QUERY 1 */ SELECT tp.tic_caduca_hnac, us.id_usuario, ve.ticket_hnac, ve.ser_venta_hnac, 
...
$query_Recordset2 = sprintf("/* PARSEADORES1 ventashnac_mie\pag_tic_hnac.php - QUERY 2 */ SELECT tp.pag_codigo_hnac FROM taquilla_opc_hnac tp, usuario us
...
$query_Recordset7 = sprintf("/* PARSEADORES1 ventashnac_mie\pag_tic_hnac.php - QUERY 3 */ SELECT est_control_pagos_hnac FROM ctrol_ventpag_global_hnac WHERE cod_ctrol_ventpag_global_hnac =1");
                    ...
                    if ($total==0) {
                        ...
                        if (($pre>0 || $rT>0) && $diasTrancurridos<=$tic_caduca) {
							...
							<tr onmouseover="cOver(this)" onmouseout="cOut(this)" style="font-size:14px">
							  <td height="34" align="right" valign="middle" style="font-size:16px"><?php echo $rest2; ?></td>
                            ...
                            if ($diasTrancurridos>$tic_caduca) {
							  ...
							  <td align="center" valign="middle">
                                  ...
                                  if ((($rT>=1 && $row_Recordset1['est_carrera_hnac']==1) ||
									...
									value="Procesar pago" 
		onclick="location.href = '../ventashnac_mie/ventas_pagar_apuestas_procesar_hnac_cod.php?pagoSIN=<?php echo $rest;?>&uVenta=<?php echo $row_Recordset1['id_usuario'];?>'"/>
