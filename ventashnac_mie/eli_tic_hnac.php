...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\eli_tic_hnac.php - QUERY 1 */ SELECT 
ve.ticket_hnac,
ve.hor_venta_hnac,
ve.ser_venta_hnac,
ve.fec_venta_hnac,
        ...
        if ($totalRows_Recordset1>0) {?>
            <div style="width:100%; float:left; padding:0px 0px 0px 0px; color:#000; font-size:20px; text-align: left">
				...
				<tr style="background:#333; color:#FFF">
                    <td width="18%" align="center">Numero de Ticket</td>
                ...
                $x1=0;
                do {
                    $carrera=$row_Recordset1['nom_hipodromo_hnac']." Carr..".$row_Recordset1['num_carrera_hnac']." (E:".$row_Recordset1['num_caballo_hnac']."/GAN:".$row_Recordset1['mon_venta_hnac'].")";
					...
					<tr onmouseover="cOver(this)" onmouseout="cOut(this)" style="font-size:14px">
					  ...
					  <td align="center" valign="middle">
                        ...
                        value="Eliminar"
onclick="location.href = '../ventashnac_mie/ventas_eliminar_ticket_hnac_cod.php?pagoSIN=<?php echo $rest; ?>&uVenta=<?php echo $row_Recordset1['id_usuario']; ?>'"/>
                      </td>
			  		</tr><?php
                        $x1++;
