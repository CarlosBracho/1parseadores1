 ...
 <tr>
          ...
          <tr align="center">
            <th colspan="4" class="imprimir" scope="col"><?php echo $row_Recordset1['nom_taquilla']; ?>-COPI3-#:<?php echo $row_Recordset1['can_ticket_hnac']; ?>
</th>
          </tr>
          <tr>
            <td colspan="4" align="center" class="imprimir"><?php echo fechanueva($row_Recordset1['fec_venta_hnac']); ?>-<?php echo horaampm($row_Recordset1['hor_venta_hnac']); ?></td>
          </tr>
          <tr>
