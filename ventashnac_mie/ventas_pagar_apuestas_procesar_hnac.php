...
$query_Recordset7 = sprintf("/* PARSEADORES1 ventashnac_mie\ventas_pagar_apuestas_procesar_hnac.php - QUERY 1 */ SELECT est_control_pagos_hnac FROM ctrol_ventpag_global_hnac WHERE cod_ctrol_ventpag_global_hnac =1");
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\ventas_pagar_apuestas_procesar_hnac.php - QUERY 2 */ SELECT venta_hnac.est_ticket_hnac, venta_hnac.ser_venta_hnac 
...
if ($totalRows_Recordset2==0 && $est_control_pagos_hnac==0) {
    $query_Recordset8 = sprintf(
        "/* PARSEADORES1 ventashnac_mie\ventas_pagar_apuestas_procesar_hnac.php - QUERY 3 */ SELECT cod_taquilla
								 FROM usuario 
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 ventashnac_mie\ventas_pagar_apuestas_procesar_hnac.php - QUERY 4 */ SELECT 
    ...
    if ((($totalRows_Recordset1>0 && $row_Recordset1['est_carrera_hnac']==0 && $xserDB==$xserTic &&
     ...
     $row_Recordset1['est_ticket_hnac']==1) && $pau_ventas_hnac==0) {
        ...
        if ($defi_regla==0) {
            $query_Recordset13 = sprintf("/* PARSEADORES1 ventashnac_mie\ventas_pagar_apuestas_procesar_hnac.php - QUERY 5 */ SELECT num_caballo_hnac FROM resultados_hnac WHERE 
			cod_carrera_hnac = %s", GetSQLValueString($xCarrera, "int"));
        } else {
            $query_Recordset13 = sprintf("/* PARSEADORES1 ventashnac_mie\ventas_pagar_apuestas_procesar_hnac.php - QUERY 6 */ SELECT num_caballo_hnac FROM resultados_oficiales_hnac WHERE 
			cod_carrera_hnac = %s", GetSQLValueString($xCarrera, "int"));
        }
        ...
        if ($totalRows_Recordset13>0 || $row_Recordset1['est_cierre_hnac']==0 || $rT>0) {
            ...
            if ($montoapagar>0) {
                do {
                    $updateSQL = sprintf(
                        "/* PARSEADORES1 ventashnac_mie\ventas_pagar_apuestas_procesar_hnac.php - QUERY 7 */ UPDATE venta_hnac 
