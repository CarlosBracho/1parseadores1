...
function ObtenerMontoEjeTaq($codT, $fecV, $numE, $codC, $codA)
{
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 ventashnac_mie\t_grabajugadahipicotickethn.php - QUERY 1 */ SELECT SUM(mon_venta_hnac) AS total FROM venta_hnac 
	WHERE 
	cod_taquilla = %s AND
...
$query_Recordset6 = sprintf("/* PARSEADORES1 ventashnac_mie\t_grabajugadahipicotickethn.php - QUERY 2 */ SELECT 
...
$query_Recordset4 = "/* PARSEADORES1 ventashnac_mie\t_grabajugadahipicotickethn.php - QUERY 3 */ SELECT * FROM mensaje WHERE cod_mensaje = 1";
...
$query_Recordset44 = sprintf("/* PARSEADORES1 ventashnac_mie\t_grabajugadahipicotickethn.php - QUERY 4 */ SELECT 
	me.mensaje
...
$query_Recordset7 = sprintf("/* PARSEADORES1 ventashnac_mie\t_grabajugadahipicotickethn.php - QUERY 5 */ SELECT * FROM ctrol_ventpag_global_hnac WHERE cod_ctrol_ventpag_global_hnac = 1");
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1" && isset($_POST["cod_carrera"]) && $_POST["cod_carrera"]!=-1 && $est_control_ventas==0) {
    ...
    $maxCa="";
    $numerotiket2="";
    $query_Recordset1 = sprintf("/* PARSEADORES1 ventashnac_mie\t_grabajugadahipicotickethn.php - QUERY 6 */ SELECT can_caballos_hnac, hor_carrera_hnac, fec_carrera_hnac, est_carrera_hnac, pau_ventas_hnac
    ...
    if ($exito==1 && $maxCa!=1 && $pau_ventas==0) {// guarda e imprime ticket
        ...
        if ($valida==1 && !isset($CRet1) && !isset($CRet2) && !isset($CRet3) && !isset($CRet4) && !isset($CRet5) &&
            ...
            foreach ($apuesta as $apta) {
                ...
                $insertSQL = sprintf(
                    "/* PARSEADORES1 ventashnac_mie\t_grabajugadahipicotickethn.php - QUERY 7 */ INSERT INTO venta_hnac (ser_venta_hnac, ticket_hnac, fec_venta_hnac, 
...
$query_Recordset15 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\t_grabajugadahipicotickethn.php - QUERY 8 */ SELECT ta.est_taquilla, tn.puedecerrar
		FROM 
			usuario us, 
			taquilla ta, 
			taquilla_opc_ame tp, 
...
$query_Recordset5 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\t_grabajugadahipicotickethn.php - QUERY 9 */ SELECT 
	ta.nom_taquilla,
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\t_grabajugadahipicotickethn.php - QUERY 10 */ SELECT
...
$query_Recordset51 = sprintf(
    "/* PARSEADORES1 ventashnac_mie\t_grabajugadahipicotickethn.php - QUERY 11 */ SELECT 
	CONCAT(hi.nom_hipodromo_hnac, ' Carr...', ca.num_carrera_hnac) AS carrera,
	ca.cod_carrera_hnac,
	ca.num_carrera_hnac
	FROM 
