...
class Stoper
{
     ...
     * @var int
     */
    public $intComputPrecision;

    /**
     * output precision
     * @var int
     */
    public $intOutputPrecision;
     ...
     * @return void
     */
    public function Stoper($intComputPrecision = 6, $intOutputPrecision = 4)
    {
     ...
     * @return void
     */
    public function setComputPrecision($intValue)
    {
        if ($intValue < 0) {
            $intValue = 6;
        }
     ...
     * @return void
     */
    public function setOutputPrecision($intValue)
    {
        if ($intValue < 0) {
            $intValue = 4;
        }
    ...
    */
    ...
    public function MidTimeRestart()
    {
    ...
    public function showResult($strDescription = '')
    {
    ...
    */
    ...
    public function AdvCheckPoint($strName)
    {
    ...
    public function saveAdvResults($fileName = '')
    {
        $out = '';
        $startTime = $this->arrResults[0]['timestamp'];
        $resNumber = sizeof($this->arrResults);
