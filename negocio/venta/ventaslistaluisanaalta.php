...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistaluisanaalta.php - QUERY 1 */ SELECT 
...
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistaluisanaalta.php - QUERY 2 */ SELECT 
inventarioydemas.id_documentoinventarioydemas,
inventarioydemas.cantidad, 
inventarioydemas.valor, 
inventarioydemas.hora,
...
AND inventarioydemas.id_usuarioreninventario = 25
...
$tVta21=$PRECIOXCANTIDAD21;
 ...
 $tVta121 += $tVta21;?>
	  ...
	  TOTAL VENTAS:. <strong><?php echo number_format($tVta121, 2, ",", "."); ?></strong></td>
        ...
        echo "Ganancia de luisanaalta por las ventas ....";
        ...
        echo "<br/>";
        echo "Anotes de luisanaalta ....";
        $anotesdeluisanaalta=number_format($tVta121, 2, ",", ".");
        $anotesdeluisanaalta = trim(str_replace(".", "", $anotesdeluisanaalta));
        
        echo $anotesdeluisanaalta;
                echo "&nbsp;Bss";

        echo "<br/>";
        $totalapagaraluisanaalta=$terceraparte-$anotesdeluisanaalta ;
        echo "Total a pagar a luisanaalta ....";
        echo $totalapagaraluisanaalta;
                echo "&nbsp;Bss";
