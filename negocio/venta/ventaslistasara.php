...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistasara.php - QUERY 1 */ SELECT 
...
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistasara.php - QUERY 2 */ SELECT 
inventarioydemas.id_documentoinventarioydemas,
inventarioydemas.cantidad, 
inventarioydemas.valor, 
inventarioydemas.hora,
...
AND inventarioydemas.id_usuarioreninventario = 10
...
$tVta21=$PRECIOXCANTIDAD21;
 ...
 $tVta121 += $tVta21;?>
	  ...
	  TOTAL VENTAS:. <strong><?php echo number_format($tVta121, 2, ",", "."); ?></strong></td>
        ...
        echo "Ganancia de sara por las ventas ....";
        ...
        echo "<br/>";
        echo "Anotes de sara ....";
        $anotesdesara=number_format($tVta121, 2, ",", ".");
        $anotesdesara = trim(str_replace(".", "", $anotesdesara));
        
        echo $anotesdesara;
                echo "&nbsp;Bss";

        echo "<br/>";
        $totalapagarasara=$terceraparte-$anotesdesara ;
        echo "Total a pagar a sara ....";
        echo $totalapagarasara;
                echo "&nbsp;Bss";
