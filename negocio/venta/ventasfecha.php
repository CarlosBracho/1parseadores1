...
$x=0;
    ...
    $query_Recordset4 = sprintf('/* PARSEADORES1 negocio\venta\ventasfecha.php - QUERY 1 */ SELECT 
  ...
  <div class="panel panel-primary">
    <div class="panel-heading">Selecciones Rango De Fecha A Consultar</div>
      <div class="panel-body">
                   <form action="ventaslista.php" method="GET" name="form1" id="form1" autocomplete="off"  
