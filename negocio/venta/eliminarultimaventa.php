...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 negocio\venta\eliminarultimaventa.php - QUERY 1 */ SELECT 
...
if ($totalRows_Recordset2>0) {
    do {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\eliminarultimaventa.php - QUERY 2 */ UPDATE inventarioydemas 
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\eliminarultimaventa.php - QUERY 3 */ UPDATE inventarionegocios 
