...
if ($usuario == -1) {
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 negocio\venta\ventaslista.php - QUERY 1 */ SELECT 
...
ASC",
    ...
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 negocio\venta\ventaslista.php - QUERY 2 */ SELECT 
inventarioydemas.id_documentoinventarioydemas,
inventarioydemas.cantidad, 
inventarioydemas.valor, 
inventarioydemas.hora,
...
<div class="container">
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
	...
	<table width="100%" border="1" align="center" border="4" >
	  ...
	  TOTAL VENTAS:. <strong><?php echo number_format($tVta1, 2, ",", "."); ?></strong></td>
	      ...
	      <?php }?>  
                            ...
                            <div id="recargar" style="padding:10px 0px 0px 0px;float:Center; width:580px">
                                <input type="button" onclick="window.location='ventasfecha.php';"
