...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistayorlieth.php - QUERY 1 */ SELECT 
...
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistayorlieth.php - QUERY 2 */ SELECT 
inventarioydemas.id_documentoinventarioydemas,
inventarioydemas.cantidad, 
inventarioydemas.valor, 
inventarioydemas.hora,
...
AND inventarioydemas.id_usuarioreninventario = 9
...
$tVta21=$PRECIOXCANTIDAD21;
 ...
 $tVta121 += $tVta21;?>
	  ...
	  TOTAL VENTAS:. <strong><?php echo number_format($tVta121, 2, ",", "."); ?></strong></td>
        ...
        echo "Ganancia de yorlieth por las ventas ....";
        $terceraparte=$totalventas/100;
        ...
        echo "<br/>";
        echo "Anotes de yorlieth ....";
        $anotesdeyorlieth=number_format($tVta121, 2, ",", ".");
        $anotesdeyorlieth = trim(str_replace(".", "", $anotesdeyorlieth));
        
        echo $anotesdeyorlieth;
                echo "&nbsp;Bss";

        echo "<br/>";
        $totalapagarayorlieth=$terceraparte-$anotesdeyorlieth ;
        echo "Total a pagar a yorlieth ....";
        echo $totalapagarayorlieth;
                echo "&nbsp;Bss";
