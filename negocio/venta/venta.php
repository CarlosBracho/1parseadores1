...
//echo $nuevahora1;
    ...
    $query_Recordset12 = sprintf('/* PARSEADORES1 negocio\venta\venta.php - QUERY 1 */ SELECT 
...
}	$query_Recordset2 = sprintf('/* PARSEADORES1 negocio\venta\venta.php - QUERY 2 */ SELECT 
...
$ultimaventa=$row_Recordset2['id_documentoinventarioydemas']+1;
    $query_Recordset3 = sprintf('/* PARSEADORES1 negocio\venta\venta.php - QUERY 3 */ SELECT 
...
if ($totalRows_Recordset3>0) {
    ...
    $query_Recordset4 = sprintf('/* PARSEADORES1 negocio\venta\venta.php - QUERY 4 */ SELECT 
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1") {
    if ($_POST['id_prox']>0 &&  $_POST['cantidad']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 5 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, 
	id_usuarioreninventario, id_negocio, valor, costo, fecha, hora
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 6 */ UPDATE producto 
										   SET precio_actual= %s
											   WHERE Id_producto = %s",
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 7 */ UPDATE inventarionegocios 
    ...
    if ($_POST['id_prox1']>0 &&  $_POST['cantidad1']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 8 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, 
	id_usuarioreninventario, id_negocio, valor, costo, fecha, hora
					 ) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimaventa, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 9 */ UPDATE producto 
										   SET precio_actual= %s
											   WHERE Id_producto = %s",
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 10 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios-%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
            GetSQLValueString($_POST['cantidad1'], "int"),
            GetSQLValueString($_POST['id_prox1'], "int")
    ...
    if ($_POST['id_prox2']>0 &&  $_POST['cantidad2']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 11 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, 
	id_usuarioreninventario, id_negocio, valor, costo, fecha, hora
					 ) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimaventa, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 12 */ UPDATE producto 
										   SET precio_actual= %s
											   WHERE Id_producto = %s",
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 13 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios-%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
            GetSQLValueString($_POST['cantidad2'], "int"),
            GetSQLValueString($_POST['id_prox2'], "int")
    ...
    if ($_POST['id_prox3']>0 &&  $_POST['cantidad3']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 14 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, 
	id_usuarioreninventario, id_negocio, valor, costo, fecha, hora
					 ) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimaventa, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 15 */ UPDATE producto 
										   SET precio_actual= %s
											   WHERE Id_producto = %s",
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 16 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios-%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
            GetSQLValueString($_POST['cantidad3'], "int"),
            GetSQLValueString($_POST['id_prox3'], "int")
    ...
    if ($_POST['id_prox4']>0 &&  $_POST['cantidad4']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 17 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, 
	id_usuarioreninventario, id_negocio, valor, costo, fecha, hora
					 ) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimaventa, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 18 */ UPDATE producto 
										   SET precio_actual= %s
											   WHERE Id_producto = %s",
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 19 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios-%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
            GetSQLValueString($_POST['cantidad4'], "int"),
            GetSQLValueString($_POST['id_prox4'], "int")
    ...
    if ($_POST['id_prox5']>0 &&  $_POST['cantidad5']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 20 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, 
	id_usuarioreninventario, id_negocio, valor, costo, fecha, hora
					 ) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimaventa, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 21 */ UPDATE producto 
										   SET precio_actual= %s
											   WHERE Id_producto = %s",
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 22 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios-%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
            GetSQLValueString($_POST['cantidad5'], "int"),
            GetSQLValueString($_POST['id_prox5'], "int")
    ...
    if ($_POST['id_prox6']>0 &&  $_POST['cantidad6']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 23 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, 
	id_usuarioreninventario, id_negocio, valor, costo, fecha, hora
					 ) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimaventa, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 24 */ UPDATE producto 
										   SET precio_actual= %s
											   WHERE Id_producto = %s",
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 25 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios-%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
            GetSQLValueString($_POST['cantidad6'], "int"),
            GetSQLValueString($_POST['id_prox6'], "int")
    ...
    if ($_POST['id_prox7']>0 &&  $_POST['cantidad7']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 26 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, 
	id_usuarioreninventario, id_negocio, valor, costo, fecha, hora
					 ) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimaventa, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 27 */ UPDATE producto 
										   SET precio_actual= %s
											   WHERE Id_producto = %s",
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 28 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios-%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
            GetSQLValueString($_POST['cantidad7'], "int"),
            GetSQLValueString($_POST['id_prox7'], "int")
    ...
    if ($_POST['id_prox8']>0 &&  $_POST['cantidad8']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 29 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, 
	id_usuarioreninventario, id_negocio, valor, costo, fecha, hora
					 ) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimaventa, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 30 */ UPDATE producto 
										   SET precio_actual= %s
											   WHERE Id_producto = %s",
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 31 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios-%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
            GetSQLValueString($_POST['cantidad8'], "int"),
            GetSQLValueString($_POST['id_prox8'], "int")
    ...
    if ($_POST['id_prox9']>0 &&  $_POST['cantidad9']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 32 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, 
	id_usuarioreninventario, id_negocio, valor, costo, fecha, hora
					 ) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimaventa, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 33 */ UPDATE producto 
										   SET precio_actual= %s
											   WHERE Id_producto = %s",
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 34 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios-%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
            GetSQLValueString($_POST['cantidad9'], "int"),
            GetSQLValueString($_POST['id_prox9'], "int")
    ...
    if ($_POST['id_prox10']>0 &&  $_POST['cantidad10']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 35 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, 
	id_usuarioreninventario, id_negocio, valor, costo, fecha, hora
					 ) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimaventa, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 36 */ UPDATE producto 
										   SET precio_actual= %s
											   WHERE Id_producto = %s",
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 37 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios-%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
            GetSQLValueString($_POST['cantidad10'], "int"),
            GetSQLValueString($_POST['id_prox10'], "int")
    ...
    if ($_POST['id_prox11']>0 &&  $_POST['cantidad11']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 38 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, 
	id_usuarioreninventario, id_negocio, valor, costo, fecha, hora
					 ) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimaventa, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 39 */ UPDATE producto 
										   SET precio_actual= %s
											   WHERE Id_producto = %s",
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 40 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios-%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
            GetSQLValueString($_POST['cantidad11'], "int"),
            GetSQLValueString($_POST['id_prox11'], "int")
        ...
        $z=1;
                ...
                $query_Recordset13 = sprintf('/* PARSEADORES1 negocio\venta\venta.php - QUERY 41 */ SELECT 
...
$totalRows_Recordset13 = mysqli_num_rows($Recordset13);
    ...
    do {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\venta\venta.php - QUERY 42 */ UPDATE inventarioydemas 
										   SET valor=%s, costo=%s
