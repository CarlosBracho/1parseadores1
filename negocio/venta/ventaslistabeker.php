...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistabeker.php - QUERY 1 */ SELECT 
...
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistabeker.php - QUERY 2 */ SELECT 
inventarioydemas.id_documentoinventarioydemas,
inventarioydemas.cantidad, 
inventarioydemas.valor, 
inventarioydemas.hora,
...
AND inventarioydemas.id_usuarioreninventario = 21
...
$tVta21=$PRECIOXCANTIDAD21;
 ...
 $tVta121 += $tVta21;?>
	  ...
	  TOTAL VENTAS:. <strong><?php echo number_format($tVta121, 2, ",", "."); ?></strong></td>
        ...
        echo "Ganancia de beker por las ventas ....";
        ...
        echo "<br/>";
        echo "Anotes de beker ....";
        $anotesdebeker=number_format($tVta121, 2, ",", ".");
        $anotesdebeker = trim(str_replace(".", "", $anotesdebeker));
        
        echo $anotesdebeker;
                echo "&nbsp;Bss";

        echo "<br/>";
        $totalapagarabeker=$anotesdebeker ;
        echo "Total a cobrar a beker ....";
        echo $totalapagarabeker;
                echo "&nbsp;Bss";
