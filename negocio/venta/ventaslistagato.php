...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistagato.php - QUERY 1 */ SELECT 
...
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistagato.php - QUERY 2 */ SELECT 
inventarioydemas.id_documentoinventarioydemas,
inventarioydemas.cantidad, 
inventarioydemas.valor, 
inventarioydemas.hora,
...
AND inventarioydemas.id_usuarioreninventario = 20
...
$tVta21=$PRECIOXCANTIDAD21;
 ...
 $tVta121 += $tVta21;?>
	  ...
	  TOTAL VENTAS:. <strong><?php echo number_format($tVta121, 2, ",", "."); ?></strong></td>
        ...
        echo "Ganancia de gato por las ventas ....";
        ...
        echo "<br/>";
        echo "Anotes de gato ....";
        $anotesdegato=number_format($tVta121, 2, ",", ".");
        $anotesdegato = trim(str_replace(".", "", $anotesdegato));
        
        echo $anotesdegato;
                echo "&nbsp;Bss";

        echo "<br/>";
        $totalapagaragato=$terceraparte-$anotesdegato ;
        echo "Total a pagar a gato ....";
        echo $totalapagaragato;
                echo "&nbsp;Bss";
