...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistadaisy.php - QUERY 1 */ SELECT 
...
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistadaisy.php - QUERY 2 */ SELECT 
inventarioydemas.id_documentoinventarioydemas,
inventarioydemas.cantidad, 
inventarioydemas.valor, 
inventarioydemas.hora,
...
AND inventarioydemas.id_usuarioreninventario = 23
...
$tVta21=$PRECIOXCANTIDAD21;
 ...
 $tVta121 += $tVta21;?>
	  ...
	  TOTAL VENTAS:. <strong><?php echo number_format($tVta121, 2, ",", "."); ?></strong></td>
        ...
        echo "Ganancia de daisy por las ventas ....";
        ...
        echo "<br/>";
        echo "Anotes de daisy ....";
        $anotesdedaisy=number_format($tVta121, 2, ",", ".");
        $anotesdedaisy = trim(str_replace(".", "", $anotesdedaisy));
        
        echo $anotesdedaisy;
                echo "&nbsp;Bss";

        echo "<br/>";
        $totalapagaradaisy=$anotesdedaisy ;
        echo "Total a cobrar a daisy ....";
        echo $totalapagaradaisy;
                echo "&nbsp;Bss";
