...
if (isset($_GET['numero'])) {
    ...
    $query_Recordset1 = "/* PARSEADORES1 negocio\venta\ultimaventa.php - QUERY 1 */ SELECT inventarioydemas.id_documentoinventarioydemas
FROM 
inventarioydemas
WHERE
...
inventarioydemas.id_inventarioydemas DESC LIMIT 1";
    ...
    $numero=$row_Recordset1['id_documentoinventarioydemas'];
    $numero1=$row_Recordset1['id_documentoinventarioydemas']-1;
}
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 negocio\venta\ultimaventa.php - QUERY 2 */ SELECT 
...
<body onload="Javascript:history.go(1);" onunload="Javascript:history.go(1);">
                            <div id="recargar" style="padding:10px 0px 0px 0px;float:Center; width:580px">
                                <input type="button" onclick="window.location='ultimaventa.php?numero=<?php echo $numero1;?>';"
                                value="Venta Anteriol" style="width:300px; font-size:20px; height:45px"
                                 title="actualiza página"/>
	...
	<table width="100%" border="0" align="center">
        ...
        <?php do { ?>
		  ...
		  <td align="left"><?php echo $row_Recordset2['id_documentoinventarioydemas']; ?></td>
		  		  <td align="left"><?php echo $row_Recordset2['cantidadinventarionegocios']; ?></td>	
	  ...
	  TOTAL VENTAS:. <strong><?php echo number_format($tVta1, 2, ",", "."); ?></strong></td>
	      <?php }?>  
							...
							<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
							                            <div id="recargar" style="padding:10px 0px 0px 0px;float:Center; width:580px">
                                <input type="button" onclick="window.location='eliminarultimaventa.php?numero=<?php echo $numero;?>';"
                                value="Eliminar Esta Venta" style="width:300px; font-size:20px; height:45px"
