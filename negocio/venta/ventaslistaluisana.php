...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistaluisana.php - QUERY 1 */ SELECT 
...
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 negocio\venta\ventaslistaluisana.php - QUERY 2 */ SELECT 
inventarioydemas.id_documentoinventarioydemas,
inventarioydemas.cantidad, 
inventarioydemas.valor, 
inventarioydemas.hora,
...
AND inventarioydemas.id_usuarioreninventario = 19
...
$tVta21=$PRECIOXCANTIDAD21;
 ...
 $tVta121 += $tVta21;?>
	  ...
	  TOTAL VENTAS:. <strong><?php echo number_format($tVta121, 2, ",", "."); ?></strong></td>
        ...
        echo "Ganancia de luisana por las ventas ....";
        ...
        echo "<br/>";
        echo "Anotes de luisana ....";
        $anotesdeluisana=number_format($tVta121, 2, ",", ".");
        $anotesdeluisana = trim(str_replace(".", "", $anotesdeluisana));
        
        echo $anotesdeluisana;
                echo "&nbsp;Bss";

        echo "<br/>";
        $totalapagaraluisana=$terceraparte-$anotesdeluisana ;
        echo "Total a pagar a luisana ....";
        echo $totalapagaraluisana;
                echo "&nbsp;Bss";
