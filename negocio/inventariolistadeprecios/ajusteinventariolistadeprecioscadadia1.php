...
//echo $nuevahora1;
    ...
    $query_Recordset12 = sprintf('/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 1 */ SELECT 
...
}	$query_Recordset2 = sprintf('/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 2 */ SELECT 
...
$ultimaventa=$row_Recordset2['id_documentoinventarioydemas']+1;
    $query_Recordset3 = sprintf('/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 3 */ SELECT 
...
if ($totalRows_Recordset3>0) {
    ...
    $query_Recordset4 = sprintf('/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 4 */ SELECT 
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1") {
    if ($_POST['id_prox']>0 &&  $_POST['cantidad']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 5 */ UPDATE inventarionegocios 
    ...
    if ($_POST['id_prox1']>0 &&  $_POST['cantidad1']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 6 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
    ...
    if ($_POST['id_prox2']>0 &&  $_POST['cantidad2']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 7 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
    ...
    if ($_POST['id_prox3']>0 &&  $_POST['cantidad3']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 8 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
    ...
    if ($_POST['id_prox4']>0 &&  $_POST['cantidad4']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 9 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
    ...
    if ($_POST['id_prox5']>0 &&  $_POST['cantidad5']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 10 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
    ...
    if ($_POST['id_prox6']>0 &&  $_POST['cantidad6']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 11 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
    ...
    if ($_POST['id_prox7']>0 &&  $_POST['cantidad7']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 12 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
    ...
    if ($_POST['id_prox8']>0 &&  $_POST['cantidad8']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 13 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
    ...
    if ($_POST['id_prox9']>0 &&  $_POST['cantidad9']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 14 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
    ...
    if ($_POST['id_prox10']>0 &&  $_POST['cantidad10']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 15 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
    ...
    if ($_POST['id_prox11']>0 &&  $_POST['cantidad11']>0 && $_POST['local']>1 && $_POST['usuario']>1) {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 16 */ UPDATE inventarionegocios
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_productoinventarionegocios = %s AND id_negocioinventarionegocios = 2",
        ...
        $z=1;
                ...
                $query_Recordset13 = sprintf('/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 17 */ SELECT 
...
$totalRows_Recordset13 = mysqli_num_rows($Recordset13);
    ...
    do {
        $updateSQL = sprintf(
            "/* PARSEADORES1 negocio\inventariolistadeprecios\ajusteinventariolistadeprecioscadadia1.php - QUERY 18 */ UPDATE inventarioydemas 
										   SET valor=%s, costo=%s
...
$p=0;
            if ($z==1) {
                header("Location: ajusteinventariolistadeprecioscadadia1.php");
            } else {
                $p=1;
            }
