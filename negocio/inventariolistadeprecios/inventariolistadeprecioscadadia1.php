...
$query_Recordset1 = "/* PARSEADORES1 negocio\inventariolistadeprecios\inventariolistadeprecioscadadia1.php - QUERY 1 */ SELECT 
...
<div class="container">
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
	...
	<table width="100%" border="0" align="center">
        ...
        <?php do { ?>
          <tr class="brillo">
		              <td align="left"><?php echo $row_Recordset1['Id_producto']; ?></td>
...
if ($row_Recordset1['id_categoriaenproductoensede']==6) {
 ...
 ?>
            ...
            <td align="center"><?php echo $row_Recordset1['cantidadinventarionegocios']; ?></td>
