...
if (isset($consultaBusqueda)) {
    ...
    $query_Recordset1 = sprintf("/* PARSEADORES1 negocio\compras\buscar.php - QUERY 1 */ SELECT 
		* 
		FROM 
			producto
		WHERE  
...
echo $mensaje;
      ...
      function buscar($b)
      {
          ...
          $sql = mysql_query("/* PARSEADORES1 negocio\compras\buscar.php - QUERY 2 */ SELECT * FROM paises WHERE nombre LIKE '%".$b."%' LIMIT 9", $con);
