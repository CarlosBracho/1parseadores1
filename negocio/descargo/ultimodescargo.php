...
$query_Recordset1 = "/* PARSEADORES1 negocio\descargo\ultimodescargo.php - QUERY 1 */ SELECT inventarioydemas.id_documentoinventarioydemas
FROM 
inventarioydemas
WHERE
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 negocio\descargo\ultimodescargo.php - QUERY 2 */ SELECT 
