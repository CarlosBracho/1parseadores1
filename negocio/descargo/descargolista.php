...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 negocio\descargo\descargolista.php - QUERY 1 */ SELECT inventarioydemas.id_documentoinventarioydemas
FROM 
inventarioydemas
WHERE
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 negocio\descargo\descargolista.php - QUERY 2 */ SELECT 
