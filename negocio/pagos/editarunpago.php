...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 negocio\pagos\editarunpago.php - QUERY 1 */ SELECT * FROM pagospendientes  
WHERE
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1") {
    $updateSQL = sprintf(
        "/* PARSEADORES1 negocio\pagos\editarunpago.php - QUERY 2 */ UPDATE pagospendientes 
