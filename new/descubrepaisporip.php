...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\descubrepaisporip.php - QUERY 1 */ SELECT 
...
ORDER BY ve.num_ticket DESC LIMIT 74",
    ...
    do {
        ...
        if ($query && $query['status'] == 'success') {
            ...
            echo '</br>';
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\descubrepaisporip.php - QUERY 2 */ UPDATE venta SET pais=%s, conomonetario=%s
                                                          WHERE num_ticket=%s",
            ...
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\descubrepaisporip.php - QUERY 3 */ UPDATE conomonetario=%s
                                                          WHERE num_ticket=%s",
