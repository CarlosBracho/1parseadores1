...
$query_Recordset19 = sprintf("/* PARSEADORES1 new\ventaslotan\guardar_ticket.php - QUERY 1 */ SELECT est_control_ventas_lot, est_control_pagos_lot
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"] == "form1" && $_SESSION["ocarritoAni"]->sumar_carrito()>0 &&
    ...
    $query_Recordset6 = sprintf("/* PARSEADORES1 new\ventaslotan\guardar_ticket.php - QUERY 2 */ SELECT tp.mon_minticket_lot
        ...
        if (sizeof($cLot)>0) {
            if ($_POST['con_tope']==2) {
                $query_Recordset11 = sprintf(
                    "/* PARSEADORES1 new\ventaslotan\guardar_ticket.php - QUERY 3 */ SELECT ba.top_triple_lot FROM banca ba
