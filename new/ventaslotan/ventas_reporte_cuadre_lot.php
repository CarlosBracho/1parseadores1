...
$query_Recordset2 = sprintf("/* PARSEADORES1 new\ventaslotan\ventas_reporte_cuadre_lot.php - QUERY 1 */ SELECT us.nom_usuario, us.id_usuario, ta.nom_taquilla FROM usuario us, taquilla ta 
...
if ($vendedor=="") {
    $query_Recordset3 = sprintf("/* PARSEADORES1 new\ventaslotan\ventas_reporte_cuadre_lot.php - QUERY 2 */ SELECT nom_usuario FROM usuario WHERE usuario.id_usuario = %s AND tip_usuario='U' 
     	...
     	<div style="width:100; float:left; padding:0px 0px 0px 10px">
             <div id="printtitle" style="float:left;">
               <table width="305" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td height="3" colspan="2" align="right" bgcolor="#333" style="font-size:1px"></td>
                  </tr>
                  <tr>
                    <td align="right">ANULADOS PAGADOS(<?php echo $Aeliminados;?>):</td>
                    <td align="right" bgcolor="#DADADA"> <?php echo number_format($row_Recordset81['tot_eliminad_lot'], 2, ",", ".");?></td>
                  </tr>
                  <tr>
                    <td height="3" colspan="2" align="right" bgcolor="#333" style="font-size:1px"></td>
                  </tr>
                  <tr>
                    ...
                    <td align="right" bgcolor="#E8E8E8">
               	    <strong><?php echo number_format($AenCaja, 2, ",", ".");?></strong></td>
                  </tr>
                  <tr>
                    <td height="3" colspan="2" align="right" bgcolor="#333" style="font-size:1px"></td>
                  </tr>
                  ...
                  <tr>
                    <td align="right">PREMIOS x PAGAR:</td>
                    <td align="right" bgcolor="#DADADA"> <?php echo number_format($row_Recordset81['pre_porpagar_lot'], 2, ",", ".");?></td>
                  </tr>
                  <?php
                  }?>
                  <tr>
