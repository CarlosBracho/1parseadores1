...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\ventaslotan\lista_animalitos.php - QUERY 1 */ SELECT 
	lo.nom_loteria, 
	lo.tip_loteria, 
	lo.id_loteria,
	lo.let_loteria,
...
$query_Recordset2 = "/* PARSEADORES1 new\ventaslotan\lista_animalitos.php - QUERY 2 */ SELECT id_animal, nom_animal, num_animal FROM animales ORDER BY num_animal";
...
$query_Recordset3 = "/* PARSEADORES1 new\ventaslotan\lista_animalitos.php - QUERY 3 */ SELECT id_fruta, nom_fruta, num_fruta FROM frutas ORDER BY num_fruta";
...
$query_Recordset4 = "/* PARSEADORES1 new\ventaslotan\lista_animalitos.php - QUERY 4 */ SELECT id_palo, nom_palo FROM palos_cartas ORDER BY id_palo";
