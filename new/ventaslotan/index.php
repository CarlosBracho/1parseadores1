...
$query_Recordset6 = sprintf(
    "/* PARSEADORES1 new\ventaslotan\index.php - QUERY 1 */ SELECT 
...
$query_Recordset19 = sprintf("/* PARSEADORES1 new\ventaslotan\index.php - QUERY 2 */ SELECT est_control_ventas_lot, est_control_pagos_lot
