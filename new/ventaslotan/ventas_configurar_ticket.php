...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\ventaslotan\ventas_configurar_ticket.php - QUERY 1 */ SELECT tp.tip_ticket_lot, tp.lar_ticket_lot, 
	tp.cod_taopclot 
	FROM 
		usuario us,
		taquilla ta, 
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    $updateSQL = sprintf(
        "/* PARSEADORES1 new\ventaslotan\ventas_configurar_ticket.php - QUERY 2 */ UPDATE taquilla_opc_lot 
			SET 
			tip_ticket_lot=%s,
			lar_ticket_lot=%s  
			WHERE 
