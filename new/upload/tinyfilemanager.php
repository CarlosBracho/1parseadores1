...
// Mass deleting
if (isset($_POST['group'], $_POST['/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 1 */ delete']) && !FM_READONLY) {
    $path = FM_ROOT_PATH;
    if (FM_PATH != '') {
        $path .= '/' . FM_PATH;
    }
...
if (isset($_GET['copy']) && !isset($_GET['finish']) && !FM_READONLY) {
    ...
    <div class="path">
        ...
        <p><i>/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 2 */ Select folder</i></p>
                ...
                <div class="btn-toolbar" role="toolbar">
                    <?php if (!$isNormalEditor) { ?>
                        <div class="btn-group js-ace-toolbar">
                            ...
                            <select id="js-ace-mode" data-type="mode" title="/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 3 */ Select Document Type" class="btn-outline-secondary border-left-0 d-none d-md-block"><option>-- /* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 4 */ Select Mode --</option></select>
                            <select id="js-ace-theme" data-type="theme" title="/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 5 */ Select Theme" class="btn-outline-secondary border-left-0 d-none d-lg-block"><option>-- /* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 6 */ Select Theme --</option></select>
                            <select id="js-ace-fontSize" data-type="fontSize" title="Selct Font Size" class="btn-outline-secondary border-left-0 d-none d-lg-block"><option>-- /* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 7 */ Select Font Size --</option></select>
                        </div>
                    <?php } ?>
                </div>
            </div>
                ...
                <?php if (!FM_READONLY): ?>
                    <th style="width:3%" class="custom-checkbox-header">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="js-/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 8 */ select-all-items" onclick="checkbox_toggle()">
                            <label class="custom-control-label" for="js-/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 9 */ select-all-items"></label>
                        </div>
                    </th><?php endif; ?>
            ...
            foreach ($folders as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions"><?php if (!FM_READONLY): ?>
                            <a title="<?php echo lng('/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 10 */ Delete')?>" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;del=<?php echo urlencode($f) ?>" onclick="return confirm('<?php echo lng('/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 11 */ Delete').' '.lng('Folder').'?'; ?>\n \n ( <?php echo urlencode($f) ?> )');"> <i class="fa fa-trash-o" aria-hidden="true"></i></a>
            ...
            foreach ($files as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions">
                        ...
                        <?php if (!FM_READONLY): ?>
                            <a title="<?php echo lng('/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 12 */ Delete') ?>" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;del=<?php echo urlencode($f) ?>" onclick="return confirm('<?php echo lng('/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 13 */ Delete').' '.lng('File').'?'; ?>\n \n ( <?php echo urlencode($f) ?> )');"> <i class="fa fa-trash-o"></i></a>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9">
            <ul class="list-inline footer-action">
                ...
                <li class="list-inline-item"><input type="submit" class="hidden" name="/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 14 */ delete" id="a-/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 15 */ delete" value="/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 16 */ Delete" onclick="return confirm('/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 17 */ Delete selected files and folders?')">
                    <a href="javascript:document.getElementById('a-/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 18 */ delete').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-trash"></i> <?php echo lng('/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 19 */ Delete') ?> </a></li>
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE):
    ...
    <script>
        ...
        function renderThemeMode() {
            var $modeEl = $("/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 20 */ select#js-ace-mode"), $themeEl = $("select#js-ace-theme"), $fontSizeEl = $("select#js-ace-fontSize"), optionNode = function(type, arr){ var $Option = ""; $.each(arr, function(i, val) { $Option += "<option value='"+type+i+"'>" + val + "</option>"; }); return $Option; },
        ...
        $(function(){
            ...
            $("/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 21 */ select#js-ace-mode, select#js-ace-theme, select#js-ace-fontSize").on("change", function(e){
                e.preventDefault();
...
function lng($txt) {
    ...
    $tr['en']['Save']           = 'Save';                   $tr['en']['SelectAll']          = '/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 22 */ Select all';
    $tr['en']['UnSelectAll']    = 'Unselect all';           $tr['en']['File']               = 'File';
    $tr['en']['Back']           = 'Back';                   $tr['en']['Size']               = 'Size';
    $tr['en']['Perms']          = 'Perms';                  $tr['en']['Modified']           = 'Modified';
    $tr['en']['Owner']          = 'Owner';                  $tr['en']['Search']             = 'Search';
    $tr['en']['NewItem']        = 'New Item';               $tr['en']['Folder']             = 'Folder';
    $tr['en']['/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 23 */ Delete']         = '/* PARSEADORES1 new\upload\tinyfilemanager.php - QUERY 24 */ Delete';                 $tr['en']['Rename']             = 'Rename';
