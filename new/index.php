...
if (isset($_POST['usuario'])) {
    ...
    $LoginRS__query=sprintf(
        "/* PARSEADORES1 new\index.php - QUERY 1 */ SELECT id_usuario, nom_usuario, pas_usuario, tip_usuario, est_usuario, hor_inicio, 		
  	hor_fin, cod_taquilla, dia_entrada, niv_acceso
  	FROM usuario 
