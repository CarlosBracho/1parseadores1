...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\admin_lot\eliminadatosagencia.php - QUERY 1 */ SELECT id_agelot
	FROM 
		agencialoterias ag
...
do {
    $query_delete =  sprintf(
        "/* PARSEADORES1 new\admin_lot\eliminadatosagencia.php - QUERY 2 */ DELETE FROM agencialoterias WHERE id_agelot = %s",
