...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $_POST['tip_usuario']="G";
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 new\admin_lot\admin_usuario_age_add_lot.php - QUERY 1 */ INSERT 
		INTO usuario 
        ...
        $insertGoTo = "admin_usuarios_age_lista_lot.php";
        if (isset($_SERVER['QUERY_STRING'])) {
...
$query_Recordset2 = "/* PARSEADORES1 new\admin_lot\admin_usuario_age_add_lot.php - QUERY 2 */ SELECT ag.cod_agencia, ag.nom_agencia FROM agencia ag, agencialoterias al 
	WHERE ag.cod_agencia = al.id_agencia GROUP BY ag.cod_agencia ORDER BY ag.nom_agencia";
                        ...
                        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="font-size:10px;border-bottom:1px solid  #D5D5D5;" height="45" align="center">
                                    DATOS DE AGENTE:<br />
                                    <?php echo '<font size="5">--- NUEVO USUARIO AGENTE ---</font><br/>'; ?>
                                </td>
                            </tr>
                            <tr valign="baseline">
                                <td height="36" align="center" valign="bottom" nowrap bgcolor="#333" style="color:#FFF">
                                    DATOS Y OPCIONES DE USUARIO AGENTE
                                </td>
                            </tr>
						</table>
                        <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                            <tr height="70" valign="bottom">
                                <td align="left" colspan="2" nowrap>&nbsp;
                                	Agente:<br />&nbsp;
 									<select name="cod_agencia" style="width:475px; height: auto" class="textbox">
                        ...
                        <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                            <tr height="100" valign="middle">
                                ...
                                <td width="46%" align="eft">
                                    <a href='admin_usuarios_age_lista_lot.php' class="btn  btn-danger" 
