...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($_POST["id_grupo_lot"]==-1) {
        ...
        $query_Recordset3 =  sprintf(
            "/* PARSEADORES1 new\admin_lot\admin_lot\admin_sorteos_add_lot.php - QUERY 1 */ SELECT 
        ...
        if ($totalRows_Recordset3==0) {
            ...
            $query_Recordset2 =  sprintf(
                "/* PARSEADORES1 new\admin_lot\admin_lot\admin_sorteos_add_lot.php - QUERY 2 */ SELECT 
				nom_sorteo
				FROM sorteos 
    ...
    if ($graba==31) {
        $insertSQL2 = sprintf(
            "/* PARSEADORES1 new\admin_lot\admin_lot\admin_sorteos_add_lot.php - QUERY 3 */ INSERT 
			INTO sorteos 
...
$query_Recordset1 =  sprintf("/* PARSEADORES1 new\admin_lot\admin_lot\admin_sorteos_add_lot.php - QUERY 4 */ SELECT id_grupo_lot, nom_grupo_lot FROM grupo_loterias ORDER BY nom_grupo_lot ASC");
