...
if (isset($_POST["fecha"])&&isset($_POST["bu_sorteo"])) {
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\admin_lot\admin_lot\admin_resultado_buscar_lot.php - QUERY 1 */ SELECT 
    ...
    if ($totalRows_Recordset1>0) {
        ...
        foreach ($resultados as $xres) {
            ...
            if ($xres=="TRIPLE TIGRE") {//$resultados[1184]
                $i=18;
                $pas=1;
                $y=1160;
                $z=74;
            ...
            if ($xres=="TRIPLE ZAMORANO") {//$resultados[1427]
                $i=18;
                $pas=1;
                $y=1403;
                $z=56;
            ...
            if ($xres=="TRIPLE MANIA") {//$resultados[1616]
                $i=18;
                $pas=1;
                $y=1592;
                $z=74;
            ...
            if ($xres=="MULTI TRIPLE") {//$resultados[1859]
                $i=18;
                $pas=1;
                $y=1835;
                $z=74;
            ...
            if ($xres=="RIENTAL") {//$resultados[2104]
                $i=18;
                $pas=1;
                $y=2080;
                $z=74;
            ...
            if ($xres=="TRIPLE CALIENTE") {//$resultados[2347]
                $i=18;
                $pas=1;
                $y=2323;
                $z=74;
            ...
            if ($xres=="TRIPLE TRADICIONAL") {//$resultados[2590]
                $i=18;
                $pas=1;
                $y=2566;
                $z=74;
            ...
            if ($xres=="LOTTO ACTIVO") {//$resultados[2832]
                $i=18;
                $pas=2;
                $y=2806;
                $z=74;
            ...
            if ($pas==2) {
                ...
                foreach ($pTriple as $trip) {
                    if (strpos($resultados[$x+$y+6+($i*38)], '-') === false) {
                        $rSorteoAn[$k][0]=$trip;//codigos animalito
                        $rSorteoAn[$k][1]=$nSorteo." ".$resultados[$x+$y+($i*38)-$t];//nombre y hora sorteo
                        $rSorteoAn[$k][2]=$resultados[$x+$y+2+($i*38)]; //numero ganador
                        $rSorteoAn[$k][3]=$resultados[$x+$y+20+($i*38)]; //animal ganador
                        $k++;
                    }
                    $i++;
                }
        ...
        if (isset($rSorteo)) {
            ...
            foreach ($rSorteo as $xres1) {
                foreach ($xres1 as $xres) {
                    ...
                    if ($xres[2]!=$s) {
                        ...
                        echo '<div style="float:left;width:220px;font-size:14px;background:#EDEDED;margin:0 5px 5px 5px;height:75px">';
            ...
            foreach ($rSorteoAn as $xres2) {
                ...
                echo '<div style="float:left;width:220px;font-size:14px;background:#EDEDED;margin:0 5px 5px 5px;padding:0 0 10px 0">';
            ...
            echo "<font size=6>Aun no existen RESULTADOS</font><br/><br/>Por favor intentelo mas tarde<br/><br/>";
