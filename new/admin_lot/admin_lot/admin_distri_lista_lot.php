...
$query_Recordset1 =  sprintf("/* PARSEADORES1 new\admin_lot\admin_lot\admin_distri_lista_lot.php - QUERY 1 */ SELECT 
		ba.cod_banca, ba.nom_banca, ba.nom_representante, ba.tel_banca, ba.tel_banca2, ba.tel_banca3, bl.id_banlot,
		CASE ba.est_banca  
	...
	FROM 
	banca ba
	LEFT JOIN bancaloterias bl ON(ba.cod_banca = bl.id_banca)
	GROUP BY ba.cod_banca
	ORDER BY 
	 ba.nom_banca ASC, ba.est_banca DESC");
  ...
  <div class="contentAdmin">
	<div style="height:100%; font-size:18px;" class="xfirefox">
        <div style="height:100%; font-size:28px; padding:10px 10px 10px 10px; float:right;">
            <a href="admin_distri_add_lot.php" class="btn alert-success" 
  ...
  <?php do { ?>
    <tr class="brillo" style="border-bottom:1px solid  #D5D5D5" valign="bottom">
      ...
      <td align="center" style="font-size:14px">
	  	<?php
            echo $row_Recordset1['tel_banca'].".".$row_Recordset1['tel_banca2'].".".$row_Recordset1['tel_banca3']; ?>
	  </td>
      <td align="center" valign="middle"><?php echo $row_Recordset1['estado']; ?></td>
      <td align="center" valign="middle">
		  <?php
          if ($row_Recordset1['id_banlot']==0) {
              $acc="CREAR OPCIONES";
          } else {
              $acc="EDITAR";
          }
          ...
          ?>
          <a href='<?php echo $url; ?>' class="btn btn-info" style="text-decoration:none"><?php echo $acc; ?></a>
      </td>
    </tr>
