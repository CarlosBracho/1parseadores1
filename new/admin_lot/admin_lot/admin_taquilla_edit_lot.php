...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin_lot\admin_lot\admin_taquilla_edit_lot.php - QUERY 1 */ UPDATE taquilla 
        ...
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin_lot\admin_lot\admin_taquilla_edit_lot.php - QUERY 2 */ UPDATE taquilla_opc_lot 
...
if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
    $query_Recordset6 =  sprintf(
        "/* PARSEADORES1 new\admin_lot\admin_lot\admin_taquilla_edit_lot.php - QUERY 3 */ SELECT 
    ...
    if ($totalRows_Recordset6>0) {
        ...
        do {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 new\admin_lot\admin_lot\admin_taquilla_edit_lot.php - QUERY 4 */ INSERT 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\admin_lot\admin_lot\admin_taquilla_edit_lot.php - QUERY 5 */ SELECT 
...
if ((isset($_POST["MM_insert3"])) && ($_POST["MM_insert3"] == "form3")) {
    $query_Recordset4 =  sprintf("/* PARSEADORES1 new\admin_lot\admin_lot\admin_taquilla_edit_lot.php - QUERY 6 */ SELECT 
    ...
    $query_Recordset4 =  sprintf("/* PARSEADORES1 new\admin_lot\admin_lot\admin_taquilla_edit_lot.php - QUERY 7 */ SELECT 
		tp.tic_caduca_lot, tp.mon_minticket_lot, tp.pag_codigo_lot, tp.tip_ticket_lot, tp.por_taquilla_lot,
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\admin_lot\admin_lot\admin_taquilla_edit_lot.php - QUERY 8 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
