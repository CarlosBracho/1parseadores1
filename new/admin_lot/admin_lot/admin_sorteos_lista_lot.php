...
$query_Recordset1 =  sprintf("/* PARSEADORES1 new\admin_lot\admin_lot\admin_sorteos_lista_lot.php - QUERY 1 */ SELECT 
...
<div class="container">
  ...
  <?php do { ?>
    <tr class="brillo" style="border-bottom:1px solid  #D5D5D5; font-size:14px" valign="middle">
      ...
      <td align="center" valign="middle"><?php echo horaampm($row_Recordset1['hor_sorteo']); ?>
      </td>
