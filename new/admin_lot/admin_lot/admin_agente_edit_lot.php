...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1" && isset($_POST["guardarAge"]))) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 1 */ UPDATE agencia SET por_agencia_lot=%s WHERE cod_agencia=%s",
...
if (isset($_POST["guardar"])) {
    ...
    if ($graba==31) {
        ...
        foreach ($_POST["idtr_agelot"] as $idl) {
            ...
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 2 */ UPDATE agencialoterias 
					SET
            ...
            if ($tip_loteria[$cta]<4) {
                $insertSQL3 = sprintf(
                    "/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 3 */ UPDATE agencialoterias 
						SET
						est_agelot=%s, lun_loteria=%s, mar_loteria=%s, mie_loteria=%s, jue_loteria=%s, vie_loteria=%s, sab_loteria=%s,
						dom_loteria=%s, top_ventaage=%s
						WHERE id_agelot=%s",
...
if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
    $query_Recordset6 =  sprintf(
        "/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 4 */ SELECT 
    ...
    if ($totalRows_Recordset6>0) {
        ...
        do {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 5 */ INSERT 
...
if ((isset($_POST["MM_inserto"])) && ($_POST["MM_inserto"] == "formo") &&
    ...
    $query_Recordset1 =  sprintf(
        "/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 6 */ SELECT 
		...
		so.nom_sorteo,
		CASE lo.tip_loteria
			WHEN 1 THEN (/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 7 */ SELECT blo.pre_loteria FROM bancaloterias blo WHERE blo.id_loteria = lo.id_terminal LIMIT 1)
			WHEN 3 THEN (/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 8 */ SELECT blo.pre_loteria FROM bancaloterias blo WHERE blo.id_loteria = lo.id_terminal LIMIT 1)
			ELSE 0
		END AS pre_terminal,	
		CASE lo.tip_loteria
			WHEN 1 THEN (/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 9 */ SELECT al2.id_agelot FROM agencialoterias al2 WHERE al2.id_loteria = lo.id_terminal LIMIT 1)
			WHEN 3 THEN (/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 10 */ SELECT al2.id_agelot FROM agencialoterias al2 WHERE al2.id_loteria = lo.id_terminal LIMIT 1)
			ELSE 0
		END AS id_agelot_ter,	
		CASE lo.tip_loteria
			WHEN 1 THEN (/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 11 */ SELECT alo.top_ventaage FROM agencialoterias alo WHERE alo.id_loteria = lo.id_terminal LIMIT 1)
			WHEN 3 THEN (/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 12 */ SELECT alo.top_ventaage FROM agencialoterias alo WHERE alo.id_loteria = lo.id_terminal LIMIT 1)
			ELSE 0
		END top_terminal	
		FROM 
			agencia ag, 
    ...
    $od_sorteo="";
    $query_Recordset1 =  sprintf(
        "/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 13 */ SELECT 
		ag.cod_agencia, ag.nom_agencia, ag.por_agencia_lot,
		al.lun_loteria, al.mar_loteria, al.mie_loteria, al.jue_loteria, al.vie_loteria, 
		al.sab_loteria, al.dom_loteria, al.id_agelot, al.est_agelot, al.top_ventaage,
		lo.nom_loteria, lo.tip_loteria, bl.id_banlot,
		...
		so.nom_sorteo,
		CASE lo.tip_loteria
			WHEN 1 THEN (/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 14 */ SELECT blo.pre_loteria FROM bancaloterias blo WHERE blo.id_loteria = lo.id_terminal LIMIT 1)
			WHEN 3 THEN (/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 15 */ SELECT blo.pre_loteria FROM bancaloterias blo WHERE blo.id_loteria = lo.id_terminal LIMIT 1)
			ELSE 0
		END AS pre_terminal,	
		CASE lo.tip_loteria
			WHEN 1 THEN (/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 16 */ SELECT al2.id_agelot FROM agencialoterias al2 WHERE al2.id_loteria = lo.id_terminal LIMIT 1)
			WHEN 3 THEN (/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 17 */ SELECT al2.id_agelot FROM agencialoterias al2 WHERE al2.id_loteria = lo.id_terminal LIMIT 1)
			ELSE 0
		END AS id_agelot_ter,	
		CASE lo.tip_loteria
			WHEN 1 THEN (/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 18 */ SELECT alo.top_ventaage FROM agencialoterias alo WHERE alo.id_loteria = lo.id_terminal LIMIT 1)
			WHEN 3 THEN (/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 19 */ SELECT alo.top_ventaage FROM agencialoterias alo WHERE alo.id_loteria = lo.id_terminal LIMIT 1)
			ELSE 0
		END top_terminal	
		FROM 
			agencia ag, 
...
$query_Recordset2 =  sprintf(
    "/* PARSEADORES1 new\admin_lot\admin_lot\admin_agente_edit_lot.php - QUERY 20 */ SELECT 
