...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $query_Recordset2 =  sprintf(
        "/* PARSEADORES1 new\admin_lot\admin_lot\admin_grupos_add_lot.php - QUERY 1 */ SELECT 
		nom_grupo_lot
		FROM grupo_loterias 
    ...
    if ($graba==31) {
        $insertSQL2 = sprintf(
            "/* PARSEADORES1 new\admin_lot\admin_lot\admin_grupos_add_lot.php - QUERY 2 */ INSERT 
			INTO grupo_loterias 
