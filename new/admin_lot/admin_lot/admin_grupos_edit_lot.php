...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 new\admin_lot\admin_lot\admin_grupos_edit_lot.php - QUERY 1 */ UPDATE grupo_loterias 
		SET
		est_grupo_lot=%s 
		WHERE id_grupo_lot=%s",
        GetSQLValueString($_POST['est_grupo_lot'], "int"),
        GetSQLValueString($_POST['id_grupo_lot'], "int")
    );
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\admin_lot\admin_lot\admin_grupos_edit_lot.php - QUERY 2 */ SELECT 
              ...
              <table width="921" align="center" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr valign="baseline">
                  ...
                  <td width="490" align="left" nowrap>
                    ...
                    value="<?php echo $row_Recordset1['nom_grupo_lot']; ?>" size="42" />
                  </td>
                  <td width="200">
                        Status del grupo:<br />
                        <select name="est_sorteo" style="width:140px; height: auto" class="textbox" tabindex="6"> 
                          <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset1['est_grupo_lot'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>ACTIVO</option>
                          <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset1['est_grupo_lot'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>INACTIVO</option>
                        </select>
                  </td>
			...
			<input type="hidden" name="id_grupo_lot" value="<?php echo $xCodigo; ?>"/>
		</form>
		<table width="920" align="center" border="0" cellpadding="0" cellspacing="0">
          <tbody>
            <tr>
