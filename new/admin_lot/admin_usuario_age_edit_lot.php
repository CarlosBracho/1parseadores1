...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $menE="";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin_lot\admin_usuario_age_edit_lot.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
				est_usuario=%s 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\admin_lot\admin_usuario_age_edit_lot.php - QUERY 2 */ SELECT 
	...
	WHERE 
	us.id_usuario = %s AND ag.cod_agencia = us.cod_taquilla AND us.tip_usuario = 'G'
	LIMIT 1",
