...
$query_Recordset1 =  sprintf("/* PARSEADORES1 new\admin_lot\admin_usuarios_dis_lista_lot.php - QUERY 1 */ SELECT 
		us.id_usuario, us.nom_usuario, ba.nom_banca, ba.tel_banca,
		CASE us.est_usuario 
	...
	FROM 
	usuario us, banca ba
	WHERE us.cod_taquilla = ba.cod_banca AND us.tip_usuario = 'D'
	ORDER BY 
	us.nom_usuario ASC, ba.nom_banca ASC");
  ...
  <div class="contentAdmin">
	<div style="height:100%; font-size:18px;" class="xfirefox">
        <div style="height:100%; font-size:28px; padding:10px 10px 10px 10px; float:right;">
            <a href="admin_usuario_dis_add_lot.php" class="btn alert-success" 
	...
	<tr style="background:#0084B4; color:#FFFFFF; height:30px; font-family:'Lucida Grande','Lucida Sans Unicode','Lucida Sans','DejaVu Sans',Verdana,sans-serif;" valign="bottom">
		...
		<td width="33%" align="center">DISTRIBUIDOR</td>
  ...
  <?php do { ?>
		<tr class="brillo" style="border-bottom:1px solid #D5D5D5" valign="bottom">
			<td align="left" style="line-height:1.1"><?php
                ...
                echo "Contacto: ".$row_Recordset1['tel_banca']."&nbsp;</font>";?>
			</td>
			<td align="center" style="font-size:14px"><?php
                echo $row_Recordset1['nom_banca']; ?>
			</td>
			<td align="center" valign="middle"><?php echo $row_Recordset1['estado']; ?></td>
			<td align="center" valign="middle"><?php
                $url='admin_usuario_dis_edit_lot.php?recordID='.$row_Recordset1['id_usuario'];?>
