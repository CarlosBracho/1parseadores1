...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $menE="";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin_lot\admin_usuario_dis_edit_lot.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
				est_usuario=%s 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\admin_lot\admin_usuario_dis_edit_lot.php - QUERY 2 */ SELECT 
	us.id_usuario, us.nom_usuario, us.nom_completo, us.tip_usuario, us.cod_taquilla, us.pas_usuario, us.est_usuario, 
	ba.nom_banca
	FROM 
	usuario us, banca ba
	WHERE 
	us.id_usuario = %s AND ba.cod_banca = us.cod_taquilla AND us.tip_usuario = 'D'
	LIMIT 1",
