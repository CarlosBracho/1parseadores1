        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_distribuidor']!="todos") {
                $query_Recordset10 = sprintf(
                    "/* PARSEADORES1 new\admin_lot\admin_reporte_cobranza_lot.php - QUERY 1 */ SELECT cod_banca, nom_banca, tel_banca, cor_banca, por_banca_lot 
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && $_POST['id_distribuidor']=="todos") ||
    ...
    $query_Recordset10 = sprintf("/* PARSEADORES1 new\admin_lot\admin_reporte_cobranza_lot.php - QUERY 2 */ SELECT cod_banca, nom_banca, tel_banca, cor_banca, por_banca_lot FROM banca");
    $v=0;
}
...
$query_Recordset2 = sprintf("/* PARSEADORES1 new\admin_lot\admin_reporte_cobranza_lot.php - QUERY 3 */ SELECT cod_banca, nom_banca FROM banca ORDER BY banca.nom_banca");
		...
		<table width="100%" border="0" style="color:#000; font-size:11px;" cellpadding="0" cellspacing="0"><?php
            ...
            if ($totalRows_Recordset10>0) {
                do {
                    ...
                    $query_Recordset3 = sprintf("/* PARSEADORES1 new\admin_lot\admin_reporte_cobranza_lot.php - QUERY 4 */ SELECT ag.cod_agencia, ag.nom_agencia, ag.por_agencia_lot
						FROM agencia ag, 
							agencialoterias al 
						WHERE 
                    ...
                    if ($totalRows_Recordset3>0) {
                        do {
                            ...
                            $query_Recordset1 = sprintf(
                                "/* PARSEADORES1 new\admin_lot\admin_reporte_cobranza_lot.php - QUERY 5 */ SELECT
