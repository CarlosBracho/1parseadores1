...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\reparacion2020.php - QUERY 1 */ SELECT numticket, Idbalancecli
...
do {
    ...
    $insertSQL15 = sprintf(
        "/* PARSEADORES1 new\reparacion2020.php - QUERY 2 */ UPDATE balanceclientes
				SET
    ...
    if ($row_Recordset1['numticket']==$anteriol) {
        ...
        $sql = "/* PARSEADORES1 new\reparacion2020.php - QUERY 3 */ delete from balanceclientes where Idbalancecli=".$id."";
    
        $queryDelete = "/* PARSEADORES1 new\reparacion2020.php - QUERY 4 */ DELETE FROM balanceclientes WHERE Idbalancecli = ".$id.";";
