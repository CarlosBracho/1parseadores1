...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\chat_ad\t_imprimeticket.php - QUERY 1 */ SELECT 
venta.fec_venta, 
venta.hor_venta,
venta.ser_venta,
venta.can_ticket,
...
<?php if ($row_Recordset1['tip_ticket']==0) { ?>
...
if ($moneda==5) {
    echo "Total Sol:.".number_format($montoapagar, 2, ",", ".");
	 ...
	 <?php if ($row_Recordset1['tip_ticket']==1) { ?>
	 <font size="<?php echo $tamletras; ?>" face="Arial" >
        <table width="225" style="font-family: Arial; font-size:13px" border="0" align="left">
          <tr>
...
if ($moneda==5) {
    echo "Total Sol:.".number_format($montoapagar, 2, ",", ".");
          ...
          <?php if ($tic_caduca>0) { ?>
          <tr>
            <td align="left"><?php echo "Caduca a ".$tic_caduca." dias";?></td>
          </tr>
          <!--<?php }?>
          <tr>
   ...
   <tr><td colspan="4" align="left">.</td></tr>		  
	 ...
	 <?php if ($row_Recordset1['tip_ticket']==2) { ?>
...
<?php if ($row_Recordset1['tip_ticket']==3) { ?>
<font size="<?php echo $tamletras; ?>" face="Arial" >
        <table width="225" border="0" align="left">
          <tr>
            <td colspan="4" class="imprimir" scope="col" align="left"><?php echo $rest2 = substr($row_Recordset1['nom_taquilla'], 0, 5); ?>-ORIG#:<?php echo $row_Recordset1['can_ticket']; ?></td>
...
if ($moneda==5) {
   ...
   <tr><td colspan="4" align="left">.</td></tr>		  
	 ...
	 <?php if ($row_Recordset1['tip_ticket']==4) { ?>
	 <font size="<?php echo $tamletras; ?>" face="Arial" >
        <table width="225" style="font-family: Arial; font-size:13px" border="0" align="left">
          <tr>
            <td colspan="4" class="imprimir" scope="col" align="left"><?php //echo $rest2 = substr($row_Recordset1['nom_taquilla'], 0, 5); ?>-ORIG#:<?php echo $row_Recordset1['can_ticket']; ?></td>
...
if ($moneda==5) {
    echo "Total Sol:.".number_format($montoapagar, 2, ",", ".");
		  ...
		  <?php for ($i = 0; $i < $largo; ++$i) {?><tr><td colspan="2" align="left"></td></tr><?php } ?>
