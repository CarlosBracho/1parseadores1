...
var loadRetir = function() {
    $.ajax({    
        type: "GET",
        url: "../includes/ret_maquinaazul_hnac.php",             
        dataType: "html",
		beforeSend: function() {
			clearTimeout(loadRetir);
			var espera1='<i class="fa fa-spinner fa-spin fa-2x"></i><br/>';
			var espera2='Cargando retirados desde MAQUINA AZUL<br/>Por favor espere un momento...';
...
<div class="container1">
    <div style="background:#333; height:25px; color:#FFFFFF; padding:25px 15px 10px 0px; text-align: center; font-size:34px"
    	id="datosUsuario">
        RETÍROS MAQUINA AZUL
