...
if (!copy($fichero, $nuevo_fichero)) {
		...
		$insertSQL = sprintf("/* PARSEADORES1 new\admin_hnac\admin_apertura_add_hnac.php - QUERY 1 */ INSERT INTO carrera_hnac 
					(cod_hipodromo_hnac, 
					fec_carrera_hnac, 
					hor_carrera_hnac,
					est_carrera_hnac,
	  ...
	  $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
		$query_RecT = "/* PARSEADORES1 new\admin_hnac\admin_apertura_add_hnac.php - QUERY 2 */ SELECT cod_carrera_hnac FROM carrera_hnac ORDER BY cod_carrera_hnac DESC LIMIT 1";
		...
		for ($x = 1;  $x <= $_POST['can_caballos']; $x++) {	//guarda los ejemplares
			$insertSQL2 = sprintf("/* PARSEADORES1 new\admin_hnac\admin_apertura_add_hnac.php - QUERY 3 */ INSERT INTO inscritos 
			(cod_carrera_hnac, 
			num_caballo_hnac, 
			nom_caballo_hnac, 
			nom_jinete_hnac, 
...
$query_Recordset2 = "/* PARSEADORES1 new\admin_hnac\admin_apertura_add_hnac.php - QUERY 4 */ SELECT cod_hipodromo_hnac, nom_hipodromo_hnac FROM hipodromo_hnac WHERE est_hipodromo_hnac = 1 ORDER BY nom_hipodromo_hnac ASC";
