...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\admin_hnac\admin_taquillas_add_hnac2.php - QUERY 1 */ INSERT 
				INTO taquilla 
        ...
        $query_RecT = "/* PARSEADORES1 new\admin_hnac\admin_taquillas_add_hnac2.php - QUERY 2 */ SELECT cod_taquilla FROM taquilla ORDER BY cod_taquilla DESC LIMIT 1";
        ...
        $insertSQL2 = sprintf(
            "/* PARSEADORES1 new\admin_hnac\admin_taquillas_add_hnac2.php - QUERY 3 */ INSERT 
		INTO 
		taquilla_opc_ame 
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 new\admin_hnac\admin_taquillas_add_hnac2.php - QUERY 4 */ INSERT 
		INTO usuario 
...
$query_Recordset2 = "/* PARSEADORES1 new\admin_hnac\admin_taquillas_add_hnac2.php - QUERY 5 */ SELECT cod_agencia, nom_agencia FROM agencia";
