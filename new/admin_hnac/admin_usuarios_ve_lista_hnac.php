...
$query_Recordset1 = "/* PARSEADORES1 new\admin_hnac\admin_usuarios_ve_lista_hnac.php - QUERY 1 */ SELECT * FROM usuario WHERE tip_usuario='U' ORDER BY usuario.nom_usuario ASC";
	...
	<table width="100%" border="0" align="center">
        ...
        <?php do { ?>
          <tr class="brillo">
            ...
            <td align="center">
           	  <a href='admin_usuarios_ve_edit_hnac.php?recordID=<?php echo $row_Recordset1['id_usuario']; ?>'class="btn btn-info"> EDITAR </a>
            </td>
          </tr>
