...
if (isset($_GET["recordID"])) {
    ...
    $query_Recordset4 = sprintf(
        "/* PARSEADORES1 new\admin_hnac\caballos_reintegrar_all_hnac.php - QUERY 1 */ SELECT * 
    ...
    if ($totalRows_Recordset4>0) {
        do {
            if ($row_Recordset4['est_inscrito_hnac']==0) {
                ...
                $insertSQL = sprintf(
                    "/* PARSEADORES1 new\admin_hnac\caballos_reintegrar_all_hnac.php - QUERY 2 */ UPDATE
									inscritos 
									SET
									est_inscrito_hnac=%s
