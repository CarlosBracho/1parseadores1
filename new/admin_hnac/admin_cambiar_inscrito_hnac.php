...
if (isset($_POST["xCarr"]) && isset($_POST["xCab"]) && isset($_POST["xCam"]) && isset($_POST["xCod"])) {
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\admin_hnac\admin_cambiar_inscrito_hnac.php - QUERY 1 */ SELECT cod_carrera_hnac 
				FROM inscritos
				WHERE 
    ...
    if ($totalRows_Recordset1>0) {
        ...
        if ($xFav>0 && $xFav<5) {// establece como favorito
            ...
            $query_Recordset2 = sprintf(
                "/* PARSEADORES1 new\admin_hnac\admin_cambiar_inscrito_hnac.php - QUERY 2 */ SELECT cod_carrera_hnac 
						FROM inscritos
						WHERE 
						cod_carrera_hnac = %s AND
            ...
            if ($totalRows_Recordset2==0 && $xCam>0) {
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 new\admin_hnac\admin_cambiar_inscrito_hnac.php - QUERY 3 */ SELECT cod_carrera_hnac 
							FROM inscritos
							WHERE 
							cod_carrera_hnac = %s AND
                ...
                $query_Recordset4 = sprintf(
                    "/* PARSEADORES1 new\admin_hnac\admin_cambiar_inscrito_hnac.php - QUERY 4 */ SELECT cod_carrera_hnac 
							FROM inscritos
							WHERE 
							cod_carrera_hnac = %s AND
							est_favorito_hnac = %s LIMIT 1",
        ...
        if ($grabar==1) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 new\admin_hnac\admin_cambiar_inscrito_hnac.php - QUERY 5 */ UPDATE inscritos 
				SET
					est_favorito_hnac=%s,
					est_inscrito_hnac=%s 
				WHERE 
