...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\admin_hnac\admin_dividendos_add_hnac.php - QUERY 1 */ SELECT hi.nom_hipodromo_hnac, ca.cod_carrera_hnac, ca.num_carrera_hnac, ca.fec_carrera_hnac,
...
function guardaBD($fec, $car, $cab, $div, $fac, $lin, $tip, $emp)
{
    ...
    $insertSQL = sprintf(
        "/* PARSEADORES1 new\admin_hnac\admin_dividendos_add_hnac.php - QUERY 2 */ INSERT 
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    $insertSQL2 = sprintf(
        "/* PARSEADORES1 new\admin_hnac\admin_dividendos_add_hnac.php - QUERY 3 */ UPDATE carrera_hnac SET
    ...
    if (isset($a) && $a==1) {
        ...
        $query_Recordset10 = sprintf(
            "/* PARSEADORES1 new\admin_hnac\admin_dividendos_add_hnac.php - QUERY 4 */ SELECT hi.nom_hipodromo_hnac, ca.num_carrera_hnac, hi.cod_hipodromo_hnac,
		ca.fec_carrera_hnac 
		FROM carrera_hnac ca, hipodromo_hnac hi
