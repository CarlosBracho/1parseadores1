        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_distribuidor']!="todos") {
                $query_Recordset10 = sprintf(
                    "/* PARSEADORES1 new\admin_hnac\admin_reporte_cobranza_hnac.php - QUERY 1 */ SELECT cod_banca, nom_banca, tel_banca, cor_banca, por_banca_hnac 
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && $_POST['id_distribuidor']=="todos") ||
    ...
    $query_Recordset10 = sprintf("/* PARSEADORES1 new\admin_hnac\admin_reporte_cobranza_hnac.php - QUERY 2 */ SELECT cod_banca, nom_banca, tel_banca, cor_banca, por_banca_hnac FROM banca");
    $v=0;
}
...
$query_Recordset2 = sprintf("/* PARSEADORES1 new\admin_hnac\admin_reporte_cobranza_hnac.php - QUERY 3 */ SELECT cod_banca, nom_banca FROM banca ORDER BY banca.nom_banca");
...
<script language="javascript"> 
	function cambiacolor_over(celda){ celda.style.backgroundColor="#A60104"; celda.style.color="#FFFFFF" }  
...
<div style="height:100%; font-size:26px; padding:50px 0px 100px 0px ">
   ...
   <div id="mostrar" style="width:99.7%; float:left; padding:0px 0px 150px 3px; background: #CCC">
   	   	<table width="934" border="0" style="color:#000; font-size:12px;" cellpadding="0" cellspacing="0" bordercolor="#F5F5F5">
			<?php
            $totalSistema=0;
            $totalGenDi=0;
               ...
               do {
                   ...
                   echo "| Correo: ".$row_Recordset10['cor_banca']; ?>
                    ...
                    <tr style="background:#5EAEFF; color:#FFF;" valign="middle" align="center">
                        <td width="145">AGENTE / TAQUILLA</td>
                   ...
                   $query_Recordset3 = sprintf(
                       "/* PARSEADORES1 new\admin_hnac\admin_reporte_cobranza_hnac.php - QUERY 4 */ SELECT cod_agencia, nom_agencia, por_agencia_hnac
                   ...
                   if ($totalRows_Recordset3>0) {
                       do {
                           ...
                           $query_Recordset1 = sprintf(
                               "/* PARSEADORES1 new\admin_hnac\admin_reporte_cobranza_hnac.php - QUERY 5 */ SELECT
							por_agencia_hnac, ta.nom_taquilla, ag.nom_agencia, 
                           ...
                           if ($totalRows_Recordset1>0) {
                               do {
                                   $nomAgente=$row_Recordset1['nom_agencia'];
                                   $nomAgente.=" / ".$row_Recordset1['nom_taquilla'];
                                   //****************
                                    
                                   //****************
                                    
                                   $porAgente=$row_Recordset1['por_agencia_hnac'];
                                   ...
                                   $tDis=$tDis+$tCobroDistri; ?>
									<tr style="color: #000; background:#FFFFFF" valign="middle" align="right"
