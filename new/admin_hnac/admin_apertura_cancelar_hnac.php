...
$query_Recordset10 = sprintf(
    "/* PARSEADORES1 new\admin_hnac\admin_apertura_cancelar_hnac.php - QUERY 1 */ SELECT hi.nom_hipodromo_hnac, ca.num_carrera_hnac, ca.fec_carrera_hnac 
...
if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $updateSQL = sprintf(
      "/* PARSEADORES1 new\admin_hnac\admin_apertura_cancelar_hnac.php - QUERY 2 */ UPDATE carrera_hnac 
		SET 
		est_carrera_hnac=%s, 
		est_cierre_hnac=%s, 
  ...
  $insertSQL2 = sprintf(
      "/* PARSEADORES1 new\admin_hnac\admin_apertura_cancelar_hnac.php - QUERY 3 */ INSERT 
					INTO bitacora 
