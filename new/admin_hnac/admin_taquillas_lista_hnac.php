...
$query_Recordset1 = "/* PARSEADORES1 new\admin_hnac\admin_taquillas_lista_hnac.php - QUERY 1 */ SELECT * 
	FROM 
	taquilla,
	agencia
	WHERE agencia.cod_agencia =  taquilla.cod_agencia
	ORDER BY 
...
<div style="height:100%; font-size:18px;" class="xfirefox">
        <div style="height:100%; font-size:28px; padding:10px 10px 10px 10px; float:right;">
            <a href="admin_taquillas_add_hnac.php" class="btn alert-success" 
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  		<tr style="background: #0E5157; color:#FFFFFF; height:30px; font-family:'Lucida Grande','Lucida Sans Unicode','Lucida Sans','DejaVu Sans',Verdana,sans-serif;">
  ...
  <?php do { ?>
    <tr class="brillo" style="border-bottom:1px solid  #D5D5D5">
      <td align="left"><?php
      echo $row_Recordset1['nom_taquilla']."<br/><FONT FACE='times new roman' SIZE=2>".$row_Recordset1['nom_agencia']."</FONT>"; ?>
      </td>
      <td align="left"><?php
      ...
      <td align="center">
      <a href='admin_taquillas_edit_hnac.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'class="btn btn-info"> EDITAR </a>
      </td>
    </tr>
