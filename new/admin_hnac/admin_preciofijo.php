        ...
        if (isset($_POST["guarda"]) && $graba==30) {
            if ($_POST["cod_taquilla"]!="todas") {
                $query_Recordset13 = sprintf(
                    "/* PARSEADORES1 new\admin_hnac\admin_preciofijo.php - QUERY 1 */ SELECT
				ta.cod_taquilla
                ...
                $query_Recordset13 = sprintf(
                    "/* PARSEADORES1 new\admin_hnac\admin_preciofijo.php - QUERY 2 */ SELECT
				ta.cod_taquilla
				FROM taquilla ta, taquilla_opc_hnac tp
				WHERE
            ...
            if ($totalRows_Recordset13>0) {
                do {
                    $query_Recordset12 = sprintf(
                        "/* PARSEADORES1 new\admin_hnac\admin_preciofijo.php - QUERY 3 */ SELECT
                    ...
                    if ($totalRows_Recordset12==0) {
                        $query_Recordset11 = sprintf(
                            "/* PARSEADORES1 new\admin_hnac\admin_preciofijo.php - QUERY 4 */ SELECT 
                        ...
                        if ($graba==30) {
                            ...
                            $insertSQL = sprintf(
                                "/* PARSEADORES1 new\admin_hnac\admin_preciofijo.php - QUERY 5 */ INSERT INTO precio_fijo_hnac (
        ...
        if ($graba==30) {
            ...
            if ($_POST["amax"]>0) {
                foreach ($_POST["id_pfijo_hnac"] as $id_pfijo_hnac) {
                    if ($id_pfijo_hnac>0) {
                        $insertSQL1 = sprintf(
                            "/* PARSEADORES1 new\admin_hnac\admin_preciofijo.php - QUERY 6 */ UPDATE precio_fijo_hnac SET max_eje_hnac=%s WHERE id_pfijo_hnac=%s",
            ...
            if ($_POST["jmax"]>0) {
                foreach ($_POST["id_pfijo_hnac"] as $id_pfijo_hnac) {
                    if ($id_pfijo_hnac>0) {
                        $insertSQL1 = sprintf(
                            "/* PARSEADORES1 new\admin_hnac\admin_preciofijo.php - QUERY 7 */ UPDATE precio_fijo_hnac SET max_jug_hnac=%s WHERE id_pfijo_hnac=%s",
            ...
            if ($_POST["pfijo"]>0) {
                foreach ($_POST["id_pfijo_hnac"] as $id_pfijo_hnac) {
                    if ($id_pfijo_hnac>0) {
                        $insertSQL1 = sprintf(
                            "/* PARSEADORES1 new\admin_hnac\admin_preciofijo.php - QUERY 8 */ UPDATE precio_fijo_hnac SET pre_fijo_hnac=%s WHERE id_pfijo_hnac=%s",
...
$query_Recordset11 = sprintf("/* PARSEADORES1 new\admin_hnac\admin_preciofijo.php - QUERY 9 */ SELECT 
	ag.nom_agencia, ag.cod_agencia 
	FROM agencia ag, taquilla ta, taquilla_opc_hnac tp
	WHERE ta.cod_agencia = ag.cod_agencia AND ta.cod_taquilla = tp.cod_taquilla
...
$query_Recordset10 = sprintf(
    "/* PARSEADORES1 new\admin_hnac\admin_preciofijo.php - QUERY 10 */ SELECT 
...
function ver() { 
    ...
    $.ajax({url:"admin_buscaEjemplar.php",type: "GET",data:xdata,
...
function verTaq(ti) {
    ...
    $.ajax({url:"admin_buscaTaquilla.php",type: "GET",data:xdata,
    	success: function(opciones){ 
...
function eliminar(cod) {
    ...
    $.ajax({url:"admin_quitarPrecioFijo.php",type: "GET",data:xdata, success: function(opciones){verTaq(1);}})
}
                                ...
                                <div id="oTaquillas" style="height:65px;text-align:left;width:400px;background:#E3E3E3;
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr align="center">
                                          ...
                                          <td width="25%">
                                          	PRECIO FIJO:
                                            <input name="pfijo"  type="text" onkeypress="javascript:return validarNro(event)"
