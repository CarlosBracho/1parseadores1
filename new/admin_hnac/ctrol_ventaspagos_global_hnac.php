...
require_once('../Connections/conexionbanca.php');
 if (isset($_POST["cod_control"])) {
     $insertSQL1 = sprintf(
         "/* PARSEADORES1 new\admin_hnac\ctrol_ventaspagos_global_hnac.php - QUERY 1 */ UPDATE ctrol_ventpag_global_hnac
		SET
     ...
     $query_Recordset13 = sprintf("/* PARSEADORES1 new\admin_hnac\ctrol_ventaspagos_global_hnac.php - QUERY 2 */ SELECT * FROM ctrol_ventpag_global_hnac WHERE cod_ctrol_ventpag_global_hnac = 1");
