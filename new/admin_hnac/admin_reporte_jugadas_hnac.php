        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_agente']!="todos") {
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\admin_hnac\admin_reporte_jugadas_hnac.php - QUERY 1 */ SELECT 
				...
				WHERE
					...
					venta_hnac.hor_venta_hnac DESC",
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && $_POST['id_agente']=="todos") ||
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\admin_hnac\admin_reporte_jugadas_hnac.php - QUERY 2 */ SELECT 
		venta_hnac.ip_venta_hnac,
		venta_hnac.ticket_hnac,
		venta_hnac.can_ticket_hnac,
		venta_hnac.fec_venta_hnac,
...
$query_Recordset2 = "/* PARSEADORES1 new\admin_hnac\admin_reporte_jugadas_hnac.php - QUERY 3 */ SELECT agencia.cod_agencia, agencia.nom_agencia FROM agencia ORDER BY agencia.nom_agencia";
...
<body onload="Javascript:history.go(1);" onunload="Javascript:history.go(1);">
   <div style="background: #099; width:100%; float:left; padding:50px 2px 2px 2px;
   ...
   <div style="background: #333; width:98%; float:left; padding:12px 13px 2px 12px;
    ...
    <table width="100%" border="0">
      <tr style="background:#0E5157; color:#FFF">
