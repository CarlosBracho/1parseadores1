...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\admin_hnac\admin_apertura_reabrir1_hnac.php - QUERY 1 */ SELECT 
...
$mtp_control=0;
$updateSQL = sprintf(
    "/* PARSEADORES1 new\admin_hnac\admin_apertura_reabrir1_hnac.php - QUERY 2 */ UPDATE 
			carrera_hnac 
			SET 
			hor_carrera_hnac=%s, 
			hor_carrera_hnac=%s, 
...
$descripcion="REABIERTA MANUALMENTE 1/2 minutos CARRERA <strong>".$nom_hipodro." Carr...".$num_carrera."</strong> por: <u>".$nom_usuario."</u>";
$insertSQL2 = sprintf(
    "/* PARSEADORES1 new\admin_hnac\admin_apertura_reabrir1_hnac.php - QUERY 3 */ INSERT 
				INTO bitacora 
