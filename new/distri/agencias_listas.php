...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\distri\agencias_listas.php - QUERY 1 */ SELECT * 
			FROM 
				agencia, 
				banca 
			WHERE 
				banca.cod_banca = agencia.cod_banca AND agencia.est_agencia = 1 AND
				banca.cod_banca = %s
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
  	<div style="height:100%; font-size:18px; padding:0px 0px 0px 0px ">
        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:right;">
            <a href="agencias_add.php" class="btn alert-success" 
            	style="font-size:24px; width:270px; height:30px; padding:10px 0px 0px 0px; background:#9C0; text-align:center ">
                Añadir Nuevo Agente
          </a>
        </div>

        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:right;">
            <a href="agencias_listasdesactivados.php" class="btn alert-success" 
            	style="font-size:24px; width:270px; height:30px; padding:10px 0px 0px 0px; background:#9C0; text-align:center ">
	...
	<td width="300">TIPO DE PAGO</td>
    <td width="412">SALDO DISPONIBLE</td>
	  ...
	  <td align="left"><?php
      if ($row_Recordset1['tipo_pagoa']==0) {
          echo 'POST PAGO';
      }
      if ($row_Recordset1['tipo_pagoa']==1) {
          echo 'PRE PAGO';
      }
      ...
      <td align="left"><?php echo $row_Recordset1['saldoactuala']/1; ?>
      </td>
            <td align="center"><?php echo ObtenerNombreStatus($row_Recordset1['est_agencia']); ?></td>
      <td align="center">
      	<a href='agencias_agregarsaldo.php?recordID=<?php echo $row_Recordset1['cod_agencia']; ?>'class="btn btn-info"> AGREGAR SALDO </a>
      </td>
            <td align="right">
            	<a href='agencias_edit.php?recordID=<?php echo $row_Recordset1['cod_agencia']; ?>'class="btn btn-info"> EDITAR </a>
            </td>
            </tr>
