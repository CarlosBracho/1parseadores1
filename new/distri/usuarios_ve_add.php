...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\distri\usuarios_ve_add.php - QUERY 1 */ INSERT 
		INTO usuario 
...
$query_Recordset2 = "/* PARSEADORES1 new\distri\usuarios_ve_add.php - QUERY 2 */ SELECT cod_taquilla, nom_taquilla FROM taquilla";
