...
$query_Recordset3 =  sprintf(
  "/* PARSEADORES1 new\distri\taquillas_add.php - QUERY 1 */ SELECT * 
FROM 
banca
WHERE cod_banca = %s",
...
if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
    if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
        ...
        $query_Recordset4 =  sprintf(
            "/* PARSEADORES1 new\distri\taquillas_add.php - QUERY 2 */ SELECT  
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==30) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\distri\taquillas_add.php - QUERY 3 */ INSERT 
				INTO taquilla 
...
taq_cob_hnac,
        ...
        $query_RecT = "/* PARSEADORES1 new\distri\taquillas_add.php - QUERY 4 */ SELECT cod_taquilla FROM taquilla ORDER BY cod_taquilla DESC LIMIT 1";
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 new\distri\taquillas_add.php - QUERY 5 */ INSERT 
		INTO usuario 
...
$msj='El Distribuidor '.$Dnom.' Creo una nueva Taquilla con el nombre: '.$tnom;
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 new\distri\taquillas_add.php - QUERY 6 */ SELECT ag.cod_agencia, ag.nom_agencia,
ba.dist_vende_ame,
ba.dist_vende_hnac
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\distri\taquillas_add.php - QUERY 7 */ SELECT ta.cod_taquilla, ta.nom_taquilla,
ba.dist_vende_ame,
ba.dist_vende_hnac
