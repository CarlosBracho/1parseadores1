...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $query_Recordset111 =  sprintf(
            "/* PARSEADORES1 new\distri\agencias_agregarsaldo.php - QUERY 1 */ SELECT
agencia.saldoactuala
	...
	agencia.cod_agencia = %s",
        ...
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\distri\agencias_agregarsaldo.php - QUERY 2 */ UPDATE agencia 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\distri\agencias_agregarsaldo.php - QUERY 3 */ SELECT
agencia.tipo_pagoa,
	agencia.nom_agencia,
	agencia.cod_banca,
...
$query_Recordset11 = sprintf(
    "/* PARSEADORES1 new\distri\agencias_agregarsaldo.php - QUERY 4 */ SELECT * FROM usuario 
	WHERE tip_usuario='G' 
