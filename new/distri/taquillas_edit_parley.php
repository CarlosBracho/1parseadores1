...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\distri\taquillas_edit_parley.php - QUERY 1 */ SELECT  
...
$query_Recordset4 =  sprintf(
    "/* PARSEADORES1 new\distri\taquillas_edit_parley.php - QUERY 2 */ SELECT  
*
...
if ($totalRows_Recordset4==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            ...
            $query_Recordset4 =  sprintf(
                "/* PARSEADORES1 new\distri\taquillas_edit_parley.php - QUERY 3 */ SELECT  
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        if ($_POST['existe']==1) {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 new\distri\taquillas_edit_parley.php - QUERY 4 */ UPDATE taquilla_opc_parley
					SET
					apu_maxparley=%s, 
					apu_minparley=%s,
                    comb_minparley=%s,
            ...
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 new\distri\taquillas_edit_parley.php - QUERY 5 */ INSERT 
			INTO 
			taquilla_opc_parley 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 new\distri\taquillas_edit_parley.php - QUERY 6 */ SELECT  
    tp.apu_mingan
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\distri\taquillas_edit_parley.php - QUERY 7 */ SELECT ta.cod_taquilla, ta.nom_taquilla
