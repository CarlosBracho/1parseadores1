...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\distri\agencias_edit.php - QUERY 1 */ UPDATE agencia 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\distri\agencias_edit.php - QUERY 2 */ SELECT
	agencia.nom_agencia,
	agencia.cod_banca,
...
$query_Recordset11 = sprintf(
    "/* PARSEADORES1 new\distri\agencias_edit.php - QUERY 3 */ SELECT * FROM usuario 
	WHERE tip_usuario='G' 
