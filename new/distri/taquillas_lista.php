...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\distri\taquillas_lista.php - QUERY 1 */ SELECT ta.nom_taquilla, ta.est_taquilla, ta.cod_taquilla, ag.nom_agencia
	FROM
		banca ba, 
		taquilla ta,
		agencia ag
	WHERE 
		...
		ba.cod_banca = %s AND ta.est_taquilla = 1 AND ta.tipotaquilla = 0
