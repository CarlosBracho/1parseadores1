...
<?php
$query_Recordset44 = sprintf("/* PARSEADORES1 new\distri\index.php - QUERY 1 */ SELECT 
	me.mensaje
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\distri\index.php - QUERY 2 */ SELECT * 
    FROM 
    bitacora, agencia, taquilla
    WHERE  
    agencia.cod_banca = %s AND 
