...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\distri_hnac\distri_usuarios_ve_lista_hnac.php - QUERY 1 */ SELECT taquilla.nom_taquilla, usuario.nom_usuario, usuario.est_usuario, usuario.id_usuario,
	agencia.nom_agencia
	FROM
	banca, 
	taquilla,
