...
$query_Recordset81 = sprintf(
    "/* PARSEADORES1 new\agente_hnac\baseAgente_hnac\ventas_carrera_ta.php - QUERY 1 */ SELECT *, 
...
$query_Recordset82 = sprintf(
    "/* PARSEADORES1 new\agente_hnac\baseAgente_hnac\ventas_carrera_ta.php - QUERY 2 */ SELECT *
	FROM 
