...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\agente_hnac\agente_taquillas_add_hnac.php - QUERY 1 */ INSERT 
			INTO taquilla 
        ...
        $query_RecT = "/* PARSEADORES1 new\agente_hnac\agente_taquillas_add_hnac.php - QUERY 2 */ SELECT cod_taquilla FROM taquilla ORDER BY cod_taquilla DESC LIMIT 1";
...
%s, %s, %s, %s, %s
        ...
        $insertSQL2 = sprintf(
            "/* PARSEADORES1 new\agente_hnac\agente_taquillas_add_hnac.php - QUERY 4 */ INSERT 
		INTO usuario 
        ...
        $insertGoTo = "agente_taquillas_lista_hnac.php";
        if (isset($_SERVER['QUERY_STRING'])) {
...
if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
    if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
        $query_Recordset2 =  sprintf(
            "/* PARSEADORES1 new\agente_hnac\agente_taquillas_add_hnac.php - QUERY 5 */ SELECT * 
			FROM  
			taquilla_opc_hnac 
			WHERE 
			cod_taquilla = %s",
...
$has=50;
$query_Recordset3 = sprintf("/* PARSEADORES1 new\agente_hnac\agente_taquillas_add_hnac.php - QUERY 6 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
...
ORDER BY nom_taquilla", GetSQLValueString($_SESSION['MM_cod_agente'], "int"));
        ...
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>" onsubmit="return chequearEnvio();">
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              ...
              <table width="919" align="center" border="0" cellpadding="0" cellspacing="0" style="line-height:14px">
                ...
                <tr valign="baseline">
                  <td width="1" height="24" align="left" valign="middle" nowrap>&nbsp;</td>
                  <td colspan="2" align="left" valign="middle" nowrap>&nbsp;</td>
              ...
              <table width="924" align="center">
                <tr valign="baseline">
                  ...
                  <a href='agente_taquillas_lista_hnac.php'
