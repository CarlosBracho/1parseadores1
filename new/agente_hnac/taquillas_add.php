...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\agente_hnac\taquillas_add.php - QUERY 1 */ INSERT 
				INTO taquilla 
        ...
        $query_RecT = "/* PARSEADORES1 new\agente_hnac\taquillas_add.php - QUERY 2 */ SELECT cod_taquilla FROM taquilla ORDER BY cod_taquilla DESC LIMIT 1";
        ...
        $insertSQL2 = sprintf(
            "/* PARSEADORES1 new\agente_hnac\taquillas_add.php - QUERY 3 */ INSERT 
		INTO 
		taquilla_opc_ame 
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 new\agente_hnac\taquillas_add.php - QUERY 4 */ INSERT 
		INTO usuario 
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
        	...
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              <table width="919" align="center">
                ...
                <tr valign="baseline">
                  ...
                  <input type="text" name="nom_representante" class="textbox" tabindex="2" placeholder="nombre de representante"
                  value="" required
              ...
              <table width="920" align="center">
                ...
                <tr valign="baseline">
                  ...
                  <td>&nbsp;</td>
                  <td align="right" valign="middle" style="font-size:12px"><span style="font-size:14px">Porcentaje:</span></td>
    ...
    if ($i<10) {
        ...
        $v=$i;
          ...
          <input type="hidden" name="cod_agencia" value="<?php echo $_SESSION['MM_cod_agente'] ?>"/>
