...
if ($nomb=="") {
    $query_Recordset3 = sprintf("/* PARSEADORES1 new\agente_hnac\ventas_reporte_jugadas_hnac.php - QUERY 1 */ SELECT nom_usuario FROM usuario WHERE usuario.id_usuario = %s AND tip_usuario='U' 
	LIMIT 1", GetSQLValueString($codigoUsuario, "int"));
    $Recordset3 = mysqli_query($conexionbanca, $query_Recordset3) or die(mysqli_error($conexionbanca));
    $row_Recordset3 = mysqli_fetch_assoc($Recordset3);
    $nomb=strtoupper($row_Recordset3['nom_usuario']);
}
$query_Recordset2 = sprintf("/* PARSEADORES1 new\agente_hnac\ventas_reporte_jugadas_hnac.php - QUERY 2 */ SELECT usuario.nom_usuario, usuario.id_usuario, taquilla.nom_taquilla FROM usuario, taquilla 
    ...
    if ($totalRows_Recordset1>0) {
        ...
        do {?>
		  <tr onmouseover="cambiacolor_over(this)" onmouseout="cambiacolor_out(this)" height="20" style="background:# FFF">
			...
			<td width="293" align="left" style="font-size:12px">
				<?php
                ...
                if ($row_Recordset1['est_ticket_hnac']==4) {
                    echo ' <font color="red" size="-8">(RETIRO)';
                }
                if ($row_Recordset1['est_ticket_hnac']==5) {
                    echo ' <font color="red" size="-8">(INVALIDADO)';
                }
                $pago=0;
                $pa[0]=0;
                $pa[1]="";
			...
			<td width="60" align="center">
				<?php
                if ($row_Recordset1['est_ticket_hnac']!=1) {
                    echo horaampm($row_Recordset1['hor_pago_hnac']);
                } else {
                    echo "-";
                }?>
            </td>
      ...
      <tr bgcolor="#999999" style="font-size:18px;" height="30">
        ...
        <td width="62" align="right"><strong><?php echo number_format($totalventa, 2, ",", "."); ?></strong></td>
        <td width="62" align="right"><strong> <?php echo " ".number_format($totalPagado, 2, ",", "."); ?></strong></td>
        <td width="100" align="center">&nbsp;</td>
        <td width="60" align="center">&nbsp;</td>
        <td width="60" align="center">&nbsp;</td>
      </tr>
      <tr bgcolor="#999999" style="font-size:20px;" height="30">
        <td colspan="8" align="right"><strong>TOTAL GENERAL:</strong></td>
        <td align="right"><strong><?php echo number_format($totalGeneral, 2, ",", "."); ?></strong></td>
