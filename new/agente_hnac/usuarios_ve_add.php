...
$codAgencia=$_SESSION['MM_cod_agente'];
$xCodigo=0;
$menNus="";
$menNcus="";
$menPass="";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\agente_hnac\usuarios_ve_add.php - QUERY 1 */ INSERT 
		INTO usuario 
		(nom_usuario, nom_completo, tip_usuario, cod_taquilla, pas_usuario, est_usuario, tic_eliminados, 
		cod_barra, hor_inicio, hor_fin, dia_entrada, niv_acceso, ini_programa) 
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 new\agente_hnac\usuarios_ve_add.php - QUERY 2 */ SELECT cod_taquilla, nom_taquilla 
	FROM 
	taquilla 
	WHERE 
	cod_agencia = %s",
        	...
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              <table width="919" align="center">
                ...
                <tr valign="baseline">
                  ...
                  <td width="365" align="left" valign="middle" nowrap>Taquilla:<br>
                    <select name="cod_taquilla" style="width:227px; height: auto" class="textbox">
                    <?php
                    do {
                        ?>
