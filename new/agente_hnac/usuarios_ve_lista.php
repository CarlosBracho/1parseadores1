...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\agente_hnac\usuarios_ve_lista.php - QUERY 1 */ SELECT taquilla.nom_taquilla, usuario.nom_usuario, usuario.est_usuario, usuario.id_usuario
	FROM 
	taquilla,
	agencia,
	usuario
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
  	<div style="height:100%; font-size:18px; padding:0px 0px 0px 0px ">
        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:right;">
            <a href="../agente - Copia/usuarios_ve_add.php" class="btn alert-success" 
	...
	<table width="100%" border="0" align="center">
          ...
          <td width="306">NOMBRE VENDEDOR</td>
          <td width="293">TAQUILLA</td>
        ...
        <?php do { ?>
          <tr class="brillo">
            ...
            <td align="center">
               <a href='../agente - Copia/usuarios_ve_edit.php?recordID=<?php echo $row_Recordset1['id_usuario']; ?>'class="btn btn-info"> EDITAR </a>
            </td>
          </tr>
      ...
      <table width="100%" border="0" align="center" style="background:#5EAEFF; color:#FFFFFF; height:30px">
  		<tr style="background:#5EAEFF; color:#FFFFFF; height:30px">
          <td width="293">NOMBRE VENDEDOR</td>
          <td width="353">TAQUILLA</td>
