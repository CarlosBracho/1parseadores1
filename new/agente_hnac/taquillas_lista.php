...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\agente_hnac\taquillas_lista.php - QUERY 1 */ SELECT taquilla.nom_taquilla, taquilla.nom_representante, taquilla.est_taquilla, taquilla.cod_taquilla 
	FROM 
	taquilla,
	agencia
	WHERE agencia.cod_agencia = taquilla.cod_agencia AND
...
<div class="container">
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
  	<div style="height:100%; font-size:18px; padding:0px 0px 0px 0px ">
        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:right;">
            <a href="../agente - Copia/taquillas_add.php" class="btn alert-success" 
  ...
  <?php do { ?>
    <tr class="brillo" >
      ...
      <td><?php echo $row_Recordset1['nom_representante']; ?></td>
      <td align="center"><?php echo ObtenerNombreStatus($row_Recordset1['est_taquilla']); ?></td>
      <td align="center">
      	<a href='../agente - Copia/taquillas_edit.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'class="btn btn-info"> EDITAR </a>
      </td>
    </tr>
