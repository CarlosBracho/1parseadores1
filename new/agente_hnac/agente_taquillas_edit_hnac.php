...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\agente_hnac\agente_taquillas_edit_hnac.php - QUERY 1 */ SELECT  
	ta.nom_taquilla,
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\agente_hnac\agente_taquillas_edit_hnac.php - QUERY 2 */ UPDATE taquilla 
...
$query_Recordset2 =  sprintf(
    "/* PARSEADORES1 new\agente_hnac\agente_taquillas_edit_hnac.php - QUERY 5 */ SELECT * FROM taquilla_opc_hnac tp, taquilla ta, agencia ag
	WHERE tp.cod_taquilla = %s AND ag.cod_agencia = ta.cod_agencia AND ag.cod_agencia = %s",
...
if ($totalRows_Recordset2==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            ...
            $query_Recordset2 =  sprintf(
                "/* PARSEADORES1 new\agente_hnac\agente_taquillas_edit_hnac.php - QUERY 6 */ SELECT * 
				FROM  
				taquilla_opc_hnac 
				WHERE 
				cod_taquilla = %s",
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\agente_hnac\agente_taquillas_edit_hnac.php - QUERY 7 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
