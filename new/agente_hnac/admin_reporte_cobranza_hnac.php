        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_distribuidor']!="todos") {
                $query_Recordset10 = sprintf(
                    "/* PARSEADORES1 new\agente_hnac\admin_reporte_cobranza_hnac.php - QUERY 1 */ SELECT cod_banca, nom_banca, tel_banca, cor_banca, por_banca_hnac 
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && $_POST['id_distribuidor']=="todos") ||
    ...
    $query_Recordset10 = sprintf("/* PARSEADORES1 new\agente_hnac\admin_reporte_cobranza_hnac.php - QUERY 2 */ SELECT cod_banca, nom_banca, tel_banca, cor_banca, por_banca_hnac FROM banca");
    $v=0;
}
...
$query_Recordset2 = sprintf("/* PARSEADORES1 new\agente_hnac\admin_reporte_cobranza_hnac.php - QUERY 3 */ SELECT cod_taquilla, nom_taquilla FROM taquilla ORDER BY nom_taquilla ASC");
       ...
       <div style="background: #FFF; width:100%; float:left; padding:5px 0px 0px 10px;
           ...
           <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" autocomplete="off"  
                ...
                <input name="fecha_fin" type="text" id="dateArrival2"  tabindex="2" 
                 ...
                 Taquillas:
             <select name="id_distribuidor" id="soflow" style="height:40px; width:350px; margin:-9px 0px 0px 0px ">
           ...
           if ($totalRows_Recordset10>0) {
               do {
                   ...
                   echo "| Correo: ".$row_Recordset10['cor_banca']; ?>
                    ...
                    <tr style="background:#0E5157; color:#FFF; border-color:#5EAEFF;" valign="middle" align="center">
                        <td width="145">TAQUILLA</td>
                        ...
                        <td width="69">% COBRO SISTEMA A TAQUILLA</td>
                        <td width="112">TOTAL A COBRAR AGENTE</td>
                    </tr><?php
                    $codBanca=$row_Recordset10['cod_banca'];
                   $porBanca=$row_Recordset10['por_banca_hnac'];
                   $query_Recordset3 = sprintf(
                       "/* PARSEADORES1 new\agente_hnac\admin_reporte_cobranza_hnac.php - QUERY 4 */ SELECT cod_agencia, nom_agencia, por_agencia_hnac
                   ...
                   if ($totalRows_Recordset3>0) {
                       do {
                           ...
                           $query_Recordset1 = sprintf(
                               "/* PARSEADORES1 new\agente_hnac\admin_reporte_cobranza_hnac.php - QUERY 5 */ SELECT
							por_agencia_hnac,
