...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\agente_hnac\agente_taquillas_lista_hnac.php - QUERY 1 */ SELECT ta.nom_taquilla, ta.nom_representante, ta.est_taquilla, ta.cod_taquilla, ta.nom_representante 
	FROM 
	taquilla ta,
	agencia ag
	WHERE ag.cod_agencia = ta.cod_agencia AND
	ag.cod_agencia = %s
	ORDER BY 
	ta.nom_taquilla",
...
<div style="height:100%; font-size:18px;" class="xfirefox">
    ...
    <table width="100%" border="0" align="center" style="background: #0E5157; color:#FFF; font-size:14px" >
        <tr>
          <td height="37" colspan="5" align="right" bgcolor="#FFFFFF" class="diezpunto">&nbsp;</td>
        </tr>
        <tr>
    ...
    <td width="299">TAQUILLA</td>
    <td width="293">REPRESENTANTE</td>
    <td width="236">STATUS</td>
    <td>ACCIONES</td>
  </tr>
  <?php do { ?>
    <tr class="brillo" >
      <td align="left"><?php echo $row_Recordset1['nom_taquilla']; ?></td>
      <td align="left"><?php echo $row_Recordset1['nom_representante']; ?></td>
      <td align="center"><?php echo ObtenerNombreStatus($row_Recordset1['est_taquilla']); ?></td>
      <td align="center">
      	<a href='agente_taquillas_edit_hnac.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'class="btn btn-info"> EDITAR </a>
      </td>
    </tr>
