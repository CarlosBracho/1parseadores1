...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\agente_hnac\taquillas_edit.php - QUERY 1 */ UPDATE taquilla 
        ...
        $insertSQL2 = sprintf(
            "/* PARSEADORES1 new\agente_hnac\taquillas_edit.php - QUERY 2 */ UPDATE taquilla_opc_ame
				SET 
				apu_maxgan=%s, 
				apu_maxpla=%s, 
				apu_maxsho=%s, 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\agente_hnac\taquillas_edit.php - QUERY 3 */ SELECT  
