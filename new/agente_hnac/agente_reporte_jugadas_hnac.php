        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_taquilla']!="todos") {
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\agente_hnac\agente_reporte_jugadas_hnac.php - QUERY 1 */ SELECT 
						agencia.nom_agencia,
...
USE INDEX(id_us_fe_fe)
                ...
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\agente_hnac\agente_reporte_jugadas_hnac.php - QUERY 2 */ SELECT 
						agencia.nom_agencia,
						venta_hnac.est_ticket_hnac,
						venta_hnac.ser_venta_hnac,
						venta_hnac.ticket_hnac,
...
USE INDEX(id_us_fe_fe)
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\agente_hnac\agente_reporte_jugadas_hnac.php - QUERY 3 */ SELECT 
			agencia.nom_agencia,
			venta_hnac.est_ticket_hnac,
			venta_hnac.ser_venta_hnac,
			venta_hnac.ticket_hnac,
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 new\agente_hnac\agente_reporte_jugadas_hnac.php - QUERY 4 */ SELECT nom_taquilla, cod_taquilla 
	FROM 
		taquilla 
	WHERE 
