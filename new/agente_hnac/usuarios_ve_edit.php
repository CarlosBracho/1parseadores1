...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $_POST['tip_usuario']="U";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\agente_hnac\usuarios_ve_edit.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
				est_usuario=%s, 
        ...
        $insertGoTo = "usuarios_ve_lista.php";
        if (isset($_SERVER['QUERY_STRING'])) {
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\agente_hnac\usuarios_ve_edit.php - QUERY 2 */ SELECT * 
	FROM 
	usuario, taquilla 
	WHERE 
              ...
              <table width="921" align="center">
                <tr valign="baseline">
                  ...
                  <td width="212">
                    ...
                    placeholder="contraseña" maxlength="20" style="height: auto" required="required"
    ...
    echo "SELECTED";
              ...
              <table width="920" border="0">
                ...
                <tr valign="baseline">
                  ...
                  <a href='../agente - Copia/usuarios_ve_lista.php'
