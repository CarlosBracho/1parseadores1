...
<style type="text/css">#contenedor {width: 55%; margin: 0 auto; padding: 50px 0px 0px 10px; font-size:24px;}</style> 
</head>
<body style="margin: center">
    <div id="contenedor">
        ...
        <div style="width:540px; float:left; line-height:20px; font-size:18px">
			...
			<?php
            $error="<h1>Agente desactivado.</h1>";
