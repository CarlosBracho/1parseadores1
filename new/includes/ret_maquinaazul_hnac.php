...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\includes\ret_maquinaazul_hnac.php - QUERY 1 */ SELECT * 
	FROM 
	hipodromo_hnac,
	carrera_hnac 
	WHERE
...
if ($totalRows_Recordset1>0) {
            ...
            if (isset($retiro[$nc][0])) {
                ...
                foreach ($retiro[$nc] as $pr) {
                    ...
                    $query_Recordset2 = sprintf(
                        "/* PARSEADORES1 new\includes\ret_maquinaazul_hnac.php - QUERY 2 */ SELECT * 
	FROM 
	inscritos
	WHERE
	...
	inscritos.est_inscrito_hnac = %s",
                    ...
                    if ($totalRows_Recordset2==1) {
                        $insertSQL = sprintf(
                            "/* PARSEADORES1 new\includes\ret_maquinaazul_hnac.php - QUERY 3 */ UPDATE inscritos
				SET 
				est_inscrito_hnac=%s  
