<?php
if (isset($car)) {
    $query_Recordset0 = sprintf("/* PARSEADORES1 new\includes\procesar_ticket_retirados_hnac.php - QUERY 1 */ SELECT ta.cod_taquilla 
    ...
    if ($totalRows_Recordset0>0) {
        ...
        do {
            ...
            $query_Recordset3 = sprintf(
                "/* PARSEADORES1 new\includes\procesar_ticket_retirados_hnac.php - QUERY 2 */ SELECT ve.num_ticket_hnac, ve.mon_venta_hnac, ve.num_caballo_hnac, ve.cod_tventa_hnac
				FROM 
				venta_hnac ve, 
				carrera_hnac ca, 
				usuario us,
            ...
            if ($totalRows_Recordset3>0) {
                ...
                if ($i>0) {
                    do {
                        $updateSQL3 = sprintf(
                            "/* PARSEADORES1 new\includes\procesar_ticket_retirados_hnac.php - QUERY 3 */ UPDATE venta_hnac 
