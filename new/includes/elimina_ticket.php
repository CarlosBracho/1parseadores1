...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\includes\elimina_ticket.php - QUERY 1 */ SELECT num_ticket, id_usuario 
	FROM 
	venta 
	WHERE 
	venta.ticket = %s",
...
if ($totalRows_Recordset3>0) {
    ...
    do {
        $updateSQL3 = sprintf(
            "/* PARSEADORES1 new\includes\elimina_ticket.php - QUERY 2 */ UPDATE venta SET est_ticket=%s, fec_pago=%s, hor_pago=%s WHERE num_ticket=%s",
