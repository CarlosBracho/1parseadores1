...
$apuestasminimaaganadorpc2='100';
$apuestasminimaaganadorsp3='0.20';

$query_Recordset1 =  sprintf("/* PARSEADORES1 new\includes\apuesta_minima_ganador_pormoneda.php - QUERY 1 */ SELECT  
...
echo "<br>";
    ...
    do {
        ...
        $query_Recordset2 =  sprintf(
            "/* PARSEADORES1 new\includes\apuesta_minima_ganador_pormoneda.php - QUERY 2 */ SELECT  
tp.apu_mingan
	...
	LIMIT 1",
        ...
        echo "<br>";
        echo $row_Recordset2['apu_mingan'];
        echo "<br>";
        ...
        if ($apuestasminimaausar > $row_Recordset2['apu_mingan'] && $totalRows_Recordset2 > 0) {
            $insertSQL11 = sprintf(
                "/* PARSEADORES1 new\includes\apuesta_minima_ganador_pormoneda.php - QUERY 3 */ UPDATE taquilla_opc_ame
					SET
					apu_mingan=%s
