...
$query_Recordset4 = sprintf(
    "/* PARSEADORES1 new\includes\infoultimo.php - QUERY 1 */ SELECT 
venta.ticket, 
venta.hor_venta 
FROM 
venta
...
$query_Recordset5 = sprintf(
    "/* PARSEADORES1 new\includes\infoultimo.php - QUERY 2 */ SELECT 
venta.ticket, 
venta.hor_venta, 
venta.cod_tventa,
venta.mon_venta,
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" 
        	style="line-height:12px; font-size:14px; background:#ddebef; color:#000000">
 <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" 
        	style="line-height:12px; font-size:16px; background:#ddebef; color:#000000">
        	<tr>
...
if ($efectivoO==5) {
 ...
 ?>
                </br></br>TOTAL:<font color="#000000"><?php echo ObtenerMonTototalVenta($row_Recordset4['ticket'])." "; ?>&nbsp;</font></td>
                </tr> 
        </table>
