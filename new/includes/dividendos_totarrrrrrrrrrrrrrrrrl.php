...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\includes\dividendos_totarrrrrrrrrrrrrrrrrl.php - QUERY 1 */ SELECT * 
	FROM 
	hipodromo,
	carrera 
	WHERE
                ...
                foreach ($cAct as $hip) {
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                        ...
                        if ((isset($eje1LugarSimple[$hip]) && isset($DivWinPriLugar[$hip]) && $eje1LugarSimple[$hip]>0 &&
                            ...
                            $updateSQL = sprintf(
                                "/* PARSEADORES1 new\includes\dividendos_totarrrrrrrrrrrrrrrrrl.php - QUERY 2 */ UPDATE carrera 
							SET 
								est_confirmacion=%s,
								control_dividendo=%s,
								eje_primero=%s, 
