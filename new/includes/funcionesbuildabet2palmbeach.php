...
{
    global $conexionbanca;
    $query_Recordset4 = "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 1 */ SELECT * FROM mensaje WHERE cod_mensaje = 1";
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 2 */ SELECT usuario.nom_usuario FROM usuario WHERE usuario.id_usuario = %s", $identificador);
...
} function buscaHip($identificador)
{
    ...
    $total=0;
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 3 */ SELECT nom_hipodromo FROM hipodromo  WHERE nom_hipodromo = %s LIMIT 1", GetSQLValueString($identificador, "text"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
} function buscaHip2($identificador)
{
    $identificador=strtoupper($identificador);
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 4 */ SELECT nom_hipodromo_hpi FROM hipodromo  WHERE nom_hipodromo = %s LIMIT 1", GetSQLValueString($identificador, "text"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
} function buscaHip3($identificador)
{
    ...
    $identificador=strtoupper($identificador);
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 5 */ SELECT nom_hipodromo FROM hipodromo  WHERE nom_hipodromo_hpi = %s LIMIT 1", GetSQLValueString($identificador, "text"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    if ($totalRows_ConsultaFuncion>0) {
...
function buscaHip4($identificador)
{
    ...
    $query_ConsultaFuncion = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 6 */ SELECT nom_hipodromo 
		FROM hipodromo 
...
function buscaHipBuild($identificador, $nomb)
{
    ...
    */
    $query_ConsultaFuncion = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 7 */ SELECT nom_hipodromo, cod_hipodromo, pre_build 
		FROM hipodromo 
		WHERE pre_build = %s 
		LIMIT 1",
        GetSQLValueString($identificador, "text")
...
function buscaHipPre($identificador)
{
    ...
    $total=0;
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 8 */ SELECT pre_hipodromo FROM hipodromo  WHERE pre_hipodromo = %s LIMIT 1", GetSQLValueString($identificador, "text"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    $total=$totalRows_ConsultaFuncion;
...
} function buscaTaq($identificador)
{
    ...
    $total=0;
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 9 */ SELECT nom_taquilla FROM taquilla  WHERE nom_taquilla = %s LIMIT 1", GetSQLValueString($identificador, "text"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    $total=$totalRows_ConsultaFuncion;
...
} function buscaUsu($identificador)
{
    ...
    $total=0;
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 10 */ SELECT nom_usuario FROM usuario  WHERE nom_usuario = %s LIMIT 1", GetSQLValueString($identificador, "text"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    $total=$totalRows_ConsultaFuncion;
...
} function buscaAge($identificador)
{
    ...
    $total=0;
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 11 */ SELECT nom_agencia FROM agencia  WHERE nom_agencia = %s LIMIT 1", GetSQLValueString($identificador, "text"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    $total=$totalRows_ConsultaFuncion;
...
} function buscaDis($identificador)
{
    ...
    $total=0;
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 12 */ SELECT banca.nom_banca FROM banca  WHERE banca.nom_banca = %s LIMIT 1", GetSQLValueString($identificador, "text"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    $total=$totalRows_ConsultaFuncion;
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 13 */ SELECT usuario.nom_usuario FROM usuario WHERE usuario.id_usuario = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 14 */ SELECT usuario.tic_eliminados FROM usuario WHERE usuario.id_usuario = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 15 */ SELECT uadmin.nom_uadmin FROM uadmin WHERE uadmin.cod_uadmin = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 16 */ SELECT banca.nom_banca FROM banca WHERE banca.cod_banca = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 17 */ SELECT banca.marquesina FROM banca WHERE banca.cod_banca = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 18 */ SELECT agencia.nom_agencia FROM agencia WHERE agencia.cod_agencia = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 19 */ SELECT agencia.nom_agencia FROM agencia WHERE agencia.cod_agencia = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 20 */ SELECT agencia.nom_agencia FROM agencia WHERE agencia.cod_agencia = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 21 */ SELECT usuario.cod_agencia FROM usuario WHERE usuario.id_usuario = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 22 */ SELECT taquilla.nom_taquilla FROM taquilla WHERE taquilla.cod_taquilla = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 23 */ SELECT taquilla.cod_agencia FROM taquilla WHERE taquilla.cod_taquilla = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 24 */ SELECT usuario.cod_taquilla FROM usuario WHERE usuario.id_usuario = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 25 */ SELECT * FROM taquilla WHERE taquilla.cod_agencia = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    $xtaquillas=array();
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 26 */ SELECT agencia.cod_banca FROM agencia WHERE agencia.cod_agencia = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 27 */ SELECT carrera.eje_primero, carrera.div_primero_gan FROM carrera WHERE carrera.nom_hipodromo = %s AND carrera.num_carrera = %s AND carrera.fec_carrera = %s LIMIT 1", GetSQLValueString($nomHip, "text"), GetSQLValueString($carAnt, "int"), GetSQLValueString($fecSis, "date"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    $res=1;
...
} function buscaResultadosLista($nomHip, $carAnt, $fecSis)
{
    $nomHip=trim($nomHip);
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 28 */ SELECT carrera.eje_primero, carrera.div_primero_gan FROM carrera WHERE carrera.nom_hipodromo = %s AND carrera.num_carrera = %s AND carrera.fec_carrera = %s LIMIT 1", GetSQLValueString($nomHip, "text"), GetSQLValueString($carAnt, "int"), GetSQLValueString($fecSis, "date"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    $resultado=1;
...
} function ObtenerFechaJugadaCarrera($identificador)
{
    $identificador=(int)$identificador;
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 29 */ SELECT carrera.fec_carrera FROM carrera WHERE carrera.cod_carrera = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
} function ObtenerHoraJugadaCarrera($identificador)
{
    $identificador=(int)$identificador;
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 30 */ SELECT carrera.hor_carrera FROM carrera WHERE carrera.cod_carrera = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
} function ObtenerStatusJugadaCarrera($identificador)
{
    $identificador=(int)$identificador;
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 31 */ SELECT carrera.est_carrera FROM carrera WHERE carrera.cod_carrera = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 32 */ SELECT carrera.can_caballos FROM carrera WHERE carrera.cod_carrera = %s LIMIT 1", GetSQLValueString($identificador, "int"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
} function ObtenerNombreynumeroJugadaCarrera($identificador)
{
    $identificador=(int)$identificador;
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 33 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
} function ObtenerStatusCarreraSinProcesar($identificador, $status)
{
    $identificador=(int)$identificador;
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 34 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", $identificador);
...
} function GanEjemplar($identificador)
{
    $identificador=(int)$identificador;
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 35 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", $identificador);
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $estatusdelacarrera=$row_Recordset1['est_carrera'];
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
...
} function ObtenerGanDivCarrera($identificador, $campo)
{
    $identificador=(int)$identificador;
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 36 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", $identificador);
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
...
function ObtenerUltimaVenta()
{
    global
$conexionbanca;
    $query_Recordset1 = "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 37 */ SELECT MAX(num_ticket) FROM venta";
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 38 */ SELECT * FROM venta WHERE venta.id_usuario = %s AND venta.est_ticket != 0 AND (venta.fec_venta BETWEEN %s AND %s)", GetSQLValueString($identificador, "int"), GetSQLValueString($fechaInicio, "date"), GetSQLValueString($fechaFin, "date"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $ventatotal=0;
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 40 */ SELECT * FROM venta WHERE venta.id_usuario = %s AND venta.est_ticket = 4 AND (venta.fec_venta BETWEEN %s AND %s)", GetSQLValueString($identificador, "int"), GetSQLValueString($fechaInicio, "date"), GetSQLValueString($fechaFin, "date"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $ventatotal=0;
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 41 */ SELECT * FROM venta WHERE venta.cod_taquilla = %s AND venta.est_ticket != 0 AND (venta.fec_venta BETWEEN %s AND %s)", GetSQLValueString($identificador, "int"), GetSQLValueString($fechaInicio, "date"), GetSQLValueString($fechaFin, "date"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $ventatotal=0;
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 42 */ SELECT * FROM venta WHERE venta.cod_taquilla = %s AND venta.cod_tventa = %s AND venta.est_ticket != 0 AND (venta.fec_venta BETWEEN %s AND %s)", GetSQLValueString($identificador, "int"), GetSQLValueString($tipoVenta, "int"), GetSQLValueString($fechaInicio, "date"), GetSQLValueString($fechaFin, "date"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $ventatotal=0;
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 43 */ SELECT * FROM venta WHERE venta.cod_taquilla = %s AND venta.est_ticket = 4 AND (venta.fec_venta BETWEEN %s AND %s)", GetSQLValueString($identificador, "int"), GetSQLValueString($fechaInicio, "date"), GetSQLValueString($fechaFin, "date"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $ventatotal=0;
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 44 */ SELECT * FROM venta 
...
} function ObtenerMonTototalVenta($identificador)
{
    $identificador=(int)$identificador;
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 45 */ SELECT * FROM venta WHERE venta.ticket = %s", $identificador, "int");
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $montojugada=0;
...
} function BuscarRetirados($identificador)
{
    $identificador=(int)$identificador;
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 46 */ SELECT * FROM retirados WHERE retirados.cod_carrera = %s ORDER BY retirados.num_rcaballo ASC", $identificador, "int");
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $retirados="";
...
} function bRetirados($identificador)
{
    $identificador=(int)$identificador;
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 47 */ SELECT * FROM retirados WHERE retirados.cod_carrera = %s ORDER BY retirados.num_rcaballo ASC", $identificador, "int");
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $retirados="";
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 48 */ SELECT retirados.cod_carrera FROM retirados WHERE retirados.cod_carrera = %s", GetSQLValueString($codCarrera, "int"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
...
} function RetiradosSimple($codcarrera, $ejemplar)
{
    ...
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 49 */ SELECT num_rcaballo FROM retirados  WHERE retirados.cod_carrera = %s AND retirados.num_rcaballo = %s LIMIT 1", GetSQLValueString($codcarrera, "int"), GetSQLValueString($ejemplar, "int"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    return $totalRows_Recordset1;
} function arrayRetirados($carrera)
{
    global $conexionbanca;
    $reti[0]="";
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 50 */ SELECT retirados.num_rcaballo FROM retirados WHERE retirados.cod_carrera = %s", GetSQLValueString($carrera, "int"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $s=0;
...
} function BuscarTicketEliminados($codusuario, $fechaactual)
{
    $totalRows_Recordset1=0;
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 51 */ SELECT est_ticket  FROM  venta  WHERE  venta.est_ticket = 0 AND  venta.id_usuario = %s AND  venta.fec_venta = %s GROUP BY ticket", GetSQLValueString($codusuario, "int"), GetSQLValueString($fechaactual, "date"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    return $totalRows_Recordset1;
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 52 */ SELECT * FROM venta, carrera WHERE venta.num_ticket = %s AND venta.cod_carrera = carrera.cod_carrera", GetSQLValueString($xTicket, "int"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $montoapagar=0;
...
{
    $query = "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 55 */ SELECT * from agencia order by nom_agencia";
...
{
    $query = "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 56 */ SELECT * FROM hijo order by hijo";
    mysql_select_db($dbname);
    $result = mysqli_query($conexionbanca, $query);
    echo "<select name='$nombre' id='$nombre'>";
...
{
    $query = "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 57 */ SELECT * FROM nieto order by nieto";
    mysql_select_db($dbname);
    $result = mysqli_query($conexionbanca, $query);
    echo "<select name='$nombre' id='$nombre'>";
...
function UltimoTicket($usu)
{
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 58 */ SELECT num_ticket, est_impresion, ticket 
		FROM venta 
		WHERE id_usuario = %s 
...
function CambiarEstImpresion($nti)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 59 */ SELECT num_ticket
		FROM venta 
		WHERE num_ticket = %s",
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 60 */ SELECT num_ticket 
		FROM venta 
...
{ //id usuario - tipo programa
    ...
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 61 */ SELECT can_actual, id_reimpresion
		FROM reimpresion 
...
function tipProHipodromo($identificador)
{
    ...
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 62 */ SELECT cod_hipodromo, pro_desde 
			FROM hipodromo 
...
function busHipodromo($identificador)
{
    ...
    $hipodromo[2]=-1;
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 63 */ SELECT cod_hipodromo, pro_desde FROM hipodromo WHERE pre_hipodromo = %s LIMIT 1", GetSQLValueString($identificador, "text"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    if ($totalRows_ConsultaFuncion>0) {
...
function verificarCarrera($identificador, $carr, $fecha)
{
    ...
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 64 */ SELECT est_carrera 
		FROM carrera  
...
function buscaHip5($identificador)
{
    ...
    $identificador=strtoupper($identificador);
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 65 */ SELECT cod_hipodromo, nom_hipodromo, bus_auto FROM hipodromo WHERE nom_hipodromo_rac = %s LIMIT 1", GetSQLValueString($identificador, "text"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    if ($totalRows_ConsultaFuncion>0) {
...
function buscaHip6($identificador)
{
    ...
    $identificador=strtoupper($identificador);
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 66 */ SELECT cod_hipodromo, nom_hipodromo, bus_auto FROM hipodromo WHERE pre_build = %s LIMIT 1", GetSQLValueString($identificador, "text"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    if ($totalRows_ConsultaFuncion>0) {
...
function buscaHipBuild5($identificador)
{
    ...
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 67 */ SELECT nom_hipodromo, bus_auto 
		FROM hipodromo 
		WHERE cod_hipodromo = %s 
		LIMIT 1",
...
{
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 68 */ SELECT est_carrera FROM carrera  WHERE cod_hipodromo = %s AND num_carrera = %s AND  fec_carrera = %s LIMIT 1", GetSQLValueString($cod, "int"), GetSQLValueString($num, "int"), GetSQLValueString($fec, "date"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    mysqli_free_result($ConsultaFuncion);
...
function verCarrera($nom, $num, $fec)
{
    ...
    if ($num>1) {
        $num=$num-1;
        $query_ConsultaFuncion = sprintf(
            "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 71 */ SELECT hor_carrera, est_carrera FROM carrera  
...
function hipodromoNac($busca)
{
    ...
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 72 */ SELECT cod_hipodromo_hnac, nom_hipodromo_hnac 
	FROM hipodromo_hnac
...
function buscaHip_hnac($identificador)
{
    ...
    $total=0;
    global $conexionbanca;
    $query_ConsultaFuncion = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 73 */ SELECT nom_hipodromo_hnac FROM hipodromo_hnac  WHERE nom_hipodromo_hnac = %s LIMIT 1", GetSQLValueString($identificador, "text"));
    $ConsultaFuncion = mysqli_query($conexionbanca, $query_ConsultaFuncion) or die(mysqli_error($conexionbanca));
    $row_ConsultaFuncion = mysqli_fetch_assoc($ConsultaFuncion);
    $totalRows_ConsultaFuncion = mysqli_num_rows($ConsultaFuncion);
    $total=$totalRows_ConsultaFuncion;
...
function cantRetirados_hnac($codCarrera)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 74 */ SELECT inscritos.cod_carrera_hnac FROM inscritos 
		WHERE 
...
function RetiradosSimple_hnac($codcarrera, $ejemplar)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 75 */ SELECT est_inscrito_hnac, cod_inscrito_hnac FROM inscritos 
...
function verRetirados_hnac($codcarrera)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 76 */ SELECT num_caballo_hnac, nom_caballo_hnac FROM inscritos 
...
function arrayRetiradosHNAC($carrera)
{
    ...
    $reti[0]="";
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 77 */ SELECT inscritos.num_caballo_hnac 
		FROM 
			inscritos 
		WHERE 
			inscritos.cod_carrera_hnac = %s AND
...
function buscaDivTaquilla($codCar, $fec, $codTaq, $tipVen, $lin)
{
    ...
    $query_Recordset111 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 78 */ SELECT 
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 79 */ SELECT ticket_hnac FROM venta_hnac WHERE fec_venta_hnac = %s AND id_usuario = %s GROUP BY ticket_hnac", GetSQLValueString($fechajugada, "date"), GetSQLValueString($identificador, "int"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
...
{
    global $conexionbanca;
    $query_Recordset1 = "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 80 */ SELECT MAX(num_ticket_hnac) FROM venta_hnac";
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
...
function favoritos_hnac($codcarrera, $ejemplar, $tipo)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 81 */ SELECT 
...
function MontodeEjempar($codTaq, $codCar, $numEje, $tipVen)
{
    ...
    $monto=0;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 82 */ SELECT 
			ve.est_ticket_hnac,
			SUM(mon_venta_hnac) as monto
			FROM
				usuario us,
...
function MontoFijo($codTaq, $codCar, $numEje)
{
    ...
    $monto=0;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 83 */ SELECT 
			pr.max_eje_hnac,
			pr.max_jug_hnac,
			pr.min_jug_hnac
			FROM
...
function inscritos_hnac($codcarrera)
{
    ...
    $query_Recordset = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 84 */ SELECT *
			FROM
				inscritos
			WHERE 
				cod_carrera_hnac = %s
...
function venPorCabUsu($cod, $usu, $num, $hoy)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 85 */ SELECT 
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 86 */ SELECT cod_carrera_hnac FROM carrera_hnac 
...
function ObtenerMonTototalVentaHNAC($identificador)
{
    $identificador=(int)$identificador;
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 87 */ SELECT mon_venta_hnac FROM venta_hnac WHERE venta_hnac.ticket_hnac = %s", $identificador, "int");
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $montojugada=0;
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 88 */ SELECT ve.est_ticket_hnac 
	FROM venta_hnac ve 
...
{
    global $conexionbanca;
    $query_Recordset2 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 89 */ SELECT ic.est_inscrito_hnac FROM inscritos ic 
...
function ctaRetTik_HNAC($retirados, $xnroTicket)
{
    $retiro=0;
    global $conexionbanca;
    $query_Recordset2 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 90 */ SELECT ve.num_caballo_hnac, ve.cod_tventa_hnac FROM venta_hnac ve
...
function retTicket_HNAC($retirados, $xnroTicket)
{
    $retiro=0;
    global $conexionbanca;
    $query_Recordset2 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 91 */ SELECT ve.num_caballo_hnac, ve.cod_tventa_hnac FROM venta_hnac ve
			WHERE ve.ticket_hnac = %s", GetSQLValueString($xnroTicket, "int"));
    $Recordset2 = mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
    $row_Recordset2 = mysqli_fetch_assoc($Recordset2);
    $tEjem = mysqli_num_rows($Recordset2);
...
function verificarPremio_hnac($xnroTicket, $uVenta)
{
    ...
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 92 */ SELECT 
                ...
                if ($row_Recordset1['cod_tventa_hnac']>=1 && $row_Recordset1['cod_tventa_hnac']<=3) {
                    ...
                    if ($defi_regla==0) {
                        $query_Recordset2 = sprintf(
                            "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 93 */ SELECT re.div_pago_hnac
                        ...
                        $query_Recordset2 = sprintf(
                            "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 94 */ SELECT re.div_pago_hnac, ic.est_favorito_hnac 
...
function buscaDivOficiales($codCar, $fec, $tipVen, $lin)
{
    ...
    $fac=0;
    $query_Recordset111 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 95 */ SELECT num_caballo_hnac, div_pago_hnac, cod_resultado_hnac, fac_div_hnac
...
function buscaDivOficialesSimple($codCar, $fec, $hasta)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 96 */ SELECT num_caballo_hnac
	FROM  resultados_oficiales_hnac
	WHERE 
...
function BuscarTicketEliminadosHNAC($codusuario, $fechaactual)
{
    $totalRows_Recordset1=0;
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 97 */ SELECT est_ticket_hnac  
		FROM venta_hnac 
...
function BuscarTicketVendidosHNAC($codigoTaquilla, $id_usuario, $in, $fi)
{
    ...
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 98 */ SELECT est_ticket_hnac  
		FROM 
			venta_hnac,
			taquilla,
			usuario,
...
function agenciaTopeLot($agencia, $loteria)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 99 */ SELECT top_ventaage FROM agencialoterias 
	WHERE agencialoterias.id_agencia = %s AND agencialoterias.id_loteria = %s LIMIT 1",
...
function numMontoVendidoLot($agencia, $numero, $loteria, $sig, $hoy)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 100 */ SELECT 
...
function horaCierreSorteo($identificador, $banca)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 101 */ SELECT hor_cierre FROM bancaloterias 
	WHERE bancaloterias.id_loteria = %s AND bancaloterias.id_banca = %s LIMIT 1",
        GetSQLValueString($identificador, "int"),
...
function NumBloqueado($xbanca, $numero)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 102 */ SELECT bloqueadoloterias.num_bloqueado FROM bloqueadoloterias
	WHERE bloqueadoloterias.id_banca = %s AND bloqueadoloterias.num_bloqueado = %s LIMIT 1",
        GetSQLValueString($xbanca, "int"),
        GetSQLValueString($numero, "text")
    );
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 103 */ SELECT nom_loteria FROM loterias 
...
function ObtenerNombreSigno($identificador)
{
    $nombresigno="";
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 104 */ SELECT nom_corto FROM signos 
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 105 */ SELECT id_terminal FROM loterias 
	WHERE loterias.id_loteria = %s LIMIT 1", GetSQLValueString($identificador, "int"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 106 */ SELECT id_triple FROM loterias WHERE id_loteria = %s LIMIT 1", $identificador, "int");
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
...
{
    global $conexionbanca;
    $query_Recordset1 = "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 107 */ SELECT num_ticket_lot FROM venta_loterias ORDER BY num_ticket_lot DESC LIMIT 1";
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 108 */ SELECT tip_loteria FROM loterias WHERE id_loteria = %s LIMIT 1", $identificador, "int");
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
...
function NombreSigno2($identificador)
{
    $nombresigno="";
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 109 */ SELECT nom_corto FROM signos WHERE id_signo = %s LIMIT 1", $identificador, "int");
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    if ($totalRows_Recordset1>0) {
...
function ObtenerNumeroJugada_lot($identificador, $fechajugada)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 110 */ SELECT ticket_lot FROM venta_loterias WHERE fec_venta_lot = %s AND id_usuario = %s
	GROUP BY ticket_lot", GetSQLValueString($fechajugada, "date"), GetSQLValueString($identificador, "int"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $contador=str_pad($totalRows_Recordset1, 5, "0", STR_PAD_LEFT);
...
{
    global $conexionbanca;
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 111 */ SELECT ticket_macu FROM venta_macu WHERE fec_venta_macu = %s AND id_usuario = %s GROUP BY ticket_macu", GetSQLValueString($fechajugada, "date"), GetSQLValueString($identificador, "int"));
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $contador=str_pad($totalRows_Recordset1, 5, "0", STR_PAD_LEFT);
...
function RetiradosSimple_macu($codcarrera, $ejemplar)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 112 */ SELECT est_inscrito_hnac, cod_inscrito_hnac FROM inscritos 
			WHERE cod_carrera_hnac = %s AND num_caballo_hnac = %s LIMIT 1",
        GetSQLValueString($codcarrera, "int"),
        GetSQLValueString($ejemplar, "int")
    );
...
function verifica_carrera_hnac($codcarrera)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 113 */ SELECT est_cierre_hnac, num_carrera_hnac FROM carrera_hnac 
...
{
    global $conexionbanca;
    $query_Recordset1 = "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 114 */ SELECT num_ticket_macu FROM venta_macu ORDER BY num_ticket_macu DESC";
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
...
function toTicIgual_macu($codTaq, $apta, $fecha, $codVen)
{
    global $conexionbanca;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 115 */ SELECT ve.num_ticket_macu FROM venta_macu ve, usuario us, taquilla ta
    ...
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 new\includes\funcionesbuildabet2palmbeach.php - QUERY 116 */ SELECT  
