<?php
    $query_Recordset10 = sprintf("/* PARSEADORES1 new\includes\reintegrar_ticket_hnac.php - QUERY 1 */ SELECT cod_hipodromo_hnac  
    ...
    if ($row_Recordset10['cod_hipodromo_hnac']==1) {
        $query_Recordset0 = sprintf("/* PARSEADORES1 new\includes\reintegrar_ticket_hnac.php - QUERY 2 */ SELECT ta.cod_taquilla FROM taquilla ta, taquilla_opc_hnac tp WHERE 
    ...
    if ($row_Recordset10['cod_hipodromo_hnac']==2) {
        $query_Recordset0 = sprintf("/* PARSEADORES1 new\includes\reintegrar_ticket_hnac.php - QUERY 3 */ SELECT ta.cod_taquilla FROM taquilla ta, taquilla_opc_hnac tp WHERE 
    ...
    if ($row_Recordset10['cod_hipodromo_hnac']==3) {
        $query_Recordset0 = sprintf("/* PARSEADORES1 new\includes\reintegrar_ticket_hnac.php - QUERY 4 */ SELECT ta.cod_taquilla FROM taquilla ta, taquilla_opc_hnac tp WHERE 
    ...
    if ($row_Recordset10['cod_hipodromo_hnac']==4) {
        $query_Recordset0 = sprintf("/* PARSEADORES1 new\includes\reintegrar_ticket_hnac.php - QUERY 5 */ SELECT ta.cod_taquilla FROM taquilla ta, taquilla_opc_hnac tp WHERE 
    ...
    if ($totalRows_Recordset0>0) {
        do {
            ...
            $query_Recordset1 = sprintf(
                "/* PARSEADORES1 new\includes\reintegrar_ticket_hnac.php - QUERY 6 */ SELECT ve.num_ticket_hnac
				FROM 
				venta_hnac ve, 
				carrera_hnac ca, 
				usuario us,
            ...
            if ($totalRows_Recordset1>0) {
                $updateSQL3 = sprintf(
                    "/* PARSEADORES1 new\includes\reintegrar_ticket_hnac.php - QUERY 7 */ UPDATE venta_hnac 
