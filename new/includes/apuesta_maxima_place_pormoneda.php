...
$apuestasminimaaganadorbss0='10000';
$apuestasminimaaganadorusd1='2';
$apuestasminimaaganadorpc2='2000';
$apuestasminimaaganadorsp3='1000';

$query_Recordset1 =  sprintf("/* PARSEADORES1 new\includes\apuesta_maxima_place_pormoneda.php - QUERY 1 */ SELECT  
...
echo "<br>";
    ...
    do {
        ...
        $query_Recordset2 =  sprintf(
            "/* PARSEADORES1 new\includes\apuesta_maxima_place_pormoneda.php - QUERY 2 */ SELECT  
tp.apu_maxpla
	...
	LIMIT 1",
        ...
        if ($apuestasminimaausar > $row_Recordset2['apu_maxpla'] && $totalRows_Recordset2 > 0) {
            $insertSQL11 = sprintf(
                "/* PARSEADORES1 new\includes\apuesta_maxima_place_pormoneda.php - QUERY 3 */ UPDATE taquilla_opc_ame
					SET
					apu_maxpla=%s
