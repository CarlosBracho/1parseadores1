...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\includes\elimina_ticket_hnac.php - QUERY 1 */ SELECT num_ticket_hnac, id_usuario 
	FROM 
	venta_hnac 
	WHERE 
...
if ($totalRows_Recordset3>0) {
    ...
    do {
        $updateSQL3 = sprintf(
            "/* PARSEADORES1 new\includes\elimina_ticket_hnac.php - QUERY 2 */ UPDATE venta_hnac SET est_ticket_hnac=%s, fec_pago_hnac=%s, hor_pago_hnac=%s 
