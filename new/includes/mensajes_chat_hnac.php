...
/* PARSEADORES1 new\includes\mensajes_chat_hnac.php - QUERY 1 */ SELECT * 
FROM 
chat
WHERE sentdate=%s AND tipo=2
ORDER BY id desc", GetSQLValueString($fechasistema, "date"));
        ...
        if (trim($row_Recordset2['from1'])!="Soporte") {
            if (!in_array($row_Recordset2['from1'], $os)) {
                ...
                <table width="100%" border="0">
                    ...
                    <tr>
                        <td align="left"><?php echo " [".ObtenerNombreTaquilla($row_Recordset2['id_taquilla'])."]"; ?></td>
                    </tr>
                    <tr>
                ...
                -webkit-border-radius: 5px 5px 5px 5px; box-shadow: #aaa 1px 1px 6px; border: 1px solid #d4d4d4;">
                    <table width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <?php echo " a ".$row_Recordset2['to1']." [".ObtenerNombreTaquilla($row_Recordset2['id_taquilla'])."]"; ?> 
                            <em><?php
                            if ($fechasistema==$row_Recordset2['sentdate']) {
                                $dia="hoy";
                            } else {
...
?>
<script type="text/JavaScript">$("#mensajes").animate({ scrollTop: $('#mensajes')[0].scrollHeight}, 100);efectoX();</script>