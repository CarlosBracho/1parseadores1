...
<div id="menu" style="width:100%; font-size:12px">
    ...
    <?php if ($est_ame==1) {?>
    <div style="width:8%; height:34px; float: right; background:#0072C6; border:1px solid  #333; font-size:12px; 
    	margin:-17px 0px 0px 0px">
        <a style="color:#FFF" href="../ventasmie/index.php" title="ir a CARRERAS AMERICANAS">ir a carreras<br/>americanas</a>
    </div>
    <?php }?>
	<?php }?>
</div>
