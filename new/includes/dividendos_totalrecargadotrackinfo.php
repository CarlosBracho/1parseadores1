...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\includes\dividendos_totalrecargadotrackinfo.php - QUERY 1 */ SELECT * 
	FROM 
	hipodromo,
	carrera 
	WHERE
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                        ...
                        //if ($control_dividendo==2) $est_confirmacion=0;
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                    ...
                                    $updateSQL = sprintf(
                                        "/* PARSEADORES1 new\includes\dividendos_totalrecargadotrackinfo.php - QUERY 2 */ UPDATE carrera 
							SET 
							confirmandox=%s,
								est_confirmacion=%s,
								control_dividendo=%s,
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                        ...
                        //if ($control_dividendo==2) $est_confirmacion=0;
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                    ...
                                    $updateSQL = sprintf(
                                        "/* PARSEADORES1 new\includes\dividendos_totalrecargadotrackinfo.php - QUERY 3 */ UPDATE carrera 
							SET 
							confirmandox=%s,
								est_confirmacion=%s,
								control_dividendo=%s,
