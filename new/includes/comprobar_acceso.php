...
if (isset($_SESSION['MM_id_usuario'])) {
    if ($MM_authorizedUsers == "U") {
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 new\includes\comprobar_acceso.php - QUERY 1 */ SELECT 
			ba.est_banca, ag.est_agencia, ta.est_taquilla, us.est_usuario, us.nom_usuario, ta.cod_taquilla,
ag.agen_vende_ame,
ag.agen_vende_hnac,
...
ta.taq_vende_parley			
        ...
        if ($totalRows_Recordset11<=0) {
            ...
            if ($row_Recordset11['est_banca']==0 or $row_Recordset11['est_banca']==2 or
                $row_Recordset11['est_agencia']==0 or $row_Recordset11['est_agencia']==2 or
                $row_Recordset11['est_taquilla']==0 or $row_Recordset11['est_taquilla']==2) {
    ...
    if ($MM_authorizedUsers == "C") {
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 new\includes\comprobar_acceso.php - QUERY 2 */ SELECT 
			ba.est_banca, ag.est_agencia, ta.est_taquilla, us.est_usuario, us.nom_usuario, ta.cod_taquilla,
ag.agen_vende_ame,
ag.agen_vende_hnac,
ba.dist_vende_ame,
...
ta.taq_vende_hnac			
    ...
    if ($MM_authorizedUsers == "G") {
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 new\includes\comprobar_acceso.php - QUERY 3 */ SELECT 
			ba.est_banca, ag.cod_agencia, ag.nom_agencia, ag.est_agencia, us.est_usuario,
...
ba.dist_vende_parley
        ...
        if ($totalRows_Recordset11<=0) {
            ...
            $_SESSION['MM_systemE']=-1;
            if ($row_Recordset11['est_banca']==0 or $row_Recordset11['est_banca']==2 or
                $row_Recordset11['est_agencia']==0 or $row_Recordset11['est_agencia']==2) {
                if (is_file("no_acceso_usuario.php")) {
                    $MM_redirectLoginSuccess = "no_acceso_usuario.php";
                }
    ...
    if ($MM_authorizedUsers == "D") {
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 new\includes\comprobar_acceso.php - QUERY 4 */ SELECT 
			ba.cod_banca, ba.nom_banca, ba.est_banca, ba.mod_resultado, us.est_usuario, ba.dist_vende_parley
        ...
        if ($totalRows_Recordset11<=0) {
            ...
            $_SESSION['MM_systemE']=-1;
            if ($row_Recordset11['est_banca']==0 or $row_Recordset11['est_banca']==2) {
                if (is_file("no_acceso_usuario.php")) {
                    $MM_redirectLoginSuccess = "no_acceso_usuario.php";
                }
