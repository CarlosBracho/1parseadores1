...
function verfechaactual()
{
    ...
    switch ($dia) {  case "1": $dia_nombre="Lunes"; break;  case "2": $dia_nombre="Martes"; break;  case "3": $dia_nombre="Mi&eacute;rcoles"; break;  case "4": $dia_nombre="Jueves"; break;  case "5": $dia_nombre="Viernes"; break;  case "6": $dia_nombre="Sabado"; break;  case "0": $dia_nombre="Domingo"; break;  }
...
} function fechaymd($fechavieja)
{
    ...
    return $a."-".$m."-".$d;
}function fechaymdadmy($fechavieja)
{
    list($a, $m, $d)=explode("-", $fechavieja);
    return $d."-".$m."-".$a;
