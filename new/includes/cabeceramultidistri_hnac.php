...
document.onmousedown = RClick
	...
	window.open("../multidistri_hnac/distri_reporte_jugadas_hnac.php","_blank",propiedades2); 
	}
</script>
<div style="font-size:12px; margin:1px 0px 0px 0px">
<ul class="dropdown dropdown-horizontal" style="font-size:12px">
	<li>
    	 <a href="../multidistri/distri_reporte_general_total.php">Reporte<br/>global</a>
    </li>
	<li>
    	 <a href="../multidistri_hnac/distri_control_venta_carrera.php">Reporte carrera a carrera<br/>Carreras Nacionales</a>
    </li>
	<li>
