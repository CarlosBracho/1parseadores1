...
<nav>
    <ul>
        <li><a href="../agente/index.php">Carreras <br/>Americanas</a></li>
        <li><a href="../agente_hnac/index.php">CARRERAS <br/>NACIONALES</a></li>
		<li><a href="../agente/1parley.php">PARLEY <br/><br/></a></li>
        <li><a href="../apostador/listaapostadoraa.php">LISTA <br/>APOSTADORES</a></li>
