...
$query_Recordset1 =  sprintf("/* PARSEADORES1 new\includes\apuesta_maxima_show_pormoneda.php - QUERY 1 */ SELECT  
...
echo "<br>";
    ...
    do {
        ...
        $query_Recordset2 =  sprintf(
            "/* PARSEADORES1 new\includes\apuesta_maxima_show_pormoneda.php - QUERY 2 */ SELECT  
tp.apu_maxsho
	...
	LIMIT 1",
        ...
        if ($apuestasminimaausar > $row_Recordset2['apu_maxsho'] && $totalRows_Recordset2 > 0) {
            $insertSQL11 = sprintf(
                "/* PARSEADORES1 new\includes\apuesta_maxima_show_pormoneda.php - QUERY 3 */ UPDATE taquilla_opc_ame
					SET
					apu_maxsho=%s
