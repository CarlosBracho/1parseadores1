...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\includes\dividendos_total.php - QUERY 1 */ SELECT * 
	FROM 
	hipodromo,
	carrera 
	WHERE
...
(hipodromo.bus_resultado_tip = 1 OR hipodromo.bus_resultado_tip = 3) AND
            ...
            if (isset($cAct) && isset($cAct[0]) && $cAct[0]>0) {
                foreach ($cAct as $hip) {
					...
					<?php
                        ...
                        //aqui comienza
                        if ($row_Recordset1['valorbuildabet']==1 or  $row_Recordset1['bus_resultado_tip']==1) {
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                ...
                                $updateSQL = sprintf(
                                    "/* PARSEADORES1 new\includes\dividendos_total.php - QUERY 2 */ UPDATE carrera 
							SET 
								est_confirmacion=%s,
								control_dividendo=%s,
								eje_primero=%s, 
                        ...
                        if ($row_Recordset1['valorbuildabet']==2 && $row_Recordset1['bus_resultado_tip']==3) {
                            if ($row_Recordset1['control_dividendo']==1) {
                                if ($row_Recordset1['eje_primero']==$eje_primero*1 &&
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                ...
                                $updateSQL = sprintf(
                                    "/* PARSEADORES1 new\includes\dividendos_total.php - QUERY 3 */ UPDATE carrera 
							SET 
								est_confirmacion=%s,
								control_dividendo=%s,
								eje_primero=%s, 
