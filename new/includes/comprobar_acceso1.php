...
if (isset($_SESSION['MM_id_usuario'])) {
    if ($MM_authorizedUsers == "U") {
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 new\includes\comprobar_acceso1.php - QUERY 1 */ SELECT est_agencia
    ...
    if ($MM_authorizedUsers == "G") {
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 new\includes\comprobar_acceso1.php - QUERY 2 */ SELECT cod_agencia, nom_agencia, est_agencia
    ...
    if ($MM_authorizedUsers == "D") {
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 new\includes\comprobar_acceso1.php - QUERY 3 */ SELECT cod_banca, nom_banca, est_banca 
			FROM 
				banca, usuario
			WHERE
