...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\autopagoticket.php - QUERY 1 */ SELECT 
	ve.fec_venta, 
	ve.ticket, 
	ve.cod_cliente,
	ve.tra_codigo,
...
$query_Recordset7 = sprintf("/* PARSEADORES1 new\includes\autopagoticket.php - QUERY 2 */ SELECT est_control_pagos_ame FROM ctrol_ventpag_global_ame WHERE cod_ctrol_ventpag_global_ame = 1");
    ...
    if ($acceso==1 && $est_control_pagos==0) {
        if ($totalRows_Recordset1>0) {
            do {
                ...
                $insertSQL15 = sprintf(
                    "/* PARSEADORES1 new\includes\autopagoticket.php - QUERY 3 */ UPDATE venta
				SET
				venta.est_ticket=%s, 
				venta.fec_pago=%s, 
                ...
                $query_Recordset13 = sprintf(
                    "/* PARSEADORES1 new\includes\autopagoticket.php - QUERY 4 */ SELECT MAX(Idbalancecli) 
                ...
                $query_Recordset14 = sprintf(
                    "/* PARSEADORES1 new\includes\autopagoticket.php - QUERY 5 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
                    GetSQLValueString($row_Recordset1['efectivoO'], "int"),
                ...
                $query_Recordset15 = sprintf(
                    "/* PARSEADORES1 new\includes\autopagoticket.php - QUERY 6 */ SELECT jugada
					FROM balanceclientes
					WHERE modulo = %s AND
					 numticket = %s",
                ...
                $insertSQL155 = sprintf(
                    "/* PARSEADORES1 new\includes\autopagoticket.php - QUERY 7 */ INSERT INTO balanceclientes  
