...
*/
$query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\mensajes_chat_mostrar_hnac.php - QUERY 1 */ SELECT * FROM chat2 WHERE (from1=%s OR to1=%s) AND tipo = 2 ORDER BY id", GetSQLValueString($de, "text"), GetSQLValueString($de, "text"));
$Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
$row_Recordset1 = mysqli_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysqli_num_rows($Recordset1);
