...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\dividendos_total2.php - QUERY 1 */ SELECT * 
	FROM 
	hipodromo,
	carrera 
	WHERE
...
<table width="100%" border="0">
  <tr>
  	...
  	<td width="417" height="41" align="right" valign="middle" style="font-size:36px; color:#000000"><?php echo $horasistema ?></td>
            ...
            if (isset($cAct)) {
                foreach ($cAct as $hip) {
                    if ($hip==$row_Recordset1['num_carrera']) {
                        ?>
                    <table width="100%" border="1" bordercolor="#F90">
					  <tr>
					  ...
					  <tr>
					    <td height="10" colspan="6" align="left" valign="top"><hr/></td>
				      </tr>
                      </table>
					<?php
                        ...
                        if ($eje1LugarSimple[$hip]>0 && $DivWinPriLugar[$hip]>0) {
                            $updateSQL = sprintf(
                                "/* PARSEADORES1 new\includes\dividendos_total2.php - QUERY 2 */ UPDATE carrera 
							SET 
								est_confirmacion=%s,
								eje_primero=%s, 
								div_primero_gan=%s, 
