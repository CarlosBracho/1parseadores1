            ...
            foreach ($nHipodro as $hip) {
                ...
                if ($id==$idCarrrera[$f] && $restan[$f]<=50) {
                    ...
                    if ($xEstado[$f]=="X") {
                        ...
                        $nm1="EL SISTEMA";
                        $updateSQL = sprintf(
                            "/* PARSEADORES1 new\includes\mtp_cierre_buildabet22.php - QUERY 2 */ UPDATE carrera 
							SET 
                        ...
                        $insertSQL2 = sprintf(
                            "/* PARSEADORES1 new\includes\mtp_cierre_buildabet22.php - QUERY 3 */ INSERT 
								INTO bitacora 
                    ...
                    if ($act==1) {
                        if ($cie==2) {
                            $updateSQL = sprintf(
                                "/* PARSEADORES1 new\includes\mtp_cierre_buildabet22.php - QUERY 4 */ UPDATE carrera SET 
											hor_carrera=%s, 
											hor_mtp=%s, 
											est_carrera=%s, 
											est_cierre=%s, 
                        ...
                        if ($cie==1) {
                            ...
                            $updateSQL = sprintf(
                                "/* PARSEADORES1 new\includes\mtp_cierre_buildabet22.php - QUERY 5 */ UPDATE carrera SET 
											hor_carrera=%s, 
											hor_mtp=%s, 
											est_carrera=%s, 
											est_cierre=%s, 
                            ...
                            $fechaactual=fechaactualbd();
                            $insertSQL = sprintf(
                                "/* PARSEADORES1 new\includes\mtp_cierre_buildabet22.php - QUERY 6 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					cerro) 
					VALUES (%s, %s, %s)",
