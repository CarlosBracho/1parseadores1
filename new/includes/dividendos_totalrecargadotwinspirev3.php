...
function twinspiresResultssolo($car,$fec,$tip,$BrisCode){
	if ($tip==0) $tipoHip="THOROUGHBRED";
	  else if ($tip==1) $tipoHip="HARNESS";
		else if ($tip==2) $tipoHip="";
	$fecUrl=str_replace("-", "", $fec);  
	$url="https://www.twinspires.com/php/fw/php_BRIS_BatchAPI/2.3/Tote/Results?ip=71.212.122.168&affid=2800&debug=off&cDate=".$fecUrl."&password=Gltbatm&track=".$BrisCode."&output=json&username=my_sports&race=".$car."&type=".$tipoHip;
	...
	if (isset($fulldatos["Results"]["WPS"]["Entries"])) {
	  $cAct[0]=$fulldatos["Results"]["WPS"]["RaceNum"];$nCar=$cAct[0];
...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\includes\dividendos_totalrecargadotwinspirev3.php - QUERY 1 */ SELECT * 
	FROM 
	hipodromo,
	carrera 
	WHERE
...
(carrera.confirmandox = 0 OR carrera.confirmandox = 4) AND	
(hipodromo.bus_resultado_tip = 4 OR hipodromo.bus_resultado_tip = 5 OR hipodromo.bus_resultado_tip = 7 OR hipodromo.bus_resultado_tip = 8) AND
...
if ($totalRows_Recordset1>0) { 
	...
	if ($totalRows_Recordset1>0)	{
		...
		if (($row_Recordset1['bus_resultado_tip']==4 OR $row_Recordset1['bus_resultado_tip']==5 OR $row_Recordset1['bus_resultado_tip']==7 OR $row_Recordset1['bus_resultado_tip']==8) && ($row_Recordset1['confirmandox']==0 OR $row_Recordset1['confirmandox']==4))	{
			//twinspires
			...
			list($cAct,$eje1LugarSimple,$eje1LugarDoble,$eje1LugarTriple,$eje2LugarSimple,$eje2LugarDoble,$eje2LugarTriple,$eje3LugarSimple,$eje3LugarDoble,$eje3LugarTriple,$eje4LugarSimple,$eje4LugarDoble,$eje4LugarTriple,$DivWinPriLugar,$DivWinPriLugarDoble,$DivWinPriLugarTriple,$DivPlaPriLugar,$DivPlaPriLugarDoble,$DivPlaPriLugarTriple,$DivShoPriLugar,$DivShoPriLugarDoble,$DivShoPriLugarTriple,$DivPlaSegLugar,$DivPlaSegLugarDoble,$DivPlaSegLugarTriple,$DivShoSegLugar,$DivShoSegLugarDoble,$DivShoSegLugarTriple,$DivShoTerLugar,$DivShoTerLugarDoble,$DivShoTerLugarTriple,$divExotic)=twinspiresResultssolo($car,$fec,$tip,$BrisCode);
		}
				...
				if ($hip==$row_Recordset1['num_carrera']) {
                    ...
                    <table width="100%" border="1" bordercolor="#20c8a8">
					  <tr>
						...
						<?php if (isset($eje1LugarSimple[$hip])) echo $eje1LugarSimple[$hip]; else echo "&nbsp;";?>
                        </div>    
                        </td>
						<td width="40" align="right">
                        <div id="divws1<?php echo $row_Recordset1['cod_carrera']; ?>">
						<?php if (isset($DivWinPriLugar[$hip])) echo $DivWinPriLugar[$hip]; else echo "&nbsp;";?>
                        </div>
                        </td>
						<td width="40" align="right">
                        <div id="divps1<?php echo $row_Recordset1['cod_carrera']; ?>">
                        <?php if (isset($DivPlaPriLugar[$hip])) echo $DivPlaPriLugar[$hip]; else echo "&nbsp;";?>
                        </div>
                        </td>
						<td width="40" align="right">
                        <div id="divss1<?php echo $row_Recordset1['cod_carrera']; ?>">
                        <?php if (isset($DivShoPriLugar[$hip])) echo $DivShoPriLugar[$hip]; else echo "&nbsp;";?>
                        </div>
                        </td>
					  </tr>
					  <tr>
						...
						*/
                        ...
                        <?php if (isset($eje2LugarSimple[$hip])) echo $eje2LugarSimple[$hip]; else echo "&nbsp;";?>
                        </div>
                        </td>
						<td align="right">&nbsp;</td>
						<td align="right">
						<div id="divps2<?php echo $row_Recordset1['cod_carrera']; ?>">
                        <?php if (isset($DivPlaSegLugar[$hip])) echo $DivPlaSegLugar[$hip]; else echo "&nbsp;";?>
                        </div>
                        </td>
						<td align="right">
						<div id="divss2<?php echo $row_Recordset1['cod_carrera']; ?>">
                        <?php if (isset($DivShoSegLugar[$hip])) echo $DivShoSegLugar[$hip]; else echo "&nbsp;";?>
                        </div>
                        </td>
					  </tr>
					  <tr>
                        ...
                        <?php if (isset($eje3LugarSimple[$hip])) echo $eje3LugarSimple[$hip]; else echo "&nbsp;";?>
                        </div>
                        </td>
						<td align="right">&nbsp;</td>
						<td align="right">&nbsp;</td>
                        ...
                        <?php if (isset($DivShoTerLugar[$hip])) echo $DivShoTerLugar[$hip]; else echo "&nbsp;";?>
                        </div>
                        </td>
					  </tr>
					  <tr>
                        ...
                        <div id="ejes4<?php echo $row_Recordset1['cod_carrera']; ?>">
                        	<?php
								if (isset($eje4LugarSimple[$hip]) && $eje4LugarSimple[$hip]>0) echo $eje4LugarSimple[$hip]; 
							?>
                        </div>
                        </td>
					    <td align="right">&nbsp;</td>
						...
						if ($row_Recordset1['cod_confirmacion']==1) {?>
                        	...
                        	<div id="botCancela<?php echo $row_Recordset1['cod_carrera']; ?>" 
                            	style="padding:0px 390px 0px 0px;float:left">
									<a onclick='if(confirm("Â¿Seguro quiere cancelar la carrera?"))cancelaCar(
					...
					<?php
						...
						if (isset($eje1LugarSimple[$hip])) $eje_primero=$eje1LugarSimple[$hip];        else $eje_primero=0;
						if (isset($eje1LugarDoble[$hip]))  $eje_doble_primero=$eje1LugarDoble[$hip];   else $eje_doble_primero=0;
						if (isset($eje1LugarTriple[$hip])) $eje_triple_primero=$eje1LugarTriple[$hip]; else $eje_triple_primero=0;
						if (isset($eje2LugarSimple[$hip])) $eje_segundo=$eje2LugarSimple[$hip]; 		else $eje_segundo=0;
						if (isset($eje2LugarDoble[$hip]))  $eje_doble_segundo=$eje2LugarDoble[$hip];  	else $eje_doble_segundo=0;
						if (isset($eje2LugarTriple[$hip])) $eje_triple_segundo=$eje2LugarTriple[$hip];	else $eje_triple_segundo =0;
						if (isset($eje3LugarSimple[$hip])) $eje_tercero =$eje3LugarSimple[$hip]; 		else $eje_tercero=0;
						if (isset($eje3LugarDoble[$hip]))  $eje_doble_tercero=$eje3LugarDoble[$hip];  	else $eje_doble_tercero=0;
						if (isset($eje3LugarTriple[$hip])) $eje_triple_tercero=$eje3LugarTriple[$hip]; 	else $eje_triple_tercero=0;
						if (isset($DivWinPriLugar[$hip])) $div_primero_gan=$DivWinPriLugar[$hip]; 	else $div_primero_gan=0;
						if (isset($DivPlaPriLugar[$hip])) $div_primero_pla=$DivPlaPriLugar[$hip]; 	else $div_primero_pla=0;
						if (isset($DivShoPriLugar[$hip])) $div_primero_sho=$DivShoPriLugar[$hip]; 	else $div_primero_sho=0;
						if (isset($DivWinPriLugarDoble[$hip])) $div_doble_primero_gan=$DivWinPriLugarDoble[$hip]; 
						else $div_doble_primero_gan =0;
						if (isset($DivPlaPriLugarDoble[$hip])) $div_doble_primero_pla=$DivPlaPriLugarDoble[$hip]; 
						else $div_doble_primero_pla=0;
						if (isset($DivShoPriLugarDoble[$hip])) $div_doble_primero_sho=$DivShoPriLugarDoble[$hip]; 
						else $div_doble_primero_sho=0;
						if (isset($DivWinPriLugarTriple[$hip])) $div_triple_primero_gan=$DivWinPriLugarTriple[$hip]; 
						else $div_triple_primero_gan =0;
						if (isset($DivPlaPriLugarTriple[$hip])) $div_triple_primero_pla=$DivPlaPriLugarTriple[$hip]; 
						else $div_triple_primero_pla=0;
						if (isset($DivShoPriLugarTriple[$hip])) $div_triple_primero_sho=$DivShoPriLugarTriple[$hip]; 
						else $div_triple_primero_sho=0;
						if (isset($DivPlaSegLugar[$hip])) $div_segundo_pla=$DivPlaSegLugar[$hip]; else $div_segundo_pla=0;
						if (isset($DivShoSegLugar[$hip])) $div_segundo_sho=$DivShoSegLugar[$hip]; else $div_segundo_sho=0;
						if (isset($DivPlaSegLugarDoble[$hip])) $div_doble_segundo_pla=$DivPlaSegLugarDoble[$hip]; 
						else $div_doble_segundo_pla=0;
						if (isset($DivShoSegLugarDoble[$hip])) $div_doble_segundo_sho=$DivShoSegLugarDoble[$hip]; 
						else $div_doble_segundo_sho=0;
						if (isset($DivPlaSegLugarTriple[$hip])) $div_triple_segundo_pla=$DivPlaSegLugarTriple[$hip]; 
						else $div_triple_segundo_pla=0;
						if (isset($DivShoSegLugarTriple[$hip])) $div_triple_segundo_sho=$DivShoSegLugarTriple[$hip]; 
						else $div_triple_segundo_sho=0;
						if (isset($DivShoTerLugar[$hip])) $div_tercero_sho=$DivShoTerLugar[$hip]; else $div_tercero_sho=0;
						if (isset($DivShoTerLugarDoble[$hip])) $div_doble_tercero_sho=$DivShoTerLugarDoble[$hip]; 
						else $div_doble_tercero_sho=0;
						if (isset($DivShoTerLugarTriple[$hip])) $div_triple_tercero_sho=$DivShoTerLugarTriple[$hip]; 
						else $div_triple_tercero_sho=0;
						if (isset($eje4LugarSimple[$hip])) $eje_cuarto=$eje4LugarSimple[$hip]; 
						else $eje_cuarto=0;
						if ($eje_primero==0 && $eje_segundo==99 && $eje_tercero =99) $eje_primero=99;
					...
					$row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
							...
							else { $control_dividendo=1; $est_confirmacion=1; }
						}
						...
						if ((isset($eje1LugarSimple[$hip]) && isset($DivWinPriLugar[$hip]) && $eje1LugarSimple[$hip]>0 &&
							...
							$updateSQL = sprintf("/* PARSEADORES1 new\includes\dividendos_totalrecargadotwinspirev3.php - QUERY 2 */ UPDATE carrera 
							SET 
								confirmandox=%s,
								est_confirmacion=%s,
								control_dividendo=%s,
						...
						if ($div_exacta==0 && $eje_primero==99){
						...
						if ((isset($eje1LugarSimple[$hip]) && isset($DivWinPriLugar[$hip]) && $eje1LugarSimple[$hip]>0 &&
							...
							$updateSQL = sprintf("/* PARSEADORES1 new\includes\dividendos_totalrecargadotwinspirev3.php - QUERY 3 */ UPDATE carrera 
							SET 
								confirmandox=%s,
								est_confirmacion=%s,
								control_dividendo=%s,
			...
			<table width="100%" border="1" bordercolor="#20c8a8">
				<tr>
					...
					<td width="678" rowspan="3"><?php
						if ($row_Recordset1['bus_resultado_tip']==0) $pagina="";
						if ($row_Recordset1['bus_resultado_tip']==1) $pagina="--> TRACK INFO";
						if ($row_Recordset1['bus_resultado_tip']==2) $pagina="--> BASIC TVG";
						if ($row_Recordset1['bus_resultado_tip']==3) $pagina="--> BUILDABET";
						if ($row_Recordset1['bus_resultado_tip']==4) $pagina="--> ";
						if ($row_Recordset1['bus_resultado_tip']==5) $pagina="--> ";
						list($a,$m,$d)=explode("-",$row_Recordset1['fec_carrera']);
						$fecha=$d."-".$m."-".$a;
						$carrera=$row_Recordset1['nom_hipodromo']." Carr...".$row_Recordset1['num_carrera'];
					  ...
					  <tr>
						...
						<?php
							if ($row_Recordset1['eje_tercero']>0 && $row_Recordset1['eje_segundo']>0 
								...
								echo "| TR".$etr." Pago: ".$row_Recordset1['div_trifecta'];" ->".$row_Recordset1['fac_trifecta'];
							}
						?>
                        </div>
                        </td>
