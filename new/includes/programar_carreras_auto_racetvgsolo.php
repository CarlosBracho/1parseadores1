...
set_time_limit(0);
$hoy=fechaactualbd();
list($hipodomo, $idcarrera, $tipocarrera, $cantidad, $horainicio, $cod_hipodromo)=programar_carreras_racebets();
?>
                    ...
                    if ($cta!=$cantidad[$y]) {?>
                        <div align="center" style="height:38px; width:100%;" id="divAccion<?php echo $y; ?>">
                          <input type="submit" id="botAccion<?php echo $y; ?>" 
                            ...
                            onClick="crearCarrera('<?php echo $hip; ?>', 
                            '<?php echo $cantidad[$y]; ?>',
                            '<?php echo $idcarrera[$y]; ?>',
                            '#divAccion<?php echo $y; ?>',
                            '<?php echo $z; ?>');"
                  style="padding:4px 0px 0px 0px; height:37px;width:130px; font-size:16px; text-decoration:none;background: #C6F;"
