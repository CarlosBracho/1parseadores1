<?php
    if ($row_Recordset10['cod_hipodromo_hnac']==1) {
        $query_Recordset0 = sprintf("/* PARSEADORES1 new\includes\procesar_ticket_hnac.php - QUERY 1 */ SELECT ta.cod_taquilla FROM taquilla ta, taquilla_opc_hnac tp WHERE 
    ...
    if ($row_Recordset10['cod_hipodromo_hnac']==2) {
        $query_Recordset0 = sprintf("/* PARSEADORES1 new\includes\procesar_ticket_hnac.php - QUERY 2 */ SELECT ta.cod_taquilla FROM taquilla ta, taquilla_opc_hnac tp WHERE 
    ...
    if ($row_Recordset10['cod_hipodromo_hnac']==3) {
        $query_Recordset0 = sprintf("/* PARSEADORES1 new\includes\procesar_ticket_hnac.php - QUERY 3 */ SELECT ta.cod_taquilla FROM taquilla ta, taquilla_opc_hnac tp WHERE 
    ...
    if ($row_Recordset10['cod_hipodromo_hnac']==4) {
        $query_Recordset0 = sprintf("/* PARSEADORES1 new\includes\procesar_ticket_hnac.php - QUERY 4 */ SELECT ta.cod_taquilla FROM taquilla ta, taquilla_opc_hnac tp WHERE 
    ...
    if ($totalRows_Recordset0>0) {
        ...
        do {
            ...
            $query_Recordset1 = sprintf(
                "/* PARSEADORES1 new\includes\procesar_ticket_hnac.php - QUERY 5 */ SELECT 
            ...
            if ($totalRows_Recordset1>0) {
                ...
                do {
                    $updateSQL3 = sprintf(
                        "/* PARSEADORES1 new\includes\procesar_ticket_hnac.php - QUERY 6 */ UPDATE venta_hnac 
