...
$query_Recordset15 = sprintf(
    "/* PARSEADORES1 new\includes\confirma_dividendos.php - QUERY 1 */ SELECT nom_hipodromo, num_carrera FROM carrera WHERE cod_carrera=%s",
...
if ($totalRows_Recordset15>0) {
    $updateSQL15 = sprintf(
        "/* PARSEADORES1 new\includes\confirma_dividendos.php - QUERY 2 */ UPDATE carrera SET est_confirmacion=%s WHERE cod_carrera=%s",
