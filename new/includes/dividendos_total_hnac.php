...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\includes\dividendos_total_hnac.php - QUERY 1 */ SELECT * 
	FROM 
	hipodromo_hnac,
	carrera_hnac 
	WHERE
...
function guardaDiv($fec, $codC, $num, $div, $codV, $lin)
{
    ...
    if ($tot==0) {
        ...
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\includes\dividendos_total_hnac.php - QUERY 2 */ INSERT INTO resultados_oficiales_hnac (
			fec_resultado_hnac, 
			cod_carrera_hnac, 
			num_caballo_hnac, 
			div_pago_hnac, 
        ...
        if ($codR>0) {
            global $conexionbanca;
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\includes\dividendos_total_hnac.php - QUERY 3 */ UPDATE resultados_oficiales_hnac 
				SET 
				num_caballo_hnac=%s, 
				div_pago_hnac=%s 
