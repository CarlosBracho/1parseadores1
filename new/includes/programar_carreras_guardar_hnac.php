    ...
    if (isset($cantCarreras) && $cantCarreras>0) {
        ...
        for ($i = 1;  $i <= $cantCarreras; $i++) {
            ...
            if ($estado==0) {
                ...
                $insertSQL = sprintf(
                    "/* PARSEADORES1 new\includes\programar_carreras_guardar_hnac.php - QUERY 1 */ INSERT INTO carrera_hnac 
					(cod_hipodromo_hnac, 
					fec_carrera_hnac, 
					hor_carrera_hnac, 
					est_carrera_hnac, 
                ...
                $query_RecT = "/* PARSEADORES1 new\includes\programar_carreras_guardar_hnac.php - QUERY 2 */ SELECT cod_carrera_hnac FROM carrera_hnac ORDER BY cod_carrera_hnac DESC LIMIT 1";
                ...
                for ($x = 1;  $x <= $enCarre[$i]; $x++) {	//guarda los ejemplares
                    $insertSQL2 = sprintf(
                        "/* PARSEADORES1 new\includes\programar_carreras_guardar_hnac.php - QUERY 3 */ INSERT INTO inscritos 
						(cod_carrera_hnac, 
						num_caballo_hnac, 
						nom_caballo_hnac, 
						nom_jinete_hnac, 
