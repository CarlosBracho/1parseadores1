...
//$totalRows_Carrera = mysqli_num_rows($Carrera);
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\includes\ameridatosverificador.php - QUERY 1 */ SELECT * FROM carrera ca, hipodromo hi WHERE ca.eje_primero=0 AND ca.fec_carrera=%s  AND ca.cod_hipodromo=hi.cod_hipodromo ORDER BY hor_carrera",
    ...
    if ($hipodr[0]!="") {
        do {
            ...
            $query_Recordset11 = sprintf(
                "/* PARSEADORES1 new\includes\ameridatosverificador.php - QUERY 2 */ SELECT * 
