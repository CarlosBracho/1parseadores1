...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\includes\ret_tvg_rb.php - QUERY 1 */ SELECT * FROM carrera, hipodromo 
	WHERE
...
?>
<div style="background: #F9F; color: #000; width:100%">
    ...
    do {
        if ($row_Recordset1['bus_retirado']==1) { //BASIC TVG
            ...
            if ($pos !== false) {
                ...
                if ($cantProg!=$row_Recordset1['can_caballos'] && $cantProg>0) {
                    ...
                    $updateSQL2 = sprintf(
                        "/* PARSEADORES1 new\includes\ret_tvg_rb.php - QUERY 2 */ UPDATE carrera SET can_caballos=%s 
										  WHERE cod_carrera=%s",
                ...
                if (isset($retiro[0])) {
                    ...
                    foreach ($retiro as $ejem) {
                        ...
                        if ($estado==0) { // retirar caballo
                            $insertSQL = sprintf(
                                "/* PARSEADORES1 new\includes\ret_tvg_rb.php - QUERY 3 */ INSERT INTO retirados 
					...
					<tr>
						...
						<td width="74" align="center" style="font-size:10px"><?php echo "BASIC TVG"; ?></td>
        ...
        if ($row_Recordset1['bus_retirado']==2) { //RACEBETS
            ...
            if ($cantProgramados!=$row_Recordset1['can_caballos']) {
                $updateSQL2 = sprintf(
                    "/* PARSEADORES1 new\includes\ret_tvg_rb.php - QUERY 4 */ UPDATE carrera SET can_caballos=%s 
									  WHERE cod_carrera=%s",
            ...
            if (isset($retiro[0]) && $retiro[0]!="") {
                ...
                foreach ($retiro as $ejem) {
                    ...
                    if ($estado==0) { // retirar caballo
                        $insertSQL = sprintf(
                            "/* PARSEADORES1 new\includes\ret_tvg_rb.php - QUERY 5 */ INSERT INTO retirados 
									(cod_carrera, num_rcaballo) VALUES (%s, %s)",
                            GetSQLValueString($cod_carrera, "int"),
                            GetSQLValueString($ejem, "int")
                        );
				...
				<tr bgcolor="#FFFFFF">
					...
					<td width="74" align="center" style="font-size:10px"><?php echo "RACEBETS"; ?></td>
					<td width="281" align="center"><?php echo $ejemRetir; ?></td>
				</tr>
				<?php
            }
