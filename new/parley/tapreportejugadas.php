    ...
    $iniciof=$_POST['fecha_inicio'].' 00:00:01';
     $finalf=$_POST['fecha_fin'].' 23:59:59';
                            ...
                            $query_Recordset13 = sprintf(
                                "/* PARSEADORES1 new\parley\tapreportejugadas.php - QUERY 1 */ SELECT *
					FROM usuario, p4jugadas
					WHERE
                    p4jugadas.jugadadtp4 >= %s AND p4jugadas.jugadadtp4 <= %s  AND
					usuario.id_usuario = %s
          AND p4jugadas.id_usuariop4= %s AND p4jugadas.lineatp4= 1 ORDER BY p4jugadas.estadoticketp4 = 1 AND p4jugadas.pverificado = 1 DESC",
...
if(isset($_POST[''])){
 $query_Recordset13 = sprintf(
      "/* PARSEADORES1 new\parley\tapreportejugadas.php - QUERY 2 */ SELECT *
FROM usuario, p4jugadas
WHERE
p4jugadas.jugadadtp4 >= %s AND p4jugadas.jugadadtp4 <= %s  AND
usuario.id_usuario = %s
...
$totalRows_Recordset13 = mysqli_num_rows($Recordset13);
    ...
    $query_Recordset1890 = sprintf(
      "/* PARSEADORES1 new\parley\tapreportejugadas.php - QUERY 3 */ SELECT factor_de_hembra, factor_de_macho, monto_apuesta, factor_pago
       FROM 
    ...
    $query_Recordset1 = sprintf(
      "/* PARSEADORES1 new\parley\tapreportejugadas.php - QUERY 4 */ SELECT 
    *
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 new\parley\tapreportejugadas.php - QUERY 5 */ SELECT *
                FROM p4jugadas
                WHERE
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
                            $query_Recordset135 = sprintf(
                                "/* PARSEADORES1 new\parley\tapreportejugadas.php - QUERY 6 */ SELECT *
					FROM usuario, p4jugadas
					WHERE
...
$query_Recordset1 = sprintf(
  "/* PARSEADORES1 new\parley\tapreportejugadas.php - QUERY 7 */ SELECT 
*
...
$totalRows_Recordset1 = mysqli_num_rows($Recordset1);
$premio=0;
$totalfactor=$row_Recordset1['mon_ventap4']*$row_Recordset1890['factor_pago'];
