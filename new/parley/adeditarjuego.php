...
if (isset($_POST['deportep2'])) {
    ...
    echo $datetime;
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 1 */ UPDATE p2juegos 
...
if (isset($_POST['nomequipo'])) {
  $insertSQL1 = sprintf(
      "/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 2 */ UPDATE p2juegos 
      SET nomequipop1=%s,
    nomdimp1=%s,
    deportep1=%s,
    ligap1=%s,
  ...
  $Result1 = mysqli_query($conexionbanca, $insertSQL1) or die(mysqli_error($conexionbanca));
        ...
        $query_Recordset1 = sprintf(
            "/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 3 */ SELECT *
...
$totalRows_Recordset1 = mysqli_num_rows($Recordset1);
    ...
    $query_Recordset2 = sprintf("/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 4 */ SELECT *
...
$totalRows_Recordset2 = mysqli_num_rows($Recordset2);
    ...
    $query_Recordset3 = sprintf("/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 5 */ SELECT *
FROM p1equipos ORDER BY nomequipop1");
...
$query_Recordset18 = sprintf(
	"/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 6 */ SELECT *
FROM p2juegos"
);
...
$query_Recordset99 =  sprintf(
  "/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 7 */ SELECT  
...
if(isset($_POST['operador'])==5 && (isset($_POST['competicion']))){
    ...
    $insertSQL20 = sprintf(
      "/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 8 */ UPDATE p2juegos 
      SET  competicionp2=%s		
      WHERE Id_p2juegosp2=%s",
...
if(isset($_POST['operador'])==5 && (isset($_POST['competicion2']))){
    ...
    $insertSQL21 = sprintf(
      "/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 9 */ UPDATE p2juegos 
      SET  competicionp2=%s		
      WHERE Id_p2juegosp2=%s",
...
?>
    ...
    "/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 10 */ SELECT *
...
maxlength="30" pattern="[A-Z a-z0-9]{2,30}" onKeyUp="return handleEnter(this, event)" onclick="ocultaDiv('Info32');"
    ...
    $query_Recordset222 = sprintf(
                             "/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 11 */ SELECT *
FROM p1equipos  WHERE Id_p1equiposp1=%s",
...
<select name="competicion" id="competicion" class="form-/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 12 */ select" style="text-align: center; border: solid" required>
...
<?php //SELECT CON BASE DE DATOS?>
<select name="competicion" class="form-/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 13 */ select" style="text-align: center; border: solid">
            <option value="todos">TODOS</option>
            <?php
      do {
...
<?php //SELECT CON BASE DE DATOS?>
<select name="competicion" class="form-/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 14 */ select" style="text-align: center; border: solid">
            <option value="todos">TODOS</option>
            <?php
      do {
...
<?php //SELECT CON BASE DE DATOS?>
<select name="competicion" class="form-/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 15 */ select" style="text-align: center; border: solid">
            <option value="todos">TODOS</option>
            <?php
      do {
...
<?php //SELECT CON BASE DE DATOS?>
<select name="competicion" class="form-/* PARSEADORES1 new\parley\adeditarjuego.php - QUERY 16 */ select" style="text-align: center; border: solid">
            <option value="todos">TODOS</option>
            <?php
      do {
