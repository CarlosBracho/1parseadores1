...
<?php
    ...
    "/* PARSEADORES1 new\parley\apc_futbolamericano.php - QUERY 1 */ SELECT * FROM p2juegos 
...
do {
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\apc_futbolamericano.php - QUERY 2 */ SELECT *
FROM p1equipos
WHERE  
Id_p1equiposp1 = %s",
...
<tr class="table-dark">
<th rowspan='2'><h6><small class="font-weight-bold"><br>EQUIPOS<br>HORA INICIO</small></h6>
...
<?php if ($row_Recordset5['futbolame_ml'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
<?php
...
<?php
if ($row_Recordset5['futbolame_ml'] == 0) {?>
...
<?php if ($row_Recordset5['futbolame_alta'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
<?php
...
<?php
if ($row_Recordset5['futbolame_alta'] == 0) {?>
...
<?php if ($row_Recordset5['futbolame_runline'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
<?php
...
<?php
if ($row_Recordset5['futbolame_runline'] == 0) {?>
...
$lg; ?>,<?php echo $row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,2,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,,13:10:00,<?php echo $row_Recordset21['nomequipop1'];?>"><small class="text-primary"><b><?php echo $lgABoRL; ?> </b></small> 
<?php $psi=0; if ($lg>0) { $psi=1;  } deam($psi, $lg, $ttl); ?></td>
<?php } else {?><td></td><?php } ?>
<?php
}?>

<?php if ($row_Recordset5['futbolame_mj_ml'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
<?php
...
<?php
if ($row_Recordset5['futbolame_mj_ml'] == 0) {?>
...
<?php if ($row_Recordset5['futbolame_mj_alta'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
<?php
...
<?php
if ($row_Recordset5['futbolame_mj_alta'] == 0) {?>
...
<?php if ($row_Recordset5['futbolame_mj_rl'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
<?php
...
<?php
if ($row_Recordset5['futbolame_mj_rl'] == 0) {?>
...
$query_Recordset22 = sprintf(
        "/* PARSEADORES1 new\parley\apc_futbolamericano.php - QUERY 3 */ SELECT *
...
<?php if ($row_Recordset5['futbolame_baja'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
<?php
...
<?php
if ($row_Recordset5['futbolame_baja'] == 0) {?>
...
<?php if ($row_Recordset5['futbolame_mj_baja'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
<?php
...
<?php
if ($row_Recordset5['futbolame_mj_baja'] == 0) {?>
