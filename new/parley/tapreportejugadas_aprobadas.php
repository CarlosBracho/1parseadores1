    ...
    $iniciof=$_POST['fecha_inicio'].' 00:00:01';
     $finalf=$_POST['fecha_fin'].' 23:59:59';
                            ...
                            $query_Recordset13 = sprintf(
                                "/* PARSEADORES1 new\parley\tapreportejugadas_aprobadas.php - QUERY 1 */ SELECT *
					FROM usuario, p4jugadas
					WHERE
                    p4jugadas.jugadadtp4 >= %s AND p4jugadas.jugadadtp4 <= %s  AND
					usuario.id_usuario = %s AND pverificado = 1
...
<div class="container">
  ...
  <div class="row">
    <div class="col-12 col-md-12  table-responsive "> 
      ...
      <th scope="col">
				<div><a href="tapreportejugadas.php" type="button" class="btn btn-danger">Ir a Tickets no Aprobados</a></div>
				</th><br>
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 new\parley\tapreportejugadas_aprobadas.php - QUERY 2 */ SELECT *
                FROM p4jugadas
                WHERE
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
                            $query_Recordset135 = sprintf(
                                "/* PARSEADORES1 new\parley\tapreportejugadas_aprobadas.php - QUERY 3 */ SELECT *
					FROM usuario, p4jugadas
					WHERE
