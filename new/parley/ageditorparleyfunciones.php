...
$query_Recordset111 = sprintf(
    "/* PARSEADORES1 new\parley\ageditorparleyfunciones.php - QUERY 1 */ SELECT logrop3, Id_p3logrosp3, logroABoRLp3, idjuegop3, equipop3, tipojugadap3, logrodtp3
FROM  p3logros
...
"/* PARSEADORES1 new\parley\ageditorparleyfunciones.php - QUERY 2 */ SELECT logrop6, idp6logrosind, logroABoRLp6, idjuegop6, equipop6, tipojugadap6, logrodtp6
FROM  p6logrosind
