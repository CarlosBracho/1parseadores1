...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    if (isset($_POST['fecha_inicio']) && isset($_POST['fecha_fin'])) {
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_usuario']!="todos") {
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\parley\ventas_reporte_jugadas.php - QUERY 1 */ SELECT 
					*
				FROM 
        ...
        GetSQLValueString($fi.' 23:59:59', "date"),
                ...
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\parley\ventas_reporte_jugadas.php - QUERY 2 */ SELECT 
					*
				FROM 
					agencia ag, taquilla ta, carrera ca, usuario us, p4jugadas p4j
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\parley\ventas_reporte_jugadas.php - QUERY 3 */ SELECT  
		*
	FROM 
		agencia ag, taquilla ta, carrera ca, usuario us, p4jugadas p4j
...
$query_Recordset2 = sprintf("/* PARSEADORES1 new\parley\ventas_reporte_jugadas.php - QUERY 4 */ SELECT id_usuario, nom_usuario FROM usuario us 
