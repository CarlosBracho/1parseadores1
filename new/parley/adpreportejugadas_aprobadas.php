...
$query_Recordset13 = sprintf("/* PARSEADORES1 new\parley\adpreportejugadas_aprobadas.php - QUERY 1 */ SELECT *
FROM p4jugadas
WHERE
p4jugadas.jugadadtp4 >= %s AND p4jugadas.jugadadtp4 <= %s AND pverificado = 1 AND
...
if(isset($_POST['ticket'])){
  $insertSQL1 = sprintf(
    "/* PARSEADORES1 new\parley\adpreportejugadas_aprobadas.php - QUERY 2 */ UPDATE p4jugadas
...
<div class="container">
  ...
  <div class="row">
    <div class="col-12 col-md-12  table-responsive "> 
      ...
      <th scope="col">
				<div><a href="adpreportejugadas.php" type="button" class="btn btn-danger">Ir a Tickets no Aprobados</a></div>
				</th><br>
        <h1 style="text-align: center;">Lista de Tickets Aprobados</h1>
...
if ($totalRows_Recordset13>=1) {
    do {
	 ...
	 $query_Recordset19 = sprintf(
        "/* PARSEADORES1 new\parley\adpreportejugadas_aprobadas.php - QUERY 3 */ SELECT 
        *
        FROM
    p4jugadas, p2juegos
    WHERE
    ...
    p4jugadas.nticketp4 = %s   ORDER BY p4jugadas.lineatp4 DESC",
        GetSQLValueString($row_Recordset13['nticketp4'], "int"));
               ...
               $query_Recordset18 = sprintf(
                  "/* PARSEADORES1 new\parley\adpreportejugadas_aprobadas.php - QUERY 4 */ SELECT 
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 new\parley\adpreportejugadas_aprobadas.php - QUERY 5 */ SELECT *
                FROM p4jugadas
                WHERE
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
 $query_Recordset135 = sprintf("/* PARSEADORES1 new\parley\adpreportejugadas_aprobadas.php - QUERY 6 */ SELECT *
FROM p4jugadas
WHERE
...
if ($row_Recordset135['estadoticketp4']==1) { echo 'Gano Por Pagar';}
