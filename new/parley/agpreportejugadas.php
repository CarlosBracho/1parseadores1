...
if (isset($_POST['fecha_inicio']) && isset($_POST['fecha_fin'])) {
    ...
    $iniciof=$_POST['fecha_inicio'].' 00:00:01';
     $finalf=$_POST['fecha_fin'].' 23:59:59';
        ...
        "/* PARSEADORES1 new\parley\agpreportejugadas.php - QUERY 1 */ SELECT *
					FROM usuario, p4jugadas, agencia, taquilla
					WHERE
          ...
          taquilla.cod_taquilla = usuario.cod_taquilla AND agencia.cod_agencia = taquilla.cod_agencia AND agencia.cod_agencia = %s
    ...
    $query_Recordset1890 = sprintf(
      "/* PARSEADORES1 new\parley\agpreportejugadas.php - QUERY 2 */ SELECT factor_de_hembra, factor_de_macho
       FROM 
    ...
    $query_Recordset1 = sprintf(
      "/* PARSEADORES1 new\parley\agpreportejugadas.php - QUERY 3 */ SELECT 
    *
...
if ($totalRows_Recordset13>=1) {
    do {
      ...
      $query_Recordset19 = sprintf(
        "/* PARSEADORES1 new\parley\agpreportejugadas.php - QUERY 4 */ SELECT 
        *
        FROM
    p4jugadas, p2juegos
    WHERE
    ...
    $totalRows_Recordset19 = mysqli_num_rows($Recordset19);
      ...
      "/* PARSEADORES1 new\parley\agpreportejugadas.php - QUERY 5 */ SELECT 
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 new\parley\agpreportejugadas.php - QUERY 6 */ SELECT *
                FROM p4jugadas
                WHERE
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
    ...
    $query_Recordset135 = sprintf("/* PARSEADORES1 new\parley\agpreportejugadas.php - QUERY 7 */ SELECT *
FROM p4jugadas, usuario, agencia, taquilla
WHERE
p4jugadas.jugadadtp4 >= %s AND 
p4jugadas.jugadadtp4 <= %s  AND
p4jugadas.nticketp4 = %s AND
taquilla.cod_taquilla = usuario.cod_taquilla 
AND agencia.cod_agencia = taquilla.cod_agencia 
AND agencia.cod_agencia = %s AND 
p4jugadas.lineatp4= 1 ORDER BY p4jugadas.nticketp4 DESC",
GetSQLValueString($iniciof, "date"), GetSQLValueString($finalf, "date"),
GetSQLValueString($row_Recordset13['nticketp4'], "int"),
GetSQLValueString($_SESSION['MM_cod_agente'], "int"));
...
$query_Recordset1 = sprintf(
  "/* PARSEADORES1 new\parley\agpreportejugadas.php - QUERY 8 */ SELECT 
*
