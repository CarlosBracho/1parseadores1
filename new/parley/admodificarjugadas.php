...
$query_Recordset13 = sprintf("/* PARSEADORES1 new\parley\admodificarjugadas.php - QUERY 1 */ SELECT *
FROM p4jugadas
WHERE
...
if(isset($_POST['ticket'])){
  $insertSQL1 = sprintf(
    "/* PARSEADORES1 new\parley\admodificarjugadas.php - QUERY 2 */ UPDATE p4jugadas
  ...
  <div class="row">
    <div class="col-12 col-md-12  table-responsive "> 
      ...
      <th scope="col">
        ...
        <h1 style="text-align: center;">Lista de Tickets</h1>
    ...
    do {
        ?>
          <tr>
            ...
            <td>
<a data-toggle="modal" data-target="#exampleModal" href="admodificarjugadas2.php" title="" 
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 new\parley\admodificarjugadas.php - QUERY 3 */ SELECT *
                FROM p4jugadas
                WHERE
...
<td><a data-toggle="modal" data-target="#exampleModal" href="admodificarjugadas2.php" title="" 
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
 $query_Recordset135 = sprintf("/* PARSEADORES1 new\parley\admodificarjugadas.php - QUERY 4 */ SELECT *
FROM p4jugadas
WHERE
...
<script>
    function detalle_ticket(nticket, jtipo, modulo){
        $.post("../parley/admodificarjugadas2.php", 
        {
		nticket:nticket,
		jtipo:jtipo,
		modulo:modulo
