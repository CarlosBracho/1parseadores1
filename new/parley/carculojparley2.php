...
$insertSQL155 = sprintf(
    "/* PARSEADORES1 new\parley\carculojparley2.php - QUERY 1 */ UPDATE p4jugadas  SET 
estadojugadap4=%s 
...
if($estadojugadap4==2){
  ...
  "/* PARSEADORES1 new\parley\carculojparley2.php - QUERY 2 */ SELECT * 
  FROM 
  p4jugadas
  WHERE 
...
///*
  ...
  $insertSQL155 = sprintf(
    "/* PARSEADORES1 new\parley\carculojparley2.php - QUERY 3 */ UPDATE p4jugadas  SET 
  estadoticketp4=%s 
...
$query_Recordset117 = sprintf(
  "/* PARSEADORES1 new\parley\carculojparley2.php - QUERY 4 */ SELECT * FROM p4jugadas WHERE 
...
$query_Recordset1890 = sprintf(
  "/* PARSEADORES1 new\parley\carculojparley2.php - QUERY 5 */ SELECT monto_apuesta, factor_pago, factor_de_hembra, factor_de_macho
   FROM 
   taquilla_opc_parley
   WHERE 
   cod_taquilla = %s ",
...
if ($ganador==1 && $Perdedor==0) {
  ...
  $insertSQL155 = sprintf(
      "/* PARSEADORES1 new\parley\carculojparley2.php - QUERY 6 */ UPDATE p4jugadas  SET 
...
WHERE nticketp4=%s AND lineatp4=%s",
 ...
 // echo "linea5 else".$premio."<br><br>";
  $insertSQL155 = sprintf(
      "/* PARSEADORES1 new\parley\carculojparley2.php - QUERY 7 */ UPDATE p4jugadas  SET 
premioapagarp4=%s
WHERE nticketp4=%s AND lineatp4=%s",
