...
"/* PARSEADORES1 new\parley\resultado_hockey.php - QUERY 1 */ SELECT *
FROM p5resultadosj
WHERE
deportep5 = %s AND 
iniciodtp5 >= %s AND 
...
do {
	...
	$query_Recordset301 = sprintf(
		"/* PARSEADORES1 new\parley\resultado_hockey.php - QUERY 2 */ SELECT * FROM p2juegos, p5resultadosj WHERE 
...
p2juegos.Id_p2juegosp2 = %s 
	...
	",
	        GetSQLValueString($iniciof, "date"), GetSQLValueString($finalf, "date"),
	GetSQLValueString($iniciof, "date"), GetSQLValueString($finalf, "date"),
		GetSQLValueString($row_Recordset13['juegop5'], "int")
	);
    ...
    if($row_Recordset13['deportep5']=='hockey'){
		?>
		...
		<?php } ?>
			...
			<tr> 
				...
				<td colspan="2" width="25%" class="text-center"><?php echo $row_Recordset13['equipo1p5']; ?></td>
			...
			<tr> 
				<td  colspan="2" width="25%" class="text-center"><?php echo $row_Recordset13['equipo2p5']; ?></td>
