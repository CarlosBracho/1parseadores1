...
if($D==1){
    $query_Recordset13 = sprintf(
        "/* PARSEADORES1 new\parley\tapcuadrecaja.php - QUERY 1 */ SELECT 
    p4jugadas.lineatp4,
...
SUM(CASE WHEN p4jugadas.lineatp4 = 1 AND p4jugadas.jugadadtp4pago >= %s AND p4jugadas.jugadadtp4pago <= %s AND  (p4jugadas.estadoticketp4 = 6) AND p4jugadas.monedap4 = 5  THEN p4jugadas.premioapagarp4 ELSE 0 END) AS total_anuladossol
    ...
    $query_Recordset13 = sprintf(
        "/* PARSEADORES1 new\parley\tapcuadrecaja.php - QUERY 2 */ SELECT 
    p4jugadas.lineatp4,
    SUM(CASE WHEN p4jugadas.lineatp4 = 1 AND p4jugadas.jugadadtp4 >= %s AND p4jugadas.jugadadtp4 <= %s  AND p4jugadas.monedap4 <= 2 THEN p4jugadas.mon_ventap4 ELSE 0 END) AS total_ventabss,
...
$query_Recordset2 = sprintf("/* PARSEADORES1 new\parley\tapcuadrecaja.php - QUERY 3 */ SELECT usuario.nom_usuario, usuario.id_usuario, taquilla.nom_taquilla FROM usuario, taquilla 
...
$query_Recordset3 = sprintf("/* PARSEADORES1 new\parley\tapcuadrecaja.php - QUERY 4 */ SELECT nom_usuario FROM usuario WHERE usuario.id_usuario = %s AND tip_usuario='U' 
