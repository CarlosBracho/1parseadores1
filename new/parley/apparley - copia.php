...
$query_Recordset5 = sprintf(
    "
/* PARSEADORES1 new\parley\apparley - copia.php - QUERY 1 */ SELECT * FROM usuario, taquilla, taquilla_opc_ame, agencia,
			banca
...
function Obtenerlogro($Id_p2juegos, $equipo, $tipojugada)
{
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\parley\apparley - copia.php - QUERY 2 */ SELECT *
FROM  p3logros
WHERE 
...
p3logros.tipojugada = %s",
    ...
    $query_Recordset1 = "/* PARSEADORES1 new\parley\apparley - copia.php - QUERY 3 */ SELECT * FROM p2juegos";
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
...
<?php
    $query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\parley\apparley - copia.php - QUERY 4 */ SELECT * FROM p2juegos 
...
do {
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\apparley - copia.php - QUERY 5 */ SELECT *
FROM p1equipos
WHERE  
...
$query_Recordset22 = sprintf(
        "/* PARSEADORES1 new\parley\apparley - copia.php - QUERY 6 */ SELECT *
...
<div id="scrollj">
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\parley\apparley - copia.php - QUERY 7 */ SELECT * FROM p2juegos 
	WHERE deporte = %s AND competicion = %s AND pais = %s",
        GetSQLValueString("Baseball", "text"),
        GetSQLValueString("MLB", "text"),
        GetSQLValueString("ESTADOS UNIDOS", "text")
...
do {
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\apparley - copia.php - QUERY 8 */ SELECT *
FROM p1equipos
WHERE  
...
<?php
$query_Recordset22 = sprintf(
        "/* PARSEADORES1 new\parley\apparley - copia.php - QUERY 9 */ SELECT *
FROM p1equipos WHERE Id_p1equipos = %s",
        GetSQLValueString($row_Recordset1['idequipo2'], "int")
    );
    $Recordset22 =mysqli_query($conexionbanca, $query_Recordset22) or die(mysqli_error($conexionbanca));
