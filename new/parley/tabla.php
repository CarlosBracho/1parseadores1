			...
			<?php 
				...
				if(isset($_SESSION['consulta'])){
					if($_SESSION['consulta'] > 0){
						...
						$sql="/* PARSEADORES1 new\parley\tabla.php - QUERY 1 */ SELECT Id_p1equiposp1, nomequipop1, nommara, nomsella, deportep1, liga, pais
						from p1equipos where Id_p1equiposp1='$idp'";
					}else{
						$sql="/* PARSEADORES1 new\parley\tabla.php - QUERY 2 */ SELECT Id_p1equiposp1, nomequipop1, nommara, nomsella, deportep1, liga, pais
						from p1equipos";
					}
				}else{
					$sql="/* PARSEADORES1 new\parley\tabla.php - QUERY 3 */ SELECT Id_p1equiposp1, nomequipop1, nommara, nomsella, deportep1, liga, pais
						from p1equipos";
				}
