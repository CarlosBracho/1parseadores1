...
$query_Recordset18 = sprintf(
	"/* PARSEADORES1 new\parley\editarcompeticion.php - QUERY 1 */ SELECT *
FROM p2juegos"
);
...
$query_Recordset99 =  sprintf(
  "/* PARSEADORES1 new\parley\editarcompeticion.php - QUERY 2 */ SELECT  
...
if(isset($_POST['competicion'])!=''){
    ...
    $insertSQL20 = sprintf(
      "/* PARSEADORES1 new\parley\editarcompeticion.php - QUERY 3 */ UPDATE p2juegos 
      SET  competicionp2=%s		
...
if(isset($_POST['competicion2'])!=''){
    ...
    $insertSQL21 = sprintf(
      "/* PARSEADORES1 new\parley\editarcompeticion.php - QUERY 4 */ UPDATE p2juegos 
      SET  competicionp2=%s		
      WHERE Id_p2juegosp2=%s",
