...
"/* PARSEADORES1 new\parley\tapeliminarticket.php - QUERY 1 */ SELECT *
FROM p4jugadas, p2juegos
WHERE
   
p4jugadas.pverificado = 0  
AND p2juegos.iniciodtp2 > %s  
AND p2juegos.Id_p2juegosp2 = p4jugadas.juegop4 
AND p4jugadas.estadoticketp4=0
AND p4jugadas.id_usuariop4= %s 
AND p4jugadas.lineatp4= 1 
ORDER BY p4jugadas.nticketp4 DESC", 
...
if ($totalRows_Recordset13>=1) {
    do {
      $query_Recordset19 = sprintf(
        "/* PARSEADORES1 new\parley\tapeliminarticket.php - QUERY 2 */ SELECT 
        *
        FROM
    p4jugadas, p2juegos
    WHERE p2juegos.iniciodtp2 < %s AND
    ...
    if($totalRows_Recordset19>0){ } else {
...
<?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 new\parley\tapeliminarticket.php - QUERY 3 */ SELECT *
                FROM p4jugadas
                WHERE
        ...
        do {
            ...
            if ($row_Recordset14['jugadadtp4']<$fechahora) { $juegoiniciado++; }
        ...
        <center><input type="submit" value="CONFIRME QUE DESEA ELIMINAR ESTE TICKET" class="btn-warning" title="CONFIRME QUE DESEA ELIMINAR ESTE TICKET" 
...
<script>
    function detalle_ticket(nticket, jtipo, modulo){
        $.post("../parley/tapeliminarticket2.php", 
        {
		nticket:nticket,
		jtipo:jtipo,
		modulo:modulo
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Eliminar Apuesta</h5>
