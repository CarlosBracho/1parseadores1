...
<div <?php if($scroll==1){ echo 'id=scrollj'; } ?> class="border border-success">
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\parley\apc_futbol_prueba.php - QUERY 1 */ SELECT * FROM p2juegos 
...
do {
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\apc_futbol_prueba.php - QUERY 2 */ SELECT *
FROM p1equipos
WHERE  
Id_p1equiposp1 = %s",
    ...
    $query_Recordset22 = sprintf(
        "/* PARSEADORES1 new\parley\apc_futbol_prueba.php - QUERY 3 */ SELECT *
...
<?php
}elseif($tipo==7){?><a class="" style="color:white" data-toggle="modal" data-target="#exampleModal100"  onclick="crearcompeticion(2, <?php echo $row_Recordset1['Id_p2juegosp2']; ?>, 5);"><?php } echo $row_Recordset1['competicionp2']; ?></a></div></td></tr>
            <tr class="table-dark">
