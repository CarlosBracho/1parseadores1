...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 1 */ SELECT * 
FROM p2juegos 
WHERE  
iniciodtp2 >= %s  AND
iniciodtp2 <= %s
...
$query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 2 */ SELECT *
FROM p1equipos
WHERE  
...
<?php
        $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 3 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
...
<?php
        $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 4 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
...
<?php
        $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 5 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
...
<?php
        $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 6 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
...
<?php
        $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 7 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
...
<?php
        $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 8 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
...
<?php
        $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 9 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
...
<?php
        $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 10 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
...
<?php
        $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 11 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
...
$query_Recordset22 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 12 */ SELECT *
...
<?php
                $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 13 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
...
<?php
                $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 14 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
...
<?php
                $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 15 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
...
<?php
                $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 16 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
...
<?php
                $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 17 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
...
<?php
                $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 18 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
...
<?php
                $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 19 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
...
<?php
                $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 20 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
...
<?php
                $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\agente\adlistajuegos.php - QUERY 21 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
