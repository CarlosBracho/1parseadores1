...
<div <?php if($scroll==1){ echo 'id=scrollj'; } ?> class="border border-success">
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\parley\apc_futbol.php - QUERY 1 */ SELECT * FROM p2juegos 
...
do {
    ...
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\apc_futbol.php - QUERY 2 */ SELECT *
FROM p1equipos
WHERE  
Id_p1equiposp1 = %s",
    ...
    $query_Recordset22 = sprintf(
        "/* PARSEADORES1 new\parley\apc_futbol.php - QUERY 3 */ SELECT *
...
<?php
}elseif($tipo==7){?><a class="" style="color:white" data-toggle="modal" data-target="#exampleModal100"  onclick="crearcompeticion(2, <?php echo $row_Recordset1['Id_p2juegosp2']; ?>, 5);"><?php } 

if($row_Recordset1['competicionp2']<>$competicionp2){   echo $row_Recordset1['competicionp2']; }

?></a></div></td></tr>
                 
                 <?php if($emcab==0 or $emcab==5 or $emcab==10 or $emcab==15 or $emcab==20 or $emcab==25 or $emcab==30 or $emcab==35 or $emcab==40 or $emcab==45 or $emcab==50 or $emcab==55 or $emcab==60 or $emcab==65 or $emcab==70 or $emcab==75 or $emcab==80 or $emcab==85 or $emcab==90 or $emcab==95 or $emcab==100 or $emcab==105 or $emcab==110 or $emcab==115 or $emcab==120 or $emcab==125 or $emcab==130 or $emcab==135 or $emcab==140 or $emcab==145 or $emcab==150){  ?>
                     <tr class="table-dark">
		

            <th rowspan='2'><h6><small class="font-weight-bold">HORA INICIO
</small></h6></th>
...
<div class="tdright"><h6 class="font-weight-bold"><small><?php echo $row_Recordset21['nomequipop1']; ?> VS <?php echo $row_Recordset22['nomequipop1']; ?></small>
<br>
...
<td></td>
<?php if ($row_Recordset5['futbol_empate'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
    <td></td>
...
if ($row_Recordset5['futbol_empate'] == 0) {?>
...
<?php if ($row_Recordset5['futbol_mj_empate'] == 1) {
...
<?php if ($row_Recordset5['futbol_mj_empate'] == 0) {?>
...
<?php if ($row_Recordset5['futbol_ml'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
...
<?php if ($row_Recordset5['futbol_alta'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
...
if ($row_Recordset5['futbol_alta'] == 0) {?>
...
<?php if ($row_Recordset5['futbol_mj_ml'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
...
if ($row_Recordset5['futbol_mj_ml'] == 0) {?>
...
<?php if ($row_Recordset5['futbol_baja'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
...
<?php
if ($row_Recordset5['futbol_baja'] == 0) {?>
