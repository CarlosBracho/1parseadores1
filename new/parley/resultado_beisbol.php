...
$query_Recordset13 = sprintf(
	"/* PARSEADORES1 new\parley\resultado_beisbol.php - QUERY 1 */ SELECT *
	FROM p5resultadosj
	WHERE
	deportep5 = %s AND 
	iniciodtp5 >= %s AND 
...
if ($totalRows_Recordset13>=1) {
    do {
        ...
        $query_Recordset301 = sprintf(
            "/* PARSEADORES1 new\parley\resultado_beisbol.php - QUERY 2 */ SELECT * 
...
p2juegos.Id_p2juegosp2 = %s 
    ...
    if($row_Recordset13['deportep5']=='beisbol'){
        ...
        <?php } ?>
                ...
                <td rowspan="2"><?php if($row_Recordset13['r29p5']==0 || $row_Recordset13['r29p5']==2){echo 'NO';} if($row_Recordset13['r29p5']==1){echo 'SI';} ?></td>
