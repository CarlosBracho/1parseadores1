...
<center>
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\parley\apc_hockey1.php - QUERY 1 */ SELECT * FROM p2juegos 
...
do {
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\apc_hockey1.php - QUERY 2 */ SELECT *
FROM p1equipos
WHERE  
Id_p1equiposp1 = %s",
    ...
    $query_Recordset22 = sprintf(
        "/* PARSEADORES1 new\parley\apc_hockey1.php - QUERY 3 */ SELECT *
...
<th><h6><small data-toggle="modal" data-target="#exampleModal94"  onclick="actualizahora(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>);" class="font-weight-bold"><?php echo strftime("%A %d ", strtotime($row_Recordset1['iniciodtp2']));
    $nuevahora1 = strtotime('+6 hour', strtotime($row_Recordset1['iniciodtp2']));
    $nuevahora1 = date('Y-m-j H:i:s', $nuevahora1);
    echo date("g:ia", strtotime($nuevahora1)); ?></small></h6></th><th><h6><small class="font-weight-bold">Ganar</small></h6></th><th><h6><small class="font-weight-bold">A/B</small></h6></th><th><h6><small class="font-weight-bold">RunLine</small></h6></th></tr>
...
<?php list($lg, $Id_p3logros, $lgABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegosp2'], 1, 'ML', $tlarray, $tlarray1);
    if(isset($lg)){
        ...
        $datos=$ver[0]."||".
               ...
               $ver[3];
    if ($lg!=0) {?>
<td id="<?php echo $idequipo1; ?>1_<?php  echo $Id_p3logros; ?>"<?php if($tipo==0){?> onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" <?php } ?> <?php if($tipo==7){?>  data-toggle="modal" data-target="#modalEdicion2" onclick="agregaformlogros('<?php echo $datos ?>')" <?php //estoy aqui
 } ?>
...
<?php } else {?><td id="<?php echo $idequipo1; ?>1_<?php  echo $Id_p3logros; ?>"<?php if($tipo==0){?> onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" <?php } ?> <?php if($tipo==7){?>  data-toggle="modal" data-target="#modalEdicion" onclick="agregaformlogros('<?php echo $datos ?>')" <?php //estoy aqui
 } ?>
class="<?php echo $idequipo1; ?>1,ML, ,<?php echo $lgABoRL; ?>,<?php  echo $lg; ?>,<?php echo $row_Recordset21['nomequipop1']; ?>,<?php echo $row_Recordset1['Id_p2juegosp2']; ?>,1,<?php echo $row_Recordset1['Id_p2juegosp2']; ?>,1, ,17:08:00,<?php echo $row_Recordset21['nomequipop1']; ?>">
...
<?php $psi=0; if ($lg>0) { $psi=1;  } deam($psi, $lg, $ttl); ?></td>
<?php } else {?><td id="<?php echo $idequipo2; ?>1_<?php echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#modalEdicion2" onclick="agregaformlogros('<?php echo $datos ?>')" <?php //estoyd aqui
 } ?>  
class="<?php echo $idequipo2; ?>1,RL,<?php echo $lgABoRL; ?>,<?php echo $Id_p3logros; ?>,<?php  echo
$lg; ?>,<?php echo $row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,2,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,,13:10:00,<?php echo $row_Recordset22['nomequipop1'];?>"><small class="text-success"><b><?php echo $lgABoRL; ?> </b></small> 
...
<?php list($lg, $Id_p3logros, $lgABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegosp2'], 2, 'ML', $tlarray, $tlarray1);
    if(isset($lg)){
        ...
        $datos=$ver[0]."||".
               ...
               $ver[3];
    if ($lg!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#modalEdicion2" onclick="agregaformlogros('<?php echo $datos ?>')" <?php //estoy aqui
 } ?> 
...
<?php $psi=0; if ($lg>0) { $psi=1;  } deam($psi, $lg, $ttl); ?></td>
<?php } else {?><td id="<?php echo $idequipo2; ?>2_<?php echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#modalEdicion2" onclick="agregaformlogros('<?php echo $datos ?>')" <?php //estoy aqui
 } ?> 
class="<?php echo $idequipo2; ?>2,ML, ,<?php  echo $Id_p3logros; ?>,<?php  echo $lg; ?>,<?php echo $row_Recordset22['nomequipop1']; ?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,5,<?php echo $row_Recordset1['Id_p2juegosp2']; ?>,1, ,17:08:00,<?php echo $row_Recordset22['nomequipop1']; ?>">
<?php $psi=0; if ($lg==0) { $psi=1;  } deam($psi, $lg, $ttl); ?></td><?php } }else{$tipojugada='ML';
