...
"/* PARSEADORES1 new\parley\adpsinresultados.php - QUERY 1 */ SELECT *
FROM p2juegos
WHERE
iniciodtp2 >= %s AND 
iniciodtp2 <= %s
...
do {
	...
	$query_Recordset14 = sprintf(
		"/* PARSEADORES1 new\parley\adpsinresultados.php - QUERY 2 */ SELECT *
		FROM p5resultadosj
		WHERE
		iniciodtp5 >= %s AND 
		iniciodtp5 <= %s AND 
...
//echo $D.'<br>';
			$query_Recordset144 = sprintf(
				"/* PARSEADORES1 new\parley\adpsinresultados.php - QUERY 3 */ SELECT *
			...
			if($totalRows_Recordset144>=1){
				...
				$query_Recordset21 = sprintf(
					"/* PARSEADORES1 new\parley\adpsinresultados.php - QUERY 4 */ SELECT *
					FROM p1equipos
					WHERE  
					...
					"/* PARSEADORES1 new\parley\adpsinresultados.php - QUERY 5 */ SELECT *
					FROM p1equipos
					WHERE  
...
if($D==2){
	//echo $D.'<br>';
			$jn++;
			$query_Recordset21 = sprintf(
				"/* PARSEADORES1 new\parley\adpsinresultados.php - QUERY 6 */ SELECT *
				FROM p1equipos
				WHERE  
				...
				$equipo1=$row_Recordset21['nomequipop1'];
				$query_Recordset22 = sprintf(
				"/* PARSEADORES1 new\parley\adpsinresultados.php - QUERY 7 */ SELECT *
				FROM p1equipos
				WHERE  
