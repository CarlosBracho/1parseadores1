...
$query_Recordset13 = sprintf(
	"/* PARSEADORES1 new\parley\resultado_futbolamericano.php - QUERY 1 */ SELECT *
	FROM p5resultadosj
	WHERE
	deportep5 = %s AND 
	iniciodtp5 >= %s AND 
...
do {
	...
	$query_Recordset301 = sprintf(
		"/* PARSEADORES1 new\parley\resultado_futbolamericano.php - QUERY 2 */ SELECT * FROM p2juegos, p5resultadosj WHERE 
