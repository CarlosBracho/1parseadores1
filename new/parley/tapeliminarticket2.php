...
"/* PARSEADORES1 new\parley\tapeliminarticket2.php - QUERY 1 */ SELECT 
*     
FROM
p4jugadas, p2juegos
WHERE   
...
$query_Recordset19 = sprintf(
    "/* PARSEADORES1 new\parley\tapeliminarticket2.php - QUERY 2 */ SELECT 
    *
    FROM
    p4jugadas, p2juegos
...
if($totalRows_Recordset19>0){ ?>
    ...
    <center><p><H1><FONT SIZE=25>TICKET CONTIENE JUGADAS CON JUEGOS YA INICIADOS</FONT></H1></p></center>
    </div>
    </div>
...
"/* PARSEADORES1 new\parley\tapeliminarticket2.php - QUERY 3 */ UPDATE p4jugadas  SET 
premioapagarp4=%s,
jugadadtp4pago=%s,
estadoticketp4=%s 
WHERE Id_p4jugadasp4=%s",
GetSQLValueString($row_Recordset12['mon_ventap4'], "double"),
GetSQLValueString($datetime, "date"),
...
"/* PARSEADORES1 new\parley\tapeliminarticket2.php - QUERY 4 */ SELECT 
*
FROM
p4jugadas
WHERE
...
<div class="card">
    ...
    <center><p><H1><FONT SIZE=25>
        Ticket Eliminado Cancelar <?php echo $row_Recordset12['mon_ventap4'].' '.$moneda; ?></FONT></H1></p></center><br/>
...
<?php }
    ...
    <center><p><H1><FONT SIZE=25>TICKET YA A SIDO ELIMINADO</FONT></H1></p></center>
    </div>
    </div>
    <?php  }}?>