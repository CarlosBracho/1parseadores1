...
"/* PARSEADORES1 new\parley\adpaprobar2.php - QUERY 1 */ SELECT 
*     
FROM
p4jugadas, p2juegos
WHERE   
...
$query_Recordset19 = sprintf(
    "/* PARSEADORES1 new\parley\adpaprobar2.php - QUERY 2 */ SELECT 
    *
    FROM
    p4jugadas, p2juegos
...
"/* PARSEADORES1 new\parley\adpaprobar2.php - QUERY 3 */ UPDATE p4jugadas  SET 
pverificado=%s,
quien_apruebap4=%s 
...
"/* PARSEADORES1 new\parley\adpaprobar2.php - QUERY 4 */ SELECT 
*
FROM
p4jugadas
WHERE
...
$insertSQL2 = sprintf(
        "/* PARSEADORES1 new\parley\adpaprobar2.php - QUERY 5 */ INSERT 
        INTO bitacora 
...
$query_Recordset12 = sprintf(
"/* PARSEADORES1 new\parley\adpaprobar2.php - QUERY 6 */ SELECT 
*     
FROM
p4jugadas, p2juegos
WHERE   
...
$query_Recordset19 = sprintf(
    "/* PARSEADORES1 new\parley\adpaprobar2.php - QUERY 7 */ SELECT 
    *
    FROM
    p4jugadas, p2juegos
    WHERE p4jugadas.nticketp4 = %s AND
...
$insertSQL155 = sprintf(
"/* PARSEADORES1 new\parley\adpaprobar2.php - QUERY 8 */ UPDATE p4jugadas  SET 
...
$query_Recordset1 = sprintf(
"/* PARSEADORES1 new\parley\adpaprobar2.php - QUERY 9 */ SELECT 
*
FROM
p4jugadas
WHERE
