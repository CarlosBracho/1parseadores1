  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<ul class="navbar-nav mr-auto">
         ...
         <a class="dropdown-item" href="listaapostadora.php">Lista De Apostadores</a>
	        ...
	        <li class="nav-item">
        <a class="dropdown-item" href="adlistajuegos.php">Lista de Juegos<span class="sr-only">(current)</span></a>
      </li>
	        <li class="nav-item">
        <a class="dropdown-item" href="adlistaequipos.php">Lista de Equipos<span class="sr-only">(current)</span></a>
      </li>
