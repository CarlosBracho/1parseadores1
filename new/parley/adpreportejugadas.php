...
$query_Recordset13 = sprintf("/* PARSEADORES1 new\parley\adpreportejugadas.php - QUERY 1 */ SELECT *
FROM p4jugadas
WHERE
p4jugadas.jugadadtp4 >= %s AND p4jugadas.jugadadtp4 <= %s AND
p4jugadas.lineatp4= 1 ORDER BY p4jugadas.estadoticketp4 = 1 AND p4jugadas.pverificado = 1 DESC",
...
if(isset($_POST['ticket'])){
  $insertSQL1 = sprintf(
    "/* PARSEADORES1 new\parley\adpreportejugadas.php - QUERY 2 */ UPDATE p4jugadas
...
SET
    ...
    nticketp4 = %s
    ",
    GetSQLValueString(($_POST['Aprobado']), "text"),
...
if ($totalRows_Recordset13>=1) {
    do {
      ...
      $query_Recordset19 = sprintf(
        "/* PARSEADORES1 new\parley\adpreportejugadas.php - QUERY 3 */ SELECT 
        *
        FROM
    p4jugadas, p2juegos
    WHERE
    ...
    p4jugadas.nticketp4 = %s   ORDER BY p4jugadas.lineatp4 DESC",
        GetSQLValueString($row_Recordset13['nticketp4'], "int"));
               ...
               $query_Recordset18 = sprintf(
                  "/* PARSEADORES1 new\parley\adpreportejugadas.php - QUERY 4 */ SELECT 
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 new\parley\adpreportejugadas.php - QUERY 5 */ SELECT *
                FROM p4jugadas
                WHERE
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
 $query_Recordset135 = sprintf("/* PARSEADORES1 new\parley\adpreportejugadas.php - QUERY 6 */ SELECT *
FROM p4jugadas
WHERE
...
if ($row_Recordset135['estadoticketp4']==1 && ($row_Recordset135['pverificado']==1)) { echo 'Ganador Aprobado Pendiente <br> por Pagar en Taquilla<br>';}}
if ($row_Recordset135['estadoticketp4']==1 && ($row_Recordset135['quien_apruebap4']<>'')) { echo '<b> Aprobado por '. $row_Recordset13['quien_apruebap4'];}
...
$query_Recordset1 = sprintf(
  "/* PARSEADORES1 new\parley\adpreportejugadas.php - QUERY 7 */ SELECT 
*
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form method="POST" name="Finalizar" action="<?php echo $editFormAction; ?>" onsubmit="return chequearEnvio();">
        <input type="text" name="ticket" id="" placeholder="Ingrese N* Ticket">
