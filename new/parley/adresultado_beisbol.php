...
if ($totalRows_Recordset1b>=1) {
    do {
        $query_Recordset301 = sprintf(
            "/* PARSEADORES1 new\parley\adresultado_beisbol.php - QUERY 1 */ SELECT * FROM p2juegos, p5resultadosj WHERE 
...
if($row_Recordset1b['quienmete']<>0 && $row_Recordset1b['quienmete']<>''){
    $query_Recordset301d = sprintf(
        "/* PARSEADORES1 new\parley\adresultado_beisbol.php - QUERY 2 */ SELECT nom_usuario FROM usuario WHERE 
    id_usuario = %s
    ",
