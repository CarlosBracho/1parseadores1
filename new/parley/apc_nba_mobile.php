...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\parley\apc_nba_mobile.php - QUERY 1 */ SELECT * FROM p2juegos 
...
do {
        $query_Recordset21 = sprintf(
            "/* PARSEADORES1 new\parley\apc_nba_mobile.php - QUERY 2 */ SELECT *
FROM p1equipos WHERE Id_p1equiposp1 = %s",
        ...
        $query_Recordset22 = sprintf(
            "/* PARSEADORES1 new\parley\apc_nba_mobile.php - QUERY 3 */ SELECT *
FROM p1equipos WHERE Id_p1equiposp1 = %s",
