...
$insertSQL155 = sprintf(
    "/* PARSEADORES1 new\parley\admodificarjugadas2.php - QUERY 1 */ UPDATE p4jugadas  SET 
...
if(isset($_POST['Reinicio'])){
    $insertSQL155 = sprintf(
        "/* PARSEADORES1 new\parley\admodificarjugadas2.php - QUERY 2 */ UPDATE p4jugadas  SET 
...
"/* PARSEADORES1 new\parley\admodificarjugadas2.php - QUERY 3 */ SELECT 
*     
FROM
p4jugadas, p2juegos
WHERE   
...
$query_Recordset19 = sprintf(
    "/* PARSEADORES1 new\parley\admodificarjugadas2.php - QUERY 4 */ SELECT 
    *
    FROM
    p4jugadas, p2juegos
...
"/* PARSEADORES1 new\parley\admodificarjugadas2.php - QUERY 5 */ SELECT 
*
FROM
p4jugadas,
p2juegos
