...
<div <?php if($scroll==1){ echo 'id=scrollj'; } ?> class="border border-danger">
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\parley\apc_hockey.php - QUERY 1 */ SELECT * FROM p2juegos 
...
do {
    ...
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 new\parley\apc_hockey.php - QUERY 2 */ SELECT *
FROM p1equipos
WHERE  
Id_p1equiposp1 = %s",
    ...
    $query_Recordset22 = sprintf(
        "/* PARSEADORES1 new\parley\apc_hockey.php - QUERY 3 */ SELECT *
...
<?php if ($row_Recordset5['hockey_ml'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
<?php
...
<?php if ($row_Recordset5['hockey_alta'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
<?php
...
<?php
if ($row_Recordset5['hockey_alta'] == 0) {?>
...
<?php if ($row_Recordset5['hockey_runline'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
<?php
...
<?php
if ($row_Recordset5['hockey_runline'] == 0) {?>
...
<?php if ($row_Recordset5['hockey_baja'] == 1) {?>
    <td style="color: red;">
    BLOQUEADO
    </td>
<?php
...
<?php
if ($row_Recordset5['hockey_baja'] == 0) {?>
