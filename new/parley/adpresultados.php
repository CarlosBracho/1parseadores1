...
$query_Recordset1b = sprintf(
    "/* PARSEADORES1 new\parley\adpresultados.php - QUERY 1 */ SELECT * FROM p5resultadosj WHERE 
deportep5 = %s AND 
iniciodtp5 >= %s AND
iniciodtp5 <= %s AND
equipo1p5 > ' ' AND
...
$query_Recordset1baloncesto = sprintf(
    "/* PARSEADORES1 new\parley\adpresultados.php - QUERY 2 */ SELECT * FROM p5resultadosj WHERE 
deportep5 = %s AND 
iniciodtp5 >= %s AND
iniciodtp5 <= %s AND
equipo1p5 > ' ' AND
...
$query_Recordset1futbol = sprintf(
    "/* PARSEADORES1 new\parley\adpresultados.php - QUERY 3 */ SELECT * FROM p5resultadosj WHERE 
deportep5 = %s AND 
iniciodtp5 >= %s AND
iniciodtp5 <= %s AND
equipo1p5 > ' ' AND
...
$query_Recordset1hockey = sprintf(
    "/* PARSEADORES1 new\parley\adpresultados.php - QUERY 4 */ SELECT * FROM p5resultadosj WHERE 
deportep5 = %s AND 
iniciodtp5 >= %s AND
iniciodtp5 <= %s AND
equipo1p5 > ' ' AND
...
$query_Recordset1futbolame = sprintf(
    "/* PARSEADORES1 new\parley\adpresultados.php - QUERY 5 */ SELECT * FROM p5resultadosj WHERE 
deportep5 = %s AND 
iniciodtp5 >= %s AND
iniciodtp5 <= %s AND
equipo1p5 > ' ' AND
...
<div class="tab-pane fade" id="beisbol">
...
<?php require_once('adresultado_beisbol.php'); ?>
                             </div>
                        </div>
                    </div>
                </div>
...
<div class="card">
                    <div class="card-body border border-primary" style="padding: 0;">
                        <div class="row">
                            <div class="col-lg-12 mb-4 table-responsive">
<?php require_once('adresultado_baloncesto.php'); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="card">
                    <div class="card-body border border-success" style="padding: 0;">
                        <div class="row">
                            <div class="col-lg-12 mb-4 table-responsive">
<?php require_once('adresultado_futbol.php'); ?>
                            </div>
                        </div>
                    </div>
                </div> 
...
<div class="card">
                    <div class="card-body border border-info" style="padding: 0;">
                        <div class="row">
                            <div class="col-lg-12 mb-4 table-responsive">
<?php require_once('adresultado_futbolame.php'); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="card">
                    <div class="card-body border border-danger" style="padding: 0;">
                        <div class="row">
                            <div class="col-lg-12 mb-4 table-responsive">
<?php require_once('adresultado_hockey.php'); ?>
                            </div>
                        </div>
                    </div>
                </div>
