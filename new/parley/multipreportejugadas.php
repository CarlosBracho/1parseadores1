...
if (isset($_POST['fecha_inicio']) && isset($_POST['fecha_fin'])) {
    ...
    $iniciof=$_POST['fecha_inicio'].' 00:00:01';
     $finalf=$_POST['fecha_fin'].' 23:59:59';
        ...
        "/* PARSEADORES1 new\parley\multipreportejugadas.php - QUERY 1 */ SELECT *
					FROM usuario, p4jugadas, agencia, taquilla, banca, multidistriMD
					WHERE
          ...
          agencia.cod_banca = banca.cod_banca AND banca.cod_multidistriMDBA = multidistriMD.cod_multidistriMD AND multidistriMD.cod_multidistriMD = %s
    ...
    $query_Recordset1890 = sprintf(
      "/* PARSEADORES1 new\parley\multipreportejugadas.php - QUERY 2 */ SELECT factor_de_hembra, factor_de_macho
       FROM 
    ...
    $query_Recordset1 = sprintf(
      "/* PARSEADORES1 new\parley\multipreportejugadas.php - QUERY 3 */ SELECT 
    *
...
if ($totalRows_Recordset13>=1) {
    do {
      ...
      $query_Recordset19 = sprintf(
        "/* PARSEADORES1 new\parley\multipreportejugadas.php - QUERY 4 */ SELECT 
        *
        FROM
    p4jugadas, p2juegos
    WHERE
    ...
    $totalRows_Recordset19 = mysqli_num_rows($Recordset19);
      ...
      "/* PARSEADORES1 new\parley\multipreportejugadas.php - QUERY 5 */ SELECT 
...
Del Distribuidor:<?php echo $row_Recordset18['nom_banca']; ?> <br/>     
</br>
</a></br>
			<?php
?>
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 new\parley\multipreportejugadas.php - QUERY 6 */ SELECT *
                FROM p4jugadas
                WHERE
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
                            ...
                            $query_Recordset135 = sprintf(
                                "/* PARSEADORES1 new\parley\multipreportejugadas.php - QUERY 7 */ SELECT *
					FROM usuario, p4jugadas, agencia, banca, multidistrimd, taquilla
					WHERE
                    ...
                    multidistrimd.cod_multidistriMD = %s AND
...
$query_Recordset1 = sprintf(
  "/* PARSEADORES1 new\parley\multipreportejugadas.php - QUERY 8 */ SELECT 
*
