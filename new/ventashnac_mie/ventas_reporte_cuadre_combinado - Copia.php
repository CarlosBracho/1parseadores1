...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\ventashnac_mie\ventas_reporte_cuadre_combinado - Copia.php - QUERY 1 */ SELECT * 
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\ventashnac_mie\ventas_reporte_cuadre_combinado - Copia.php - QUERY 2 */ SELECT * 
    ...
    if (isset($_POST['fecha_inicio']) && isset($_POST['fecha_fin'])) {
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_usuario']!="todos") {
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 new\ventashnac_mie\ventas_reporte_cuadre_combinado - Copia.php - QUERY 3 */ SELECT * 
				FROM 
                ...
                //-------------------------------------- AMERICANAS --- INICIO
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\ventashnac_mie\ventas_reporte_cuadre_combinado - Copia.php - QUERY 4 */ SELECT * 
				FROM agencia, taquilla, taquilla_opc_ame, venta, usuario, carrera 
				WHERE usuario.cod_taquilla = taquilla.cod_taquilla AND usuario.id_usuario = venta.id_usuario AND
				(venta.fec_venta >= %s AND venta.fec_venta <= %s OR venta.fec_pago >= %s AND venta.fec_pago <= %s) AND 
				taquilla.cod_agencia = agencia.cod_agencia AND taquilla.cod_taquilla = venta.cod_taquilla AND
            ...
            //-------------------------------------- AMERICANAS --- FIN
                ...
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 new\ventashnac_mie\ventas_reporte_cuadre_combinado - Copia.php - QUERY 5 */ SELECT * 
				FROM agencia, taquilla, taquilla_opc_hnac, venta_hnac, usuario, carrera_hnac 
				WHERE taquilla.cod_taquilla = usuario.cod_taquilla AND venta_hnac.id_usuario = usuario.id_usuario AND
				(venta_hnac.fec_venta_hnac >= %s AND venta_hnac.fec_venta_hnac <= %s OR 
				venta_hnac.fec_pago_hnac >= %s AND venta_hnac.fec_pago_hnac <= %s) AND 
                ...
                //-------------------------------------- AMERICANAS --- INICIO
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\ventashnac_mie\ventas_reporte_cuadre_combinado - Copia.php - QUERY 6 */ SELECT * 
				FROM agencia, taquilla, taquilla_opc_ame, venta, usuario, carrera 
				WHERE usuario.cod_taquilla = taquilla.cod_taquilla AND usuario.id_usuario = venta.id_usuario AND
				(venta.fec_venta >= %s AND venta.fec_venta <= %s OR venta.fec_pago >= %s AND venta.fec_pago <= %s) AND 
				taquilla.cod_agencia = agencia.cod_agencia AND taquilla.cod_taquilla = venta.cod_taquilla AND
...
$query_Recordset2 = sprintf("/* PARSEADORES1 new\ventashnac_mie\ventas_reporte_cuadre_combinado - Copia.php - QUERY 7 */ SELECT * FROM usuario 
            ...
            do {
                ...
                if ($row_Recordset3['est_ticket_hnac']==1 && $row_Recordset3['est_cierre_hnac']!=0) {
                    ...
                    $query_Recordset21 = sprintf(
                        "/* PARSEADORES1 new\ventashnac_mie\ventas_reporte_cuadre_combinado - Copia.php - QUERY 8 */ SELECT resultados_hnac.div_pago_hnac, inscritos.est_favorito_hnac,
