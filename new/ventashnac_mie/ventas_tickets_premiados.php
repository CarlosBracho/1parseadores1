    ...
    if (isset($_POST['fecha_inicio'])) {
        ...
        if ($ecie==0 &&	$ecar==0) {
            $query_Recordset81 = sprintf(
                "/* PARSEADORES1 new\ventashnac_mie\ventas_tickets_premiados.php - QUERY 1 */ SELECT
					est_carrera_hnac, 
					est_cierre_hnac,
					est_calculo_hnac,				
            ...
            $query_Recordset81 = sprintf(
                "/* PARSEADORES1 new\ventashnac_mie\ventas_tickets_premiados.php - QUERY 2 */ SELECT 
					est_carrera_hnac, 
					est_cierre_hnac,
					est_calculo_hnac,				
					venta_hnac.pag_premio_hnac, 
...
$query_Recordset2 = sprintf("/* PARSEADORES1 new\ventashnac_mie\ventas_tickets_premiados.php - QUERY 3 */ SELECT usuario.nom_usuario, usuario.id_usuario, taquilla.nom_taquilla FROM usuario, taquilla 
...
$query_Recordset4 = sprintf(
    "/* PARSEADORES1 new\ventashnac_mie\ventas_tickets_premiados.php - QUERY 4 */ SELECT 
