...
if (isset($_GET["cod_carrera"])) {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\ventashnac_mie\buscaEjemplar.php - QUERY 1 */ SELECT
        ...
        GetSQLValueString($_GET["cod_carrera"], "int")
    );
    ...
    if ($totalRows_Recordset1>0) {
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 new\ventashnac_mie\buscaEjemplar.php - QUERY 2 */ SELECT
			ins.cod_inscrito_hnac,
			ins.nom_caballo_hnac,
			ins.num_caballo_hnac,
			ca.num_carrera_hnac,
        ...
        echo '$("#guarda").removeAttr("disabled");';
