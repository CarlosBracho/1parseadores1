...
if (isset($_GET["uVenta"])) {
    ...
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 new\ventashnac_mie\t_imprimePizarra.php - QUERY 1 */ SELECT 
        ...
        if (isset($totalRows_Recordset2) && $totalRows_Recordset2>0) {
            do {
                ...
                if ($row_Recordset2['est_inscrito_hnac']==0) {?>
                    <BR/>EJEMP:. <?php echo $row_Recordset2['num_caballo_hnac']; ?> 
                     -- RETIRADO
                    <?php
                    } else {
                        $gan=0;
                        ...
                        //}?>
				<BR/>EJEMP:. <?php echo $row_Recordset2['num_caballo_hnac']; ?>
				. : .  <?php echo number_format($gan, 2, ",", "."); ?> Bs
				<?php echo $tipFav; ?>
			  ...
			  <?php
					...
					<?php
						...
						<BR/>.:TOTAL:. <?php echo number_format($totCarr, 2, ",", "."); ?> Bs:.<BR/><BR/><BR/><BR/><BR/>..
