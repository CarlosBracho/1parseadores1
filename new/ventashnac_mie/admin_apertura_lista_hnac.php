...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\ventashnac_mie\admin_apertura_lista_hnac.php - QUERY 1 */ SELECT 
	...
	ORDER BY carrera_hnac.est_confirmacion_hnac ASC, carrera_hnac.num_carrera_hnac ASC, carrera_hnac.hor_carrera_hnac ASC",
...
if ($totalRows_Recordset1>0) {
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 new\ventashnac_mie\admin_apertura_lista_hnac.php - QUERY 2 */ SELECT dv.cod_dividendo_macu, dv.div_pago_macu
		FROM 
...
$query_Recordset3 = sprintf("/* PARSEADORES1 new\ventashnac_mie\admin_apertura_lista_hnac.php - QUERY 3 */ SELECT * FROM ctrol_ventpag_global_hnac WHERE cod_ctrol_ventpag_global_hnac = 1");
