...
if (isset($_GET["recordID"])) {
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 new\ventashnac_mie\ventas_reimprimir_ultimo_hnac.php - QUERY 1 */ SELECT 
    ...
    $query_Recordset2 = sprintf("/* PARSEADORES1 new\ventashnac_mie\ventas_reimprimir_ultimo_hnac.php - QUERY 2 */ SELECT venta_hnac.ticket_hnac 
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\ventashnac_mie\ventas_reimprimir_ultimo_hnac.php - QUERY 3 */ SELECT 
...
if ($horacarrerabd >= horaactual() && $row_Recordset1['fec_venta_hnac']==fechaactualbd() && $totalRows_Recordset1>0 &&
    ...
    if ($rimp==1 && $row_Recordset1['rei_ticket_hnac']==0) {
        if ($conte==1) {
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\ventashnac_mie\ventas_reimprimir_ultimo_hnac.php - QUERY 4 */ INSERT 
					INTO reimpresion 
            ...
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 new\ventashnac_mie\ventas_reimprimir_ultimo_hnac.php - QUERY 5 */ UPDATE reimpresion 
					SET can_actual=%s
        ...
        $insertSQL2 = sprintf(
            "/* PARSEADORES1 new\ventashnac_mie\ventas_reimprimir_ultimo_hnac.php - QUERY 6 */ UPDATE venta_hnac 
