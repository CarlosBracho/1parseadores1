...
if ($ecie==0 &&	$ecar==0) {
    $query_Recordset81 = sprintf(
        "/* PARSEADORES1 new\ventashnac_mie\base_hnac\bPremio_ta_hnac.php - QUERY 1 */ SELECT 
    ...
    $query_Recordset81 = sprintf(
        "/* PARSEADORES1 new\ventashnac_mie\base_hnac\bPremio_ta_hnac.php - QUERY 2 */ SELECT 
					venta_hnac.ser_venta_hnac,
					venta_hnac.ticket_hnac,
					venta_hnac.mon_venta_hnac,
