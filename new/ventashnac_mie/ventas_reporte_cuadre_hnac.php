...
$query_Recordset2 = sprintf("/* PARSEADORES1 new\ventashnac_mie\ventas_reporte_cuadre_hnac.php - QUERY 1 */ SELECT usuario.nom_usuario, usuario.id_usuario, taquilla.nom_taquilla FROM usuario, taquilla 
...
if ($vendedor=="") {
    $query_Recordset3 = sprintf("/* PARSEADORES1 new\ventashnac_mie\ventas_reporte_cuadre_hnac.php - QUERY 2 */ SELECT nom_usuario FROM usuario WHERE usuario.id_usuario = %s AND tip_usuario='U' 
