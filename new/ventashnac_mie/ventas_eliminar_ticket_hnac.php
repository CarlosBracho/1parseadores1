...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\ventashnac_mie\ventas_eliminar_ticket_hnac.php - QUERY 1 */ SELECT tic_eliminados 
...
if ($totaleliminados<=$maximo) {
    $query_Recordset8 = sprintf(
        "/* PARSEADORES1 new\ventashnac_mie\ventas_eliminar_ticket_hnac.php - QUERY 2 */ SELECT cod_taquilla 
								 FROM usuario 
    ...
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 new\ventashnac_mie\ventas_eliminar_ticket_hnac.php - QUERY 3 */ SELECT 
    ...
    if ($totalRows_Recordset2>=1 && $row_Recordset2['est_ticket_hnac']==1 && $row_Recordset2['est_carrera_hnac']==1 &&
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 new\ventashnac_mie\ventas_eliminar_ticket_hnac.php - QUERY 4 */ SELECT num_ticket_hnac 
			FROM 
			venta_hnac
			WHERE 
        ...
        if ($totalRows_Recordset3>0) {
            ...
            do {
                $updateSQL3 = sprintf(
                    "/* PARSEADORES1 new\ventashnac_mie\ventas_eliminar_ticket_hnac.php - QUERY 5 */ UPDATE venta_hnac SET est_ticket_hnac=%s, fec_pago_hnac=%s, hor_pago_hnac=%s 
