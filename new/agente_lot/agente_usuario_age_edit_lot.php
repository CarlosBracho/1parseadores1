...
$xCodigo = "-1";
$xCodigo = $_SESSION['MM_id_usuario'];
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $menE="";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\agente_lot\agente_usuario_age_edit_lot.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
				WHERE id_usuario=%s",
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\agente_lot\agente_usuario_age_edit_lot.php - QUERY 2 */ SELECT 
	us.id_usuario, us.nom_usuario, us.nom_completo, us.tip_usuario, us.cod_taquilla, us.pas_usuario, us.est_usuario, 
	ba.nom_banca, ag.nom_agencia
	FROM 
	usuario us, banca ba, agencia ag
	WHERE 
	us.id_usuario = %s AND ag.cod_agencia = us.cod_taquilla AND us.tip_usuario = 'G' AND ba.cod_banca = %s AND 
	ag.cod_agencia = %s AND ag.cod_banca = ba.cod_banca
	LIMIT 1",
                        ...
                        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="font-size:10px;border-bottom:1px solid  #D5D5D5;" height="45" align="center">
                                    <?php echo '<font size="1">AGENTE '.$row_Recordset1['nom_agencia'].'</font><br/>'; ?>
