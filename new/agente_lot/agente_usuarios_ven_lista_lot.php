...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\agente_lot\agente_usuarios_ven_lista_lot.php - QUERY 1 */ SELECT 
			us.id_usuario, us.nom_usuario, ta.nom_taquilla, ta.tel_taquilla,
			CASE us.est_usuario 
		...
		WHERE 
			us.cod_taquilla = ta.cod_taquilla AND us.tip_usuario = 'U' AND ta.cod_agencia = ag.cod_agencia AND ag.cod_agencia = %s
		ORDER BY 
...
<div class="container">
  ...
  <div class="contentAdmin">
	...
	<tr style="background:#0084B4; color:#FFFFFF; height:30px; font-family:'Lucida Grande','Lucida Sans Unicode','Lucida Sans','DejaVu Sans',Verdana,sans-serif;" valign="bottom">
		...
		<td width="33%" align="center">TAQUILLA</td>
  ...
  <?php do { ?>
		<tr class="brillo" style="border-bottom:1px solid #D5D5D5" valign="bottom">
			...
			<td align="center" valign="middle"><?php
                $url='agente_usuario_ven_edit_lot.php?recordID='.$row_Recordset1['id_usuario'];?>
