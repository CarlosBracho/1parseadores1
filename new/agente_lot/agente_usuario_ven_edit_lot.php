...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $menE="";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\agente_lot\agente_usuario_ven_edit_lot.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
				est_usuario=%s, 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\agente_lot\agente_usuario_ven_edit_lot.php - QUERY 2 */ SELECT 
