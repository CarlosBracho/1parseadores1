...
$MM_authorizedUsers = "G"; include("../includes/comprobar_acceso.php");
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\agente_lot\agente_taquilla_edit_lot.php - QUERY 1 */ UPDATE taquilla 
        ...
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\agente_lot\agente_taquilla_edit_lot.php - QUERY 2 */ UPDATE taquilla_opc_lot 
...
if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
    $query_Recordset7 =  sprintf(
        "/* PARSEADORES1 new\agente_lot\agente_taquilla_edit_lot.php - QUERY 3 */ SELECT ta.cod_agencia FROM taquilla ta WHERE ta.cod_taquilla = %s LIMIT 1",
        GetSQLValueString($_POST['cod_taquilla'], "int")
    );
    ...
    $query_Recordset6 =  sprintf(
        "/* PARSEADORES1 new\agente_lot\agente_taquilla_edit_lot.php - QUERY 4 */ SELECT 
    ...
    $query_Recordset8 =  sprintf(
        "/* PARSEADORES1 new\agente_lot\agente_taquilla_edit_lot.php - QUERY 5 */ SELECT cod_taquilla FROM taquilla_opc_lot WHERE cod_taquilla = %s LIMIT 1",
        GetSQLValueString($_POST['cod_taquilla'], "int")
    );
    ...
    if ($totalRows_Recordset6>0&&$totalRows_Recordset7>0&&$totalRows_Recordset8==0) {
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 new\agente_lot\agente_taquilla_edit_lot.php - QUERY 6 */ INSERT 
        ...
        do {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 new\agente_lot\agente_taquilla_edit_lot.php - QUERY 7 */ INSERT 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\agente_lot\agente_taquilla_edit_lot.php - QUERY 8 */ SELECT 
	...
	WHERE ta.cod_taquilla = tp.cod_taquilla AND
		...
		ta.cod_taquilla = %s AND ag.cod_banca = %s AND
		ag.cod_agencia = %s
	LIMIT 1",
...
if ((isset($_POST["MM_insert3"])) && ($_POST["MM_insert3"] == "form3")) {
    $query_Recordset4 =  sprintf("/* PARSEADORES1 new\agente_lot\agente_taquilla_edit_lot.php - QUERY 9 */ SELECT 
    ...
    $query_Recordset4 =  sprintf("/* PARSEADORES1 new\agente_lot\agente_taquilla_edit_lot.php - QUERY 10 */ SELECT 
		tp.tic_caduca_lot, tp.mon_minticket_lot, tp.pag_codigo_lot, tp.tip_ticket_lot, tp.por_taquilla_lot,
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\agente_lot\agente_taquilla_edit_lot.php - QUERY 11 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
FROM taquilla ta, taquilla_opc_lot tp, agencia ag 
WHERE 
	ta.cod_taquilla = tp.cod_taquilla AND ta.cod_taquilla != %s AND ag.cod_agencia = ta.cod_agencia AND ag.cod_banca = %s AND
	ag.cod_agencia = %s 
                    ...
                    echo "SELECTED";
                            ...
                            <tr style="font-size:16px">
                                ...
                                <td width="19%">
                                  ...
                                  <input type="text" name="tel_taquilla2" class="textbox" required tabindex="4"
                                  size="32" pattern="[0-9]{9,20}" maxlength="20" onkeypress="ValidaSoloNumeros()"
                                  value="<?php echo htmlentities($row_Recordset1['tel_taquilla2'], ENT_COMPAT, 'utf-8'); ?>"  
                                  placeholder="02124124125" title="indique número de teléfono. 9 caracteres mín"
                                  onKeyUp="return handleEnter(this, event)"/>
                                </td>
                                <td width="19%">
                                  Nro de contacto 2do auxiliar:<br />
                                  <input type="text" name="tel_taquilla3" class="textbox" required tabindex="5"
                                  size="32" pattern="[0-9]{9,20}" maxlength="20" onkeypress="ValidaSoloNumeros()"
                                  value="<?php echo htmlentities($row_Recordset1['tel_taquilla3'], ENT_COMPAT, 'utf-8'); ?>"  
                                  placeholder="02124124126" title="indique número de teléfono. 9 caracteres mín"
                                  onKeyUp="return handleEnter(this, event)"/>
                                </td>
                            </tr>
						</table>
						...
						<table width="920" align="center" border="0" cellpadding="0" cellspacing="0">
                            <tr bgcolor="#FFFFFF">
                                ...
                                <td align="center" valign="bottom">
                                    <a href='agente_taquillas_lista_lot.php' class="btn  btn-danger"
