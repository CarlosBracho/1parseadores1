...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\admin\dividendos_add.php - QUERY 1 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", GetSQLValueString($xCarrera_Recordset1, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $updateSQL = sprintf(
        "/* PARSEADORES1 new\admin\dividendos_add.php - QUERY 2 */ UPDATE carrera SET 
							est_confirmacion=%s, 
							est_carrera=%s, 
							eje_primero=%s, 
							div_primero_gan=%s, 
    ...
    // if (is_file('../includes/procesar_resultados_tickets_ame.php')) include("../includes/procesar_resultados_tickets_ame.php");
    $updateGoTo = "historial_lista.php";
    if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <div style="height:100%; padding:70px 10px 20px 10px; text-align:left">
      <table width="100%" border="0" height="50" align="center" style="background:#333; color:#FFFFFF; font-size:16px;">
        <tr>
		  ...
		  <?php  echo " - Fecha de cierre: ".fechanueva(ObtenerFechaJugadaCarrera($row_Recordset1['cod_carrera']));?></td>
        </tr>
        <tr bgcolor="#FFFFFF">
          <td width="380"></td>
          <td width="524"></td>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table width="100%" align="center">
          ...
          <tr valign="baseline">
            ...
            <td width="57" align="center" bgcolor="#333" style="color:#FFF">PLA</td>
    ...
    echo htmlentities($eje_superfT[3], ENT_COMPAT, 'utf-8');
          ...
          <tr valign="baseline">
            ...
            <a href="dividendos_lista.php" class="btn btn-warning" 
            	style="width:100px; height:25px; font-size:16px; text-decoration:none; padding:11px 0px 0px 0px">Volver</a></td>
          </tr>
        </table>
        <input type="hidden" name="est_carrera" 
        	value="<?php echo htmlentities($row_Recordset1['est_carrera'], ENT_COMPAT, 'utf-8'); ?>" />
...
var sprytextfield10 = new Spry.Widget.ValidationTextField("sprytextfield10", "integer", {minChars:1, maxChars:2, minValue:1});
