...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin\usuarios_ve_add.php - QUERY 1 */ INSERT 
		INTO usuario 
        ...
        $insertGoTo = "../admin/taquillas_edit.php?recordID=".$xCodigo_taquilla;
        if (isset($_SERVER['QUERY_STRING'])) {
...
$query_Recordset2 = "/* PARSEADORES1 new\admin\usuarios_ve_add.php - QUERY 2 */ SELECT cod_taquilla, nom_taquilla FROM taquilla";
    ...
    if ($i<10) {
        ...
        $v=$i;
                ...
                <tr valign="baseline">
                  ...
                  <a href='../admin/taquillas_edit.php?recordID=<?php echo $xCodigo_taquilla;?>'
'
