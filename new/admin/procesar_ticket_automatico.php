...
if (isset($_POST["recordID"])) {
    ...
    $query_Recordset11 = sprintf(
        "/* PARSEADORES1 new\admin\procesar_ticket_automatico.php - QUERY 1 */ SELECT * 
		FROM 
			venta, carrera 
		WHERE 
			venta.ticket = %s AND 
    ...
    do {
        ...
        $updateSQL11 = sprintf(
            "/* PARSEADORES1 new\admin\procesar_ticket_automatico.php - QUERY 2 */ UPDATE venta 
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\admin\procesar_ticket_automatico.php - QUERY 3 */ SELECT * 
		FROM 
			venta, carrera 
		WHERE 
			venta.ticket = %s AND 
    ...
    $query_Recordset3 = sprintf(
        "/* PARSEADORES1 new\admin\procesar_ticket_automatico.php - QUERY 4 */ SELECT * 
	FROM 
    ...
    $query_Recordset4 = sprintf(
        "/* PARSEADORES1 new\admin\procesar_ticket_automatico.php - QUERY 5 */ SELECT num_caballo, cod_tventa 
								 FROM venta, carrera 
    ...
    if ($montoapagar>0) {
        do {
            ...
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\admin\procesar_ticket_automatico.php - QUERY 6 */ UPDATE venta 
				SET est_ticket=%s, pag_premio=%s 
				WHERE num_ticket=%s",
    ...
    do {
        $updateSQL2 = sprintf(
            "/* PARSEADORES1 new\admin\procesar_ticket_automatico.php - QUERY 7 */ UPDATE venta SET est_calculo=%s WHERE num_ticket=%s",
            GetSQLValueString(1, "int"),
