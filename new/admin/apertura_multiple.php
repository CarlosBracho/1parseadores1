            ...
            if ($bandera==1) {
                ...
                for ($i = 1; $i <= 21; $i++) {
                    if (isset($_POST['box_carrera'.$i])) {
                        ...
                        $insertSQL = sprintf(
                            "/* PARSEADORES1 new\admin\apertura_multiple.php - QUERY 1 */ INSERT INTO carrera (cod_banca, cod_hipodromo, nom_hipodromo, nom_hipodromo_hpi, 
...
$query_Recordset2 = "/* PARSEADORES1 new\admin\apertura_multiple.php - QUERY 2 */ SELECT cod_hipodromo, nom_hipodromo FROM hipodromo WHERE est_hipodromo = 1 ORDER BY nom_hipodromo";
