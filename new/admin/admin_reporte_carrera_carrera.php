    ...
    if ($_POST['id_hipod']!="-1") {
        if ($_POST['id_hipod']!="-1" && $_POST['id_carrera']=="todas") {
            $query_Recordset4 = sprintf(
                "/* PARSEADORES1 new\admin\admin_reporte_carrera_carrera.php - QUERY 1 */ SELECT 
				nom_hipodromo
			FROM hipodromo
            ...
            $query_Recordset4 = sprintf(
                "/* PARSEADORES1 new\admin\admin_reporte_carrera_carrera.php - QUERY 2 */ SELECT 
        ...
        $query_Recordset6 = sprintf(
            "/* PARSEADORES1 new\admin\admin_reporte_carrera_carrera.php - QUERY 3 */ SELECT 
        ...
        if ($_POST['id_agente']!="todos") {
            $query_Recordset5 = sprintf(
                "/* PARSEADORES1 new\admin\admin_reporte_carrera_carrera.php - QUERY 4 */ SELECT nom_taquilla, cod_taquilla FROM taquilla WHERE cod_taquilla = %s",
...
$query_Recordset2 = "/* PARSEADORES1 new\admin\admin_reporte_carrera_carrera.php - QUERY 5 */ SELECT 
	ag.nom_agencia,
	ta.cod_taquilla,
	ta.nom_taquilla 
	FROM 
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\admin\admin_reporte_carrera_carrera.php - QUERY 6 */ SELECT 
...
<script language="javascript">
	...
	function ver2() {
		...
		$.ajax({ data:parametros1, url:'filt_carrera_fecha.php', type:'post',
			success: function(opciones) {                    
				...
				$.ajax({ url:"filt_carrera_hipodromo.php", type: "POST", data:parametros,
	...
	function verInfo() {
		...
		$.ajax({ data:parametros1, url:'reca_carrera_carrera.php', type:'post',
			beforeSend: function() {
...
<div class="container">
    ...
    echo "SELECTED";
                       ...
                       <option value="<?php echo $row_Recordset2['cod_taquilla']?>"
                            ...
                            echo " -- (".strtoupper($row_Recordset2['nom_agencia']).")"; ?>
                       </option>
                              <?php
		  ...
		  <div id="gener" style="width:100%; float:left; height:750px">
                ...
                <div id="reporte" style="width:100%; float:left; height:400px">
					<?php include("reca_carrera_carrera.php");?>
                </div>
			</div>
        </div>
