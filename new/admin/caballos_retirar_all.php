...
if (isset($_GET["recordID"])) {
    ...
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\admin\caballos_retirar_all.php - QUERY 1 */ SELECT * FROM retirados WHERE retirados.cod_carrera = %s", GetSQLValueString($xCodRetirado, "int"));
    ...
    if ($totalRows_Recordset1>0) {
        do {
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\admin\caballos_retirar_all.php - QUERY 2 */ UPDATE
								retirados 
								SET
								cod_carrera=%s
