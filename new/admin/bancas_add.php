...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\admin\bancas_add.php - QUERY 1 */ INSERT 
				INTO banca 
...
dist_cob_hnac,				
        ...
        $query_RecT = "/* PARSEADORES1 new\admin\bancas_add.php - QUERY 2 */ SELECT cod_banca FROM banca ORDER BY cod_banca DESC LIMIT 1";
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 new\admin\bancas_add.php - QUERY 3 */ INSERT 
		INTO usuario 
