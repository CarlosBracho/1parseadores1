...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\admin\dividendos_tvg...php - QUERY 1 */ SELECT * 
	FROM 
	hipodromo,
	carrera 
	WHERE
    ...
    do {
        if ($row_Recordset1['bus_auto']>0 && $row_Recordset1['bus_resultado_tip']>0) {
            ...
            if ($row_Recordset1['bus_resultado_tip']==2 && $row_Recordset1['fec_carrera']==$fech) {
                ...
                //echo $url."<br/>";
                list($cAct, $eje1LugarSimple, $eje1LugarDoble, $eje1LugarTriple, $eje2LugarSimple, $eje2LugarDoble, $eje2LugarTriple, $eje3LugarSimple, $eje3LugarDoble, $eje3LugarTriple, $eje4LugarSimple, $eje4LugarDoble, $eje4LugarTriple, $DivWinPriLugar, $DivWinPriLugarDoble, $DivWinPriLugarTriple, $DivPlaPriLugar, $DivPlaPriLugarDoble, $DivPlaPriLugarTriple, $DivShoPriLugar, $DivShoPriLugarDoble, $DivShoPriLugarTriple, $DivPlaSegLugar, $DivPlaSegLugarDoble, $DivPlaSegLugarTriple, $DivShoSegLugar, $DivShoSegLugarDoble, $DivShoSegLugarTriple, $DivShoTerLugar, $DivShoTerLugarDoble, $DivShoTerLugarTriple, $divExotic, $existe)=resultadoTVG2($url);
            }
                ...
                foreach ($cAct as $hip) {
					...
					<?php
                        ...
                        if (($eje1LugarSimple[$hip]>0 && $DivWinPriLugar[$hip]>0) || $eje1LugarSimple[$hip]==99) {
                            ...
                            $updateSQL = sprintf(
                                "/* PARSEADORES1 new\admin\dividendos_tvg...php - QUERY 2 */ UPDATE carrera 
							SET 
								est_confirmacion=%s,
								control_dividendo=%s,
								eje_primero=%s, 
