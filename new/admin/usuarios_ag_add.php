...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin\usuarios_ag_add.php - QUERY 1 */ INSERT 
		INTO usuario 
...
$query_Recordset2 = "/* PARSEADORES1 new\admin\usuarios_ag_add.php - QUERY 2 */ SELECT cod_agencia, nom_agencia FROM agencia";
        	...
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              <table width="919" align="center">
                ...
                <tr valign="baseline">
                  ...
                  <td width="365" align="left" valign="middle" nowrap>Agente:<br>
