...
$query_Recordset1 = "/* PARSEADORES1 new\admin\usuariosyclaves.php - QUERY 1 */ SELECT * FROM usuario WHERE (tip_usuario='G' OR tip_usuario='D') ORDER BY usuario.nom_usuario ASC";
...
<div class="container">
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
	...
	<table width="100%" border="0" align="center">
          ...
          <td width="238">Usuario</td>
          <td width="188">Clave</td>
        </tr>
        <?php do { ?>
          <tr class="brillo">
            <td align="left"><?php echo $row_Recordset1['nom_usuario']; ?></td>
			
            <td align="left"><?php echo $row_Recordset1['pas_usuario']; ?></td>
