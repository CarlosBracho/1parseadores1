...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin\bancas_edit.php - QUERY 1 */ UPDATE banca 
				SET nom_representante=%s, tel_banca=%s, dir_banca=%s, 
dist_vende_ame=%s,
dist_por_ame=%s,
dist_vende_parley=%s,
dist_por_parley=%s,
dist_vende_hnac=%s,
dist_cob_hnac=%s,
				por_banca_lot=%s, por_banca_macu=%s, est_banca=%s, sinoclavesdistri = %s
				WHERE cod_banca=%s",
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\admin\bancas_edit.php - QUERY 2 */ SELECT *
	FROM  
	banca
	WHERE 
	banca.cod_banca = %s",
...
$query_Recordset94 =  sprintf(
  "/* PARSEADORES1 new\admin\bancas_edit.php - QUERY 3 */ SELECT
