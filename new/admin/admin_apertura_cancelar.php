...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\admin\admin_apertura_cancelar.php - QUERY 1 */ SELECT nom_hipodromo, num_carrera FROM carrera WHERE carrera.cod_carrera = %s",
...
if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $updateSQL = sprintf(
      "/* PARSEADORES1 new\admin\admin_apertura_cancelar.php - QUERY 2 */ UPDATE carrera 
							SET 
							est_carrera=%s, 
							est_cierre=%s, 
							est_confirmacion=%s, 
  ...
  $insertSQL2 = sprintf(
      "/* PARSEADORES1 new\admin\admin_apertura_cancelar.php - QUERY 3 */ INSERT 
					INTO bitacora 
  ...
  echo "<h4><font color='#027BAD'>Proceso culminado! ".$carrera."</font></h4>";
