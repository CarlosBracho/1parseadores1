...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\admin\admin_apertura_reabrir2.php - QUERY 1 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", GetSQLValueString($xReabrirCarrera_Recordset1, "int"));
...
$mtp_control=0;
$updateSQL = sprintf(
    "/* PARSEADORES1 new\admin\admin_apertura_reabrir2.php - QUERY 2 */ UPDATE carrera SET hor_carrera=%s, hor_mtp=%s, mtp_control=%s, est_carrera=%s, est_cierre=%s 
				WHERE cod_carrera=%s",
...
$insertSQL2 = sprintf(
    "/* PARSEADORES1 new\admin\admin_apertura_reabrir2.php - QUERY 3 */ INSERT 
				INTO bitacora 
