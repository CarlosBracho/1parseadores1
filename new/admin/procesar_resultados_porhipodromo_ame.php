...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\admin\procesar_resultados_porhipodromo_ame.php - QUERY 1 */ SELECT cod_carrera, nom_hipodromo, num_carrera FROM carrera WHERE 
