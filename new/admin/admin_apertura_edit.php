...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\admin\admin_apertura_edit.php - QUERY 1 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", GetSQLValueString($xCarrera_Recordset1, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $updateSQL = sprintf(
        "/* PARSEADORES1 new\admin\admin_apertura_edit.php - QUERY 2 */ UPDATE carrera SET 
  		hor_carrera=%s, num_carrera=%s, hor_mtp=%s, can_caballos=%s, est_carrera=%s, est_cierre=%s WHERE cod_carrera=%s",
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
   ...
   <option value="12" <?php if (!(strcmp(12, htmlentities($hora, ENT_COMPAT, 'utf-8')))) {
    ...
    <option value="59" <?php if (!(strcmp(59, htmlentities($minutos, ENT_COMPAT, 'utf-8')))) {
          ...
          <tr valign="baseline">
            <td height="60" colspan="2" align="center" valign="bottom" nowrap="nowrap">
            	<input type="submit" value="Actualizar carrera" class="btn btn-success" style="width:150px; font-size:16px;"/>
            	<a href="admin_apertura_lista.php" class="btn btn-warning" style="width:100px; font-size:18px;">Cancelar</a></td>
          </tr>
        </table>
