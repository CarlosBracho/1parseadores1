...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\admin\cambiodeagente2.php - QUERY 1 */ SELECT 
* 
FROM 
taquilla, agencia
WHERE
...
$query_Recordset2 = sprintf("/* PARSEADORES1 new\admin\cambiodeagente2.php - QUERY 2 */ SELECT 
* 
FROM 
agencia
ORDER BY 
...
if ((isset($_POST["cod_agencia"]))) {
    if ($_POST["cod_agencia"]>=1) {
        $insertSQL2 = sprintf(
            "/* PARSEADORES1 new\admin\cambiodeagente2.php - QUERY 3 */ UPDATE taquilla
SET
cod_agencia=%s
...
<html lang="en">
  ...
  <table class="table table-responsive table-striped">
    ...
    <select  name="cod_agencia" id="cod_agencia" class="form-/* PARSEADORES1 new\admin\cambiodeagente2.php - QUERY 4 */ select form-/* PARSEADORES1 new\admin\cambiodeagente2.php - QUERY 5 */ select-lg mb-3" aria-label=".form-/* PARSEADORES1 new\admin\cambiodeagente2.php - QUERY 6 */ select-lg example">
