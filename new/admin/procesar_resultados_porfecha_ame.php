...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    if (isset($_POST['fecha_inicio']) && isset($_POST['fecha_fin'])) {
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            $query_Recordset0 = sprintf("/* PARSEADORES1 new\admin\procesar_resultados_porfecha_ame.php - QUERY 1 */ SELECT cod_taquilla FROM taquilla");
            ...
            do {
                ...
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\admin\procesar_resultados_porfecha_ame.php - QUERY 2 */ SELECT 
                ...
                if ($totalRows_Recordset1>0) {
                    do {
                        ...
                        echo "<br/>-----------------------------------<br/>";
                        $updateSQL = sprintf(
                            "/* PARSEADORES1 new\admin\procesar_resultados_porfecha_ame.php - QUERY 3 */ UPDATE venta 
