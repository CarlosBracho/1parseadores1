...
$query_Recordset1 = "/* PARSEADORES1 new\admin\usuarios_ad_lista.php - QUERY 1 */ SELECT * FROM usuario WHERE usuario.tip_usuario= 'A' ORDER BY usuario.nom_usuario ASC";
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
  	<div style="height:100%; font-size:18px;" class="xfirefox">
        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:right;">
            <a href="usuarios_ad_add.php" class="btn alert-success" 
            	style="font-size:18px; width:165px; height:40px; padding:5px 0px 0px 0px; text-align:center; background:#9C0;
                text-decoration:none;" title="crear nuevo administrador">
    ...
    <table width="100%" border="0" align="center" style="background: #333; color:#FFF; font-size:14px" >
        <tr>
          ...
          Administradores <?php echo($startRow_Recordset1 + 1) ?>-<?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?> de <?php echo $totalRows_Recordset1 ?></td>
	...
	<table width="100%" border="0" align="center">
        <tr style="background:#5EAEFF; color:#FFFFFF; height:30px">
          <td width="375">NOMBRE</td>
          <td width="278">TIPO</td>
          <td width="201">STATUS</td>
          <td width="68">ACCIÓN</td>
        </tr>
        <?php do { ?>
          <tr class="brillo">
            <td align="left"><?php echo $row_Recordset1['nom_usuario']; ?></td>
            <td align="center"><?php echo ObtenerNombreTipo($row_Recordset1['niv_acceso']); ?></td>
            <td align="center"><?php echo ObtenerNombreStatus($row_Recordset1['est_usuario']); ?></td>
            <td align="center">
            	<a href='usuarios_ad_edit.php?recordID=<?php echo $row_Recordset1['id_usuario']; ?>'class="btn btn-info"> EDITAR </a>
            </td>
          </tr>
