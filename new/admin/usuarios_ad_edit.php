...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin\usuarios_ad_edit.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
				est_usuario=%s, 
            ...
            GetSQLValueString($_POST['niv_acceso'], "int"),
            GetSQLValueString($_POST['id_usuario'], "int")
        );
        
        $Result1 = mysqli_query($conexionbanca, $insertSQL1) or die(mysqli_error($conexionbanca));
        $insertGoTo = "usuarios_ad_lista.php";
        if (isset($_SERVER['QUERY_STRING'])) {
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\admin\usuarios_ad_edit.php - QUERY 2 */ SELECT * 
	FROM 
	usuario 
	WHERE 
        ...
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>" onsubmit="return chequearEnvio();">
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              <table width="919" align="center">
                <tr valign="baseline">
                  <td height="44" colspan="4" align="center" valign="middle" nowrap bgcolor="#5EAEFF" 
                ...
                <tr valign="baseline">
                  ...
                  <td width="117">&nbsp;</td>
                  <td>Nivel de acceso:<br>
					<select name="niv_acceso" style="width:140px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset1['niv_acceso'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>NIVEL 1</option>
                      <option value="2" <?php if (!(strcmp(2, htmlentities($row_Recordset1['niv_acceso'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>NIVEL 2</option>
                      <option value="3" <?php if (!(strcmp(3, htmlentities($row_Recordset1['niv_acceso'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>NIVEL 3</option>
                    </select>
                  </td>
                <tr valign="baseline">
                  <td height="26" colspan="4" align="center" valign="middle" nowrap bgcolor="#5EAEFF">DATOS Y OPCIONES DE USUARIO</td>
                </tr>
              </table>
...
<table width="924" align="center">
          ...
          <input type="hidden" name="tip_usuario" value="A"/>
