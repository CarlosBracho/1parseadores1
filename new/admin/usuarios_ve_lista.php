...
$query_Recordset1 = "/* PARSEADORES1 new\admin\usuarios_ve_lista.php - QUERY 1 */ SELECT * FROM usuario WHERE tip_usuario='U' ORDER BY usuario.nom_usuario ASC";
...
<div class="container">
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
	...
	<table width="100%" border="0" align="center">
          ...
          <td width="188">AGENTE</td>
          <td width="221">TAQUILLA</td>
        ...
        <?php do { ?>
          <tr class="brillo">
            ...
            <td align="left"><?php echo ObtenerNombreAgencia($xagente); ?></td>
