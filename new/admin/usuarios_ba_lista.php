...
$query_Recordset1 = "/* PARSEADORES1 new\admin\usuarios_ba_lista.php - QUERY 1 */ SELECT * 
	FROM 
	usuario, 
	banca 
	WHERE 
	banca.cod_banca = usuario.cod_taquilla AND
	usuario.tip_usuario = 'D'";
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
  	<div style="height:100%; font-size:18px;" class="xfirefox">
        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:right;">
            <a href="usuarios_ba_add.php" class="btn alert-success" 
                ...
                text-decoration:none;" title="crear nuevo usuario distribuidor">
                 Añadir Nuevo Usuario Distribuidor
            </a>
        </div>
	...
	<table width="100%" border="0" align="center">
        ...
        <tr class="brillo">
            ...
            <td align="left"><?php echo $row_Recordset1['nom_banca']; ?></td>
            <td align="center"><?php echo ObtenerNombreStatus($row_Recordset1['est_usuario']); ?></td>
            <td align="center">
            	<a href='usuarios_ba_edit.php?recordID=<?php echo $row_Recordset1['id_usuario']; ?>'class="btn btn-info"> EDITAR </a>
            </td>
