...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\admin\apertura_lista.php - QUERY 1 */ SELECT * FROM carrera WHERE carrera.eje_primero=0 AND carrera.eje_segundo=0 AND carrera.eje_tercero=0 AND carrera.div_primero_gan=0 AND carrera.div_primero_pla=0 AND carrera.div_primero_sho=0 AND carrera.div_segundo_pla=0 AND carrera.div_segundo_sho=0 AND  carrera.div_tercero_sho=0 AND carrera.fec_carrera = %s ORDER BY carrera.hor_carrera ASC", GetSQLValueString($fechasistema, "date"));
