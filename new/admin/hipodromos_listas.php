...
$query_Recordset1 = "/* PARSEADORES1 new\admin\hipodromos_listas.php - QUERY 1 */ SELECT cod_hipodromo, nom_hipodromo, est_hipodromo, bus_auto FROM hipodromo ORDER BY nom_hipodromo ASC";
		...
		if(confirma==true){
			...
			$.ajax({ data:parametros, url:'../includes/cambio_mtp_hipodromo.php', type:'post',
				success:function (response) { 
					...
					window.location='hipodromos_listas.php';
				}
			}); 
		} else window.location='hipodromos_listas.php';
	} else window.location='hipodromos_listas.php';
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
  	<div style="height:100%; font-size:18px;" class="xfirefox">
        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:right;">
            <a href="../admin/hipodromo_programa_listas.php" class="btn alert-success" 
            	style="font-size:18px; width:200px; height:40px; padding:5px 0px 0px 0px; text-align:center; background: #FC0;
