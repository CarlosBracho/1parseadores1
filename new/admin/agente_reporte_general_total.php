...
$query_Recordset555 = sprintf("/* PARSEADORES1 new\admin\agente_reporte_general_total.php - QUERY 1 */ SELECT * FROM tasadecambio WHERE Idtasadecambio = 1");
...
$query_Recordset18 = sprintf("/* PARSEADORES1 new\admin\agente_reporte_general_total.php - QUERY 2 */ SELECT cod_banca, nom_agencia, cod_agencia FROM agencia ORDER BY agencia.nom_agencia");
...
$query_Recordset6 = sprintf("/* PARSEADORES1 new\admin\agente_reporte_general_total.php - QUERY 3 */ SELECT cod_banca, nom_agencia FROM agencia 
        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_usuario']!="todos") {
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 new\admin\agente_reporte_general_total.php - QUERY 4 */ SELECT
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && isset($_POST['id_usuario']) && $_POST['id_usuario']=="todos") || (!isset($_POST["MM_update"]))) {
    $query_Recordset3 = sprintf(
        "/* PARSEADORES1 new\admin\agente_reporte_general_total.php - QUERY 5 */ SELECT
...
$query_Recordset4 = sprintf("/* PARSEADORES1 new\admin\agente_reporte_general_total.php - QUERY 6 */ SELECT cod_taquilla, nom_taquilla FROM taquilla 
...
$query_Recordset5 = sprintf("/* PARSEADORES1 new\admin\agente_reporte_general_total.php - QUERY 7 */ SELECT info1,info11,info2,info22,info3,info33,info4,info44,info5,info55 FROM banca 
...
<?php
$query_Recordset44 = sprintf("/* PARSEADORES1 new\admin\agente_reporte_general_total.php - QUERY 8 */ SELECT 
	me.mensaje
        ...
        if ($totalRows_Recordset3>0) {
            do {
                ...
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\admin\agente_reporte_general_total.php - QUERY 9 */ SELECT
                ...
                $query_Recordset2 = sprintf(
                    "/* PARSEADORES1 new\admin\agente_reporte_general_total.php - QUERY 10 */ SELECT
...
USE INDEX(id_us_fe_fe)
                ...
                $query_Recordset50 = sprintf(
                    "/* PARSEADORES1 new\admin\agente_reporte_general_total.php - QUERY 11 */ SELECT 
...
GetSQLValueString($newDate.' 00:00:02', "date"), GetSQLValueString($newDate1.' 23:59:59', "date"),
                ...
                $query_Recordset7 =  sprintf(
                    "/* PARSEADORES1 new\admin\agente_reporte_general_total.php - QUERY 12 */ SELECT id_usuario
					FROM  
					cobro_hnac
					WHERE 
					cod_taquilla = %s AND
                ...
                $query_Recordset7 =  sprintf(
                    "/* PARSEADORES1 new\admin\agente_reporte_general_total.php - QUERY 13 */ SELECT id_usuario
					FROM  
					cobro_hnac
					WHERE 
					cod_taquilla = %s AND
