<?php
    ...
    $query_Recordset0 = sprintf("/* PARSEADORES1 new\admin\procesar_resultados_ticket.php - QUERY 1 */ SELECT cod_taquilla FROM taquilla");
    ...
    do {
        ...
        $query_Recordset1 = sprintf(
            "/* PARSEADORES1 new\admin\procesar_resultados_ticket.php - QUERY 2 */ SELECT 
        ...
        if ($totalRows_Recordset1>0) {
            do {
                ...
                $updateSQL = sprintf(
                    "/* PARSEADORES1 new\admin\procesar_resultados_ticket.php - QUERY 3 */ UPDATE venta 
