...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin\crear_mensaje_ataquillasdeldistribuidor.php - QUERY 1 */ INSERT 
        ...
        $insertGoTo = "admin_mensajesyalertas.php";
        if (isset($_SERVER['QUERY_STRING'])) {
...
$query_Recordset2 = "/* PARSEADORES1 new\admin\crear_mensaje_ataquillasdeldistribuidor.php - QUERY 2 */ SELECT cod_banca, nom_banca FROM banca ORDER BY nom_banca";
  ...
  <div class="header" style="height:100px; background:#333">
        ...
        <div style="background:#333; height:25px; color:#FFFFFF; padding:25px 15px 0px 0px; text-align:right;" id="datosUsuario">
        	<div style="background: #333;position:absolute;border-radius: 0px 0px 5px 5px; padding:15px; text-align:center;
                ...
                Crear Mensaje a Taquillas del Distribuidor<br/>
				<!-- InstanceEndEditable -->        
            </div>
              ...
              <table width="919" align="center">
                <tr valign="baseline">
                  <td height="44" colspan="5" align="center" valign="middle" nowrap bgcolor="#5EAEFF" 
                  	...
                  	Crear Mensaje a Taquillas del Distribuidor
                  </td>
                <tr valign="baseline">
                  <td width="1" align="left" valign="middle" nowrap>&nbsp;</td>
                  <td width="365" align="left" valign="middle" nowrap>Seleccione Distribuidor:<br>

                    <select name="cod_banca" style="width:327px; height: auto" class="textbox"  required="required">
              ...
              <td colspan="11" align="left" nowrap>&nbsp;</td>
                ...
                <tr valign="baseline">
                  ...
                  <td width="482" align="left" nowrap><br />
                  	<input type="submit" class="btn badge-warning" value="GUARDAR MENSAJE A TAQUILLAS DE DISTRIBUIDOR"  tabindex="50"
                  ...
                  <a href='admin_mensajesyalertas.php'
