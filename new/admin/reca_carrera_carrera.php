...
if (($codagencia>0 or $codagencia=="todos") && ($codcarrera>0 or $codcarrera=="todas") && $in!="" && $codHipodromo!=-1 && $codHipodromo!="") {
    ...
    if ($codcarrera!="todas") {
        $query_Recordset7 = sprintf(
            "/* PARSEADORES1 new\admin\reca_carrera_carrera.php - QUERY 1 */ SELECT 
        ...
        $query_Recordset7 = sprintf(
            "/* PARSEADORES1 new\admin\reca_carrera_carrera.php - QUERY 2 */ SELECT 
    ...
    if ($totalRows_Recordset7>0) {
        do {
            if ($totalRows_Recordset7==1) {
                ...
                $eje_cuarto=$row_Recordset7['eje_cuarto'];
                $div_cuarto_sho= $row_Recordset7['div_cuarto_sho'];
            ...
            for ($numCab = 1; $numCab <= $row_Recordset7['can_caballos']; $numCab++) {
                if ($codagencia!="todos") {
                    $query_Recordset8 = sprintf(
                        "/* PARSEADORES1 new\admin\reca_carrera_carrera.php - QUERY 3 */ SELECT 
                    ...
                    $query_Recordset8 = sprintf(
                        "/* PARSEADORES1 new\admin\reca_carrera_carrera.php - QUERY 4 */ SELECT 
						SUM(mon_venta) AS apuestas,
						SUM(CASE WHEN est_ticket = 2 
							THEN pag_premio ELSE 0 END) AS tpremios,
						SUM(CASE WHEN est_ticket >= 4 AND est_ticket <= 5
            ...
            if ($codagencia!="todos") {
                $query_Recordset9 = sprintf(
                    "/* PARSEADORES1 new\admin\reca_carrera_carrera.php - QUERY 5 */ SELECT 
					SUM(mon_venta) AS apuestas,
					SUM(CASE WHEN est_ticket = 2 
						THEN pag_premio ELSE 0 END) AS tpremios,
					SUM(CASE WHEN est_ticket >= 4 AND est_ticket <= 5
                ...
                $query_Recordset9 = sprintf(
                    "/* PARSEADORES1 new\admin\reca_carrera_carrera.php - QUERY 6 */ SELECT 
					SUM(mon_venta) AS apuestas,
...
<tr style="border-bottom:1px solid  #D5D5D5; font-size:12px;">
					...
					<td align="center" bgcolor="#E0E0E0"><?php echo $eje_cuarto; ?></td>
					<td align="right">&nbsp;</td>
					<td align="right" bgcolor="#E0E0E0">&nbsp;</td>
					<td align="right"><?php echo $div_cuarto_sho; ?></td>
					<td bgcolor="#E0E0E0">&nbsp;</td>
