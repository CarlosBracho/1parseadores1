        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_agente']!="todos") {
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\admin\reporte_ultimasjugadasx.php - QUERY 1 */ SELECT 
				...
				WHERE
				usuario.cod_taquilla = taquilla.cod_taquilla AND usuario.id_usuario = venta.id_usuario AND
				...
				ORDER BY venta.fec_venta, venta.hor_venta DESC LIMIT 0,100000",
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && isset($_POST['id_agente']) && $_POST['id_agente']=="todos") || (!isset($_POST["MM_update"]))) {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\admin\reporte_ultimasjugadasx.php - QUERY 2 */ SELECT 
					venta.ticket, venta.ip_venta, venta.fec_venta, venta.hor_venta, venta.mon_venta, venta.cod_usuario_pago, 
					venta.pag_premio, venta.est_ticket, venta.est_calculo, venta.can_ticket, venta.hor_pago,
					taquilla.nom_taquilla, usuario.nom_usuario, 
					venta.cod_tventa, venta.fec_pago, venta.ip_pago,
...
$query_Recordset2 = "/* PARSEADORES1 new\admin\reporte_ultimasjugadasx.php - QUERY 3 */ SELECT cod_agencia, nom_agencia FROM agencia WHERE cod_agencia > 0 ORDER BY agencia.nom_agencia";
   ...
   <div style="background: #FFF; width:100%; float:left; padding:25px 0px 0px 10px;
       ...
       <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" autocomplete="off"  
            ...
            <select name="id_agente" id="soflow" style="height:40px">
                  <option value="todos" >TOTAL DE JUGADAS <?php echo $totalRows_Recordset1;?></option>
                  <?php
            do {
                ?>
