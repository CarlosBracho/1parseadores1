        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_agente']!="todos") {
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\admin\admin_reporte_jugadas_hnac.php - QUERY 1 */ SELECT 
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && $_POST['id_agente']=="todos") ||
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\admin\admin_reporte_jugadas_hnac.php - QUERY 2 */ SELECT 
		venta_hnac.ip_venta_hnac,
		venta_hnac.ticket_hnac,
		venta_hnac.can_ticket_hnac,
		venta_hnac.fec_venta_hnac,
...
$query_Recordset2 = "/* PARSEADORES1 new\admin\admin_reporte_jugadas_hnac.php - QUERY 3 */ SELECT agencia.cod_agencia, agencia.nom_agencia FROM agencia ORDER BY agencia.nom_agencia";
