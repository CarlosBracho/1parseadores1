...
if ((isset($_GET['recordID'])) && ($_GET['recordID'] != "")) {
    $deleteSQL = sprintf(
        "/* PARSEADORES1 new\admin\usuario_ba_delete.php - QUERY 1 */ DELETE FROM ubanca WHERE cod_ubanca=%s",
 ...
 <br class="lineainicio">
  ...
  <tr>
    ...
    <table width="756" border="0" class="lista">
      <tr>
        <td width="26">&nbsp;</td>
        <td width="345" align="center" valign="bottom" class="barraaccionusuario"><p><strong><img src="../images//* PARSEADORES1 new\admin\usuario_ba_delete.php - QUERY 2 */ delete.png" alt="" width="24" height="24" />Eliminar Distribuidor</strong></p></td>
