...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin\agencias_edit.php - QUERY 1 */ UPDATE agencia 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\admin\agencias_edit.php - QUERY 2 */ SELECT
	agencia.nom_agencia,
	agencia.cod_banca,
    ...
    echo "SELECTED";
			  ...
			  <table width="919" align="center">
                ...
                <tr valign="baseline">
                  ...
                  size="32" title="indique un nombre de representante. 0-30 caracteres" onclick="ocultaDiv('Info2');"/>
