...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\admin\apertura_reabrir.php - QUERY 1 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", GetSQLValueString($xReabrirCarrera_Recordset1, "int"));
...
$updateSQL = sprintf(
    "/* PARSEADORES1 new\admin\apertura_reabrir.php - QUERY 2 */ UPDATE carrera SET hor_carrera=%s, hor_mtp=%s, est_carrera=%s WHERE cod_carrera=%s",
