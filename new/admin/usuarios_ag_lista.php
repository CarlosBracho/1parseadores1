...
$query_Recordset1 = '/* PARSEADORES1 new\admin\usuarios_ag_lista.php - QUERY 1 */ SELECT * 
	FROM 
	usuario, agencia 
	WHERE 
	usuario.tip_usuario = "G" AND
	usuario.cod_taquilla = agencia.cod_agencia
  	...
  	<div style="height:100%; font-size:18px;" class="xfirefox">
        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:right;">
            <a href="usuarios_ag_add.php" class="btn alert-success" 
                ...
                text-decoration:none;" title="crear nuevo usuario agente">
