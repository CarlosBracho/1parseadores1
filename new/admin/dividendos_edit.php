...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\admin\dividendos_edit.php - QUERY 1 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", GetSQLValueString($xCarrera_Recordset1, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $updateSQL = sprintf(
        "/* PARSEADORES1 new\admin\dividendos_edit.php - QUERY 2 */ UPDATE carrera SET 
  							est_confirmacion=%s, 
							est_carrera=%s, 
							eje_primero=%s, 
							div_primero_gan=%s, 
    ...
    $num_carrera=$_POST['cod_carrera'];

    $nom_usuario=$_SESSION['MM_nom_usuario'];
    $carrera=$nom_hipodro." Carr...".$num_carrera;
    $descripcion="Guardado de dividendos <strong>".$_POST['cod_carrera']."</strong> por: <u>".$nom_usuario."</u>";
    $horaactual=horaactual();
    $fechaactual=fechaactualbd();
    $insertSQL2 = sprintf(
        "/* PARSEADORES1 new\admin\dividendos_edit.php - QUERY 3 */ INSERT 
                        INTO bitacora 
    ...
    $updateGoTo = "historial_lista.php?fechaID=$fecha";
    if (isset($_SERVER['QUERY_STRING'])) {
