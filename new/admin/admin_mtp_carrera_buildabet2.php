...
var loadHora = function() {
    $.ajax({    
        type: "GET",
        url: "../includes/mtp_cierre_buildabet2.php",             
        dataType: "html",
		beforeSend: function() {
...
<div class="container">
    <div style="background: #693; height:25px; color:#FFFFFF; padding:25px 0px 0px 0px;text-align:center;font-size:34px;width:100%"
    	id="datosUsuario">
        BUILDABET2 (MTP)
	</div>
</div>
