...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\admin\bancas_info.php - QUERY 1 */ SELECT * FROM banca WHERE banca.cod_banca = %s", GetSQLValueString($varBanca_Recordset1, "int"));
