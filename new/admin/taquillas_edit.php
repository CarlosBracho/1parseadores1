...
$query_Recordset3 =  sprintf(
  "/* PARSEADORES1 new\admin\taquillas_edit.php - QUERY 1 */ SELECT * 
FROM 
usuario
WHERE id_usuario = %s",
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\admin\taquillas_edit.php - QUERY 2 */ SELECT
ta.taq_vende_ame,
ta.taq_por_ame,
ta.taq_vende_parley,
ta.taq_por_parley,
...
$tonvi=$row_Recordset1['nom_taquilla']; 

$query_Recordset94 =  sprintf(
  "/* PARSEADORES1 new\admin\taquillas_edit.php - QUERY 3 */ SELECT
  nom_banca
FROM  taquilla ta, 
      banca ba,
      agencia ag
...
$est_taquilla=$row_Recordset1['est_taquilla']/1;
    ...
    $agen_vende_parley=$row_Recordset1['agen_vende_parley']/1;
        ...
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 new\admin\taquillas_edit.php - QUERY 4 */ SELECT * FROM usuario 
	WHERE tip_usuario='U' 
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin\taquillas_edit.php - QUERY 5 */ UPDATE taquilla 
				SET nom_taquilla=%s, nom_representante=%s, tel_taquilla=%s, tel_taquilla2=%s, tel_taquilla3=%s, est_taquilla=%s,
				taq_vende_ame=%s,
taq_por_ame=%s,
taq_vende_parley=%s,
taq_por_parley=%s,
...
moneda=%s				
            ...
            GetSQLValueString($_POST['nom_taquilla'], "text"),
        ...
        if ($_POST['nom_taquilla'] == $row_Recordset1['nom_taquilla']){}else{
        $tnom=$_POST['nom_taquilla'];
  
  $msj='El Administrador ' .$Anom. ' cambio el nombre de la taquilla '.$tonvi. '  A: '.$tnom;
  ...
  curl_close ($ch);
        ...
        $query_Recordset22 =  sprintf(
            "/* PARSEADORES1 new\admin\taquillas_edit.php - QUERY 6 */ SELECT  
tp.apu_mingan
	...
	LIMIT 1",
        ...
        if ($apuestasminimaausar > $row_Recordset22['apu_mingan']) {
            $insertSQL11 = sprintf(
                "/* PARSEADORES1 new\admin\taquillas_edit.php - QUERY 7 */ UPDATE taquilla_opc_ame
					SET
					apu_mingan=%s
					WHERE cod_taquilla=%s",
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\admin\taquillas_edit.php - QUERY 8 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
...
<tr valign="baseline">
    ...
    echo "SELECTED";
                    ...
                    onKeyUp="return handleEnter(this, event)" tabindex="8" required max="100"/>
                  	%
										     <br/> <a href='../admin/taquillas_edit_ame.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'class="btn btn-info"> EDITAR MODULO <br/>HIPISMO INTERNACIONAL</a>
    ...
    echo "SELECTED";
                    ...
                    onKeyUp="return handleEnter(this, event)" tabindex="8" required max="100"/>
                  	%
										     <br/> <a href='../admin/taquillas_edit_parley.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'class="btn btn-info"> EDITAR MODULO <br/>PARLEY</a>
			  ...
			  <table width="919" align="center" border="0" cellpadding="0" cellspacing="0" style="line-height:13px">
                ...
                <tr valign="baseline">
                  ...
                  <td colspan="4" align="left" valign="middle" nowrap><br>
                    ...
                    Nombre de taquilla:
                  	<?php echo $row_Recordset1['nom_taquilla']." | Agente: ".$row_Recordset1['nom_agencia']." | Distribuidor: ".$row_Recordset94['nom_banca']?>
                    </div>
                    <br>
                  </td>
                  ...
                  <td colspan="2" align="left" valign="middle" nowrap>Nuevo nombre de taquilla:<br />
                    <input type="text" name="nom_taquilla" id="nom_taquilla" size="32" class="textbox"  
                    placeholder="usuario" pattern="[.-,-=+-%-$-(-)-A-Z a-z0-9]{4,20}" maxlength="20" style="height: auto"
                    value="<?php echo htmlentities($row_Recordset1['nom_taquilla'], ENT_COMPAT, 'utf-8'); ?>" 
        ...
        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:left;">
            <a href="usuarios_ve_desactivados.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>" class="btn alert-success" 
                ...
                text-decoration:none;" title="crear nuevo usuario vendedor">
                 Ver Lista de Vendedores Desactivados
            </a>
