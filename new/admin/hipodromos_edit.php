...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\admin\hipodromos_edit.php - QUERY 1 */ UPDATE hipodromo
				SET
				nom_hipodromo_hpi=%s,
                                mtp_WatchandWager=%s,
				nom_hipodromo_sup=%s,
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\admin\hipodromos_edit.php - QUERY 2 */ SELECT *
	FROM  
	hipodromo
	WHERE 
...
id="mtp_tvg">
  <option 
  value="1"
<?php if (!(strcmp(1, htmlentities($row_Recordset1['mtp_tvg'], ENT_COMPAT, 'utf-8')))) {
echo "SELECTED";
}?>>Si</option>
  <option 
  value="0"
<?php if (!(strcmp(0, htmlentities($row_Recordset1['mtp_tvg'], ENT_COMPAT, 'utf-8')))) {
echo "SELECTED";
} ?>>No</option>
</select>  
...
<tr valign="baseline">
        ...
        <tr valign="baseline">
            ...
            echo "SELECTED";
                    ...
                    <select name="mtp_twinspire" style="width:150px; height:35px" class="textbox" tabindex="7" 
                    id="mtp_twinspire">
                      <option 
                      value="1"
					  <?php if (!(strcmp(1, htmlentities($row_Recordset1['mtp_twinspire'], ENT_COMPAT, 'utf-8')))) {
            echo "SELECTED";
        }?>>Si</option>
                      <option 
                      value="0"
					  <?php if (!(strcmp(0, htmlentities($row_Recordset1['mtp_twinspire'], ENT_COMPAT, 'utf-8')))) {
            echo "SELECTED";
        } ?>>No</option>
                  </select>  
                  </td>
...
<option 
                      value="5"
					  <?php if (!(strcmp(5, htmlentities($row_Recordset1['bus_resultado_tip'], ENT_COMPAT, 'utf-8')))) {
            echo "SELECTED";
        } ?>>TRACK BUIL TWIN</option>
<option 
                      value="6"
					  <?php if (!(strcmp(6, htmlentities($row_Recordset1['bus_resultado_tip'], ENT_COMPAT, 'utf-8')))) {
            echo "SELECTED";
        } ?>>TRACK BUIL</option>
<option 
                      value="7"
					  <?php if (!(strcmp(7, htmlentities($row_Recordset1['bus_resultado_tip'], ENT_COMPAT, 'utf-8')))) {
            echo "SELECTED";
        } ?>>TRACK TWIN</option>
<option 
                      value="8"
					  <?php if (!(strcmp(8, htmlentities($row_Recordset1['bus_resultado_tip'], ENT_COMPAT, 'utf-8')))) {
            echo "SELECTED";
        } ?>>BUIL TWIN</option>
 ...
 <td colspan="2" align="right" nowrap>VALOR BUILDABET:<br />
                    ...
                    <select name="valorbuildabet" style="width:150px; height:35px" class="textbox" tabindex="7" 
                    id="valorbuildabet">
                      <option 
                      value="1"<?php if (!(strcmp(1, htmlentities($row_Recordset1['valorbuildabet'], ENT_COMPAT, 'utf-8')))) {
            echo "SELECTED";
        } ?> >x 1.</option>
                      <option 
                      value="2"<?php if (!(strcmp(2, htmlentities($row_Recordset1['valorbuildabet'], ENT_COMPAT, 'utf-8')))) {
            echo "SELECTED";
        } ?> >x 2.</option>
                  </select>  
                  </td>
...
<option
                      value="4"<?php if (!(strcmp(4, htmlentities($row_Recordset1['bus_retirado'], ENT_COMPAT, 'utf-8')))) {
                      echo "SELECTED";
                  } ?>>BUIL TWIN</option>
<option
                      value="5"<?php if (!(strcmp(5, htmlentities($row_Recordset1['bus_retirado'], ENT_COMPAT, 'utf-8')))) {
                      echo "SELECTED";
                  } ?>>BUIL TWIN AMER</option>
<option
                      value="6"<?php if (!(strcmp(6, htmlentities($row_Recordset1['bus_retirado'], ENT_COMPAT, 'utf-8')))) {
                      echo "SELECTED";
                  } ?>>TWIN AMER</option>
<option
                      value="7"<?php if (!(strcmp(7, htmlentities($row_Recordset1['bus_retirado'], ENT_COMPAT, 'utf-8')))) {
                      echo "SELECTED";
                  } ?>>BUIL, AMER</option>
