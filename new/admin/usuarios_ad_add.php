...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($_POST['pas_usuario']=="" || strlen($_POST['pas_usuario'])<=3) {
        $menPass="genere clave";
        $graba--;
    }
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin\usuarios_ad_add.php - QUERY 1 */ INSERT 
		INTO usuario 
        	...
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              <table width="919" align="center">
                ...
                <tr valign="baseline">
                  ...
                  <td width="365" align="left" valign="middle" nowrap>Nivel de acceso:<br>
              ...
              <table width="921" align="center">
                <tr valign="baseline">
                  ...
                  <td width="212">
                    ...
                    <input type="text" name="pas_usuario" id="pas_usuario" size="32" class="textbox" readonly="readonly" 
                  ...
                  <td width="272">
                    ...
                    pattern="[A-Z a-z0-9]{4,30}" title="indique un nombre completo. 4-30 caracteres"
