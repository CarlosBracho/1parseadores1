...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\admin\admin_apertura_listax.php - QUERY 1 */ SELECT * FROM carrera 
	WHERE  
...
$query_Recordset3 = sprintf("/* PARSEADORES1 new\admin\admin_apertura_listax.php - QUERY 2 */ SELECT * FROM ctrol_ventpag_global_ame WHERE cod_ctrol_ventpag_global_ame =1");
...
<div class="container">
  ...
  <tr style="background:#5EAEFF; color:#FFFFFF; height:30px; font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif;">
    ...
    <td width="35" style="font-size:8px" valign="bottom">CORREN</td>
