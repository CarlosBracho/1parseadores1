...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($_POST['tel_taquilla']=="" || strlen($_POST['tel_taquilla'])<=10) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\admin\bancas_addreparar.php - QUERY 1 */ INSERT 
				INTO banca 
				(nom_banca, nom_representante, tel_banca, dir_banca, por_banca, cob_banca_hnac, por_banca_lot, por_macu,
				fec_banca, est_banca) 
            ...
            GetSQLValueString($_POST['por_ame'], "double"),
            GetSQLValueString($_POST['cob_banca_hnac'], "double"),
            GetSQLValueString($_POST['por_lot'], "double"),
            GetSQLValueString($_POST['por_mac'], "double"),
            GetSQLValueString($fecInicio, "date"),
            GetSQLValueString(1, "int")
        );
        
        $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $query_RecT = "/* PARSEADORES1 new\admin\bancas_addreparar.php - QUERY 2 */ SELECT cod_banca FROM banca ORDER BY cod_banca DESC LIMIT 1";
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 new\admin\bancas_addreparar.php - QUERY 3 */ INSERT 
		INTO usuario 
        ...
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>" onsubmit="return chequearEnvio();">
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              ...
              <table width="919" align="center">
                ...
                <tr valign="baseline">
                  <td height="41" align="center" valign="bottom" nowrap bgcolor="#999999">Internacionales:</td>
                  <td align="center" valign="bottom" nowrap>Costo x pto <br/>Nacionales:</td>
                  <td align="center" valign="bottom" nowrap bgcolor="#999999">Macuare:</td>
                  <td align="center" valign="bottom" nowrap>Loterias:</td>
                  <td align="center" valign="bottom" nowrap>&nbsp;</td>
                </tr>  
                <tr valign="baseline">
                  <td width="120" height="88" align="center" valign="top" nowrap bgcolor="#999999">
                  	<input type="text" name="por_ame" class="textbox" style="height:auto; width:50px" 
                  ...
                  <td width="120" align="center" valign="top" nowrap>
                  	<input type="text" name="cob_banca_hnac" class="textbox" style="height:auto; width:100px" 
                    onclick="ocultaDiv('Info7');"
                    value="0.00" 
                    size="10" onkeypress="ValidaSoloNumeros()" title="indique pocentaje"
                    onKeyUp="return handleEnter(this, event)" tabindex="8" required max="100"/>
                  </td>
                  <td width="120" align="center" valign="top" nowrap bgcolor="#999999">
                  	<input type="text" name="por_mac" class="textbox" style="height:auto; width:50px" 
                    onclick="ocultaDiv('Info7');"
                    value="0.00" 
                    size="10" onkeypress="ValidaSoloNumeros()" title="indique pocentaje"
                    onKeyUp="return handleEnter(this, event)" tabindex="8" required max="100"/>
              ...
              <table width="921" align="center">
                ...
                <tr valign="baseline">
                  ...
                  <td width="272" valign="top">
                    ...
                    pattern="[A-Z a-z0-9]{4,20}" title="indique nombre completo. 4-20 caracteres"
                    onKeyUp="return handleEnter(this, event)" onclick="ocultaDiv('Info35');" tabindex="34" required
                    value="" 
                    size="32" />
                    <div id="Info35" style="float: left; padding:-10px 0px 0px 0px; font-size:12px; color:#F00">
