...
<div class="container">
  ...
  <div class="contentAdmin">
    ...
    "/* PARSEADORES1 new\admin\taquillasparalelas.php - QUERY 1 */ SELECT 
ve.cod_taquilla, ve.ip_venta, ve.pais, ta.nom_taquilla, ag.nom_agencia, ba.nom_banca
 FROM venta ve, taquilla ta, agencia ag, banca ba
WHERE ve.can_ticket = 1 AND lin_ticket = 1  
AND fec_venta = %s 
AND ta.cod_taquilla = ve.cod_taquilla 
AND ta.cod_agencia = ag.cod_agencia 
AND ag.cod_banca = ba.cod_banca 
ORDER BY ve.ip_venta LIMIT 9999",
...
?>
  ...
  <tr style="background: #333; color:#FFF;  height:30px">
    ...
    <td width="70">NOMBRE DE TAQUILLA</td>
        <td width="100">NOMBRE DE AGENCIA</td>
    <td width="100">NOMBRE DE DISTRIBUIDOR</td>
  </tr>
  <?php do { ?>
  <tr bgcolor="#FFFFFF" style="background: #333; color:#FFF; font-size:14px">
      <td align="left"><?php echo $row_Recordset1['pais']; ?></td>
