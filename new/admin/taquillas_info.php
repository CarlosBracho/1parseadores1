...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\admin\taquillas_info.php - QUERY 1 */ SELECT * FROM taquilla WHERE taquilla.cod_taquilla = %s", GetSQLValueString($xTaquilla_Recordset1, "int"));
