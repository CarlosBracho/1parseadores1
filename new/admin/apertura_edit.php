...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\admin\apertura_edit.php - QUERY 1 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", GetSQLValueString($xCarrera_Recordset1, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $updateSQL = sprintf(
        "/* PARSEADORES1 new\admin\apertura_edit.php - QUERY 2 */ UPDATE carrera SET 
