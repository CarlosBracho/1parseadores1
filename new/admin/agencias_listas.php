...
$query_Recordset1 = "/* PARSEADORES1 new\admin\agencias_listas.php - QUERY 1 */ SELECT * FROM agencia, banca WHERE banca.cod_banca = agencia.cod_banca ORDER BY agencia.nom_agencia, banca.cod_banca";
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
  	<div style="height:100%; font-size:18px;" class="xfirefox">
        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:right;">
            <a href="agencias_add.php" class="btn alert-success" 
                ...
                text-decoration:none;" title="crear nuevo agente">
                  Añadir Nuevo Agente
            </a>
        </div>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr style="background:#5EAEFF; color:#FFFFFF; height:30px">
          <td width="31%">AGENTE</td>
          <td width="51%">NÚMEROS DE CONTACTO</td>
        ...
        <?php do { ?>
          <tr class="brillo" style="border-bottom:1px solid  #D5D5D5">
            <td align="left"><?php
            echo $row_Recordset1['nom_agencia']."<br/><FONT FACE='times new roman' SIZE=2>".$row_Recordset1['nom_banca']."</FONT>"; ?>
            </td>
            <td align="left"><?php
            $telagencia=$row_Recordset1['tel_agencia'];
            if ($row_Recordset1['tel_agencia2']!="") {
                $telagencia.=" / ".$row_Recordset1['tel_agencia2'];
            }
            if ($row_Recordset1['tel_agencia3']!="") {
                $telagencia.=" / ".$row_Recordset1['tel_agencia3'];
            }
            echo $telagencia; ?>
            </td>
