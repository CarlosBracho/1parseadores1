...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\admin\admin_apertura_lista2.php - QUERY 1 */ SELECT * FROM carrera 
	WHERE 
	...
	ORDER BY carrera.hor_carrera ASC",
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
  	<div style="height:100%; font-size:18px;" class="xfirefox">
        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:right;">
            <a href="admin_apertura_add_auto.php" class="btn alert-success" 
            ...
            <i class="fa fa-circle-o-notch" style="color:#000"></i>
            </a>
...
div>
  ...
  <tr bgcolor="#FFFFFF" onmouseover="cambiacolor_over(this)" onmouseout="cambiacolor_out(this)"; style="font-size:14px">
    ...
    <td width="92" align="center" valign="bottom" style="color:#090">
		<select name="mtp_control"  style="width:122px; height:30px; font-size:13px;" tabindex="4" 
        	onchange="cStatus(this.value, <?php echo $row_Recordset1['cod_carrera'] ?>)"> 
    ...
    <td width="25" align="center">
    	<a title="cancelar carrera" onclick='if(confirm("¿Seguro quiere cancelar la carrera?"))href="admin_apertura_cancelar.php?recordID=<?php echo $row_Recordset1['cod_carrera']; ?>";' href='#'>
        <i class="fa fa-times-circle fa-2x"></i>
        </a>
    </td>
    <td width="25" align="center"><a title="editar carrera" href="admin_apertura_edit.php?recordID=<?php echo $row_Recordset1['cod_carrera']; ?>"><i class="fa fa-pencil fa-2x"></i></td>
    <td width="25" align="center">
    <?php if ($row_Recordset1['est_carrera']!=0) {?>
    	<a title="cerrar carrera" href="admin_apertura_cierre.php?recordID=<?php echo $row_Recordset1['cod_carrera']; ?>">
        <i class="fa fa-flag fa-2x"></i>
        </a>
    <?php } ?>    
    </td>
    <td width="24" align="center"><a  title="reabrir 2 minutos" href="admin_apertura_reabrir.php?recordID=<?php echo $row_Recordset1['cod_carrera']; ?>"> <i class="fa fa-2x"><strong>2</strong></i></a></td>
    <td width="26" align="center"><a title="reabrir 1 minuto" href="admin_apertura_reabrir2.php?recordID=<?php echo $row_Recordset1['cod_carrera']; ?>"><i class="fa fa-2x"><strong>1</strong></i></a></td>
  </tr>
  <?php
