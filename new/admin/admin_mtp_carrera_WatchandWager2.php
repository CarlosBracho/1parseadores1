...
var loadHora = function() {
    $.ajax({    
        type: "GET",
        url: "../includes/admin_mtp_watchandwager_hora2.php",             
        dataType: "html",
		beforeSend: function() {
...
var loadCierre = function() {
    $.ajax({    
        type: "GET",
        url: "../includes/admin_mtp_watchandwager_cierre2.php",             
        dataType: "html",
		beforeSend: function() {
...
<div class="container" style="width: 100%">
    <div style="background:#20c8a8; height:25px; color:#FFFFFF; padding:25px 0px 0px 0px;text-align:center; font-size:34px; width:100%"
    	id="datosUsuario">
        WATCHANDWAGER (MTP)
	</div>
</div>
