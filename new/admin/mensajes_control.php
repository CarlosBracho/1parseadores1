...
/* PARSEADORES1 new\admin\mensajes_control.php - QUERY 1 */ SELECT usuario.nom_usuario, usuario.tip_usuario, taquilla.nom_taquilla, taquilla.cod_taquilla 
FROM 
usuario,
taquilla
WHERE
usuario.cod_taquilla=taquilla.cod_taquilla AND
usuario.tip_usuario='U' AND taquilla.est_taquilla = 1 ORDER BY usuario.nom_usuario");
...
$(document).ready(function() {
	$("#enviarMen").click(function(){
		var url = "../includes/mensajes_chat_enviar.php"; // El script en dónde se realizará la petición.
	...
	var refreshId1 = null;	
		function startChat() {
			refreshId1 = setInterval(function() {
				...
				$.ajax({ data:parametros, url:'../includes/mensajes_chat.php', type:'post',
	...
	<script>
		...
		$(document).ready(function() {
			$('.botonChat').click(function() {
				...
				$.ajax({ data:parametros, url:'../includes/mensajes_chat_mostrar.php', type:'post',
					success:function (response) { 
...
$(function(){
	$("#buttonverde").click(function(){
		if (document.getElementById('pagarT').value!="") {
			var url = '../includes/ticketchat.php';
...
<div class="container1" style="background: #333;">
	<div style="height:700px; width:100%; padding:0px 0px 0px 0px; text-align:left;">
		...
		<div style="height:100%; width:20%; padding:5px 0px 10px 0px; text-align:left; background:#F90; float:left; 
		...
		<div style="height:100%; width:80%; padding:5px 0px 10px 0px; text-align:left; background:#0099CC; float:left;
   			color:#FFF; font-size:16px;text-align: center;">
    			CHAT
				<div style="height:94%; width:99%; margin:15px 1px 2px 2px; text-align:left; background: #FFF; 
                    ...
                    onmouseout="startChat()" >
      				<?php
                    include("../includes/mensajes_chat.php");?>
      			</div>
		</div>
...
<div style="background: #FFF; width:100%; float:left; padding:25px 0px 15px 0px; font-size:18px">
  		<form method="post" id="form2">
            ...
            <div style="float:left; padding:0px 0px 0px 10px;">
				...
				<div style="text-align:center; color: #000" id="info1">
    					</div>
