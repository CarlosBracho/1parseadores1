...
var programa = function() {
    $.ajax({    
        type: "GET",
        url: "../includes/programar_carreras_auto_buildtvg2.php",             
        dataType: "html",                   
...
function crearCarrera(hipodromo, cantidad, idCarr, xDiv, x) {
	...
	$.ajax({ data:parametros2, url:'../includes/programar_carreras_guardar_buildtvg.php', type:'GET',
  ...
  <div class="header" style="height:100px; background:#333">
        ...
        <div style="background:#333; height:25px; color:#FFFFFF; padding:25px 15px 0px 0px; text-align:right;" id="datosUsuario">
        	<div style="background: #333;position:absolute;border-radius: 0px 0px 5px 5px; padding:15px; text-align:center;
               ...
               Apertura Automática <br/>BUILDABET2/TVG
				<!-- InstanceEndEditable -->        
            </div>
	...
	<div style="height:100%; font-size:18px; padding:0px 0px 0px 0px ">
      <div style="padding:50px 0px 140px 0px;text-align:left;font-size:18px;height:auto" id="divprograma" class="divprograma">
            <div style="color: #000; width:100%; text-align:center; padding:100px 0px 50px 0px; font-size:24px">
                ...
                Cargando información de carreras desde BUILDABET2 y TVG<br/><br/>Por favor espere un momento...
            </div>
      </div>
	</div> 
  <!-- InstanceEndEditable -->
