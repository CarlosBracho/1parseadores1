...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\admin\crear_mensaje_aundistribuidor.php - QUERY 1 */ INSERT 
...
$query_Recordset2 = "/* PARSEADORES1 new\admin\crear_mensaje_aundistribuidor.php - QUERY 2 */ SELECT cod_banca, nom_banca FROM banca ORDER BY nom_banca";
