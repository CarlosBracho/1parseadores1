    ...
    if (isset($_POST['fecha_inicio']) && $_POST['fecha_inicio']!="") {
        ...
        if ($_POST['id_agente']!="todos" && $_POST['id_hipod']=="todos" && $_POST['id_carrera']=="todas") {
            $query_Recordset1 = sprintf(
                "/* PARSEADORES1 new\admin\jugadas_cambio.php - QUERY 1 */ SELECT venta.ser_venta, venta.est_calculo,
        ...
        if ($_POST['id_agente']!="todos" && $_POST['id_hipod']!="todos" && $_POST['id_carrera']=="todas") {
            $query_Recordset1 = sprintf(
                "/* PARSEADORES1 new\admin\jugadas_cambio.php - QUERY 2 */ SELECT venta.ser_venta, venta.est_calculo,
					venta.ticket, venta.ip_venta, venta.fec_venta, venta.hor_venta, venta.mon_venta, venta.cod_usuario_pago, 
					venta.pag_premio,venta.est_ticket, venta.can_ticket, taquilla_opc_ame.anu_regalia, venta.hor_pago, 
					taquilla.nom_taquilla, usuario.nom_usuario, carrera.eje_primero, carrera.eje_doble_primero,
					venta.est_ticket, carrera.est_confirmacion, venta.cod_tventa, venta.fec_pago, venta.ip_pago,
        ...
        if ($_POST['id_agente']!="todos" && $_POST['id_hipod']!="todos" && $_POST['id_carrera']!="todas") {
            $query_Recordset1 = sprintf(
                "/* PARSEADORES1 new\admin\jugadas_cambio.php - QUERY 3 */ SELECT venta.ser_venta, venta.est_calculo,
					venta.ticket, venta.ip_venta, venta.fec_venta, venta.hor_venta, venta.mon_venta, venta.cod_usuario_pago, 
					venta.pag_premio,venta.est_ticket, venta.can_ticket, taquilla_opc_ame.anu_regalia, venta.hor_pago, 
					taquilla.nom_taquilla, usuario.nom_usuario, carrera.eje_primero, carrera.eje_doble_primero,
					venta.est_ticket, carrera.est_confirmacion, venta.cod_tventa, venta.fec_pago, venta.ip_pago,
        ...
        if ($_POST['id_agente']=="todos" && $_POST['id_hipod']!="todos" && $_POST['id_carrera']=="todas") {
            $query_Recordset1 = sprintf(
                "/* PARSEADORES1 new\admin\jugadas_cambio.php - QUERY 4 */ SELECT venta.ser_venta, venta.est_calculo,
					venta.ticket, venta.ip_venta, venta.fec_venta, venta.hor_venta, venta.mon_venta, venta.cod_usuario_pago, 
					venta.pag_premio,venta.est_ticket, venta.can_ticket, taquilla_opc_ame.anu_regalia, venta.hor_pago, 
					taquilla.nom_taquilla, usuario.nom_usuario, carrera.eje_primero, carrera.eje_doble_primero,
					venta.est_ticket, carrera.est_confirmacion, venta.cod_tventa, venta.fec_pago, venta.ip_pago,
        ...
        if ($_POST['id_agente']=="todos" && $_POST['id_hipod']!="todos" && $_POST['id_carrera']!="todas") {
            $query_Recordset1 = sprintf(
                "/* PARSEADORES1 new\admin\jugadas_cambio.php - QUERY 5 */ SELECT venta.ser_venta, venta.est_calculo,
					venta.ticket, venta.ip_venta, venta.fec_venta, venta.hor_venta, venta.mon_venta, venta.cod_usuario_pago, 
					venta.pag_premio,venta.est_ticket, venta.can_ticket, taquilla_opc_ame.anu_regalia, venta.hor_pago, 
					taquilla.nom_taquilla, usuario.nom_usuario, carrera.eje_primero, carrera.eje_doble_primero,
					venta.est_ticket, carrera.est_confirmacion, venta.cod_tventa, venta.fec_pago, venta.ip_pago,
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && $_POST['id_agente']=="todos" && $_POST['id_hipod']=="todos" && $_POST['id_carrera']=="todas") ||
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\admin\jugadas_cambio.php - QUERY 6 */ SELECT venta.ser_venta, venta.est_calculo,
				venta.ticket, venta.ip_venta, venta.fec_venta, venta.hor_venta, venta.mon_venta, venta.cod_usuario_pago, 
				venta.pag_premio,venta.est_ticket, venta.can_ticket, taquilla_opc_ame.anu_regalia, venta.hor_pago, 
				taquilla.nom_taquilla, usuario.nom_usuario, carrera.eje_primero, carrera.eje_doble_primero,
				venta.est_ticket, carrera.est_confirmacion, venta.cod_tventa, venta.fec_pago, venta.ip_pago,
...
$query_Recordset2 = "/* PARSEADORES1 new\admin\jugadas_cambio.php - QUERY 7 */ SELECT agencia.cod_agencia, agencia.nom_agencia FROM agencia ORDER BY agencia.nom_agencia";
$Recordset2 = mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
$row_Recordset2 = mysqli_fetch_assoc($Recordset2);
$totalRows_Recordset2 = mysqli_num_rows($Recordset2);

$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\admin\jugadas_cambio.php - QUERY 8 */ SELECT 
