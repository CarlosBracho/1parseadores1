...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $menE="";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\distri_lot\distri_usuario_ven_edit_lot.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
				est_usuario=%s, 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\distri_lot\distri_usuario_ven_edit_lot.php - QUERY 2 */ SELECT 
                        ...
                        <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                            <tr height="100" valign="middle">
                                ...
                                <td width="46%" align="eft">
                                    <a href='distri_usuarios_ven_lista_lot.php' class="btn  btn-danger" 
