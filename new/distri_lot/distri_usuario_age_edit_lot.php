...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $menE="";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\distri_lot\distri_usuario_age_edit_lot.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
				est_usuario=%s 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\distri_lot\distri_usuario_age_edit_lot.php - QUERY 2 */ SELECT 
	us.id_usuario, us.nom_usuario, us.nom_completo, us.tip_usuario, us.cod_taquilla, us.pas_usuario, us.est_usuario, 
	ag.nom_agencia
	FROM 
	usuario us, agencia ag
	WHERE 
	us.id_usuario = %s AND ag.cod_agencia = us.cod_taquilla AND us.tip_usuario = 'G' AND ag.cod_banca = %s 
	LIMIT 1",
                        ...
                        <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                            <tr height="100" valign="middle">
                                ...
                                <td width="46%" align="eft">
                                    <a href='distri_usuarios_age_lista_lot.php' class="btn  btn-danger" 
