...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\distri_lot\distri_usuarios_ven_lista_lot.php - QUERY 1 */ SELECT 
	...
	WHERE us.cod_taquilla = ta.cod_taquilla AND us.tip_usuario = 'U' AND ta.cod_agencia = ag.cod_agencia AND ag.cod_banca = %s
	ORDER BY 
  ...
  <?php do { ?>
		<tr class="brillo" style="border-bottom:1px solid #D5D5D5" valign="bottom">
			...
			<td align="center" valign="middle"><?php
                $url='distri_usuario_ven_edit_lot.php?recordID='.$row_Recordset1['id_usuario'];?>
