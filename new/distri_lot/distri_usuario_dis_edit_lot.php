...
$MM_authorizedUsers = "D"; include("../includes/comprobar_acceso.php");
$xCodigo = "-1";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $menE="";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\distri_lot\distri_usuario_dis_edit_lot.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
				WHERE id_usuario=%s",
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\distri_lot\distri_usuario_dis_edit_lot.php - QUERY 2 */ SELECT 
	us.id_usuario, us.nom_usuario, us.nom_completo, us.tip_usuario, us.cod_taquilla, us.pas_usuario, us.est_usuario, 
	ba.nom_banca
	FROM 
	usuario us, banca ba
	WHERE 
	us.id_usuario = %s AND ba.cod_banca = us.cod_taquilla AND us.tip_usuario = 'D' AND ba.cod_banca = %s
	LIMIT 1",
                        ...
                        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="font-size:10px;border-bottom:1px solid  #D5D5D5;" height="45" align="center">
                                    <?php echo '<font size="1">DISTRIBUIDOR '.$row_Recordset1['nom_banca'].'</font><br/>'; ?>
