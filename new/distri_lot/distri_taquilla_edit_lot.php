...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\distri_lot\distri_taquilla_edit_lot.php - QUERY 1 */ UPDATE taquilla 
        ...
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\distri_lot\distri_taquilla_edit_lot.php - QUERY 2 */ UPDATE taquilla_opc_lot 
...
if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
    $query_Recordset7 =  sprintf(
        "/* PARSEADORES1 new\distri_lot\distri_taquilla_edit_lot.php - QUERY 3 */ SELECT ta.cod_agencia FROM taquilla ta WHERE ta.cod_taquilla = %s LIMIT 1",
        GetSQLValueString($_POST['cod_taquilla'], "int")
    );
    ...
    $query_Recordset6 =  sprintf(
        "/* PARSEADORES1 new\distri_lot\distri_taquilla_edit_lot.php - QUERY 4 */ SELECT 
    ...
    $query_Recordset8 =  sprintf(
        "/* PARSEADORES1 new\distri_lot\distri_taquilla_edit_lot.php - QUERY 5 */ SELECT cod_taquilla FROM taquilla_opc_lot WHERE cod_taquilla = %s LIMIT 1",
        GetSQLValueString($_POST['cod_taquilla'], "int")
    );
    ...
    if ($totalRows_Recordset6>0&&$totalRows_Recordset7>0&&$totalRows_Recordset8==0) {
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 new\distri_lot\distri_taquilla_edit_lot.php - QUERY 6 */ INSERT 
        ...
        do {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 new\distri_lot\distri_taquilla_edit_lot.php - QUERY 7 */ INSERT 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\distri_lot\distri_taquilla_edit_lot.php - QUERY 8 */ SELECT 
...
if ((isset($_POST["MM_insert3"])) && ($_POST["MM_insert3"] == "form3")) {
    $query_Recordset4 =  sprintf("/* PARSEADORES1 new\distri_lot\distri_taquilla_edit_lot.php - QUERY 9 */ SELECT 
    ...
    $query_Recordset4 =  sprintf("/* PARSEADORES1 new\distri_lot\distri_taquilla_edit_lot.php - QUERY 10 */ SELECT 
		tp.tic_caduca_lot, tp.mon_minticket_lot, tp.pag_codigo_lot, tp.tip_ticket_lot, tp.por_taquilla_lot,
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\distri_lot\distri_taquilla_edit_lot.php - QUERY 11 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
