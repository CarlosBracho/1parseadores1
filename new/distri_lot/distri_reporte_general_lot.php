...
$query_Recordset12 = sprintf(
    "/* PARSEADORES1 new\distri_lot\distri_reporte_general_lot.php - QUERY 1 */ SELECT por_banca_lot FROM banca WHERE cod_banca = %s LIMIT 1",
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\distri_lot\distri_reporte_general_lot.php - QUERY 2 */ SELECT * 
	FROM 
    ...
    if (isset($_POST['fecha_inicio']) && isset($_POST['fecha_fin'])) {
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_agencia']!="todos") {
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 new\distri_lot\distri_reporte_general_lot.php - QUERY 3 */ SELECT * 
					FROM 
						agencia ag 
					WHERE 
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 new\distri_lot\distri_reporte_general_lot.php - QUERY 4 */ SELECT * 
	FROM 
		agencia ag, agencialoterias al
	WHERE
		ag.cod_banca = %s AND al.id_agencia = ag.cod_agencia
               ...
               do {
                   ...
                   echo "| Correo: ".$row_Recordset3['cor_agencia']; ?>
                    ...
                    $query_Recordset1 = sprintf(
                       "/* PARSEADORES1 new\distri_lot\distri_reporte_general_lot.php - QUERY 5 */ SELECT
