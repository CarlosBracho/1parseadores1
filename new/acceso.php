...
<br/><input align="center" type="button" onclick="window.location='parley/1taparley.php';"
      style="height:65px; width:340px; font-size:20px; margin:0px 15px 0px 0px" 
      value="Ventas Parley" />
</td></tr>
<?php } ?>
...
<html lang="en">
  ...
  <?php if ($dist_vende_amex==1 && $agen_vende_amex==1 && $taq_vende_amex==1) { ?>
  <center>
  <a href='ventas/index.php'> <img src="img/Gulfstream-Park.jpg" class="img-fluid" alt="Responsive image"> </a>
  </center>
  <button type="button" onclick="window.location='ventas/index.php';" class="btn btn-primary btn-lg btn-block">Ventas Hipismo Internacional</button>
  
  
  <?php } ?>
  <?php if ($dist_vende_hnacx==1 && $agen_vende_hnacx==1 && $taq_vende_hnacx==1) { ?>
  <center> 
  <a href='ventashnac_mie/index.php'> <img src="img/hipismonacional.jpg" class="img-fluid" alt="Responsive image"> </a>
  </center>

  <button type="button" onclick="window.location=ventashnac_mie/index.php" class="btn btn-success btn-lg btn-block">Ventas Hipismo Venezuela</button>
  
  <?php } ?>
  <?php if ($dist_vende_parley==1 && $agen_vende_parley==1 && $taq_vende_parley==1) { ?>

  <center>
  <a href='parley/1taparley.php'> <img src="img/deportes.jpg" class="img-fluid" alt="Responsive image"> </a>
  </center>
  <button type="button" onclick="window.location='parley/1taparley.php';" class="btn btn-warning btn-lg btn-block">Ventas Parley</button>
