...
if ($usuario == -1) {
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 new\negocio\venta\ventaslistagocho.php - QUERY 1 */ SELECT 
...
ASC",
    ...
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 new\negocio\venta\ventaslistagocho.php - QUERY 2 */ SELECT 
inventarioydemas.id_documentoinventarioydemas,
inventarioydemas.cantidad, 
inventarioydemas.valor, 
inventarioydemas.hora,
...
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 new\negocio\venta\ventaslistagocho.php - QUERY 3 */ SELECT 
inventarioydemas.id_documentoinventarioydemas,
inventarioydemas.cantidad, 
inventarioydemas.valor, 
inventarioydemas.hora,
...
$query_Recordset11 = sprintf(
    "/* PARSEADORES1 new\negocio\venta\ventaslistagocho.php - QUERY 4 */ SELECT * FROM pagospendientes,
