...
$x=0;
    ...
    $query_Recordset2 = sprintf('/* PARSEADORES1 new\negocio\productos\registrar_producto.php - QUERY 1 */ SELECT 
...
$ultimaventa=$row_Recordset2['id_documentoinventarioydemas']+1;
    ...
    $query_Recordset3 = sprintf('/* PARSEADORES1 new\negocio\productos\registrar_producto.php - QUERY 2 */ SELECT 
...
if ($totalRows_Recordset3>0) {
    ...
    $query_Recordset4 = sprintf('/* PARSEADORES1 new\negocio\productos\registrar_producto.php - QUERY 3 */ SELECT 
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1") {
    ...
    if ($_POST['categoria_producto']>0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\productos\registrar_producto.php - QUERY 4 */ INSERT INTO producto (id_categoriaenproductoensede, productoensede
					 ) 
					 VALUES (%s, %s)",
