...
//echo $nuevahora1;
    ...
    $query_Recordset1 = sprintf('/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 1 */ SELECT 
...
if ($totalRows_Recordset1>0) {
    ...
    $query_Recordset2 = sprintf('/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 2 */ SELECT 
...
$ultimotraslado=$row_Recordset2['id_documentoinventarioydemas']+1;
    ...
    $query_Recordset3 = sprintf('/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 3 */ SELECT 
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1") {
    if ($_POST['id_prox']>0 &&  $_POST['cantidad']>=0 && $_POST['local']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 4 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
 ...
 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 5 */ UPDATE producto 
        ...
        $query_Recordset111 = sprintf(
            '/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 6 */ SELECT 
        ...
        if ($row_Recordset111['id_productoinventarionegocios']==$_POST['id_prox'] && $row_Recordset111['id_negocioinventarionegocios']==$_POST['local']) {
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 7 */ UPDATE inventarionegocios 
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 8 */ INSERT INTO inventarionegocios (id_negocioinventarionegocios, id_productoinventarionegocios, cantidadinventarionegocios
					 ) 
					 VALUES (%s, %s, %s)",
                GetSQLValueString($_POST['local'], "int"),
                GetSQLValueString($_POST['id_prox'], "int"),
    ...
    if ($_POST['id_prox1']>0 &&  $_POST['cantidad1']>=0 && $_POST['local']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 9 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora
					 ) 
 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimotraslado, "int"),
        ...
        $Result = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 10 */ UPDATE producto 
										   SET cantidadensede=cantidadensede-%s
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad1'], "int"),
            GetSQLValueString($_POST['id_prox1'], "int")
        ...
        $query_Recordset111 = sprintf(
            '/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 11 */ SELECT 
		inventarionegocios.Id_inventarionegocios, inventarionegocios.id_productoinventarionegocios, inventarionegocios.id_negocioinventarionegocios
        ...
        if ($row_Recordset111['id_productoinventarionegocios']==$_POST['id_prox1'] && $row_Recordset111['id_negocioinventarionegocios']==$_POST['local']) {
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 12 */ UPDATE inventarionegocios 
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_negocioinventarionegocios = %s AND  id_productoinventarionegocios = %s",
                GetSQLValueString($_POST['cantidad1'], "int"),
                GetSQLValueString($_POST['local'], "int"),
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 13 */ INSERT INTO inventarionegocios (id_negocioinventarionegocios, id_productoinventarionegocios, cantidadinventarionegocios
					 ) 
					 VALUES (%s, %s, %s)",
                GetSQLValueString($_POST['local'], "int"),
                GetSQLValueString($_POST['id_prox1'], "int"),
    ...
    if ($_POST['id_prox2']>0 &&  $_POST['cantidad2']>=0 && $_POST['local']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 14 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora
					 ) 
 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimotraslado, "int"),
        ...
        $Result = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 15 */ UPDATE producto 
										   SET cantidadensede=cantidadensede-%s
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad2'], "int"),
            GetSQLValueString($_POST['id_prox2'], "int")
        ...
        $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset111 = sprintf(
            '/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 16 */ SELECT 
		inventarionegocios.Id_inventarionegocios, inventarionegocios.id_productoinventarionegocios, inventarionegocios.id_negocioinventarionegocios
        ...
        if ($row_Recordset111['id_productoinventarionegocios']==$_POST['id_prox2'] && $row_Recordset111['id_negocioinventarionegocios']==$_POST['local']) {
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 17 */ UPDATE inventarionegocios 
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_negocioinventarionegocios = %s AND  id_productoinventarionegocios = %s",
                GetSQLValueString($_POST['cantidad2'], "int"),
                GetSQLValueString($_POST['local'], "int"),
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 18 */ INSERT INTO inventarionegocios (id_negocioinventarionegocios, id_productoinventarionegocios, cantidadinventarionegocios
					 ) 
					 VALUES (%s, %s, %s)",
                GetSQLValueString($_POST['local'], "int"),
                GetSQLValueString($_POST['id_prox2'], "int"),
    ...
    if ($_POST['id_prox3']>0 &&  $_POST['cantidad3']>=0 && $_POST['local']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 19 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora
					 ) 
 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimotraslado, "int"),
        ...
        $Result = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 20 */ UPDATE producto 
										   SET cantidadensede=cantidadensede-%s
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad3'], "int"),
            GetSQLValueString($_POST['id_prox3'], "int")
        ...
        $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset111 = sprintf(
            '/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 21 */ SELECT 
		inventarionegocios.Id_inventarionegocios, inventarionegocios.id_productoinventarionegocios, inventarionegocios.id_negocioinventarionegocios
        ...
        if ($row_Recordset111['id_productoinventarionegocios']==$_POST['id_prox3'] && $row_Recordset111['id_negocioinventarionegocios']==$_POST['local']) {
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 22 */ UPDATE inventarionegocios 
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_negocioinventarionegocios = %s AND  id_productoinventarionegocios = %s",
                GetSQLValueString($_POST['cantidad3'], "int"),
                GetSQLValueString($_POST['local'], "int"),
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 23 */ INSERT INTO inventarionegocios (id_negocioinventarionegocios, id_productoinventarionegocios, cantidadinventarionegocios
					 ) 
					 VALUES (%s, %s, %s)",
                GetSQLValueString($_POST['local'], "int"),
                GetSQLValueString($_POST['id_prox3'], "int"),
    ...
    if ($_POST['id_prox4']>0 &&  $_POST['cantidad4']>=0 && $_POST['local']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 24 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora
					 ) 
 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimotraslado, "int"),
        ...
        $Result = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 25 */ UPDATE producto 
										   SET cantidadensede=cantidadensede-%s
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad4'], "int"),
            GetSQLValueString($_POST['id_prox4'], "int")
        ...
        $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset111 = sprintf(
            '/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 26 */ SELECT 
		inventarionegocios.Id_inventarionegocios, inventarionegocios.id_productoinventarionegocios, inventarionegocios.id_negocioinventarionegocios
        ...
        if ($row_Recordset111['id_productoinventarionegocios']==$_POST['id_prox4'] && $row_Recordset111['id_negocioinventarionegocios']==$_POST['local']) {
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 27 */ UPDATE inventarionegocios 
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_negocioinventarionegocios = %s AND  id_productoinventarionegocios = %s",
                GetSQLValueString($_POST['cantidad4'], "int"),
                GetSQLValueString($_POST['local'], "int"),
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 28 */ INSERT INTO inventarionegocios (id_negocioinventarionegocios, id_productoinventarionegocios, cantidadinventarionegocios
					 ) 
					 VALUES (%s, %s, %s)",
                GetSQLValueString($_POST['local'], "int"),
                GetSQLValueString($_POST['id_prox4'], "int"),
    ...
    if ($_POST['id_prox5']>0 &&  $_POST['cantidad5']>=0 && $_POST['local']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 29 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora
					 ) 
 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimotraslado, "int"),
        ...
        $Result = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 30 */ UPDATE producto 
										   SET cantidadensede=cantidadensede-%s
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad5'], "int"),
            GetSQLValueString($_POST['id_prox5'], "int")
        ...
        $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset111 = sprintf(
            '/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 31 */ SELECT 
		inventarionegocios.Id_inventarionegocios, inventarionegocios.id_productoinventarionegocios, inventarionegocios.id_negocioinventarionegocios
        ...
        if ($row_Recordset111['id_productoinventarionegocios']==$_POST['id_prox5'] && $row_Recordset111['id_negocioinventarionegocios']==$_POST['local']) {
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 32 */ UPDATE inventarionegocios 
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_negocioinventarionegocios = %s AND  id_productoinventarionegocios = %s",
                GetSQLValueString($_POST['cantidad5'], "int"),
                GetSQLValueString($_POST['local'], "int"),
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 33 */ INSERT INTO inventarionegocios (id_negocioinventarionegocios, id_productoinventarionegocios, cantidadinventarionegocios
					 ) 
					 VALUES (%s, %s, %s)",
                GetSQLValueString($_POST['local'], "int"),
                GetSQLValueString($_POST['id_prox5'], "int"),
    ...
    if ($_POST['id_prox6']>0 &&  $_POST['cantidad6']>=0 && $_POST['local']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 34 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora
					 ) 
 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimotraslado, "int"),
        ...
        $Result = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 35 */ UPDATE producto 
										   SET cantidadensede=cantidadensede-%s
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad6'], "int"),
            GetSQLValueString($_POST['id_prox6'], "int")
        ...
        $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset111 = sprintf(
            '/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 36 */ SELECT 
		inventarionegocios.Id_inventarionegocios, inventarionegocios.id_productoinventarionegocios, inventarionegocios.id_negocioinventarionegocios
        ...
        if ($row_Recordset111['id_productoinventarionegocios']==$_POST['id_prox6'] && $row_Recordset111['id_negocioinventarionegocios']==$_POST['local']) {
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 37 */ UPDATE inventarionegocios 
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_negocioinventarionegocios = %s AND  id_productoinventarionegocios = %s",
                GetSQLValueString($_POST['cantidad6'], "int"),
                GetSQLValueString($_POST['local'], "int"),
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 38 */ INSERT INTO inventarionegocios (id_negocioinventarionegocios, id_productoinventarionegocios, cantidadinventarionegocios
					 ) 
					 VALUES (%s, %s, %s)",
                GetSQLValueString($_POST['local'], "int"),
                GetSQLValueString($_POST['id_prox6'], "int"),
    ...
    if ($_POST['id_prox7']>0 &&  $_POST['cantidad7']>=0 && $_POST['local']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 39 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario,
	id_negocio, valor, fecha, hora
					 ) 
 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimotraslado, "int"),
        ...
        $Result = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 40 */ UPDATE producto 
										   SET cantidadensede=cantidadensede-%s
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad7'], "int"),
            GetSQLValueString($_POST['id_prox7'], "int")
        ...
        $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset111 = sprintf(
            '/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 41 */ SELECT 
		inventarionegocios.Id_inventarionegocios, inventarionegocios.id_productoinventarionegocios, inventarionegocios.id_negocioinventarionegocios
        ...
        if ($row_Recordset111['id_productoinventarionegocios']==$_POST['id_prox7'] && $row_Recordset111['id_negocioinventarionegocios']==$_POST['local']) {
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 42 */ UPDATE inventarionegocios 
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_negocioinventarionegocios = %s AND  id_productoinventarionegocios = %s",
                GetSQLValueString($_POST['cantidad7'], "int"),
                GetSQLValueString($_POST['local'], "int"),
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 43 */ INSERT INTO inventarionegocios (id_negocioinventarionegocios, id_productoinventarionegocios, cantidadinventarionegocios
					 ) 
					 VALUES (%s, %s, %s)",
                GetSQLValueString($_POST['local'], "int"),
                GetSQLValueString($_POST['id_prox7'], "int"),
    ...
    if ($_POST['id_prox8']>0 &&  $_POST['cantidad8']>=0 && $_POST['local']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 44 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario,
	id_negocio, valor, fecha, hora
					 ) 
 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimotraslado, "int"),
        ...
        $Result = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 45 */ UPDATE producto 
										   SET cantidadensede=cantidadensede-%s
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad8'], "int"),
            GetSQLValueString($_POST['id_prox8'], "int")
        ...
        $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset111 = sprintf(
            '/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 46 */ SELECT 
		inventarionegocios.Id_inventarionegocios, inventarionegocios.id_productoinventarionegocios, inventarionegocios.id_negocioinventarionegocios
        ...
        if ($row_Recordset111['id_productoinventarionegocios']==$_POST['id_prox8'] && $row_Recordset111['id_negocioinventarionegocios']==$_POST['local']) {
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 47 */ UPDATE inventarionegocios 
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_negocioinventarionegocios = %s AND  id_productoinventarionegocios = %s",
                GetSQLValueString($_POST['cantidad8'], "int"),
                GetSQLValueString($_POST['local'], "int"),
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 48 */ INSERT INTO inventarionegocios (id_negocioinventarionegocios, id_productoinventarionegocios, cantidadinventarionegocios
					 ) 
					 VALUES (%s, %s, %s)",
                GetSQLValueString($_POST['local'], "int"),
                GetSQLValueString($_POST['id_prox8'], "int"),
    ...
    if ($_POST['id_prox9']>0 &&  $_POST['cantidad9']>=0 && $_POST['local']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 49 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario,
	id_negocio, valor, fecha, hora
					 ) 
 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimotraslado, "int"),
        ...
        $Result = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 50 */ UPDATE producto 
										   SET cantidadensede=cantidadensede-%s
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad9'], "int"),
            GetSQLValueString($_POST['id_prox9'], "int")
        ...
        $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset111 = sprintf(
            '/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 51 */ SELECT 
		inventarionegocios.Id_inventarionegocios, inventarionegocios.id_productoinventarionegocios, inventarionegocios.id_negocioinventarionegocios
        ...
        if ($row_Recordset111['id_productoinventarionegocios']==$_POST['id_prox9'] && $row_Recordset111['id_negocioinventarionegocios']==$_POST['local']) {
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 52 */ UPDATE inventarionegocios 
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_negocioinventarionegocios = %s AND  id_productoinventarionegocios = %s",
                GetSQLValueString($_POST['cantidad9'], "int"),
                GetSQLValueString($_POST['local'], "int"),
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 53 */ INSERT INTO inventarionegocios (id_negocioinventarionegocios, id_productoinventarionegocios, cantidadinventarionegocios
					 ) 
					 VALUES (%s, %s, %s)",
                GetSQLValueString($_POST['local'], "int"),
                GetSQLValueString($_POST['id_prox9'], "int"),
    ...
    if ($_POST['id_prox10']>0 &&  $_POST['cantidad10']>=0 && $_POST['local']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 54 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario,
	id_negocio, valor, fecha, hora
					 ) 
 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimotraslado, "int"),
        ...
        $Result = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 55 */ UPDATE producto 
										   SET cantidadensede=cantidadensede-%s
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad10'], "int"),
            GetSQLValueString($_POST['id_prox10'], "int")
        ...
        $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset111 = sprintf(
            '/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 56 */ SELECT 
		inventarionegocios.Id_inventarionegocios, inventarionegocios.id_productoinventarionegocios, inventarionegocios.id_negocioinventarionegocios
        ...
        if ($row_Recordset111['id_productoinventarionegocios']==$_POST['id_prox10'] && $row_Recordset111['id_negocioinventarionegocios']==$_POST['local']) {
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 57 */ UPDATE inventarionegocios 
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_negocioinventarionegocios = %s AND  id_productoinventarionegocios = %s",
                GetSQLValueString($_POST['cantidad10'], "int"),
                GetSQLValueString($_POST['local'], "int"),
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 58 */ INSERT INTO inventarionegocios (id_negocioinventarionegocios, id_productoinventarionegocios, cantidadinventarionegocios
					 ) 
					 VALUES (%s, %s, %s)",
                GetSQLValueString($_POST['local'], "int"),
                GetSQLValueString($_POST['id_prox10'], "int"),
    ...
    if ($_POST['id_prox11']>0 &&  $_POST['cantidad11']>=0 && $_POST['local']>1) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 59 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario,
	id_negocio, valor, fecha, hora
					 ) 
 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimotraslado, "int"),
        ...
        $Result = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 60 */ UPDATE producto 
										   SET cantidadensede=cantidadensede-%s
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad11'], "int"),
            GetSQLValueString($_POST['id_prox11'], "int")
        ...
        $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset111 = sprintf(
            '/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 61 */ SELECT 
		inventarionegocios.Id_inventarionegocios, inventarionegocios.id_productoinventarionegocios, inventarionegocios.id_negocioinventarionegocios
        ...
        if ($row_Recordset111['id_productoinventarionegocios']==$_POST['id_prox11'] && $row_Recordset111['id_negocioinventarionegocios']==$_POST['local']) {
            $updateSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 62 */ UPDATE inventarionegocios 
										   SET cantidadinventarionegocios=cantidadinventarionegocios+%s
											   WHERE id_negocioinventarionegocios = %s AND  id_productoinventarionegocios = %s",
                GetSQLValueString($_POST['cantidad11'], "int"),
                GetSQLValueString($_POST['local'], "int"),
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 63 */ INSERT INTO inventarionegocios (id_negocioinventarionegocios, id_productoinventarionegocios, cantidadinventarionegocios
					 ) 
					 VALUES (%s, %s, %s)",
                GetSQLValueString($_POST['local'], "int"),
                GetSQLValueString($_POST['id_prox11'], "int"),
        ...
        $z=1;
            ...
            $query_Recordset12 = sprintf('/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 64 */ SELECT 
...
$totalRows_Recordset12 = mysqli_num_rows($Recordset12);
    ...
    do {
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\traslado\traslado.php - QUERY 65 */ UPDATE inventarioydemas 
										   SET valor=%s
