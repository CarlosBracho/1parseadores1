...
//echo $nuevahora1;
    ...
    $query_Recordset2 = sprintf('/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 1 */ SELECT 
...
$ultimacompra=$row_Recordset2['id_documentoinventarioydemas']+1;
    ...
    $query_Recordset1 = sprintf('/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 2 */ SELECT 
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1") {
    ...
    if ($_POST['id_prox']>0 &&  $_POST['cantidad']>0 && $_POST['costoxunidad']>=0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 3 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora) 
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 4 */ UPDATE producto 
    ...
    if ($_POST['id_prox1']>0 &&  $_POST['cantidad1']>0 && $_POST['costoxunidad1']>=0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 5 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimacompra, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 6 */ UPDATE producto 
										   SET cantidadensede=cantidadensede+%s, precioultimacompra=%s 
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad1'], "int"),
    ...
    if ($_POST['id_prox2']>0 &&  $_POST['cantidad2']>0 && $_POST['costoxunidad2']>=0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 7 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimacompra, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 8 */ UPDATE producto 
										   SET cantidadensede=cantidadensede+%s, precioultimacompra=%s 
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad2'], "int"),
    ...
    if ($_POST['id_prox3']>0 &&  $_POST['cantidad3']>0 && $_POST['costoxunidad3']>=0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 9 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimacompra, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 10 */ UPDATE producto 
										   SET cantidadensede=cantidadensede+%s, precioultimacompra=%s 
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad3'], "int"),
    ...
    if ($_POST['id_prox4']>0 &&  $_POST['cantidad4']>0 && $_POST['costoxunidad4']>=0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 11 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimacompra, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 12 */ UPDATE producto 
										   SET cantidadensede=cantidadensede+%s, precioultimacompra=%s 
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad4'], "int"),
    ...
    if ($_POST['id_prox5']>0 &&  $_POST['cantidad5']>0 && $_POST['costoxunidad5']>=0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 13 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimacompra, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 14 */ UPDATE producto 
										   SET cantidadensede=cantidadensede+%s, precioultimacompra=%s 
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad5'], "int"),
    ...
    if ($_POST['id_prox6']>0 &&  $_POST['cantidad6']>0 && $_POST['costoxunidad6']>=0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 15 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimacompra, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 16 */ UPDATE producto 
										   SET cantidadensede=cantidadensede+%s, precioultimacompra=%s 
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad6'], "int"),
    ...
    if ($_POST['id_prox7']>0 &&  $_POST['cantidad7']>0 && $_POST['costoxunidad7']>=0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 17 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimacompra, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 18 */ UPDATE producto 
										   SET cantidadensede=cantidadensede+%s, precioultimacompra=%s 
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad7'], "int"),
    ...
    if ($_POST['id_prox8']>0 &&  $_POST['cantidad8']>0 && $_POST['costoxunidad8']>=0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 19 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimacompra, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 20 */ UPDATE producto 
										   SET cantidadensede=cantidadensede+%s, precioultimacompra=%s 
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad8'], "int"),
    ...
    if ($_POST['id_prox9']>0 &&  $_POST['cantidad9']>0 && $_POST['costoxunidad9']>=0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 21 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimacompra, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 22 */ UPDATE producto 
										   SET cantidadensede=cantidadensede+%s, precioultimacompra=%s 
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad9'], "int"),
    ...
    if ($_POST['id_prox10']>0 &&  $_POST['cantidad10']>0 && $_POST['costoxunidad10']>=0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 23 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimacompra, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 24 */ UPDATE producto 
										   SET cantidadensede=cantidadensede+%s, precioultimacompra=%s 
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad10'], "int"),
    ...
    if ($_POST['id_prox11']>0 &&  $_POST['cantidad11']>0 && $_POST['costoxunidad11']>=0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 25 */ INSERT INTO inventarioydemas (id_documentoinventarioydemas, id_productoinventarioydemas, cantidad, tipoinventarioydemas, id_usuarioreninventario, 
	id_negocio, valor, fecha, hora) 
					 VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString($ultimacompra, "int"),
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\negocio\compras\registrarcompra.php - QUERY 26 */ UPDATE producto 
										   SET cantidadensede=cantidadensede+%s, precioultimacompra=%s 
											   WHERE id_producto = %s",
            GetSQLValueString($_POST['cantidad11'], "int"),
