  ...
  <div class="panel panel-primary">
    <div class="panel-heading">Selecciones Rango De Fecha A Consultar</div>
      <div class="panel-body">
                   <form action="inventariodiariocadadia.php" method="GET" name="form1" id="form1" autocomplete="off"  
         ...
         <div class="row">
            <div class="col-md-6">
                  ...
                  <div class='input-group date' name="fechainventario" id='fechainventario'>
                     <input type='text' class="form-control" name="fechainventario" value="<?php echo htmlentities($fecha, ENT_COMPAT, 'utf-8'); ?>"/>
