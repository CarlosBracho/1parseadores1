...
$query_Recordset1 = "/* PARSEADORES1 new\negocio\inventariolistadeprecios\inventariodiariocadadia.php - QUERY 1 */ SELECT 
...
$query_Recordset2 = "/* PARSEADORES1 new\negocio\inventariolistadeprecios\inventariodiariocadadia.php - QUERY 2 */ SELECT 
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1") {
    ...
    for ($i=0;$i<$numeroregistros;$i++) {
        ...
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\inventariolistadeprecios\inventariodiariocadadia.php - QUERY 3 */ INSERT INTO inventariodiario (id_numerodeinventariodiario, id_negocioeninventariodiario, id_productoeninventariodiario,
