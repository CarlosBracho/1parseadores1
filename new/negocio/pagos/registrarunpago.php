...
$x=0;
    ...
    $query_Recordset3 = sprintf('/* PARSEADORES1 new\negocio\pagos\registrarunpago.php - QUERY 1 */ SELECT 
...
$totalRows_Recordset3 = mysqli_num_rows($Recordset3);
    ...
    $query_Recordset4 = sprintf('/* PARSEADORES1 new\negocio\pagos\registrarunpago.php - QUERY 2 */ SELECT 
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1") {
    if ($_POST['local']>=0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\negocio\pagos\registrarunpago.php - QUERY 3 */ INSERT INTO pagospendientes (tipodepagopendiente, cuentabanco, fechapago, estadopago, datosdelpagohecho, id_negocioenpagopendiente, productoacancelar, idcategoriaengopendiente, telefono, monto
					 ) 
