...
"/* PARSEADORES1 new\logrosresultados\subirresultadoswiningbet.php - QUERY 1 */ UPDATE variables  SET 
variabledat=%s
WHERE variablenom=%s",
...
$query_Recordset1771 = sprintf(
    "/* PARSEADORES1 new\logrosresultados\subirresultadoswiningbet.php - QUERY 2 */ SELECT *
FROM variables 
WHERE  
variablenom = %s ",
    GetSQLValueString('fechalogrosresultados', "text")
