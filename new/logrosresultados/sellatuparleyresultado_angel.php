...
$urlayer='https://sellatuparley.com/results/index/2022-10-24';
...
if($mostrar==1){
  ...
  if(strpos($datoscurl2, 'ZZFutbolZZ')){
              ...
              $mostrar=1;
                      ...
                      preg_match_all("(,.tt.(.*).tt.(.*).tt.th.tt.td.tt.classtit-th1.tt.stylepadding-left:.tt.2px!importantheight:.tt.37px.tt.!important.tt.(.*):.tt.(.*)br.tt.(.*):.tt.(.*)br.tt..tt.td.tt.td.tt.titleDEPORTE.tt..tt.LIGA.tt.classdet-th1.tt.(.*).tt.ZZ(.*)ZZ.tt.td.tt.th.tt.classdet-th1(.*)brbr.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*).tt.th.tt.th.tt.classdet-th1(.*)brbr.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*))siU", $datoscurl2, $datoscurl3);
                      //var_dump($datoscurl3);
          ...
          $hora=$hora.':00';
                      ...
                      $segundamitad=$datoscurl3[9][0]-$datoscurl3[13][0];
              $segundamitad2=$datoscurl3[10][0]-$datoscurl3[14][0];



              $query_Recordset1111 = sprintf(
                "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 1 */ SELECT nomequipop1, Id_p1equiposp1
              FROM p1equipos
              ...
              $query_Recordset1112 = sprintf(
                "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 2 */ SELECT nomequipop1, Id_p1equiposp1
              FROM p1equipos
              WHERE nomsella = %s AND deportep1 = %s",
              ...
              $query_Recordset177 = sprintf(
                "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 3 */ SELECT *
              FROM  p2juegos
            ...
            $query_Recordset14 = sprintf(
              "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 4 */ SELECT * FROM p5resultadosj WHERE 
                  juegop5 = %s",
         ...
         if($totalRows_Recordset14==0){
          ...
          if ($row_Recordset177['Id_p2juegosp2']>0) {
            ...
            $insertSQL155 = sprintf(
                "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 5 */ INSERT INTO p5resultadosj  
...
%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                ...
                GetSQLValueString($datoscurl3[14][0], "int"),
...
if(strpos($datoscurl2, 'ZZBasketballZZ')){
          ...
          $mostrar=1;
                  ...
                  //preg_match_all("(spanclassVsOddsVSspanbr(.*)tdtdwidth25(.*)-(.*)tdtdclasstext-center(.*))siU", $datoscurl2, $datoscurl3);
                  //preg_match_all("(,(.*)thtdclasstit-th1stylepadding-left:2px!importantheight:37px!important39579:FUKUSHIMAUNITEDFCbr39580:SCSAGAMIHARAbrtdtdtitleDEPORTELIGA)siU", $datoscurl2, $datoscurl3);
                  preg_match_all("(,.tt.(.*).tt.(.*).tt.th.tt.td.tt.classtit-th1.tt.stylepadding-left:.tt.2px!importantheight:.tt.37px.tt.!important.tt.(.*):.tt.(.*)br.tt.(.*):.tt.(.*)br.tt..tt.td.tt.td.tt.titleDEPORTE.tt..tt.LIGA.tt.classdet-th1.tt.(.*).tt.ZZ(.*)ZZ.tt.td.tt.th.tt.classdet-th1(.*)brbr.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*).tt.th.tt.th.tt.classdet-th1(.*)brbr.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.)siU", $datoscurl2, $datoscurl3);
                  //var_dump($datoscurl3);
                  if (isset($datoscurl3[13][0])){ 
      ...
      $hora=$hora.':00';
              ...
              $query_Recordset1111 = sprintf(
                "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 6 */ SELECT nomequipop1, Id_p1equiposp1
              FROM p1equipos
              WHERE nomsella = %s AND deportep1 = %s",
              GetSQLValueString($Primerequipo, "text"),
              GetSQLValueString($deporte, "text"));
              ...
              $query_Recordset1112 = sprintf(
                "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 7 */ SELECT nomequipop1, Id_p1equiposp1
              FROM p1equipos
              WHERE nomsella = %s AND deportep1 = %s",
              GetSQLValueString($Primerequipo2, "text"),
              GetSQLValueString($deporte, "int"));
              ...
              $query_Recordset177 = sprintf(
                "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 8 */ SELECT *
              FROM  p2juegos
              WHERE idequipo1p2 = %s AND idequipo2p2 = %s AND iniciodtp2 >= %s AND iniciodtp2 <= %s ",
               GetSQLValueString($row_Recordset1111['Id_p1equiposp1'], "int"),
              GetSQLValueString($row_Recordset1112['Id_p1equiposp1'], "int"),
            ...
            $query_Recordset14 = sprintf(
              "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 9 */ SELECT * FROM p5resultadosj WHERE 
                  juegop5 = %s",
              GetSQLValueString($row_Recordset177['Id_p2juegosp2'], "int")
          );
          $Recordset14 = mysqli_query($conexionbanca, $query_Recordset14) or die(mysqli_error($conexionbanca));
         ...
         if($totalRows_Recordset14==0){
          ...
          if ($row_Recordset177['Id_p2juegosp2']>0) {
                  ...
                  $insertSQL1555 = sprintf(
                      "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 10 */ INSERT INTO p5resultadosj  
      (deportep5, juegop5, equipo1p5, equipo2p5, iniciodtp5, tiemposjugadosp5,
       r1p5, r2p5, r3p5, r4p5, r5p5, r6p5, r7p5, r8p5, r9p5, r10p5, 
       r11p5, r12p5, r13p5, r14p5, r15p5, r16p5, r17p5, r18p5, r19p5, r20p5, 
       r21p5, r22p5, r23p5, r24p5, r25p5, r26p5, r27p5, r28p5, r29p5, r30p5, quienmete)
      ...
      %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        include('../parley/carculojparley.php');
            ...
            $hora=$hora.':00';
                        ...
                        $segundamitad=$datoscurl3[13][0];
                        $segundamitad2=$datoscurl3[14][0];

                        $query_Recordset1111 = sprintf(
                          "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 11 */ SELECT nomequipop1, Id_p1equiposp1
                        FROM p1equipos
                        WHERE nomsella = %s AND deportep1 = %s",
                        GetSQLValueString($Primerequipo, "text"),
                        GetSQLValueString($deporte, "text"));
                        ...
                        $query_Recordset1112 = sprintf(
                          "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 12 */ SELECT nomequipop1, Id_p1equiposp1
                        FROM p1equipos
                        WHERE nomsella = %s AND deportep1 = %s",
                        GetSQLValueString($Primerequipo2, "text"),
                        GetSQLValueString($deporte, "int"));
                        ...
                        $query_Recordset177 = sprintf(
                          "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 13 */ SELECT *
                        FROM  p2juegos
                        WHERE idequipo1p2 = %s AND idequipo2p2 = %s AND iniciodtp2 >= %s AND iniciodtp2 <= %s ",
                         GetSQLValueString($row_Recordset1111['Id_p1equiposp1'], "int"),
                        GetSQLValueString($row_Recordset1112['Id_p1equiposp1'], "int"),
                        ...
                        $query_Recordset1444 = sprintf(
                          "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 14 */ SELECT * FROM p5resultadosj WHERE 
                              juegop5 = %s",
                          GetSQLValueString($row_Recordset177['Id_p2juegosp2'], "int")
                      );
                     ...
                     if($totalRows_Recordset1444==0){
                      ...
                      if ($row_Recordset177['Id_p2juegosp2']>0) {
                        echo 'creando';
                        $insertSQL155 = sprintf(
                            "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 15 */ INSERT INTO p5resultadosj  
            (deportep5, juegop5, equipo1p5, equipo2p5, iniciodtp5, tiemposjugadosp5,
             r1p5, r2p5, r3p5, r4p5, r5p5, r6p5, r7p5, r8p5, r9p5, r10p5, 
             r11p5, r12p5, r13p5, r14p5, r15p5, r16p5, r17p5, r18p5, r19p5, r20p5, 
             r21p5, r22p5, r23p5, r24p5, r25p5, r26p5, r27p5, r28p5, r29p5, r30p5, quienmete)
            ...
            %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                    ...
                    $mostrar=1;
                            ...
                            //preg_match_all("(spanclassVsOddsVSspanbr(.*)tdtdwidth25(.*)-(.*)tdtdclasstext-center(.*))siU", $datoscurl2, $datoscurl3);
                            //preg_match_all("(,(.*)thtdclasstit-th1stylepadding-left:2px!importantheight:37px!important39579:FUKUSHIMAUNITEDFCbr39580:SCSAGAMIHARAbrtdtdtitleDEPORTELIGA)siU", $datoscurl2, $datoscurl3);
                            preg_match_all("(,.tt.(.*).tt.(.*).tt.th.tt.td.tt.classtit-th1.tt.stylepadding-left:.tt.2px!importantheight:.tt.37px.tt.!important.tt.(.*):.tt.(.*)br.tt.(.*):.tt.(.*)br.tt..tt.td.tt.td.tt.titleDEPORTE.tt..tt.LIGA.tt.classdet-th1.tt.(.*).tt.ZZ(.*)ZZ.tt.td.tt.th.tt.classdet-th1(.*)brbr.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*).tt.th.tt.th.tt.classdet-th1(.*)brbr.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*).tt.th.tt.th.tt.classdet-th1(.*).tt.th.tt.th.tt.classdet-th1.tt.(.*).tt.th.(.*).tt.th.tt.)siU", $datoscurl2, $datoscurl3);
                            //var_dump($datoscurl3);
                ...
                $anotaprimero=0;
                            ...
                            //echo 'HORA '.$hora.' '.$datoscurl3[2][0].'<br> Primer equipo '.$Primerequipo.' Segundo equipo '.$Primerequipo2.' <br>Liga '.$liga.' Deporte '.$datoscurl3[8][0].' <br>RESJC: '.$datoscurl3[9][0].'-'.$datoscurl3[10][0].' A/BJC: '.$datoscurl3[11][0].' RLJC: '.$datoscurl3[12][0].' RESMJ: '.$datoscurl3[13][0].'-'.$datoscurl3[14][0].' A/BMJ: '.$datoscurl3[15][0].' RLMJ: '.$datoscurl3[16][0].' S/N: '.$datoscurl3[17][0].' H/V: '.$datoscurl3[18][0].' HRE: '.$datoscurl3[19][0].' <br><br> ';
                
                            //echo '<br>'.$datoscurl2.'<br><br><br>';


                            
                            if($datoscurl3[17][0]=='S'){$sinoj=1;}else{$sinoj=2;}

                
                if($datoscurl3[18][0] == 'H' ){
                  $anotaprimero=$Primerequipo2;
                }
                if($datoscurl3[18][0] == 'V' ){
                  $anotaprimero=$Primerequipo;
                }
                

                $query_Recordset1111 = sprintf(
                  "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 16 */ SELECT nomequipop1, Id_p1equiposp1
                FROM p1equipos
                WHERE nomsella = %s AND deportep1 = %s",
                GetSQLValueString($Primerequipo, "text"),
                GetSQLValueString($deporte, "text"));
                ...
                $query_Recordset1112 = sprintf(
                  "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 17 */ SELECT nomequipop1, Id_p1equiposp1
                FROM p1equipos
                WHERE nomsella = %s AND deportep1 = %s",
                GetSQLValueString($Primerequipo2, "text"),
                GetSQLValueString($deporte, "int"));
                ...
                $query_Recordset177 = sprintf(
                  "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 18 */ SELECT *
                FROM  p2juegos
                WHERE idequipo1p2 = %s AND idequipo2p2 = %s AND iniciodtp2 >= %s AND iniciodtp2 <= %s ",
                 GetSQLValueString($row_Recordset1111['Id_p1equiposp1'], "int"),
                GetSQLValueString($row_Recordset1112['Id_p1equiposp1'], "int"),
                ...
                //echo $row_Recordset1112['Id_p2juegosp2'];
                              ...
                              $query_Recordset444 = sprintf(
                                "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 19 */ SELECT * FROM p5resultadosj WHERE 
                                    juegop5 = %s",
                                GetSQLValueString($row_Recordset177['Id_p2juegosp2'], "int")
                            );
                           ...
                           if($totalRows_Recordset444==0){
                            ...
                            if ($row_Recordset177['Id_p2juegosp2']>0) {
                              echo 'creando';
                              $insertSQL155 = sprintf(
                                  "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 20 */ INSERT INTO p5resultadosj  
                  ...
                  %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                                  ...
                                  GetSQLValueString($datoscurl3[19][0], "int"),
                                  GetSQLValueString(-1, "int")
                              );
                              $Result155 = mysqli_query($conexionbanca, $insertSQL155) or die(mysqli_error($conexionbanca));
                              $ja++;
             ...
             //echo $hora.'<br>'.$Primerequipo.' VS '.$Primerequipo2.'<br>'.$liga.$hora;
                          ...
                          $segundamitad=$datoscurl3[9][0];
                  $segundamitad2=$datoscurl3[10][0];
    
                  //echo $datoscurl3[13][0].$datoscurl3[14][0].'<br>';
    
                  $query_Recordset1111 = sprintf(
                    "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 21 */ SELECT nomequipop1, Id_p1equiposp1
                  FROM p1equipos
                  WHERE nomsella = %s AND deportep1 = %s",
                  GetSQLValueString($Primerequipo, "text"),
                  GetSQLValueString($deporte, "text"));
                  ...
                  $query_Recordset1112 = sprintf(
                    "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 22 */ SELECT nomequipop1, Id_p1equiposp1
                  FROM p1equipos
                  WHERE nomsella = %s AND deportep1 = %s",
                  GetSQLValueString($Primerequipo2, "text"),
                  GetSQLValueString($deporte, "int"));
                  ...
                  $query_Recordset177 = sprintf(
                    "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 23 */ SELECT *
                  FROM  p2juegos
                  WHERE idequipo1p2 = %s AND idequipo2p2 = %s AND iniciodtp2 >= %s AND iniciodtp2 <= %s ",
                   GetSQLValueString($row_Recordset1111['Id_p1equiposp1'], "int"),
                  GetSQLValueString($row_Recordset1112['Id_p1equiposp1'], "int"),
                ...
                $query_Recordset14 = sprintf(
                  "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 24 */ SELECT * FROM p5resultadosj WHERE 
                      juegop5 = %s",
                  GetSQLValueString($row_Recordset177['Id_p2juegosp2'], "int")
              );
              $Recordset14 = mysqli_query($conexionbanca, $query_Recordset14) or die(mysqli_error($conexionbanca));
             ...
             if($totalRows_Recordset14==0){
              ...
              if ($row_Recordset177['Id_p2juegosp2']>0) {
                ...
                echo 'creando';
                $insertSQL155 = sprintf(
                    "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 25 */ INSERT INTO p5resultadosj  
    (deportep5, juegop5, equipo1p5, equipo2p5, iniciodtp5, tiemposjugadosp5,
     r1p5, r2p5, r3p5, r4p5, r5p5, r6p5, r7p5, r8p5, r9p5, r10p5, 
     r11p5, r12p5, r13p5, r14p5, r15p5, r16p5, r17p5, r18p5, r19p5, r20p5, 
     r21p5, r22p5, r23p5, r24p5, r25p5, r26p5, r27p5, r28p5, r29p5, r30p5, quienmete)
    ...
    echo '<br>';
      ...
      include('../parley/carculojparley.php');
        ...
        $msj='El Administrador New '.$usuario. ' actualizo resultados  de ' .$ja. ' en total desde SellatuParley';
...
curl_close ($ch);
        ...
        $query_RecordsetD = sprintf(
          "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 26 */ SELECT *
        FROM  p2juegos
     ...
     $query_RecordsetL = sprintf(
          "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 27 */ SELECT * FROM p5resultadosj WHERE 
              juegop5 = %s",
...
/*/
        ...
        $query_RecordsetD1 = sprintf(
          "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 28 */ SELECT * FROM p5resultadosj WHERE 
              juegop5 = %s",
          GetSQLValueString($row_RecordsetD['Id_p2juegosp2'], "int")
      );
...
if($totalRows_RecordsetD1==0){
  ...
  $query_RecordsetDP = sprintf(
    "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 29 */ SELECT nomequipop1
  FROM p1equipos
...
//echo $row_RecordsetDP['Id_p1equiposp1'];
  $query_RecordsetDP2 = sprintf(
    "/* PARSEADORES1 new\logrosresultados\sellatuparleyresultado_angel.php - QUERY 30 */ SELECT nomequipop1
  FROM p1equipos
  WHERE Id_p1equiposp1 = %s",
