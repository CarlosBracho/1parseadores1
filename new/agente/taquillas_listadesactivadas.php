...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\agente\taquillas_listadesactivadas.php - QUERY 1 */ SELECT 
	ta.nom_taquilla, ta.nom_representante, ta.est_taquilla, ta.cod_taquilla 
	FROM 
	taquilla ta,
	agencia ag
	WHERE ag.cod_agencia = ta.cod_agencia AND ag.cod_agencia = %s AND ta.est_taquilla = 0
