...
if (isset($_POST['cod_taquilla']) && $_POST['cod_taquilla']==0) {
    $menTaqui="indique taquilla";
    $graba--;
}
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if (isset($_POST['nom_usuario']) && $_POST['nom_usuario']!="") {
        $_POST['nom_usuario']=strtoupper($_POST['nom_usuario']);
        if (buscaUsu($_POST['nom_usuario'])>0) {
            $menNus="Ya existe";
            $graba--;
        }
    }
    $_POST['nom_completo']=strtoupper($_POST['nom_completo']);
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\agente\usuarios_ve_add.php - QUERY 1 */ INSERT 
		INTO usuario 
		...
		VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            ...
            GetSQLValueString($_POST['tic_re'], "text"),
            GetSQLValueString(1, "int")
        );
        
        $Result1 = mysqli_query($conexionbanca, $insertSQL1) or die(mysqli_error($conexionbanca));
        $insertGoTo = "../agente/taquillas_edit.php?recordID=".$xCodigo_taquilla;
        if (isset($_SERVER['QUERY_STRING'])) {
...
$query_Recordset2 = "/* PARSEADORES1 new\agente\usuarios_ve_add.php - QUERY 2 */ SELECT cod_taquilla, nom_taquilla FROM taquilla";
        ...
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>" onsubmit="return chequearEnvio();">
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              <table width="919" align="center">
                ...
                <tr valign="baseline">
                  <td height="26" colspan="5" align="center" valign="middle" nowrap bgcolor="#5EAEFF">DATOS Y OPCIONES DE USUARIO VENDEDOR</td>
                </tr>
              </table>
    ...
    if ($i<10) {
        ...
        $v=$i;
                ...
                <tr valign="baseline" style="font-size:12px">
                  ...
                  <td width="101" rowspan="2" align="right" valign="top">
                  ...
                  <td colspan="2" rowspan="2" align="left" valign="top">
					<select name="tic_re" style="width: auto; height: auto" class="textbox" tabindex="41">
                        	<?php for ($i = 0; $i <= 40; $i++) {?>
                                <option value="<?php echo $i; ?>" <?php
                                if (!(strcmp($i, htmlentities($tic_re, ENT_COMPAT, 'utf-8')))) {
                                    echo "SELECTED";
                                } ?>><?php echo $i; ?>
                                </option>
                           <?php  }?>
                ...
                <tr valign="baseline">
                  ...
                  <a href='../agente/taquillas_edit.php?recordID=<?php echo $xCodigo_taquilla;?>'
class="btn  btn-danger" style="width:150px; height:40px; font-size:16px;">
          ...
          <input type="hidden" name="tip_usuario" value="U"/>
		            <input type="hidden" name="cod_taquilla" value="<?php echo $xCodigo_taquilla;  ?>"/>
      </form>
    </div>
  <!-- InstanceEndEditable -->
  </div>
