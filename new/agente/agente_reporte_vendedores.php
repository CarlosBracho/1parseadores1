        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_distribuidor']!="todos") {
                $query_Recordset10 = sprintf(
                    "/* PARSEADORES1 new\agente\agente_reporte_vendedores.php - QUERY 1 */ SELECT ta.cod_taquilla, ta.nom_taquilla, ta.tel_taquilla, ta.taq_por_ame, 
				ag.agen_por_ame
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && $_POST['id_distribuidor']=="todos") ||
    ...
    $query_Recordset10 = sprintf(
        "/* PARSEADORES1 new\agente\agente_reporte_vendedores.php - QUERY 2 */ SELECT ta.cod_taquilla, ta.nom_taquilla, ta.tel_taquilla, ta.taq_por_ame, ag.agen_por_ame
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 new\agente\agente_reporte_vendedores.php - QUERY 3 */ SELECT cod_taquilla, nom_taquilla FROM taquilla WHERE cod_agencia = %s ORDER BY nom_taquilla",
    GetSQLValueString($codigoAgente, "int")
);
		...
		<table width="100%" border="0" style="color:#000; font-size:11px;" cellpadding="0" cellspacing="0"><?php
            ...
            if ($totalRows_Recordset10>0) {
                do {
                    ...
                    $query_Recordset3 = sprintf("/* PARSEADORES1 new\agente\agente_reporte_vendedores.php - QUERY 4 */ SELECT id_usuario, nom_usuario
                    ...
                    if ($totalRows_Recordset3>0) {
                        do {
                            ...
                            $query_Recordset1 = sprintf(
                                "/* PARSEADORES1 new\agente\agente_reporte_vendedores.php - QUERY 5 */ SELECT
