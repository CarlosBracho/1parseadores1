...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\agente\taquillas_lista.php - QUERY 1 */ SELECT 
	ta.nom_taquilla, ta.nom_representante, ta.est_taquilla, ta.cod_taquilla, ta.saldoactual, ta.tipo_pago  
	FROM 
	taquilla ta,
	agencia ag
	WHERE ag.cod_agencia = ta.cod_agencia AND ag.cod_agencia = %s AND ta.est_taquilla = 1 AND ta.tipotaquilla = 0
...
<div style="height:100%; font-size:18px;" class="xfirefox">
  ...
  <?php do { ?>
    <tr class="brillo" style="border-bottom:1px solid  #D5D5D5">
      <td align="left"><?php echo $row_Recordset1['nom_taquilla']; ?>
      </td>
	  <td align="left"><?php
      if ($row_Recordset1['tipo_pago']==0) {
          echo 'POST PAGO';
      }
      if ($row_Recordset1['tipo_pago']==1) {
          echo 'PRE PAGO';
      }
      ...
      <td align="left"><?php echo $row_Recordset1['saldoactual']/1; ?>
      </td>
      <td align="center"><?php echo ObtenerNombreStatus($row_Recordset1['est_taquilla']); ?></td>
      <td align="center">
      	<a href='taquillas_agregarsaldo.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'class="btn btn-info"> AGREGAR SALDO </a>
      </td>
	        <td align="center">
