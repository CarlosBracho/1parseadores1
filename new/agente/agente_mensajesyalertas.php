...
$query_mensajesyalertas = sprintf(
    "/* PARSEADORES1 new\agente\agente_mensajesyalertas.php - QUERY 1 */ SELECT me.tipo, me.para, me.mensaje, me.mostrarhasta, me.Id_mensajesyalertas, ta.cod_agencia FROM mensajesyalertas me, taquilla ta
WHERE (me.mostrarhasta >= CURDATE()) AND me.creadopor = 1 AND me.para = ta.cod_taquilla AND ta.cod_agencia = %s ORDER BY me.Id_mensajesyalertas DESC",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 new\agente\agente_mensajesyalertas.php - QUERY 2 */ UPDATE mensajesyalertas 
...
<div class="container">
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
  	<div style="height:100%; font-size:18px;" class="xfirefox">
            ...
            <a href="agente_crear_mensaje_ataquilla.php" class="btn alert-success" 
...
if ($row_mensajesyalertas['tipo']==1) {
    $query_Recordset4 = sprintf(
        "/* PARSEADORES1 new\agente\agente_mensajesyalertas.php - QUERY 3 */ SELECT ta.nom_taquilla FROM taquilla ta, agencia ag
WHERE ta.cod_taquilla = %s
...
echo 'Taquilla'."<br/><FONT FACE='times new roman' SIZE=4>".$nomdedetaquilla."</FONT>";
          ...
          <?php
} while ($row_mensajesyalertas = mysqli_fetch_assoc($mensajesyalertas)); ?>
      </table>
      </div>
      <?php } else {?>
