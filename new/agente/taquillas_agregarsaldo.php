...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\agente\taquillas_agregarsaldo.php - QUERY 1 */ SELECT
ta.taq_vende_ame,
ta.taq_por_ame,
ta.taq_vende_hnac,
ta.taq_cob_hnac,
...
$est_taquilla=$row_Recordset1['est_taquilla']/1;
    ...
    $taq_cob_hnac=$row_Recordset1['taq_cob_hnac']/1;
        ...
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 new\agente\taquillas_agregarsaldo.php - QUERY 2 */ SELECT * FROM usuario 
	WHERE tip_usuario='U' 
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\agente\taquillas_agregarsaldo.php - QUERY 3 */ UPDATE taquilla 
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\agente\taquillas_agregarsaldo.php - QUERY 4 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
