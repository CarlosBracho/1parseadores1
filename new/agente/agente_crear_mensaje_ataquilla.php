...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\agente\agente_crear_mensaje_ataquilla.php - QUERY 1 */ INSERT 
        ...
        $insertGoTo = "agente_mensajesyalertas.php";
        if (isset($_SERVER['QUERY_STRING'])) {
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 new\agente\agente_crear_mensaje_ataquilla.php - QUERY 2 */ SELECT cod_taquilla, nom_taquilla FROM taquilla WHERE cod_agencia = %s",
            ...
            <tr valign="baseline">
              <td colspan="11" align="left" nowrap>&nbsp;</td>
                ...
                <tr valign="baseline">
                  ...
                  <a href='agente_mensajesyalertas.php'
