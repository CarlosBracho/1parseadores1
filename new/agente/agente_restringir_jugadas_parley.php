...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\agente\agente_restringir_jugadas_parley.php - QUERY 1 */ SELECT  
...
$query_Recordset4 =  sprintf(
    "/* PARSEADORES1 new\agente\agente_restringir_jugadas_parley.php - QUERY 2 */ SELECT  
*
...
if ($totalRows_Recordset4==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            $query_Recordset4 =  sprintf(
                "/* PARSEADORES1 new\agente\agente_restringir_jugadas_parley.php - QUERY 3 */ SELECT  
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        if ($_POST['existe']==1) {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 new\agente\agente_restringir_jugadas_parley.php - QUERY 4 */ UPDATE taquilla_opc_parley
					SET
                    bloqueo_empate=%s,
                    bloqueo_ml=%s,
                    bloqueo_alta=%s,
                    bloqueo_baja=%s,
                    bloqueo_runline=%s,
                    bloqueo_superrunline=%s,
                    bloqueo_mj_empate=%s,
                    bloqueo_mj_ml=%s,
                    bloqueo_mj_alta=%s,
                    bloqueo_mj_baja=%s,
                    bloqueo_mj_runline=%s,
                    bloqueo_si=%s,
                    bloqueo_no=%s,
                    bloqueo_ap=%s,
                    bloqueo_hce=%s
					WHERE cod_taopcparley=%s",
                GetSQLValueString($_POST['bloqueo_empate'], "int"),
                GetSQLValueString($_POST['bloqueo_ml'], "int"),
                GetSQLValueString($_POST['bloqueo_alta'], "int"),
                GetSQLValueString($_POST['bloqueo_baja'], "int"), 
                GetSQLValueString($_POST['bloqueo_runline'], "int"),
                GetSQLValueString($_POST['bloqueo_superrunline'], "int"),
                GetSQLValueString($_POST['bloqueo_mj_empate'], "int"),
                GetSQLValueString($_POST['bloqueo_mj_ml'], "int"),
                GetSQLValueString($_POST['bloqueo_mj_alta'], "int"),
                GetSQLValueString($_POST['bloqueo_mj_baja'], "int"), 
                GetSQLValueString($_POST['bloqueo_runline'], "int"),
                GetSQLValueString($_POST['bloqueo_si'], "int"),
                GetSQLValueString($_POST['bloqueo_no'], "int"),
                GetSQLValueString($_POST['bloqueo_ap'], "int"), 
                GetSQLValueString($_POST['bloqueo_hce'], "int"),            
...
/*/
            ...
            if ($_POST['monto_apuesta']<>$row_Recordset4['monto_apuesta'] or $_POST['factor_pago']<>$row_Recordset4['factor_pago']) {
...
/*/
            ...
            echo "/* PARSEADORES1 new\agente\agente_restringir_jugadas_parley.php - QUERY 5 */ insert";
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 new\agente\agente_restringir_jugadas_parley.php - QUERY 6 */ INSERT 
			INTO 
			taquilla_opc_parley 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 new\agente\agente_restringir_jugadas_parley.php - QUERY 7 */ SELECT  
tp.apu_minparley, tp.apu_maxparley, tp.comb_minparley, tp.comb_maxparley
	...
	LIMIT 1",
            ...
            if ($apuestasminimaausar > $row_Recordset22['apu_minparley']) {
                $insertSQL11 = sprintf(
                    "/* PARSEADORES1 new\agente\agente_restringir_jugadas_parley.php - QUERY 8 */ UPDATE taquilla_opc_parley
					SET
					apu_minparley=%s
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\agente\agente_restringir_jugadas_parley.php - QUERY 9 */ SELECT ta.cod_taquilla, ta.nom_taquilla
FROM taquilla ta, taquilla_opc_parley tp
          ...
          <input type="hidden" name="cod_taopcparley" value="<?php echo $cod_taopcparley; ?>">
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              ...
              <tr valign="baseline">
                ...
                <tr valign="baseline">
                  <td nowrap align="left">EMPATE:</td>
                  <td>
            
          <select name="bloqueo_empate" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_empate']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_empate']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  ...
                  <td>
                  <select name="bloqueo_ml" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="bloqueo_alta" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  ...
                  <td>
                  <select name="bloqueo_baja" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="bloqueo_runline" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_runline']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_runline']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  ...
                  <td>
                  <select name="bloqueo_superrunline" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_superrunline']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_superrunline']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="bloqueo_mj_empate" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_mj_empate']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_mj_empate']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  <td nowrap align="left">MONEYLINE:</td>
                  <td>
                  <select name="bloqueo_mj_ml" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_mj_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_mj_ml']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="bloqueo_mj_alta" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_mj_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_mj_alta']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  <td nowrap align="left">BAJA:</td>
                  <td>
                  <select name="bloqueo_mj_baja" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_mj_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_mj_baja']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="bloqueo_mj_runline" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_mj_runline']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_mj_runline']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="bloqueo_sino" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_si']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_si']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  ...
                  <td>
                  <select name="bloqueo_ap" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_no']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_no']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
          ...
          <select name="bloqueo_ap" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_ap']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_ap']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
                  ...
                  <td>
                  <select name="bloqueo_hce" style="width:200px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset4['bloqueo_hce']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>BLOQUEADO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset4['bloqueo_hce']/1, ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
    } ?>>ACTIVO</option>
						  </select>
                  </td>
