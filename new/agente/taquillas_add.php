...
$query_Recordset3 =  sprintf(
  "/* PARSEADORES1 new\agente\taquillas_add.php - QUERY 1 */ SELECT * 
FROM 
agencia
WHERE cod_agencia = %s",
...
$Gnom=$row_Recordset3['nom_agencia'];
...
if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
    if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
        ...
        $query_Recordset4 =  sprintf(
            "/* PARSEADORES1 new\agente\taquillas_add.php - QUERY 2 */ SELECT  
		, tp.apu_maxgan, tp.apu_maxpla, tp.apu_maxsho, tp.apu_maxexa, tp.apu_maxtri, tp.apu_maxsup, tp.apu_mingan,
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==30) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\agente\taquillas_add.php - QUERY 3 */ INSERT 
				INTO taquilla 
...
taq_cob_hnac,
        ...
        $query_RecT = "/* PARSEADORES1 new\agente\taquillas_add.php - QUERY 4 */ SELECT cod_taquilla FROM taquilla ORDER BY cod_taquilla DESC LIMIT 1";
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 new\agente\taquillas_add.php - QUERY 5 */ INSERT 
		INTO usuario 
...
$msj='El Agente ' .$Gnom . ' creo una nueva Taquilla con el nombre: '.$tnom;
...
curl_close ($ch);
        ...
        $insertGoTo = "../agente/taquillas_edit.php?recordID=".$codTaquilla;
...
$query_Recordset3 = "/* PARSEADORES1 new\agente\taquillas_add.php - QUERY 6 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
