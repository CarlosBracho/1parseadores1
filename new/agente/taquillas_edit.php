...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\agente\taquillas_edit.php - QUERY 1 */ UPDATE taquilla 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\agente\taquillas_edit.php - QUERY 2 */ SELECT
ta.taq_vende_ame,
ag.sinoclaves,
ta.taq_por_ame,
ta.taq_vende_parley,
...
$est_taquilla=$row_Recordset1['est_taquilla']/1;
    ...
    $taq_cob_hnac=$row_Recordset1['taq_cob_hnac']/1;
        ...
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 new\agente\taquillas_edit.php - QUERY 3 */ SELECT * FROM usuario 
	WHERE tip_usuario='U' 
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\agente\taquillas_edit.php - QUERY 4 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
	...
	<table width="100%" border="0" align="center">
        ...
        <?php do { ?>
          <tr class="brillo">
            ...
            <td align="left"><?php
              if ($row_Recordset1['sinoclaves']==1){
