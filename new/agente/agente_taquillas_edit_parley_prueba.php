...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\agente\agente_taquillas_edit_parley_prueba.php - QUERY 1 */ SELECT  
...
$query_Recordset4 =  sprintf(
    "/* PARSEADORES1 new\agente\agente_taquillas_edit_parley_prueba.php - QUERY 2 */ SELECT  
*
...
if ($totalRows_Recordset4==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            $query_Recordset4 =  sprintf(
                "/* PARSEADORES1 new\agente\agente_taquillas_edit_parley_prueba.php - QUERY 3 */ SELECT  
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        if ($_POST['existe']==1) {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 new\agente\agente_taquillas_edit_parley_prueba.php - QUERY 4 */ UPDATE taquilla_opc_parley
					SET
apu_maxparley=%s, 
apu_minparley=%s,
comb_minparley=%s, 
...
factor_pago=%s,
            ...
            echo "/* PARSEADORES1 new\agente\agente_taquillas_edit_parley_prueba.php - QUERY 5 */ insert";
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 new\agente\agente_taquillas_edit_parley_prueba.php - QUERY 6 */ INSERT 
			INTO 
			taquilla_opc_parley 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 new\agente\agente_taquillas_edit_parley_prueba.php - QUERY 7 */ SELECT  
tp.apu_minparley, tp.apu_maxparley, tp.comb_minparley, tp.comb_maxparley
	...
	LIMIT 1",
            ...
            if ($apuestasminimaausar > $row_Recordset22['apu_minparley']) {
                $insertSQL11 = sprintf(
                    "/* PARSEADORES1 new\agente\agente_taquillas_edit_parley_prueba.php - QUERY 8 */ UPDATE taquilla_opc_parley
					SET
					apu_minparley=%s
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\agente\agente_taquillas_edit_parley_prueba.php - QUERY 9 */ SELECT ta.cod_taquilla, ta.nom_taquilla
FROM taquilla ta, taquilla_opc_parley tp
        	...
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              ...
              <table width="920" align="center" border="0"  style="line-height:11px" cellpadding="0" cellspacing="0">
                ...
                <tr valign="baseline">
                  ...
                  <td>
                      <input type="text" name="comb_minparley" class="textboxsmal" style="height:auto; width:100px" onclick="ocultaDiv('Info5');"
                  ...
                  <td>
                      <input type="text" name="comb_maxparley" class="textboxsmal" style="height:auto; width:140px" onclick="ocultaDiv('Info5');"
                 ...
                 <td nowrap align="left">Monto maximo a pagar por ticket:</td>
                  <td>
                      <input type="text" name="monto_apuesta" class="textboxsmal" style="height:auto; width:140px" onclick="ocultaDiv('Info5');"
                  ...
                  <tr valign="baseline">
                  <td nowrap align="left">LIMITE DE MINUTOS PARA PODER<br> <br>ELIMINAR UNA APUESTA:</td>
                  <td>
                 ...
                 <td nowrap align="left">Maximo a multiplicar por apuestas:</td>
                  <td>
                      <input type="text" name="factor_pago" class="textboxsmal" style="height:auto; width:140px" onclick="ocultaDiv('Info5');"
...
<table width="920" align="center" border="0"  style="line-height:11px" cellpadding="0" cellspacing="0">
                ...
                <tr valign="baseline">
                  <td height="26" colspan="5" align="center" valign="middle" nowrap bgcolor="#5EAEFF">BLOQUEAR JUGADAS PARLEY</td>
                </tr>
                <tr>
                    <td>
                    <div class="row">
				<h2 style="text-align:center">SELECCION DEPORTE</h2>
			</div>
            <a href='../agente/agente_restringir_jugadas_beisbol.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'
                  class="btn btn-warning btn-lg" target="_blank" style="width:150px; height:40px; font-size:16px;" role="button">
            <div style="padding:10px 0px 0px 0px">BEISBOL</div>
            <a href='../agente/agente_restringir_jugadas_baloncesto.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'
                  class="btn btn-primary btn-lg" target="_blank" style="width:150px; height:40px; font-size:16px;" role="button">
            <div style="padding:10px 0px 0px 0px">BALONCESTO</div>
            <a href='../agente/agente_restringir_jugadas_futbol.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'
                  class="btn btn-success btn-lg" target="_blank" style="width:150px; height:40px; font-size:16px;" role="button">
            <div style="padding:10px 0px 0px 0px">FUTBOL</div>
            <a href='../agente/agente_restringir_jugadas_futbolame.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'
                  class="btn btn-secondary btn-lg" target="_blank" style="width:150px; height:40px; font-size:16px;" role="button">
            <div style="padding:10px 0px 0px 0px">FUTBOLAMERICANO</div>
            <a href='../agente/agente_restringir_jugadas_hockey.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'
                  class="btn btn-danger btn-lg" target="_blank" style="width:150px; height:40px; font-size:16px;" role="button">
            <div style="padding:10px 0px 0px 0px">HOCKEY</div>
			<a href="../agente/agente_restringir_jugadas_parley.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>" style="width:150px; height:40px; font-size:16px; font: size 20px;"role="button"></a>
