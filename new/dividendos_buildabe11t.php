...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\dividendos_buildabe11t.php - QUERY 1 */ SELECT * 
	FROM 
	hipodromo,
	carrera 
	WHERE
...
<table width="100%" border="0" style="font-family:Verdana, Geneva, sans-serif;font-size:16px; color:#FFFFFF">
  <tr  style="color: #FFF">
  	...
  	<td height="41" align="left" valign="middle" style="font-size:34px">BUILDABET - DIVIDENDOS</td>
                ...
                foreach ($cAct as $hip) {
					...
					<?php
                        ...
                        if (($eje1LugarSimple[$hip]>0 && $DivWinPriLugar[$hip]>0) || $eje1LugarSimple[$hip]==99) {
                            ...
                            $updateSQL = sprintf(
                                "/* PARSEADORES1 new\dividendos_buildabe11t.php - QUERY 2 */ UPDATE carrera 
							SET 
								est_confirmacion=%s,
								control_dividendo=%s,
								eje_primero=%s, 
