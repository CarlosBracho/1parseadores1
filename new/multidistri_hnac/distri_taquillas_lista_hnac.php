...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\multidistri_hnac\distri_taquillas_lista_hnac.php - QUERY 1 */ SELECT * 
	FROM
		banca, 
		taquilla,
		agencia
...
<div style="height:100%; font-size:18px; padding:0px 0px 0px 0px; margin:70px 0 0 0">
  ...
  <?php do { ?>
    <tr class="brillo" >
      ...
      <td align="center">
      	<a href='distri_taquillas_edit_hnac.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'class="btn btn-info"> EDITAR </a>
      </td>
    </tr>
