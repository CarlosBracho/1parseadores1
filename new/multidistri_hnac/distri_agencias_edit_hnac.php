...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\multidistri_hnac\distri_agencias_edit_hnac.php - QUERY 1 */ UPDATE agencia 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\multidistri_hnac\distri_agencias_edit_hnac.php - QUERY 2 */ SELECT
	agencia.nom_agencia,
	agencia.cod_banca,
