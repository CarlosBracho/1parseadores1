...
$xCodigodistri = $_GET["recordID"];


$query_Recordset11 =  sprintf(
    "/* PARSEADORES1 new\multidistri_hnac\distri_taquillas_edit_hnacres.php - QUERY 1 */ SELECT  
    ...
    GetSQLValueString($xCodigodistri, "int")
);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\multidistri_hnac\distri_taquillas_edit_hnacres.php - QUERY 2 */ UPDATE taquilla 
...
%s, %s, %s, %s, %s. %s
            ...
            if($_POST['redondeo_hnac']==0 && $_POST['redondeo_hnac']){
...
/*/
        ...
        $insertGoTo = "../distri/taquillas_edit.php?recordID=".$xCodigo;
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\multidistri_hnac\distri_taquillas_edit_hnacres.php - QUERY 5 */ SELECT  
	ta.nom_taquilla,
	...
	taoa.cod_taopcame
	FROM  
	taquilla ta, agencia ag, taquilla_opc_ame taoa 
	WHERE ta.cod_taquilla = %s AND taoa.cod_taquilla = %s AND ag.cod_agencia = ta.cod_agencia 
	LIMIT 1",
...
$query_Recordset2 =  sprintf(
    "/* PARSEADORES1 new\multidistri_hnac\distri_taquillas_edit_hnacres.php - QUERY 6 */ SELECT * FROM taquilla_opc_hnac
	WHERE cod_taquilla = %s",
    GetSQLValueString($xCodigo, "int"),
...
if ($totalRows_Recordset2==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            ...
            $query_Recordset2 =  sprintf(
                "/* PARSEADORES1 new\multidistri_hnac\distri_taquillas_edit_hnacres.php - QUERY 7 */ SELECT * 
				FROM  
				taquilla_opc_hnac 
				WHERE 
				cod_taquilla = %s",
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\multidistri_hnac\distri_taquillas_edit_hnacres.php - QUERY 8 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
        	...
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              ...
              <table width="924" align="center">
                <tr valign="baseline">
                  ...
                  <a href='../distri/taquillas_edit.php?recordID=<?php echo $xCodigo; ?>'
