...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\multidistri_hnac\distri_taquillas_add_hnac.php - QUERY 1 */ INSERT 
			INTO taquilla 
        ...
        $query_RecT = "/* PARSEADORES1 new\multidistri_hnac\distri_taquillas_add_hnac.php - QUERY 2 */ SELECT cod_taquilla FROM taquilla ORDER BY cod_taquilla DESC LIMIT 1";
...
%s, %s, %s, %s, %s
        ...
        $insertSQL2 = sprintf(
            "/* PARSEADORES1 new\multidistri_hnac\distri_taquillas_add_hnac.php - QUERY 4 */ INSERT 
		INTO usuario 
...
if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
    if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
        $query_Recordset2 =  sprintf(
            "/* PARSEADORES1 new\multidistri_hnac\distri_taquillas_add_hnac.php - QUERY 5 */ SELECT * 
			FROM  
			taquilla_opc_hnac 
			WHERE 
			cod_taquilla = %s",
...
$query_Recordset4 = sprintf(
    "/* PARSEADORES1 new\multidistri_hnac\distri_taquillas_add_hnac.php - QUERY 6 */ SELECT ag.cod_agencia, ag.nom_agencia 
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\multidistri_hnac\distri_taquillas_add_hnac.php - QUERY 7 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
