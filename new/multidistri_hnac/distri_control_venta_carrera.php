    ...
    if ($_POST['id_hipod']!="-1") {
        if ($_POST['id_hipod']!="-1" && $_POST['id_carrera']=="todas") {
            $query_Recordset4 = sprintf(
                "/* PARSEADORES1 new\multidistri_hnac\distri_control_venta_carrera.php - QUERY 1 */ SELECT 
				nom_hipodromo_hnac
			FROM hipodromo_hnac
            ...
            $query_Recordset4 = sprintf(
                "/* PARSEADORES1 new\multidistri_hnac\distri_control_venta_carrera.php - QUERY 2 */ SELECT 
				ca.cod_carrera_hnac, 
        ...
        $query_Recordset6 = sprintf(
            "/* PARSEADORES1 new\multidistri_hnac\distri_control_venta_carrera.php - QUERY 3 */ SELECT 
        ...
        if ($_POST['id_agente']!="todos") {
            $query_Recordset5 = sprintf(
                "/* PARSEADORES1 new\multidistri_hnac\distri_control_venta_carrera.php - QUERY 4 */ SELECT nom_taquilla, cod_taquilla FROM taquilla WHERE cod_taquilla = %s",
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 new\multidistri_hnac\distri_control_venta_carrera.php - QUERY 5 */ SELECT 
	ag.nom_agencia,
	ta.cod_taquilla,
	ta.nom_taquilla 
	FROM 
        ...
        multidistriMD mu
	WHERE
		mu.cod_multidistriMD = %s AND
		ag.cod_banca = ba.cod_banca AND
        mu.cod_multidistriMD = ba.cod_multidistriMDBA AND 
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\multidistri_hnac\distri_control_venta_carrera.php - QUERY 6 */ SELECT 
...
<script language="javascript">
	...
	function verInfo() {
		var parametros1 = { 
			...
			"fecCarrera":document.getElementById("datepickeri").value,
			"codHipodromo":document.getElementById("id_hipod").value};
		$.ajax({ data:parametros1, url:'distri_reca_carrera_carrera_hnac.php', type:'post',
			beforeSend: function() {
...
<div class="container">
		...
		<?php include("../includes/cabeceraamericana_multidistri.php");?>
            <div id="menu" style="height:50px; padding:0px 0px 0px 50px; margin:-10px 0px 0px 0px">
                ...
                <div style="background:#F90; margin:0px 0px 0px 0px; padding:0px 20px 5px 20px; word-spacing: normal;
					...
					<?php include("../includes/cabeceramultidistri_hnac.php");?>
                </div>
            </div> <!-- end .menu -->
	</div> <!-- end .header -->
    ...
    echo "SELECTED";
		  ...
		  <div id="gener" style="width:100%; float:left; height:750px">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tbody>
                        <tr style="font-family:'Lucida Grande','Lucida Sans Unicode','Lucida Sans','DejaVu Sans',Verdana,sans-serif; background:#0e5157; color:#FFF; font-size:14px; text-align:center ">
                ...
                <div id="reporte" style="width:100%; float:left; height:400px">
					<?php include("distri_reca_carrera_carrera_hnac.php"); ?>
                </div>
			</div>
        </div>
