...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\multidistri_hnac\distri_usuarios_ve_lista_hnac.php - QUERY 1 */ SELECT taquilla.nom_taquilla, usuario.nom_usuario, usuario.est_usuario, usuario.id_usuario,
	agencia.nom_agencia
	FROM
	banca, 
	taquilla,
	...
	usuario.tip_usuario = 'U' AND
	banca.cod_banca = %s
	ORDER BY 
	taquilla.nom_taquilla ASC, agencia.nom_agencia ASC, usuario.nom_usuario ASC",
...
<div style="height:100%; font-size:18px; padding:0px 0px 0px 0px; margin:70px 0 0 0">
    ...
    <table width="100%" border="0" align="center" style="background:#0E5157; color:#FFF; font-size:14px" >
        <tr>
          <td width="472" align="right">&nbsp;Vendedores <?php echo($startRow_Recordset1 + 1) ?>-<?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?> de <?php echo $totalRows_Recordset1 ?></td>
	...
	<table width="100%" border="0" align="center">
          ...
          <td width="231">NOMBRE VENDEDOR</td>
          <td width="200">AGENTE</td>
          <td width="218">TAQUILLA</td>
          <td width="152">STATUS</td>
          <td width="121">ACCIÓN</td>
        </tr>
        <?php do { ?>
          <tr class="brillo">
            ...
            <td align="center">
               <a href='distri_usuarios_ve_edit_hnac.php?recordID=<?php echo $row_Recordset1['id_usuario']; ?>'class="btn btn-info"> EDITAR </a>
            </td>
          </tr>
       ...
       <?php } else {?>
      <table width="100%" border="0" align="center" style="background:#0E5157; color:#FFFFFF; height:30px">
