...
$query_Recordset1 = sprintf(
    '/* PARSEADORES1 new\multidistri_hnac\distri_usuarios_ag_lista_hnac.php - QUERY 1 */ SELECT usuario.nom_usuario, usuario.id_usuario, usuario.est_usuario, agencia.nom_agencia
	FROM 
		banca, 
		agencia,
		usuario
  ...
  <?php do { ?>
    <tr class="brillo">
      ...
      <td align="center" class="brillo">
      	<a href='distri_usuarios_ag_edit_hnac.php?recordID=<?php echo $row_Recordset1['id_usuario']; ?>'class="btn btn-info"> EDITAR </a>
      </td>
      </tr>
