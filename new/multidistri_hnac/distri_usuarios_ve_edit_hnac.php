...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $_POST['tip_usuario']="U";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\multidistri_hnac\distri_usuarios_ve_edit_hnac.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
				est_usuario=%s, 
            ...
            GetSQLValueString($_POST['tic_re_hnac'], "int"),
            GetSQLValueString($_POST['id_usuario'], "int")
        );
        
        $Result1 = mysqli_query($conexionbanca, $insertSQL1) or die(mysqli_error($conexionbanca));
        $insertGoTo = "distri_usuarios_ve_lista_hnac.php";
        if (isset($_SERVER['QUERY_STRING'])) {
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\multidistri_hnac\distri_usuarios_ve_edit_hnac.php - QUERY 2 */ SELECT us.id_usuario, us.pas_usuario, us.nom_usuario, us.dia_entrada, us.hor_inicio, us.hor_fin,
	us.nom_completo, us.pas_usuario, us.est_usuario, us.tic_eliminados, us.cod_barra, us.can_reimpresion, 	
	us.can_reimpresion_hnac, ta.nom_taquilla
	FROM 
	usuario us, taquilla ta, agencia ag, banca ba
	WHERE 
	us.id_usuario = %s AND
    ...
    echo "SELECTED";
              ...
              <table width="920" border="0">
                ...
                <tr valign="baseline" style="font-size:12px">
                  ...
                  <td width="98" rowspan="2" align="right" valign="top">&nbsp;</td>
              ...
              <table width="920" align="center" border="0">
                ...
                <tr valign="baseline">
                  <td colspan="12" align="left" bgcolor="#333333">&nbsp;</td>
                </tr>
                <tr valign="baseline">
                  <td width="124" align="center" valign="bottom">AMERICANAS</td>
                  <td align="center" valign="bottom" nowrap bgcolor="#999999">NACIONALES</td>
                  <td width="465" align="center" valign="bottom">&nbsp;</td>
                ...
                <tr valign="baseline">
                  ...
                  <strong>Cant. de tickets a reimprimir:</strong></td>
                  <td align="center" valign="bottom" bgcolor="#999999" style="font-size:12px">
                ...
                <tr valign="baseline">
                  ...
                  <td width="124" align="center" valign="top" bgcolor="#999999">
					<select name="tic_re_hnac" style="width: auto; height: auto" class="textbox" tabindex="41">
                        	<?php for ($i = 0; $i <= 50; $i++) {?>
                                <option value="<?php echo $i; ?>" <?php
                                if (!(strcmp($i, htmlentities($row_Recordset1['can_reimpresion_hnac'], ENT_COMPAT, 'utf-8')))) {
                                    echo "SELECTED";
                                } ?>><?php echo $i; ?>
                                </option>
                           <?php  }?>
				...
				<table width="920" align="center">
                <tr valign="baseline">
                  <td width="142" align="left" nowrap>&nbsp;</td>
                  <td width="256" align="left" nowrap><br />
