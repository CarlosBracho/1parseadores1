        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_agente']!="todos") {
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\multidistri_hnac\distri_reporte_jugadas_hnac.php - QUERY 1 */ SELECT 
					ve.ticket_hnac, 
					ve.ip_venta_hnac, 
					ve.fec_venta_hnac, 
					ve.hor_venta_hnac, 
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && isset($_POST['id_agente']) && $_POST['id_agente']=="todos") || (!isset($_POST["MM_update"]))) {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\multidistri_hnac\distri_reporte_jugadas_hnac.php - QUERY 2 */ SELECT 
					ve.ticket_hnac, 
					ve.ip_venta_hnac, 
					ve.fec_venta_hnac,
					ve.hor_venta_hnac, 
...
$query_Recordset2 = sprintf(
  "/* PARSEADORES1 new\multidistri_hnac\distri_reporte_jugadas_hnac.php - QUERY 3 */ SELECT 
