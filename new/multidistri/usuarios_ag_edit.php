...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\multidistri\usuarios_ag_edit.php - QUERY 1 */ SELECT * 
	FROM 
	usuario, agencia 
	WHERE 
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $control=0;
    $contron=0;
    if (strlen($_POST['nom_completo'])<0) {
    ...
    if ($graba==31) {
        $_POST['tip_usuario']="G";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\multidistri\usuarios_ag_edit.php - QUERY 2 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
				est_usuario=%s, 
