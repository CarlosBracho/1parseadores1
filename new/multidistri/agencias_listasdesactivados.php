...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\multidistri\agencias_listasdesactivados.php - QUERY 1 */ SELECT * 
			FROM 
				agencia, 
				banca 
			WHERE 
				banca.cod_banca = agencia.cod_banca AND agencia.est_agencia = 0 AND
				banca.cod_banca = %s
...
<div class="container">
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
  	<div style="height:100%; font-size:18px; padding:0px 0px 0px 0px ">
        ...
        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:right;">
            <a href="agencias_listas.php" class="btn alert-success" 
            	style="font-size:24px; width:270px; height:30px; padding:10px 0px 0px 0px; background:#9C0; text-align:center ">
                Agentes Activos
          </a>
        </div>
