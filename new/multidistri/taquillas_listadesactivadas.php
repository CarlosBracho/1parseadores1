...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\multidistri\taquillas_listadesactivadas.php - QUERY 1 */ SELECT ta.nom_taquilla, ta.est_taquilla, ta.cod_taquilla, ag.nom_agencia
	FROM
		banca ba, 
		taquilla ta,
		agencia ag,
	...
	WHERE 
		...
		mu.cod_multidistriMD = %s AND ta.est_taquilla = 0
...
<div class="container">
  ...
  <?php do { ?>
    <tr class="brillo" style="border-bottom:1px solid  #D5D5D5">
      ...
      <td align="left"><?php echo $row_Recordset1['nom_agencia']; ?>
      </td>
