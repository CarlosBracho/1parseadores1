...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\multidistri\bancas_edit.php - QUERY 1 */ UPDATE banca 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\multidistri\bancas_edit.php - QUERY 2 */ SELECT *
	FROM  
	banca
	WHERE 
	banca.cod_banca = %s",
...
$query_Recordset94 =  sprintf(
  "/* PARSEADORES1 new\multidistri\bancas_edit.php - QUERY 3 */ SELECT
