...
$query_Recordset12 = sprintf(
    "/* PARSEADORES1 new\multidistri\distri_reporte_general_total2.php - QUERY 1 */ SELECT por_banca, cob_banca_hnac FROM banca WHERE cod_banca = %s LIMIT 1",
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\multidistri\distri_reporte_general_total2.php - QUERY 2 */ SELECT *
	FROM agencia ag
    ...
    if (isset($_POST['fecha_inicio']) && isset($_POST['fecha_fin'])) {
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_agencia']!="todos") {
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 new\multidistri\distri_reporte_general_total2.php - QUERY 3 */ SELECT *
					FROM agencia ag
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 new\multidistri\distri_reporte_general_total2.php - QUERY 4 */ SELECT ag.cod_agencia, ag.nom_agencia
	FROM agencia ag
	WHERE ag.cod_banca = %s
	ORDER BY ag.nom_agencia ASC",
    GetSQLValueString($_SESSION['MM_cod_banca'], "int")
...
<div class="container">
  ...
  <div style="height:100%; font-size:26px; padding:0px 0px 100px 0px ">
       ...
       <div style="background: #FFF; width:1115px; float:left; padding:5px 0px 0px 10px;
       ...
       <div style="background: #333; width:1115px; float:left; padding:12px 13px 2px 12px;color:#FFF; font-size:20px;">
       	GANANCIA Y TOTAL A PAGAR POR EL SISTEMA DISTRIBUIDOR AMERICANAS - NACIONALES<br/><br/>
       </div>
	   <div>
		<table width:1115px; border="0" style="color:#000; font-size:12px;" cellpadding="0" cellspacing="0">
			<tr style="font-size:16px" valign="middle" align="center">
				...
				<td width="33%" colspan="-2" bgcolor="#333" style="color:#FFF"><br/>
                    AMERICANAS: <?php echo number_format($row_Recordset12['por_banca'], 2, ",", ".")."%<br/>"; ?>
                    NACIONALES: <?php echo number_format($row_Recordset12['cob_banca_hnac'], 2, ",", ".").""; ?>
				</td>
   ...
   <div style="background:#CCC; width:1115px; float:left; padding:12px 13px 0px 12px;
   ...
   <div id="mostrar" style="width:99.7%; float:left; padding:0px 0px 150px 3px; background: #CCC">
           ...
           if ($totalRows_Recordset3>0) {
               do {
                   ...
                   $porcentaje=$row_Recordset3['por_agencia'];
                   $cob_agencia_hnac=$row_Recordset3['cob_agencia_hnac']; ?>
       			<table width:1115px; border="0" style="color:#000; font-size:11px" bordercolor="#F5F5F5" cellpadding="0" 
                	cellspacing="0">
           ...
           <td width="11%">TAQUILLA</td>
            ...
            <td width="29%">TOTAL A COBRAR Al<br/> TAQUILLA AMERICANA (%)<br/> NACIONALES(X) TOTAL ( )</td>
                    ...
                    $query_Recordset30 = sprintf(
                       "/* PARSEADORES1 new\multidistri\distri_reporte_general_total2.php - QUERY 5 */ SELECT cod_taquilla, nom_taquilla
						FROM taquilla
						WHERE cod_agencia = %s
                   ...
                   if ($totalRows_Recordset30>0) {
                       do {
                           ...
                           $query_Recordset1 = sprintf(
                               "/* PARSEADORES1 new\multidistri\distri_reporte_general_total2.php - QUERY 6 */ SELECT
                           ...
                           $query_Recordset21 = sprintf(
                               "/* PARSEADORES1 new\multidistri\distri_reporte_general_total2.php - QUERY 7 */ SELECT
								ta.cod_taquilla, ta.nom_taquilla, ag.cob_agencia_hnac,
                           ...
                           $query_Recordset22 =  sprintf(
                               "/* PARSEADORES1 new\multidistri\distri_reporte_general_total2.php - QUERY 8 */ SELECT cob_taquilla_hnac
								FROM  
...
<?php
                   ...
                   $totalPagarSistemaN=$tPuntosAg*$cob_agencia_hnac;
                   ...
                   $tPuntosBa=$tPuntosBa+$tPuntosAg; ?>  
                    ...
                    NACIONALES: <?php echo number_format($cob_agencia_hnac, 2, ",", "."); ?>
                   </div>
      			   <div id="costo1" style="width:1115px; float:left; padding:0px 0px 0px 0px">
               ...
               $cobroaBanca=($totGenBanca*$row_Recordset12['por_banca'])/100;
               $cobroaBancaN=$row_Recordset12['cob_banca_hnac']*$tPuntosBa;
               $costosistema=$cobroaBanca+$cobroaBancaN;
               $ganBanca1=$totCobraBanca+$totCobraBancaN;
               $ganBanca=$ganBanca1-$costosistema; ?>
                <HR/>
	    <div style="background:#7DCEA0; width:1115px; float:left; padding:12px 13px 2px 12px;font-size:20px; color:#000">
		   ...
		   <?php
           		...
           		<table width:1115px; border="1" style="color:#000; font-size:16px" bordercolor="#F5F5F5">
                    <tr align="left">
