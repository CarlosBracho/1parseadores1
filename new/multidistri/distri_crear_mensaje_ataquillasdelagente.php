...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\multidistri\distri_crear_mensaje_ataquillasdelagente.php - QUERY 1 */ INSERT 
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 new\multidistri\distri_crear_mensaje_ataquillasdelagente.php - QUERY 2 */ SELECT agencia.cod_agencia, agencia.nom_agencia 
		FROM
			banca, 
			agencia,
      multidistriMD
