...
if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
    if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
        ...
        $query_Recordset4 =  sprintf(
            "/* PARSEADORES1 new\multidistri\taquillas_add.php - QUERY 1 */ SELECT  
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==30) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 new\multidistri\taquillas_add.php - QUERY 2 */ INSERT 
				INTO taquilla 
...
taq_cob_hnac,
        ...
        $query_RecT = "/* PARSEADORES1 new\multidistri\taquillas_add.php - QUERY 3 */ SELECT cod_taquilla FROM taquilla ORDER BY cod_taquilla DESC LIMIT 1";
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 new\multidistri\taquillas_add.php - QUERY 4 */ INSERT 
		INTO usuario 
...
/*/
        ...
        $insertGoTo = "../multidistri/taquillas_edit.php?recordID=".$codTaquilla;
...
$query_Recordset2 = sprintf(
  "/* PARSEADORES1 new\multidistri\taquillas_add.php - QUERY 5 */ SELECT * 
    FROM 
      agencia, 
      banca,
      multidistriMD 
...
$query_Recordset3 = "/* PARSEADORES1 new\multidistri\taquillas_add.php - QUERY 6 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
        	...
        	<div style="width:100%; text-align:left; font-size:18px; background: #E1E1E1">
              ...
              <table width="919" align="center" border="0" cellpadding="0" cellspacing="0" style="line-height:14px">
                ...
                <tr valign="baseline">
                  ...
                  <td colspan="2" align="left" valign="middle" nowrap>Asignar a Agente:<font color="red">***</font><br>
