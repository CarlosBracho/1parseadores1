...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\multidistri\taquillas_edit.php - QUERY 1 */ SELECT
ta.taq_vende_ame,
ta.taq_por_ame,
ta.taq_vende_parley,
ta.taq_por_parley,
...
$query_Recordset94 =  sprintf(
  "/* PARSEADORES1 new\multidistri\taquillas_edit.php - QUERY 2 */ SELECT
ba.sinoclavesdistri,
ba.sinomonedadistri
FROM  taquilla ta, 
      banca ba,
...
$est_taquilla=$row_Recordset1['est_taquilla']/1;
    ...
    $taq_cob_hnac=$row_Recordset1['taq_cob_hnac']/1;
        ...
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 new\multidistri\taquillas_edit.php - QUERY 3 */ SELECT * FROM usuario 
	WHERE tip_usuario='U' 
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\multidistri\taquillas_edit.php - QUERY 4 */ UPDATE taquilla 
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\multidistri\taquillas_edit.php - QUERY 5 */ SELECT ta.cod_taquilla, ta.nom_taquilla
...
?>
    ...
    echo "SELECTED";
                    ...
                    onKeyUp="return handleEnter(this, event)" tabindex="8" required max="100"/>
                  	%
										     <br/> <a href='../multidistri/taquillas_edit_ame.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'class="btn btn-info"> EDITAR MODULO <br/>HIPISMO INTERNACIONAL</a>
    ...
    echo "SELECTED";
                    ...
                    onKeyUp="return handleEnter(this, event)" tabindex="8" required max="100"/>
										     <br/> <a href='../multidistri_hnac/distri_taquillas_edit_hnac.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'class="btn btn-info"> EDITAR MODULO <br/>HIPISMO NACIONAL</a>
