...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 new\multidistri\agencias_edit.php - QUERY 1 */ UPDATE agencia 
...
agen_vende_hnac=%s,
agen_cob_hnac=%s,
				por_agencia_lot=%s, por_agencia_macu=%s, est_agencia=%s, sinomoneda=%s 
				WHERE cod_agencia=%s",
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\multidistri\agencias_edit.php - QUERY 2 */ SELECT
	agencia.nom_agencia,
	agencia.cod_banca,
...
$query_Recordset11 = sprintf(
    "/* PARSEADORES1 new\multidistri\agencias_edit.php - QUERY 3 */ SELECT * FROM usuario 
	WHERE tip_usuario='G' 
...
$query_Recordset94 =  sprintf(
  "/* PARSEADORES1 new\multidistri\agencias_edit.php - QUERY 4 */ SELECT
agencia.sinomoneda
FROM  
agencia
WHERE 
