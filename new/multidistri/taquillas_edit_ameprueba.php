...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 new\multidistri\taquillas_edit_ameprueba.php - QUERY 1 */ SELECT  
...
$query_Recordset4 =  sprintf(
    "/* PARSEADORES1 new\multidistri\taquillas_edit_ameprueba.php - QUERY 2 */ SELECT  
...
if ($totalRows_Recordset4==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            ...
            $query_Recordset4 =  sprintf(
                "/* PARSEADORES1 new\multidistri\taquillas_edit_ameprueba.php - QUERY 3 */ SELECT  
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        curl_close ($ch);
                ...
                $insertSQL2 = sprintf(
                    "/* PARSEADORES1 new\multidistri\taquillas_edit_ameprueba.php - QUERY 4 */ INSERT 
					INTO bitacora 
        ...
        if ($_POST['existe']==1) {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 new\multidistri\taquillas_edit_ameprueba.php - QUERY 5 */ UPDATE taquilla_opc_ame
					SET
					pag_codigo=%s, 
					apu_maxgan=%s, 
					apu_maxpla=%s, 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 new\multidistri\taquillas_edit_ameprueba.php - QUERY 6 */ SELECT  
tp.apu_mingan
	...
	LIMIT 1",
            ...
            if ($apuestasminimaausar > $row_Recordset22['apu_mingan']) {
                $insertSQL11 = sprintf(
                    "/* PARSEADORES1 new\multidistri\taquillas_edit_ameprueba.php - QUERY 7 */ UPDATE taquilla_opc_ame
					SET
					apu_mingan=%s
            ...
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 new\multidistri\taquillas_edit_ameprueba.php - QUERY 8 */ INSERT 
			INTO 
			taquilla_opc_ame 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 new\multidistri\taquillas_edit_ameprueba.php - QUERY 9 */ SELECT  
tp.apu_mingan
	FROM  taquilla_opc_ame tp 
	WHERE tp.cod_taquilla = %s
	LIMIT 1",
            ...
            if ($apuestasminimaausar > $row_Recordset22['apu_mingan']) {
                $insertSQL11 = sprintf(
                    "/* PARSEADORES1 new\multidistri\taquillas_edit_ameprueba.php - QUERY 10 */ UPDATE taquilla_opc_ame
					SET
					apu_mingan=%s
					WHERE cod_taquilla=%s",
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 new\multidistri\taquillas_edit_ameprueba.php - QUERY 11 */ SELECT ta.cod_taquilla, ta.nom_taquilla
