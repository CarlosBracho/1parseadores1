...
$query_Recordset6 = sprintf("/* PARSEADORES1 new\ventas\index.php - QUERY 1 */ SELECT 
	tp.est_venta_ame
...
$query_Recordset4 = "/* PARSEADORES1 new\ventas\index.php - QUERY 2 */ SELECT * FROM mensaje WHERE cod_mensaje = 1";
...
$query_Recordset5 = sprintf(
    "
/* PARSEADORES1 new\ventas\index.php - QUERY 3 */ SELECT * FROM usuario, taquilla, taquilla_opc_ame, agencia,
			banca
...
$query_Recordset7 = sprintf("/* PARSEADORES1 new\ventas\index.php - QUERY 4 */ SELECT * FROM ctrol_ventpag_global_ame WHERE cod_ctrol_ventpag_global_ame =1");
...
$query_Recordset44 = sprintf("/* PARSEADORES1 new\ventas\index.php - QUERY 5 */ SELECT 
	me.mensaje
...
if ($info["version"]<=9 & $info["browser"]=='IE') {
    if ($info["version"]>=8 & $info["browser"]=='IE') {
        ?>
...
<?php if ($moneda==10) {
        ...
        for ($i = 1; $i <= 4; $i++) {
            if ($i == 1) {?>
                         ...
                         style="width:25px" maxlength="2" value="" id="<?php echo "numCa2".$i; ?>"/>
                         ...
                         style="width:25px" maxlength="2" value="" id="<?php echo "numCa3".$i; ?>"/>
                         ...
                         style="width:25px" maxlength="2" value="" id="<?php echo "numCa4".$i; ?>"/> -
                         ...
                         style="width:73px; font-size:17px" maxlength="9"  value="" id="<?php echo "monGan".$i; ?>"/>
                         ...
                         style="width:73px; font-size:17px" maxlength="9" value="" id="<?php echo "monPla".$i; ?>"/>
                         ...
                         style="width:73px; font-size:17px" maxlength="9" value="" id="<?php echo "monSho".$i; ?>"/>
					    </div><!-- end .apuesta -->		
                        <?php
                            $x=$x+7;
        } ?>
...
<div id="selecionclientes" ></div>		
                ...
                <div id="derecha" style="margin:0px 0px 0px 1.9px;font-size:16px;width:44.8%;float:left; background:#e0e0e0;
                	border-radius:10px 10px 0px 0px; border-left-width:thin; height:190px">
				                <div id="ultimajugada" style="background:#e0e0e0;float:right;height:120px;width:99.5%; padding:3px 0px 0px 0px;
...
<?php } ?>
                    ...
                    <div id="pagarapuesta" style="font-size:16px; height:100%; width:99%; float:left; text-align:left; 
                    	text-align:center; padding:0px 0px 49px 10px; line-height:80px; position: relative;">
                        <form method="post" id="form2">
                            <div id="pagaTicket" style="height:30px; width:99%; float:left; padding:35px 0 0 0">
            ...
            echo 'disabled="disabled"';
                  ...
                  <div id="mensajeChat" style="font-size:16px; height:177px; width:100%; float:left; 
                        ...
                        <form method="post" id="form3">
                            <div id="enviarChat" style="font-size:18px; height:260px; width:89.6%; float:left; text-align:left; 
                                ...
                                style="width:100%; height:50px; overflow: auto;resize:none; border: 1px solid #888; font-size:12px;
                                font-family: Arial, Helvetica, sans-serif;"></textarea>
                            </div><!-- end .Chat -->
                            <div id="enviarBoton" style="font-size:14px; height:50px; width:98px; float:left; text-align: center; 
				...
				<div id="infoticket" style="background:#A0A0A0;float:right;height:90px;width:49.5%; padding:3px 0px 0px 0px;
                	margin:0px 0px 0px 0px;border-radius:0px 5px 0px 0px;border-right-width: thin;border-right-style: solid;
                    border-bottom-style: solid;border-bottom-width: thin; border-right-color: #CCC; border-bottom-color: #CCC;
                    font-size:13px; line-height:10px;">
				</div>                                       
				<div id="infocarreras" style="background:#A0A0A0;float:right;height:90px; width:50%; padding:3px 0px 0px 0px; 
...
<?php
        ...
        echo 'Su versión de internet Explorer no es compatible con esta taquilla será direccionado a una compatible en 7 segundos.'; ?>

		<meta http-equiv="refresh" content="7; url=../ventasmie/index.php">
		<?php
    }
} else {
    ?>
...
$(function(){
	$("#barra").click(function(){
		//alert('qwqwqwqw')
    var url = 'ventas_pagar_apuestas_procesar.php';
$.post( url,  $( "#formbarra" ).serialize() )
  .done(function( data ) {
...
function mybarra() {
  var x = document.getElementById("pagoSINb");
  var x2 = document.getElementById("pagoSINb").value;
  var xnumero = x2.length;
  var x3 = document.getElementById("uVentab").value;
  var xnumero3 = x3.length;
  //alert(xnumero)
  if((xnumero-xnumero3)>=8){
	var url = 'ventas_pagar_apuestas_procesar.php';
$.post( url,  $( "#formbarra" ).serialize() )
  .done(function( data ) {
    $("#dialog-message").html(data);
...
<div class="col-sm-12 order-1  border border-primary" style="padding: 0;">


  <div class="container-fluid" style="padding: 0;font-size:160%;">
  <?php include('../ventas/menutah.php'); ?>
</div>
</div>


<div class="col-sm-4 order-2  border border-primary" style=" font-size:16px;">
TAQUILLA DE VENTAS <br>
                <!-- InstanceBeginEditable name="nTaquilla" -->
                <?php echo ' '.strtoupper($row_Recordset5['nom_taquilla']); ?>
                <!-- InstanceEndEditable -->
</div>
<div class="col-sm-4 order-3  border border-primary" style=" font-size:16px;">
HIPISMO INTERNACIONAL<br>
<?php if ($row_Recordset5['tipo_pago']==1) {?>
...
<div class="col-sm-4 order-4  border border-primary" style=" font-size:16px;">
<?php
$fechad=vfechaActual();
    echo substr($fechad, 0, -8)."<br>"; ?><span id="reloj"></span>


</div>
    <div class="col-sm-12 order-5  table-responsive  border border-primary">
  <div class="row">
    <div id="info1" class="col" style=" font-size:20px; color:#ff1a00;font-weight: bold"><?php echo $mensaje1; ?></div>
    <div class="w-100"></div>
    <div id="info2" class="col"  style=" font-size:20px; color:#F90;font-weight: bold"><?php echo $mensaje2; ?></div>
...
<!-- end .info -->
    ...
    <div class="col-sm-7 order-6  table-responsive border border-primary" style="padding: 0;">
	<form method="post" id="formulario" name="formulario" onSubmit="return enviado()" autocomplete="off">
...
<button type="button" class="btn btn-dark  btn-sm "  style="height:40px; width:550px;">Cantidad de tickets creados:<a id="mon_canticket"></a></button>
</td>

</tr>

<tr>
<td colspan="6" HEIGHT="20"  class="" style="" >
...
<td colspan="6" align="center" class="" style="height:40px;padding: 0;">&nbsp;&nbsp;&nbsp;
<button type="button" class="btn btn-light" style="height:40px; width:170px;">EJEMPLAR</button>
<button type="button" class="btn btn-light" style="height:40px; width:75px;">GAN</button>
<button type="button" class="btn btn-light" style="height:40px; width:75px;">PLA</button>
<button type="button" class="btn btn-light" style="height:40px; width:75px;">SHW</button>
</td>
</tr>
<tr>
<td colspan="6" align="center" class="" style="padding: 0;">
<?php
$x=1;
    for ($i = 1; $i <= 4; $i++) {?>
...
<input class="text rounded" tabindex="<?php echo $x;?>" type="text" 
onKeyDown="return handleEnter(this, event)" name="<?php echo "numCa1".$i;?>" 
style="width:30px; font-size:16px" maxlength="2" value="" id="<?php echo "numCa1".$i;?>" />

<input class="text rounded" tabindex="<?php echo $x+1;?>" type="text" 
onKeyDown="return handleEnter(this, event)" name="<?php echo "numCa2".$i;?>" 
style="width:30px; font-size:16px" maxlength="2" value="" id="<?php echo "numCa2".$i;?>"/>

<input class="text rounded" tabindex="<?php echo $x+2;?>" type="text" 
onKeyDown="return handleEnter(this, event)" name="<?php echo "numCa3".$i;?>"
style="width:30px; font-size:16px" maxlength="2" value="" id="<?php echo "numCa3".$i;?>"/>

<input class="text rounded" tabindex="<?php echo $x+3;?>" type="text" 
onKeyDown="return handleEnter(this, event)" name="<?php echo "numCa4".$i;?>"
style="width:30px; font-size:16px" maxlength="2" value="" id="<?php echo "numCa4".$i;?>"/>



<input class="text rounded" tabindex="<?php echo $x+4;?>" type="text" 
onKeyDown="return handleEnter(this, event)" name="<?php echo "monGan".$i; ?>"
style="width:95px; font-size:16px" maxlength="9" value="" id="<?php echo "monGan".$i;?>"/>

<input class="text rounded" tabindex="<?php echo $x+5;?>" type="text" 
onKeyDown="return handleEnter(this, event)" name="<?php echo "monPla".$i; ?>" 
style="width:95px; font-size:16px" maxlength="9" value="" id="<?php echo "monPla".$i;?>"/>

<input class="text rounded" tabindex="<?php echo $x+6;?>" type="text" 
onKeyDown="return handleEnter(this, event)" name="<?php echo "monSho".$i; ?>"
style="width:95px; font-size:16px" maxlength="9" value="" id="<?php echo "monSho".$i;?>"/>
...
<tr>
<td colspan="6" font-size:25px align="center"  class="" style=" padding: 0;">
<input type="button"  class="btn btn-success rounded" id="imprimir" name="imprimir"  style="height:50px" onClick="return enviado(); imprimeTicket();" 
...
<tr>
<td colspan="6" font-size:30px align="center" style=" padding: 0;">
<input type="button" class="btn btn-primary  rounded" onclick="window.location='index.php';"
...
<input type="hidden" name="MM_insert" value="form1" />
    ...
    <div class="col-sm-5 order-7 border border-primary"   style="padding: 0; ">
	<div id="ultimajugada" >
	...
	<div><br>
	<?php if ($cod_barra==1) { ?>
		<form  id="formbarra" name="formbarra" autocomplete="off">
	<input  class="form-control" id="pagoSINb" name="pagoSINb" onkeyup="mybarra()" placeholder="Codigo De Barra" value="">
  
  

  <input type="button"   class="btn btn-success btn-sm"  id="barra" name="barra"
  data-toggle="modal" data-target="#exampleModal" onClick="return enviado();" value="PROCESAR COD BARRA" hidden="true" />
<input type="hidden" name="uVentab" id="uVentab" value="<?php echo $usuarioVenta; ?>" />
</form>
<?php } ?>
                    ...
                    <div id="pagarapuesta" style="font-size:16px; height:100%; width:99%; float:left; text-align:left; 
                        ...
                        <form method="post" id="form2">
                            <div id="pagaTicket" style="height:30px; width:99%; float:left; padding:35px 0 0 0">
                            	<input type="submit"  class="btn btn-success  btn-sm" id="buttonverde" value="ir a Pagar apuesta" 
                                title="paga apuesta" onclick="javascript:window.open('../ventasmie/pag_tic_sincodigo.php?uVenta=<?php echo $usuarioVenta?>', '_blank');" <?php if ($est_control_pagos==1) {
        echo 'disabled="disabled"';
    } ?>/>
                            </div><br><br>
                            <div id="eliminaTicket" style="height:50px; width:99%; float:left; padding:30px 0px 0px 0px;">
                            	<input type="submit" class="btn btn-danger  btn-sm" id="buttonrojo" value="ir a Eliminar ticket" title="elimina apuesta" 
                                onclick="javascript:window.open('../ventasmie/eli_tic_sincodigo.php?uVenta=<?php echo $usuarioVenta?>', '_blank');"/>
                            </div>
                            <input type="hidden" name="id_usuario_pago" value="<?php echo $usuarioVenta; ?>" />
                        </form>
                        <div id="pagamensaje" style="font-size:16px; height:100px; width:95%; float:left; color:#CC0000; 
                        position: absolute; text-align:left; text-align:center; margin:-20px 0px 0px 0px; line-height:10px;
                        background:#ddebef; display:none; padding:10px 0px 0px 0px ">
                        </div>
                  </div>
	</div>
	<br><br>
...
<div class="col-sm-12 order-8   border border-primary"   style="padding: 0;">
  ...
  <div id="mensajeChat" style="font-size:16px; height:177px; width:100%; float:left; 
                        ...
                        <div id="membreteChat" style="font-size:14px; height:35px; width:100%; float:left; text-align:left; 
                    		padding:5px 0px 0px 0px; color: #FFF; background:#23528c; border-top-style: 
                        	solid;border-top-width: thin; border-top-color: #FFF;">
                            &nbsp;&nbsp;Por favor, ante cualquier duda o inconveniente envÃƒÂ­enos un mensaje por este medio,
                             serÃƒÂ¡ respondido en breve
                        </div><!-- end .membreteChat -->
						<br>
                        <div id="Chat" style="font-size:14px; height:90px; width:100%; float:left; text-align:left; 
                    		padding:0px 0px 0px 0px; background: #FFF; margin:0px 0px 0px 0px; overflow: auto;
                            position: relative;z-index: 0;" onmouseover="stopChat()" onmouseout="startChat()">
	                            <?php include("ventas_chat_mostrar.php"); ?>
                        </div><!-- end .Chat -->
  ...
  <tr><td width="80%">
                                ...
                                <textarea id="txtMensaje"  class="form-control " name="txtMensaje" placeholder="ESCRIBA SU MENSAJE AQUI" 
                                style="width:100%; height:50px; overflow: auto;resize:none; border: 1px solid #888; font-size:12px;
                                font-family: Arial, Helvetica, sans-serif;"></textarea>
</td><td width="20%">
                                <input name="enviarChatBoton"  class="btn btn-success" id="enviarChatBoton" 
								style="width:100%; float:left; border: 1px solid #888;  height:50px;"
                                    tabindex="<?php echo $x; ?>" 
                                    value="ENVIAR"/>
...
<!-- end .mensajeChat -->    
	...
	<div class="col-sm-6 order-9  border border-primary "  style="padding: 0;">
	<div id="infocarreras" style="background:#A0A0A0;float:right;height:120px; width:100%; padding:0px 0px 0px 0px; 
                	margin:0px 0px 0px 0px; border-radius:0px 0px 0px 0px; border-left-style: solid; border-left-width: thin;
                    border-bottom-style:solid;border-bottom-width: thin; border-right-width: thin;border-right-style: solid;
                    border-right-color:#CCC;border-bottom-color:#CCC;border-left-color:#CCC;font-size:12px;line-height:15px;">
				</div> 

    </div>
	<div class="col-sm-6 order-10   border border-primary"    style="padding: 0;">
	<div id="infoticket"   style="background:#A0A0A0;float:right;height:120px; width:100%; padding:0px 0px 0px 0px; 
                	margin:0px 0px 0px 0px; border-radius:0px 0px 0px 0px; border-left-style: solid; border-left-width: thin;
                    border-bottom-style:solid;border-bottom-width: thin; border-right-width: thin;border-right-style: solid;
                    border-right-color:#CCC;border-bottom-color:#CCC;border-left-color:#CCC;font-size:12px;line-height:15px;">
				</div> 
    </div>
	<div class="col-sm-12 order-11   border border-primary  bg-primary">
	---
	</div> 
	<div id="divImprime" style="display:none;">
		    </div>
