...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\ventas\ventas_revistaticket.php - QUERY 1 */ SELECT 
venta.fec_venta, 
venta.hor_venta,
venta.ser_venta,
venta.can_ticket,
...
if ($horacarrerabd >= horaactual() && $row_Recordset1['fec_venta']==fechaactualbd() && $totalRows_Recordset1>0 &&
    ...
    if ($rimp==1 && $row_Recordset1['rei_ticket']==0) {
        if ($conte==1) {
            $insertSQL = sprintf(
                "/* PARSEADORES1 new\ventas\ventas_revistaticket.php - QUERY 2 */ INSERT 
					INTO reimpresion 
            ...
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 new\ventas\ventas_revistaticket.php - QUERY 3 */ UPDATE reimpresion 
					SET can_actual=%s
        ...
        $insertSQL2 = sprintf(
            "/* PARSEADORES1 new\ventas\ventas_revistaticket.php - QUERY 4 */ UPDATE venta 
				SET rei_ticket=%s
				WHERE num_ticket=%s",
            GetSQLValueString(1, "int"),
