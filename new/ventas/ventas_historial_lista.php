...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && isset($_POST['fecha_inicio'])) {
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\ventas\ventas_historial_lista.php - QUERY 1 */ SELECT * FROM carrera 
		WHERE 
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\ventas\ventas_historial_lista.php - QUERY 2 */ SELECT * FROM carrera 
		WHERE 
			carrera.est_confirmacion=0 AND 
			carrera.fec_carrera = %s 
		ORDER BY carrera.hor_carrera DESC",
