...
$query_Recordset4 =  sprintf(
    "/* PARSEADORES1 new\ventas\ventas_ver_opciones_ame.php - QUERY 1 */ SELECT  
...
<?php } ?>
  ...
  <div class="table-responsive">
        <table class="table" width="920" align="center" border="0"  style="line-height:12px" cellpadding="0" cellspacing="0">
