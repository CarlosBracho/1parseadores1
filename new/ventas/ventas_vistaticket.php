...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\ventas\ventas_vistaticket.php - QUERY 1 */ SELECT * FROM venta WHERE venta.ticket = %s ORDER BY venta.cod_tventa", GetSQLValueString($xTicket_Recordset1, "int"));
