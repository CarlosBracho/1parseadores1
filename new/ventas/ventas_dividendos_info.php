...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\ventas\ventas_dividendos_info.php - QUERY 1 */ SELECT *
FROM 
carrera 
WHERE 
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 new\ventas\ventas_dividendos_info.php - QUERY 2 */ SELECT * FROM retirados WHERE retirados.cod_carrera = %s",
    GetSQLValueString($xcarrera_Recordset1, "int")
);
