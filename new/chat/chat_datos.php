...
if ($_SESSION['MM_UserGroup'] == "A") {
    ...
    $query_Recordset105 = sprintf(
        "/* PARSEADORES1 new\chat\chat_datos.php - QUERY 1 */ SELECT ta.nom_taquilla, ta.cod_agencia 
			FROM 
				usuario us, 
				taquilla ta 
			WHERE 
    ...
    $query_Recordset105 = sprintf(
        "/* PARSEADORES1 new\chat\chat_datos.php - QUERY 2 */ SELECT ag.nom_agencia, ag.cod_banca, ag.cod_agencia
			FROM 
				usuario us, 
				agencia ag 
			WHERE 
    ...
    $query_Recordset105 = sprintf(
        "/* PARSEADORES1 new\chat\chat_datos.php - QUERY 3 */ SELECT ba.nom_banca, ba.cod_banca 
			FROM 
				usuario us, 
				banca ba
			WHERE 
