...
$query_Recordset18D =  sprintf(
    "/* PARSEADORES1 new\sincronizado\pruebaarray.php - QUERY 1 */ SELECT  
*
...
$query_RecordsetAE =  sprintf(
    "/* PARSEADORES1 new\sincronizado\pruebaarray.php - QUERY 2 */ SELECT
...
$query_RecordsetAJ =  sprintf(
    "/* PARSEADORES1 new\sincronizado\pruebaarray.php - QUERY 3 */ SELECT
...
$query_RecordsetLG =  sprintf(
    "/* PARSEADORES1 new\sincronizado\pruebaarray.php - QUERY 4 */ SELECT
...
//inicio array de juegos
$query_RecordsetAJ =  sprintf(
    "/* PARSEADORES1 new\sincronizado\pruebaarray.php - QUERY 5 */ SELECT
  Id_p2juegosp2, idequipo1p2, idequipo2p2, deportep2, competicionp2, iniciodtp2
  FROM  
  p10juegos
  WHERE 
...
$query_RecordsetLG =  sprintf(
    "/* PARSEADORES1 new\sincronizado\pruebaarray.php - QUERY 6 */ SELECT
  Id_p3logrosp3, idjuegop3, equipop3, tipojugadap3, logroABoRLp3, logrop3
  FROM  
  p10logros
  WHERE logrodtp3 >= %s AND actxp3 = 1 AND Id_p3logrosp3 >= 0 ORDER BY Id_p3logrosp3 ASC",
...
if($yaestajuego==0){ echo 'se creara el juego<br>'; 
  ...
  if($row_Recordset18D['Swicht']==1){
$insertSQL = sprintf(
"/* PARSEADORES1 new\sincronizado\pruebaarray.php - QUERY 7 */ INSERT 
INTO p2juegos
...
$Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
  ...
  $insertSQL = sprintf(
    "/* PARSEADORES1 new\sincronizado\pruebaarray.php - QUERY 8 */ INSERT 
    INTO p10juegos
    (idequipo1p2, idequipo2p2, deportep2, competicionp2, iniciodtp2) 
    VALUES (%s, %s, %s, %s, %s)",
        GetSQLValueString($yaestaequipo1cod, "int"),
...
if($yaestajuego==1 && $yaestajuegohorajuego==1){ echo 'se actualiza hora del juego<br>'; 
  ...
  if($row_Recordset18D['Swicht']==1){
    ...
    $insertSQL24 = sprintf(
      "/* PARSEADORES1 new\sincronizado\pruebaarray.php - QUERY 9 */ UPDATE p2juegos 
SET iniciodtp2=%s			
WHERE 
Id_p2juegosp2 = %s", 
  ...
  $Result24 = mysqli_query($conexionbanca, $insertSQL24);
    ...
    $insertSQL24 = sprintf(
      "/* PARSEADORES1 new\sincronizado\pruebaarray.php - QUERY 10 */ UPDATE p10juegos 
SET iniciodtp2=%s			
WHERE 
Id_p2juegosp2 = %s", 
