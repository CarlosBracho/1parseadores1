...
$query_Recordset13 = sprintf(
  "/* PARSEADORES1 new\sincronizado\sellatuparleyresultados.php - QUERY 1 */ SELECT *
  FROM p2juegos
  WHERE
  iniciodtp2 >= %s AND 
  iniciodtp2 <= %s
  ...
  do {
    $query_Recordset14 = sprintf(
      "/* PARSEADORES1 new\sincronizado\sellatuparleyresultados.php - QUERY 2 */ SELECT *
      FROM p5resultadosj
      WHERE
      iniciodtp5 >= %s AND 
      iniciodtp5 <= %s AND 
...
$query_Recordset21 = sprintf(
  "/* PARSEADORES1 new\sincronizado\sellatuparleyresultados.php - QUERY 3 */ SELECT *
  FROM p1equipos
  WHERE  
  ...
  $query_Recordset22 = sprintf(
    "/* PARSEADORES1 new\sincronizado\sellatuparleyresultados.php - QUERY 4 */ SELECT *
    FROM p1equipos
    WHERE  
