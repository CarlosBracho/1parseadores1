...
elseif( $data==="" ) {
    echo "<h3>Please enter data to be encoded, /* PARSEADORES1 new\sincronizado\Grafico_src\barcode\demoapp\barcode_image.php - QUERY 1 */ select symbology and press 'Ok'.</h3>";
