    ...
    <div class="container">
		<div class="header" style="height:130px; background:#333">
            ...
            <div id="menu" style="height:50px; padding:0px 0px 0px 50px; margin:-10px 0px 0px 0px">
      			<div class="triangulo_sup_nacional" style="margin:0px 0px 0px 75px;"></div>
                <div style="background: #0072C6; margin:0px 0px 0px 0px; padding:0px 20px 5px 20px; word-spacing: normal;
                    position:absolute;border-radius: 0px 0px 5px 5px;">
                    <?php include("../includes/cabeceraventas_nacional.php");?>        	
                </div>
            </div> <!-- end .menu -->
		</div> <!-- end .header -->
