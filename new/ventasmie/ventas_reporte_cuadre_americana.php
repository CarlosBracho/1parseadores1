...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\ventasmie\ventas_reporte_cuadre_americana.php - QUERY 1 */ SELECT * 
FROM 
agencia, 
taquilla,
taquilla_opc_ame, 
    ...
    if (isset($_POST['fecha_inicio']) && isset($_POST['fecha_fin'])) {
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_usuario']!="todos") {
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\ventasmie\ventas_reporte_cuadre_americana.php - QUERY 2 */ SELECT * 
				FROM 
				agencia, 
				taquilla,
				taquilla_opc_ame, 
...
USE INDEX(id_us_fe_fe)
                ...
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 new\ventasmie\ventas_reporte_cuadre_americana.php - QUERY 3 */ SELECT * 
				FROM 
				agencia, 
				taquilla,
				taquilla_opc_ame, 
...
$query_Recordset2 = sprintf("/* PARSEADORES1 new\ventasmie\ventas_reporte_cuadre_americana.php - QUERY 4 */ SELECT * FROM usuario 
