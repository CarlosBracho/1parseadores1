...
function ObtenerMontoEjeTaq($codT, $fecV, $numE, $codC, $codA)
{
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\ventasmie\t_grabajugadahipicoticket.php - QUERY 1 */ SELECT 
...
$query_Recordset7 = sprintf("/* PARSEADORES1 new\ventasmie\t_grabajugadahipicoticket.php - QUERY 2 */ SELECT est_control_ventas_ame FROM ctrol_ventpag_global_ame WHERE cod_ctrol_ventpag_global_ame = 1");
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1" && isset($_POST["cod_carrera"]) && $_POST["cod_carrera"]!=-1 && $est_control_ventas==0) {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\ventasmie\t_grabajugadahipicoticket.php - QUERY 3 */ SELECT can_caballos, hor_carrera, fec_carrera, est_carrera, pau_ventas
								 FROM carrera
								 WHERE cod_carrera = %s 
								 LIMIT 1",
    ...
    $_POST["saldoactual"]=((int)$_POST["saldoactual"]/(int)1);
    ...
    $_POST["monGan1"]=((int)$_POST["monGan1"]/(int)1);
    $_POST["monPla1"]=((int)$_POST["monPla1"]/(int)1);
    $_POST["monSho1"]=((int)$_POST["monSho1"]/(int)1);
    $_POST["monGan2"]=((int)$_POST["monGan2"]/(int)1);
    $_POST["monPla2"]=((int)$_POST["monPla2"]/(int)1);
    $_POST["monSho2"]=((int)$_POST["monSho2"]/(int)1);
    $_POST["monGan3"]=((int)$_POST["monGan3"]/(int)1);
    $_POST["monPla3"]=((int)$_POST["monPla3"]/(int)1);
    $_POST["monSho3"]=((int)$_POST["monSho3"]/(int)1);
    $_POST["monGan4"]=((int)$_POST["monGan4"]/(int)1);
    $_POST["monPla4"]=((int)$_POST["monPla4"]/(int)1);
    $_POST["monSho4"]=((int)$_POST["monSho4"]/(int)1);
    $_POST["numCa11"]=((int)$_POST["numCa11"]/(int)1);
    $_POST["numCa21"]=((int)$_POST["numCa21"]/(int)1);
    $_POST["numCa31"]=((int)$_POST["numCa31"]/(int)1);
    $_POST["numCa41"]=((int)$_POST["numCa41"]/(int)1);
    $_POST["numCa12"]=((int)$_POST["numCa12"]/(int)1);
    $_POST["numCa22"]=((int)$_POST["numCa22"]/(int)1);
    $_POST["numCa32"]=((int)$_POST["numCa32"]/(int)1);
    $_POST["numCa42"]=((int)$_POST["numCa42"]/(int)1);
    $_POST["numCa13"]=((int)$_POST["numCa13"]/(int)1);
    $_POST["numCa23"]=((int)$_POST["numCa23"]/(int)1);
    $_POST["numCa33"]=((int)$_POST["numCa33"]/(int)1);
    $_POST["numCa43"]=((int)$_POST["numCa43"]/(int)1);
    $_POST["numCa14"]=((int)$_POST["numCa14"]/(int)1);
    $_POST["numCa24"]=((int)$_POST["numCa24"]/(int)1);
    $_POST["numCa34"]=((int)$_POST["numCa34"]/(int)1);
    $_POST["numCa44"]=((int)$_POST["numCa44"]/(int)1);
    ...
    if ($exito==1 && $pau_ventas==0) {// guarda e imprime ticket
        ...
        if ($valida==1 && $pau_ventas==0) {
            ...
            $query_Recordset55 = sprintf(
                "
/* PARSEADORES1 new\ventasmie\t_grabajugadahipicoticket.php - QUERY 4 */ SELECT 
...
tasadecambio.Idtasadecambio = %s",
        ...
        if ($valida==1 && $pau_ventas==0) {
            ...
            foreach ($apuesta as $apta) {
                ...
                $insertSQL = sprintf(
                    "/* PARSEADORES1 new\ventasmie\t_grabajugadahipicoticket.php - QUERY 5 */ INSERT INTO venta (ser_venta, ticket, cod_taquilla, fec_venta, hor_venta, cod_tventa,
                ...
                if ($tipo_pago==1) {
                    $insertSQL15 = sprintf(
                        "/* PARSEADORES1 new\ventasmie\t_grabajugadahipicoticket.php - QUERY 6 */ UPDATE taquilla 
				SET
                ...
                if ($tipo_pagoa==1) {
                    $insertSQL155 = sprintf(
                        "/* PARSEADORES1 new\ventasmie\t_grabajugadahipicoticket.php - QUERY 7 */ UPDATE agencia 
				SET
...
} else { imprimeTicketall(<?php echo $numerotiket2; ?>,<?php echo $exito; ?>); }
</script>
