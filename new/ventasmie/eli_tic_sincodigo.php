...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\ventasmie\eli_tic_sincodigo.php - QUERY 1 */ SELECT 
...
$hora1=$row_Recordset1['hor_venta'];
  ...
  <td align="center" valign="middle">
                        ...
                        value="Eliminar"
onclick="location.href = '../ventas/ventas_eliminar_ticket.php?pagoSIN=<?php echo $ticket2; ?>&uVenta=<?php echo $row_Recordset1['id_usuario']; ?>'"/>
                      </td>
			  		</tr><?php
                        $x1++;
