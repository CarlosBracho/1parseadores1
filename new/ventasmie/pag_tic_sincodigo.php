...
$query_Recordset1 = sprintf("/* PARSEADORES1 new\ventasmie\pag_tic_sincodigo.php - QUERY 1 */ SELECT  
...
$query_Recordset7 = sprintf("/* PARSEADORES1 new\ventasmie\pag_tic_sincodigo.php - QUERY 2 */ SELECT est_control_pagos_ame FROM ctrol_ventpag_global_ame WHERE cod_ctrol_ventpag_global_ame = 1");
