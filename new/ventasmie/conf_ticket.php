...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1" && (isset($_POST["aceptar"]) || isset($_POST["cancelar"]))) {
    if (isset($_POST["aceptar"])) {
        ...
        $query_Recordset1 = sprintf("/* PARSEADORES1 new\ventasmie\conf_ticket.php - QUERY 1 */ SELECT num_ticket 
			FROM venta 
        ...
        if ($totalRows_Recordset1>0) {
            do {
                ...
                $insertSQL2 = sprintf(
                    "/* PARSEADORES1 new\ventasmie\conf_ticket.php - QUERY 2 */ UPDATE venta
							SET 
							est_impresion=%s
							WHERE num_ticket=%s",
