...
$query_Recordset6 = sprintf("/* PARSEADORES1 new\apostador\internacionalesa.php - QUERY 1 */ SELECT 
	tp.est_venta_ame
...
$query_Recordset5 = sprintf(
    "
/* PARSEADORES1 new\apostador\internacionalesa.php - QUERY 2 */ SELECT * FROM usuario, taquilla, taquilla_opc_ame, agencia,
			banca
...
$query_Recordset7 = sprintf("/* PARSEADORES1 new\apostador\internacionalesa.php - QUERY 3 */ SELECT * FROM ctrol_ventpag_global_ame WHERE cod_ctrol_ventpag_global_ame =1");
...
$query_Recordset44 = sprintf("/* PARSEADORES1 new\apostador\internacionalesa.php - QUERY 4 */ SELECT 
	me.mensaje
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\apostador\internacionalesa.php - QUERY 5 */ SELECT 
* FROM 
carrera 
WHERE 
...
<button type="button" class="btn btn-outline-danger" onclick="ActivarCampoOtrohipodromo<?php echo $n ?>();"><?php echo $faltan; ?></button>
