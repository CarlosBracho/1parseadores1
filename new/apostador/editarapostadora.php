...
if (isset($_POST['telefono1'])) {
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 new\apostador\editarapostadora.php - QUERY 1 */ UPDATE taquilla 
				SET tel_taquilla=%s
    ...
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 new\apostador\editarapostadora.php - QUERY 2 */ UPDATE usuario 
				SET
				pas_usuario=%s
				WHERE id_usuario=%s",
    ...
    $insertSQL2 = sprintf(
        "/* PARSEADORES1 new\apostador\editarapostadora.php - QUERY 3 */ UPDATE taquilla_opc_ame
					SET
					apu_maxgan=%s, 
					apu_maxpla=%s, 
					apu_maxsho=%s, 
    ...
    $query_Recordset1 =  sprintf(
        "/* PARSEADORES1 new\apostador\editarapostadora.php - QUERY 4 */ SELECT  
*
