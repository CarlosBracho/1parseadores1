...
if (isset($_POST['tipo'])) {
    $query_Recordset13 = sprintf(
        "/* PARSEADORES1 new\apostador\modificarsaldoad.php - QUERY 1 */ SELECT MAX(Idbalancecli) 
    ...
    $query_Recordset14 = sprintf(
        "/* PARSEADORES1 new\apostador\modificarsaldoad.php - QUERY 2 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
        GetSQLValueString($_POST['moneda'], "int"),
    ...
    $query_Recordset12 = sprintf(
        "/* PARSEADORES1 new\apostador\modificarsaldoad.php - QUERY 3 */ SELECT MAX(numticket) 
					FROM balanceclientes
					WHERE 
					monedac = %s AND 
					tipo = %s AND 
    ...
    $insertSQL155 = sprintf(
        "/* PARSEADORES1 new\apostador\modificarsaldoad.php - QUERY 4 */ INSERT INTO balanceclientes  
...
VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
    ...
    //}
                            ...
                            $query_Recordset13 = sprintf(
                                "/* PARSEADORES1 new\apostador\modificarsaldoad.php - QUERY 5 */ SELECT MAX(Idbalancecli) 
					FROM balanceclientes
					WHERE monedac = %s AND 
					cod_taquilla = %s",
    ...
    $Idbalancecli0=((int)$row_Recordset13['MAX(Idbalancecli)']);
                            ...
                            $query_Recordset14 = sprintf(
                                "/* PARSEADORES1 new\apostador\modificarsaldoad.php - QUERY 6 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
                                GetSQLValueString(0, "int"),
    ...
    $saldoactualc0=((float)$row_Recordset14['saldoactualc']);
                                ...
                                $query_Recordset15 = sprintf(
                                    "/* PARSEADORES1 new\apostador\modificarsaldoad.php - QUERY 7 */ SELECT MAX(Idbalancecli) 
					FROM balanceclientes
					WHERE monedac = %s AND 
					cod_taquilla = %s",
                                    GetSQLValueString(3, "int"),
    ...
    $Idbalancecli3=((int)$row_Recordset15['MAX(Idbalancecli)']);
                            ...
                            $query_Recordset16 = sprintf(
                                "/* PARSEADORES1 new\apostador\modificarsaldoad.php - QUERY 8 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
                                GetSQLValueString(3, "int"),
    ...
    $saldoactualc3=((float)$row_Recordset16['saldoactualc']);
                                ...
                                $query_Recordset17 = sprintf(
                                    "/* PARSEADORES1 new\apostador\modificarsaldoad.php - QUERY 9 */ SELECT MAX(Idbalancecli) 
					FROM balanceclientes
					WHERE monedac = %s AND 
					cod_taquilla = %s",
    ...
    $Idbalancecli4=((int)$row_Recordset17['MAX(Idbalancecli)']);
                            ...
                            $query_Recordset18 = sprintf(
                                "/* PARSEADORES1 new\apostador\modificarsaldoad.php - QUERY 10 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
                                GetSQLValueString(4, "int"),
    ...
    $saldoactualc4=((float)$row_Recordset18['saldoactualc']);
                                ...
                                $query_Recordset19 = sprintf(
                                    "/* PARSEADORES1 new\apostador\modificarsaldoad.php - QUERY 11 */ SELECT MAX(Idbalancecli) 
					FROM balanceclientes
					WHERE monedac = %s AND 
					cod_taquilla = %s",
    ...
    $Idbalancecli5=((int)$row_Recordset19['MAX(Idbalancecli)']);
                            ...
                            $query_Recordset20 = sprintf(
                                "/* PARSEADORES1 new\apostador\modificarsaldoad.php - QUERY 12 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
                                GetSQLValueString(5, "int"),
