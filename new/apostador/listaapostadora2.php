...
$codigoAgente=37;
    ...
    $query_Recordset1 = "/* PARSEADORES1 new\apostador\listaapostadora2.php - QUERY 1 */ SELECT * FROM taquilla, agencia $where";
...
<html lang="es">
	...
	<body>
		...
		<!-- Modal -->
		<div class="modal fade" id="confirm-/* PARSEADORES1 new\apostador\listaapostadora2.php - QUERY 2 */ delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<a class="btn btn-danger btn-ok">/* PARSEADORES1 new\apostador\listaapostadora2.php - QUERY 3 */ Delete</a>
					</div>
				</div>
			</div>
		</div>
		...
		<script>
			$('#confirm-delete').on('show.bs.modal', function(e) {
				...
				$('.debug-url').html('/* PARSEADORES1 new\apostador\listaapostadora2.php - QUERY 4 */ Delete URL: <strong>' + $(this).find('.btn-ok').attr('href') + '</strong>');
			});
		</script>	
