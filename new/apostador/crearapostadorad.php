...
if (isset($_POST['username'])) {
    $insertSQL = sprintf(
        "/* PARSEADORES1 new\apostador\crearapostadorad.php - QUERY 1 */ INSERT 
				INTO taquilla 
...
moneda,
    ...
    $query_RecT = "/* PARSEADORES1 new\apostador\crearapostadorad.php - QUERY 2 */ SELECT cod_taquilla FROM taquilla ORDER BY cod_taquilla DESC LIMIT 1";
    ...
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 new\apostador\crearapostadorad.php - QUERY 3 */ INSERT 
		INTO usuario 
    ...
    $insertSQL2 = sprintf(
        "/* PARSEADORES1 new\apostador\crearapostadorad.php - QUERY 4 */ INSERT 
			INTO 
			taquilla_opc_ame 
    ...
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 new\apostador\crearapostadorad.php - QUERY 5 */ SELECT ag.cod_agencia, ag.nom_agencia,
ba.dist_vende_ame,
ba.dist_vende_hnac
      ...
      <li class="nav-item">
		...
		<div class="container">
			...
			<form class="form-horizontal" name="form1" method="POST" action="<?php echo $editFormAction; ?>" onsubmit="return chequearEnvio();">
					...
					<label for="nombre" class="col-sm-8 control-label">Seleccione Agente:</label>
					<div class="col-sm-4">
...
<div class="col-sm-4">
                    <select name="moneda" class="selectpicker" data-style="btn-danger" required>
