...
if (!isset($_SESSION['MM_id_usuario'])) {
    ...
    $id_usuarioO=0;
                            ...
                            $query_Recordset13 = sprintf(
                                "/* PARSEADORES1 new\apostador\reportec.php - QUERY 1 */ SELECT cod_taquilla
					FROM usuario
					WHERE
					id_usuario = %s",
    ...
    $totalRows_Recordset13 = mysqli_num_rows($Recordset13);
                    ...
                    $query_Recordset1 = sprintf(
                        "/* PARSEADORES1 new\apostador\reportec.php - QUERY 2 */ SELECT * 
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="internacionalesc.php">Apostar Hipismo Internacional</a>
      </li>
      <li class="nav-item">
        <a class="dropdown-item" href="reportec.php">Reporte General<span class="sr-only">(current)</span></a>
      </li>
	        <li class="nav-item">
         <a class="dropdown-item" href="dividendosyretirados.php">Dividendos y Retirados</a>
      </li>
	  	        <li class="nav-item">
         <a class="dropdown-item" href="../gacetas/retrospectosc.php">Retrospectos</a>
      </li>
      <li class="nav-item">
...
do {
    ?>
          <tr>
            ...
            <td><?php echo $row_Recordset1['numticket']; ?></td>
