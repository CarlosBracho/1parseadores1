...
$query_Recordset6 = sprintf("/* PARSEADORES1 new\apostador\internacionalesc3.php - QUERY 1 */ SELECT 
	tp.est_venta_ame
...
$query_Recordset4 = "/* PARSEADORES1 new\apostador\internacionalesc3.php - QUERY 2 */ SELECT * FROM mensaje WHERE cod_mensaje = 1";
...
$query_Recordset5 = sprintf(
    "
/* PARSEADORES1 new\apostador\internacionalesc3.php - QUERY 3 */ SELECT * FROM usuario, taquilla, taquilla_opc_ame, agencia,
			banca
...
$query_Recordset7 = sprintf("/* PARSEADORES1 new\apostador\internacionalesc3.php - QUERY 4 */ SELECT * FROM ctrol_ventpag_global_ame WHERE cod_ctrol_ventpag_global_ame =1");
...
$query_Recordset44 = sprintf("/* PARSEADORES1 new\apostador\internacionalesc3.php - QUERY 5 */ SELECT 
	me.mensaje
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\apostador\internacionalesc3.php - QUERY 6 */ SELECT 
* FROM 
carrera 
WHERE 
...
<form method="post" id="form<?php echo $n ?>">
    ...
    <div class="card-header" id="<?php echo $n ?>">
      <h5 class="mb-0">
        <button class="btn btn-primary collapsed" data-toggle="collapse" data-target="#collapse<?php echo $n ?>" aria-expanded="false" aria-controls="collapse<?php echo $n ?>">
    ...
    <div id="collapse<?php echo $n ?>" class="collapse" aria-labelledby="heading3" data-parent="#accordion">
      <div class="card-body">
...
<?php
        ...
        $n++;
    } while ($row_Recordset1 = mysqli_fetch_assoc($Recordset1)); ?></div>	<?php
    }
?>
    </fieldset>
  </div>
