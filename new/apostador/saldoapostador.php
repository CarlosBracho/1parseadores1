...
if (!isset($_SESSION['MM_id_usuario'])) {
    ...
    $id_usuarioO=0;
                            ...
                            $query_Recordset13 = sprintf(
                                "/* PARSEADORES1 new\apostador\saldoapostador.php - QUERY 1 */ SELECT taquilla.cod_taquilla, taquilla.moneda
    ...
    $totalRows_Recordset13 = mysqli_num_rows($Recordset13);
                            ...
                            $query_Recordset14 = sprintf(
                                "/* PARSEADORES1 new\apostador\saldoapostador.php - QUERY 2 */ SELECT saldoactualc, Idbalancecli
    ...
    $totalRows_Recordset14 = mysqli_num_rows($Recordset14);
                                $query_Recordset15 = sprintf(
                                    "/* PARSEADORES1 new\apostador\saldoapostador.php - QUERY 3 */ SELECT saldoactualc, Idbalancecli
					FROM balanceclientes
					WHERE monedac = 3 AND
    ...
    $totalRows_Recordset15 = mysqli_num_rows($Recordset15);
                                $query_Recordset16 = sprintf(
                                    "/* PARSEADORES1 new\apostador\saldoapostador.php - QUERY 4 */ SELECT saldoactualc, Idbalancecli
					FROM balanceclientes
					WHERE monedac = 4 AND
					cod_taquilla = %s ORDER BY Idbalancecli DESC LIMIT 1",
                                    GetSQLValueString($row_Recordset13['cod_taquilla'], "int")
    ...
    $totalRows_Recordset16 = mysqli_num_rows($Recordset16);
                                $query_Recordset17 = sprintf(
                                    "/* PARSEADORES1 new\apostador\saldoapostador.php - QUERY 5 */ SELECT saldoactualc, Idbalancecli
					FROM balanceclientes
					WHERE monedac = 5 AND
					cod_taquilla = %s ORDER BY Idbalancecli DESC LIMIT 1",
                                    GetSQLValueString($row_Recordset13['cod_taquilla'], "int")
...
$COP=0;
$SOL=0;
if ($row_Recordset14['saldoactualc']>0 && $row_Recordset13['moneda']<=2) {
...
if ($row_Recordset14['saldoactualc']>0 && $BSS==0) {
    echo $row_Recordset14['saldoactualc'];
    echo ' BSS  ';
}
if ($row_Recordset15['saldoactualc']>0 && $row_Recordset13['moneda']==3) {
    echo	'<FONT color="#ff0000">';
...
if ($row_Recordset15['saldoactualc']>0 && $USD==0) {
    echo $row_Recordset15['saldoactualc'];
    echo ' USD  ';
}
if ($row_Recordset16['saldoactualc']>0 && $row_Recordset13['moneda']==4) {
    echo	'<FONT color="#ff0000">';
...
if ($row_Recordset16['saldoactualc']>0 && $COP==0) {
    echo $row_Recordset16['saldoactualc'];
    echo ' COP  ';
}
if ($row_Recordset17['saldoactualc']>0 && $row_Recordset13['moneda']==5) {
    echo	'<FONT color="#ff0000">';
...
if ($row_Recordset17['saldoactualc']>0 && $SOL==0) {
    echo $row_Recordset17['saldoactualc'];
    echo ' SOL ';
}
