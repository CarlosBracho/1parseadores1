...
if (isset($_GET["recordID"])) {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\apostador\reporteca.php - QUERY 1 */ SELECT *
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 new\apostador\reporteca.php - QUERY 2 */ SELECT *
					FROM balanceclientes, taquilla, agencia
					WHERE
					taquilla.cod_taquilla = balanceclientes.cod_taquilla AND
      ...
      <table class="table">
        <thead class="thead-dark">
          <tr>
            ...
            <th scope="col"># Cliente / Fecha / Ticket </th>
