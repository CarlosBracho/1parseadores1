...
$codigoAgente=$_SESSION['MM_cod_agente'];
    ...
    $query_Recordset1 = "/* PARSEADORES1 new\apostador\listaclientesa.php - QUERY 1 */ SELECT * FROM taquilla, agencia $where";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<ul class="navbar-nav mr-auto">
	  	        <li class="nav-item">
         <a class="dropdown-item" href="listaclientesa.php">Lista De Clientes</a>
      </li>

	        <li class="nav-item">
        <a class="dropdown-item" href="reporteca.php">Reporte De Jugadas<span class="sr-only">(current)</span></a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="cerrar_sesion_cliente.php">Salir</a>
      </li>
    </ul>
...
do {
    ?>
        ...
        "/* PARSEADORES1 new\apostador\listaclientesa.php - QUERY 2 */ SELECT MAX(Idbalancecli) 
    ...
    $query_Recordset14 = sprintf(
        "/* PARSEADORES1 new\apostador\listaclientesa.php - QUERY 3 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
        GetSQLValueString(3, "int"),
    ...
    $saldoactualc=((float)$row_Recordset14['saldoactualc']); ?>
		...
		<td><a href="modificarsaldoa.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>"  class="btn btn-info" />Modificar Saldo</td>
		<td><a href="reporteca.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>"  class="btn btn-info" />Reporte</td>

		<td><a href="#" class="btn btn-xs btn-success"><span class="glyphicon glyphicon-pencil"></span>Editar</a></td>
          </tr>
          <?php
