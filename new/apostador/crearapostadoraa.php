...
if (isset($_POST['username'])) {
    $insertSQL = sprintf(
        "/* PARSEADORES1 new\apostador\crearapostadoraa.php - QUERY 1 */ INSERT 
				INTO taquilla 
...
moneda,
    ...
    $query_RecT = "/* PARSEADORES1 new\apostador\crearapostadoraa.php - QUERY 2 */ SELECT cod_taquilla FROM taquilla ORDER BY cod_taquilla DESC LIMIT 1";
    ...
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 new\apostador\crearapostadoraa.php - QUERY 3 */ INSERT 
		INTO usuario 
    ...
    $insertSQL2 = sprintf(
        "/* PARSEADORES1 new\apostador\crearapostadoraa.php - QUERY 4 */ INSERT 
			INTO 
			taquilla_opc_ame 
