...
function ObtenerMontoEjeTaq($codT, $fecV, $numE, $codC, $codA)
{
    ...
    $query_Recordset11 = sprintf(
        "/* PARSEADORES1 new\apostador\grabarjugada.php - QUERY 1 */ SELECT 
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\apostador\grabarjugada.php - QUERY 2 */ SELECT can_caballos, hor_carrera, fec_carrera, est_carrera, pau_ventas, cod_carrera
								 FROM carrera
								 WHERE cod_carrera = %s 
								 LIMIT 1",
    ...
    $exito=1; $mensaje="";
                            $query_Recordset13 = sprintf(
                                "/* PARSEADORES1 new\apostador\grabarjugada.php - QUERY 3 */ SELECT MAX(Idbalancecli) 
    ...
    $Idbalancecli=((int)$row_Recordset13['MAX(Idbalancecli)']);
                            ...
                            $query_Recordset14 = sprintf(
                                "/* PARSEADORES1 new\apostador\grabarjugada.php - QUERY 4 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
                                GetSQLValueString($_POST['moneda'], "int"),
