...
if (!empty($_SESSION['act']) && !empty($_POST['act']) && $_POST['act'] == $_SESSION['act']) {
    if (isset($_POST['tipo'])) {
        $query_Recordset13 = sprintf(
            "/* PARSEADORES1 new\apostador\modificarsaldoa.php - QUERY 1 */ SELECT MAX(Idbalancecli) 
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 new\apostador\modificarsaldoa.php - QUERY 2 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
            GetSQLValueString(3, "int"),
        ...
        $query_Recordset12 = sprintf(
            "/* PARSEADORES1 new\apostador\modificarsaldoa.php - QUERY 3 */ SELECT MAX(numticket) 
					FROM balanceclientes
					WHERE 
					tipo = %s AND 
					cod_taquilla = %s",
        ...
        $insertSQL155 = sprintf(
            "/* PARSEADORES1 new\apostador\modificarsaldoa.php - QUERY 4 */ INSERT INTO balanceclientes  
...
VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        $Result155 = mysqli_query($conexionbanca, $insertSQL155) or die(mysqli_error($conexionbanca));
                            ...
                            $query_Recordset13 = sprintf(
                                "/* PARSEADORES1 new\apostador\modificarsaldoa.php - QUERY 5 */ SELECT MAX(Idbalancecli) 
					FROM balanceclientes
					WHERE monedac = %s AND 
					cod_taquilla = %s",
                                GetSQLValueString(3, "int"),
    ...
    $Idbalancecli=((int)$row_Recordset13['MAX(Idbalancecli)']);
                            ...
                            $query_Recordset14 = sprintf(
                                "/* PARSEADORES1 new\apostador\modificarsaldoa.php - QUERY 6 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
                                GetSQLValueString(3, "int"),
