<?php
    ...
    $insertSQL = sprintf(
        "/* PARSEADORES1 new\apostador\grabarjugada2.php - QUERY 1 */ INSERT INTO venta (ser_venta, ticket, cod_taquilla, fec_venta, hor_venta, cod_tventa,
...
$montobss=0; $montousd=0; $montocop=0; $montosol=0;
                ...
                if ($_POST['moneda']==5) {
                    $montosol=$monto;
                                            ...
                                            $query_Recordset13 = sprintf(
                                                "/* PARSEADORES1 new\apostador\grabarjugada2.php - QUERY 2 */ SELECT MAX(Idbalancecli) 
    ...
    $Idbalancecli=((int)$row_Recordset13['MAX(Idbalancecli)']);
                            ...
                            $query_Recordset14 = sprintf(
                                "/* PARSEADORES1 new\apostador\grabarjugada2.php - QUERY 3 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
                                GetSQLValueString($_POST['moneda'], "int"),
    ...
    $saldoactualc=((float)$row_Recordset14['saldoactualc']);
                    ...
                    $query_Recordset12 = sprintf(
                        "/* PARSEADORES1 new\apostador\grabarjugada2.php - QUERY 4 */ SELECT MAX(num_ticket) 
					FROM venta
...
$query_Recordset15 = sprintf(
    "/* PARSEADORES1 new\apostador\grabarjugada2.php - QUERY 5 */ SELECT 
...
$wwww=$row_Recordset15['carrera'].$row_Recordset15['cab_apuesta'].$row_Recordset15['tip_apuesta_nom'];
            ...
            $insertSQL155 = sprintf(
                "/* PARSEADORES1 new\apostador\grabarjugada2.php - QUERY 6 */ INSERT INTO balanceclientes  
