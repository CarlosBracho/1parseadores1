...
if (isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    foreach ($_FILES['files']['name'] as $f => $name) {
		echo $_FILES['files']['name'].' nombre del archivo';
...
<head>
	<meta charset="UTF-8" />
	<title>.:SUBIR JUEGOS Y LOGROS:.</title>
<style type="text/css">
...
<body>
	<div class="wrap">
		...
		<p></p>
		<br />
		RECUERDE QUE LOS JUEGOS QUE SUBAN CORRESPONDA CON LA FECHA ACTUAL<br />
