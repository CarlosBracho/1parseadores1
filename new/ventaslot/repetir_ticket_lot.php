...
$bandera=0;
$monTotal=0;
echo '<script type="text/javascript">$("#mensaje").html("");document.getElementById("num_apuesta").value="";</script>';
if (isset($_POST["repetirT"])&&isset($_POST["repetirT"])&&isset($_POST["taRep"])&&isset($_POST["agRep"])) {
    ...
    $query_Recordset1 = sprintf("/* PARSEADORES1 new\ventaslot\repetir_ticket_lot.php - QUERY 1 */ SELECT 
		ve.id_loteria,
		ve.tip_loteria_lot,
		ve.id_signo,
		ve.num_apuesta_lot,
    ...
    if ($totalRows_Recordset1>0) {
        ...
        do {
            ...
            $tip_loteria=$row_Recordset1['tip_loteria_lot'];
