...
$query_Recordset19 = sprintf("/* PARSEADORES1 new\ventaslot\pagar_ticket_lot.php - QUERY 1 */ SELECT est_control_pagos_lot FROM ctrol_ventpag_global_lot LIMIT 1");
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\ventaslot\pagar_ticket_lot.php - QUERY 2 */ SELECT 
...
$query_Recordset7 = sprintf("/* PARSEADORES1 new\ventaslot\pagar_ticket_lot.php - QUERY 3 */ SELECT est_control_pagos_lot FROM ctrol_ventpag_global_lot");
