...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\ventaslot\lista_loterias2.php - QUERY 1 */ SELECT 
	lo.nom_loteria, 
	lo.tip_loteria, 
	lo.id_loteria,
	lo.let_loteria,
...
$query_Recordset2 = "/* PARSEADORES1 new\ventaslot\lista_loterias2.php - QUERY 2 */ SELECT id_signo, nom_corto, nom_signo FROM signos";
