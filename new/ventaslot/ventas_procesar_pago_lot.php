...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 new\ventaslot\ventas_procesar_pago_lot.php - QUERY 1 */ SELECT ve.ticket_lot, ve.ser_ticket_lot, tp.pag_codigo_lot, ta.cod_taquilla
	FROM 
		venta_lot ve, 
		usuario us,
		taquilla ta, 
...
$query_Recordset19 = sprintf("/* PARSEADORES1 new\ventaslot\ventas_procesar_pago_lot.php - QUERY 2 */ SELECT est_control_pagos_lot FROM ctrol_ventpag_global_lot LIMIT 1");
...
if (isset($_POST["MM_update"]) && $_POST["MM_update"] == "form1" && isset($_POST["ticket"]) && isset($_POST["uVenta"])) {
    ...
    if ($totalRows_Recordset1>0 && $est_control_pagos==0) {
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 new\ventaslot\ventas_procesar_pago_lot.php - QUERY 3 */ SELECT 
                ...
                if (isset($_POST["ser_ticket_lot"]) && $_POST["ser_ticket_lot"]==$serial) {
                    if ($row_Recordset2['est_ticket_lot']==1) {
                        if ($row_Recordset2['est_pago']==0) {
                            ...
                            $query_Recordset3 = sprintf("/* PARSEADORES1 new\ventaslot\ventas_procesar_pago_lot.php - QUERY 4 */ SELECT num_ticket_lot, ve.est_calculo_lot, ve.pag_premio_lot
								FROM venta_lot ve 
                            ...
                            if ($totalRows_Recordset3>0) {
                                ...
                                do {
                                    $updateSQL = sprintf(
                                        "/* PARSEADORES1 new\ventaslot\ventas_procesar_pago_lot.php - QUERY 5 */ UPDATE venta_lot
