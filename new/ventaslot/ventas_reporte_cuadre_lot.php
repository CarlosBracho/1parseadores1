...
$query_Recordset2 = sprintf("/* PARSEADORES1 new\ventaslot\ventas_reporte_cuadre_lot.php - QUERY 1 */ SELECT us.nom_usuario, us.id_usuario, ta.nom_taquilla FROM usuario us, taquilla ta 
...
if ($vendedor=="") {
    $query_Recordset3 = sprintf("/* PARSEADORES1 new\ventaslot\ventas_reporte_cuadre_lot.php - QUERY 2 */ SELECT nom_usuario FROM usuario WHERE usuario.id_usuario = %s AND tip_usuario='U' 
