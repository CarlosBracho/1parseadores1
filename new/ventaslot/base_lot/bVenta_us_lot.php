<?php
    ...
    "/* PARSEADORES1 new\ventaslot\base_lot\bVenta_us_lot.php - QUERY 1 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla,
					ta.cod_taquilla,
					tp.por_taquilla_lot,
    ...
    GetSQLValueString($codigoUsuario, "int")
                ...
                $query_Recordset = sprintf(
                    "/* PARSEADORES1 new\ventaslot\base_lot\bVenta_us_lot.php - QUERY 2 */ SELECT cod_taquilla FROM taquilla_opc_lot WHERE cod_taquilla = %s LIMIT 1",
