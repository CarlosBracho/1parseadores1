...
$query_Recordset1111 = sprintf(
  "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_di.php - QUERY 1 */ SELECT id_Loterias_y_nombres_ani1, nom_Loterias_y_nombres_ani1, animales_Loterias_y_nombres_ani1
...
$query_Recordset1111_solteos = sprintf(
  "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_di.php - QUERY 2 */ SELECT id_solteo_ani4,
...
//print_r($dir_solteos);
                            ...
                            $query_Recordset13 = sprintf(
                                "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_di.php - QUERY 3 */ SELECT *
					FROM usuario, ani5_jugadas, ani4_solteos, taquilla_opc_ani, agencia, taquilla 
					WHERE
          ...
          ani5_jugadas.linea_ticket_ani5= 1 AND 
          ani5_jugadas.id_usuario_ani5= usuario.id_usuario AND 
          taquilla_opc_ani.cod_taquilla = taquilla.cod_taquilla AND 
...
if(isset($_POST[''])){
 $query_Recordset13 = sprintf(
      "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_di.php - QUERY 4 */ SELECT *
...
$totalRows_Recordset13 = mysqli_num_rows($Recordset13);
    ...
    $query_Recordset1 = sprintf(
      "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_di.php - QUERY 5 */ SELECT 
    *
...
Hora: <?php $nuevahora1 = strtotime('+6 hour', strtotime($row_Recordset13['fechahora_creacion_ani5']));
        ...
        Taquilla: <?php echo $row_Recordset13['nom_taquilla']; ?>
</a></br>
			<?php
?>
...
onclick="detalle_ticket(<?php echo $row_Recordset13['num_ticket_ani5']; ?>, 0, 3); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_di.php - QUERY 6 */ SELECT *
...
onclick="detalle_ticket(<?php echo $row_Recordset13['num_ticket_ani5']; ?>, 0, 3); return false"><?php
                            $query_Recordset135 = sprintf(
                                "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_di.php - QUERY 7 */ SELECT *
...
$query_Recordset1 = sprintf(
  "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_di.php - QUERY 8 */ SELECT 
*
