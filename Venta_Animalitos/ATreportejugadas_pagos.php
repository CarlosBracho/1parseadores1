...
$query_Recordset1111 = sprintf(
  "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos.php - QUERY 1 */ SELECT id_Loterias_y_nombres_ani1, nom_Loterias_y_nombres_ani1, animales_Loterias_y_nombres_ani1
...
$query_Recordset1111_solteos = sprintf(
  "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos.php - QUERY 2 */ SELECT id_solteo_ani4,
...
//print_r($dir_solteos);
                            ...
                            $query_Recordset13 = sprintf(
                                "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos.php - QUERY 3 */ SELECT *
					FROM usuario, ani5_jugadas, ani4_solteos, taquilla_opc_ani 
					WHERE
...
if(isset($_POST[''])){
 $query_Recordset13 = sprintf(
      "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos.php - QUERY 4 */ SELECT *
FROM usuario, ani5_jugadas, ani4_solteos, taquilla_opc_ani 
WHERE
...
$totalRows_Recordset13 = mysqli_num_rows($Recordset13);
    ...
    $query_Recordset1 = sprintf(
      "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos.php - QUERY 5 */ SELECT 
    *
...
onclick="detalle_ticket(<?php echo $row_Recordset13['num_ticket_ani5']; ?>, 0, 3); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos.php - QUERY 6 */ SELECT *
        ...
        $yacerrada=0;
        do {
          $minxcerrar=$row_Recordset13['cierre_adelantado']*60;
          $horaTxt=horaactual();
...
onclick="detalle_ticket(<?php echo $row_Recordset13['num_ticket_ani5']; ?>, 0, 3); return false"><?php
                            $query_Recordset135 = sprintf(
                                "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos.php - QUERY 7 */ SELECT *
...
$minparapodereliminar=$row_Recordset13['max_minutos_eliminar']*60;
...
if ($ganadorodevolucion==0 && $yacancelado==0 && $yacerrada==0 && $datetime7>=$datetime) {



?>
<center><input type="submit" value="Eliminar" class="btn-primary" title="Eliminar" 
          data-toggle="modal" data-target="#exampleModal" href="ATdetalle_ticket.php" title="" 
onclick="detalle_ticket2(<?php echo $row_Recordset13['id_ticket_ani5']; ?>, <?php echo $row_Recordset13['num_ticket_ani5']; ?>, 4); return false"   />
</center>
...
if ($ganadorodevolucion==1) {
  if ($Eliminada!=1) {
    if ($estadojugada_ani5_sihayganadora==1) {
  ?>
  <center><input type="submit" value="PAGAR" class="btn-primary" title="PAGAR" 
          data-toggle="modal" data-target="#exampleModal" href="ATdetalle_ticket.php" title="" 
onclick="detalle_ticket2(<?php echo $row_Recordset13['id_ticket_ani5']; ?>, <?php echo $row_Recordset13['num_ticket_ani5']; ?>, 1); return false"   />
</center>
        <?php
          }}}
...
$query_Recordset1 = sprintf(
  "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos.php - QUERY 8 */ SELECT 
*
