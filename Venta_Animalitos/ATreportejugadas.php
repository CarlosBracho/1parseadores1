...
$query_Recordset1111 = sprintf(
  "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas.php - QUERY 1 */ SELECT id_Loterias_y_nombres_ani1, nom_Loterias_y_nombres_ani1, animales_Loterias_y_nombres_ani1
...
$query_Recordset1111_solteos = sprintf(
  "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas.php - QUERY 2 */ SELECT id_solteo_ani4,
...
//print_r($dir_solteos);
                            ...
                            $query_Recordset13 = sprintf(
                                "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas.php - QUERY 3 */ SELECT *
          ...
          AND ani5_jugadas.id_usuario_ani5= %s AND ani5_jugadas.linea_ticket_ani5= 1 ORDER BY ani5_jugadas.id_ticket_ani5 DESC",
...
if(isset($_POST[''])){
 $query_Recordset13 = sprintf(
      "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas.php - QUERY 4 */ SELECT *
FROM usuario, ani5_jugadas
WHERE
ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s  AND
usuario.id_usuario = %s
...
$totalRows_Recordset13 = mysqli_num_rows($Recordset13);
    ...
    $query_Recordset1 = sprintf(
      "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas.php - QUERY 5 */ SELECT 
    *
...
Hora: <?php $nuevahora1 = strtotime($_SESSION['ZonaHorario'], strtotime($row_Recordset13['fechahora_creacion_ani5']));
...
onclick="detalle_ticket(<?php echo $row_Recordset13['num_ticket_ani5']; ?>, 0, 3); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas.php - QUERY 6 */ SELECT *
                FROM ani5_jugadas
                WHERE
                ani5_jugadas.num_ticket_ani5= %s ",
            GetSQLValueString($row_Recordset13['num_ticket_ani5'], "int")
        );
...
echo $clave_solteos_fechahora_solteo_ani4.' -- ';
          ...
          echo 'Monto Apostado= '.$row_Recordset14['mon_venta_ani5'].' ';
          ...
          if ($row_Recordset14['estadojugada_ani5']==5) {
            echo 'Gandor ya cancelado ';
            $estadoticketd=1;
            $query_Recordset1 = sprintf(
              "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas.php - QUERY 7 */ SELECT 
            *
            ...
            id_ticket_ani5 = %s            ",
              GetSQLValueString($row_Recordset13['id_ticket_ani5'], "int")
            );
            $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
            $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
            $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
            ...
            echo 'Premio= '.$row_Recordset1['mon_pago_ani5'];
            if ($row_Recordset13['moneda_ani5']==0) {echo ' BSS';}
            if ($row_Recordset13['moneda_ani5']==1) {echo ' BSS';}
            if ($row_Recordset13['moneda_ani5']==2) {echo ' BSS';}
            if ($row_Recordset13['moneda_ani5']==3) {echo ' USD';}
...
onclick="detalle_ticket(<?php echo $row_Recordset13['num_ticket_ani5']; ?>, 0, 3); return false"><?php
                            $query_Recordset135 = sprintf(
                                "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas.php - QUERY 8 */ SELECT *
					FROM usuario, ani5_jugadas
					WHERE
...
<?php if ($row_Recordset135['estado_ticket_ani5']==1 ) {?>
...
onclick="detalle_ticket2(<?php echo $row_Recordset13['num_ticket_ani5']; ?>, 0, 3); return false"   />
</center>
        <?php
          } 
          ?>
