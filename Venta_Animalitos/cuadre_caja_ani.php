...
if($D==1){
    ...
    $query_Recordset13 = sprintf(
        "/* PARSEADORES1 Venta_Animalitos\cuadre_caja_ani.php - QUERY 1 */ SELECT 
...
SUM(CASE WHEN  ani5_jugadas.fechahora_pago_ani5 >= %s AND ani5_jugadas.fechahora_pago_ani5 <= %s AND  (ani5_jugadas.estadojugada_ani5 = 6) AND ani5_jugadas.moneda_ani5 = 5  THEN ani5_jugadas.mon_pago_ani5 ELSE 0 END) AS total_anuladossol
    ...
    echo 'este2<br>';
    $query_Recordset13 = sprintf(
        "/* PARSEADORES1 Venta_Animalitos\cuadre_caja_ani.php - QUERY 2 */ SELECT 
     
    SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s  AND ani5_jugadas.moneda_ani5 <= 2 THEN ani5_jugadas.mon_venta_ani5 ELSE 0 END) AS total_ventabss,
SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND (ani5_jugadas.estadojugada_ani5 = 5) AND ani5_jugadas.moneda_ani5 <= 2  THEN ani5_jugadas.mon_pago_ani5 ELSE 0 END) AS total_pagadobss,
SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND (ani5_jugadas.estadojugada_ani5 = 4) AND ani5_jugadas.moneda_ani5 <= 2  THEN ani5_jugadas.mon_pago_ani5 ELSE 0 END) AS total_eliminadosbss,
SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND (ani5_jugadas.estadojugada_ani5 = 6) AND ani5_jugadas.moneda_ani5 <= 2  THEN ani5_jugadas.mon_pago_ani5 ELSE 0 END) AS total_anuladosbss,

SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND ani5_jugadas.moneda_ani5 = 3 THEN ani5_jugadas.mon_venta_ani5 ELSE 0 END) AS total_ventausd,
SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND (ani5_jugadas.estadojugada_ani5 = 5) AND ani5_jugadas.moneda_ani5 = 3  THEN ani5_jugadas.mon_pago_ani5 ELSE 0 END) AS total_pagadousd,
SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND (ani5_jugadas.estadojugada_ani5 = 4) AND ani5_jugadas.moneda_ani5 = 3  THEN ani5_jugadas.mon_pago_ani5 ELSE 0 END) AS total_eliminadosusd,
SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND (ani5_jugadas.estadojugada_ani5 = 6) AND ani5_jugadas.moneda_ani5 = 3  THEN ani5_jugadas.mon_pago_ani5 ELSE 0 END) AS total_anuladosusd,

SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND ani5_jugadas.moneda_ani5 = 4 THEN ani5_jugadas.mon_venta_ani5 ELSE 0 END) AS total_ventacop,
SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND (ani5_jugadas.estadojugada_ani5 = 5) AND ani5_jugadas.moneda_ani5 = 4  THEN ani5_jugadas.mon_pago_ani5 ELSE 0 END) AS total_pagadocop,
SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND (ani5_jugadas.estadojugada_ani5 = 4) AND ani5_jugadas.moneda_ani5 = 4  THEN ani5_jugadas.mon_pago_ani5 ELSE 0 END) AS total_eliminadoscop,
SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND (ani5_jugadas.estadojugada_ani5 = 6) AND ani5_jugadas.moneda_ani5 = 4  THEN ani5_jugadas.mon_pago_ani5 ELSE 0 END) AS total_anuladoscop,

SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND ani5_jugadas.moneda_ani5 = 5 THEN ani5_jugadas.mon_venta_ani5 ELSE 0 END) AS total_ventasol,
SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND (ani5_jugadas.estadojugada_ani5 = 5) AND ani5_jugadas.moneda_ani5 = 5  THEN ani5_jugadas.mon_pago_ani5 ELSE 0 END) AS total_pagadosol,
SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND (ani5_jugadas.estadojugada_ani5 = 4) AND ani5_jugadas.moneda_ani5 = 5  THEN ani5_jugadas.mon_pago_ani5 ELSE 0 END) AS total_eliminadossol,
SUM(CASE WHEN  ani5_jugadas.fechahora_creacion_ani5 >= %s AND ani5_jugadas.fechahora_creacion_ani5 <= %s AND (ani5_jugadas.estadojugada_ani5 = 6) AND ani5_jugadas.moneda_ani5 = 5 THEN ani5_jugadas.mon_pago_ani5 ELSE 0 END) AS total_anuladossol
    FROM 
    ani5_jugadas
    WHERE
    ani5_jugadas.id_usuario_ani5= %s",
...
$query_Recordset2 = sprintf("/* PARSEADORES1 Venta_Animalitos\cuadre_caja_ani.php - QUERY 3 */ SELECT usuario.nom_usuario, usuario.id_usuario, taquilla.nom_taquilla FROM usuario, taquilla 
...
$query_Recordset3 = sprintf("/* PARSEADORES1 Venta_Animalitos\cuadre_caja_ani.php - QUERY 4 */ SELECT nom_usuario FROM usuario WHERE usuario.id_usuario = %s AND tip_usuario='U' 
...
<input type="submit" value=" " class="btn-warning" title="" onClick="return enviado()"/>
...
$sihay=0;
?>
<br/><strong>CUADRE ANIMALITOS</strong>
