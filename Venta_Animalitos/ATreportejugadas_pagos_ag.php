...
$query_Recordset1111 = sprintf(
  "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_ag.php - QUERY 1 */ SELECT id_Loterias_y_nombres_ani1, nom_Loterias_y_nombres_ani1, animales_Loterias_y_nombres_ani1
...
$query_Recordset1111_solteos = sprintf(
  "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_ag.php - QUERY 2 */ SELECT id_solteo_ani4,
...
//print_r($dir_solteos);
                            ...
                            $query_Recordset13 = sprintf(
                                "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_ag.php - QUERY 3 */ SELECT *
...
if(isset($_POST[''])){
 $query_Recordset13 = sprintf(
      "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_ag.php - QUERY 4 */ SELECT *
...
$totalRows_Recordset13 = mysqli_num_rows($Recordset13);
    ...
    $query_Recordset1 = sprintf(
      "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_ag.php - QUERY 5 */ SELECT 
    *
...
onclick="detalle_ticket(<?php echo $row_Recordset13['num_ticket_ani5']; ?>, 0, 3); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_ag.php - QUERY 6 */ SELECT *
...
onclick="detalle_ticket(<?php echo $row_Recordset13['num_ticket_ani5']; ?>, 0, 3); return false"><?php
                            $query_Recordset135 = sprintf(
                                "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_ag.php - QUERY 7 */ SELECT *
...
$query_Recordset1 = sprintf(
  "/* PARSEADORES1 Venta_Animalitos\ATreportejugadas_pagos_ag.php - QUERY 8 */ SELECT 
*
