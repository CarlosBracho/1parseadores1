...
<nav class="navbar navbar-expand-lg navbar-dark bg-warning">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item">
        <a class="dropdown-item" href="index.php">Apostar <br/> Animalitos</a>
      </li>


	  	        <li class="nav-item">
         <a class="dropdown-item" href="cuadre_caja_ani.php">Cuadre de<br/> Caja</a>
      </li>
      <li class="nav-item" hidden>
        <a class="dropdown-item" href="ATreportejugadas.php">Reporte de<br/>Jugadas</a>
      </li>
      <li class="nav-item">
        <a class="dropdown-item" href="resultados_animalitos.php">Resultados</a>
      </li>
      <!--
      <li class="nav-item">
      ...
      -->
      <li class="nav-item">
        <a class="dropdown-item" href="ATreportejugadas_pagos.php">Eliminar o Pagar<br/>Ticket</a>
      </li>
      <li class="nav-item">
        <a class="dropdown-item" href="aniconfiguracion.php">Configurar</a>
      </li>
      <li class="nav-item" hidden>
