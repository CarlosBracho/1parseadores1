...
<table width="100%" border="0" cellpadding="0" cellspacing="0" 
 <tr><td>
    ...
    "/* PARSEADORES1 includes\seleccionclientesventas.php - QUERY 1 */ SELECT ve.cod_cliente 
		FROM 
			usuario us, 
			taquilla ta, 
			venta ve 
...
?>
                    ...
                    type="text" name="cod_cliente" style="width:150px; font-size:14px" 
                    ...
                    if ($totalRows_Recordset115>0) {?> 
                        <select name="cod_cliente2" tabindex="4" form="formulario"  style="font-size:16px; width:280px; height:28px">
