...
<?php
        echo "<tr>";
        echo "<td>DisplayName DisplayName DisplayName</td>";
        echo "<td>RaceNum</td>";
        echo "<td>restante</td>";
        echo "<td>hora cierre</td>";
        echo "<td>status</td>";
        echo "</tr>";
if (!isset($_SESSION)) {
    session_start();
    ...
    if (isset($fulldatos["upcoming_races"])) {
        ...
        foreach ($fulldatos["card_list"] as $data) {
            ...
            foreach ($fulldatos["card_list"][$card_id]["races"] as $race) {
                $id=$race["id"];
                $status_race[$g]=$fulldatos["card_list"][$card_id]["races"][$id]["status"];
                   ...
                   $nuevaHora[$g]=date("H:i:s",$segundos_horaInicial+$segundos_minutoAnadir);
                   echo $nuevaHora[$g];
