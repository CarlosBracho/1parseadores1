...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2allyes.php - QUERY 1 */ SELECT * 
	FROM 
	hipodromo,
	carrera 
	WHERE
...
(hipodromo.bus_resultado_tip = 3 OR hipodromo.bus_resultado_tip = 5 OR hipodromo.bus_resultado_tip = 6 OR hipodromo.bus_resultado_tip = 8) AND
...
if ($totalRows_Recordset1>0) {
    ...
    do {
        ...
        if ($totalRows_Recordset1>0) {
            ...
            if (($row_Recordset1['bus_resultado_tip']==111 or $row_Recordset1['bus_resultado_tip']==555 or $row_Recordset1['bus_resultado_tip']==666 or $row_Recordset1['bus_resultado_tip']==777) && ($row_Recordset1['confirmandox']==0 or $row_Recordset1['confirmandox']==1)) {
                //track info
                $confirmandox=1;
                ...
                //echo $url."<br/>";
            list($cAct, $eje1LugarSimple, $eje1LugarDoble, $eje1LugarTriple, $eje2LugarSimple, $eje2LugarDoble, $eje2LugarTriple, $eje3LugarSimple, $eje3LugarDoble, $eje3LugarTriple, $eje4LugarSimple, $eje4LugarDoble, $eje4LugarTriple, $DivWinPriLugar, $DivWinPriLugarDoble, $DivWinPriLugarTriple, $DivPlaPriLugar, $DivPlaPriLugarDoble, $DivPlaPriLugarTriple, $DivShoPriLugar, $DivShoPriLugarDoble, $DivShoPriLugarTriple, $DivPlaSegLugar, $DivPlaSegLugarDoble, $DivPlaSegLugarTriple, $DivShoSegLugar, $DivShoSegLugarDoble, $DivShoSegLugarTriple, $DivShoTerLugar, $DivShoTerLugarDoble, $DivShoTerLugarTriple, $divExotic, $existe)=resultadoTrackInfo($url, 1);// 0 no permite ABCDEX   //1 permite ABCDEX
            }
            if ($row_Recordset1['bus_resultado_tip']==222 && $row_Recordset1['fec_carrera']==$fech) {
                //tvg
                $confirmandox=2;
                $f=explode("-", $fech);
                $fecha=$f[1]."/".$f[2]."/".$f[0];
                ...
                //echo $url."<br/>";
            list($cAct, $eje1LugarSimple, $eje1LugarDoble, $eje1LugarTriple, $eje2LugarSimple, $eje2LugarDoble, $eje2LugarTriple, $eje3LugarSimple, $eje3LugarDoble, $eje3LugarTriple, $eje4LugarSimple, $eje4LugarDoble, $eje4LugarTriple, $DivWinPriLugar, $DivWinPriLugarDoble, $DivWinPriLugarTriple, $DivPlaPriLugar, $DivPlaPriLugarDoble, $DivPlaPriLugarTriple, $DivShoPriLugar, $DivShoPriLugarDoble, $DivShoPriLugarTriple, $DivPlaSegLugar, $DivPlaSegLugarDoble, $DivPlaSegLugarTriple, $DivShoSegLugar, $DivShoSegLugarDoble, $DivShoSegLugarTriple, $DivShoTerLugar, $DivShoTerLugarDoble, $DivShoTerLugarTriple, $divExotic, $existe)=resultadoTVG($url, 1);// 0 no permite ABCDEX   //1 permite ABCDEX
            }
            if (($row_Recordset1['bus_resultado_tip']==3 or $row_Recordset1['bus_resultado_tip']==5 or $row_Recordset1['bus_resultado_tip']==6 or $row_Recordset1['bus_resultado_tip']==8) && ($row_Recordset1['confirmandox']==0 or $row_Recordset1['confirmandox']==3)) {
                echo 'build';
                $confirmandox=3;
                ...
                $idH=$id[0];
                $idC=$id[$car];
                list($cAct, $eje1LugarSimple, $eje1LugarDoble, $eje1LugarTriple, $eje2LugarSimple, $eje2LugarDoble, $eje2LugarTriple, $eje3LugarSimple, $eje3LugarDoble, $eje3LugarTriple, $eje4LugarSimple, $eje4LugarDoble, $eje4LugarTriple, $DivWinPriLugar, $DivWinPriLugarDoble, $DivWinPriLugarTriple, $DivPlaPriLugar, $DivPlaPriLugarDoble, $DivPlaPriLugarTriple, $DivShoPriLugar, $DivShoPriLugarDoble, $DivShoPriLugarTriple, $DivPlaSegLugar, $DivPlaSegLugarDoble, $DivPlaSegLugarTriple, $DivShoSegLugar, $DivShoSegLugarDoble, $DivShoSegLugarTriple, $DivShoTerLugar, $DivShoTerLugarDoble, $DivShoTerLugarTriple, $divExotic, $existe)=resultadoCarrerasBuild($idH, $idC, $fech, $car);
            }
            if ($row_Recordset1['bus_resultado_tip']==444) {
                //twinspires
                $confirmandox=2;
                $car=$row_Recordset1['num_carrera'];
                $fec=$row_Recordset1['fec_carrera'];
                ...
                list($cAct, $eje1LugarSimple, $eje1LugarDoble, $eje1LugarTriple, $eje2LugarSimple, $eje2LugarDoble, $eje2LugarTriple, $eje3LugarSimple, $eje3LugarDoble, $eje3LugarTriple, $eje4LugarSimple, $eje4LugarDoble, $eje4LugarTriple, $DivWinPriLugar, $DivWinPriLugarDoble, $DivWinPriLugarTriple, $DivPlaPriLugar, $DivPlaPriLugarDoble, $DivPlaPriLugarTriple, $DivShoPriLugar, $DivShoPriLugarDoble, $DivShoPriLugarTriple, $DivPlaSegLugar, $DivPlaSegLugarDoble, $DivPlaSegLugarTriple, $DivShoSegLugar, $DivShoSegLugarDoble, $DivShoSegLugarTriple, $DivShoTerLugar, $DivShoTerLugarDoble, $DivShoTerLugarTriple, $divExotic)=twinspiresResults($car, $fec, $tip, $BrisCode);
            }
            if (isset($cAct) && isset($cAct[0]) && $cAct[0]>0) {
                foreach ($cAct as $hip) {
					...
					<?php
                        ...
                        //aqui comienza
                        if ($row_Recordset1['valorbuildabet']==1 && ($row_Recordset1['bus_resultado_tip']==3 or  $row_Recordset1['bus_resultado_tip']==5 or  $row_Recordset1['bus_resultado_tip']==6 or  $row_Recordset1['bus_resultado_tip']==8)) {
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                        ...
                        //if ($control_dividendo==2) $est_confirmacion=0;
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                    ...
                                    $updateSQL = sprintf(
                                        "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2allyes.php - QUERY 2 */ UPDATE carrera 
							SET 
							confirmandox=%s,
								est_confirmacion=%s,
								control_dividendo=%s,
                ...
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2allyes.php - QUERY 3 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2allyes.php - QUERY 4 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
                ...
                $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
                        ...
                        if ($row_Recordset1['valorbuildabet']==2 && ($row_Recordset1['bus_resultado_tip']==3 or  $row_Recordset1['bus_resultado_tip']==5 or  $row_Recordset1['bus_resultado_tip']==6 or  $row_Recordset1['bus_resultado_tip']==8)) {
                            if ($row_Recordset1['control_dividendo']==1) {
                                if ($row_Recordset1['eje_primero']==$eje_primero*1 &&
                    number_format(floatval($row_Recordset1['div_primero_gan']), 2)==number_format(floatval($div_primero_gan*2), 2) &&
                    number_format(floatval($row_Recordset1['div_primero_pla']), 2)==number_format(floatval($div_primero_pla*2), 2) &&
                    number_format(floatval($row_Recordset1['div_primero_sho']), 2)==number_format(floatval($div_primero_sho*2), 2) &&
                    $row_Recordset1['eje_segundo']==$eje_segundo*1 &&
                    number_format(floatval($row_Recordset1['div_segundo_pla']), 2)==number_format(floatval($div_segundo_pla*2), 2) &&
                    number_format(floatval($row_Recordset1['div_segundo_sho']), 2)==number_format(floatval($div_segundo_sho*2), 2) &&
                    $row_Recordset1['eje_tercero']==$eje_tercero*1 &&
                    number_format(floatval($row_Recordset1['div_tercero_sho']), 2)==number_format(floatval($div_tercero_sho*2), 2) &&
                    $row_Recordset1['eje_doble_primero']==$eje_doble_primero*1 &&
                    number_format(floatval($row_Recordset1['div_doble_primero_gan']), 2)==number_format(floatval($div_doble_primero_gan*2), 2) &&
                    number_format(floatval($row_Recordset1['div_doble_primero_pla']), 2)==number_format(floatval($div_doble_primero_pla*2), 2) &&
                    number_format(floatval($row_Recordset1['div_doble_primero_sho']), 2)==number_format(floatval($div_doble_primero_sho*2), 2) &&
                    $row_Recordset1['eje_doble_segundo']==$eje_doble_segundo*1 &&
                    number_format(floatval($row_Recordset1['div_doble_segundo_pla']), 2)==number_format(floatval($div_doble_segundo_pla*2), 2) &&
                    number_format(floatval($row_Recordset1['div_doble_segundo_sho']), 2)==number_format(floatval($div_doble_segundo_sho*2), 2) &&
                    $row_Recordset1['eje_doble_tercero']==$eje_doble_tercero*1 &&
                    number_format(floatval($row_Recordset1['div_doble_tercero_sho']), 2)==number_format(floatval($div_doble_tercero_sho*2), 2) &&
                    $row_Recordset1['eje_triple_primero']==$eje_triple_primero*1 &&
                    number_format(floatval($row_Recordset1['div_triple_primero_gan']), 2)==number_format(floatval($div_triple_primero_gan*2), 2) &&
                    number_format(floatval($row_Recordset1['div_triple_primero_pla']), 2)==number_format(floatval($div_triple_primero_pla*2), 2) &&
                    number_format(floatval($row_Recordset1['div_triple_primero_sho']), 2)==number_format(floatval($div_triple_primero_sho*2), 2) &&
                    $row_Recordset1['eje_triple_segundo']==$eje_triple_segundo*1 &&
                    number_format(floatval($row_Recordset1['div_triple_segundo_pla']), 2)==number_format(floatval($div_triple_segundo_pla*2), 2) &&
                    number_format(floatval($row_Recordset1['div_triple_segundo_sho']), 2)==number_format(floatval($div_triple_segundo_sho*2), 2) &&
                    $row_Recordset1['eje_triple_tercero']==$eje_triple_tercero*1 &&
                    number_format(floatval($row_Recordset1['div_triple_tercero_sho']), 2)==number_format(floatval($div_triple_tercero_sho*2), 2) &&
                    $row_Recordset1['eje_cuarto']==$eje_cuarto*1 &&
                    number_format($row_Recordset1['div_exacta'], 2)==number_format(floatval($div_exacta), 2) &&
                    number_format($row_Recordset1['fac_exacta'], 2)==number_format(floatval($fac_exacta), 2) &&
                    number_format($row_Recordset1['div_trifecta'], 2)==number_format(floatval($div_trifecta), 2) &&
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                        ...
                        //if ($control_dividendo==2) $est_confirmacion=0;
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                    ...
                                    if ($control_dividendo==2){ $hconfir=$horasistema;  }else{$hconfir='00:00:00';}
                                    $updateSQL = sprintf(
                                        "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2allyes.php - QUERY 5 */ UPDATE carrera 
							SET 
							confirmandox=%s,
								est_confirmacion=%s,
								control_dividendo=%s,
							...
							WHERE cod_carrera=%s",
                                        ...
                                        GetSQLValueString($control_dividendo, "int"),
                                        GetSQLValueString($eje_primero, "int"),
                                        GetSQLValueString($div_primero_gan*2, "double"),
                                        GetSQLValueString($div_primero_pla*2, "double"),
                                        GetSQLValueString($div_primero_sho*2, "double"),
                                        GetSQLValueString($eje_segundo, "int"),
                                        GetSQLValueString($div_segundo_pla*2, "double"),
                                        GetSQLValueString($div_segundo_sho*2, "double"),
                                        GetSQLValueString($eje_tercero, "int"),
                                        GetSQLValueString($div_tercero_sho*2, "double"),
                                        GetSQLValueString($eje_doble_primero, "int"),
                                        GetSQLValueString($div_doble_primero_gan*2, "double"),
                                        GetSQLValueString($div_doble_primero_pla*2, "double"),
                                        GetSQLValueString($div_doble_primero_sho*2, "double"),
                                        GetSQLValueString($eje_doble_segundo, "int"),
                                        GetSQLValueString($div_doble_segundo_pla*2, "double"),
                                        GetSQLValueString($div_doble_segundo_sho*2, "double"),
                                        GetSQLValueString($eje_doble_tercero, "int"),
                                        GetSQLValueString($div_doble_tercero_sho*2, "double"),
                                        GetSQLValueString($eje_triple_primero, "int"),
                                        GetSQLValueString($div_triple_primero_gan*2, "double"),
                                        GetSQLValueString($div_triple_primero_pla*2, "double"),
                                        GetSQLValueString($div_triple_primero_sho*2, "double"),
                                        GetSQLValueString($eje_triple_segundo, "int"),
                                        GetSQLValueString($div_triple_segundo_pla*2, "double"),
                                        GetSQLValueString($div_triple_segundo_sho*2, "double"),
                                        GetSQLValueString($eje_triple_tercero, "int"),
                                        GetSQLValueString($div_triple_tercero_sho*2, "double"),
                                        GetSQLValueString($eje_cuarto, "int"),
                                        GetSQLValueString($div_exacta, "double"),
                                        GetSQLValueString($fac_exacta, "double"),
                                        GetSQLValueString($div_trifecta, "double"),
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2allyes.php - QUERY 6 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2allyes.php - QUERY 7 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
