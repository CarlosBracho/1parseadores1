...
$query_Recordset5 = sprintf(
    "/* PARSEADORES1 includes\infoTicket.php - QUERY 1 */ SELECT ticket, hor_venta FROM venta 
...
?>
                  <table style="width:100%">
                      <tr bgcolor="#FFFFFF" style="font-size:12px">
                        <td width="36%" height="12" align="center">ÚLTIMOS TICKETS CREADOS </td>
                        <td width="27%" align="center">APUESTA</td>
                        <td width="37%" align="center">TIEMPO DESDE SU CREACIÓN</td>
                      </tr>
                      <?php
