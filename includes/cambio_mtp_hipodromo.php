...
if (isset($_POST["codCar"]) && isset($_POST["modo"])) {
    $query_Recordset2 = sprintf("/* PARSEADORES1 includes\cambio_mtp_hipodromo.php - QUERY 1 */ SELECT cod_hipodromo, nom_hipodromo FROM hipodromo WHERE cod_hipodromo = %s", GetSQLValueString($_POST["codCar"], "int"));
    ...
    if ($totalRows_Recordset2>0) {
        ...
        $updateSQL2 = sprintf(
            "/* PARSEADORES1 includes\cambio_mtp_hipodromo.php - QUERY 2 */ UPDATE hipodromo SET bus_auto=%s 
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 includes\cambio_mtp_hipodromo.php - QUERY 3 */ INSERT 
						INTO bitacora 
        ...
        if ($totalRows_Recordset1>0) {
            ...
            do {
                ...
                if ($_POST["modo"]>=0 && $_POST["modo"]<=9) {
                    $updateSQL1 = sprintf(
                        "/* PARSEADORES1 includes\cambio_mtp_hipodromo.php - QUERY 5 */ UPDATE carrera SET mtp_control=%s 
							  WHERE cod_carrera=%s",
                        GetSQLValueString($_POST["modo"], "int"),
                    ...
                    $des=$des1.$des2;
                    $insertSQL12 = sprintf(
                        "/* PARSEADORES1 includes\cambio_mtp_hipodromo.php - QUERY 6 */ INSERT 
									INTO bitacora 
									(des_bitacora, hor_bitacora, fec_bitacora) 
									VALUES (%s, %s, %s)",
                        GetSQLValueString($des, "text"),
