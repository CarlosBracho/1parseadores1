            ...
            foreach ($nHipodro as $hip) {
                ...
                if ($id==$idCarrrera[$f] && $restan[$f]<=50) {
                    ...
                    if ($xEstado[$f]=="X") {
                        ...
                        $nm1="EL SISTEMA";
                        $updateSQL = sprintf(
                            "/* PARSEADORES1 includes\mtp_cierre_buildabet22respaldo.php - QUERY 2 */ UPDATE carrera 
							SET 
                        ...
                        $insertSQL2 = sprintf(
                            "/* PARSEADORES1 includes\mtp_cierre_buildabet22respaldo.php - QUERY 3 */ INSERT 
								INTO bitacora 
                    ...
                    if ($act==1) {
                        ...
                        $updateSQL = sprintf(
                            "/* PARSEADORES1 includes\mtp_cierre_buildabet22respaldo.php - QUERY 4 */ UPDATE carrera SET 
											hor_carrera=%s, 
											hor_mtp=%s, 
											est_carrera=%s, 
											est_cierre=%s, 
                        ...
                        $insertSQL = sprintf(
                            "/* PARSEADORES1 includes\mtp_cierre_buildabet22respaldo.php - QUERY 5 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					cerro) 
					VALUES (%s, %s, %s)",
