...
if (isset($_POST["codCar"]) && isset($_POST["modo"])) {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 includes\man_aut_carr_hnac.php - QUERY 1 */ SELECT 
    ...
    $updateSQL = sprintf(
        "/* PARSEADORES1 includes\man_aut_carr_hnac.php - QUERY 2 */ UPDATE carrera_hnac SET mtp_control_hnac=%s 
    ...
    $insertSQL2 = sprintf(
        "/* PARSEADORES1 includes\man_aut_carr_hnac.php - QUERY 3 */ INSERT 
					INTO bitacora 
