...
$query_Recordset1 = "/* PARSEADORES1 includes\replicaciontest.php - QUERY 1 */ SELECT MAX(num_ticket) FROM venta";
...
$query_Recordset15 = "/* PARSEADORES1 includes\replicaciontest.php - QUERY 2 */ SELECT MAX(num_ticket) FROM venta";
