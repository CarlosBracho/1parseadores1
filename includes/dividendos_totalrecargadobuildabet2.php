...
function resultadoCarrerasBuild2($idH, $idC, $hoy, $numC)
{
            ...
            if ($fulldatos["Result"]["powps"][$g]["RaceKey"]==$idC) {
                ...
                if ($fulldatos["Result"]["powps"][$g]["OrderOfFinish"]==1) {
                    if ($cwin==0) {
                       // $eje1LugarSimple[$nCar]=$fulldatos["Result"]["powps"][$g]["EntryNumber"];
                        $eje1LugarSimple[$nCar]=str_replace("A", "99", $fulldatos["Result"]["powps"][$g]["EntryNumber"]);
                    ...
                    if ($cwin==1) {
                        ...
                        $eje1LugarDoble[$nCar]=str_replace("A", "99", $fulldatos["Result"]["powps"][$g]["EntryNumber"]);
                    ...
                    if ($cwin==2) {
                        ...
                        $eje1LugarTriple[$nCar]=str_replace("A", "99", $fulldatos["Result"]["powps"][$g]["EntryNumber"]);
                ...
                if ($fulldatos["Result"]["powps"][$g]["OrderOfFinish"]==2) {
                    if ($cpla==0) {
                        ...
                        $eje2LugarSimple[$nCar]=str_replace("A", "99", $fulldatos["Result"]["powps"][$g]["EntryNumber"]);
                    ...
                    if ($cpla==1) {
                        ...
                        $eje2LugarDoble[$nCar]=str_replace("A", "99", $fulldatos["Result"]["powps"][$g]["EntryNumber"]);
                    ...
                    if ($cpla==2) {
                        ...
                        $eje2LugarTriple[$nCar]=str_replace("A", "99", $fulldatos["Result"]["powps"][$g]["EntryNumber"]);
                ...
                if ($fulldatos["Result"]["powps"][$g]["OrderOfFinish"]==3) {
                    if ($csho==0) {
                        ...
                        $eje3LugarSimple[$nCar]=str_replace("A", "99", $fulldatos["Result"]["powps"][$g]["EntryNumber"]);
                    ...
                    if ($csho==1) {
                        ...
                        $eje3LugarDoble[$nCar]=str_replace("A", "99", $fulldatos["Result"]["powps"][$g]["EntryNumber"]);
                    ...
                    if ($csho==2) {
                        ...
                        $eje3LugarTriple[$nCar]=str_replace("A", "99", $fulldatos["Result"]["powps"][$g]["EntryNumber"]);
                ...
                if ($fulldatos["Result"]["powps"][$g]["OrderOfFinish"]==104) {
                    if ($cuar==0) {
                        ...
                        $eje4LugarSimple[$nCar]=str_replace("A", "99", $fulldatos["Result"]["powps"][$g]["EntryNumber"]);
                       
                    
                    }
                    if ($cuar==1) {
                       // $eje4LugarDoble[$nCar]=$fulldatos["Result"]["powps"][$g]["EntryNumber"];
                        $eje4LugarDoble[$nCar]=str_replace("A", "99", $fulldatos["Result"]["powps"][$g]["EntryNumber"]);
                    ...
                    if ($cuar==2) {
                       // $eje4LugarTriple[$nCar]=$fulldatos["Result"]["powps"][$g]["EntryNumber"];
                        $eje4LugarTriple[$nCar]=str_replace("A", "99", $fulldatos["Result"]["powps"][$g]["EntryNumber"]);
            ...
            foreach ($fulldatos["Result"]["poexotics"] as $da) {
                ...
                if ($fulldatos["Result"]["poexotics"][$g]["BetTypeCode"]=="SUP" &&
                    ...
                    if ($aS==1) {
                        ...
                        $divExotic[$nCar][2][$ctaSu][1]=str_replace("ALL", "99", $fulldatos["Result"]["poexotics"][$g]["RunnerList"]);//llegada
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2.php - QUERY 1 */ SELECT * 
	FROM 
	hipodromo,
	carrera 
	WHERE
    ...
    do {
        ...
        if ($totalRows_Recordset1>0) {
            ...
            if (($row_Recordset1['bus_resultado_tip']==3 or $row_Recordset1['bus_resultado_tip']==5 or $row_Recordset1['bus_resultado_tip']==6 or $row_Recordset1['bus_resultado_tip']==8) && ($row_Recordset1['confirmandox']==0 or $row_Recordset1['confirmandox']==3)) {
                ...
                $idH=$id[0];
                $idC=$id[$car];
                list($cAct, $eje1LugarSimple, $eje1LugarDoble, $eje1LugarTriple, $eje2LugarSimple, $eje2LugarDoble, $eje2LugarTriple, $eje3LugarSimple, $eje3LugarDoble, $eje3LugarTriple, $eje4LugarSimple, $eje4LugarDoble, $eje4LugarTriple, $DivWinPriLugar, $DivWinPriLugarDoble, $DivWinPriLugarTriple, $DivPlaPriLugar, $DivPlaPriLugarDoble, $DivPlaPriLugarTriple, $DivShoPriLugar, $DivShoPriLugarDoble, $DivShoPriLugarTriple, $DivPlaSegLugar, $DivPlaSegLugarDoble, $DivPlaSegLugarTriple, $DivShoSegLugar, $DivShoSegLugarDoble, $DivShoSegLugarTriple, $DivShoTerLugar, $DivShoTerLugarDoble, $DivShoTerLugarTriple, $divExotic, $existe)=resultadoCarrerasBuild2($idH, $idC, $fech, $car);
            }
            if (isset($cAct) && isset($cAct[0]) && $cAct[0]>0) {
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                        ...
                        //if ($control_dividendo==2) $est_confirmacion=0;
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                    ...
                                    $updateSQL = sprintf(
                                        "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2.php - QUERY 2 */ UPDATE carrera 
							SET 
							confirmandox=%s,
								est_confirmacion=%s,
								control_dividendo=%s,
                ...
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2.php - QUERY 3 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2.php - QUERY 4 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                        ...
                        //if ($control_dividendo==2) $est_confirmacion=0;
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                    ...
                                    if ($control_dividendo==2){ $hconfir=$horasistema;  }else{$hconfir='00:00:00';}
                                    $updateSQL = sprintf(
                                        "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2.php - QUERY 5 */ UPDATE carrera 
							SET 
							confirmandox=%s,
								est_confirmacion=%s,
								control_dividendo=%s,
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2.php - QUERY 6 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadobuildabet2.php - QUERY 7 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
