...
$query_Recordset111 = sprintf("/* PARSEADORES1 includes\twinspire_dividendos_totalrecargadov4.php - QUERY 1 */ SELECT * 
	FROM 
	cookies 
	WHERE
...
function twinspiresResultssolo($car,$fec,$tip,$BrisCode,$cookie,$conexionbanca){
	...
	$url="https://www.twinspires.com/api/raceresults/results/".$fec."/".$BrisCode."/".$tipoHip."/".$car;
	//$url="https://www.twinspires.com/api/raceresults/results/2022-06-10/HOU/Thoroughbred/5"; //empate primer lugar
...
curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
			...
			if (curl_errno($ch)) {
				...
				$updateSQL = sprintf("/* PARSEADORES1 includes\twinspire_dividendos_totalrecargadov4.php - QUERY 2 */ UPDATE cookies SET errorcookie=errorcookie+1
				WHERE 	id_cookie = 1 AND cookinombre=%s",
				GetSQLValueString("twinspire", "text"));
				$Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
				$query_Recordset112 = sprintf("/* PARSEADORES1 includes\twinspire_dividendos_totalrecargadov4.php - QUERY 3 */ SELECT * 
					FROM 
					cookies 
					WHERE
					id_cookie = 1 AND cookinombre = %s
				...
				if($row_Recordset112['errorcookie']>5){
					$updateSQL = sprintf("/* PARSEADORES1 includes\twinspire_dividendos_totalrecargadov4.php - QUERY 4 */ UPDATE cookies SET errorcookie=errorcookie+1, cookiefull=0
					WHERE 	id_cookie = 1 AND cookinombre=%s",
					GetSQLValueString("twinspire", "text"));
					$Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
				}
			...
			curl_close($ch);
echo '<br><br>';
//$datoscurlresult2 = json_decode($result2,true); 
$datoscurlresult2=str_replace('', '', $result2); 
$datoscurlresult2=str_replace('"', '', $datoscurlresult2);
			var_dump($datoscurlresult2);
			print_r($datoscurlresult2);
			echo '<br><br>';
...
$query_Recordset1 = sprintf("/* PARSEADORES1 includes\twinspire_dividendos_totalrecargadov4.php - QUERY 5 */ SELECT * 
	FROM 
	hipodromo,
	carrera 
	WHERE
...
(hipodromo.bus_resultado_tip = 4 OR hipodromo.bus_resultado_tip = 5 OR hipodromo.bus_resultado_tip = 7 OR hipodromo.bus_resultado_tip = 8 OR hipodromo.bus_resultado_tip = 10) AND
...
if ($totalRows_Recordset1>0) { 
	...
	if ($totalRows_Recordset1>0)	{
		...
		if (($row_Recordset1['bus_resultado_tip']==4 OR $row_Recordset1['bus_resultado_tip']==5 OR $row_Recordset1['bus_resultado_tip']==7 OR $row_Recordset1['bus_resultado_tip']==8 OR $row_Recordset1['bus_resultado_tip']==10) && ($row_Recordset1['confirmandox']==0 OR $row_Recordset1['confirmandox']==4))	{
			//twinspires
			...
			list($cAct,$eje1LugarSimple,$eje1LugarDoble,$eje1LugarTriple,$eje2LugarSimple,$eje2LugarDoble,$eje2LugarTriple,$eje3LugarSimple,$eje3LugarDoble,$eje3LugarTriple,$eje4LugarSimple,$eje4LugarDoble,$eje4LugarTriple,$DivWinPriLugar,$DivWinPriLugarDoble,$DivWinPriLugarTriple,$DivPlaPriLugar,$DivPlaPriLugarDoble,$DivPlaPriLugarTriple,$DivShoPriLugar,$DivShoPriLugarDoble,$DivShoPriLugarTriple,$DivPlaSegLugar,$DivPlaSegLugarDoble,$DivPlaSegLugarTriple,$DivShoSegLugar,$DivShoSegLugarDoble,$DivShoSegLugarTriple,$DivShoTerLugar,$DivShoTerLugarDoble,$DivShoTerLugarTriple,$divExotic)=twinspiresResultssolo($car,$fec,$tip,$BrisCode,$row_Recordset111['cookiefull'],$conexionbanca);
		}
            ...
            <td colspan="6" align="left" valign="top">
                ...
                <div id="botReset<?php echo $row_Recordset1['cod_carrera']; ?>"
                    ...
                    <a href="#" onClick="resetDiv('<?php echo $row_Recordset1['cod_carrera']; ?>',
                        ...
                        title="reset dividendos <?php echo $carrera; ?>" class="btn btn-info"
                        style="color: #FFF">Reset</a>
                </div>

                <div id="botModifica<?php echo $row_Recordset1['cod_carrera']; ?>"
                    style="float:left; padding:0px 15px 0px 0px;">
                    <a href="#" onClick="ModiDiv('<?php echo $row_Recordset1['cod_carrera']; ?>','1')"
                        title="modificar dividendos <?php echo $carrera; ?>" class="btn btn-inverse"
                        style="color: #FFF">Modificar</a>
                </div>
                <div id="botCancela<?php echo $row_Recordset1['cod_carrera']; ?>"
                    ...
                    <a onclick='if(confirm("Â¿Seguro quiere cancelar la carrera?"))cancelaCar(
                        ...
                        class="btn btn-danger" style="color: #FFF" title="cancelar <?php echo $carrera; ?>">Cancelar</a>
                </div>
                <div id="botConfirma<?php echo $row_Recordset1['cod_carrera']; ?>"
                    ...
                    <a href="#" onClick="confirmarDiv(<?php echo $row_Recordset1['cod_carrera']; ?>,
                                ...
                                '#botReset<?php echo $row_Recordset1['cod_carrera']; ?>',
                                '#botModifica<?php echo $row_Recordset1['cod_carrera']; ?>');"
                        title="confirmar dividendos <?php echo $carrera; ?>" class="btn btn-success"
                        style="color: #FFF">Confirmar</a>
                    <?php 
							 }
							 else { ?>
    ...
    <?php
						...
						if ($row_Recordset1['control_dividendo']==1) {
							...
							if ($eje_segundo=='' && $eje_primero>=1 && $div_primero_pla>=1){
								$eje_segundo=99;
								$div_segundo_pla=2;
								if ($div_primero_sho>=1){	
									$div_segundo_sho=2;
								 }
							 }
							 if ($eje_tercero=='' && $eje_segundo>=1 && $div_segundo_pla>=1){
								$eje_tercero=99;

								if ($div_segundo_sho>=1){	
									$div_tercero_sho=2;
								 }
							 }
					...
					$row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
						...
						if ((isset($eje1LugarSimple[$hip]) && isset($DivWinPriLugar[$hip]) && $eje1LugarSimple[$hip]>0 &&
							...
							$updateSQL = sprintf("/* PARSEADORES1 includes\twinspire_dividendos_totalrecargadov4.php - QUERY 6 */ UPDATE carrera 
							SET 
								confirmandox=%s,
								est_confirmacion=%s,
								control_dividendo=%s,
                ...
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\twinspire_dividendos_totalrecargadov4.php - QUERY 7 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\twinspire_dividendos_totalrecargadov4.php - QUERY 8 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
