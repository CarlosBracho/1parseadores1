...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 includes\dividendos_total.php - QUERY 1 */ SELECT * 
	FROM 
	hipodromo,
	carrera 
	WHERE
                ...
                foreach ($cAct as $hip) {
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                ...
                                $updateSQL = sprintf(
                                    "/* PARSEADORES1 includes\dividendos_total.php - QUERY 2 */ UPDATE carrera 
							SET 
								est_confirmacion=%s,
								control_dividendo=%s,
								eje_primero=%s, 
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                ...
                                $updateSQL = sprintf(
                                    "/* PARSEADORES1 includes\dividendos_total.php - QUERY 3 */ UPDATE carrera 
							SET 
								est_confirmacion=%s,
								control_dividendo=%s,
								eje_primero=%s, 
