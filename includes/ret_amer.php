...
if ($hipoCar[0]!="") {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 includes\ret_amer.php - QUERY 1 */ SELECT * FROM  carrera, hipodromo WHERE 
            ...
            if ($hipoCar[$f]==$hiC) {
                ...
                if ($resultado1 !== false) {
                    ...
                    foreach ($ejemp as $ej) {
                        ...
                        if ($ret==0) {
                            $insertSQL = sprintf(
                                "/* PARSEADORES1 includes\ret_amer.php - QUERY 2 */ INSERT INTO retirados 
                    ...
                    if ($ret==0) {
                        $insertSQL2 = sprintf(
                            "/* PARSEADORES1 includes\ret_amer.php - QUERY 3 */ INSERT INTO retirados 
					  			(cod_carrera, num_rcaballo) VALUES (%s, %s)",
                            GetSQLValueString($cod_carrera, "int"),
                        ...
                        $insertSQL = sprintf(
                            "/* PARSEADORES1 includes\ret_amer.php - QUERY 4 */ INSERT INTO quiencierrayabre 
                            (codcarrera, 
                            fechaquien, 
                            que) 
                            VALUES (%s, %s, %s)",
