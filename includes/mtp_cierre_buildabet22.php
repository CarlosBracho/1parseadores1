...
function mtpCierreBuildaBet2l($p)
{
...
$query_Recordset1 = sprintf("/* PARSEADORES1 includes\mtp_cierre_buildabet22.php - QUERY 1 */ SELECT 
carrera.cod_carrera,
...
if ($totalRows_Recordset1>0) {
    list($idCarrrera, $nHipodro, $nCarrera, $xEstado, $xhora, $restan)=mtpCierreBuildaBet2l(1);
    $estado2=$xEstado;
            ...
            foreach ($nHipodro as $hip) {
                ...
                if ($id==$idCarrrera[$f] && $restan[$f]<=50) {
                    ...
                    if ($xEstado[$f]=="O" && $row_Recordset1['hor_carrera']=="01:00:00") {
                        ...
                        if (($xEstado[$f]=="O" && $faltan2<="00:00:30") OR ($xEstado[$f]=="I" && $faltan2<="00:00:30")) {
                            $minutoAnadir=3;
                    ...
                    if ($xEstado[$f]=="X") {
                        ...
                        $nm1="EL SISTEMA";
                        $updateSQL = sprintf(
                            "/* PARSEADORES1 includes\mtp_cierre_buildabet22.php - QUERY 2 */ UPDATE carrera 
							SET 
                        ...
                        $insertSQL2 = sprintf(
                            "/* PARSEADORES1 includes\mtp_cierre_buildabet22.php - QUERY 3 */ INSERT 
								INTO bitacora 
                    ...
                    if ($act==1) {
                        if ($cie==2) {
                            $updateSQL = sprintf(
                                "/* PARSEADORES1 includes\mtp_cierre_buildabet22.php - QUERY 4 */ UPDATE carrera SET 
											hor_carrera=%s, 
											hor_mtp=%s, 
											est_carrera=%s, 
											est_cierre=%s, 
                        ...
                        if ($cie==1 && $restan[$f]<=50 && $estadoanticierre<>"I") {
                            
                            $updateSQL = sprintf(
                                "/* PARSEADORES1 includes\mtp_cierre_buildabet22.php - QUERY 5 */ UPDATE carrera SET 
											hor_carrera=%s, 
											hor_mtp=%s, 
											est_carrera=%s, 
											est_cierre=%s, 
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\mtp_cierre_buildabet22.php - QUERY 6 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
