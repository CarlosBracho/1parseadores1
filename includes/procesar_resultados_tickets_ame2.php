...
if (isset($_GET['carrera'])) {
    ...
    if (isset($reset)) {// reset dividendos
        if ($reset==1) {// reset dividendos todos los ticket
            $query_Recordset12 = sprintf(
                "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 1 */ SELECT num_ticket 
            ...
            if ($totalRows_Recordset12>0) {
                do {
                    ...
                    $insertSQL12 = sprintf(
                        "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 2 */ UPDATE venta 
        ...
        if ($reset==2) {// reset dividendos todos los ticket
            $query_Recordset12 = sprintf(
                "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 3 */ SELECT num_ticket 
            ...
            if ($totalRows_Recordset12>0) {
                do {
                    $num_ticket=$row_Recordset12['num_ticket'];
                    $insertSQL12 = sprintf(
                        "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 4 */ UPDATE venta 
					SET pag_premio=%s, est_calculo=%s
						WHERE num_ticket=%s",
                        GetSQLValueString(0, "double"),
                        GetSQLValueString(0, "int"),
    ...
    if ($tipoProceso==2) { //proceso de premiacion
        $query_Recordset10 = sprintf("/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 5 */ SELECT cod_taquilla, saldoactual, tipotaquilla FROM taquilla");
        ...
        do {
            ...
            $query_Recordset11 = sprintf(
                "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 6 */ SELECT 
            ...
            if ($totalRows_Recordset11>0) {
                ...
                do {
                    ...
                    $updateSQL = sprintf(
                        "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 7 */ UPDATE venta 
                    ...
                    $query_Recordset87 = sprintf(
                        "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 8 */ SELECT
                                        venta.cod_taquilla				
                                      FROM 
					venta
				      WHERE
                    ...
                    $query_Recordset88 = sprintf(
                        "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 9 */ SELECT
                    ...
                    if ($tipotaquilla>=1) {
                        ...
                        $saldoactual=$saldoactual/1;
                        $insertSQL15 = sprintf(
                            "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 10 */ UPDATE taquilla 
				SET
				saldoactual=%s
				WHERE 
				cod_taquilla=%s",
        ...
        if ($tipoProceso==5) {// devolucion
            $query_Recordset12 = sprintf(
                "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 11 */ SELECT num_ticket, mon_venta, cod_taquilla 
		  FROM venta WHERE cod_carrera = %s AND est_ticket=1 AND est_calculo=0",
            ...
            if ($totalRows_Recordset12 >0) {
                do {
                    ...
                    $insertSQL12 = sprintf(
                        "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 12 */ UPDATE venta 
                    ...
                    $query_Recordset87 = sprintf(
                        "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 13 */ SELECT
                                        venta.cod_taquilla				
                                      FROM 
					venta
				      WHERE
                    ...
                    $query_Recordset88 = sprintf(
                        "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 14 */ SELECT
                                        taquilla.tipotaquilla, 	taquilla.saldoactual				
                                      FROM 
					taquilla
				      WHERE
                    ...
                    if ($tipotaquilla>=1) {
                        ...
                        $saldoactual=$saldoactual/1;
                        $insertSQL15 = sprintf(
                            "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 15 */ UPDATE taquilla 
				SET
				saldoactual=%s
				WHERE 
				cod_taquilla=%s",
            ...
            if ($tipoProceso==4) {// retiro de caballo
                $query_Recordset12 = sprintf(
                    "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 16 */ SELECT num_ticket, mon_venta, cod_tventa, num_caballo 
				  FROM venta 
                ...
                if ($totalRows_Recordset12>0) {
                    ...
                    do {
                        ...
                        if ($retiro==1) {
                            ...
                            $mon_venta=$row_Recordset12['mon_venta'];
                            $insertSQL12 = sprintf(
                                "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 17 */ UPDATE venta 
								SET pag_premio=%s, est_calculo=%s, saldocalculo=%s
								WHERE num_ticket=%s",
                                GetSQLValueString($mon_venta, "double"),
                            ...
                            $query_Recordset87 = sprintf(
                                "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 18 */ SELECT
                                        venta.cod_taquilla				
                                      FROM 
					venta
				      WHERE
                            ...
                            $query_Recordset88 = sprintf(
                                "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 19 */ SELECT
                                        taquilla.tipotaquilla, 	taquilla.saldoactual				
                                      FROM 
					taquilla
				      WHERE
                            ...
                            if ($tipotaquilla>=1) {
                                ...
                                $saldoactual=$saldoactual/1;
                                $insertSQL15 = sprintf(
                                    "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 20 */ UPDATE taquilla 
				SET
				saldoactual=%s
				WHERE 
				cod_taquilla=%s",
                ...
                mysqli_free_result($Recordset12);
                $query_Recordset13 = sprintf("/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 21 */ SELECT cod_taquilla FROM taquilla");
                ...
                do {
                    ...
                    $query_Recordset14 = sprintf(
                        "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 22 */ SELECT 
                    ...
                    do {
                        ...
                        if ($row_Recordset14['min_ejecarrera']>$van) {
                            ...
                            $insertSQL15 = sprintf(
                                "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 23 */ UPDATE venta 
								SET pag_premio=%s, est_calculo=%s, saldocalculo=%s
								WHERE num_ticket=%s",
                                GetSQLValueString($mon_venta, "double"),
                                GetSQLValueString(5, "int"),
                            ...
                            $query_Recordset87 = sprintf(
                                "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 24 */ SELECT
                                        venta.cod_taquilla				
                                      FROM 
					venta
				      WHERE
                            ...
                            $query_Recordset88 = sprintf(
                                "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 25 */ SELECT
                                        taquilla.tipotaquilla, 	taquilla.saldoactual				
                                      FROM 
					taquilla
				      WHERE
                            ...
                            if ($tipotaquilla>=1) {
                                ...
                                $saldoactual=$saldoactual/1;
                                $insertSQL15 = sprintf(
                                    "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 26 */ UPDATE taquilla 
				SET
				saldoactual=%s
				WHERE 
				cod_taquilla=%s",
                ...
                if ($tipoProceso==1) {// reset dividendos
                    $query_Recordset12 = sprintf(
                        "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 27 */ SELECT num_ticket 
				  FROM venta WHERE cod_carrera = %s AND est_ticket=1 AND est_calculo!=4",
                        GetSQLValueString($cod_carrera, "int")
                    );
                    $Recordset12 = mysqli_query($conexionbanca, $query_Recordset12) or die(mysqli_error($conexionbanca));
                    ...
                    if ($totalRows_Recordset12>0) {
                        do {
                            $num_ticket=$row_Recordset12['num_ticket'];
                            $insertSQL12 = sprintf(
                                "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 28 */ UPDATE venta 
							SET pag_premio=%s, est_calculo=%s, saldocalculo=%s
							WHERE num_ticket=%s",
                                GetSQLValueString(0, "double"),
                                GetSQLValueString(0, "int"),
                    ...
                    if ($tipoProceso==3) {// reintegro de caballo
                        $query_Recordset12 = sprintf(
                            "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 29 */ SELECT num_ticket, cod_tventa, num_caballo 
							  FROM venta 
                            ...
                            do {
                                ...
                                if ($acceso==1) {
                                    ...
                                    if ($acceso2==1) {
                                        $num_ticket=$row_Recordset12['num_ticket'];
                                        $insertSQL12 = sprintf(
                                            "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 30 */ UPDATE venta 
										SET pag_premio=%s, est_calculo=%s, saldocalculo=%s
										WHERE num_ticket=%s",
                                            GetSQLValueString(0, "double"),
                                            GetSQLValueString(0, "int"),
                        ...
                        if ($tipoProceso==6) {// reintegro de TODOS caballo
                            $query_Recordset12 = sprintf(
                                "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 31 */ SELECT num_ticket 
								  FROM venta 
                            ...
                            if ($totalRows_Recordset12>0) {
                                do {
                                    $num_ticket=$row_Recordset12['num_ticket'];
                                    $insertSQL12 = sprintf(
                                        "/* PARSEADORES1 includes\procesar_resultados_tickets_ame2.php - QUERY 32 */ UPDATE venta 
										SET pag_premio=%s, est_calculo=%s, saldocalculo=%s
										WHERE num_ticket=%s",
                                        GetSQLValueString(0, "double"),
                                        GetSQLValueString(0, "int"),
