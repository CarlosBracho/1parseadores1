...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 includes\cobro_hnac.php - QUERY 1 */ SELECT 
...
do {
    ...
    $query_Recordset22 =  sprintf(
        "/* PARSEADORES1 includes\cobro_hnac.php - QUERY 2 */ SELECT ve.id_usuario
        FROM  
        venta_hnac ve
        WHERE 
        ve.id_usuario = %s AND
    ...
    echo $row_Recordset1['total_venta'].' total ventas <br>';
    echo $totalRows_Recordset22.' cantidad_ventas <br>';
    if ($totalRows_Recordset22>10) {
        echo ' tiene ventas suficientes como para cobrar <br>';

        $query_Recordset2 =  sprintf(
            "/* PARSEADORES1 includes\cobro_hnac.php - QUERY 3 */ SELECT id_usuario
			FROM  
			cobro_hnac
			WHERE 
			id_usuario = %s AND
        ...
        echo $row_Recordset2['id_usuario'].' .....<br>';
        ...
        if ($totalRows_Recordset2==0) {
            ...
            $insertSQL3 = sprintf(
                "/* PARSEADORES1 includes\cobro_hnac.php - QUERY 4 */ INSERT 
			INTO cobro_hnac 
