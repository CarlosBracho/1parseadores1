...
document.onmousedown = RClick
	...
	window.open("../distri/distri_reporte_jugadas.php","_blank",propiedades2); 
	}
	function busTicket() { 
	...
	window.open("../distri/buscar_ticket.php","_blank",propiedades11); 
	}
	function cuadrecaja() { 
	propiedades11="width=500,height=680,Aresizable=no,location=no,menubar=no,scrollbars=yes,status=yes,toolbar=yes,fullscreen=no,dependent=yes";
	window.open("../distri/reporte_cuadre_americana.php","_blank",propiedades11); 
	}
...
<ul class="dropdown dropdown-horizontal" style="font-size:12px">
	...
	<li>
    	<a href="../distri/distri_reporte_carrera_carrera.php">Reporte <br/>carrera a carrera</a>
    </li>
	<li>
	...
	<li>
    	<a href="../distri/taquillas_lista.php"><br/>Taquillas</a>
			...
			<li>
    	<a href="../distri/distri_mensajesyalertas.php">mensaje<br/>a taquillas</a>
    </li>
    	<li>
