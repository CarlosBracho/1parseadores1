...
$query_Recordset1_alertas = sprintf(
        "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfo.php - QUERY 1 */ SELECT * FROM 
alertas
WHERE  
idalertas=14",
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfo.php - QUERY 2 */ SELECT * 
	FROM 
	hipodromo,
	carrera 
	WHERE
...
(hipodromo.bus_resultado_tip = 1 OR hipodromo.bus_resultado_tip = 5 OR hipodromo.bus_resultado_tip = 6 OR hipodromo.bus_resultado_tip = 7 OR hipodromo.bus_resultado_tip = 10) AND
...
if ($totalRows_Recordset1>0) {
    ...
    do {
        ...
        if ($totalRows_Recordset1>0) {
            ...
            if (($row_Recordset1['bus_resultado_tip']==1 or $row_Recordset1['bus_resultado_tip']==5 or $row_Recordset1['bus_resultado_tip']==6 or $row_Recordset1['bus_resultado_tip']==7 or $row_Recordset1['bus_resultado_tip']==10) && ($row_Recordset1['confirmandox']==0 or $row_Recordset1['confirmandox']==1)) {
                echo 'track info';
                $confirmandox=1;
            ...
            if (isset($cAct) && isset($cAct[0]) && $cAct[0]>0) {
                foreach ($cAct as $hip) {
					...
					<?php
                        ...
                        //aqui comienza
                        if ($row_Recordset1['bus_resultado_tip']==1 or $row_Recordset1['bus_resultado_tip']==5 or $row_Recordset1['bus_resultado_tip']==6 or $row_Recordset1['bus_resultado_tip']==7 or $row_Recordset1['bus_resultado_tip']==10) {
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                        ...
                        //if ($control_dividendo==2) $est_confirmacion=0;
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                    ...
                                    $updateSQL = sprintf(
                                        "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfo.php - QUERY 3 */ UPDATE carrera 
							SET 
							confirmandox=%s,
								est_confirmacion=%s,
								control_dividendo=%s,
                ...
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfo.php - QUERY 4 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfo.php - QUERY 5 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                        ...
                        //if ($control_dividendo==2) $est_confirmacion=0;
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                    ...
                                    if ($control_dividendo==2){ $hconfir=$horasistema;  }else{$hconfir='00:00:00';}
                                    $updateSQL = sprintf(
                                        "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfo.php - QUERY 6 */ UPDATE carrera 
							SET 
							confirmandox=%s,
								est_confirmacion=%s,
								control_dividendo=%s,
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfo.php - QUERY 7 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfo.php - QUERY 8 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
