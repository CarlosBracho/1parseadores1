...
document.onmousedown = RClick
	...
	window.open("../admin/distri_reporte_general.php","_blank",propiedades2); 
	}
	function mtp() { 
...
function abrir_ventana2() { 
	propiedades="width=500,height=480,Aresizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=yes";
	window.open("http://web2.interamericanas.com:9930/program1.asp","_blank",propiedades); 
	} 
...
<ul class="dropdown dropdown-horizontal" style="font-size:11px">
	<li>
    	 <a href="../admin/admin_apertura_lista.php"> Apertura <br>y Cierre </a>
    </li>
	<li>Resultados<br/>y retiros
		<ul>
            <li><a href="../admin/dividendos_lista.php">RESULTADOS</a></li>
            <li><a href="../admin/historial_lista.php">HISTORIAL</a></li>
            <li><a href="../admin/caballos_lista.php">RETIROS</a></li>
            <li><a href="../admin/busca_dividendos.php"target="_blank">DIVIDENDOS AUTOMATICOS</a></li>
		</ul>
    </li>
	<li>CARRERAS<br/> PROGRAMADAS
		<ul>
			...
			<li><a href="javascript:abrir_ventana2()")>Carreras<br>Ameridaros</a></li>
			<li><a href="javascript:abrir_ventana3()")>Alerta<br>Sonora</a></li>
		</ul>
</li>

	<li>BUSCAR<br/> TICKETS
		<ul>
			<li><a href="../admin/buscar_ticket.php"target="_blank">INTERNACIONALES<br/> INTERNACIONALES<br/> INTERNACIONALES<br/><br/> </a></li>
	                <li><a href="../admin_hnac/buscar_ticket_hnac.php"target="_blank"><br/>NACIONALES<br/> NACIONALES<br/> NACIONALES</a></li>
	...
	<li><br>Reportes
		<ul>
			<li><a href="../admin/reporte_ultimasjugadasx.php">ÚLTIMAS JUGADAS</a></li>
			<li><a href="javascript:reportegeneral()">JUGADAS</a></li>
            <li><a href="../admin/reporte_cobranza.php">COBRANZA</a></li>
            <li><a href="../admin/apuestas_pendientes.php">APUESTAS PENDIENTES</a></li>
            <li><a href="../admin/versionexplorador.php">VER VERCIONES EXPLORADORES TAQUILLAS</a></li>
<li><a href="../admin/taquillasparalelas.php">BUSCAR TAQUILLAS PARALLELAS</a></li>

            <li><a href="../admin/admin_reporte_carrera_carrera.php">REPORTE CARRERA A CARRERA</a></li>
	...
	<li><br>Usuarios
		<ul>
			...
			<li><a href="../admin/usuarios_multi_lista.php">MULTIDISTRI</a></li>
    ...
    <?php }?>
	<li>
    	<a href="../admin/hipodromo_programa_listas.php"><br/>Hipódromos</a>
    </li>
    ...
    <li><br/>sistema
	    ...
	    <li><a href="../admin/alertas_lista.php">ALERTAS</a></li>
            <?php }?>
		</ul>
