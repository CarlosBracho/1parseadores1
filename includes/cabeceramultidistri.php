...
document.onmousedown = RClick
	...
	window.open("../multidistri/distri_reporte_jugadas.php","_blank",propiedades2); 
	}
	function busTicket() { 
	...
	window.open("../multidistri/buscar_ticket.php","_blank",propiedades11); 
	}
...
<ul class="dropdown dropdown-horizontal" style="font-size:12px">
	<li>
    	 <a href="../multidistri/multidistri_reporte_general_total.php">Reporte<br/> global</a>
    </li>
	<li>
    	<a href="javascript:reportegeneral()">Reporte <br/>de jugadas</a>
    </li>
	<li>
    	<a href="../multidistri/distri_reporte_carrera_carrera.php">Reporte <br/>carrera a carrera</a>
    </li>
	<li>
	...
	<li>
    	<a href="../multidistri/bancas_lista.php"><br/>Distribuidores</a>
    </li>
	<li>
    	<a href="../multidistri/agencias_listas.php"><br/>Agentes</a>
    </li>
	<li>
    	<a href="../multidistri/taquillas_lista.php"><br/>Taquillas</a>
    </li>
			<li>
    	<a href="../multidistri/distri_mensajesyalertas.php">mensaje<br/>a taquillas</a>
    </li>
    	<li>
    	<a href="../multidistri/index.php">chat<br/> soporte</a>
    </li>
</ul>
</div>