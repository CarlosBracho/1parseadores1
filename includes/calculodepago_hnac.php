...
function jNormaHNAC(
    ...
    if ($defi_regla==0) {
        $query_Recordset1 = sprintf(
            "/* PARSEADORES1 includes\calculodepago_hnac.php - QUERY 1 */ SELECT re.div_pago_hnac, ic.est_favorito_hnac 
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 includes\calculodepago_hnac.php - QUERY 2 */ SELECT ic.est_inscrito_hnac 
			FROM inscritos ic
        ...
        $query_Recordset1 = sprintf(
            "/* PARSEADORES1 includes\calculodepago_hnac.php - QUERY 3 */ SELECT re.div_pago_hnac, ic.est_favorito_hnac, re.est_empate_hnac 
    ...
    if ($totalRows_Recordset1>0) {
        ...
        $div_oficial=$div_oficial/5;

        if($redondeo_hnac==1){
        $div_oficial=floor($div_oficial);
        } 
        if($redondeo_hnac==2){
            
            $div_oficial=round($div_oficial);
        } 
...
function jNormaSimpleHNAC(
    ...
    $dPago=0;
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 includes\calculodepago_hnac.php - QUERY 4 */ SELECT re.div_pago_hnac, ic.est_favorito_hnac 
		FROM resultados_hnac re, inscritos ic
		WHERE
		re.cod_carrera_hnac = ic.cod_carrera_hnac AND re.num_caballo_hnac = ic.num_caballo_hnac AND
		re.num_caballo_hnac = %s AND re.cod_carrera_hnac = %s AND re.fec_resultado_hnac = %s AND
...
function pFijoEjemplarHNAC($numCab, $codigoCarrera, $taqVenta)
{
    ...
    global $conexionbanca;
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 includes\calculodepago_hnac.php - QUERY 5 */ SELECT pr.pre_fijo_hnac 
		FROM 
