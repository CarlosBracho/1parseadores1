...
$query_Recordset10 = sprintf(
    "/* PARSEADORES1 includes\confirma_dividendos_hnac.php - QUERY 1 */ SELECT hi.nom_hipodromo_hnac, ca.num_carrera_hnac, hi.cod_hipodromo_hnac, ca.fec_carrera_hnac 
...
if ($totalRows_Recordset10>0) {
    $updateSQL = sprintf(
        "/* PARSEADORES1 includes\confirma_dividendos_hnac.php - QUERY 2 */ UPDATE carrera_hnac SET est_confirmacion_hnac=%s WHERE cod_carrera_hnac=%s",
