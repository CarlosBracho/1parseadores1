...
if ($nCarrera == $numeroca  && $horaInicial >= $row_Recordset1['hor_carrera_hnac'] && $nCarrera>=1) {
    ...
    $updateSQL = sprintf(
        "/* PARSEADORES1 includes\mtp_cierre_nacionales_ag2.php - QUERY 2 */ UPDATE carrera_hnac SET hor_carrera_hnac=%s 
...
if ($nCarrera == $numeroca  && $h<=0 && $m<=01  && $s<=59 && $nCarrera>=1) {
    ...
    $row_Recordset1['nom_hipodromo_hnac']." | ".$h.":".$m.".".$s." +2<br/>";
    $updateSQL = sprintf(
        "/* PARSEADORES1 includes\mtp_cierre_nacionales_ag2.php - QUERY 3 */ UPDATE carrera_hnac SET hor_carrera_hnac=%s 
											  WHERE cod_carrera_hnac=%s",
        GetSQLValueString($nuevaHora, "date"),
        GetSQLValueString($cod_carrera_hnac1, "int")
    );
...
if ($nCarrera <> $numeroca && $nCarrera>=1 && $xdelaycierre==5) {
    $updateSQL = sprintf(
        "/* PARSEADORES1 includes\mtp_cierre_nacionales_ag2.php - QUERY 4 */ UPDATE carrera_hnac SET hor_carrera_hnac=%s, est_carrera_hnac=%s,	est_cierre_hnac=%s 
										  WHERE cod_carrera_hnac=%s",
...
if ($nCarrera <> $numeroca && $nCarrera>=1 && $xdelaycierre==4) {
    $updateSQL = sprintf(
        "/* PARSEADORES1 includes\mtp_cierre_nacionales_ag2.php - QUERY 5 */ UPDATE carrera_hnac SET cierredelay=%s 
										  WHERE cod_carrera_hnac=%s",
...
if ($nCarrera <> $numeroca && $nCarrera>=1 && $xdelaycierre==3) {
    $updateSQL = sprintf(
        "/* PARSEADORES1 includes\mtp_cierre_nacionales_ag2.php - QUERY 6 */ UPDATE carrera_hnac SET cierredelay=%s 
										  WHERE cod_carrera_hnac=%s",
...
if ($nCarrera <> $numeroca && $nCarrera>=1 && $xdelaycierre==2) {
    $updateSQL = sprintf(
        "/* PARSEADORES1 includes\mtp_cierre_nacionales_ag2.php - QUERY 7 */ UPDATE carrera_hnac SET cierredelay=%s 
										  WHERE cod_carrera_hnac=%s",
...
if ($nCarrera <> $numeroca && $nCarrera>=1 && $xdelaycierre==1) {
    $updateSQL = sprintf(
        "/* PARSEADORES1 includes\mtp_cierre_nacionales_ag2.php - QUERY 8 */ UPDATE carrera_hnac SET cierredelay=%s 
										  WHERE cod_carrera_hnac=%s",
...
if ($nCarrera <> $numeroca && $nCarrera>=1 && $xdelaycierre==0) {
    $updateSQL = sprintf(
        "/* PARSEADORES1 includes\mtp_cierre_nacionales_ag2.php - QUERY 9 */ UPDATE carrera_hnac SET cierredelay=%s 
										  WHERE cod_carrera_hnac=%s",
        GetSQLValueString(1, "int"),
        GetSQLValueString($cod_carrera_hnac1, "int")
    );
...
if ($nCarrera == $numeroca && horaactual()>=$row_Recordset1['hor_carrera_hnac'] && $nCarrera>=1) {
    ...
    $row_Recordset1['nom_hipodromo_hnac']." | ".$h.":".$m.".".$s." +2<br/>";
    $updateSQL = sprintf(
        "/* PARSEADORES1 includes\mtp_cierre_nacionales_ag2.php - QUERY 10 */ UPDATE carrera_hnac SET hor_carrera_hnac=%s 
											  WHERE cod_carrera_hnac=%s",
        GetSQLValueString($nuevaHora, "date"),
        GetSQLValueString($cod_carrera_hnac1, "int")
    );
...
if ($nCarrera == $numeroca && $nCarrera>=1 && $xdelaycierre>=1) {
    $updateSQL = sprintf(
        "/* PARSEADORES1 includes\mtp_cierre_nacionales_ag2.php - QUERY 11 */ UPDATE carrera_hnac SET cierredelay=%s 
										  WHERE cod_carrera_hnac=%s",
        GetSQLValueString(0, "int"),
        GetSQLValueString($cod_carrera_hnac1, "int")
    );
...
if ($nCarrera == $numeroca && $nCarrera>=1 && $estadodecarrera==0) {
    ...
    $updateSQL = sprintf(
        "/* PARSEADORES1 includes\mtp_cierre_nacionales_ag2.php - QUERY 12 */ UPDATE carrera_hnac SET hor_carrera_hnac=%s, est_carrera_hnac=%s,	est_cierre_hnac=%s, cierredelay=%s 
										  WHERE cod_carrera_hnac=%s",
        GetSQLValueString($nuevaHora, "date"),
        GetSQLValueString(1, "int"),
        GetSQLValueString(3, "int"),
