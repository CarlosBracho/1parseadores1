...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfoallydemas.php - QUERY 1 */ SELECT * 
	FROM 
	hipodromo,
	carrera 
	WHERE
...
if ($totalRows_Recordset1>0) {
    ...
    do {
        ...
        if ($totalRows_Recordset1>0) {
            ...
            if (($row_Recordset1['bus_resultado_tip']==333 or $row_Recordset1['bus_resultado_tip']==555 or $row_Recordset1['bus_resultado_tip']==666 or $row_Recordset1['bus_resultado_tip']==888) && ($row_Recordset1['confirmandox']==0 or $row_Recordset1['confirmandox']==3)) {
                echo 'build';
                $confirmandox=3;
            ...
            if (isset($cAct) && isset($cAct[0]) && $cAct[0]>0) {
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                        ...
                        //if ($control_dividendo==2) $est_confirmacion=0;
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                    ...
                                    $updateSQL = sprintf(
                                        "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfoallydemas.php - QUERY 2 */ UPDATE carrera 
							SET 
							confirmandox=%s,
								est_confirmacion=%s,
								control_dividendo=%s,
                ...
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfoallydemas.php - QUERY 3 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfoallydemas.php - QUERY 4 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
                ...
                $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
                        ...
                        if ($row_Recordset1['valorbuildabet']==222) {
                            if ($row_Recordset1['control_dividendo']==1) {
                                if ($row_Recordset1['eje_primero']==$eje_primero*1 &&
                    ...
                    $row_Recordset1['ord_superfecta_triple']==trim($ord_superfecta_triple)) {
                        ...
                        //if ($control_dividendo==2) $est_confirmacion=0;
                            ...
                            $DivWinPriLugar[$hip]==0)) {
                                    ...
                                    if ($control_dividendo==2){ $hconfir=$horasistema;  }else{$hconfir='00:00:00';}
                                    $updateSQL = sprintf(
                                        "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfoallydemas.php - QUERY 5 */ UPDATE carrera 
							SET 
							confirmandox=%s,
								est_confirmacion=%s,
								control_dividendo=%s,
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfoallydemas.php - QUERY 6 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\dividendos_totalrecargadotrackinfoallydemas.php - QUERY 7 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
