...
foreach ($matches10[0] as $datos) {
    ...
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 1 */ SELECT *
FROM p1equipos
WHERE  
nomequipop1 = %s",
    ...
    $query_Recordset22 = sprintf(
        "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 2 */ SELECT *
FROM p1equipos
WHERE  
nomequipop1 = %s",
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 3 */ SELECT * 
FROM p2juegos 
WHERE  
idequipo1p2 = %s  AND
pichee1p2 = %s  AND
...
<\/span>%siU", $iML, $matchesML);
    ...
    if ($totalRows_Recordset1>0) {
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 4 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
tipojugadap3 = 'ML'",
        ...
        if ($row_Recordset2['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 5 */ UPDATE p3logros 
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 6 */ INSERT 
				INTO p3logros
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 7 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
tipojugadap3 = 'ML'",
        ...
        if ($row_Recordset3['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 8 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 9 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
...
<\/span>%siU", $iAB, $matchesAB);
    ...
    if ($totalRows_Recordset1>0) {
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 10 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
tipojugadap3 = 'A'",
        ...
        if ($row_Recordset2['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 11 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 12 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 13 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
tipojugadap3 = 'B'",
        ...
        if ($row_Recordset3['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 14 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 15 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
...
<\/span>%siU", $iRL, $matchesRL);
    ...
    if ($totalRows_Recordset1>0) {
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 16 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
tipojugadap3 = 'RL'",
        ...
        if ($row_Recordset2['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 17 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 18 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 19 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
tipojugadap3 = 'RL'",
        ...
        if ($row_Recordset3['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 20 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 21 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
...
<\/span>%siU", $iML5in, $matchesML5in);
    ...
    if ($totalRows_Recordset1>0) {
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 22 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
tipojugadap3 = '5ML'",
        ...
        if ($row_Recordset2['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 23 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 24 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 25 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
tipojugadap3 = '5ML'",
        ...
        if ($row_Recordset3['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 26 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 27 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
...
<\/span>%siU", $iAB5in, $matchesAB5in);
    ...
    if ($totalRows_Recordset1>0) {
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 28 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
tipojugadap3 = '5A'",
        ...
        if ($row_Recordset2['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 29 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 30 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 31 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
tipojugadap3 = '5B'",
        ...
        if ($row_Recordset3['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 32 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 33 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
...
<\/span>%siU", $iRL5in, $matchesRL5in);
    ...
    if ($totalRows_Recordset1>0) {
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 34 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
tipojugadap3 = '5RL'",
        ...
        if ($row_Recordset2['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 35 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 36 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 37 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
tipojugadap3 = '5RL'",
        ...
        if ($row_Recordset3['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 38 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 39 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
...
<\/span>%siU", $Anota1ero, $matchesAnota1ero);
    ...
    if ($totalRows_Recordset1>0) {
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 40 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
tipojugadap3 = 'AP'",
        ...
        if ($row_Recordset2['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 41 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 42 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 43 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
tipojugadap3 = 'AP'",
        ...
        if ($row_Recordset3['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 44 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 45 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
...
<\/span>%siU", $SINO, $matchesSINO);
    ...
    if ($totalRows_Recordset1>0) {
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 46 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
tipojugadap3 = 'SI'",
        ...
        if ($row_Recordset2['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 47 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 48 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 49 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
tipojugadap3 = 'NO'",
        ...
        if ($row_Recordset3['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 50 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 51 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
...
<\/span>%siU", $iABHCE, $matchesABHCE);
    ...
    if ($totalRows_Recordset1>0) {
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 52 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =1 AND
idjuegop3 = %s AND
tipojugadap3 = 'AG'",
        ...
        if ($row_Recordset2['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 53 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 54 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 55 */ SELECT *
FROM  p3logros
WHERE 
equipop3 =2 AND
idjuegop3 = %s AND
tipojugadap3 = 'BG'",
        ...
        if ($row_Recordset3['Id_p3logrosp3']>0) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 56 */ UPDATE p3logros 
				SET logrop3=%s, logroABoRLp3=%s			
				WHERE Id_p3logrosp3=%s",
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\splogrosparleyla.php - QUERY 57 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset1['Id_p2juegosp2'], "int"),
