...
if (isset($_POST["codCar"]) && isset($_POST["modo"])) {
    $query_Recordset2 = sprintf("/* PARSEADORES1 includes\cambio_mtp_hipodromo_hnac.php - QUERY 1 */ SELECT cod_hipodromo_hnac, nom_hipodromo_hnac FROM hipodromo_hnac 
    ...
    if ($totalRows_Recordset2>0) {
        ...
        $updateSQL2 = sprintf(
            "/* PARSEADORES1 includes\cambio_mtp_hipodromo_hnac.php - QUERY 2 */ UPDATE hipodromo_hnac SET bus_resultado_hnac=%s, bus_inscrito_hnac=%s, bus_retirado_hnac=%s 
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 includes\cambio_mtp_hipodromo_hnac.php - QUERY 3 */ INSERT 
						INTO bitacora 
        ...
        $query_Recordset1 = sprintf(
            "/* PARSEADORES1 includes\cambio_mtp_hipodromo_hnac.php - QUERY 4 */ SELECT carrera.cod_carrera_hnac, carrera.num_carrera_hnac, 
        ...
        if ($totalRows_Recordset1>0) {
            ...
            do {
                ...
                if ($_POST["modo"]==0 || $_POST["modo"]==1 || $_POST["modo"]==2) {
                    $updateSQL1 = sprintf(
                        "/* PARSEADORES1 includes\cambio_mtp_hipodromo_hnac.php - QUERY 5 */ UPDATE carrera_hnac SET mtp_control_hnac=%s 
                    ...
                    $des=$des1.$des2;
                    $insertSQL12 = sprintf(
                        "/* PARSEADORES1 includes\cambio_mtp_hipodromo_hnac.php - QUERY 6 */ INSERT 
									INTO bitacora 
									(des_bitacora, hor_bitacora, fec_bitacora) 
									VALUES (%s, %s, %s)",
                        GetSQLValueString($des, "text"),
