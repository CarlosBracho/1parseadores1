...
<nav>
    <ul>
        <li><a href="../multidistri/index.php">Carreras <br/>Internacionales</a></li>
        <li><a href="../multidistri_hnac/index.php">CARRERAS <br/>NACIONALES</a></li>
		<li><a href="../multidistri/1parley.php">PARLEY <br/><br/></a></li>
		<li><a href="../apostador/listaapostadoraM.php">LISTA <br/>APOSTADORES</a></li>
