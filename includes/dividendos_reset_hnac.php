...
if (isset($_GET["recordID"])) {
    ...
    $query_Recordset1 = sprintf("/* PARSEADORES1 includes\dividendos_reset_hnac.php - QUERY 1 */ SELECT fec_carrera_hnac FROM carrera_hnac 
    ...
    if ($totalRows_Recordset1>0) {
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 includes\dividendos_reset_hnac.php - QUERY 2 */ SELECT * FROM resultados_oficiales_hnac 
		WHERE 
    ...
    if ($totalRows_Recordset2>0) {
        do {
            ...
            $insertSQL = sprintf(
                "/* PARSEADORES1 includes\dividendos_reset_hnac.php - QUERY 3 */ UPDATE resultados_oficiales_hnac 
					SET 
					num_caballo_hnac=%s, 
					div_pago_hnac=%s 
