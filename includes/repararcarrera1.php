...
$horasistema=horaactual();
    $query_Recordset1 = sprintf("/* PARSEADORES1 includes\repararcarrera1.php - QUERY 1 */ SELECT 
	ca.cod_carrera,
	ca.nom_hipodromo,
	ca.num_carrera,
	ca.fec_carrera	
...
if ($totalRows_Recordset1>0) {
    do {
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 includes\repararcarrera1.php - QUERY 2 */ UPDATE carrera SET est_carrera=%s  
							  WHERE cod_carrera=%s",
