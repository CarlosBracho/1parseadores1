...
$query_Recordset1_alertas = sprintf(
        "/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 1 */ SELECT * FROM 
alertas
WHERE  
idalertas=5",
...
$query_Recordset111 = sprintf("/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 2 */ SELECT * 
	FROM 
	cookies 
	WHERE
...
$query_Recordset1 = sprintf("/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 3 */ SELECT 
		hi.pre_twin,
		hi.nom_hipodromo,
		ca.cod_carrera,
		ca.num_carrera,
...
curl_setopt($ch, CURLOPT_COOKIEFILE, 'twinspirecookie.txt');
$headers = array();
...
if (curl_errno($ch)) {
    ...
    $updateSQL = sprintf("/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 4 */ UPDATE cookies SET errorcookie=errorcookie+1
    WHERE 	id_cookie = 1 AND cookinombre=%s",
    GetSQLValueString("twinspire", "text"));
    $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
    $query_Recordset112 = sprintf("/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 5 */ SELECT * 
        FROM 
        cookies 
        WHERE
        id_cookie = 1 AND cookinombre = %s
    ...
    if($row_Recordset112['errorcookie']>5){
        $updateSQL = sprintf("/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 6 */ UPDATE cookies SET errorcookie=errorcookie+1, cookiefull=0
        WHERE 	id_cookie = 1 AND cookinombre=%s",
        GetSQLValueString("twinspire", "text"));
        $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
    }
...
if ($last==0 && $horasistema<="17:00:00") {
    $updateSQL = sprintf("/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 7 */ UPDATE alertas SET contadoralerta=contadoralerta+1, contadorfallos=contadorfallos+1
    WHERE idalertas=%s",
    ...
    $query_Recordset11 = sprintf("/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 8 */ SELECT 
...
echo $msj;
$updateSQL = sprintf("/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 9 */ UPDATE alertas SET  fec_alerta=%s, hor_alerta=%s , contadorfallos=0
WHERE idalertas=%s",
GetSQLValueString($fech, "date"),
...
$updateSQL = sprintf("/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 10 */ UPDATE alertas SET contadoralerta=contadoralerta+1, fec_alerta=%s, hor_alerta=%s , contadorfallos=0
WHERE idalertas=%s",
GetSQLValueString($fech, "date"),
GetSQLValueString($horasistema, "date"),
GetSQLValueString(9, "int"));
...
<?php
               $updateSQL = sprintf("/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 11 */ UPDATE carrera SET 
               hor_carrera=%s, 
               hor_mtp=%s, 
               est_carrera=%s, 
               est_cierre=%s, 
               ...
               $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
                ...
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 12 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
...
echo $row_Recordset1['nom_hipodromo']." | ".$h.":".$m.".".$s." +2<br/>";
                   $updateSQL = sprintf("/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 13 */ UPDATE carrera SET hor_carrera=%s, hor_mtp=%s 
                                     WHERE cod_carrera=%s",
...
if ($row_Recordset1['est_carrera']==1 && $row_Recordset1['est_cierre']==2 && $control==1 && $last!=0) {
   ...
   $est=0;
   $cie=1;
   $updateSQL = sprintf("/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 14 */ UPDATE carrera SET 
   hor_carrera=%s, 
   hor_mtp=%s, 
   est_carrera=%s, 
   est_cierre=%s, 
   ...
   $Result1 = mysqli_query($conexionbanca, $updateSQL) or die(mysqli_error($conexionbanca));
                ...
                $fechaactual=fechaactualbd();
                $insertSQL = sprintf(
                    "/* PARSEADORES1 includes\twinspire_solocierre_v4.php - QUERY 15 */ INSERT INTO quiencierrayabre 
					(codcarrera, 
					fechaquien, 
					que) 
					VALUES (%s, %s, %s)",
