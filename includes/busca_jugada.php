...
if ($tip_usuario=="A") {
    $query_Recordset1D = sprintf(
        "/* PARSEADORES1 includes\busca_jugada.php - QUERY 1 */ SELECT *
		FROM 
			venta,
			carrera,
			usuario,
...
$totalRows_Recordset1D = mysqli_num_rows($Recordset1D);
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 includes\busca_jugada.php - QUERY 2 */ SELECT *
		FROM 
			venta,
			carrera,
			usuario,
...
if ($tip_usuario=="U") {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 includes\busca_jugada.php - QUERY 3 */ SELECT venta.est_ticket, venta.ser_venta, venta.fec_venta, venta.hor_venta,
...
if ($tip_usuario=="G") {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 includes\busca_jugada.php - QUERY 4 */ SELECT 
			ve.est_ticket, 
			ve.ser_venta, 
			ve.fec_venta, 
			ve.hor_venta,
...
if ($tip_usuario=="D") {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 includes\busca_jugada.php - QUERY 5 */ SELECT 
			ve.est_ticket, 
			ve.ser_venta, 
			ve.fec_venta, 
			ve.hor_venta,
...
if ($ver==1) {
    if ($row_Recordset1['est_confirmacion']==0 && $row_Recordset1['est_carrera']==0 && $row_Recordset1['est_ticket']!=0) {
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 includes\busca_jugada.php - QUERY 6 */ SELECT
...
$hora1=$row_Recordset1['hor_venta'];
    ...
    do { ?>
        ...
        <tr>
              <td height="10" colspan="4" align="center"><?php echo "________________________________"; ?>
        </td>
        </tr>
...
<br><br><br>
    ...
    <td bgcolor="#CCCCCC"><strong><?php echo $row_Recordset1D['eje_primero']; ?></strong></td>
    <td bgcolor="#CCCCCC"><strong><?php echo $row_Recordset1D['div_primero_gan']; ?></strong></td>
    <td bgcolor="#CCCCCC"><strong><?php echo $row_Recordset1D['div_primero_pla']; ?></strong></td>
    <td bgcolor="#CCCCCC"><strong><?php echo $row_Recordset1D['div_primero_sho']; ?></strong></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr align="center">
    ...
    <td bgcolor="#CCCCCC"><strong><?php echo $row_Recordset1D['eje_segundo']; ?></strong></td>
    <td bgcolor="#CCCCCC">&nbsp;</td>
    <td bgcolor="#CCCCCC"><strong><?php echo $row_Recordset1D['div_segundo_pla']; ?></strong></td>
    <td bgcolor="#CCCCCC"><strong><?php echo $row_Recordset1D['div_segundo_sho']; ?></strong></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr align="center">
    ...
    <td bgcolor="#CCCCCC"><strong><?php echo $row_Recordset1D['eje_tercero']; ?></strong></td>
    <td bgcolor="#CCCCCC">&nbsp;</td>
    <td bgcolor="#CCCCCC">&nbsp;</td>
    <td bgcolor="#CCCCCC"><strong><?php echo $row_Recordset1D['div_tercero_sho']; ?></strong></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr align="center">
    ...
    <td bgcolor="#CCCCCC"><strong><?php echo $row_Recordset1D['eje_cuarto']; ?></strong></td>
    <td bgcolor="#CCCCCC">&nbsp;</td>
    <td bgcolor="#CCCCCC">&nbsp;</td>
    <td bgcolor="#CCCCCC">&nbsp;</td>
    <td>&nbsp;</td>
...
window.open("../admin/taquillas_edit_ame.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>","_blank",pro1+pro2); 
} 
</script>


<br/> <a href="javascript:cambio()"class="btn btn-info" style="font-size: 12px;">CONFIGURACION HIPISMO<br/>INTERNACIONAL DE <br/>ESTA TAQUILLA</a>
