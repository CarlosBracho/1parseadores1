...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 includes\elimina_ticket_lot.php - QUERY 1 */ SELECT num_ticket_lot, id_usuario 
	FROM 
	venta_lot 
	WHERE 
	ticket_lot = %s",
...
if ($totalRows_Recordset3>0) {
    ...
    do {
        $updateSQL3 = sprintf(
            "/* PARSEADORES1 includes\elimina_ticket_lot.php - QUERY 2 */ UPDATE venta_lot SET est_ticket_lot=%s, fec_pago_lot=%s, hor_pago_lot=%s 
