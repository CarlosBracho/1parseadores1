<script language="javascript"> 
	...
	window.open("../ventashnac_mie/ventas_reimprimir_hnacP.php","_blank",propiedades); 
	}
	...
	window.open("../ventashnac_mie/ventas_reimprimir_ultimo_hnacP.php","_blank",propiedades); 
	} 
	function dividendos() { 
...
window.location="../acceso.php";
    ...
    margin:-17px 0px 0px 0px">
    <a style="color:#FFF" href="../parley/1taparley.php" title="Ir a PARLEY">Ir a <br/>PARLEY</a>
    </div>
