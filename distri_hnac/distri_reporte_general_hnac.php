...
$query_Recordset12 = sprintf(
    "/* PARSEADORES1 distri_hnac\distri_reporte_general_hnac.php - QUERY 1 */ SELECT por_banca_hnac FROM banca WHERE cod_banca = %s LIMIT 1",
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 distri_hnac\distri_reporte_general_hnac.php - QUERY 2 */ SELECT * 
	FROM 
		agencia
	WHERE
		agencia.cod_banca = %s
    ...
    if (isset($_POST['fecha_inicio']) && isset($_POST['fecha_fin'])) {
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_agencia']!="todos") {
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 distri_hnac\distri_reporte_general_hnac.php - QUERY 3 */ SELECT * 
					FROM 
						agencia 
					WHERE 
						cod_agencia = %s",
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 distri_hnac\distri_reporte_general_hnac.php - QUERY 4 */ SELECT * 
	FROM 
		agencia
	WHERE
		agencia.cod_banca = %s
               ...
               do {
                   ...
                   echo "| Correo: ".$row_Recordset3['cor_agencia']; ?>
                    ...
                    $query_Recordset1 = sprintf(
                       "/* PARSEADORES1 distri_hnac\distri_reporte_general_hnac.php - QUERY 5 */ SELECT
						ta.cod_taquilla, 
						ta.nom_taquilla, 
