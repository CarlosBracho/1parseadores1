<?php
    ...
    "/* PARSEADORES1 distri_hnac\base_hnac\bVenta_us_hnac.php - QUERY 1 */ SELECT 
					us.nom_usuario,
...
<?php
    ...
    "/* PARSEADORES1 distri_hnac\base_hnac\bVenta_us_hnac.php - QUERY 2 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla, ta.efectivoO,
					ta.taq_cob_hnac,
					tp.ver_porpagar_hnac,
...
<?php
    ...
    "/* PARSEADORES1 distri_hnac\base_hnac\bVenta_us_hnac.php - QUERY 3 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla, ta.efectivoO,
					ta.taq_cob_hnac,
					tp.ver_porpagar_hnac,
...
<?php
    ...
    "/* PARSEADORES1 distri_hnac\base_hnac\bVenta_us_hnac.php - QUERY 4 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla, ta.efectivoO,
					ta.taq_cob_hnac,
					tp.ver_porpagar_hnac,
...
<?php
    ...
    "/* PARSEADORES1 distri_hnac\base_hnac\bVenta_us_hnac.php - QUERY 5 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla, ta.efectivoO,
					ta.taq_cob_hnac,
					tp.ver_porpagar_hnac,
...
<?php
    ...
    "/* PARSEADORES1 distri_hnac\base_hnac\bVenta_us_hnac.php - QUERY 6 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla, ta.efectivoO,
					ta.taq_cob_hnac,
					tp.ver_porpagar_hnac,
...
<?php
    ...
    "/* PARSEADORES1 distri_hnac\base_hnac\bVenta_us_hnac.php - QUERY 7 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla, ta.efectivoO,
					ta.taq_cob_hnac,
					tp.ver_porpagar_hnac,
