...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $_POST['tip_usuario']="G";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 distri_hnac\distri_usuarios_ag_edit_hnac.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
				est_usuario=%s, 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 distri_hnac\distri_usuarios_ag_edit_hnac.php - QUERY 2 */ SELECT * 
	FROM 
