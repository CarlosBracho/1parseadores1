...
$query_Recordset18D =  sprintf(
    "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 1 */ SELECT  
*
...
$query_Recordsetuno24 = sprintf(
    "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 2 */ SELECT * 
FROM p6logrosind
WHERE  
idp6logrosind = %s",
...
if($row_Recordsetuno24['logrodtp6']<>$fechahora){
    $insertSQL24 = sprintf(
        "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 3 */ UPDATE p6logrosind  
SET logrodtp6=%s			
WHERE 
idp6logrosind = %s", 
    ...
    $insertSQL25 = sprintf(
        "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 4 */ UPDATE p6logrosind  
SET logrodtp6=%s			
WHERE 
idp6logrosind = %s", 
...
$updateSQL = sprintf("/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 5 */ UPDATE alertas SET contadoralerta=contadoralerta+1, fec_alerta=%s, hor_alerta=%s , contadorfallos=0
WHERE idalertas=%s",
...
$query_Recordsetuno1 = sprintf(
    "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 6 */ SELECT * 
FROM p3logros 
WHERE  
idjuegop3 = %s AND
logrodtp3 >= %s",
...
if ($totalRows_Recordsetuno1==0) {
    $insertSQL = sprintf(
        "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 7 */ INSERT 
INTO p3logros
...
function verificarjuego($codWiningBet)
{
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 8 */ SELECT Id_p2juegosp2, idequipo1p2, idequipo2p2, pichee1p2, pichee2p2, codWiningBet_empate
    FROM p2juegos 
    WHERE  
    iniciodtp2 > %s AND
    codWiningBet = %s ",
...
function updatepiche($matches10px, $todox, $equipo)
{
    ...
    if ($equipo==1) {
        ...
        $datetime=$FechaTxt.' '.$horaTxt;
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 9 */ UPDATE p2juegos  
SET pichee1p2=%s			
WHERE 
iniciodtp2 > %s AND
codWiningBet=%s",
    ...
    if ($equipo==2) {
        ...
        $datetime=$FechaTxt.' '.$horaTxt;
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 10 */ UPDATE p2juegos  
SET pichee2p2=%s			
WHERE 
iniciodtp2 > %s AND
codWiningBet=%s",
...
function updatelogro($todolo1, $todolo2, $Id_p3logrosp3)
{
    ...
    $datetime=$FechaTxt.' '.$horaTxt;
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 11 */ UPDATE p3logros 
...
function insertlogro($Id_p2juegosp2in, $Id_p1equiposp1in, $equipoin, $todoin1, $todoin2, $datetimein, $todoin3)
{
    ...
    $datetime=$FechaTxt.' '.$horaTxt;
    $insertSQL = sprintf(
        "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 12 */ INSERT 
INTO p3logros
(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
$query_Recordset111 = sprintf(
    "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 13 */ SELECT logrop3, Id_p3logrosp3, logroABoRLp3, idjuegop3, equipop3, tipojugadap3
FROM  p3logros
...
$query_Recordset19 = sprintf(
    "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 14 */ SELECT Id_p2juegosp2, idequipo1p2, idequipo2p2, pichee1p2, pichee2p2, codWiningBet_empate, codWiningBet
FROM p2juegos 
WHERE  
iniciodtp2 > %s",
    GetSQLValueString($FechaTxt.' 00:00:01', "date")
...
///*
  ...
  $query_Recordset21 = sprintf(
    "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 15 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
...
if ($totalRows_Recordset21==0) {
    ...
    echo " . . .";
    $insertSQL = sprintf(
        "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 16 */ INSERT 
INTO p1equipos
...
VALUES (%s, %s, %s, %s, %s)",
    ...
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 17 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
        GetSQLValueString($e1, "text")
...
$query_Recordset22 = sprintf(
  "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 18 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
...
if ($totalRows_Recordset22==0) {
  ...
  echo " . . .";
  $insertSQL = sprintf(
      "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 19 */ INSERT 
INTO p1equipos
(nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
VALUES (%s, %s, %s, %s, %s)",
      GetSQLValueString($e2, "text"),
  ...
  $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
  $query_Recordset22 = sprintf(
      "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 20 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
      GetSQLValueString($e2, "text")
...
$horajuego = date('Y-m-j H:i:s', $horajuego);
...
if ($totaltotalRows==0) {
    ...
    if ($totaltotalRows==0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 21 */ INSERT 
INTO p2juegos
...
if(strpos($datoscurl2, '2.ZZ.img.ZZ.srcassetsparlaydeportesfut')){ echo ' Futbol '; $ja++;
  ...
  $query_Recordset21 = sprintf(
    "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 22 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
GetSQLValueString($e1, "text"));
...
if ($totalRows_Recordset21==0) {
    ...
    echo " . . .";
    $insertSQL = sprintf(
        "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 23 */ INSERT 
INTO p1equipos
(nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
VALUES (%s, %s, %s, %s, %s)",
        GetSQLValueString($e1, "text"),
    ...
    $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 24 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
        GetSQLValueString($e1, "text")
...
$query_Recordset22 = sprintf(
  "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 25 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
GetSQLValueString($e2, "text"));
...
if ($totalRows_Recordset22==0) {
  ...
  echo " . . .";
  $insertSQL = sprintf(
      "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 26 */ INSERT 
INTO p1equipos
(nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
VALUES (%s, %s, %s, %s, %s)",
      GetSQLValueString($e2, "text"),
  ...
  $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
  $query_Recordset22 = sprintf(
      "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 27 */ SELECT Id_p1equiposp1
FROM p1equipos
WHERE  
nomwinningbet = %s",
      GetSQLValueString($e2, "text")
...
if ($totaltotalRows==0) {
    ...
    if ($totaltotalRows==0) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 28 */ INSERT 
INTO p2juegos
(idequipo1p2, idequipo2p2, deportep2, codWiningBet, iniciodtp2) 
VALUES (%s, %s, %s, %s, %s)",
            GetSQLValueString($row_Recordset21['Id_p1equiposp1'], "int"),
...
if(strpos($datoscurl2, '2.ZZ.img.ZZ.srcassetsparlaydeportesnba')){ echo ' Baloncesto '; $ja++;
    ...
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 29 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
    GetSQLValueString($e1, "text"));
    ...
    if ($totalRows_Recordset21==0) {
        ...
        echo " . . .";
        $insertSQL = sprintf(
            "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 30 */ INSERT 
    INTO p1equipos
    (nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
    VALUES (%s, %s, %s, %s, %s)",
            GetSQLValueString($e1, "text"),
        ...
        $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset21 = sprintf(
            "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 31 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
            GetSQLValueString($e1, "text")
    ...
    $query_Recordset22 = sprintf(
      "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 32 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
    GetSQLValueString($e2, "text"));
    ...
    if ($totalRows_Recordset22==0) {
      ...
      echo " . . .";
      $insertSQL = sprintf(
          "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 33 */ INSERT 
    INTO p1equipos
    (nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
    VALUES (%s, %s, %s, %s, %s)",
          GetSQLValueString($e2, "text"),
      ...
      $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
      $query_Recordset22 = sprintf(
          "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 34 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
          GetSQLValueString($e2, "text")
    ...
    if ($totaltotalRows==0) {
        ...
        if ($totaltotalRows==0) {
            $insertSQL = sprintf(
                "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 35 */ INSERT 
    INTO p2juegos
    (idequipo1p2, idequipo2p2, deportep2, codWiningBet, iniciodtp2) 
    VALUES (%s, %s, %s, %s, %s)",
                GetSQLValueString($row_Recordset21['Id_p1equiposp1'], "int"),
...
if(strpos($datoscurl2, '2.ZZ.img.ZZ.srcassetsparlaydeportesnhl')){ echo ' Hoskey <br>'; $ja++;
   // var_dump($datoscurl2);
    ...
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 36 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
    GetSQLValueString($e1, "text"));
    ...
    if ($totalRows_Recordset21==0) {
        ...
        echo " . . .";
        $insertSQL = sprintf(
            "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 37 */ INSERT 
    INTO p1equipos
    (nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
    VALUES (%s, %s, %s, %s, %s)",
            GetSQLValueString($e1, "text"),
        ...
        $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset21 = sprintf(
            "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 38 */ SELECT Id_p1equiposp1
    FROM p1equipos
    WHERE  
    nomwinningbet = %s",
            GetSQLValueString($e1, "text")
    ...
    $query_Recordset22 = sprintf(
        "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 39 */ SELECT Id_p1equiposp1
      FROM p1equipos
      WHERE  
      nomwinningbet = %s",
      GetSQLValueString($e2, "text"));
      ...
      if ($totalRows_Recordset22==0) {
        ...
        echo " . . .";
        $insertSQL = sprintf(
            "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 40 */ INSERT 
      INTO p1equipos
      (nomequipop1, nomdimp1, nomwinningbet, deportep1, ordenp1) 
      VALUES (%s, %s, %s, %s, %s)",
            GetSQLValueString($e2, "text"),
        ...
        $Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
        $query_Recordset22 = sprintf(
            "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 41 */ SELECT Id_p1equiposp1
      FROM p1equipos
      WHERE  
      nomwinningbet = %s",
            GetSQLValueString($e2, "text")
      ...
      if ($totaltotalRows==0) {
          ...
          if ($totaltotalRows==0) {
              $insertSQL = sprintf(
                  "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 42 */ INSERT 
      INTO p2juegos
      (idequipo1p2, idequipo2p2, deportep2, codWiningBet, iniciodtp2) 
      VALUES (%s, %s, %s, %s, %s)",
                  GetSQLValueString($row_Recordset21['Id_p1equiposp1'], "int"),
...
$query_Recordset17 = sprintf(
    "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 43 */ SELECT p2juegos.Id_p2juegosp2, p2juegos.idequipo1p2, p2juegos.idequipo2p2, p2juegos.pichee1p2, 
...
$insertSQL1 = sprintf(
    "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 44 */ UPDATE p2juegos 
  SET competicionp2=%s		
  WHERE 
  Id_p2juegosp2=%s",
...
$query_Recordset1111 = sprintf(
    "/* PARSEADORES1 sincronizado\WiningBet_con_array.php - QUERY 45 */ SELECT p3logros.idjuegop3, p1equipos.nomequipop1
