...
$query_Recordset1111 = sprintf(
    "/* PARSEADORES1 sincronizado\php.php - QUERY 1 */ SELECT Id_p2juegosp2
FROM  p2juegos
...
$totalRows_Recordset1111 = mysqli_num_rows($Recordset1111);
  ...
  do {
    $query_Recordset3 = sprintf(
        "/* PARSEADORES1 sincronizado\php.php - QUERY 2 */ SELECT logrop3, Id_p3logrosp3, logroABoRLp3, idjuegop3, equipop3, tipojugadap3
    FROM  p3logros
    ...
    if($totalRows_Recordset3>0){echo 'si tiene logros ';}else{
        ...
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 sincronizado\php.php - QUERY 3 */ UPDATE p2juegos 
				SET iniciodtp2=%s 
