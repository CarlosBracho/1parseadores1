<?php
//incluyo el cï¿½digo de la clase stoper
...
$query_Recordset18D =  sprintf(
    "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 1 */ SELECT  
*
...
$actualizologro=0;
$a1111='REAL MADRID ESP';
$b2222='REAL MADRID ESP';
if($a1111==$b2222){ echo 'uno es igual a dos<br>';}

//estosolo apra borrar logros
/*
$id='2022-04-04 00:00:00	';
...
$url='https://localhost/new/sincronizado/maradeporteslogross.html';
...
//list($logroactualizado)=verificarlogro($yaestaequipo1cod, $datoscurl2223[3][0], $tipojugada, $idp10juego, 1, $logrodate, $tlarray1lg, $Fechahoramara, 0);}
if($row_Recordset18D['Swicht']==1){
//inicio funciones1
function verificarlogro($yaestaequipo1cod, $logro, $tipojugada, $idp10juego, $equipo1o2, $logrodate, $tlarray1lg2, $Fechahoramarafun, $valorabrl){
    global $conexionbanca;
    $yaestalg=0;
    $yaestalgperonoigual=0;
    $Id_p3logrosp3=0;
    $logroactualizado=0;
    foreach ($tlarray1lg2 as $clave=>$valor2) {
...
$insertSQL = sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 2 */ INSERT 
INTO p3logros
...
$insertSQL = sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 3 */ INSERT 
INTO p7histolg
...
$logroactualizado=1;
  ...
  $insertSQL1 = sprintf(
      "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 4 */ UPDATE p3logros 
  ...
  $insertSQL = sprintf(
    "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 5 */ INSERT 
  INTO p7histolg
  (idjuegop7, Id_p1equiposp7, equipop7, tipojugadap7, logrop7, logroABoRLp7, actxp7) 
VALUES (%s, %s, %s, %s, %s, %s, %s)",
GetSQLValueString($idp10juego, "int"),
...
$insertSQL = sprintf(
"/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 6 */ INSERT 
INTO p10logros
(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3, actxp3) 
VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
GetSQLValueString($idp10juego, "int"),
...
$insertSQL = sprintf(
"/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 7 */ INSERT 
INTO p7histolg
(idjuegop7, Id_p1equiposp7, equipop7, tipojugadap7, logrop7, logroABoRLp7, actxp7) 
VALUES (%s, %s, %s, %s, %s, %s, %s)",
GetSQLValueString($idp10juego, "int"),
...
$datetime=$FechaTxt.' '.$horaTxt;
$insertSQL1 = sprintf(
    "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 8 */ UPDATE p10logros 
  SET logrop3=%s, logroABoRLp3=%s	
  WHERE 
  Id_p3logrosp3=%s",
...
$insertSQL = sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 9 */ INSERT 
INTO p7histolg
(idjuegop7, Id_p1equiposp7, equipop7, tipojugadap7, logrop7, logroABoRLp7, actxp7) 
VALUES (%s, %s, %s, %s, %s, %s, %s)",
GetSQLValueString($idp10juego, "int"),
...
if($row_Recordset18D['Swicht']==1){
//inicio logro y juego falsos para que no falle el array


$query_Recordset7 =  sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 10 */ SELECT
*
FROM  
p2juegos
WHERE 
quinregistrap2 = %s  AND
idequipo1p2 = %s  AND
idequipo2p2 = %s  AND
iniciodtp2 > %s  ORDER BY Id_p2juegosp2 ASC",
GetSQLValueString('Maradeportes', "text"),
GetSQLValueString(2795, "int"),
GetSQLValueString(2795, "int"),
...
if($totalRows_Recordset7==0){
  ...
  $insertSQL = sprintf(
    "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 11 */ INSERT 
INTO p2juegos
(quinregistrap2, idequipo1p2, idequipo2p2, iniciodtp2) 
VALUES (%s, %s, %s, %s)",

GetSQLValueString('Maradeportes', "text"),
GetSQLValueString(2795, "text"),
GetSQLValueString(2795, "text"),
GetSQLValueString($FechaTxtMARA.' 23:59:59', "date")
);
...
$query_Recordset7 =  sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 12 */ SELECT
*
FROM  
p2juegos
WHERE 
...
if($totalRows_Recordset7==0){
  ...
  $insertSQL = sprintf(
    "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 13 */ INSERT 
INTO p2juegos
(quinregistrap2, idequipo1p2, idequipo2p2, iniciodtp2) 
VALUES (%s, %s, %s, %s)",

GetSQLValueString('Maradeportes', "text"),
GetSQLValueString(2796, "text"),
GetSQLValueString(2796, "text"),
GetSQLValueString($FechaTxtMARA.' 23:59:59', "date")
);
...
$query_Recordsetuno1 = sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 14 */ SELECT * 
FROM p3logros 
WHERE  
idjuegop3 = %s AND
actxp3 = 1 AND
...
if ($totalRows_Recordsetuno1==0) {
  $insertSQL = sprintf(
      "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 15 */ INSERT 
INTO p3logros
(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3, actxp3) 
VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
      GetSQLValueString(999999, "int"),
...
$query_Recordsetuno1 = sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 16 */ SELECT * 
FROM p3logros 
WHERE  
idjuegop3 = %s AND
logrodtp3 >= %s",
GetSQLValueString(999991, "int"),
GetSQLValueString($FechaTxtMARA." 00:00:00", "date"));
$Recordsetuno1 = mysqli_query($conexionbanca, $query_Recordsetuno1) or die(mysqli_error($conexionbanca));
$row_Recordsetuno1 = mysqli_fetch_assoc($Recordsetuno1);
$totalRows_Recordsetuno1 = mysqli_num_rows($Recordsetuno1);
...
if ($totalRows_Recordsetuno1==0) {
  $insertSQL = sprintf(
      "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 17 */ INSERT 
INTO p3logros
(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3, actxp3) 
VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
      GetSQLValueString(999991, "int"),
...
//fin logro y juego falsos para que no falle el array
//inicio arrays
$query_Recordset123x =  sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 18 */ SELECT
*
FROM  
p1equipos
ORDER BY Id_p1equiposp1 ASC");
$Recordset123x = mysqli_query($conexionbanca, $query_Recordset123x) or die(mysqli_error($conexionbanca));
$row_Recordset123x = mysqli_fetch_assoc($Recordset123x);
$totalRows_Recordset123x = mysqli_num_rows($Recordset123x);

while ($fila = mysqli_fetch_assoc($Recordset123x)) {
  $tlarray1equipos[] = $fila;
}
//var_dump($tlarray1equipos[1687]);
//echo $tlarray1equipos[1687]["nommara"].' ('.$tlarray1equipos[1687]["nommarapais"].')';
//echo $tlarray1equipos[1687]["nommarapais"];


$query_Recordset123 =  sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 19 */ SELECT
*
FROM  
p2juegos
WHERE 
iniciodtp2 > %s  ORDER BY Id_p2juegosp2 ASC",
GetSQLValueString($FechaTxtMARA.' 00:00:00', "date"));
$Recordset123 = mysqli_query($conexionbanca, $query_Recordset123) or die(mysqli_error($conexionbanca));
$row_Recordset123 = mysqli_fetch_assoc($Recordset123);
$totalRows_Recordset123 = mysqli_num_rows($Recordset123);

while ($fila = mysqli_fetch_assoc($Recordset123)) {
  $tlarray1juego[] = $fila;
}
//var_dump($tlarray1juego);

$query_Recordset1111 = sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 20 */ SELECT *
FROM  p3logros
...
$query_Recordset7 =  sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 21 */ SELECT
*
FROM  
p10juegos
WHERE 
...
if($totalRows_Recordset7==0){
  ...
  $insertSQL = sprintf(
    "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 22 */ INSERT 
INTO p10juegos
(quinregistrap2, idequipo1p2, idequipo2p2, iniciodtp2) 
VALUES (%s, %s, %s, %s)",
...
$query_Recordset7 =  sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 23 */ SELECT
*
FROM  
p10juegos
WHERE 
...
if($totalRows_Recordset7==0){
  ...
  $insertSQL = sprintf(
    "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 24 */ INSERT 
INTO p10juegos
(quinregistrap2, idequipo1p2, idequipo2p2, iniciodtp2) 
VALUES (%s, %s, %s, %s)",
...
$query_Recordsetuno1 = sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 25 */ SELECT * 
FROM p10logros 
WHERE  
idjuegop3 = %s AND
actxp3 = 1 AND
...
if ($totalRows_Recordsetuno1==0) {
  $insertSQL = sprintf(
      "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 26 */ INSERT 
INTO p10logros
(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3, actxp3) 
VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
      GetSQLValueString(999999, "int"),
...
$query_Recordsetuno1 = sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 27 */ SELECT * 
FROM p10logros 
WHERE  
idjuegop3 = %s AND
actxp3 = 1 AND
...
if ($totalRows_Recordsetuno1==0) {
  $insertSQL = sprintf(
      "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 28 */ INSERT 
INTO p10logros
(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3, actxp3) 
VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
      GetSQLValueString(999991, "int"),
...
//inicio arrays
$query_Recordset123x =  sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 29 */ SELECT
*
FROM  
p1equipos
ORDER BY Id_p1equiposp1 ASC");
...
$query_Recordset123 =  sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 30 */ SELECT
*
FROM  
p10juegos
WHERE 
...
//estoy aqui
$query_Recordset1111 = sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 31 */ SELECT *
FROM  p10logros
WHERE logrodtp3 >= %s AND Id_p3logrosp3 >= 0 AND actxp3 = 1 ORDER BY Id_p3logrosp3 ASC",
  GetSQLValueString($FechaTxtMARA.' 00:00:00', "date"));
$Recordset1111 =mysqli_query($conexionbanca, $query_Recordset1111) or die(mysqli_error($conexionbanca));
$row_Recordset1111 = mysqli_fetch_assoc($Recordset1111);
$totalRows_Recordset1111 = mysqli_num_rows($Recordset1111);
...
//estoy aqui
$equiposmara[] = array('equipo1' => $equipo1, 'equipo2' => $equipo2, 'deportecod' => $deportecod);
...
$yaestaequipo1cod=0;
$yaestaequipo2cod=0;
foreach ($tlarray1equipos as $clave=>$valore) {

 // if (strcasecmp($valore["nommara"], $equipo1) == 0) { echo $valore["nommara"].'si es igual';}
  //if (stristr($valore["nommara"], $equipo1)) {     print ("According to \$a, you like PHP.");     }
  ///  if($valore["Id_p1equiposp1"]==3548){ echo '.'.$valore["nommara"].'.'; }
    $equipo11=rtrim($valore["nommara"]);
  if($equipo11==$equipo1 && $valore["deportep1"]==$deportecod){    $yaestaequipo1=1; $yaestaequipo1cod=$valore["Id_p1equiposp1"];  }
  if($valore["nommara"]==$equipo2 && $valore["deportep1"]==$deportecod){    $yaestaequipo2=1; $yaestaequipo2cod=$valore["Id_p1equiposp1"];  }

  if($yaestaequipo1==0){
    $equipo112=$equipo11.' ('.$valore["nommarapais"].')';
...
//if($yaestaequipo1==1){ echo '<br>Si esta este equipo '.$equipo1.'<br>';}
//if($yaestaequipo2==1){ echo '<br>Si esta este equipo '.$equipo2.'<br>';}
...
foreach ($tlarray1juego as $clave=>$valor2) {
...
if($yaestajuego==0){ echo 'se creara el juego<br>'; 
  ...
  if($row_Recordset18D['Swicht']==1){
$insertSQL = sprintf(
"/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 32 */ INSERT 
INTO p2juegos
...
$Result1 = mysqli_query($conexionbanca, $insertSQL) or die(mysqli_error($conexionbanca));
  ...
  $insertSQL = sprintf(
    "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 33 */ INSERT 
    INTO p10juegos
    (idequipo1p2, idequipo2p2, deportep2, competicionp2, iniciodtp2) 
    VALUES (%s, %s, %s, %s, %s)",
        GetSQLValueString($yaestaequipo1cod, "int"),
...
if($yaestajuego==1 && $yaestajuegohorajuego==1){ echo 'se actualiza hora del juego<br>'; 
  ...
  if($row_Recordset18D['Swicht']==1){
    ...
    $insertSQL24 = sprintf(
      "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 34 */ UPDATE p2juegos 
SET iniciodtp2=%s			
WHERE 
Id_p2juegosp2 = %s", 
  ...
  $Result24 = mysqli_query($conexionbanca, $insertSQL24);
    ...
    $insertSQL24 = sprintf(
      "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 35 */ UPDATE p10juegos 
SET iniciodtp2=%s			
WHERE 
Id_p2juegosp2 = %s", 
...
if($noestaequipo>9999999999999999){
$msj='Falta Agregar equipos o solo el nombre maradeportes correcto en parley falta # '.$noestaequipo;
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL,"https://api.telegram777.org/bot309341364:AAETe6H8z5HXbqdv5XhpTEY-nsfBKtYQ0mE/sendMessage");
...
$msj='Se actualizaron '.$juegos.' juegos y '.$la.' logros Maradeportes BD2 fatan '.$noestaequipo.' equipos t '.$tiempo;
$msjx=utf8_encode($msj);
$post=[
  'chat_id'=>-576782283,
  'text'=>$msjx,
...
//estoy aqui
echo '<br><br>';
var_dump($equiposmara[0]['equipo1']);
echo '<br><br>';
var_dump($equiposmara[0]);
echo '<br><br>';
var_dump($tlarray1juego);
...
$query_Recordset123 =  sprintf(
  "/* PARSEADORES1 sincronizado\logrosmaradeportesV2.php - QUERY 36 */ SELECT
*
FROM  
p10juegos
WHERE 
