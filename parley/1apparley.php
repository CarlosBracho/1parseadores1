...
$query_Recordset5 = sprintf(
    "
/* PARSEADORES1 parley\1apparley.php - QUERY 1 */ SELECT * FROM usuario, taquilla, taquilla_opc_ame, agencia,
			banca
...
$totalRows_Recordset1=0;
                                            ...
                                            $query_Recordset13 = sprintf(
                                                "/* PARSEADORES1 parley\1apparley.php - QUERY 2 */ SELECT MAX(Idbalancecli) 
    ...
    $Idbalancecli=((int)$row_Recordset13['MAX(Idbalancecli)']);
                                    ...
                                    $query_Recordset14 = sprintf(
                                        "/* PARSEADORES1 parley\1apparley.php - QUERY 3 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
                                        GetSQLValueString($moneda, "int"),
    ...
    $query_Recordset111 = sprintf(
        "/* PARSEADORES1 parley\1apparley.php - QUERY 4 */ SELECT logrop3, Id_p3logrosp3, logroABoRLp3, idjuegop3, equipop3, tipojugadap3
    FROM  p3logros
...
$query_Recordset1b = sprintf(
    "/* PARSEADORES1 parley\1apparley.php - QUERY 5 */ SELECT * FROM p2juegos WHERE 
deportep2 = %s AND 
iniciodtp2 > %s AND
idequipo1p2 > 0 AND
idequipo1p2 > 0
...
$query_Recordset101 = sprintf(
    "/* PARSEADORES1 parley\1apparley.php - QUERY 6 */ SELECT * FROM p2juegos WHERE 
deportep2 = %s AND 
iniciodtp2 > %s AND
idequipo1p2 > 0 AND
idequipo1p2 > 0
...
$query_Recordset201 = sprintf(
    "/* PARSEADORES1 parley\1apparley.php - QUERY 7 */ SELECT * FROM p2juegos WHERE 
deportep2 = %s AND 
iniciodtp2 > %s AND
idequipo1p2 > 0 AND
idequipo2p2 > 0
...
$query_Recordset301 = sprintf(
    "/* PARSEADORES1 parley\1apparley.php - QUERY 8 */ SELECT * FROM p2juegos WHERE 
deportep2 = %s AND 
iniciodtp2 > %s AND
idequipo1p2 > 0 AND
idequipo2p2 > 0
...
<?php
 $query_Recordset1fm = sprintf(
                    "/* PARSEADORES1 parley\1apparley.php - QUERY 9 */ SELECT DISTINCT competicionp2
FROM  p2juegos
where deportep2 = %s
 AND 
 iniciodtp2 > %s",
