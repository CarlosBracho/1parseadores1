...
$query_Recordset5 = sprintf(
    "/* PARSEADORES1 parley\1taparley.php - QUERY 1 */ SELECT * FROM usuario, taquilla, taquilla_opc_parley, agencia,
			banca
...
$totalRows_Recordset1=0;
                                            ...
                                            $query_Recordset13 = sprintf(
                                                "/* PARSEADORES1 parley\1taparley.php - QUERY 2 */ SELECT MAX(Idbalancecli) 
    ...
    $Idbalancecli=((int)$row_Recordset13['MAX(Idbalancecli)']);
                                    ...
                                    $query_Recordset14 = sprintf(
                                        "/* PARSEADORES1 parley\1taparley.php - QUERY 3 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
                                        GetSQLValueString($moneda, "int"),
...
$query_Recordset1111 = sprintf(
    "/* PARSEADORES1 parley\1taparley.php - QUERY 4 */ SELECT logrop6, idp6logrosind, logroABoRLp6, idjuegop6, equipop6, tipojugadap6
FROM  p6logrosind
...
//final logros colocados por agente
    $query_Recordset111 = sprintf(
        "/* PARSEADORES1 parley\1taparley.php - QUERY 5 */ SELECT logrop3, Id_p3logrosp3, logroABoRLp3, idjuegop3, equipop3, tipojugadap3
    FROM  p3logros
...
$query_Recordset1b = sprintf(
    "/* PARSEADORES1 parley\1taparley.php - QUERY 6 */ SELECT * FROM p2juegos WHERE 
deportep2 = %s AND 
iniciodtp2 > %s AND
idequipo1p2 > 0 AND
idequipo1p2 > 0 AND
...
$query_Recordset101 = sprintf(
    "/* PARSEADORES1 parley\1taparley.php - QUERY 7 */ SELECT * FROM p2juegos WHERE 
deportep2 = %s AND 
iniciodtp2 > %s AND
idequipo1p2 > 0 AND
idequipo1p2 > 0 AND
...
$query_Recordset201 = sprintf(
    "/* PARSEADORES1 parley\1taparley.php - QUERY 8 */ SELECT * FROM p2juegos WHERE 
deportep2 = %s AND 
iniciodtp2 > %s AND
idequipo1p2 > 0 AND
idequipo2p2 > 0 AND
...
$query_Recordset301 = sprintf(
    "/* PARSEADORES1 parley\1taparley.php - QUERY 9 */ SELECT * FROM p2juegos WHERE 
deportep2 = %s AND 
iniciodtp2 > %s AND
idequipo1p2 > 0 AND
idequipo2p2 > 0 AND
...
$query_Recordset401 = sprintf(
    "/* PARSEADORES1 parley\1taparley.php - QUERY 10 */ SELECT * FROM p2juegos WHERE 
deportep2 = %s AND 
iniciodtp2 > %s AND
idequipo1p2 > 0 AND
idequipo2p2 > 0 AND
                    ...
                    <td colspan="2">
                        <div class="row">
                            <div class="col-md-12 col-lg-7">
                                ...
                                <?php if($moneda==12){?>
                                <br><select name="monedaD" class="form-/* PARSEADORES1 parley\1taparley.php - QUERY 11 */ select textbox table-primary" style="width:175px; font-size:20px; height:30px;">
