...
"/* PARSEADORES1 parley\tappagarticket2.php - QUERY 1 */ SELECT 
*     
FROM
p4jugadas
WHERE   
...
"/* PARSEADORES1 parley\tappagarticket2.php - QUERY 2 */ UPDATE p4jugadas  SET 
jugadadtp4pago=%s,
estadoticketp4=%s 
WHERE nticketp4=%s",
...
echo $Result155.' resultado de /* PARSEADORES1 parley\tappagarticket2.php - QUERY 3 */ update';
...
"/* PARSEADORES1 parley\tappagarticket2.php - QUERY 4 */ SELECT 
*
FROM
p4jugadas
WHERE
