...
.card{
   font-family: Arial, Helvetica, sans-serif;
    ...
    "/* PARSEADORES1 parley\t_imprimeticketp.php - QUERY 1 */ SELECT 
*
...
",
    GetSQLValueString($_POST['iD'], "int")
        ...
        $query_Recordset18 = sprintf(
            "/* PARSEADORES1 parley\t_imprimeticketp.php - QUERY 2 */ SELECT 
    ...
    "/* PARSEADORES1 parley\t_imprimeticketp.php - QUERY 3 */ SELECT monto_apuesta, factor_pago, largotikpar, tipoticketpar, factor_de_hembra, factor_de_macho
     FROM 
     taquilla_opc_parley
     WHERE 
     cod_taquilla = %s ",
