...
<?php
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 parley\apc_beisbol.php - QUERY 1 */ SELECT * FROM p2juegos 
...
do { 
    ...
    $query_Recordset111D = sprintf(
        "/* PARSEADORES1 parley\apc_beisbol.php - QUERY 2 */ SELECT logrop3, Id_p3logrosp3, logroABoRLp3, idjuegop3, equipop3, tipojugadap3, logroactualdt
    FROM  p3logros
    ...
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 parley\apc_beisbol.php - QUERY 3 */ SELECT *
FROM p1equipos
WHERE  
Id_p1equiposp1 = %s",
...
$query_Recordset22 = sprintf(
        "/* PARSEADORES1 parley\apc_beisbol.php - QUERY 4 */ SELECT *
