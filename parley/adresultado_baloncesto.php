...
do {
	...
	$query_Recordset301 = sprintf(
		"/* PARSEADORES1 parley\adresultado_baloncesto.php - QUERY 1 */ SELECT * FROM p2juegos, p5resultadosj WHERE 
...
p2juegos.Id_p2juegosp2 = %s 
	...
	if($row_Recordset1baloncesto['quienmete']<>0 && $row_Recordset1baloncesto['quienmete']<>''){
		$query_Recordset301d = sprintf(
			"/* PARSEADORES1 parley\adresultado_baloncesto.php - QUERY 2 */ SELECT nom_usuario FROM usuario WHERE 
		id_usuario = %s
		",
