...
"/* PARSEADORES1 parley\tapeliminarticket.php - QUERY 1 */ SELECT *
...
if ($totalRows_Recordset13>=1) {
    do {
      $query_Recordset19 = sprintf(
        "/* PARSEADORES1 parley\tapeliminarticket.php - QUERY 2 */ SELECT 
        *
        FROM
    p4jugadas, p2juegos
...
<?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 parley\tapeliminarticket.php - QUERY 3 */ SELECT *
                FROM p4jugadas
                WHERE
