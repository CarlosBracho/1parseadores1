...
$query_Recordsetuno1 = sprintf(
    "/* PARSEADORES1 parley\adagregarjuego.php - QUERY 1 */ SELECT * 
FROM p3logros 
WHERE  
idjuegop3 = %s AND
logrodtp3 >= %s",
...
if ($totalRows_Recordsetuno1==0) {
    $insertSQL = sprintf(
        "/* PARSEADORES1 parley\adagregarjuego.php - QUERY 2 */ INSERT 
INTO p3logros
...
if (isset($_POST['idequipo1']) && ($_POST['competicion']!='')) {
    ...
    echo $datetime;
    $insertSQL = sprintf(
        "/* PARSEADORES1 parley\adagregarjuego.php - QUERY 3 */ INSERT 
				INTO p2juegos
    ...
    header(sprintf("Location: %s", $insertGoTo));
      ...
      $insertGoTo2 = "adeditorparley.php";
...
if (isset($_POST['idequipo1']) && ($_POST['competicion2'])) {
  ...
  echo $datetime;
  $insertSQL18 = sprintf(
      "/* PARSEADORES1 parley\adagregarjuego.php - QUERY 4 */ INSERT 
      INTO p2juegos
      (idequipo1p2, idequipo2p2, competicionp2, deportep2, pichee1p2, pichee2p2, iniciodtp2, paisp2) 
      VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
      GetSQLValueString($_POST['idequipo1'], "int"),
...
$query_Recordset1 =  sprintf(
  "/* PARSEADORES1 parley\adagregarjuego.php - QUERY 5 */ SELECT  
*
  FROM  p2juegos"
);
...
<?php  } else {
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 parley\adagregarjuego.php - QUERY 6 */ SELECT *
		FROM p1equipos 
		WHERE deportep1 = %s
    ...
    $query_Recordset3 = sprintf(
        "/* PARSEADORES1 parley\adagregarjuego.php - QUERY 7 */ SELECT *
		FROM p1equipos 
		WHERE deportep1 = %s
		ORDER BY nomequipop1",
        GetSQLValueString($_GET["recordID"], "int")
