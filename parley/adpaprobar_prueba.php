...
$query_Recordset13 = sprintf(
  "/* PARSEADORES1 parley\adpaprobar_prueba.php - QUERY 1 */ SELECT *
  FROM p4jugadas
  WHERE
...
if ($totalRows_Recordset13>0) {
    do {
      $query_Recordset19 = sprintf(
        "/* PARSEADORES1 parley\adpaprobar_prueba.php - QUERY 2 */ SELECT 
        *
        FROM
    p4jugadas, p2juegos
    WHERE
    ...
    p4jugadas.nticketp4 = %s   ORDER BY p4jugadas.lineatp4 DESC",
        GetSQLValueString($row_Recordset13['nticketp4'], "int"));
               ...
               $query_Recordset18 = sprintf(
                  "/* PARSEADORES1 parley\adpaprobar_prueba.php - QUERY 3 */ SELECT 
...
<?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 parley\adpaprobar_prueba.php - QUERY 4 */ SELECT *
                FROM p4jugadas
                WHERE
        ...
        do {
            ...
            if ($row_Recordset14['jugadadtp4']<$final) { $juegoiniciado++; }
        ...
        <center><input type="submit" value="CONFIRME QUE TODO ESTA CORRECTO" class="btn-warning" title="CONFIRME QUE TODO ESTA CORRECTO" 
...
if ($row_Recordset13['monedap4']==5) {echo ' SOL';}} ?>
     ...
     <td>
      <input type="submit" value="DEVOLVER TICKET" class="btn-danger" title="CONFIRME QUE TODO ESTA CORRECTO" 
          data-toggle="modal" data-target="#exampleModal" href="detalle_ticket.php" title="" 
