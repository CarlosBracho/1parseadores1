...
if($D==1){
    $query_Recordset13 = sprintf(
        "/* PARSEADORES1 parley\tapcuadrecaja_prueba.php - QUERY 1 */ SELECT 
    p4jugadas.lineatp4,
    ...
    SUM(CASE WHEN p4jugadas.lineatp4 = 1 AND p4jugadas.jugadadtp4 >= %s AND p4jugadas.jugadadtp4 <= %s AND (p4jugadas.estadoticketp4 = 5 OR p4jugadas.estadoticketp4 = 6) AND p4jugadas.monedap4 <= 2  THEN p4jugadas.premioapagarp4 ELSE 0 END) AS total_pagadobss,
    ...
    SUM(CASE WHEN p4jugadas.lineatp4 = 1 AND p4jugadas.jugadadtp4 >= %s AND p4jugadas.jugadadtp4 <= %s AND (p4jugadas.estadoticketp4 = 5 OR p4jugadas.estadoticketp4 = 6) AND p4jugadas.monedap4 = 3  THEN p4jugadas.premioapagarp4 ELSE 0 END) AS total_pagadousd,
    ...
    SUM(CASE WHEN p4jugadas.lineatp4 = 1 AND p4jugadas.jugadadtp4 >= %s AND p4jugadas.jugadadtp4 <= %s AND (p4jugadas.estadoticketp4 = 5 OR p4jugadas.estadoticketp4 = 6) AND p4jugadas.monedap4 = 4  THEN p4jugadas.premioapagarp4 ELSE 0 END) AS total_pagadocop,
    ...
    SUM(CASE WHEN p4jugadas.lineatp4 = 1 AND p4jugadas.jugadadtp4 >= %s AND p4jugadas.jugadadtp4 <= %s AND  (p4jugadas.estadoticketp4 = 5 OR p4jugadas.estadoticketp4 = 6) AND p4jugadas.monedap4 = 5  THEN p4jugadas.premioapagarp4 ELSE 0 END) AS total_pagadosol,
...
$query_Recordset13 = sprintf(
    "/* PARSEADORES1 parley\tapcuadrecaja_prueba.php - QUERY 2 */ SELECT 
p4jugadas.lineatp4,
SUM(CASE WHEN p4jugadas.lineatp4 = 1 AND p4jugadas.jugadadtp4pago >= %s AND p4jugadas.jugadadtp4pago <= %s  AND p4jugadas.monedap4 <= 2 THEN p4jugadas.mon_ventap4 ELSE 0 END) AS total_ventabss,
...
SUM(CASE WHEN p4jugadas.lineatp4 = 1 AND p4jugadas.jugadadtp4pago >= %s AND p4jugadas.jugadadtp4pago <= %s AND p4jugadas.monedap4 = 3 THEN p4jugadas.mon_ventap4 ELSE 0 END) AS total_ventausd,
...
SUM(CASE WHEN p4jugadas.lineatp4 = 1 AND p4jugadas.jugadadtp4pago >= %s AND p4jugadas.jugadadtp4pago <= %s AND p4jugadas.monedap4 = 4 THEN p4jugadas.mon_ventap4 ELSE 0 END) AS total_ventacop,
...
SUM(CASE WHEN p4jugadas.lineatp4 = 1 AND p4jugadas.jugadadtp4pago >= %s AND p4jugadas.jugadadtp4pago <= %s AND p4jugadas.monedap4 = 5 THEN p4jugadas.mon_ventap4 ELSE 0 END) AS total_ventasol,
...
$query_Recordset2 = sprintf("/* PARSEADORES1 parley\tapcuadrecaja_prueba.php - QUERY 3 */ SELECT usuario.nom_usuario, usuario.id_usuario, taquilla.nom_taquilla FROM usuario, taquilla 
...
$query_Recordset3 = sprintf("/* PARSEADORES1 parley\tapcuadrecaja_prueba.php - QUERY 4 */ SELECT nom_usuario FROM usuario WHERE usuario.id_usuario = %s AND tip_usuario='U' 
...
<input type="submit" value="VER FECHAS DE INGRESO" class="btn-warning" title="" onClick="return enviado()"
                 />
<input type="hidden" name="FechaS" value="1">
<?php }?>
<?php if($D==1){ ?>

<input type="submit" value="VER FECHAS DE EGRESO" class="btn-warning" title="" onClick="return enviado()"/>
...
if ($row_Recordset13['total_ventabss']>0 or $row_Recordset13['total_pagadobss']>0) {
    ...
    <br/>BSS EN CAJA:
    <br/><strong>***<?php echo number_format(($row_Recordset13['total_ventabss']-$row_Recordset13['total_pagadobss']-$row_Recordset13['total_eliminadosbss']), 2, ",", "."); ?>***</strong>
...
if ($row_Recordset13['total_ventausd']>0 or $row_Recordset13['total_pagadousd']>0) {
    ...
    <br/>USD EN CAJA:
    <br/><strong>***<?php echo number_format(($row_Recordset13['total_ventausd']-$row_Recordset13['total_pagadousd']-$row_Recordset13['total_eliminadosusd']), 2, ",", "."); ?>***</strong>
...
if ($row_Recordset13['total_ventacop']>0 or $row_Recordset13['total_pagadocop']>0) {
    ...
    <br/>COP EN CAJA:
    <br/><strong>***<?php echo number_format(($row_Recordset13['total_ventacop']-$row_Recordset13['total_pagadocop']-$row_Recordset13['total_eliminadoscop']), 2, ",", "."); ?>***</strong>
...
if ($row_Recordset13['total_ventasol']>0 or $row_Recordset13['total_pagadosol']>0) {
    ...
    <br/>SOL EN CAJA:
    <br/><strong>***<?php echo number_format(($row_Recordset13['total_ventasol']-$row_Recordset13['total_pagadosol']-$row_Recordset13['total_eliminadossol']), 2, ",", "."); ?>***</strong>
