...
do {
	...
	$query_Recordset301 = sprintf(
		"/* PARSEADORES1 parley\adresultado_futbolame.php - QUERY 1 */ SELECT * FROM p2juegos, p5resultadosj WHERE 
	Id_p2juegosp2 = %s 
	ORDER BY competicionp2
	",
...
$quienmete2=0;
	if($row_Recordset1futbolame['quienmete']<>0 && $row_Recordset1futbolame['quienmete']<>''){
		$query_Recordset301d = sprintf(
			"/* PARSEADORES1 parley\adresultado_futbolame.php - QUERY 2 */ SELECT nom_usuario FROM usuario WHERE 
		id_usuario = %s
		",
