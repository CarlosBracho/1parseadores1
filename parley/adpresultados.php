...
$query_Recordset1b = sprintf(
    "/* PARSEADORES1 parley\adpresultados.php - QUERY 1 */ SELECT * FROM p5resultadosj WHERE 
deportep5 = %s AND 
iniciodtp5 >= %s AND
iniciodtp5 <= %s AND
equipo1p5 > ' ' AND
...
$query_Recordset1baloncesto = sprintf(
    "/* PARSEADORES1 parley\adpresultados.php - QUERY 2 */ SELECT * FROM p5resultadosj WHERE 
deportep5 = %s AND 
iniciodtp5 >= %s AND
iniciodtp5 <= %s AND
equipo1p5 > ' ' AND
...
$query_Recordset1futbol = sprintf(
    "/* PARSEADORES1 parley\adpresultados.php - QUERY 3 */ SELECT * FROM p5resultadosj WHERE 
deportep5 = %s AND 
iniciodtp5 >= %s AND
iniciodtp5 <= %s AND
equipo1p5 > ' ' AND
...
$query_Recordset1hockey = sprintf(
    "/* PARSEADORES1 parley\adpresultados.php - QUERY 4 */ SELECT * FROM p5resultadosj WHERE 
deportep5 = %s AND 
iniciodtp5 >= %s AND
iniciodtp5 <= %s AND
equipo1p5 > ' ' AND
...
$query_Recordset1futbolame = sprintf(
    "/* PARSEADORES1 parley\adpresultados.php - QUERY 5 */ SELECT * FROM p5resultadosj WHERE 
deportep5 = %s AND 
iniciodtp5 >= %s AND
iniciodtp5 <= %s AND
equipo1p5 > ' ' AND
