<?php
echo 'v1<br><br>';
$log='2000-05-22 22.22.22';
echo substr($log, 0, 10);
echo '<br>v1<br><br>';
...
$codus=$_SESSION['MM_id_usuario'];
    ...
    if (empty($_GET['Id_p2juegosp2'])) {
        var_dump($_POST);
        $logrodtp3=$_POST['logrodtp3'];
        $Id_p2juegosp2=$_POST['Id_p2juegosp2'];
    } else {
        var_dump($_GET);
        $logrodtp3=$_GET['logrodtp3'];
        $Id_p2juegosp2=$_GET['Id_p2juegosp2'];
            ...
            $query_Recordset111 = sprintf(
                "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 1 */ SELECT * FROM p5resultadosj WHERE 
			juegop5 = %s",
    ...
    if (empty($Id_p2juegosp2)) {
        ...
        $query_Recordset1 = sprintf(
            "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 2 */ SELECT * FROM p2juegos WHERE 
			Id_p2juegosp2 = %s",
            GetSQLValueString($Id_p2juegosp2, "int")
        );
...
if (empty($_POST['1e1']!='')) {
    ...
    $query_Recordset14 = sprintf(
        "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 3 */ SELECT * FROM p5resultadosj WHERE 
			juegop5 = %s",
    ...
    if ($totalRows_Recordset14==0) {
        if ($_POST['Id_p2juegosp2']>0) {
            ...
            $insertSQL155 = sprintf(
                "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 4 */ INSERT INTO p5resultadosj  
...
curl_close ($ch);
        ...
        $insertSQL155 = sprintf(
            "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 5 */ UPDATE p5resultadosj  SET 
...
curl_close ($ch);
    ...
    $Dfecha3=$_POST['iniciodtp5'];
    $timestamp3 = strtotime($Dfecha3);
    $newDate3 = date("Y-m-d", $timestamp3);
    echo $newDate.' 00:00:02';


    $insertGoTo =('../parley/carculojparley.php?Id_p2juegosp2='.$_POST['Id_p2juegosp2'].'&Fechacal='.$newDate3);
    ...
    $query_Recordset14 = sprintf(
        "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 6 */ SELECT * FROM p5resultadosj WHERE 
			juegop5 = %s",
        GetSQLValueString($_POST['Id_p2juegosp2'], "int")
    );
    $Recordset14 = mysqli_query($conexionbanca, $query_Recordset14) or die(mysqli_error($conexionbanca));
    ...
    if ($totalRows_Recordset14==0) {
        if ($_POST['Id_p2juegosp2']>0) {
            ...
            $insertSQL155 = sprintf(
                "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 7 */ INSERT INTO p5resultadosj  
(deportep5, juegop5, equipo1p5, equipo2p5, anotaprimerop5, iniciodtp5, tiemposjugadosp5,
 r1p5, r2p5, r3p5, r4p5, r5p5, r6p5, r7p5, r8p5, r9p5, r10p5, 
 r11p5, r12p5, r13p5, r14p5, r15p5, r16p5, r17p5, r18p5, r19p5, r20p5, 
 r21p5, r22p5, r23p5, r24p5, r25p5, r26p5, r27p5, r28p5, r29p5, r30p5, quienmete)
...
curl_close ($ch);
        ...
        $insertSQL156 = sprintf(
            "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 8 */ UPDATE p2juegos 
            SET 
            iniciodtp2 = %s
...
//include('../parley/carculojparley.php?Id_p2juegosp2='.$_POST['Id_p2juegosp2']);
$Dfecha33=$_POST['iniciodtp5'];
$timestamp33 = strtotime($Dfecha33);
$newDate33 = date("Y-m-d", $timestamp33);
echo $newDate33.' 00:00:02';
$insertGoTo =('../parley/carculojparley.php?Id_p2juegosp2='.$_POST['Id_p2juegosp2'].'&Fechacal='.$newDate33 );
...
if (isset($_POST['eliminar'])){
    ...
    $query_Recordset14_eliminar = sprintf(
        "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 9 */ SELECT * FROM p5resultadosj WHERE 
			juegop5 = %s",
        GetSQLValueString($Id_p2juegosp2, "int")
    );
    $Recordset14_eliminar = mysqli_query($conexionbanca, $query_Recordset14_eliminar) or die(mysqli_error($conexionbanca));
    $row_Recordset14_eliminar = mysqli_fetch_assoc($Recordset14_eliminar);
    $totalRows_Recordset14_eliminar = mysqli_num_rows($Recordset14_eliminar);

    $Dfecha2=$row_Recordset14_eliminar['iniciodtp5'];
    $timestamp2 = strtotime($Dfecha2);
    $newDate2 = date("Y-m-d", $timestamp2);

    
$query_delete =  sprintf(
    "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 10 */ DELETE FROM p5resultadosj WHERE juegop5 = %s",
    
    GetSQLValueString($Id_p2juegosp2, "int"));
    $Result1 = mysqli_query($conexionbanca, $query_delete) or die(mysqli_error($conexionbanca));
    //aqui termina el delete
    $insertGoTo =('../parley/carculojparley.php?Id_p2juegosp2='.$_POST['Id_p2juegosp2'].'&Fechacal='.$newDate2);
...
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 11 */ SELECT *
FROM p1equipos
WHERE  
...
$query_Recordset22 = sprintf(
    "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 12 */ SELECT *
FROM p1equipos
WHERE  
...
<th scope="col"><?php
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 13 */ SELECT *
FROM p1equipos
WHERE  
...
$equipo1=$row_Recordset21['nomequipop1'];
$query_Recordset22 = sprintf(
    "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 14 */ SELECT *
FROM p1equipos
WHERE  
...
<th scope="col"><?php
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 15 */ SELECT *
FROM p1equipos
WHERE  
...
$equipo1=$row_Recordset21['nomequipop1'];
$query_Recordset22 = sprintf(
    "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 16 */ SELECT *
FROM p1equipos
WHERE  
...
<th scope="col"><?php
$query_Recordset21 = sprintf(
"/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 17 */ SELECT *
FROM p1equipos
WHERE  
...
$equipo1=$row_Recordset21['nomequipop1'];
$query_Recordset22 = sprintf(
"/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 18 */ SELECT *
FROM p1equipos
WHERE  
...
<th scope="col"><?php
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 19 */ SELECT *
FROM p1equipos
WHERE  
...
$equipo1=$row_Recordset21['nomequipop1'];
$query_Recordset22 = sprintf(
    "/* PARSEADORES1 parley\adpsinresultados2.php - QUERY 20 */ SELECT *
FROM p1equipos
WHERE  
