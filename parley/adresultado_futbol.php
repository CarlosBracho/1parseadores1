...
do {
        ...
        $query_Recordset301 = sprintf(
            "/* PARSEADORES1 parley\adresultado_futbol.php - QUERY 1 */ SELECT * FROM p2juegos, p5resultadosj WHERE 
...
$quienmete2=0;
	if($row_Recordset1futbol['quienmete']<>0 && $row_Recordset1futbol['quienmete']<>''){
		$query_Recordset301d = sprintf(
			"/* PARSEADORES1 parley\adresultado_futbol.php - QUERY 2 */ SELECT nom_usuario FROM usuario WHERE 
		id_usuario = %s
		",
