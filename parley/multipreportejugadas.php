...
if (isset($_POST['fecha_inicio']) && isset($_POST['fecha_fin'])) {
    ...
    $iniciof=$_POST['fecha_inicio'].' 00:00:01';
     $finalf=$_POST['fecha_fin'].' 23:59:59';
        ...
        "/* PARSEADORES1 parley\multipreportejugadas.php - QUERY 1 */ SELECT *
    ...
    $query_Recordset1890 = sprintf(
      "/* PARSEADORES1 parley\multipreportejugadas.php - QUERY 2 */ SELECT factor_de_hembra, factor_de_macho
       FROM 
    ...
    $query_Recordset1 = sprintf(
      "/* PARSEADORES1 parley\multipreportejugadas.php - QUERY 3 */ SELECT 
    *
...
if ($totalRows_Recordset13>=1) {
    do {
      ...
      $query_Recordset19 = sprintf(
        "/* PARSEADORES1 parley\multipreportejugadas.php - QUERY 4 */ SELECT 
        *
        FROM
    p4jugadas, p2juegos
    WHERE
    ...
    $totalRows_Recordset19 = mysqli_num_rows($Recordset19);
      ...
      "/* PARSEADORES1 parley\multipreportejugadas.php - QUERY 5 */ SELECT 
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 parley\multipreportejugadas.php - QUERY 6 */ SELECT *
                FROM p4jugadas
                WHERE
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
                            ...
                            $query_Recordset135 = sprintf(
                                "/* PARSEADORES1 parley\multipreportejugadas.php - QUERY 7 */ SELECT *
...
$query_Recordset1 = sprintf(
  "/* PARSEADORES1 parley\multipreportejugadas.php - QUERY 8 */ SELECT 
*
