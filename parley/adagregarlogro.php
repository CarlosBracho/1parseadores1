...
$datetime2 = strtotime('0 hours', strtotime($datetime2));
...
$query_Recordsetuno1 = sprintf(
    "/* PARSEADORES1 parley\adagregarlogro.php - QUERY 1 */ SELECT * 
FROM p3logros 
WHERE  
idjuegop3 = %s AND
logrodtp3 >= %s",
...
if ($totalRows_Recordsetuno1==0) {
    $insertSQL = sprintf(
        "/* PARSEADORES1 parley\adagregarlogro.php - QUERY 2 */ INSERT 
INTO p3logros
...
if (isset($_POST['logro'])) {
    ...
    $insertSQL = sprintf(
        "/* PARSEADORES1 parley\adagregarlogro.php - QUERY 3 */ INSERT 
				INTO p3logros
				(idjuegop3, Id_p1equiposp3, equipop3, tipojugadap3, logrop3, logrodtp3, logroABoRLp3) 
				VALUES (%s, %s, %s, %s, %s, %s, %s)",
    ...
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 parley\adagregarlogro.php - QUERY 4 */ SELECT *
...
$totalRows_Recordset2 = mysqli_num_rows($Recordset2);
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 parley\adagregarlogro.php - QUERY 5 */ SELECT *
...
$totalRows_Recordset21 = mysqli_num_rows($Recordset21);
    ...
    $query_Recordset22 = sprintf(
        "/* PARSEADORES1 parley\adagregarlogro.php - QUERY 6 */ SELECT *
FROM p1equipos WHERE Id_p1equiposp1 = %s",
...
<input type="hidden" name="tipojugada" value="<?php echo $_POST['tipoapuesta']; ?>"/>					
<input type="hidden" name="equipo" value="<?php echo $_POST['num_equipo']; ?>"/>					
<input type="hidden" name="Id_p1equipos" value="<?php echo $_POST['idequipo']; ?>"/>
<input type="hidden" name="logrodtp3" value="<?php echo $datetime; ?>"/>	
