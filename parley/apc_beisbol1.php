...
<?php
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 parley\apc_beisbol1.php - QUERY 1 */ SELECT * FROM p2juegos 
...
do {
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 parley\apc_beisbol1.php - QUERY 2 */ SELECT *
FROM p1equipos
WHERE  
Id_p1equiposp1 = %s",
...
?>
			...
			<th rowspan='2'><h6><small class="font-weight-bold"><br>EQUIPOS<br>HORA INICIO<br>
    ...
    echo date("g:ia", strtotime($nuevahora1));   echo ' Codigo de juego '.$row_Recordset1['Id_p2juegosp2']; ?></p>
</small></h6></th>
...
</td><?php } else {?><td id="<?php echo $idequipo1; ?>1_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101" onclick="crearcompeticion2(1, <?php echo $Id_p3logros; ?>, 1);" <?php //estoyd aqui
 } ?>  
class="<?php echo $idequipo1; ?>1,ML, ,<?php echo $Id_p3logros; ?>,<?php  echo $lg; ?>,<?php echo
$row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,1,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipop1'];?>"></br>
<?php $psi=0; if ($lg==0) { $psi=1;  } deam($psi, $lg, $ttl); ?>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $iddiego; ?>, 'ML', 1);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $iddiego; ?>, 'RL', 1);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $iddiego; ?>, 'SRL', 1);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $iddiego; ?>, 'A', 1);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $iddiego; ?>, '5ML', 1);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $iddiego; ?>, '5RL', 1);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $iddiego; ?>, '5A', 1);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $iddiego; ?>, 'SI', 1);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $iddiego; ?>, 'AP', 1);" <?php //estoyd aqui
} ?>
>
...
<?php $psi=0; if ($lg>0) { $psi=1;  } deam($psi, $lg, $ttl); ?></td>
<?php } else {?><td style="display:" id="<?php echo $idequipo1; ?>1_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101" onclick="crearcompeticion2(1, <?php echo $Id_p3logros; ?>, 1);" <?php //estoyd aqui
 } ?>  
class="<?php echo $idequipo1; ?>1,AG,<?php echo $lgABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $lg; ?>,
<?php echo $row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,20,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipop1'];?>">
<small class="text-danger"><b>A <?php echo $lgABoRL; ?></b></small> <br>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $iddiego; ?>, 'AG', 1);" <?php //estoyd aqui
} ?>
>
...
$query_Recordset22 = sprintf(
        "/* PARSEADORES1 parley\apc_beisbol1.php - QUERY 3 */ SELECT *
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $row_Recordset1['idequipo2p2']; ?>, 'SRL', 2);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $row_Recordset1['idequipo2p2']; ?>, '5ML', 2);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $row_Recordset1['idequipo2p2']; ?>, '5RL', 2);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $row_Recordset1['idequipo2p2']; ?>, '5B', 2);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $row_Recordset1['idequipo2p2']; ?>, 'NO', 2);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $row_Recordset1['idequipo2p2']; ?>, 'AP', 2);" <?php //estoyd aqui
} ?>
>
...
<?php } else {?><td style="display:" id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101" onclick="crearcompeticion2(1, <?php echo $Id_p3logros; ?>, 1);" <?php //estoyd aqui
 } ?>  
class="<?php echo $idequipo2; ?>2,BG,<?php echo $lgABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $lg; ?>,<?php echo
$row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,24,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipop1'];?>">
<small class="text-danger"><b>B <?php echo $lgABoRL; ?></b></small><br>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $row_Recordset1['idequipo2p2']; ?>, 'BG', 2);" <?php //estoyd aqui
} ?>
>
