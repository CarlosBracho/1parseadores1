...
$query_Recordset13 = sprintf(
  "/* PARSEADORES1 parley\adpaprobar.php - QUERY 1 */ SELECT *
  FROM p4jugadas
  WHERE
...
if ($totalRows_Recordset13>0) {
    do {
      $query_Recordset19 = sprintf(
        "/* PARSEADORES1 parley\adpaprobar.php - QUERY 2 */ SELECT 
        *
        FROM
    p4jugadas, p2juegos
    WHERE
    ...
    p4jugadas.nticketp4 = %s   ORDER BY p4jugadas.lineatp4 DESC",
        GetSQLValueString($row_Recordset13['nticketp4'], "int"));
               ...
               $query_Recordset18 = sprintf(
                  "/* PARSEADORES1 parley\adpaprobar.php - QUERY 3 */ SELECT 
...
<?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 parley\adpaprobar.php - QUERY 4 */ SELECT *
                FROM p4jugadas
                WHERE
