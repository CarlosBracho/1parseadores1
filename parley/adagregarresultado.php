...
if (!isset($_SESSION)) {
    ...
    if (empty($_GET['Id_p2juegosp2'])) {
        ...
        $Id_p2juegosp2=$_GET['Id_p2juegosp2'];
            ...
            $query_Recordset111 = sprintf(
                "/* PARSEADORES1 parley\adagregarresultado.php - QUERY 1 */ SELECT * FROM p5resultadosj WHERE 
			juegop5 = %s",
    ...
    if (empty($Id_p2juegosp2)) {
        ...
        $query_Recordset1 = sprintf(
            "/* PARSEADORES1 parley\adagregarresultado.php - QUERY 2 */ SELECT * FROM p2juegos WHERE 
			Id_p2juegosp2 = %s",
            GetSQLValueString($Id_p2juegosp2, "int")
        );
...
if (empty($_POST['1e1']!='')) {
    ...
    $query_Recordset14 = sprintf(
        "/* PARSEADORES1 parley\adagregarresultado.php - QUERY 3 */ SELECT * FROM p5resultadosj WHERE 
			juegop5 = %s",
    ...
    if ($totalRows_Recordset14==0) {
        if ($_POST['Id_p2juegosp2']>0) {
            ...
            $insertSQL155 = sprintf(
                "/* PARSEADORES1 parley\adagregarresultado.php - QUERY 4 */ INSERT INTO p5resultadosj  
...
%s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        $insertSQL155 = sprintf(
            "/* PARSEADORES1 parley\adagregarresultado.php - QUERY 5 */ UPDATE p5resultadosj  SET 
...
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 parley\adagregarresultado.php - QUERY 6 */ SELECT *
FROM p1equipos
WHERE  
...
$query_Recordset22 = sprintf(
    "/* PARSEADORES1 parley\adagregarresultado.php - QUERY 7 */ SELECT *
FROM p1equipos
WHERE  
...
<th scope="col"><?php
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 parley\adagregarresultado.php - QUERY 8 */ SELECT *
FROM p1equipos
WHERE  
...
$equipo1=$row_Recordset21['nomequipop1'];
$query_Recordset22 = sprintf(
    "/* PARSEADORES1 parley\adagregarresultado.php - QUERY 9 */ SELECT *
FROM p1equipos
WHERE  
...
<th scope="col"><?php
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 parley\adagregarresultado.php - QUERY 10 */ SELECT *
FROM p1equipos
WHERE  
...
$equipo1=$row_Recordset21['nomequipop1'];
$query_Recordset22 = sprintf(
    "/* PARSEADORES1 parley\adagregarresultado.php - QUERY 11 */ SELECT *
FROM p1equipos
WHERE  
...
<th scope="col"><?php
$query_Recordset21 = sprintf(
"/* PARSEADORES1 parley\adagregarresultado.php - QUERY 12 */ SELECT *
FROM p1equipos
WHERE  
...
$equipo1=$row_Recordset21['nomequipop1'];
$query_Recordset22 = sprintf(
"/* PARSEADORES1 parley\adagregarresultado.php - QUERY 13 */ SELECT *
FROM p1equipos
WHERE  
...
<th scope="col"><?php
$query_Recordset21 = sprintf(
"/* PARSEADORES1 parley\adagregarresultado.php - QUERY 14 */ SELECT *
FROM p1equipos
WHERE  
...
$equipo1=$row_Recordset21['nomequipop1'];
$query_Recordset22 = sprintf(
"/* PARSEADORES1 parley\adagregarresultado.php - QUERY 15 */ SELECT *
FROM p1equipos
WHERE  
...
<th scope="col"><?php
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 parley\adagregarresultado.php - QUERY 16 */ SELECT *
FROM p1equipos
WHERE  
...
$equipo1=$row_Recordset21['nomequipop1'];
$query_Recordset22 = sprintf(
    "/* PARSEADORES1 parley\adagregarresultado.php - QUERY 17 */ SELECT *
FROM p1equipos
WHERE  
