...
<center>
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 parley\apc_futbol1.php - QUERY 1 */ SELECT * FROM p2juegos 
...
do {
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 parley\apc_futbol1.php - QUERY 2 */ SELECT *
FROM p1equipos
WHERE  
Id_p1equiposp1 = %s",
    ...
    $query_Recordset22 = sprintf(
        "/* PARSEADORES1 parley\apc_futbol1.php - QUERY 3 */ SELECT *
...
<small class="font-weight-bold"><?php echo strftime("%A %d ", strtotime($row_Recordset1['iniciodtp2']));
    ...
    echo date("g:ia", strtotime($nuevahora1));   echo ' Codigo de juego '.$row_Recordset1['Id_p2juegosp2']; ?>
    </small>
...
<?php } else {?><td  id="<?php echo $idequipo1 ?><?php echo $idequipo2 ?>0<?php echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101" onclick="crearcompeticion2(1, <?php echo $Id_p3logros; ?>, 1);" <?php //estoyd aqui
 } ?>  
class="<?php echo $idequipo1 ?>0<?php echo $idequipo2 ?>,EML, ,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,<?php  echo $lg; ?>,<?php echo
$row_Recordset21['nomequipop1']; ?> VS <?php echo $row_Recordset22['nomequipop1']; ?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,25,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,,13:10:00,<?php echo $row_Recordset21['nomequipop1']; ?> VS <?php echo $row_Recordset22['nomequipop1'];?>">
<?php $psi=0; if ($lg==0) { $psi=1;  } deam($psi, $lg, $ttl); ?></td><?php }}else{?>

<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $row_Recordset1['idequipo2p2']; ?>, 'EML', 0);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $row_Recordset1['idequipo2p2']; ?>, 'E5ML', 0);" <?php //estoyd aqui
} ?>
>
...
class="<?php echo $idequipo1; ?>1,RL,<?php echo $lgABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo
$lg; ?>,<?php echo $row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,2,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,3,,22:00:00,"><?php echo $lgABoRL; ?> <?php $psi=0; if ($lg==0) { $psi=1;  } deam($psi, $lg, $ttl); ?></td><?php }}else{?>
...
class="<?php echo $idequipo2; ?>2,RL,<?php echo $lgABoRL; ?>,<?php echo $Id_p3logros; ?>,<?php  echo
$lg; ?>,<?php echo $row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,3,,22:00:00,"><?php echo $lgABoRL; ?> <?php $psi=0; if ($lg==0) { $psi=1;  } deam($psi, $lg, $ttl); ?></td><?php }}else{?>
