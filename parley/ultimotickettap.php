...
$FechaTxt=fechaactualbd();
        $query_Recordset12 = sprintf(
            "/* PARSEADORES1 parley\ultimotickettap.php - QUERY 1 */ SELECT 
    *
    ...
    "/* PARSEADORES1 parley\ultimotickettap.php - QUERY 2 */ SELECT 
*
...
$query_Recordset94 = sprintf(
  "/* PARSEADORES1 parley\ultimotickettap.php - QUERY 3 */ SELECT 
*
