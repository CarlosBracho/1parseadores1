...
$query_Recordset13 = sprintf("/* PARSEADORES1 parley\adpreportejugadas.php - QUERY 1 */ SELECT *
FROM p4jugadas
WHERE
...
if(isset($_POST['ticket'])){
  $insertSQL1 = sprintf(
    "/* PARSEADORES1 parley\adpreportejugadas.php - QUERY 2 */ UPDATE p4jugadas
...
if ($totalRows_Recordset13>=1) {
    do {
      ...
      $query_Recordset19 = sprintf(
        "/* PARSEADORES1 parley\adpreportejugadas.php - QUERY 3 */ SELECT 
        *
        FROM
    p4jugadas, p2juegos
    WHERE
    ...
    p4jugadas.nticketp4 = %s   ORDER BY p4jugadas.lineatp4 DESC",
        GetSQLValueString($row_Recordset13['nticketp4'], "int"));
               ...
               $query_Recordset18 = sprintf(
                  "/* PARSEADORES1 parley\adpreportejugadas.php - QUERY 4 */ SELECT 
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 parley\adpreportejugadas.php - QUERY 5 */ SELECT *
                FROM p4jugadas
                WHERE
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
 $query_Recordset135 = sprintf("/* PARSEADORES1 parley\adpreportejugadas.php - QUERY 6 */ SELECT *
FROM p4jugadas
WHERE
...
$query_Recordset1 = sprintf(
  "/* PARSEADORES1 parley\adpreportejugadas.php - QUERY 7 */ SELECT 
*
