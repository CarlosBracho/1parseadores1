...
<?php
    ...
    "/* PARSEADORES1 parley\apc_futbolamericano1.php - QUERY 1 */ SELECT * FROM p2juegos 
...
do {
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 parley\apc_futbolamericano1.php - QUERY 2 */ SELECT *
FROM p1equipos
WHERE  
Id_p1equiposp1 = %s",
...
<?php echo strftime("%A %d ", strtotime($row_Recordset1['iniciodtp2']));
    ...
    echo date("g:ia", strtotime($nuevahora1));   echo ' Codigo de juego '.$row_Recordset1['Id_p2juegosp2']; ?></small></h6></div></td>
</th>
...
$query_Recordset22 = sprintf(
        "/* PARSEADORES1 parley\apc_futbolamericano1.php - QUERY 3 */ SELECT *
