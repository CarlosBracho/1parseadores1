...
$query_Recordset18 = sprintf(
    "/* PARSEADORES1 parley\carculojparleyres.php - QUERY 1 */ SELECT * FROM p5resultadosj WHERE 
...
$query_Recordset188 = sprintf(
    "/* PARSEADORES1 parley\carculojparleyres.php - QUERY 2 */ SELECT * 
FROM 
p4jugadas, p2juegos 
WHERE 
p4jugadas.padrep4 = %s AND p4jugadas.juegop4 = p2juegos.Id_p2juegosp2  AND estadoticketp4 <>7
ORDER BY 
...
$insertSQL155 = sprintf(
    "/* PARSEADORES1 parley\carculojparleyres.php - QUERY 3 */ UPDATE p4jugadas  SET 
estadojugadap4=%s
WHERE juegop4=%s",
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 parley\carculojparleyres.php - QUERY 4 */ SELECT * 
FROM 
p4jugadas, p2juegos 
WHERE 
p4jugadas.padrep4 = %s AND p4jugadas.juegop4 = p2juegos.Id_p2juegosp2  AND estadoticketp4 <>7
...
$query_Recordset11 = sprintf(
    "/* PARSEADORES1 parley\carculojparleyres.php - QUERY 5 */ SELECT * FROM p5resultadosj WHERE 
juegop5 = %s ORDER BY Id_p5resultadosjp5 ASC LIMIT 1",
    GetSQLValueString($Id_p2juegosp2, "int")
);
...
if ($row_Recordset1['deportep2']=='beisbol') {
    ...
    do {
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 parley\carculojparleyres.php - QUERY 6 */ SELECT * FROM p1equipos WHERE 
nomequipop1 = %s",
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 parley\carculojparleyres.php - QUERY 7 */ SELECT * FROM p2juegos WHERE 
...
if ($row_Recordset1['deportep2']=='baloncesto') {
    ...
    do {
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 parley\carculojparleyres.php - QUERY 8 */ SELECT * FROM p1equipos WHERE 
nomequipop1 = %s",
            GetSQLValueString($row_Recordset1['equipop4'], "text")
        );
        $Recordset2 = mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 parley\carculojparleyres.php - QUERY 9 */ SELECT * FROM p2juegos WHERE 
idequipo1p2 = %s AND Id_p2juegosp2 = %s",
            GetSQLValueString($row_Recordset2['Id_p1equiposp1'], "int"),
            GetSQLValueString($Id_p2juegosp2, "int")
        );
...
if ($row_Recordset1['deportep2']=='futbol' or $row_Recordset1['deportep2']=='futbolamericano' or $row_Recordset1['deportep2']=='baloncesto') {
    ...
    do {
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 parley\carculojparleyres.php - QUERY 10 */ SELECT * FROM p1equipos WHERE 
nomequipop1 = %s",
            GetSQLValueString($row_Recordset1['equipop4'], "text")
        );
        $Recordset2 = mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 parley\carculojparleyres.php - QUERY 11 */ SELECT * FROM p2juegos WHERE 
idequipo1p2 = %s AND Id_p2juegosp2 = %s",
            GetSQLValueString($row_Recordset2['Id_p1equiposp1'], "int"),
            GetSQLValueString($Id_p2juegosp2, "int")
        );
...
if ($row_Recordset1['deportep2']=='hockey') {
    ...
    do {
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 parley\carculojparleyres.php - QUERY 12 */ SELECT * FROM p1equipos WHERE 
nomequipop1 = %s",
            GetSQLValueString($row_Recordset1['equipop4'], "text")
        );
        $Recordset2 = mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 parley\carculojparleyres.php - QUERY 13 */ SELECT * FROM p2juegos WHERE 
idequipo1p2 = %s AND Id_p2juegosp2 = %s",
            GetSQLValueString($row_Recordset2['Id_p1equiposp1'], "int"),
            GetSQLValueString($Id_p2juegosp2, "int")
        );
