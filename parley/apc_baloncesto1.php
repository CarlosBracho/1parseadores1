...
function imprim2(imp2){
var printContents = document.getElementById('imp2').innerHTML;
        w = window.open();
...
<center>
    <table class="table table-bordered table-sm"><br>
        <center>
    <button type="button" class='btn-primary' onclick="javascript:imprim2(imp2);">IMPRIMIR HOJA DE LOGROS BALONCESTO</button>
        </center>
        <br>
        <thead>
            <tr class="table-dark">
...
<?php
    ...
    "/* PARSEADORES1 parley\apc_baloncesto1.php - QUERY 1 */ SELECT * FROM p2juegos 
...
do {
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 parley\apc_baloncesto1.php - QUERY 2 */ SELECT *
FROM p1equipos
WHERE  
Id_p1equiposp1 = %s",
...
<?php
}elseif(($tipo==7)){?><a class="" style="color:white" data-toggle="modal" data-target="#exampleModal100"  onclick="crearcompeticion(1, <?php echo $row_Recordset1['Id_p2juegosp2'];?>, 5);"><?php } echo $row_Recordset1['competicionp2']; ?></a></div></td></tr>
...
<th><h6><small class="font-weight-bold"><?php echo strftime("%A %d ", strtotime($row_Recordset1['iniciodtp2']));
    ...
    echo date("g:ia", strtotime($nuevahora1));  echo ' Codigo de juego '.$row_Recordset1['Id_p2juegosp2']; ?></small></h6></th><th><h6><small class="font-weight-bold">Ganar</small></h6></th><th><h6><small class="font-weight-bold">A/B</small></h6></th><th><h6><small class="font-weight-bold">RL</small></h6></th><th><h6><small class="font-weight-bold">Ganar MJ</small></h6></th><th><h6><small class="font-weight-bold">A/B MJ</small></h6></th><th><h6><small class="font-weight-bold">RL MJ</small></h6></th></tr>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $row_Recordset1['idequipo2p2']; ?>, '5ML', 1);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $row_Recordset1['idequipo2p2']; ?>, '5A', 1);" <?php //estoyd aqui
} ?>
>
...
<td  onmouseover="changeCell(this)" onmouseout="changeCellOut(this)"<?php if($tipo==7){?>  data-toggle="modal" data-target="#exampleModal101d" onclick="agregarlogros(<?php echo $row_Recordset1['Id_p2juegosp2']; ?>, <?php echo $row_Recordset1['idequipo2p2']; ?>, '5RL', 1);" <?php //estoyd aqui
} ?>
>
...
$query_Recordset22 = sprintf(
        "/* PARSEADORES1 parley\apc_baloncesto1.php - QUERY 3 */ SELECT *
