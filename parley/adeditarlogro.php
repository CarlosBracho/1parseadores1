...
if (isset($_POST['logro'])) {
    ...
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 parley\adeditarlogro.php - QUERY 1 */ UPDATE p3logros 
    ...
    $query_Recordset1 =  sprintf(
        "/* PARSEADORES1 parley\adeditarlogro.php - QUERY 2 */ SELECT  
*
				FROM  p3logros
				WHERE Id_p3logrosp3 = %s
				LIMIT 1",
    ...
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 parley\adeditarlogro.php - QUERY 3 */ SELECT *
