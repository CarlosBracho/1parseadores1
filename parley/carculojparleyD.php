...
$query_Recordset118 = sprintf(
    "/* PARSEADORES1 parley\carculojparleyD.php - QUERY 1 */ SELECT * FROM p4jugadas WHERE 
  ...
  if ($ganador==1) {
    ...
    $insertSQL155 = sprintf(
             "/* PARSEADORES1 parley\carculojparleyD.php - QUERY 2 */ UPDATE p4jugadas  SET 
       ...
       WHERE nticketp4=%s AND lineatp4=%s AND estadoticketp4=%s",
        ...
        $insertSQL1556 = sprintf(
            "/* PARSEADORES1 parley\carculojparleyD.php - QUERY 3 */ UPDATE p4jugadas  SET 
