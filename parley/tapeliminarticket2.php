...
"/* PARSEADORES1 parley\tapeliminarticket2.php - QUERY 1 */ SELECT 
*     
FROM
p4jugadas, p2juegos
WHERE   
...
$query_Recordset19 = sprintf(
    "/* PARSEADORES1 parley\tapeliminarticket2.php - QUERY 2 */ SELECT 
    *
    FROM
    p4jugadas, p2juegos
...
"/* PARSEADORES1 parley\tapeliminarticket2.php - QUERY 3 */ UPDATE p4jugadas  SET 
premioapagarp4=%s,
jugadadtp4pago=%s,
estadoticketp4=%s 
...
"/* PARSEADORES1 parley\tapeliminarticket2.php - QUERY 4 */ SELECT 
*
FROM
p4jugadas
WHERE
