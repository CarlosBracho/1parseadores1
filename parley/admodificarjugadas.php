...
$query_Recordset13 = sprintf("/* PARSEADORES1 parley\admodificarjugadas.php - QUERY 1 */ SELECT *
FROM p4jugadas
WHERE
...
if(isset($_POST['ticket'])){
  $insertSQL1 = sprintf(
    "/* PARSEADORES1 parley\admodificarjugadas.php - QUERY 2 */ UPDATE p4jugadas
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
        ...
        $query_Recordset14 = sprintf(
            "/* PARSEADORES1 parley\admodificarjugadas.php - QUERY 3 */ SELECT *
                FROM p4jugadas
                WHERE
...
onclick="detalle_ticket(<?php echo $row_Recordset13['nticketp4']; ?>, 0, 2); return false"><?php
 $query_Recordset135 = sprintf("/* PARSEADORES1 parley\admodificarjugadas.php - QUERY 4 */ SELECT *
FROM p4jugadas
WHERE
