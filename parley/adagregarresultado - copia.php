...
if (!isset($_SESSION)) {
    ...
    if (empty($_GET['Id_p2juegosp2'])) {
        ...
        $query_Recordset12 = sprintf(
            "/* PARSEADORES1 parley\adagregarresultado - copia.php - QUERY 1 */ SELECT * FROM p5resultadosj WHERE 
			juegop5 = %s",
    ...
    if ($totalRows_Recordset12>0) {
        $query_Recordset111 = sprintf(
            "/* PARSEADORES1 parley\adagregarresultado - copia.php - QUERY 2 */ SELECT * FROM p5resultadosj WHERE 
        ...
        $query_Recordset112 = sprintf(
            "/* PARSEADORES1 parley\adagregarresultado - copia.php - QUERY 3 */ SELECT * FROM p5resultadosj WHERE 
			juegop5 = %s AND equipop5 = %s ",
            GetSQLValueString($Id_p2juegosp2, "int"),
    ...
    if (empty($Id_p2juegosp2)) {
        ...
        $query_Recordset1 = sprintf(
            "/* PARSEADORES1 parley\adagregarresultado - copia.php - QUERY 4 */ SELECT * FROM p2juegos WHERE 
			Id_p2juegosp2 = %s",
            GetSQLValueString($Id_p2juegosp2, "int")
        );
...
if (empty($_POST['1e1']!='')) {
    ...
    $query_Recordset14 = sprintf(
        "/* PARSEADORES1 parley\adagregarresultado - copia.php - QUERY 5 */ SELECT * FROM p5resultadosj WHERE 
			juegop5 = %s",
    ...
    if ($totalRows_Recordset14==0) {
        if ($_POST['juegop5']>0) {
            ...
            $insertSQL155 = sprintf(
                "/* PARSEADORES1 parley\adagregarresultado - copia.php - QUERY 6 */ INSERT INTO p5resultadosj  
...
VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            ...
            $insertSQL155 = sprintf(
                "/* PARSEADORES1 parley\adagregarresultado - copia.php - QUERY 7 */ INSERT INTO p5resultadosj  
(deportep5, juegop5, equipop5, fec_inciop5, hor_inciop5, tiemposjugadosp5, r1p5, r2p5, r3p5, r4p5, r5p5, r6p5, r7p5, r8p5, r9p5, r10p5, r11p5, r12p5, r13p5, r14p5, r15p5, r16p5, r17p5, r18p5, r19p5, r20p5, r21p5, r22p5, r23p5, r24p5, r25p5, r26p5, r27p5, r28p5, r29p5, r30p5)
VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($_POST['deporte'], "text"),
                GetSQLValueString($_POST['juegop5'], "int"),
        ...
        $insertSQL155 = sprintf(
            "/* PARSEADORES1 parley\adagregarresultado - copia.php - QUERY 8 */ UPDATE p5resultadosj  SET 
...
WHERE juegop5=%s AND equipop5=%s",
        ...
        $insertSQL156 = sprintf(
            "/* PARSEADORES1 parley\adagregarresultado - copia.php - QUERY 9 */ UPDATE p5resultadosj  SET 
deportep5=%s, juegop5=%s, equipop5=%s, fec_inciop5=%s, hor_inciop5=%s, tiemposjugadosp5=%s, r1p5=%s, r2p5=%s, r3p5=%s, r4p5=%s, r5p5=%s, r6p5=%s, r7p5=%s, r8p5=%s, r9p5=%s, r10p5=%s, r11p5=%s, r12p5=%s, r13p5=%s, r14p5=%s, r15p5=%s, r16p5=%s, r17p5=%s, r18p5=%s, r19p5=%s, r20p5=%s, r21p5=%s, r22p5=%s, r23p5=%s, r24p5=%s, r25p5=%s, r26p5=%s, r27p5=%s, r28p5=%s, r29p5=%s, r30p5=%s
WHERE juegop5=%s AND equipop5=%s",
            GetSQLValueString($_POST['deporte'], "text"),
            GetSQLValueString($_POST['juegop5'], "int"),
...
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 parley\adagregarresultado - copia.php - QUERY 10 */ SELECT *
FROM p1equipos
WHERE  
...
<th scope="col"><?php
$query_Recordset21 = sprintf(
    "/* PARSEADORES1 parley\adagregarresultado - copia.php - QUERY 11 */ SELECT *
FROM p1equipos
WHERE  
