...
$query_Recordset18 = sprintf(
    "/* PARSEADORES1 parley\carculojparley.php - QUERY 1 */ SELECT * FROM p5resultadosj WHERE
...
echo $totalRows_Recordset18.'totalRows_Recordset18.<br>';
...
$query_Recordset188 = sprintf(
    "/* PARSEADORES1 parley\carculojparley.php - QUERY 2 */ SELECT * 
FROM 
p4jugadas, p2juegos 
WHERE 
...
$insertSQL155 = sprintf(
    "/* PARSEADORES1 parley\carculojparley.php - QUERY 3 */ UPDATE p4jugadas  SET 
estadojugadap4=%s
WHERE juegop4=%s",
...
if($row_Recordset188['estadojugadap4']==0 && $row_Recordset188['estadojugadap4']<>2|| $row_Recordset188['estadojugadap4']==1 && $row_Recordset188['estadojugadap4']<>2){
    echo 'se mando a calcular jugada<br>';
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 parley\carculojparley.php - QUERY 4 */ SELECT * 
FROM 
p4jugadas, p2juegos 
WHERE 
p2juegos.iniciodtp2 >= %s AND p2juegos.iniciodtp2 <= %s AND p4jugadas.jugadadtp4 >= %s AND p4jugadas.jugadadtp4 <= %s AND 
...
echo 'estadojugadap4= '.$row_Recordset1['estadojugadap4'].'<br>';

if($row_Recordset1['estadojugadap4'] <> 7){
//if($row_Recordset1['estadojugadap4'] <> 3){

$query_Recordset11 = sprintf(
    "/* PARSEADORES1 parley\carculojparley.php - QUERY 5 */ SELECT * FROM p5resultadosj WHERE
     iniciodtp5 >= %s AND iniciodtp5 <= %s AND 
juegop5 = %s ORDER BY Id_p5resultadosjp5 ASC LIMIT 1",
GetSQLValueString($Fechacal.' 00:00:02', "date"),
GetSQLValueString($Fechacal.' 23:59:59', "date"),
...
echo $totalRows_Recordset11.'totalRows_Recordset11<br>';
...
if ($row_Recordset1['deportep2']=='beisbol') {
    ...
    do {
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 parley\carculojparley.php - QUERY 6 */ SELECT * FROM p1equipos WHERE 
nomequipop1 = %s",
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 parley\carculojparley.php - QUERY 7 */ SELECT * FROM p2juegos WHERE 
...
if ($row_Recordset1['deportep2']=='baloncesto') {
    ...
    do {
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 parley\carculojparley.php - QUERY 8 */ SELECT * FROM p1equipos WHERE 
nomequipop1 = %s",
            GetSQLValueString($row_Recordset1['equipop4'], "text")
        );
        $Recordset2 = mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 parley\carculojparley.php - QUERY 9 */ SELECT * FROM p2juegos WHERE 
                        iniciodtp2 >= %s AND iniciodtp2 <= %s AND 
idequipo1p2 = %s AND Id_p2juegosp2 = %s",
GetSQLValueString($Fechacal.' 00:00:02', "date"),
GetSQLValueString($Fechacal.' 23:59:59', "date"),
...
if ($row_Recordset1['deportep2']=='futbol' or $row_Recordset1['deportep2']=='futbolamericano' or $row_Recordset1['deportep2']=='baloncesto') {
    ...
    do {
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 parley\carculojparley.php - QUERY 10 */ SELECT * FROM p1equipos WHERE 
nomequipop1 = %s",
            GetSQLValueString($row_Recordset1['equipop4'], "text")
        );
        $Recordset2 = mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 parley\carculojparley.php - QUERY 11 */ SELECT * FROM p2juegos WHERE 
                        iniciodtp2 >= %s AND iniciodtp2 <= %s AND 
idequipo1p2 = %s AND Id_p2juegosp2 = %s",
GetSQLValueString($Fechacal.' 00:00:02', "date"),
GetSQLValueString($Fechacal.' 23:59:59', "date"),
...
if ($row_Recordset1['deportep2']=='hockey') {
    ...
    do {
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 parley\carculojparley.php - QUERY 12 */ SELECT * FROM p1equipos WHERE 
nomequipop1 = %s",
            GetSQLValueString($row_Recordset1['equipop4'], "text")
        );
        $Recordset2 = mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 parley\carculojparley.php - QUERY 13 */ SELECT * FROM p2juegos WHERE 
                        iniciodtp2 >= %s AND iniciodtp2 <= %s AND 
idequipo1p2 = %s AND Id_p2juegosp2 = %s",
GetSQLValueString($Fechacal.' 00:00:02', "date"),
GetSQLValueString($Fechacal.' 23:59:59', "date"),
