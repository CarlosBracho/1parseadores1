...
<?php
    ...
    "/* PARSEADORES1 parley\parley\apc_baloncesto.php - QUERY 1 */ SELECT * FROM p2juegos 
...
do {
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 parley\parley\apc_baloncesto.php - QUERY 2 */ SELECT *
FROM p1equipos
WHERE  
Id_p1equiposp1 = %s",
...
<tr class="table-primary"><td colspan="8"><div class="equipos"><?php  echo $row_Recordset1['competicionp2']; ?></div></td></tr>
...
<th><h6><small class="font-weight-bold"><?php echo strftime("%A %d ", strtotime($row_Recordset1['iniciodtp2']));
    ...
    echo date("g:ia", strtotime($nuevahora1)); ?></small></h6></th><th><h6><small class="font-weight-bold">Ganar</small></h6></th><th><h6><small class="font-weight-bold">A/B</small></h6></th><th><h6><small class="font-weight-bold">Spread</small></h6></th><th><h6><small class="font-weight-bold">Ganar MJ</small></h6></th><th><h6><small class="font-weight-bold">A/B MJ</small></h6></th><th><h6><small class="font-weight-bold">Spread MJ</small></h6></th></tr>
...
$row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,1,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,,13:10:00,<?php echo $row_Recordset21['nomequipop1'];?>"><?php if ($logro>0) {
    echo "+";
}  echo $logro;?></td>
<?php } else {?><td></td><?php } ?>
...
$logro; ?>,<?php echo $row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,,13:10:00,"><small class="text-primary"><b>A <?php echo $logroABoRL; ?></b></small> <?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegosp2'], 1, 'RL', $tlarray);
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>1_<?php echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" 
class="<?php echo $idequipo2; ?>1,RL,<?php echo $logroABoRL; ?>,<?php echo $Id_p3logros; ?>,<?php  echo
$logro; ?>,<?php echo $row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,2,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,,13:10:00,<?php echo $row_Recordset22['nomequipop1'];?>"><small class="text-primary"><b><?php echo $logroABoRL; ?> </b></small> <?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
$row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,9,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,9,,13:10:00,<?php echo $row_Recordset21['nomequipop1'];?>"><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>	
...
$row_Recordset21['nomequipop1'];?>"><small class="text-primary"><b>A <?php echo $logroABoRL; ?></b></small> <?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
<?php  echo $logro; ?>,<?php echo $row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,10,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,,13:10:00,"><small 
class="text-primary"><b><?php echo $logroABoRL; ?></b></small> <?php if ($logro>0) {
        echo "+";
    }  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>	
...
$query_Recordset22 = sprintf(
        "/* PARSEADORES1 parley\parley\apc_baloncesto.php - QUERY 3 */ SELECT *
...
$row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,5,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,,13:10:00,<?php echo $row_Recordset22['nomequipop1'];?>"><?php if ($logro>0) {
    echo "+";
} echo $logro;?></td>
<?php } else {?><td></td><?php } ?>
...
$logro; ?>,<?php echo $row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,8,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,,13:10:00,<?php echo $row_Recordset22['nomequipop1'];?>"><small class="text-primary">
<b>B <?php echo $logroABoRL; ?></b></small> <?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
$logro; ?>,<?php echo $row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,,13:10:00,<?php echo $row_Recordset22['nomequipop1'];?>"><small class="text-primary"><b><?php echo $logroABoRL; ?></b></small> <?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
$row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,13,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,,13:10:00,<?php echo $row_Recordset21['nomequipop1'];?>"><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
$row_Recordset22['nomequipop1'];?>"><small class="text-primary"><b>B <?php echo $logroABoRL; ?></b></small> <?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
$logro; ?>,<?php echo $row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,14,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,,13:10:00,<?php echo $row_Recordset22['nomequipop1'];?>"><small 
class="text-primary"><b><?php echo $logroABoRL; ?></b></small> <?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
