...
$query_Recordset5 = sprintf(
    "
/* PARSEADORES1 parley\parley\parleya.php - QUERY 1 */ SELECT * FROM usuario, taquilla, taquilla_opc_ame, agencia,
			banca
...
function Obtenerlogro($Id_p2juegos, $equipo, $tipojugada)
{
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 parley\parley\parleya.php - QUERY 2 */ SELECT *
FROM  p3logros
WHERE 
...
p3logros.tipojugada = %s",
    ...
    $query_Recordset1 = "/* PARSEADORES1 parley\parley\parleya.php - QUERY 3 */ SELECT * FROM p2juegos";
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
