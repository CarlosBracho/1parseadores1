...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 parley\parley\carculojparley.php - QUERY 1 */ SELECT * 
FROM 
p4jugadas, p2juegos 
WHERE 
p4jugadas.padrep4 = %s AND p4jugadas.juegop4 = p2juegos.Id_p2juegosp2
ORDER BY 
...
$query_Recordset11 = sprintf(
    "/* PARSEADORES1 parley\parley\carculojparley.php - QUERY 2 */ SELECT * FROM p5resultadosj WHERE 
...
if ($row_Recordset1['deportep2']=='beisbol') {
    ...
    do {
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 parley\parley\carculojparley.php - QUERY 3 */ SELECT * FROM p1equipos WHERE 
nomequipop1 = %s",
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 parley\parley\carculojparley.php - QUERY 4 */ SELECT * FROM p2juegos WHERE 
...
if ($row_Recordset1['deportep2']=='baloncesto') {
    ...
    do {
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 parley\parley\carculojparley.php - QUERY 5 */ SELECT * FROM p1equipos WHERE 
nomequipop1 = %s",
            GetSQLValueString($row_Recordset1['equipop4'], "text")
        );
        $Recordset2 = mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 parley\parley\carculojparley.php - QUERY 6 */ SELECT * FROM p2juegos WHERE 
idequipo1p2 = %s AND Id_p2juegosp2 = %s",
            GetSQLValueString($row_Recordset2['Id_p1equiposp1'], "int"),
            GetSQLValueString($_GET['Id_p2juegosp2'], "int")
        );
...
//inicio futbol
if ($row_Recordset1['deportep2']=='futbol') {
    $AB=$row11['r21p5']+$row11['r22p5']+$row11['r23p5']+$row11['r24p5'];
    $ABmi=$row11['r21p5']+$row11['r22p5'];
    if (($row11['r21p5']+$row11['r23p5'])>($row11['r22p5']+$row11['r24p5'])) {
        $gano=1;
    ...
    do {
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 parley\parley\carculojparley.php - QUERY 7 */ SELECT * FROM p1equipos WHERE 
nomequipop1 = %s",
            GetSQLValueString($row_Recordset1['equipop4'], "text")
        );
        $Recordset2 = mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 parley\parley\carculojparley.php - QUERY 8 */ SELECT * FROM p2juegos WHERE 
idequipo1p2 = %s AND Id_p2juegosp2 = %s",
            GetSQLValueString($row_Recordset2['Id_p1equiposp1'], "int"),
            GetSQLValueString($_GET['Id_p2juegosp2'], "int")
        );
...
if ($row_Recordset1['deportep2']=='hockey') {
    ...
    do {
        ...
        $query_Recordset2 = sprintf(
            "/* PARSEADORES1 parley\parley\carculojparley.php - QUERY 9 */ SELECT * FROM p1equipos WHERE 
nomequipop1 = %s",
            GetSQLValueString($row_Recordset1['equipop4'], "text")
        );
        $Recordset2 = mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
        ...
        $query_Recordset3 = sprintf(
            "/* PARSEADORES1 parley\parley\carculojparley.php - QUERY 10 */ SELECT * FROM p2juegos WHERE 
idequipo1p2 = %s AND Id_p2juegosp2 = %s",
            GetSQLValueString($row_Recordset2['Id_p1equiposp1'], "int"),
            GetSQLValueString($_GET['Id_p2juegosp2'], "int")
        );
