...
$query_Recordset5 = sprintf(
    "
/* PARSEADORES1 parley\parley\apparleymalo.php - QUERY 1 */ SELECT * FROM usuario, taquilla, taquilla_opc_ame, agencia,
			banca
...
function Obtenerlogro($Id_p2juegos, $equipo, $tipojugada)
{
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 parley\parley\apparleymalo.php - QUERY 2 */ SELECT *
FROM  p3logros
WHERE 
...
p3logros.tipojugada = %s",
    ...
    $query_Recordset1 = "/* PARSEADORES1 parley\parley\apparleymalo.php - QUERY 3 */ SELECT * FROM p2juegos";
    $Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
    $row_Recordset1 = mysqli_fetch_assoc($Recordset1);
    $totalRows_Recordset1 = mysqli_num_rows($Recordset1);
...
<span class="d-none d-xl-inline d-lg-inline d-xl-none">
    <div class="row">
        <div class="col-lg-3 mb-4">
            ...
            <form action="http://localhost/parley/apparley.php" method="post" accept-charset="utf-8" id="form" name="form">            
...
<?php
    $query_Recordset1 = sprintf(
    "/* PARSEADORES1 parley\parley\apparleymalo.php - QUERY 4 */ SELECT * FROM p2juegos 
	WHERE deporte = %s AND competicion = %s AND pais = %s",
...
do {
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 parley\parley\apparleymalo.php - QUERY 5 */ SELECT *
FROM p1equipos
WHERE  

p1equipos.Id_p1equipos = %s",
        GetSQLValueString($row_Recordset1['idequipo1'], "int")
    );
    ...
    $idequipo1=$row_Recordset1['Id_p2juegos'];
    $idequipo2=$row_Recordset1['Id_p2juegos']; ?>
...
<tr class="table-light"><td><div class="text-center font-weight-bold"><?php echo $idequipo1; ?>1</div></td>
<td><img width="22px" height="22px" class="img-fluid" src=""><?php echo $row_Recordset21['nomequipo']; ?><p><small class="text-danger font-weight-bold">J URENA -R </small></p></td>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'ML');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo1; ?>1_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo1; ?>1,ML, ,<?php echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset21['nomequipo'];?>,7027,1,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipo'];?>"></br><?php echo $logro;?></td>
<?php } else {?><td></td><?php } ?>	

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'RL');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo1; ?>1_<?php echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo1; ?>1,RL,<?php echo $logroABoRL; ?>,<?php echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset21['nomequipo'];?>,7027,2,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipo'];?>"><small class="text-muted"><b><?php echo $logroABoRL; ?></b></small></br><?php echo $logro;?></td>
<?php } else {?><td></td><?php } ?>	

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'SR');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo1; ?>1_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo1; ?>1,SR,<?php echo $logroABoRL; ?>,<?php echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset21['nomequipo'];?>,7027,3,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipo'];?>"><small class="text-danger"><b><?php echo $logroABoRL; ?></b></small></br><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>		

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'A');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo1; ?>1_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo1; ?>1,A,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset21['nomequipo'];?>,7027,4,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,13:10:00,"><small class="text-danger"><b>A <?php echo $logroABoRL; ?></b></small></br><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>	

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, '5ML');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo1; ?>1_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo1; ?>1,5ML, ,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset21['nomequipo'];?>,7027,9,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipo'];?>"></br><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>	

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, '5RL');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo1; ?>1_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo1; ?>1,5RL,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset21['nomequipo'];?>,7027,10,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,13:10:00,"><small class="text-danger"><b><?php echo $logroABoRL; ?></b></small></br><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>	

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, '5A');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo1; ?>1_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo1; ?>1,5A,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset21['nomequipo'];?>,7027,12,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipo'];?>"><small class="text-danger"><b>A <?php echo $logroABoRL; ?></b></small></br><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'SI');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo1; ?>1_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo1; ?>1,SI, ,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset21['nomequipo'];?>,5291,17,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipo'];?>"><small class="text-danger"><b>SI</b></small></br><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'AP');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo1; ?>1_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo1; ?>1,AP, ,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset21['nomequipo'];?>,5291,19,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipo'];?>"></br><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'AG');
    if ($logro!=0) {?>
<td  id="<?php echo $idequipo1; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo1; ?>1,AG,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset21['nomequipo'];?>,5291,20,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipo'];?>"><small class="text-danger"><b>A <?php echo $logroABoRL; ?></b></small> <br><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
$query_Recordset22 = sprintf(
        "/* PARSEADORES1 parley\parley\apparleymalo.php - QUERY 6 */ SELECT *
FROM p1equipos WHERE Id_p1equipos = %s",
        GetSQLValueString($row_Recordset1['idequipo2'], "int")
    );
...
<td><div class="text-center font-weight-bold"><?php echo $idequipo2; ?>2</div></td>
<td><img width="22px" height="22px" class="img-fluid" src=""> <?php echo $row_Recordset22['nomequipo']; ?><p><small class="text-danger font-weight-bold">I ANDERSON -R </small></p></td>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'ML');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo2; ?>2,ML, ,<?php echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5265,5,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipo'];?>"></br><?php echo $logro;?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'RL');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo2; ?>2,RL,<?php echo $logroABoRL; ?>,<?php echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5265,6,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-muted"><b><?php echo $logroABoRL; ?></br></b></small><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'SR');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo2; ?>2,SR,<?php echo $logroABoRL; ?>,<?php echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,<?php echo $row_Recordset22['nomequipo'];?>,5279,7,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,20:10:00,<?php echo $row_Recordset22['nomequipo'];?>" style="cursor: pointer; color: rgb(0, 0, 0);"><small class="text-danger"><b><?php echo $logroABoRL; ?></br></b></small><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'B');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo2; ?>2,B,<?php echo $logroABoRL; ?>,<?php echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5265,8,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b>B <?php echo $logroABoRL; ?></br></b></small> <?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, '5ML');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo2; ?>2,5ML, ,<?php echo $Id_p3logros; ?>,<?php echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5265,13,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipo'];?>"></br><?php echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, '5RL');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo2; ?>2,5RL,<?php echo $logroABoRL; ?>,<?php echo $Id_p3logros; ?>,<?php echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5265,14,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b><?php echo $logroABoRL; ?></b></small></br><?php echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, '5B');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo2; ?>2,5B,<?php echo $logroABoRL; ?>,<?php echo $Id_p3logros; ?>,<?php echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5265,16,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b>B <?php echo $logroABoRL; ?></br></b></small> <?php echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'NO');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo2; ?>2,NO, ,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5280,21,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b>NO</b></small></br><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'AP');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo2; ?>2,AP, ,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5280,23,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipo'];?>"></br><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'BG');
    if ($logro!=0) {?>
<td  id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" class="<?php echo $idequipo2; ?>2,BG,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5280,24,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b>B <?php echo $logroABoRL; ?></b></small> <br><?php  echo $logro; ?></td></tr><tr></tr><tr class="table-dark">
<?php } else {?><td></td><?php } ?>
...
<div id="scrollj">
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 parley\parley\apparleymalo.php - QUERY 7 */ SELECT * FROM p2juegos 
	WHERE deporte = %s AND competicion = %s AND pais = %s",
        GetSQLValueString("Baseball", "text"),
        GetSQLValueString("MLB", "text"),
        GetSQLValueString("ESTADOS UNIDOS", "text")
...
do {
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 parley\parley\apparleymalo.php - QUERY 8 */ SELECT *
FROM p1equipos
WHERE  
...
p1equipos.Id_p1equipos = %s",
    ...
    $idequipo2=$row_Recordset1['Id_p2juegos']; ?>
			...
			src=""> <?php echo $row_Recordset21['nomequipo']; ?><p>
			<small class="text-danger font-weight-bold">J. Teheran </small></p></td>
			
			

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'ML');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,ML, ,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5291,1,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'RL');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,RL,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5291,2,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-muted"><b><?php echo $logroABoRL; ?></b></small> <?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'SR');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,SR,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5291,3,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b><?php echo $logroABoRL; ?></b></small> <?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'A');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,A,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5291,4,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b>A <?php echo $logroABoRL; ?></b></small> <?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, '5ML');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,5ML, ,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5291,9,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, '5RL');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,5RL,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5291,10,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b><?php echo $logroABoRL; ?></b></small> <?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, '5A');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,5A,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5291,12,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b>A <?php echo $logroABoRL; ?></b></small> <?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'SI');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,SI, ,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5291,17,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b>SI</b></small> <?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'AP');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,AP, ,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5291,19,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 1, 'AG');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,AG,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5291,20,<?php echo $idequipo1; ?>1<?php echo $idequipo1; ?>,4,,20:05:00,Los Angeles Angels"><small class="text-danger"><b>A <?php echo $logroABoRL; ?></b></small> <br><?php  echo $logro; ?></td>
...
<?php
$query_Recordset22 = sprintf(
        "/* PARSEADORES1 parley\parley\apparleymalo.php - QUERY 9 */ SELECT *
FROM p1equipos WHERE Id_p1equipos = %s",
        GetSQLValueString($row_Recordset1['idequipo2'], "int")
    );
    $Recordset22 =mysqli_query($conexionbanca, $query_Recordset22) or die(mysqli_error($conexionbanca));
    ...
    $totalRows_Recordset22 = mysqli_num_rows($Recordset22); ?>
			...
			<?php echo $row_Recordset22['nomequipo']; ?><p><small class="text-danger font-weight-bold">Kyle Cody </small></p></td>
			
			
			
<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'ML');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,ML, ,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5280,5,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'RL');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,RL,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5280,6,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-muted"><b><?php echo $logroABoRL; ?></b></small> <?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'SR');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,SR,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5280,7,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b><?php echo $logroABoRL; ?></b></small> <?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'B');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,B,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5280,8,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b>B <?php echo $logroABoRL; ?></b></small> <?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, '5ML');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,5ML, ,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5280,13,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, '5RL');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,5RL,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5280,14,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b><?php echo $logroABoRL; ?></b></small> <?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, '5B');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,5B,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5280,16,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b>B <?php echo $logroABoRL; ?></b></small> <?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'NO');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,NO, ,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5280,21,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>">
<small class="text-danger"><b>NO</b></small> <?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'AP');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,AP, ,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5280,23,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>

<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegos'], 2, 'BG');
    if ($logro!=0) {?>
<td id="<?php echo $idequipo2; ?>2_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell_mobil(this)" onmouseout="changeCellOut_mobil(this)" class="<?php echo $idequipo2; ?>2,BG,<?php echo $logroABoRL; ?>,<?php  echo $Id_p3logros; ?>,<?php  echo $logro; ?>,<?php echo $row_Recordset22['nomequipo'];?>,5280,24,<?php echo $idequipo2; ?>2<?php echo $idequipo2; ?>,4,,20:05:00,<?php echo $row_Recordset22['nomequipo'];?>"><small class="text-danger"><b>B <?php echo $logroABoRL; ?></b></small> <br><?php  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
</tr><tr></tr>
          <?php
} while ($row_Recordset1 = mysqli_fetch_assoc($Recordset1));
...
<div class="modal fade" id="exampleModal_mobil1" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    ...
    <script src="./Vendedorclon_files/sweetalert2@9"></script>
                            ...
                            <script src="./Vendedorclon_files/taquilla.js.descarga3"></script>
