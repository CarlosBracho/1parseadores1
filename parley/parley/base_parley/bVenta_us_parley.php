<?php
    ...
    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 1 */ SELECT
 					us.nom_usuario,
					ta.nom_taquilla,
					ta.taq_por_ame,
					ta.moneda,
...
USE INDEX(id_us_fe_fe)
    ...
    GetSQLValueString($codigoUsuario, "int")
                ...
                $query_Recordset = sprintf(
                    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 2 */ SELECT cod_taquilla FROM taquilla_opc_hnac WHERE cod_taquilla = %s LIMIT 1",
...
<?php
    ...
    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 3 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla,
					ta.taq_por_ame,
					SUM(CASE WHEN fec_venta >= %s AND fec_venta <= %s 
...
USE INDEX(id_us_fe_fe)
    ...
    GetSQLValueString($codigoUsuario, "int")
                ...
                $query_Recordset = sprintf(
                    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 4 */ SELECT cod_taquilla FROM taquilla_opc_hnac WHERE cod_taquilla = %s LIMIT 1",
                    GetSQLValueString($codigoTaquilla, "int")
                );
                $Recordset = mysqli_query($conexionbanca, $query_Recordset) or die(mysqli_error($conexionbanca));
                $row_Recordset = mysqli_fetch_assoc($Recordset);$totalRows_Recordset = mysqli_num_rows($Recordset);
...
<?php
    ...
    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 5 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla,
					ta.taq_por_ame,
					ta.efectivoO,
...
USE INDEX(id_us_fe_fe)
    ...
    GetSQLValueString($codigoUsuario, "int")
                ...
                $query_Recordset = sprintf(
                    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 6 */ SELECT cod_taquilla FROM taquilla_opc_hnac WHERE cod_taquilla = %s LIMIT 1",
                    GetSQLValueString($codigoTaquilla, "int")
                );
                $Recordset = mysqli_query($conexionbanca, $query_Recordset) or die(mysqli_error($conexionbanca));
                $row_Recordset = mysqli_fetch_assoc($Recordset);$totalRows_Recordset = mysqli_num_rows($Recordset);
...
<?php
    ...
    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 7 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla,
					ta.taq_por_ame,
					ta.efectivoO,
...
USE INDEX(id_us_fe_fe)
    ...
    GetSQLValueString($codigoUsuario, "int")
                ...
                $query_Recordset = sprintf(
                    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 8 */ SELECT cod_taquilla FROM taquilla_opc_hnac WHERE cod_taquilla = %s LIMIT 1",
                    GetSQLValueString($codigoTaquilla, "int")
                );
                $Recordset = mysqli_query($conexionbanca, $query_Recordset) or die(mysqli_error($conexionbanca));
                $row_Recordset = mysqli_fetch_assoc($Recordset);$totalRows_Recordset = mysqli_num_rows($Recordset);
...
<?php
    ...
    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 9 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla,
					ta.taq_por_ame,
					ta.efectivoO,
...
USE INDEX(id_us_fe_fe)
    ...
    GetSQLValueString($codigoUsuario, "int")
                ...
                $query_Recordset = sprintf(
                    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 10 */ SELECT cod_taquilla FROM taquilla_opc_hnac WHERE cod_taquilla = %s LIMIT 1",
                    GetSQLValueString($codigoTaquilla, "int")
                );
                $Recordset = mysqli_query($conexionbanca, $query_Recordset) or die(mysqli_error($conexionbanca));
                $row_Recordset = mysqli_fetch_assoc($Recordset);$totalRows_Recordset = mysqli_num_rows($Recordset);
...
<?php
    ...
    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 11 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla,
					ta.taq_por_ame,
					ta.efectivoO,
...
USE INDEX(id_us_fe_fe)
    ...
    GetSQLValueString($codigoUsuario, "int")
                ...
                $query_Recordset = sprintf(
                    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 12 */ SELECT cod_taquilla FROM taquilla_opc_hnac WHERE cod_taquilla = %s LIMIT 1",
                    GetSQLValueString($codigoTaquilla, "int")
                );
                $Recordset = mysqli_query($conexionbanca, $query_Recordset) or die(mysqli_error($conexionbanca));
                $row_Recordset = mysqli_fetch_assoc($Recordset);$totalRows_Recordset = mysqli_num_rows($Recordset);
...
<?php
    ...
    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 13 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla,
					ta.taq_por_ame,
					ta.efectivoO,
...
USE INDEX(id_us_fe_fe)
    ...
    GetSQLValueString($codigoUsuario, "int")
                ...
                $query_Recordset = sprintf(
                    "/* PARSEADORES1 parley\parley\base_parley\bVenta_us_parley.php - QUERY 14 */ SELECT cod_taquilla FROM taquilla_opc_hnac WHERE cod_taquilla = %s LIMIT 1",
                    GetSQLValueString($codigoTaquilla, "int")
                );
                $Recordset = mysqli_query($conexionbanca, $query_Recordset) or die(mysqli_error($conexionbanca));
                $row_Recordset = mysqli_fetch_assoc($Recordset);$totalRows_Recordset = mysqli_num_rows($Recordset);
