<?php
    ...
    "/* PARSEADORES1 parley\parley\base_parley\bVenta_ta_parley.php - QUERY 1 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla,
					ta.cod_taquilla,
					ta.taq_por_ame,
    ...
    GetSQLValueString($codigoTaquilla, "int")
                ...
                $query_Recordset = sprintf(
                    "/* PARSEADORES1 parley\parley\base_parley\bVenta_ta_parley.php - QUERY 2 */ SELECT cod_taquilla FROM taquilla_opc_hnac WHERE cod_taquilla = %s LIMIT 1",
                    GetSQLValueString($codigoTaquilla, "int")
                );
