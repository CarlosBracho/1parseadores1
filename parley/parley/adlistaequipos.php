...
if (!isset($_SESSION)) {
    ...
    $query_Recordset1 = "/* PARSEADORES1 parley\parley\adlistaequipos.php - QUERY 1 */ SELECT * FROM p1equipos $where";
...
do {
    ...
    echo $row_Recordset1['nomdimp1']; ?></td>
        ...
        <td><?php echo $row_Recordset1['deportep1']; ?> USD</td>
		<td><?php echo $row_Recordset1['ligap1']; ?> USD</td>
		<td><?php echo $row_Recordset1['ordenp1']; ?> USD</td>
