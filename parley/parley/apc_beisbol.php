...
<?php
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 parley\parley\apc_beisbol.php - QUERY 1 */ SELECT * FROM p2juegos 
...
do {
    $query_Recordset21 = sprintf(
        "/* PARSEADORES1 parley\parley\apc_beisbol.php - QUERY 2 */ SELECT *
FROM p1equipos
WHERE  
Id_p1equiposp1 = %s",
...
<?php  if ($row_Recordset1['competicionp2']==$compex) {
    } else { ?>
<tr class="table-danger"><td colspan="12"><div class="equipos"><?php echo $row_Recordset1['competicionp2'];  $compex=$row_Recordset1['competicionp2'];  ?></div></td></tr>
<?php } ?>
			<tr class="table-dark">
...
<td><img width="22px" height="22px" class="img-fluid" src=""><?php echo $row_Recordset21['nomequipop1']; ?><p><small class="text-danger font-weight-bold"><?php echo $row_Recordset1['pichee1p2'] ?></small></p></td>
...
$row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,1,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipop1'];?>"></br><?php if ($logro>0) {
    echo "+";
}  echo $logro;?></td>
<?php } else {?><td></td><?php } ?>	
...
$logro; ?>,<?php echo $row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,2,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipop1'];?>"><small class="text-muted"><b><?php echo $logroABoRL; ?></b></small></br><?php if ($logro>0) {
    echo "+";
}  echo $logro;?></td>
<?php } else {?><td></td><?php } ?>	
...
$logro; ?>,<?php echo $row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,3,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipop1'];?>"><small class="text-danger"><b><?php echo $logroABoRL; ?></b></small></br><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>		
...
$logro; ?>,<?php echo $row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,"><small class="text-danger"><b>A <?php echo $logroABoRL; ?></b></small></br><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>	
...
$row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,9,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipop1'];?>"></br><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>	
...
<?php  echo $logro; ?>,<?php echo $row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,10,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,"><small 
class="text-danger"><b><?php echo $logroABoRL; ?></b></small></br><?php if ($logro>0) {
        echo "+";
    }  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>	
...
<?php  echo $logro; ?>,<?php echo $row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,12,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo
$row_Recordset21['nomequipop1'];?>"><small class="text-danger"><b>A <?php echo $logroABoRL; ?></b></small></br><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
<small class="text-danger"><b>SI</b></small></br><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
$row_Recordset21['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,19,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipop1'];?>">
</br><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
<?php list($logro, $Id_p3logros, $logroABoRL)=Obtenerlogro($row_Recordset1['Id_p2juegosp2'], 1, 'AG', $tlarray);
    if ($logro!=0) {?>
<td style="display:" id="<?php echo $idequipo1; ?>1_<?php  echo $Id_p3logros; ?>" onmouseover="changeCell(this)" onmouseout="changeCellOut(this)" 
...
$query_Recordset22 = sprintf(
        "/* PARSEADORES1 parley\parley\apc_beisbol.php - QUERY 3 */ SELECT *
...
<tr class="table-light">
<td><img width="22px" height="22px" class="img-fluid" src=""> <?php echo $row_Recordset22['nomequipop1']; ?><p><small class="text-danger font-weight-bold"><?php echo $row_Recordset1['pichee2p2'] ?> </small></p></td>
...
$row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,5,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipop1'];?>"></br><?php if ($logro>0) {
    echo "+";
} echo $logro;?></td>
<?php } else {?><td></td><?php } ?>
...
$logro; ?>,<?php echo $row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,6,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipop1'];?>"><small class="text-muted"><b><?php echo $logroABoRL; ?></br></b></small><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
$logro; ?>,<?php echo $row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,7,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,20:10:00,<?php echo $row_Recordset22['nomequipop1'];?>" style="cursor: pointer; color: rgb(0, 0, 0);"><small class="text-danger"><b><?php echo $logroABoRL; ?></br></b></small><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
$logro; ?>,<?php echo $row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,8,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipop1'];?>"><small class="text-danger">
<b>B <?php echo $logroABoRL; ?></br></b></small> <?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
$row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,13,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset21['nomequipop1'];?>"></br><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
$logro; ?>,<?php echo $row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,14,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipop1'];?>"><small 
class="text-danger"><b><?php echo $logroABoRL; ?></b></small></br><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
<?php echo $logro; ?>,<?php echo $row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,16,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo
$row_Recordset22['nomequipop1'];?>"><small class="text-danger"><b>B <?php echo $logroABoRL; ?></br></b></small> <?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
<small class="text-danger"><b>NO</b></small></br><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
$row_Recordset22['nomequipop1'];?>,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,23,<?php echo $row_Recordset1['Id_p2juegosp2'];?>,4,,13:10:00,<?php echo $row_Recordset22['nomequipop1'];?>">
</br><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td>
<?php } else {?><td></td><?php } ?>
...
<small class="text-danger"><b>B <?php echo $logroABoRL; ?></b></small> <br><?php if ($logro>0) {
    echo "+";
}  echo $logro; ?></td></tr><tr></tr><tr class="table-dark">
<?php } else {?><td></td><?php } ?>
