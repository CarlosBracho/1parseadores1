...
if ($_POST['jtipo']==0 && $_POST['modulo']==0) {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 parley\parley\detalle_ticket.php - QUERY 1 */ SELECT 
			ve.est_ticket, 
			ve.ser_venta, 
			ve.fec_venta, 
			ve.hor_venta,
...
<?php if ($_POST['jtipo']==0 && $_POST['modulo']==2) {
        $query_Recordset12 = sprintf(
            "/* PARSEADORES1 parley\parley\detalle_ticket.php - QUERY 2 */ SELECT 
    *
    ...
    ",
        ...
        $query_Recordset1 = sprintf(
            "/* PARSEADORES1 parley\parley\detalle_ticket.php - QUERY 3 */ SELECT 
*
