...
| **Controlador Nativo Historial (JS)** | JavaScript | Controlador 100% nativo (XMLHttpRequest, abrirHistorial y cerrarHistorial) en `alertas_lista.php` desacoplado de las librerías JS de Bootstrap y jQuery para mitigar conflictos y garantizar la apertura del modal. |
