<?php
    ...
    "/* PARSEADORES1 distri\base_ame\bVenta_ta_ame.php - QUERY 1 */ SELECT 
					us.nom_usuario,
					ta.nom_taquilla,
					ta.cod_taquilla,
					ta.taq_por_ame,
    ...
    GetSQLValueString($codigoAgente, "int")
                ...
                $query_Recordset = sprintf(
                    "/* PARSEADORES1 distri\base_ame\bVenta_ta_ame.php - QUERY 2 */ SELECT cod_taquilla FROM taquilla_opc_hnac WHERE cod_taquilla = %s LIMIT 1",
                    GetSQLValueString($codigoAgente, "int")
                );
