    ...
    if ($_POST['id_hipod']!="-1") {
        if ($_POST['id_hipod']!="-1" && $_POST['id_carrera']=="todas") {
            $query_Recordset4 = sprintf(
                "/* PARSEADORES1 distri\distri_reporte_carrera_carrera.php - QUERY 1 */ SELECT 
				nom_hipodromo
			FROM hipodromo
            ...
            $query_Recordset4 = sprintf(
                "/* PARSEADORES1 distri\distri_reporte_carrera_carrera.php - QUERY 2 */ SELECT 
        ...
        $query_Recordset6 = sprintf(
            "/* PARSEADORES1 distri\distri_reporte_carrera_carrera.php - QUERY 3 */ SELECT 
        ...
        if ($_POST['id_agente']!="todos") {
            $query_Recordset5 = sprintf(
                "/* PARSEADORES1 distri\distri_reporte_carrera_carrera.php - QUERY 4 */ SELECT nom_taquilla, cod_taquilla FROM taquilla WHERE cod_taquilla = %s",
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 distri\distri_reporte_carrera_carrera.php - QUERY 5 */ SELECT 
	ag.nom_agencia,
	ta.cod_taquilla,
	ta.nom_taquilla 
	FROM 
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 distri\distri_reporte_carrera_carrera.php - QUERY 6 */ SELECT 
