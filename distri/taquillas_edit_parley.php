...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 distri\taquillas_edit_parley.php - QUERY 1 */ SELECT  
...
$query_Recordset4 =  sprintf(
    "/* PARSEADORES1 distri\taquillas_edit_parley.php - QUERY 2 */ SELECT  
*
...
if ($totalRows_Recordset4==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            ...
            $query_Recordset4 =  sprintf(
                "/* PARSEADORES1 distri\taquillas_edit_parley.php - QUERY 3 */ SELECT  
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        if ($_POST['existe']==1) {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 distri\taquillas_edit_parley.php - QUERY 4 */ UPDATE taquilla_opc_parley
					SET
					apu_maxparley=%s, 
					apu_minparley=%s,
                    comb_minparley=%s,
        ...
        curl_close ($ch);
            ...
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 distri\taquillas_edit_parley.php - QUERY 5 */ INSERT 
			INTO 
			taquilla_opc_parley 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 distri\taquillas_edit_parley.php - QUERY 6 */ SELECT  
    tp.apu_mingan
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 distri\taquillas_edit_parley.php - QUERY 7 */ SELECT ta.cod_taquilla, ta.nom_taquilla
FROM taquilla ta, taquilla_opc_parley tp, agencia ag, banca ba 
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
	...
	<div style="padding:70px 10px 20px 10px; text-align:left; font-size:18px; height: auto">
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>" onsubmit="return chequearEnvio();">
              ...
              <table width="920" align="center" border="0"  style="line-height:11px" cellpadding="0" cellspacing="0">
                ...
                <tr valign="baseline">
                  ...
                  <td>
                    ...
                    size="10" max="10" tabindex="7" min="0" max="10" onkeypress="ValidaSoloNumeros()" title="indique combinacion maxima"
                    onKeyUp="return handleEnter(this, event)" />
                    <div id="Info4" style="float: left; width:auto; color: #F00; margin:-13px 0px 0px 0px; font-size:10px">
					<?php echo $menAmig; ?></div>
                    </td>
            ...
            <a href='../distri/restringir_jugadas_beisbol.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'
            ...
            <a href='../distri/restringir_jugadas_baloncesto.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'
            ...
            <a href='../distri/restringir_jugadas_futbol.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'
            ...
            <a href='../distri/restringir_jugadas_futbolame.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'
            ...
            <a href='../distri/restringir_jugadas_hockey.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>'
			...
			<a href="../distri/restringir_jugadas_parley.php?recordID=<?php echo $row_Recordset1['cod_taquilla']; ?>" style="width:150px; height:40px; font-size:16px; font: size 20px;"role="button"></a>
