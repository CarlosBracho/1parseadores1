...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 distri\taquillas_edit.php - QUERY 1 */ SELECT
ta.taq_vende_ame,
ta.taq_por_ame,
ta.taq_vende_parley,
ta.taq_por_parley,
...
ta.moneda,  
	...
	ag.nom_agencia, ag.agen_vende_parley, ba.dist_vende_parley 
	FROM  taquilla ta, agencia ag, banca ba
...
$query_Recordset94 =  sprintf(
  "/* PARSEADORES1 distri\taquillas_edit.php - QUERY 2 */ SELECT
ba.sinoclavesdistri,
ba.sinomonedadistri
FROM  taquilla ta, 
      banca ba,
...
$est_taquilla=$row_Recordset1['est_taquilla']/1;
    ...
    $dist_vende_parley=$row_Recordset1['dist_vende_parley']/1;
    
    
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 distri\taquillas_edit.php - QUERY 3 */ SELECT * FROM usuario 
	WHERE tip_usuario='U' 
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 distri\taquillas_edit.php - QUERY 4 */ UPDATE taquilla 
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 distri\taquillas_edit.php - QUERY 5 */ SELECT ta.cod_taquilla, ta.nom_taquilla
