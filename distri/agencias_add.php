...
$query_Recordset3 =  sprintf(
  "/* PARSEADORES1 distri\agencias_add.php - QUERY 1 */ SELECT * 
FROM 
banca
WHERE cod_banca = %s",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 distri\agencias_add.php - QUERY 2 */ INSERT 
				INTO agencia 
...
agen_vende_hnac,
agen_cob_hnac,
				por_agencia_lot, por_agencia_macu, est_agencia) 
        ...
        $query_RecT = "/* PARSEADORES1 distri\agencias_add.php - QUERY 3 */ SELECT cod_agencia FROM agencia ORDER BY cod_agencia DESC LIMIT 1";
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 distri\agencias_add.php - QUERY 4 */ INSERT 
		INTO usuario 
        ...
        $msj='El Distribuidor '. $Dnom .' creo un nuevo Agente con el nombre: '.$Gnom;
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 distri\agencias_add.php - QUERY 5 */ SELECT
	agencia.nom_agencia,
	agencia.cod_banca,
...
echo $row_Recordset1['dist_vende_ame'];
?>
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
        ...
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>" onsubmit="return chequearEnvio();">
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
                ...
                <tr valign="baseline">
                  ...
                  <td width="400" height="88" align="center" valign="top" nowrap bgcolor="#999999">
				  Estado Venta Internacionales:<br />
                  ...
                  <td width="400" align="center" valign="top" nowrap>
   ...
   <td align="left">
                 ...
                 <tr valign="baseline">
                  ...
                  <td colspan="2" align="left" valign="middle" nowrap><br><br>
                  </td>
                  <td width="232">&nbsp;</td>
                  <td width="180">&nbsp;</td>
                <tr valign="baseline">
...
<table width="924" align="center">
          ...
          <input type="hidden" name="cod_agencia" value="<?php echo $_SESSION['MM_cod_banca'] ?>"/>
      </form>
    </div>
  <!-- InstanceEndEditable -->
  </div>
