...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 distri\restringir_jugadas_futbolame.php - QUERY 1 */ SELECT  
...
$query_Recordset4 =  sprintf(
    "/* PARSEADORES1 distri\restringir_jugadas_futbolame.php - QUERY 2 */ SELECT  
*
...
if ($totalRows_Recordset4==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            $query_Recordset4 =  sprintf(
                "/* PARSEADORES1 distri\restringir_jugadas_futbolame.php - QUERY 3 */ SELECT  
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        if ($_POST['existe']==1) {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 distri\restringir_jugadas_futbolame.php - QUERY 4 */ UPDATE taquilla_opc_parley
					SET
                    futbolame_ml=%s,
                    futbolame_alta=%s,
                    futbolame_baja=%s,
        ...
        curl_close ($ch);
            ...
            echo "/* PARSEADORES1 distri\restringir_jugadas_futbolame.php - QUERY 5 */ insert";
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 distri\restringir_jugadas_futbolame.php - QUERY 6 */ INSERT 
			INTO 
			taquilla_opc_parley 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 distri\restringir_jugadas_futbolame.php - QUERY 7 */ SELECT  
tp.apu_minparley, tp.apu_maxparley, tp.comb_minparley, tp.comb_maxparley
	...
	LIMIT 1",
            ...
            if ($apuestasminimaausar > $row_Recordset22['apu_minparley']) {
                $insertSQL11 = sprintf(
                    "/* PARSEADORES1 distri\restringir_jugadas_futbolame.php - QUERY 8 */ UPDATE taquilla_opc_parley
					SET
					apu_minparley=%s
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 distri\restringir_jugadas_futbolame.php - QUERY 9 */ SELECT ta.cod_taquilla, ta.nom_taquilla
FROM taquilla ta, taquilla_opc_parley tp
