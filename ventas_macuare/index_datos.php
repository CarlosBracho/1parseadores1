...
$query_Recordset6 = sprintf("/* PARSEADORES1 ventas_macuare\index_datos.php - QUERY 1 */ SELECT 
	tp.est_ven_macu
...
$query_Recordset4 = "/* PARSEADORES1 ventas_macuare\index_datos.php - QUERY 2 */ SELECT * FROM mensaje WHERE cod_mensaje = 1";
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1") {
    ...
    if ($grabar==30) {
        ...
        $aPagar=$xDivP*$xMonA;
        $insertSQL = sprintf(
            "/* PARSEADORES1 ventas_macuare\index_datos.php - QUERY 3 */ INSERT INTO venta_macu (ser_venta_macu, ticket_macu, fec_venta_macu, 
...
$query_Recordset6 = sprintf(
    "/* PARSEADORES1 ventas_macuare\index_datos.php - QUERY 4 */ SELECT 
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 ventas_macuare\index_datos.php - QUERY 5 */ SELECT 
		ca.cod_carrera_hnac, 
...
if ($totalRows_Recordset3>5) {
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 ventas_macuare\index_datos.php - QUERY 6 */ SELECT 
			ca.cod_carrera_hnac, 
			ca.can_caballos_hnac, 
			ca.num_carrera_hnac,
			ca.hor_carrera_hnac,
    ...
    if ($div_ofi_macu==1) {
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 ventas_macuare\index_datos.php - QUERY 7 */ SELECT div_pago_macu FROM div_oficiales_macu
        ...
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 ventas_macuare\index_datos.php - QUERY 8 */ SELECT 
				div_pago_macu
				FROM
					div_taquilla_macu
				WHERE
    ...
    $query_Recordset15 = sprintf(
        "/* PARSEADORES1 ventas_macuare\index_datos.php - QUERY 9 */ SELECT 
			ca.cod_carrera_hnac
			FROM 
				carrera_hnac ca
			WHERE
