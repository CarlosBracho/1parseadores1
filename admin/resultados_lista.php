...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && isset($_POST['fecha_inicio'])) {
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 admin\resultados_lista.php - QUERY 1 */ SELECT * FROM carrera 
		WHERE 
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 admin\resultados_lista.php - QUERY 2 */ SELECT * FROM carrera 
		WHERE 
			carrera.est_confirmacion=0 AND 
			carrera.fec_carrera = %s 
		ORDER BY carrera.hor_carrera DESC",
...
<div class="content5">
  ...
  border: none;">
			  ...
			  <tr>
                ...
                <?php      if ($row_Recordset1['confirmandox']==0){echo 'MANUAL'; }
      ...
      ?>	
                <?php echo '<br>'.$row_Recordset1['nom_hipodromo']; ?>
...
?>
			  ...
			  <tr style="background:#CCCCCC">
               ...
               <?php //echo $row_Recordset1['pickresultados']; 
             
               $exoticas2=explode(',,', $row_Recordset1['pickresultados']);
       
               foreach ($exoticas2 as $exoticas22) {
                $exoticas22=str_replace('--', ' ', $exoticas22);
                $exoticas22 = strtoupper($exoticas22);
                if(strlen($exoticas22)>='2') { 
               echo $exoticas22.' | ';
