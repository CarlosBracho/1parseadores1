...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 admin\multidistri_edit.php - QUERY 1 */ UPDATE multidistriMD 
				SET nom_multidistriMD=%s, tel_multidistriMD=%s, 
        multi_vende_ameMD=%s,
        multi_por_ameMD=%s,
        multi_vende_parleyMD=%s,
        multi_por_parleyMD=%s,
        multi_vende_hnacMD=%s,
        multipor_banca_hnacMD=%s,
				est_multidistriMD=%s
				WHERE cod_multidistriMD=%s",
            GetSQLValueString($_POST['nom_multidistriMD'], "text"),
            GetSQLValueString($_POST['tel_multidistriMD'], "text"),
            GetSQLValueString($_POST['multi_vende_ameMD'], "int"),
            GetSQLValueString($_POST['multi_por_ameMD'], "double"),
            GetSQLValueString($_POST['multi_vende_parleyMD'], "int"),
            GetSQLValueString($_POST['multi_por_parleyMD'], "double"),
            GetSQLValueString($_POST['multi_vende_hnacMD'], "int"),
            GetSQLValueString($_POST['multipor_banca_hnacMD'], "double"),
            GetSQLValueString($_POST['est_multidistriMD'], "int"),
        ...
        $insertGoTo = "multidistri_lista.php";
        if (isset($_SERVER['QUERY_STRING'])) {
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 admin\multidistri_edit.php - QUERY 2 */ SELECT *
	FROM  
	multidistriMD
	WHERE 
        	...
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
				...
				<tr valign="baseline">
				                  <td width="220" height="88" align="center" valign="top" nowrap bgcolor="#999999">
				                    ...
				                    <select name="multi_vende_ameMD" style="width:140px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset1['multi_vende_ameMD'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>ACTIVO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset1['multi_vende_ameMD'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>INACTIVO</option>
						  </select>
						   <br />Porcentaje Internacionales:<br />
                  	<input type="text" name="multi_por_ameMD" class="textbox" style="height:auto; width:50px" 
                    onclick="ocultaDiv('Info7');"
                    value="<?php echo htmlentities($row_Recordset1['multi_por_ameMD'], ENT_COMPAT, 'utf-8'); ?>" 
                  ...
                  <td width="220" align="center" valign="top" nowrap>
				                      <select name="multi_vende_hnacMD" style="width:140px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset1['multi_vende_hnacMD'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>ACTIVO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset1['multi_vende_hnacMD'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>INACTIVO</option>
						  </select>
						  <br />Costo x pto Nacionales:<br />
                  	<input type="text" name="multipor_banca_hnacMD" class="textbox" style="height:auto; width:100px" 
                    onclick="ocultaDiv('Info7');"
                    value="<?php echo htmlentities($row_Recordset1['multipor_banca_hnacMD'], ENT_COMPAT, 'utf-8'); ?>" 
                  ...
                  <td width="220" align="center" valign="top" nowrap>
				                      <select name="multi_vende_parleyMD" style="width:140px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset1['multi_vende_parleyMD'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>ACTIVO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset1['multi_vende_parleyMD'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>INACTIVO</option>
						  </select>
						  <br />Porcentaje Parley:<br />
                  	<input type="text" name="multi_por_parleyMD" class="textbox" style="height:auto; width:100px" 
                    onclick="ocultaDiv('Info7');"
                    value="<?php echo htmlentities($row_Recordset1['multi_por_parleyMD'], ENT_COMPAT, 'utf-8'); ?>" 
			  ...
			  <table width="919" align="center">
                ...
                <tr valign="baseline">
                  ...
                  <td colspan="4" align="left" valign="middle" nowrap><br>
                    ...
                    Nombre de Multidistribuidor:
                  	<?php echo $row_Recordset1['nom_multidistriMD'];?>
                    </div>
                    <br>
                  </td>
                <tr valign="baseline">
                  ...
                  Nuevo nombre de distribuidor:<br />
                    <input type="text" name="nom_multidistriMD" id="nom_multidistriMD" size="32" class="textbox"  
                    placeholder="usuario" pattern="[.-,-=+-%-$-(-)-A-Z a-z0-9]{4,20}" maxlength="20" style="height: auto"
                    value="<?php echo htmlentities($row_Recordset1['nom_multidistriMD'], ENT_COMPAT, 'utf-8'); ?>" 
                  ...
                  <input type="text" name="tel_multidistriMD" class="textbox"  tabindex="3"
                  size="32" pattern="[0-9]{11,20}" maxlength="20" onkeypress="ValidaSoloNumeros()"
                  value="<?php echo htmlentities($row_Recordset1['tel_multidistriMD'], ENT_COMPAT, 'utf-8'); ?>"  
                  ...
                  Estado Distribuidor:<br />
                    <select name="est_multidistriMD" style="width:140px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset1['est_multidistriMD'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>ACTIVO</option>
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset1['est_multidistriMD'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>INACTIVO</option>
                  </select>
                  </td>
