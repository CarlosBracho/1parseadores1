...
$query_Recordset1 = sprintf("/* PARSEADORES1 admin\admin_apertura_reabrir.php - QUERY 1 */ SELECT nom_hipodromo, num_carrera, mtp_control FROM carrera 
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 admin\admin_apertura_reabrir.php - QUERY 2 */ SELECT bus_auto FROM hipodromo 
...
$updateSQL = sprintf(
    "/* PARSEADORES1 admin\admin_apertura_reabrir.php - QUERY 3 */ UPDATE carrera SET hor_carrera=%s, hor_mtp=%s, mtp_control=%s, est_carrera=%s, est_cierre=%s 
				WHERE cod_carrera=%s",
...
$insertSQL2 = sprintf(
    "/* PARSEADORES1 admin\admin_apertura_reabrir.php - QUERY 4 */ INSERT 
				INTO bitacora 
