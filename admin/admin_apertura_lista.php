...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 admin\admin_apertura_lista.php - QUERY 1 */ SELECT * FROM carrera 
	WHERE  
...
$query_Recordset3 = sprintf("/* PARSEADORES1 admin\admin_apertura_lista.php - QUERY 2 */ SELECT * FROM ctrol_ventpag_global_ame WHERE cod_ctrol_ventpag_global_ame =1");
