...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 admin\crear_mensaje_ataquilla.php - QUERY 1 */ INSERT 
...
$query_Recordset2 = "/* PARSEADORES1 admin\crear_mensaje_ataquilla.php - QUERY 2 */ SELECT cod_taquilla, nom_taquilla FROM taquilla";
