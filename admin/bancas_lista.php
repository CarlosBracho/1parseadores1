...
$query_Bancas = "/* PARSEADORES1 admin\bancas_lista.php - QUERY 1 */ SELECT * FROM banca ORDER BY banca.nom_banca ASC";
...
<div class="container">
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td width="167" align="center">QUIEN COBRA</td>
...
$query_Recordset1x =  sprintf(
  "/* PARSEADORES1 admin\bancas_lista.php - QUERY 2 */ SELECT *
FROM  
multidistriMD
WHERE 
multidistriMD.cod_multidistriMD = %s",
  GetSQLValueString($row_Bancas['cod_multidistriMDBA'], "int")
);
$Recordset1x = mysqli_query($conexionbanca, $query_Recordset1x) or die(mysqli_error($conexionbanca));
$row_Recordset1x = mysqli_fetch_assoc($Recordset1x);
$totalRows_Recordset1x = mysqli_num_rows($Recordset1x);



            if($totalRows_Recordset1x==0){
            if($row_Bancas['cobrodirectoDT']==0){ echo 'Cobra Directo'; }}
            if($totalRows_Recordset1x>0){
 echo 'No Se Cobra';
