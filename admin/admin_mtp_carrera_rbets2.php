...
var loadHora = function() {
    $.ajax({    
        type: "GET",
        url: "../includes/mtp_cierre_rbets2.php",             
        dataType: "html",
		beforeSend: function() {
...
<div class="container">
    <div style="background: #CFC; height:35px; color:#333333; padding:25px 0px 0px 0px;text-align:center;font-size:34px;width:100%"
    	id="datosUsuario">
    	RACEBETS <em>TODAY</em> (MTP) 
    </div>
</div>
