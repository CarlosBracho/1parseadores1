...
$query_Recordset1 = sprintf("/* PARSEADORES1 admin\admin_apertura_cierre.php - QUERY 1 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", GetSQLValueString($xCarrera_Recordset1, "int"));
...
if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $mtp_control=0;
  $updateSQL = sprintf(
      "/* PARSEADORES1 admin\admin_apertura_cierre.php - QUERY 2 */ UPDATE carrera SET est_carrera=%s, est_cierre=%s, mtp_control=%s, hor_carrera=%s WHERE cod_carrera=%s",
  ...
  $insertSQL2 = sprintf(
      "/* PARSEADORES1 admin\admin_apertura_cierre.php - QUERY 3 */ INSERT 
					INTO bitacora 
