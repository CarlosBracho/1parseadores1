...
$query_Recordset3 =  sprintf(
  "/* PARSEADORES1 admin\bancas_add.php - QUERY 1 */ SELECT * 
FROM 
usuario
WHERE id_usuario = %s",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 admin\bancas_add.php - QUERY 2 */ INSERT 
				INTO banca 
				(nom_banca, nom_representante, tel_banca, dir_banca,				
dist_vende_ame,
dist_por_ame,
dist_vende_hnac,
dist_cob_hnac,				
        ...
        $query_RecT = "/* PARSEADORES1 admin\bancas_add.php - QUERY 3 */ SELECT cod_banca FROM banca ORDER BY cod_banca DESC LIMIT 1";
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 admin\bancas_add.php - QUERY 4 */ INSERT 
		INTO usuario 
