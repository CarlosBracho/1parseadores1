...
$query_Bancas = "/* PARSEADORES1 admin\multidistri_lista.php - QUERY 1 */ SELECT * FROM multidistriMD ORDER BY multidistriMD.nom_multidistriMD ASC";
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
  	<div style="height:100%; font-size:18px;" class="xfirefox">
        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:right;">
            <a href="multidistri_add.php" class="btn alert-success" 
                ...
                text-decoration:none;" title="crear nuevo distribuidor">
                 Añadir Nuevo Multi Distribuidor
            </a>
        </div>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <?php do { ?>
          <tr class="brillo" style="border-bottom:1px solid  #D5D5D5">
            <td align="left"><?php
            echo $row_Bancas['nom_multidistriMD']."<br/><FONT FACE='times new roman' SIZE=2>"."</FONT>"; ?>
            </td>
            <td align="left">
			<?php
            $telbanca=$row_Bancas['tel_multidistriMD'];
            echo $telbanca; ?>
            </td>
            <td align="center"><?php echo ObtenerNombreStatus($row_Bancas['est_multidistriMD']); ?></td>
            <td align="center">
            <a class="btn btn-primary" style="text-decoration:none;" 
            	href='multidistri_edit.php?recordID=<?php echo $row_Bancas['cod_multidistriMD']; ?>'>
