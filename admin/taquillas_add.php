...
if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
    if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
        ...
        $query_Recordset4 =  sprintf(
            "/* PARSEADORES1 admin\taquillas_add.php - QUERY 1 */ SELECT  
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==30) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 admin\taquillas_add.php - QUERY 2 */ INSERT 
				INTO taquilla 
...
moneda,
        ...
        $query_RecT = "/* PARSEADORES1 admin\taquillas_add.php - QUERY 3 */ SELECT cod_taquilla FROM taquilla ORDER BY cod_taquilla DESC LIMIT 1";
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 admin\taquillas_add.php - QUERY 4 */ INSERT 
		INTO usuario 
...
$query_Recordset2 = "/* PARSEADORES1 admin\taquillas_add.php - QUERY 5 */ SELECT cod_agencia, nom_agencia FROM agencia ORDER BY nom_agencia";
$Recordset2 =mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
$row_Recordset2 = mysqli_fetch_assoc($Recordset2);
$totalRows_Recordset2 = mysqli_num_rows($Recordset2);
$query_Recordset3 = "/* PARSEADORES1 admin\taquillas_add.php - QUERY 6 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
