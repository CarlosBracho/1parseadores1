...
<div class="container">
  ...
  <div style="height:100%; font-size:18px;" class="xfirefox">
	...
	<a href="../parley/adeditorparley.php" target="_blank" class="btn alert-success" id="crear" name="crear" 
            ...
            <a href="../new/logrosresultados/subirresultadoswiningbet.php" target="_blank" class="btn alert-success" id="crear" name="crear" 
            	style="font-size:18px; width:110px; height:55px; padding:5px 0px 0px 0px; text-align:center; background:purple; color: white;
                text-decoration:none;" title="">
                 Subir<br/> Resultados WininBets
            </a>
            ...
            <a href="../new/logrosresultados/WiningBetresultadosMejorado.php" target="_blank" class="btn alert-success" id="crear" name="crear" 
            	style="font-size:18px; width:110px; height:55px; padding:5px 0px 0px 0px; text-align:center; background:crimson; color: white;
                text-decoration:none;" title="">
                 Actualizar<br/> Resultados WininBets
            </a>
            <br><br>
            ...
            <a href="../new/sincronizado/logrosmaradeportes.php" target="_blank" class="btn alert-success" id="crear" name="crear" 
