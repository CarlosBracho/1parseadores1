...
if (isset($_POST['ticketticket'])) {
    ...
    if ($_POST['modulo']==0) {
        $query_Recordset1 = sprintf(
            "/* PARSEADORES1 admin\1resetiarticket.php - QUERY 1 */ SELECT *
		FROM 
			venta,
			carrera,
			usuario,
        ...
        if ($totalRows_Recordset1>=1) {
            $insertSQL1 = sprintf(
                "/* PARSEADORES1 admin\1resetiarticket.php - QUERY 2 */ UPDATE venta
            SET
            est_ticket=1,
            est_calculo=0
            WHERE ticket=%s",
...
?>
  ...
  <select class="custom-/* PARSEADORES1 admin\1resetiarticket.php - QUERY 3 */ select" id="inputGroupSelect04" name="modulo">
