...
$query_Recordset3 =  sprintf(
  "/* PARSEADORES1 admin\taquillas_edit.php - QUERY 1 */ SELECT * 
FROM 
usuario
WHERE id_usuario = %s",
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 admin\taquillas_edit.php - QUERY 2 */ SELECT
ta.taq_vende_ame,
ta.taq_por_ame,
ta.taq_vende_parley,
ta.taq_por_parley,
...
$query_Recordset94 =  sprintf(
  "/* PARSEADORES1 admin\taquillas_edit.php - QUERY 3 */ SELECT
  nom_banca
FROM  taquilla ta, 
      banca ba,
      agencia ag
...
$est_taquilla=$row_Recordset1['est_taquilla']/1;
    ...
    $agen_vende_parley=$row_Recordset1['agen_vende_parley']/1;
        ...
        $query_Recordset11 = sprintf(
            "/* PARSEADORES1 admin\taquillas_edit.php - QUERY 4 */ SELECT * FROM usuario 
	WHERE tip_usuario='U' 
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 admin\taquillas_edit.php - QUERY 5 */ UPDATE taquilla 
...
moneda=%s				
  ...
  curl_close ($ch);
        ...
        $query_Recordset22 =  sprintf(
            "/* PARSEADORES1 admin\taquillas_edit.php - QUERY 6 */ SELECT  
tp.apu_mingan
	...
	LIMIT 1",
        ...
        if ($apuestasminimaausar > $row_Recordset22['apu_mingan']) {
            $insertSQL11 = sprintf(
                "/* PARSEADORES1 admin\taquillas_edit.php - QUERY 7 */ UPDATE taquilla_opc_ame
					SET
					apu_mingan=%s
					WHERE cod_taquilla=%s",
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 admin\taquillas_edit.php - QUERY 8 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
