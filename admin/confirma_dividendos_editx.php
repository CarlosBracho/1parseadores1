...
$query_Recordset1 = sprintf("/* PARSEADORES1 admin\confirma_dividendos_editx.php - QUERY 1 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", GetSQLValueString($xCarrera_Recordset1, "int"));
