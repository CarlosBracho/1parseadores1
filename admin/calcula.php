        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_distribuidor']!="todos") {
                $query_Recordset10 = sprintf(
                    "/* PARSEADORES1 admin\calcula.php - QUERY 1 */ SELECT cod_banca, nom_banca, tel_banca, cor_banca, por_banca 
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && $_POST['id_distribuidor']=="todos") ||
    ...
    $query_Recordset10 = sprintf("/* PARSEADORES1 admin\calcula.php - QUERY 2 */ SELECT cod_banca, nom_banca, tel_banca, cor_banca, por_banca FROM banca");
    $v=0;
}
...
$query_Recordset2 = sprintf("/* PARSEADORES1 admin\calcula.php - QUERY 3 */ SELECT cod_banca, nom_banca FROM banca ORDER BY banca.nom_banca");
           ...
           if ($totalRows_Recordset10>0) {
               ...
               do {
                   ...
                   $query_Recordset3 = sprintf(
                       "/* PARSEADORES1 admin\calcula.php - QUERY 4 */ SELECT cod_agencia, nom_agencia, por_agencia
                   ...
                   if ($totalRows_Recordset3>0) {
                       do {
                           ...
                           $query_Recordset1 = sprintf(
                               "/* PARSEADORES1 admin\calcula.php - QUERY 5 */ SELECT venta.num_ticket,
							...
							taquilla_opc_ame.reg_exa, taquilla_opc_ame.def_regdiv1, taquilla_opc_ame.div_pdes1, taquilla_opc_ame.div_phas1, taquilla_opc_ame.opc_ame, taquilla_opc_ame.pag_pdiv1, taquilla_opc_ame.div_pdes2, taquilla_opc_ame.div_phas2, taquilla_opc_ame.opc_ame2, taquilla_opc_ame.pag_pdiv2 
                           ...
                           if ($totalRows_Recordset1>0) {
                               do {
                                   ...
                                   if ($row_Recordset1['est_ticket']==1 && $row_Recordset1['est_confirmacion']==0) {
                                       ...
                                       if ($pago>0) {
                                           $updateSQL = sprintf(
                                               "/* PARSEADORES1 admin\calcula.php - QUERY 6 */ UPDATE venta 
															   SET pag_premio=%s 
															   WHERE num_ticket=%s",
                                   ...
                                   if ($row_Recordset1['est_ticket']==2 && $row_Recordset1['fec_pago']>=$in
                                       ...
                                       if ($pago>0) {
                                           $updateSQL2 = sprintf(
                                               "/* PARSEADORES1 admin\calcula.php - QUERY 7 */ UPDATE venta 
															   SET pag_premio=%s 
															   WHERE num_ticket=%s",
                                               GetSQLValueString($pago, "double"),
                                               GetSQLValueString($row_Recordset1['num_ticket'], "int")
                                   ...
                                   if (($row_Recordset1['est_ticket']==4 || $row_Recordset1['est_ticket']==5)
                                       ...
                                       $updateSQL3 = sprintf(
                                           "/* PARSEADORES1 admin\calcula.php - QUERY 8 */ UPDATE venta 
