...
var loadHora = function() {
    $.ajax({    
        type: "GET",
        url: "../includes/mtp_cierre_rbets3.php",             
        dataType: "html",
		beforeSend: function() {
...
<div class="container">
    <div style="background: #C60; height:35px; color:#FFFFFF;padding:25px 0px 0px 0px;text-align:center;font-size:34px;width:100%"
    	id="datosUsuario">
   		RACEBETS <em>YESTERDAY</em> (MTP) 
	</div>
</div>
