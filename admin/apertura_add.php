...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("/* PARSEADORES1 admin\apertura_add.php - QUERY 1 */ INSERT INTO carrera (cod_banca, nom_hipodromo, nom_hipodromo_hpi, fec_carrera, hor_carrera, hor_mtp, num_carrera, est_carrera, can_caballos) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$query_Recordset2 = "/* PARSEADORES1 admin\apertura_add.php - QUERY 2 */ SELECT cod_hipodromo, nom_hipodromo FROM hipodromo WHERE est_hipodromo = 1";
