...
$totSistemaA=0;
$query_Recordset555 = sprintf("/* PARSEADORES1 admin\distri_reporte_general_totalviejo.php - QUERY 1 */ SELECT * FROM tasadecambio  WHERE Idtasadecambio = 1");
...
$query_Recordset18 = sprintf("/* PARSEADORES1 admin\distri_reporte_general_totalviejo.php - QUERY 2 */ SELECT nom_banca, cod_banca  FROM banca ORDER BY banca.nom_banca");
...
$query_Recordset12 = sprintf(
    "/* PARSEADORES1 admin\distri_reporte_general_totalviejo.php - QUERY 3 */ SELECT  nom_banca, dist_por_ame, dist_cob_hnac, dist_por_parley FROM banca WHERE cod_banca = %s",
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 admin\distri_reporte_general_totalviejo.php - QUERY 4 */ SELECT *
	FROM  agencia ag
    ...
    if (isset($_POST['fecha_inicio']) && isset($_POST['fecha_fin'])) {
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_agencia']!="todos") {
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 admin\distri_reporte_general_totalviejo.php - QUERY 5 */ SELECT *
					FROM agencia ag
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 admin\distri_reporte_general_totalviejo.php - QUERY 6 */ SELECT ag.cod_agencia, ag.nom_agencia
	FROM agencia ag
	WHERE ag.cod_banca = %s
	ORDER BY ag.nom_agencia ASC",
    GetSQLValueString($codigobanca=$_POST['Banca'], "int")
...
<?php
$query_Recordset44 = sprintf("/* PARSEADORES1 admin\distri_reporte_general_totalviejo.php - QUERY 7 */ SELECT 
	me.mensaje
	   ...
	   <div>
		<table width="100%" border="0" style="color:#000; font-size:12px;" cellpadding="0" cellspacing="0">
			<tr style="font-size:16px" valign="middle" align="center">
                ...
                <?php
                                              $corbro= $row_Recordset12['dist_por_ame']*$row_Recordset555['usdabss'];
                                                       ?>
				...
				<td width="33%" colspan="-2" bgcolor="#333" style="color:#FFF"><br/>
                    ...
                    PARLEY: <?php echo number_format($row_Recordset12['dist_por_parley'], 2, ",", ".")."%<br/><br/><br/>"; ?>
           ...
           <td width="21%">TAQUILLA</td>
            ...
            <td width="19%">TOTAL A COBRAR Al<br/> TAQUILLA AMERICANA (%)<br/> NACIONALES(X) TOTAL ( )</td>
                    ...
                    $query_Recordset30 = sprintf(
                       "/* PARSEADORES1 admin\distri_reporte_general_totalviejo.php - QUERY 8 */ SELECT cod_taquilla, nom_taquilla
						FROM taquilla
						WHERE cod_agencia = %s
                   ...
                   if ($totalRows_Recordset30>0) {
                       do {
                           ...
                           $query_Recordset1 = sprintf(
                               "/* PARSEADORES1 admin\distri_reporte_general_totalviejo.php - QUERY 9 */ SELECT
					...
					SUM(CASE WHEN ve.est_ticket = 0 AND ve.fec_venta >= %s AND ve.fec_venta <= %s AND ve.lin_ticket = 1  AND ve.efectivoO = 5
						THEN 1 ELSE 0 END) AS con_tic_elisol
                           ...
                           $query_Recordset21 = sprintf(
                               "/* PARSEADORES1 admin\distri_reporte_general_totalviejo.php - QUERY 10 */ SELECT
					...
					SUM(CASE WHEN veN.est_ticket_hnac = 0 AND veN.fec_venta_hnac >= %s AND veN.fec_venta_hnac <= %s AND
						...
						THEN 1 ELSE 0 END) AS con_tic_eliNsol
                           ...
                           $query_Recordset22 =  sprintf(
                               "/* PARSEADORES1 admin\distri_reporte_general_totalviejo.php - QUERY 11 */ SELECT cob_taquilla_hnac 
								FROM  
                           ...
                           $newDate1 = date("Y-m-d", $timestamp1 );
                              ...
                              $query_Recordset50 = sprintf(
                               "/* PARSEADORES1 admin\distri_reporte_general_totalviejo.php - QUERY 12 */ SELECT 
...
SUM(CASE WHEN p4jugadas.lineatp4 = 1 AND p4jugadas.jugadadtp4 >= %s AND p4jugadas.jugadadtp4 <= %s AND (p4jugadas.estadoticketp4 = 1) AND p4jugadas.monedap4 = 5  THEN p4jugadas.premioapagarp4 ELSE 0 END) AS total_ganadorsol
        ...
        <?php  //PARLEY BSS
           if ($totVentaTaqP!=0 or $totPremiTaqP!=0 or $totAnulaTaqP!=0 or $totTaquillaP!=0 or $totPTaqPpagP!=0 or
                    ...
                    $parleypagobss=$ventasparleyBSS*$row_Recordset12['dist_por_parley']/100;
           ...
           if ($totVentaTaqPUSD!=0 or $totPremiTaqPUSD!=0 or $totAnulaTaqPUSD!=0 or $totTaquillaPUSD!=0 or $totPTaqPpagPUSD!=0 or
                    $porPagarEliTaqPUSD!=0 or $totGanPerTaqPUSD!=0) {?>
                      <tr onmouseover="cambiacolor_over1(this)" onmouseout="cambiacolor_out3(this)" height="20" 
                        ...
                        <?php 
                    $parleypagobusd=$totAnulaTaqPUSD-$porPagarEliTaqPUSD;
...
echo '<br/><br/><br/>';
               ...
               $totalparleyUSD=$totalusd*$row_Recordset12['dist_por_parley']/100;
               $parleypagoUSD=$parleypagobusd*$row_Recordset555['usdabss']*$row_Recordset12['dist_por_parley']/100;
               ...
               $totalparleyCOP=$totalcop*$row_Recordset12['dist_por_parley']/100;
               $parleypagoCOP=$parleypagobcop*$row_Recordset555['copabss']*$row_Recordset12['dist_por_parley']/100;
               ...
               $totalparleySOL=$totalsol*$row_Recordset12['dist_por_parley']/100;
               $parleypagoSOL=$parleypagobsol*$row_Recordset555['solabss']*$row_Recordset12['dist_por_parley']/100;
