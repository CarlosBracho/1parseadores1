...
$query_Recordset1 = sprintf("/* PARSEADORES1 admin\dividendos_add.php - QUERY 1 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", GetSQLValueString($xCarrera_Recordset1, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $hconfir=horaactual();
    $updateSQL = sprintf(
        "/* PARSEADORES1 admin\dividendos_add.php - QUERY 2 */ UPDATE carrera SET 
							est_confirmacion=%s, 
							est_carrera=%s, 
							eje_primero=%s, 
							div_primero_gan=%s, 
