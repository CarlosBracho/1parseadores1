...
$query_Recordset3 =  sprintf(
  "/* PARSEADORES1 admin\multidistri_add.php - QUERY 1 */ SELECT * 
FROM 
usuario
WHERE id_usuario = %s",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if (isset($_POST['nom_multidistriMD']) && $_POST['nom_multidistriMD']!="") {
        if (buscaDis($_POST['nom_multidistriMD'])>0) {
            $menTaq="Ya existe";
            $graba--;
        }
    }
    if ($_POST['nom_multidistriMD']=="" || strlen($_POST['nom_multidistriMD'])<=3) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 admin\multidistri_add.php - QUERY 2 */ INSERT 
				INTO multidistriMD 
				(nom_multidistriMD,  tel_multidistriMD,				
        multi_vende_ameMD,
        multi_por_ameMD,
        multi_vende_hnacMD,
        multipor_banca_hnacMD,
        multi_vende_parleyMD,
        multi_por_parleyMD,
        est_multidistriMD) 
				VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString(strtoupper($_POST['nom_multidistriMD']), "text"),
        ...
        $query_RecT = "/* PARSEADORES1 admin\multidistri_add.php - QUERY 3 */ SELECT cod_multidistriMD FROM multidistriMD ORDER BY cod_multidistriMD DESC LIMIT 1";
        ...
        $codTaquilla=$row_RecT['cod_multidistriMD'];
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 admin\multidistri_add.php - QUERY 4 */ INSERT 
		INTO usuario 
        ...
        $msj='El Administrador '. $Anom .' creo un nuevo Multi Distribuidor con el nombre: '.$Dnom;
              ...
              <table width="919" align="center">
			   <tr valign="baseline">
                ...
                <tr valign="baseline">
                  ...
                  <td width="420" align="center" valign="bottom" nowrap>Estado Venta Parley:</td>
...
<input type="text" name="multi_vende_parleyMD" class="textbox" style="height:auto; width:100px" 
                    onclick="ocultaDiv('Info7');"
                    value="0.00" 
                    size="10" onkeypress="ValidaSoloNumeros()" title="indique pocentaje"
                    onKeyUp="return handleEnter(this, event)" tabindex="8" required max="100"/>
                  ...
                  <td width="420" height="88" align="center" valign="top" nowrap bgcolor="#999999">
					                    ...
					                    <select name="multi_por_parleyMD" style="width:140px; height: auto" class="textbox" tabindex="4"> 
                      <option value="1">ACTIVO</option>
                      <option value="0">INACTIVO</option>
					  </select>
                ...
                <tr valign="baseline">
                  ...
                  Nombre del Multi Distribuidor:<br>
                    <input type="text" name="nom_multidistriMD" id="nom_multidistriMD" class="textbox" tabindex="1"
                    value="" 
		...
		<table width="924" align="center">
          ...
          <input type="hidden" name="tip_usuario" value="S"/>
      </form>
    </div>
  <!-- InstanceEndEditable -->
  </div>
