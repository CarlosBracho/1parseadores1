...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 admin\bancas_addreparar.php - QUERY 1 */ INSERT 
				INTO banca 
        ...
        $query_RecT = "/* PARSEADORES1 admin\bancas_addreparar.php - QUERY 2 */ SELECT cod_banca FROM banca ORDER BY cod_banca DESC LIMIT 1";
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 admin\bancas_addreparar.php - QUERY 3 */ INSERT 
		INTO usuario 
