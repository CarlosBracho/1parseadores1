...
$query_Recordset1 = sprintf("/* PARSEADORES1 admin\respaldohistorial_lista.php - QUERY 1 */ SELECT * FROM carrera WHERE carrera.eje_primero > 0 AND carrera.fec_carrera = %s ORDER BY carrera.hor_carrera DESC", GetSQLValueString($fechaactual_Recordset1, "date"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 admin\respaldohistorial_lista.php - QUERY 2 */ SELECT * FROM carrera 
