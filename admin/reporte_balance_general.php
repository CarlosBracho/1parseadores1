...
$query_Recordset1 = "/* PARSEADORES1 admin\reporte_balance_general.php - QUERY 1 */ SELECT * FROM banca, agencia WHERE agencia.cod_banca = banca.cod_banca ORDER BY agencia.nom_agencia ASC";
