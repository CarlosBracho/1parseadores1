...
$query_Recordset1 = "/* PARSEADORES1 admin\usuarios_multi_lista.php - QUERY 1 */ SELECT * 
	FROM 
	usuario, 
	multidistriMD 
	WHERE 
	multidistriMD.cod_multidistriMD = usuario.cod_taquilla AND
	usuario.tip_usuario = 'S'";
  ...
  <div class="header" style="height:100px; background:#333">
        ...
        <div style="background:#333; height:25px; color:#FFFFFF; padding:25px 15px 0px 0px; text-align:right;" id="datosUsuario">
        	<div style="background: #333;position:absolute;border-radius: 0px 0px 5px 5px; padding:15px; text-align:center;
                ...
                Lista de Usuarios Distribuidor<br/>
				<!-- InstanceEndEditable -->        
            </div>
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
  	<div style="height:100%; font-size:18px;" class="xfirefox">
        <div style="height:100%; font-size:28px; padding:10px 10px 20px 10px; float:right;">
            <a href="usuarios_multi_add.php" class="btn alert-success" 
            	style="font-size:18px; width:165px; height:55px; padding:5px 0px 0px 0px; text-align:center; background:#9C0;
                text-decoration:none;" title="crear nuevo usuario distribuidor">
                 Añadir Nuevo Usuario Multi Distribuidor
            </a>
        </div>
    <?php if ($totalRows_Recordset1>0) {?>    
    <table width="100%" border="0" align="center" style="background: #333; color:#FFF; font-size:14px" >
        <tr>
          <td width="594" align="right" class="diezpunto">Usuarios Distribuidores <?php echo($startRow_Recordset1 + 1) ?>-<?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?> de <?php echo $totalRows_Recordset1 ?></td>
	...
	<table width="100%" border="0" align="center">
        ...
        <tr class="brillo">
            ...
            <td align="left"><?php echo $row_Recordset1['nom_multidistriMD']; ?></td>
            <td align="center"><?php echo ObtenerNombreStatus($row_Recordset1['est_usuario']); ?></td>
            <td align="center">
            	<a href='usuarios_multi_edit.php?recordID=<?php echo $row_Recordset1['id_usuario']; ?>'class="btn btn-info"> EDITAR </a>
            </td>
