...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 admin\usuarios_multi_add.php - QUERY 1 */ INSERT 
		INTO usuario 
...
$query_Recordset2 = "/* PARSEADORES1 admin\usuarios_multi_add.php - QUERY 2 */ SELECT cod_multidistriMD, nom_multidistriMD FROM multidistriMD";
  ...
  <div class="header" style="height:100px; background:#333">
        ...
        <div style="background:#333; height:25px; color:#FFFFFF; padding:25px 15px 0px 0px; text-align:right;" id="datosUsuario">
        	<div style="background: #333;position:absolute;border-radius: 0px 0px 5px 5px; padding:15px; text-align:center;
                ...
                Nuevo Usuario Multi Distribuidor<br/>
				<!-- InstanceEndEditable -->        
            </div>
              ...
              <table width="919" align="center">
                <tr valign="baseline">
                  <td height="44" colspan="5" align="center" valign="middle" nowrap bgcolor="#5EAEFF" 
                  	...
                  	DATOS DE MULTI DISTRIBUIDOR
                  </td>
                <tr valign="baseline">
                  <td width="1" align="left" valign="middle" nowrap>&nbsp;</td>
                  <td width="365" align="left" valign="middle" nowrap>Multi Distribuidor:<br>
                ...
                <tr valign="baseline">
                  ...
                  DATOS Y OPCIONES DE USUARIO MULTI DISTRIBUIDOR</td>
                </tr>
              </table>
