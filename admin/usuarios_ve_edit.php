...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
      echo '11111111111111111111<br>';
        $_POST['tip_usuario']="U";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 admin\usuarios_ve_edit.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
                nom_usuario=%s,
            ...
            GetSQLValueString($_POST['ZonaHorario'], "text"),
        ...
        $insertGoTo = "../admin/taquillas_edit.php?recordID=".$_POST['cod_taquilla7'];
        if (isset($_SERVER['QUERY_STRING'])) {
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 admin\usuarios_ve_edit.php - QUERY 2 */ SELECT us.id_usuario, us.pas_usuario, us.nom_usuario, us.dia_entrada, us.hor_inicio, us.hor_fin,
	us.nom_completo, us.pas_usuario, us.est_usuario, us.tic_eliminados, us.cod_barra, us.can_reimpresion, 
	ta.nom_taquilla, ta.cod_taquilla, us.ZonaHorario, us.24hr
	FROM 
...
if (isset($_POST['eliminar'])){
  ...
  $query_delete =  sprintf(
      "/* PARSEADORES1 admin\usuarios_ve_edit.php - QUERY 3 */ DELETE FROM usuario WHERE id_usuario = %s",
        	...
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              <table width="919" align="center">
                ...
                <tr valign="baseline" align="center">
                  ...
                  <td colspan="3" align="center">Selecione Zona Horario:
                  <?php
//'+7 hour' Brasil, Uruguay, Argentina
//'+6 hour' Venezuela, Chile, Puerto Rico, Trinidad y Tobago
//'+5 hour' Colombia, Panama, Peru, Ecuador

?>
                    	<select name="ZonaHorario" style="width: auto; height: auto" class="textbox" tabindex="36">
                      <option value="+7 hour" <?php
                            if (!(strcmp("+7 hour", htmlentities($row_Recordset1['ZonaHorario'], ENT_COMPAT, 'utf-8')))) {
                                echo "SELECTED";
                            } ?>>Brasil, Uruguay, Argentina
                            </option>
                      <option value="+6 hour" <?php
                            if (!(strcmp("+6 hour", htmlentities($row_Recordset1['ZonaHorario'], ENT_COMPAT, 'utf-8')))) {
                                echo "SELECTED";
                            } ?>>Venezuela, Chile, Puerto Rico, Trinidad y Tobago
                            </option>
                      <option value="+5 hour" <?php
                            if (!(strcmp("+5 hour", htmlentities($row_Recordset1['ZonaHorario'], ENT_COMPAT, 'utf-8')))) {
                                echo "SELECTED";
                            } ?>>Colombia, Panama, Peru, Ecuador
                            </option>
                    	</select>
...
<tr width="123" align="left" valign="middle">
                  TRABAJAR 24/7: (Activarlo eliminara el formato de Hora y Cierre de Ventas<br/>
    ...
    echo "SELECTED";
                ...
                <td width="212">
                    ...
                    <input type="text" name="nom_usuario" id="nom_usuario" size="32" class="textbox"  
                    placeholder="usuario" pattern="[.-,-=-+-%-$-(-)-A-Z a-z0-9]{4,20}" maxlength="20" style="height: auto"
                    value="<?php echo htmlentities($row_Recordset1['nom_usuario'], ENT_COMPAT, 'utf-8'); ?>" 
...
-->
    ...
    echo "SELECTED";
                  ...
                  <!--<button type="submit" name="eliminar" style="width:180px; height:50px; font-size:16px;"  class="btn btn-warning">Eliminar Vendedor</button>-->
                  </td>
                  <td align="left" nowrap>&nbsp;</td>
                  <td align="left" nowrap>&nbsp;</td>
                  <td align="left" nowrap>&nbsp;</td>
