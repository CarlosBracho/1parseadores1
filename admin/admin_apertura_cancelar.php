...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 admin\admin_apertura_cancelar.php - QUERY 1 */ SELECT nom_hipodromo, num_carrera FROM carrera WHERE carrera.cod_carrera = %s",
...
if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $updateSQL = sprintf(
      "/* PARSEADORES1 admin\admin_apertura_cancelar.php - QUERY 2 */ UPDATE carrera 
							SET 
							est_carrera=%s, 
							est_cierre=%s, 
							est_confirmacion=%s, 
  ...
  $insertSQL2 = sprintf(
      "/* PARSEADORES1 admin\admin_apertura_cancelar.php - QUERY 3 */ INSERT 
					INTO bitacora 
