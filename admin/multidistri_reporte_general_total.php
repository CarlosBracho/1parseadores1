...
$totSistemaA=0;
$query_Recordset555 = sprintf("/* PARSEADORES1 admin\multidistri_reporte_general_total.php - QUERY 1 */ SELECT * FROM tasadecambio WHERE Idtasadecambio = 1");
...
$query_Recordset18 = sprintf("/* PARSEADORES1 admin\multidistri_reporte_general_total.php - QUERY 2 */ SELECT 
...
$query_Recordset12 = sprintf(
    "/* PARSEADORES1 admin\multidistri_reporte_general_total.php - QUERY 3 */ SELECT  nom_multidistriMD, multi_por_ameMD, multipor_banca_hnacMD, multi_por_parleyMD FROM multidistriMD WHERE cod_multidistriMD = %s",
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 admin\multidistri_reporte_general_total.php - QUERY 4 */ SELECT *
    ...
    if (isset($_POST['fecha_inicio']) && isset($_POST['fecha_fin'])) {
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_agencia']!="todos") {
                $query_Recordset3 = sprintf(
                    "/* PARSEADORES1 admin\multidistri_reporte_general_total.php - QUERY 5 */ SELECT *
					FROM agencia ag
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 admin\multidistri_reporte_general_total.php - QUERY 6 */ SELECT ag.cod_agencia, ag.nom_agencia
	FROM agencia ag, banca ba, multidistriMD mu
...
<?php
$query_Recordset44 = sprintf("/* PARSEADORES1 admin\multidistri_reporte_general_total.php - QUERY 7 */ SELECT 
	me.mensaje
           ...
           <td width="21%">TAQUILLA</td>
            ...
            <td width="19%">TOTAL A COBRAR Al<br/> TAQUILLA AMERICANA (%)<br/> NACIONALES(X) TOTAL ( )</td>
                    ...
                    $query_Recordset30 = sprintf(
                       "/* PARSEADORES1 admin\multidistri_reporte_general_total.php - QUERY 8 */ SELECT cod_taquilla, nom_taquilla
						FROM taquilla
						WHERE cod_agencia = %s
                   ...
                   if ($totalRows_Recordset30>0) {
                       do {
                           ...
                           $query_Recordset1 = sprintf(
                               "/* PARSEADORES1 admin\multidistri_reporte_general_total.php - QUERY 9 */ SELECT
					...
					SUM(CASE WHEN ve.est_ticket = 0 AND ve.fec_venta >= %s AND ve.fec_venta <= %s AND ve.lin_ticket = 1  AND ve.efectivoO = 5
						THEN 1 ELSE 0 END) AS con_tic_elisol
                           ...
                           $query_Recordset21 = sprintf(
                               "/* PARSEADORES1 admin\multidistri_reporte_general_total.php - QUERY 10 */ SELECT
					...
					SUM(CASE WHEN veN.est_ticket_hnac = 0 AND veN.fec_venta_hnac >= %s AND veN.fec_venta_hnac <= %s AND
						...
						THEN 1 ELSE 0 END) AS con_tic_eliNsol
                           ...
                           $query_Recordset22 =  sprintf(
                               "/* PARSEADORES1 admin\multidistri_reporte_general_total.php - QUERY 11 */ SELECT cob_taquilla_hnac 
								FROM  
                           ...
                           $newDate1 = date("Y-m-d", $timestamp1 );
                              ...
                              $query_Recordset50 = sprintf(
                               "/* PARSEADORES1 admin\multidistri_reporte_general_total.php - QUERY 12 */ SELECT 
