...
$query_Recordset1 = "/* PARSEADORES1 admin\usuariosyclaves.php - QUERY 1 */ SELECT * FROM usuario WHERE (tip_usuario='G' OR tip_usuario='D') ORDER BY usuario.nom_usuario ASC";
