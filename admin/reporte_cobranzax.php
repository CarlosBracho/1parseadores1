        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_distribuidor']!="todos") {
                $query_Recordset10 = sprintf(
                    "/* PARSEADORES1 admin\reporte_cobranzax.php - QUERY 1 */ SELECT cod_banca, nom_banca, tel_banca, cor_banca, dist_por_ame 
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && $_POST['id_distribuidor']=="todos") ||
    ...
    $query_Recordset10 = sprintf("/* PARSEADORES1 admin\reporte_cobranzax.php - QUERY 2 */ SELECT cod_banca, nom_banca, tel_banca, cor_banca, dist_por_ame, dist_cob_hnac FROM banca");
    $v=0;
}
...
$query_Recordset2 = sprintf("/* PARSEADORES1 admin\reporte_cobranzax.php - QUERY 3 */ SELECT cod_banca, nom_banca, dist_cob_hnac FROM banca ORDER BY banca.nom_banca");
		...
		<table width="100%" border="0" style="color:#000; font-size:11px;" cellpadding="0" cellspacing="0"><?php
            ...
            if ($totalRows_Recordset10>0) {
                do {
                    ...
                    $query_Recordset3 = sprintf("/* PARSEADORES1 admin\reporte_cobranzax.php - QUERY 4 */ SELECT cod_agencia, nom_agencia, agen_por_ame, agen_cob_hnac
                    ...
                    if ($totalRows_Recordset3>0) {
                        do {
                            ...
                            $query_Recordset7 = sprintf(
                                "/* PARSEADORES1 admin\reporte_cobranzax.php - QUERY 5 */ SELECT 
...
cobro_hnac.cod_agencia = %s",
                            ...
                            $query_Recordset15 = sprintf(
                                "/* PARSEADORES1 admin\reporte_cobranzax.php - QUERY 6 */ SELECT 
...
cobro_hnac.cod_banca = %s",
                            ...
                            $query_Recordset1 = sprintf(
                                "/* PARSEADORES1 admin\reporte_cobranzax.php - QUERY 7 */ SELECT
