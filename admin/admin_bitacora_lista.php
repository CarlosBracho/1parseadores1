...
$query_Recordset1 = sprintf("/* PARSEADORES1 admin\admin_bitacora_lista.php - QUERY 1 */ SELECT * FROM bitacora WHERE bitacora.fec_bitacora = %s ORDER BY bitacora.hor_bitacora DESC", GetSQLValueString($fechaactual_Recordset1, "date"));
$Recordset1 = mysqli_query($conexionbanca, $query_Recordset1) or die(mysqli_error($conexionbanca));
$fecha=fechanueva(fechaactualbd());
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    $fechaactual_Recordset1=fechaymd($_POST["fecha"]);
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 admin\admin_bitacora_lista.php - QUERY 2 */ SELECT * FROM bitacora 
