...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 admin\usuarios_ba_edit.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
        nom_usuario=%s,
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 admin\usuarios_ba_edit.php - QUERY 2 */ SELECT * 
	FROM 
	usuario, banca 
	WHERE 
	usuario.id_usuario = %s AND
	banca.cod_banca = usuario.cod_taquilla LIMIT 1",
  ...
  <div class="header" style="height:100px; background:#333">
        ...
        <div style="background:#333; height:25px; color:#FFFFFF; padding:25px 15px 0px 0px; text-align:right;" id="datosUsuario">
        	<div style="background: #333;position:absolute;border-radius: 0px 0px 5px 5px; padding:15px; text-align:center;
                ...
                Editar Usuario distribuidor<br/>
				<!-- InstanceEndEditable -->        
            </div>
              ...
              <table width="919" align="center">
                ...
                <tr valign="baseline">
                  ...
                  <td align="left" valign="bottom" nowrap>
                    ...
                    Nombre de usuario:
                  	<?php echo $row_Recordset1['nom_usuario']." | ".$row_Recordset1['nom_banca']?>
                    </div>
                    <br>
                  </td>
                  <td width="180">&nbsp;</td>
