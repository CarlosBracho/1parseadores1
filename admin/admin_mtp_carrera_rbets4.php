...
var loadHora = function() {
    $.ajax({    
        type: "GET",
        url: "../includes/mtp_cierre_rbets4.php",             
        dataType: "html",
		beforeSend: function() {
...
<div class="container">
    <div style="background: #93C; height:35px; color:#FFFFFF; padding:25px 0px 0px 0px;text-align:center;font-size:34px;width:100%"
    	id="datosUsuario">
    RACEBETS <em>TOMORROW</em> (MTP) </div>
</div>
<div class="contentAdmin">
	<div style="padding:0px 0px 40px 0px;text-align:left;font-size:18px;height:auto" id="divControlHora" class="divControlHora">
    	<div style="color: #000; width:100%; text-align:center; padding:20px 0px 0px 0px" id="dHora" class="dHora">
        </div>    
	</div>
</div>
</body>
