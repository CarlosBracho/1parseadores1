...
$query_Recordset3 =  sprintf(
  "/* PARSEADORES1 admin\usuarios_ag_edit.php - QUERY 1 */ SELECT * 
FROM 
usuario
WHERE id_usuario = %s",
...
$query_Recordset2 =  sprintf(
  "/* PARSEADORES1 admin\usuarios_ag_edit.php - QUERY 2 */ SELECT * 
FROM 
usuario
WHERE id_usuario = %s",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $_POST['tip_usuario']="G";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 admin\usuarios_ag_edit.php - QUERY 3 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
        nom_usuario=%s,
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 admin\usuarios_ag_edit.php - QUERY 4 */ SELECT * 
	FROM 
	usuario, agencia 
	WHERE 
