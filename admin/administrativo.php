...
$query_Recordset1 = "/* PARSEADORES1 admin\administrativo.php - QUERY 1 */ SELECT * FROM agencia, banca WHERE banca.cod_banca = agencia.cod_banca ORDER BY agencia.nom_agencia, banca.cod_banca";
