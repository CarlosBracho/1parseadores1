...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 admin\agencias_edit.php - QUERY 1 */ UPDATE agencia 
				SET nom_representante=%s, nom_agencia=%s, tel_agencia=%s, dir_agencia=%s, 
agen_vende_ame=%s,
agen_por_ame=%s,
agen_vende_hnac=%s,
agen_cob_hnac=%s,
				por_agencia_lot=%s, por_agencia_macu=%s, est_agencia=%s, sinoclaves=%s, sinomoneda=%s, agen_vende_parley=%s, agen_por_parley=%s 
				WHERE cod_agencia=%s",
...
/*/
        ...
        $msj=' el nuevo de nombre de agente es: '.$Gnom;
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 admin\agencias_edit.php - QUERY 2 */ SELECT
	agencia.nom_agencia,
	agencia.cod_banca,
...
$query_Recordset94 =  sprintf(
  "/* PARSEADORES1 admin\agencias_edit.php - QUERY 3 */ SELECT
agencia.sinoclaves,
agencia.sinomoneda
FROM  
agencia
...
$query_Recordset2 = "/* PARSEADORES1 admin\agencias_edit.php - QUERY 4 */ SELECT cod_banca, nom_banca FROM banca";
$Recordset2 =mysqli_query($conexionbanca, $query_Recordset2) or die(mysqli_error($conexionbanca));
$row_Recordset2 = mysqli_fetch_assoc($Recordset2);
$totalRows_Recordset2 = mysqli_num_rows($Recordset2);

$query_Recordset22 = sprintf(
  "/* PARSEADORES1 admin\agencias_edit.php - QUERY 5 */ SELECT * 
  	FROM
	agencia,
	banca
  WHERE 
...
<div class="container">
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
	<div style="padding:70px 10px 20px 10px; text-align:left; font-size:18px; height: auto">
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>" onsubmitsub="return chequearEnvio();">
