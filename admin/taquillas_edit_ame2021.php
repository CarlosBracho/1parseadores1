...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 admin\taquillas_edit_ame2021.php - QUERY 1 */ SELECT  
...
$query_Recordset4 =  sprintf(
    "/* PARSEADORES1 admin\taquillas_edit_ame2021.php - QUERY 2 */ SELECT  
...
if ($totalRows_Recordset4==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            ...
            $query_Recordset4 =  sprintf(
                "/* PARSEADORES1 admin\taquillas_edit_ame2021.php - QUERY 3 */ SELECT  
    ...
    if ($graba==31) {
        if (isset($row_Recordset4['reg_gan'])) {
            if ($_POST['reg_gan']<>$row_Recordset4['reg_gan'] or $_POST['reg_pla']<>$row_Recordset4['reg_pla'] or $_POST['pag_codigo']<>$row_Recordset4['pag_codigo']) {
                ...
                $insertSQL2 = sprintf(
                    "/* PARSEADORES1 admin\taquillas_edit_ame2021.php - QUERY 4 */ INSERT 
					INTO bitacora 
        ...
        if ($_POST['existe']==1) {
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 admin\taquillas_edit_ame2021.php - QUERY 5 */ UPDATE taquilla_opc_ame
					SET
					pag_codigo=%s, 
					apu_maxgan=%s, 
					apu_maxpla=%s, 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 admin\taquillas_edit_ame2021.php - QUERY 6 */ SELECT  
tp.apu_mingan
	FROM  taquilla_opc_ame tp 
	WHERE tp.cod_taquilla = %s
	LIMIT 1",
            ...
            if ($apuestasminimaausar > $row_Recordset22['apu_mingan']) {
                $insertSQL11 = sprintf(
                    "/* PARSEADORES1 admin\taquillas_edit_ame2021.php - QUERY 7 */ UPDATE taquilla_opc_ame
					SET
					apu_mingan=%s
            ...
            $insertSQL2 = sprintf(
                "/* PARSEADORES1 admin\taquillas_edit_ame2021.php - QUERY 8 */ INSERT 
			INTO 
			taquilla_opc_ame 
            ...
            $query_Recordset22 =  sprintf(
                "/* PARSEADORES1 admin\taquillas_edit_ame2021.php - QUERY 9 */ SELECT  
tp.apu_mingan
	FROM  taquilla_opc_ame tp 
	WHERE tp.cod_taquilla = %s
	LIMIT 1",
            ...
            if ($apuestasminimaausar > $row_Recordset22['apu_mingan']) {
                $insertSQL11 = sprintf(
                    "/* PARSEADORES1 admin\taquillas_edit_ame2021.php - QUERY 10 */ UPDATE taquilla_opc_ame
					SET
					apu_mingan=%s
					WHERE cod_taquilla=%s",
                    GetSQLValueString($apuestasminimaausar, "int"),
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 admin\taquillas_edit_ame2021.php - QUERY 11 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
