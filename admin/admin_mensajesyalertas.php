...
$query_mensajesyalertas = "/* PARSEADORES1 admin\admin_mensajesyalertas.php - QUERY 1 */ SELECT me.tipo, me.para, me.mensaje, me.mostrarhasta, me.Id_mensajesyalertas  FROM mensajesyalertas me WHERE (me.mostrarhasta >= CURDATE()) AND me.creadopor = 0 ORDER BY me.Id_mensajesyalertas DESC";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 admin\admin_mensajesyalertas.php - QUERY 2 */ UPDATE mensajesyalertas 
...
if ($row_mensajesyalertas['tipo']==1) {
    $query_Recordset4 = sprintf(
        "/* PARSEADORES1 admin\admin_mensajesyalertas.php - QUERY 3 */ SELECT nom_taquilla FROM taquilla
...
if ($row_mensajesyalertas['tipo']==2) {
    $query_Recordset4 = sprintf(
        "/* PARSEADORES1 admin\admin_mensajesyalertas.php - QUERY 4 */ SELECT ag.nom_agencia FROM agencia ag
...
if ($row_mensajesyalertas['tipo']==3) {
    $query_Recordset4 = sprintf(
        "/* PARSEADORES1 admin\admin_mensajesyalertas.php - QUERY 5 */ SELECT ba.nom_banca FROM banca ba
...
if ($row_mensajesyalertas['tipo']==4) {
    $query_Recordset4 = sprintf(
        "/* PARSEADORES1 admin\admin_mensajesyalertas.php - QUERY 6 */ SELECT ag.nom_agencia FROM agencia ag
WHERE ag.cod_agencia = %s
ORDER BY RAND() LIMIT 1",
        GetSQLValueString($row_mensajesyalertas['para'], "int")
    );
...
if ($row_mensajesyalertas['tipo']==5) {
    $query_Recordset4 = sprintf(
        "/* PARSEADORES1 admin\admin_mensajesyalertas.php - QUERY 7 */ SELECT ba.nom_banca FROM banca ba
WHERE ba.cod_banca = %s
ORDER BY RAND() LIMIT 1",
        GetSQLValueString($row_mensajesyalertas['para'], "int")
    );
...
if ($row_mensajesyalertas['tipo']==6) {
    $query_Recordset4 = sprintf(
        "/* PARSEADORES1 admin\admin_mensajesyalertas.php - QUERY 8 */ SELECT ba.nom_banca FROM banca ba
WHERE ba.cod_banca = %s
ORDER BY RAND() LIMIT 1",
        GetSQLValueString($row_mensajesyalertas['para'], "int")
    );
