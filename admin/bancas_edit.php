...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 admin\bancas_edit.php - QUERY 1 */ UPDATE banca 
...
dist_vende_hnac=%s,
dist_cob_hnac=%s,
				por_banca_lot=%s, por_banca_macu=%s, est_banca=%s, sinoclavesdistri = %s, sinomonedadistri = %s, cobrodirectoDT = %s, cod_multidistriMDBA = %s
				WHERE cod_banca=%s",
            ...
            GetSQLValueString($_POST['cobrodirectoDT'], "int"),  ///aqui va
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 admin\bancas_edit.php - QUERY 2 */ SELECT *
	FROM  
	banca
	WHERE 
	banca.cod_banca = %s",
...
$query_Recordset94 =  sprintf(
  "/* PARSEADORES1 admin\bancas_edit.php - QUERY 3 */ SELECT
...
$query_Recordset2 = "/* PARSEADORES1 admin\bancas_edit.php - QUERY 4 */ SELECT  DISTINCT
cod_multidistriMD, nom_multidistriMD 
FROM multidistriMD";
...
$query_Recordset22 = sprintf(
  "/* PARSEADORES1 admin\bancas_edit.php - QUERY 5 */ SELECT DISTINCT * 
  	FROM 
	banca,
  multidistriMD
  WHERE 
  banca.cod_banca=%s AND
  banca.cod_multidistriMDBA=multidistriMD.cod_multidistriMD",
    GetSQLValueString($xCodigo, "int")
);
...
<div class="container">
  ...
  <div class="contentAdmin"><!-- InstanceBeginEditable name="Contenido" -->
    ...
    echo "SELECTED";
			  ...
			  <table width="919" align="center">
                <tr valign="baseline">
                  ...
                  <td colspan="2" align="left" valign="middle" nowrap>Asignar a un MultiDistribuidor:<br>
                 
              
                  <select name="cod_banca" style="width:327px; height: auto" class="textbox">
                  
                    
                  

                  <option value="<?php echo $row_Recordset22['cod_multidistriMDBA']?>">
                                            <?php echo $row_Recordset22['nom_multidistriMD']?></option>
                    ...
                    ?>
                    <option value="0">NO ASIGNAR A MULTIDISTRI</option>
                    </select>
    ...
    echo "SELECTED";
                  ...
                  Quien Cobra:<br />
                    <select name="cobrodirectoDT" style="width:210px; height: auto" class="textbox" tabindex="4"> 
                      <option value="0" <?php if (!(strcmp(0, htmlentities($row_Recordset1['cobrodirectoDT'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>Cobro Directo</option>
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_Recordset1['cobrodirectoDT'], ENT_COMPAT, 'utf-8')))) {
    echo "SELECTED";
} ?>>Cobra Multi Distribuidor</option>
                  </select>
