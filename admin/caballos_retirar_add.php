...
$query_Recordset1 = sprintf("/* PARSEADORES1 admin\caballos_retirar_add.php - QUERY 1 */ SELECT * FROM carrera WHERE carrera.cod_carrera = %s", GetSQLValueString($xCarrera_Recordset1, "int"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = sprintf(
        "/* PARSEADORES1 admin\caballos_retirar_add.php - QUERY 2 */ INSERT INTO retirados (cod_carrera, num_rcaballo) VALUES (%s, %s)",
    ...
    $insertSQL2 = sprintf(
        "/* PARSEADORES1 admin\caballos_retirar_add.php - QUERY 3 */ INSERT 
					INTO bitacora 
...
$query_Recordset2 = "/* PARSEADORES1 admin\caballos_retirar_add.php - QUERY 4 */ SELECT * FROM retirados";
