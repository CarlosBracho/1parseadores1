...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if (isset($_POST['nom_taquilla']) && $_POST['nom_taquilla']!="") {
        if (buscaAge($_POST['nom_taquilla'])>0) {
            $menTaq="Ya existe";
            $graba--;
        }
    }
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 admin\agencias_add.php - QUERY 1 */ INSERT 
				INTO agencia 
				(nom_agencia, nom_representante, tel_agencia, cod_banca, dir_agencia, 
agen_vende_ame,
agen_por_ame,
agen_vende_hnac,
agen_cob_hnac,
				por_agencia_lot, por_agencia_macu, est_agencia, agen_vende_parley, agen_por_parley) 
        ...
        $query_RecT = "/* PARSEADORES1 admin\agencias_add.php - QUERY 2 */ SELECT cod_agencia FROM agencia ORDER BY cod_agencia DESC LIMIT 1";
        ...
        $codTaquilla=$row_RecT['cod_agencia'];
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 admin\agencias_add.php - QUERY 3 */ INSERT 
		INTO usuario 
        ...
        $Gnom=$_POST['nom_usuario'];

        /*/
        $msj='se creo un nuevo agente de nombre: '.$Gnom;
...
$query_Recordset2 = "/* PARSEADORES1 admin\agencias_add.php - QUERY 4 */ SELECT cod_banca, nom_banca FROM banca";
	...
	<div style="padding:70px 10px 20px 10px; text-align:left; font-size:18px; height: auto">
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>" onsubmit="return chequearEnvio();">
                ...
                <tr valign="baseline">
                  ...
                  <td width="450" align="center" valign="bottom" nowrap bgcolor="#999999">Estado Venta Parley:<br /></td>
                ...
                <tr valign="baseline">
                  ...
                  <td width="120" align="center" valign="top" nowrap bgcolor="#999999">
                  	...
                  	<input type="text" name="agen_por_parley" class="textbox" style="height:auto; width:100px" 
                    onclick="ocultaDiv('Info7');"
                    value="0.00" 
                    size="10" onkeypress="ValidaSoloNumeros()" title="indique monto"
                    onKeyUp="return handleEnter(this, event)" tabindex="8" required max="100"/>
        	...
        	<div style="width:920px; text-align:left; font-size:18px; background: #E1E1E1">
              <table width="919" align="center">
                ...
                <tr valign="baseline">
                  ...
                  <td colspan="2" align="left" valign="middle" nowrap>Distribuidor:<br>
                 

 <select name="cod_agencia" style="width:247px; height: auto" class="textbox">
              ...
              <table width="921" align="center">
                ...
                <tr valign="baseline">
                  ...
                  <td width="249" align="left" valign="top" nowrap>
                    ...
                    maxlength="30"  title="indique un nombre de usuario. 4-30 caracteres"
                  ...
                  <td width="272" valign="top">
                     ...
                     title="indique un nombre para mostrar en ticket. 4-10 caracteres"
                    onKeyUp="return handleEnter(this, event)" onclick="ocultaDiv('Info35');" tabindex="34" 
                    value="" 
                    size="32" />
                    <div id="Info35" style="float: left; padding:-10px 0px 0px 0px; font-size:12px; color:#F00">
