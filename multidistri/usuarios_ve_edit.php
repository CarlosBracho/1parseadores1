...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $_POST['tip_usuario']="U";
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 multidistri\usuarios_ve_edit.php - QUERY 1 */ UPDATE usuario 
				SET
				nom_completo=%s, 
				pas_usuario=%s,
        nom_usuario=%s,
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 multidistri\usuarios_ve_edit.php - QUERY 2 */ SELECT us.id_usuario, us.pas_usuario, us.nom_usuario, us.dia_entrada, us.hor_inicio, us.hor_fin,
