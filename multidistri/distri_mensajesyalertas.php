...
$query_mensajesyalertas = "/* PARSEADORES1 multidistri\distri_mensajesyalertas.php - QUERY 1 */ SELECT me.tipo, me.para, me.mensaje, me.mostrarhasta, me.Id_mensajesyalertas  FROM mensajesyalertas me WHERE (me.mostrarhasta >= CURDATE()) AND me.creadopor = 2 ORDER BY me.Id_mensajesyalertas DESC";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 multidistri\distri_mensajesyalertas.php - QUERY 2 */ UPDATE mensajesyalertas 
...
if ($row_mensajesyalertas['tipo']==1) {
    $query_Recordset4 = sprintf(
        "/* PARSEADORES1 multidistri\distri_mensajesyalertas.php - QUERY 3 */ SELECT nom_taquilla FROM taquilla
...
if ($row_mensajesyalertas['tipo']==2) {
    $query_Recordset4 = sprintf(
        "/* PARSEADORES1 multidistri\distri_mensajesyalertas.php - QUERY 4 */ SELECT ag.nom_agencia FROM agencia ag
...
if ($row_mensajesyalertas['tipo']==3) {
    $query_Recordset4 = sprintf(
        "/* PARSEADORES1 multidistri\distri_mensajesyalertas.php - QUERY 5 */ SELECT ba.nom_banca FROM banca ba
