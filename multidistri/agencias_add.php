...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 multidistri\agencias_add.php - QUERY 1 */ INSERT 
				INTO agencia 
...
agen_cob_hnac,
        ...
        $query_RecT = "/* PARSEADORES1 multidistri\agencias_add.php - QUERY 2 */ SELECT cod_agencia FROM agencia ORDER BY cod_agencia DESC LIMIT 1";
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 multidistri\agencias_add.php - QUERY 3 */ INSERT 
		INTO usuario 
...
"/* PARSEADORES1 multidistri\agencias_add.php - QUERY 4 */ SELECT 
cod_banca, nom_banca 
FROM 
banca,
multidistriMD
