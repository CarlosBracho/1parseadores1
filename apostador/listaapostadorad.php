...
$codigoDistri=$_SESSION['MM_cod_banca'];
    ...
    if (!empty($_POST)) {
        if (!empty($_POST['campo'])) {
			...
			agencia.cod_banca = banca.cod_banca AND
			banca.cod_banca = '$codigoDistri' AND
			taquilla.nom_taquilla LIKE '%$valor%' ";
            }
        }
    }
    $query_Recordset1 = "/* PARSEADORES1 apostador\listaapostadorad.php - QUERY 1 */ SELECT * FROM taquilla, agencia, banca $where";
...
do {
    ...
    echo $row_Recordset1['tel_taquilla']; ?></td>
        ...
        "/* PARSEADORES1 apostador\listaapostadorad.php - QUERY 2 */ SELECT MAX(Idbalancecli) 
    ...
    $query_Recordset14 = sprintf(
        "/* PARSEADORES1 apostador\listaapostadorad.php - QUERY 3 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
        GetSQLValueString(0, "int"),
    ...
    $query_Recordset15 = sprintf(
        "/* PARSEADORES1 apostador\listaapostadorad.php - QUERY 4 */ SELECT MAX(Idbalancecli) 
					FROM balanceclientes
					WHERE monedac = %s AND 
					cod_taquilla = %s",
    ...
    $query_Recordset16 = sprintf(
        "/* PARSEADORES1 apostador\listaapostadorad.php - QUERY 5 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
        GetSQLValueString(3, "int"),
    ...
    $query_Recordset17 = sprintf(
        "/* PARSEADORES1 apostador\listaapostadorad.php - QUERY 6 */ SELECT MAX(Idbalancecli) 
					FROM balanceclientes
					WHERE monedac = %s AND 
					cod_taquilla = %s",
    ...
    $query_Recordset18 = sprintf(
        "/* PARSEADORES1 apostador\listaapostadorad.php - QUERY 7 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
        GetSQLValueString(4, "int"),
    ...
    $query_Recordset19 = sprintf(
        "/* PARSEADORES1 apostador\listaapostadorad.php - QUERY 8 */ SELECT MAX(Idbalancecli) 
					FROM balanceclientes
					WHERE monedac = %s AND 
					cod_taquilla = %s",
    ...
    $query_Recordset20 = sprintf(
        "/* PARSEADORES1 apostador\listaapostadorad.php - QUERY 9 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
        GetSQLValueString(5, "int"),
