...
$query_Recordset6 = sprintf("/* PARSEADORES1 apostador\internacionalesa.php - QUERY 1 */ SELECT 
	tp.est_venta_ame
...
$query_Recordset5 = sprintf(
    "
/* PARSEADORES1 apostador\internacionalesa.php - QUERY 2 */ SELECT * FROM usuario, taquilla, taquilla_opc_ame, agencia,
			banca
...
$query_Recordset7 = sprintf("/* PARSEADORES1 apostador\internacionalesa.php - QUERY 3 */ SELECT * FROM ctrol_ventpag_global_ame WHERE cod_ctrol_ventpag_global_ame =1");
...
$query_Recordset44 = sprintf("/* PARSEADORES1 apostador\internacionalesa.php - QUERY 4 */ SELECT 
	me.mensaje
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 apostador\internacionalesa.php - QUERY 5 */ SELECT 
* FROM 
carrera 
WHERE 
...
<a class="nav-link" href="../parley/apparley.php">Apostar Parley<span class="sr-only">(current)</span></a>
<?php } else { ?>
...
<button type="button" onclick="window.location='internacionalesa.php';" class="btn btn-primary btn-lg btn-block">ACTUALIZAR PÁGINA</button>
...
<div id="ultimajugada"></div>
    ...
    <fieldset>
				...
				<?php
						if ($row_Recordset5['24hr'] == 0 && $nuevahora1 > $row_Recordset5['hor_fin'] OR $nuevahora1 < $row_Recordset5['hor_inicio']) {
...
if ($totalRows_Recordset1>0) {
        ...
        do {
            ...
            $faltan=restahoras($horaactualcarrera, $row_Recordset1['hor_mtp']);
            if ($horaactualcarrera>$row_Recordset1['hor_mtp']) {
                $faltan="00:00";
            } 
			$diego=boton_hipodromo($row_Recordset1['cod_hipodromo'], $row_Recordset5['cod_taquilla']);
                if($diego==1){
...
class="btn btn-warning"
		onclick="ActivarCampoOtrohipodromo<?php echo $n ?>();"><?php if($diego==1){ echo $row_Recordset1['num_carrera']; }?>
</button>
<?php } if($diego==1){ ?>
<button type="button" class="btn btn-outline-danger" onclick="ActivarCampoOtrohipodromo<?php echo $n ?>();"><?php if($diego==1){ echo $faltan; }?></button>
<?php } ?>
...
class="btn btn-warning btn-sm"
    ...
    <div class="col">
                         ...
                         style="width:73px; font-size:12px" maxlength="9"  value="" id="<?php echo "monGan".$t; ?>"/>
    </div>
    <div class="col">
                         ...
                         style="width:73px; font-size:12px" maxlength="9" value="" id="<?php echo "monPla".$t; ?>"/>
    </div>
    <div class="col">
                         ...
                         style="width:73px; font-size:12px" maxlength="9" value="" id="<?php echo "monSho".$t; ?>"/>
      ...
      echo '</br>';
            ...
            $cod_carrera=$row_Recordset1['cod_carrera']; ?>
                        ...
                        <input form="form<?php echo $n ?>"  type="hidden" name="moneda" value="<?php echo $moneda; ?>" />
...
<?php if ($tel_agencia!="") {
    $whatsapp = "http://wa.me/+".$tel_agencia." Aquí Tú Teléfono"; ?>
...
<div class="separator" style="clear: both; text-align: left;">
<a href="<?php echo $whatsapp ?>" style="clear: left; float: left; margin-bottom: 1em; margin-right: 1em;" target="_blank"><img border="0" data-original-height="59" data-original-width="59" src="https://1.bp.blogspot.com/-q3Dot9N2qac/XOQgr9etVpI/AAAAAAABT1M/6V4Bqaqr-6UQcl9Fy2_CaVgex0N_OYuQgCLcBGAs/s1600/whatsapp%2Bicono.png" /></a></div>
