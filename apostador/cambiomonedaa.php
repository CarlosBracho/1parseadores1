...
if (!isset($_SESSION['MM_id_usuario'])) {
    ...
    $query_Recordset13 = sprintf(
        "/* PARSEADORES1 apostador\cambiomonedaa.php - QUERY 1 */ SELECT taquilla.cod_taquilla, taquilla.moneda , taquilla.nom_taquilla
...
if (isset($_POST['moneda'])) {
    $insertSQL2 = sprintf(
        "/* PARSEADORES1 apostador\cambiomonedaa.php - QUERY 2 */ UPDATE taquilla
					SET
					moneda=%s
