...
if (isset($_GET["recordID"])) {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 apostador\reporteaa.php - QUERY 1 */ SELECT *
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 apostador\reporteaa.php - QUERY 2 */ SELECT *
					FROM balanceclientes, taquilla, agencia, usuario
					WHERE
					taquilla.cod_taquilla = balanceclientes.cod_taquilla AND
					agencia.cod_agencia = taquilla.cod_agencia AND
					taquilla.cod_taquilla = usuario.cod_taquilla AND usuario.tip_usuario = 'C' AND
      ...
      <table class="table">
        <thead class="thead-dark">
          <tr>
            ...
            <th scope="col">Apostador</BR>Fecha</BR>Registro #</th>
