...
$query_Recordset6 = sprintf("/* PARSEADORES1 apostador\internacionalesc3.php - QUERY 1 */ SELECT 
	tp.est_venta_ame
...
$query_Recordset4 = "/* PARSEADORES1 apostador\internacionalesc3.php - QUERY 2 */ SELECT * FROM mensaje WHERE cod_mensaje = 1";
...
$query_Recordset5 = sprintf(
    "
/* PARSEADORES1 apostador\internacionalesc3.php - QUERY 3 */ SELECT * FROM usuario, taquilla, taquilla_opc_ame, agencia,
			banca
...
$query_Recordset7 = sprintf("/* PARSEADORES1 apostador\internacionalesc3.php - QUERY 4 */ SELECT * FROM ctrol_ventpag_global_ame WHERE cod_ctrol_ventpag_global_ame =1");
...
$query_Recordset44 = sprintf("/* PARSEADORES1 apostador\internacionalesc3.php - QUERY 5 */ SELECT 
	me.mensaje
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 apostador\internacionalesc3.php - QUERY 6 */ SELECT 
* FROM 
carrera 
WHERE 
