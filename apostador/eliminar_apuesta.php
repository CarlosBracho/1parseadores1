...
if (isset($_POST["ticket"]) && isset($_POST["id_usuario"])) {
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 apostador\eliminar_apuesta.php - QUERY 1 */ SELECT 
ve.cod_taquilla,
ve.est_ticket, 
ve.efectivoO,
ve.mon_venta,
...
ca.hor_carrera 
    ...
    if ($row_Recordset1['est_ticket']!=0 && $row_Recordset1['hor_carrera']>=$horasistema && $row_Recordset1['est_carrera']==1) {
        $query_Recordset3 = sprintf("/* PARSEADORES1 apostador\eliminar_apuesta.php - QUERY 2 */ SELECT num_ticket, mon_venta
FROM venta ve 
WHERE  ve.ticket = %s", GetSQLValueString($_POST["ticket"], "int"));
        ...
        if ($totalRows_Recordset3>0) {
            ...
            do {
                ...
                $updateSQL = sprintf(
                    "/* PARSEADORES1 apostador\eliminar_apuesta.php - QUERY 3 */ UPDATE venta 
                ...
                $query_Recordset13 = sprintf(
                    "/* PARSEADORES1 apostador\eliminar_apuesta.php - QUERY 4 */ SELECT MAX(Idbalancecli) 
                ...
                $query_Recordset14 = sprintf(
                    "/* PARSEADORES1 apostador\eliminar_apuesta.php - QUERY 5 */ SELECT saldoactualc
					FROM balanceclientes
					WHERE monedac = %s AND
					Idbalancecli = %s",
                    GetSQLValueString($row_Recordset1['efectivoO'], "int"),
                ...
                $query_Recordset15 = sprintf(
                    "/* PARSEADORES1 apostador\eliminar_apuesta.php - QUERY 6 */ SELECT 
...
GROUP BY ve.num_ticket DESC LIMIT 1",
                ...
                $insertSQL155 = sprintf(
                    "/* PARSEADORES1 apostador\eliminar_apuesta.php - QUERY 7 */ INSERT INTO balanceclientes  
