...
if (isset($_POST['telefono1'])) {
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 apostador\editarapostadoraa.php - QUERY 1 */ UPDATE taquilla 
    ...
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 apostador\editarapostadoraa.php - QUERY 2 */ UPDATE usuario 
				SET
				nom_usuario=%s,
				pas_usuario=%s,
				hor_inicio=%s,
    ...
    $insertSQL2 = sprintf(
        "/* PARSEADORES1 apostador\editarapostadoraa.php - QUERY 3 */ UPDATE taquilla_opc_ame
					SET
					apu_maxgan=%s, 
					apu_maxpla=%s, 
					apu_maxsho=%s, 
    ...
    $query_Recordset1 =  sprintf(
        "/* PARSEADORES1 apostador\editarapostadoraa.php - QUERY 4 */ SELECT  
*
		...
		<div class="container">
			...
			<form class="form-horizontal" name="form1" method="POST" action="<?php echo $editFormAction; ?>" onsubmit="return chequearEnvio();">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="nom_usuario" name="nom_usuario" value="<?php echo$row_Recordset1['nom_usuario']; ?>" placeholder="Nombre De Usuario"  
...
maxlength="30" pattern="[A-Z a-z0-9]{4,30}" onKeyUp="return handleEnter(this, event)" onclick="ocultaDiv('Info32');"
				...
				<div class="form-group">
<label for="24hr" class="col-sm-8 control-label">TRABAJAR LAS 24 HORAS (Si esta activo se desactivara el formado de Inicio y Cierre de Ventas en taquilla)</label>
<div class="col-sm-4">
<select name="24hr" style="width:140px; height: auto" class="textbox" tabindex="4"> 
    ...
    echo "SELECTED";
				...
				<div class="form-group">
					<label for="telefono" class="col-sm-8 control-label">Hora de Inicio</label>
					<div class="col-sm-4">
					<td>
				...
				<div class="form-group">
					<label for="telefono" class="col-sm-8 control-label">Hora de Cierre</label>
					<div class="col-sm-4">
					<td>
		  ...
		  <input type="hidden" name="cod_taopcame" value="<?php echo $row_Recordset1['cod_taopcame']; ?>"/>
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<a href="listaapostadoraa.php" class="btn btn-default">Regresar</a>
