...
if (!isset($_SESSION['MM_id_usuario'])) {
    ...
    $id_usuarioO=0;
                            ...
                            $query_Recordset13 = sprintf(
                                "/* PARSEADORES1 apostador\saldocliente.php - QUERY 1 */ SELECT cod_taquilla
					FROM usuario
					WHERE
					id_usuario = %s",
    ...
    $totalRows_Recordset13 = mysqli_num_rows($Recordset13);
                            ...
                            $query_Recordset14 = sprintf(
                                "/* PARSEADORES1 apostador\saldocliente.php - QUERY 2 */ SELECT saldoactualc, Idbalancecli
    ...
    $totalRows_Recordset14 = mysqli_num_rows($Recordset14);
                                $query_Recordset15 = sprintf(
                                    "/* PARSEADORES1 apostador\saldocliente.php - QUERY 3 */ SELECT saldoactualc, Idbalancecli
					FROM balanceclientes
					WHERE monedac = 3 AND
    ...
    $totalRows_Recordset15 = mysqli_num_rows($Recordset15);
                                $query_Recordset16 = sprintf(
                                    "/* PARSEADORES1 apostador\saldocliente.php - QUERY 4 */ SELECT saldoactualc, Idbalancecli
					FROM balanceclientes
					WHERE monedac = 4 AND
					cod_taquilla = %s ORDER BY Idbalancecli DESC LIMIT 1",
                                    GetSQLValueString($row_Recordset13['cod_taquilla'], "int")
    ...
    $totalRows_Recordset16 = mysqli_num_rows($Recordset16);
                                $query_Recordset17 = sprintf(
                                    "/* PARSEADORES1 apostador\saldocliente.php - QUERY 5 */ SELECT saldoactualc, Idbalancecli
					FROM balanceclientes
					WHERE monedac = 5 AND
					cod_taquilla = %s ORDER BY Idbalancecli DESC LIMIT 1",
                                    GetSQLValueString($row_Recordset13['cod_taquilla'], "int")
