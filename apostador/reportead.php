...
if (isset($_GET["recordID"])) {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 apostador\reportead.php - QUERY 1 */ SELECT *
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 apostador\reportead.php - QUERY 2 */ SELECT *
					FROM balanceclientes, taquilla, agencia, banca, usuario
					WHERE
					taquilla.cod_taquilla = balanceclientes.cod_taquilla AND
