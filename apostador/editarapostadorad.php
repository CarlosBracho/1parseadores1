...
if (isset($_POST['telefono1'])) {
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 apostador\editarapostadorad.php - QUERY 1 */ UPDATE taquilla 
    ...
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 apostador\editarapostadorad.php - QUERY 2 */ UPDATE usuario 
				SET
				nom_usuario=%s,
				pas_usuario=%s,
				hor_inicio=%s,
    ...
    $insertSQL2 = sprintf(
        "/* PARSEADORES1 apostador\editarapostadorad.php - QUERY 3 */ UPDATE taquilla_opc_ame
					SET
					apu_maxgan=%s, 
					apu_maxpla=%s, 
					apu_maxsho=%s, 
    ...
    $query_Recordset1 =  sprintf(
        "/* PARSEADORES1 apostador\editarapostadorad.php - QUERY 4 */ SELECT  
*
