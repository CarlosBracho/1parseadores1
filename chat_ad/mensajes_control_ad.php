...
/* PARSEADORES1 chat_ad\mensajes_control_ad.php - QUERY 1 */ SELECT 
	us.nom_usuario,
	us.tip_usuario,
	CASE us.tip_usuario
		WHEN 'G' THEN 'Agente'
	...
	END AS tipo,
	CASE us.tip_usuario
		WHEN 'G' THEN (/* PARSEADORES1 chat_ad\mensajes_control_ad.php - QUERY 2 */ SELECT nom_agencia FROM agencia ag WHERE ag.cod_agencia=us.cod_taquilla LIMIT 1)
		WHEN 'D' THEN (/* PARSEADORES1 chat_ad\mensajes_control_ad.php - QUERY 3 */ SELECT nom_banca FROM banca ba WHERE ba.cod_banca=us.cod_taquilla LIMIT 1)
	END AS nombre
FROM usuario us
