...
set_time_limit(0);
$query_Recordset1 = sprintf("/* PARSEADORES1 pasar_datos.php - QUERY 1 */ SELECT 
...
WHERE tp.por_taquilla > 0 AND tp.cod_taquilla=ta.cod_taquilla LIMIT 99999");
    ...
    do {
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 pasar_datos.php - QUERY 2 */ UPDATE taquilla SET taq_por_ame=%s
...
?>
<?php
$query_Recordset2 = sprintf("/* PARSEADORES1 pasar_datos.php - QUERY 3 */ SELECT 
...
WHERE tpn.cob_taquilla_hnac > 0 AND tpn.cod_taquilla = ta.cod_taquilla LIMIT 99999");
    ...
    do {
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 pasar_datos.php - QUERY 4 */ UPDATE taquilla SET taq_cob_hnac=%s
                                                          WHERE cod_taquilla=%s",
...
?>
<?php
$query_Recordset2 = sprintf("/* PARSEADORES1 pasar_datos.php - QUERY 5 */ SELECT 
...
WHERE tpn.est_taquilla_hnac > 0 AND tpn.cod_taquilla = ta.cod_taquilla LIMIT 99999");
    ...
    do {
        ...
        $updateSQL = sprintf(
            "/* PARSEADORES1 pasar_datos.php - QUERY 6 */ UPDATE taquilla SET taq_vende_hnac=%s
                                                          WHERE cod_taquilla=%s",
