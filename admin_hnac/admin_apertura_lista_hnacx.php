...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 admin_hnac\admin_apertura_lista_hnacx.php - QUERY 1 */ SELECT 
...
if ($totalRows_Recordset1>0) {
    $query_Recordset2 = sprintf(
        "/* PARSEADORES1 admin_hnac\admin_apertura_lista_hnacx.php - QUERY 2 */ SELECT dv.cod_dividendo_macu, dv.div_pago_macu
		FROM 
...
$query_Recordset3 = sprintf("/* PARSEADORES1 admin_hnac\admin_apertura_lista_hnacx.php - QUERY 3 */ SELECT * FROM ctrol_ventpag_global_hnac WHERE cod_ctrol_ventpag_global_hnac = 1");
