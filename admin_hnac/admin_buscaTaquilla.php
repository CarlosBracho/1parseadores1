...
if (isset($_GET["ag"])&&isset($_GET["ta"])&&isset($_GET["ti"])) {
    ...
    if ($_GET["ti"]==1) {
        ...
        $query_Recordset1 = sprintf(
            "/* PARSEADORES1 admin_hnac\admin_buscaTaquilla.php - QUERY 1 */ SELECT
        ...
        if ($totalRows_Recordset1>0) {
            ...
            $query_Recordset2 = sprintf(
                "/* PARSEADORES1 admin_hnac\admin_buscaTaquilla.php - QUERY 2 */ SELECT
				ta.nom_taquilla, 
    ...
    elseif ($_GET["ti"]==2) {
        ...
        if ($_GET["ta"]!="todas") {
            $query_Recordset2 = sprintf(
                "/* PARSEADORES1 admin_hnac\admin_buscaTaquilla.php - QUERY 3 */ SELECT
				ta.nom_taquilla,
            ...
            $query_Recordset2 = sprintf(
                "/* PARSEADORES1 admin_hnac\admin_buscaTaquilla.php - QUERY 4 */ SELECT
				ta.nom_taquilla,
				ins.cod_inscrito_hnac,
				ins.nom_caballo_hnac,
				ins.num_caballo_hnac,
    ...
    elseif ($_GET["ti"]==3&&isset($_GET["ca"])) {
        ...
        if ($_GET["ta"]!="todas"&&$_GET["ca"]!="todas") {
            $resultado="No hay registros";
            $query_Recordset2 = sprintf(
                "/* PARSEADORES1 admin_hnac\admin_buscaTaquilla.php - QUERY 5 */ SELECT
				ta.nom_taquilla, 
				ins.cod_inscrito_hnac, ins.nom_caballo_hnac, ins.num_caballo_hnac,
				ca.num_carrera_hnac, ca.cod_carrera_hnac,
				pr.max_eje_hnac, pr.max_jug_hnac, pr.min_jug_hnac, pr.pre_fijo_hnac, pr.id_pfijo_hnac
            ...
            $resultado="No hay registros";
            $query_Recordset2 = sprintf(
                "/* PARSEADORES1 admin_hnac\admin_buscaTaquilla.php - QUERY 6 */ SELECT
				ta.nom_taquilla,
				ins.cod_inscrito_hnac,
				ins.nom_caballo_hnac,
				ins.num_caballo_hnac,
            ...
            $resultado="No hay registros";
            $query_Recordset2 = sprintf(
                "/* PARSEADORES1 admin_hnac\admin_buscaTaquilla.php - QUERY 7 */ SELECT
				ta.nom_taquilla,
				ins.cod_inscrito_hnac,
				ins.nom_caballo_hnac,
				ins.num_caballo_hnac,
            ...
            $resultado="No hay registros";
            $query_Recordset2 = sprintf(
                "/* PARSEADORES1 admin_hnac\admin_buscaTaquilla.php - QUERY 8 */ SELECT
				ta.nom_taquilla, 
				ins.cod_inscrito_hnac, ins.nom_caballo_hnac, ins.num_caballo_hnac,
				ca.num_carrera_hnac, ca.cod_carrera_hnac,
				pr.max_eje_hnac, pr.max_jug_hnac, pr.min_jug_hnac, pr.pre_fijo_hnac, pr.id_pfijo_hnac
