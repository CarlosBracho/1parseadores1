...
$query_Recordset1 = "/* PARSEADORES1 admin_hnac\admin_usuarios_ve_lista_hnac.php - QUERY 1 */ SELECT * FROM usuario WHERE tip_usuario='U' ORDER BY usuario.nom_usuario ASC";
