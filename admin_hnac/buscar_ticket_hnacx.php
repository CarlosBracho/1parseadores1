...
if (isset($_GET["numeroticketreset"])) {
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 admin_hnac\buscar_ticket_hnacx.php - QUERY 1 */ UPDATE venta_hnac
    SET
    est_ticket_hnac= 1,
    est_calculo_hnac= 0
    WHERE ticket_hnac=%s",
...
$(function(){
	$("#buttonverde").click(function(){
		if (document.getElementById('pagarT').value!="") {
			var url = '../includes/busca_jugada_hnacx.php';
...
<body style="margin: 0px">
	<div style="background:#0E5157; width:100%; float:left; padding:50px 0px 2px 0px;
   		color:#FFF; font-size:28px; text-align:center">
       BUSCAR TICKET NACIONALES
	</div>
