...
$query_Recordset3 =  sprintf(
    "/* PARSEADORES1 admin_hnac\admin_taquillas_edit_hnac.php - QUERY 1 */ SELECT * FROM taquilla_opc_hnac 
...
$query_Recordset11 =  sprintf(
    "/* PARSEADORES1 admin_hnac\admin_taquillas_edit_hnac.php - QUERY 2 */ SELECT  
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 admin_hnac\admin_taquillas_edit_hnac.php - QUERY 3 */ UPDATE taquilla 
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 admin_hnac\admin_taquillas_edit_hnac.php - QUERY 6 */ SELECT  
	taquilla.nom_taquilla,
...
$query_Recordset2 =  sprintf(
    "/* PARSEADORES1 admin_hnac\admin_taquillas_edit_hnac.php - QUERY 7 */ SELECT * FROM taquilla_opc_hnac 
	WHERE cod_taquilla = %s",
    GetSQLValueString($xCodigo, "int")
);
...
if ($totalRows_Recordset2==0 && (!isset($_POST["MM_insert2"]))) {
    ...
    if ((isset($_POST["MM_insert2"])) && ($_POST["MM_insert2"] == "form2")) {
        if (isset($_POST["exp_agencia"]) && $_POST["exp_agencia"]>0) {
            ...
            $query_Recordset2 =  sprintf(
                "/* PARSEADORES1 admin_hnac\admin_taquillas_edit_hnac.php - QUERY 8 */ SELECT * 
				FROM  
				taquilla_opc_hnac 
				WHERE 
				cod_taquilla = %s",
...
$has=50;
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 admin_hnac\admin_taquillas_edit_hnac.php - QUERY 9 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
              ...
              style="background:#0E5157;color:#FFF; font-size:10px; line-height:11px">
                ...
                <td rowspan="2" align="center" valign="top" style="font-size:9px">
                  ...
                  <tr>
                    ...
                    <td align="center" valign="top">
                      <select name="pre_fijo_hnac" style="width:50px; height: 39px" class="textbox">
                        <option value="1" 
