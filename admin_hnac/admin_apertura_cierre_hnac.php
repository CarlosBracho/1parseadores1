...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 admin_hnac\admin_apertura_cierre_hnac.php - QUERY 1 */ SELECT 
...
if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $mtp_control=0;
  $updateSQL = sprintf(
      "/* PARSEADORES1 admin_hnac\admin_apertura_cierre_hnac.php - QUERY 2 */ UPDATE 
  			carrera_hnac 
			SET 
			est_carrera_hnac=%s, 
			est_cierre_hnac=%s, 
  ...
  $insertSQL2 = sprintf(
      "/* PARSEADORES1 admin_hnac\admin_apertura_cierre_hnac.php - QUERY 3 */ INSERT 
					INTO bitacora 
