...
$query_Recordset4 = sprintf("/* PARSEADORES1 admin_hnac\agente_reporte_general_hnac.php - QUERY 1 */ SELECT cod_banca FROM agencia 
        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_taquilla']!="todos") {
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 admin_hnac\agente_reporte_general_hnac.php - QUERY 2 */ SELECT
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && $_POST['id_taquilla']=="todos") ||
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 admin_hnac\agente_reporte_general_hnac.php - QUERY 3 */ SELECT
		ag.por_agencia_hnac, ag.nom_agencia, ta.nom_taquilla, tp.por_alquiler_hanc,
		SUM(CASE WHEN veN.fec_venta_hnac >= %s AND veN.fec_venta_hnac <= %s 
			THEN veN.mon_venta_hnac ELSE 0 END) AS total_ventaN,
		SUM(CASE WHEN veN.est_ticket_hnac = 2 AND veN.fec_pago_hnac >= %s AND veN.fec_pago_hnac <= %s 
...
$query_Recordset2 = sprintf("/* PARSEADORES1 admin_hnac\agente_reporte_general_hnac.php - QUERY 4 */ SELECT cod_taquilla, nom_taquilla FROM taquilla 
...
$query_Recordset3 = sprintf("/* PARSEADORES1 admin_hnac\agente_reporte_general_hnac.php - QUERY 5 */ SELECT info1,info11,info2,info22,info3,info33,info4,info44,info5,info55 FROM banca 
