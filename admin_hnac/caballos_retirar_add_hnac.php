...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 admin_hnac\caballos_retirar_add_hnac.php - QUERY 1 */ SELECT * 
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    $insertSQL1 = sprintf(
        "/* PARSEADORES1 admin_hnac\caballos_retirar_add_hnac.php - QUERY 2 */ UPDATE inscritos 
			SET
			est_inscrito_hnac=%s 
			WHERE 
			cod_inscrito_hnac=%s",
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 admin_hnac\caballos_retirar_add_hnac.php - QUERY 3 */ SELECT * 
