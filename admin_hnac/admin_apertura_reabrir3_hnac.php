...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 admin_hnac\admin_apertura_reabrir3_hnac.php - QUERY 1 */ SELECT 
...
$mtp_control=0;
$updateSQL = sprintf(
    "/* PARSEADORES1 admin_hnac\admin_apertura_reabrir3_hnac.php - QUERY 2 */ UPDATE 
			carrera_hnac 
			SET 
			hor_carrera_hnac=%s, 
			hor_carrera_hnac=%s, 
...
$insertSQL2 = sprintf(
    "/* PARSEADORES1 admin_hnac\admin_apertura_reabrir3_hnac.php - QUERY 3 */ INSERT 
				INTO bitacora 
