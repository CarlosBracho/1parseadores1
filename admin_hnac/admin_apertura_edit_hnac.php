...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 admin_hnac\admin_apertura_edit_hnac.php - QUERY 1 */ SELECT 
		ca.cod_carrera_hnac,
		ca.fec_carrera_hnac,
		ca.hor_carrera_hnac,
		ca.cod_carrera_hnac,
...
$query_Recordset2 = sprintf(
    "/* PARSEADORES1 admin_hnac\admin_apertura_edit_hnac.php - QUERY 2 */ SELECT 
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($estado==0) {
        $updateSQL = sprintf(
            "/* PARSEADORES1 admin_hnac\admin_apertura_edit_hnac.php - QUERY 3 */ UPDATE carrera_hnac SET 
				hor_carrera_hnac=%s, 
				num_carrera_hnac=%s, 
				can_caballos_hnac=%s, 
				est_carrera_hnac=%s 
        ...
        if ($_POST['can_caballos']!=$_POST['caballos']) {
            $query_Recordset3 = sprintf(
                "/* PARSEADORES1 admin_hnac\admin_apertura_edit_hnac.php - QUERY 4 */ SELECT 
					ito.cod_inscrito_hnac,
					ito.num_caballo_hnac
					FROM 
						inscritos ito 
            ...
            if ($_POST['can_caballos']>$_POST['caballos']) {//agregar
                for ($x = $totalRows_Recordset3+1;  $x <= $_POST['can_caballos']; $x++) {	//guarda los ejemplares
                    $insertSQL2 = sprintf(
                        "/* PARSEADORES1 admin_hnac\admin_apertura_edit_hnac.php - QUERY 5 */ INSERT INTO inscritos 
					(cod_carrera_hnac, 
					num_caballo_hnac, 
					nom_caballo_hnac, 
					nom_jinete_hnac, 
            ...
            if ($_POST['can_caballos']<$_POST['caballos']) {//eliminar
                $deleteSQL = sprintf(
                    "/* PARSEADORES1 admin_hnac\admin_apertura_edit_hnac.php - QUERY 6 */ DELETE 
					FROM inscritos 
        ...
        $updateGoTo = "admin_apertura_edit_hnac.php";
        if (isset($_SERVER['QUERY_STRING'])) {
...
<?php ?>       <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background:#CCC">
          <tr>
            <td width="45%" height="76" align="center" valign="bottom">
            ...
            <!--<td width="45%" align="left" valign="bottom">
                <button onclick="location.href='admin_apertura_lista_hnac.php'" class="btn-danger"
