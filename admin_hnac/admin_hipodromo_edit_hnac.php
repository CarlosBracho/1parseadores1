...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 admin_hnac\admin_hipodromo_edit_hnac.php - QUERY 1 */ UPDATE hipodromo_hnac SET
...
$query_Recordset1 =  sprintf(
    "/* PARSEADORES1 admin_hnac\admin_hipodromo_edit_hnac.php - QUERY 2 */ SELECT *
	FROM  
	hipodromo_hnac
	WHERE 
