...
function guardaBD($fec, $car, $cab, $div, $fac, $lin, $tip, $emp)
{
    ...
    $insertSQL = sprintf(
        "/* PARSEADORES1 admin_hnac\admin_hnac\admin_dividendos_edit_hnac.php - QUERY 1 */ INSERT 
...
function modifiBD($id, $cab, $div, $fac, $emp)
{
    ...
    global $conexionbanca;
    $insertSQL2 = sprintf(
        "/* PARSEADORES1 admin_hnac\admin_hnac\admin_dividendos_edit_hnac.php - QUERY 2 */ UPDATE resultados_oficiales_hnac SET
			fac_div_hnac=%s,
			num_caballo_hnac=%s,
			div_pago_hnac=%s,
			est_empate_hnac=%s
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if (isset($a) && $a==1) {
        ...
        $query_Recordset10 = sprintf(
            "/* PARSEADORES1 admin_hnac\admin_hnac\admin_dividendos_edit_hnac.php - QUERY 3 */ SELECT hi.nom_hipodromo_hnac, ca.num_carrera_hnac, hi.cod_hipodromo_hnac,
		ca.fec_carrera_hnac 
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 admin_hnac\admin_hnac\admin_dividendos_edit_hnac.php - QUERY 4 */ SELECT hi.nom_hipodromo_hnac, ca.cod_carrera_hnac, ca.num_carrera_hnac, ca.fec_carrera_hnac,
