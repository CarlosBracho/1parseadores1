...
<script src="../js/jquery-3.5.1.min.js"></script>
 ...
 $(document).ready(function() {
	 $("#saldocliente").load('../apostador/saldoapostador.php?&js='+Math.random());
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="../apostador/internacionalesa.php">Apostar Hipismo Internacional<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
