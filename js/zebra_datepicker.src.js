                ...
                if (regexp.length) {
                    ...
                    if ((segments = regexp.exec(str_date))) {
                        ...
                        var tmpdate = new Date(),
                            ...
                            english_days   = ['Domingo','Lunes','Martes','Miercoles','Jueves','Viernes','Sabado'],
                            english_months = ['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'],
                            iterable,
