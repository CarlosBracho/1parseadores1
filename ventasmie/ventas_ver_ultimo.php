...
$query_Recordset2 = sprintf("/* PARSEADORES1 ventasmie\ventas_ver_ultimo.php - QUERY 1 */ SELECT ticket FROM venta 
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 ventasmie\ventas_ver_ultimo.php - QUERY 2 */ SELECT 
venta.fec_venta, 
venta.hor_venta,
venta.ser_venta,
venta.cod_cliente,
