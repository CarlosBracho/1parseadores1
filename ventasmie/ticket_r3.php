...
if (!isset($_SESSION)) {
    session_start();
            ...
            <th colspan="4" class="imprimir" scope="col"><?php echo $row_Recordset1['nom_taquilla']; ?>-COPI3-#:<?php echo $row_Recordset1['can_ticket']; ?>
</th>
          </tr>
          <br/><tr>
            <td colspan="4" align="center" class="imprimir"><?php echo fechanueva($row_Recordset1['fec_venta']); ?>-<?php
...
?></td>
          ...
          <br/><tr>
            <td colspan="4" align="center" class="imprimircod">Cod: <?php echo $rest; ?></td>
          </tr>
          <br/><tr>
