...
function ObtenerMontoEjeTaq($codT, $fecV, $numE, $codC, $codA)
{
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 ventasmie\t_grabajugadahipicoticket.php - QUERY 1 */ SELECT 
...
$query_Recordset7 = sprintf("/* PARSEADORES1 ventasmie\t_grabajugadahipicoticket.php - QUERY 2 */ SELECT est_control_ventas_ame FROM ctrol_ventpag_global_ame WHERE cod_ctrol_ventpag_global_ame = 1");
...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1" && isset($_POST["cod_carrera"]) && $_POST["cod_carrera"]!=-1 && $est_control_ventas==0) {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 ventasmie\t_grabajugadahipicoticket.php - QUERY 3 */ SELECT can_caballos, hor_carrera, fec_carrera, est_carrera, pau_ventas
								 FROM carrera
								 WHERE cod_carrera = %s 
								 LIMIT 1",
    ...
    if ($exito==1 && $pau_ventas==0) {// guarda e imprime ticket
        ...
        if ($valida==1 && $pau_ventas==0) {
            ...
            $query_Recordset55 = sprintf(
                "
/* PARSEADORES1 ventasmie\t_grabajugadahipicoticket.php - QUERY 4 */ SELECT 
...
tasadecambio.Idtasadecambio = %s",
        ...
        if ($valida==1 && $pau_ventas==0) {
            ...
            foreach ($apuesta as $apta) {
                ...
                $insertSQL = sprintf(
                    "/* PARSEADORES1 ventasmie\t_grabajugadahipicoticket.php - QUERY 5 */ INSERT INTO venta (ser_venta, ticket, cod_taquilla, fec_venta, hor_venta, cod_tventa,
                ...
                if ($tipo_pago==1) {
                    $insertSQL15 = sprintf(
                        "/* PARSEADORES1 ventasmie\t_grabajugadahipicoticket.php - QUERY 6 */ UPDATE taquilla 
				SET
                ...
                if ($tipo_pagoa==1) {
                    $insertSQL155 = sprintf(
                        "/* PARSEADORES1 ventasmie\t_grabajugadahipicoticket.php - QUERY 7 */ UPDATE agencia 
				SET
