...
$DAMG=$_SESSION['MM_id_usuario'];
include("index_datos_prueba.php");
...
<?php
                ...
                <div id="derecha" style="font-size:16px;width:39%;float:left; background:#e0e0e0;height:386px;
                    margin:0px 0px 0px 2px; color:#000">
                    <!-- diego pizzarra --> 
					<div id="men_pagar" style="font-size:12px; background: #333;width:100%; float:left; height:180px; 
                    ...
                    <div id="men_pagar" style="font-size:12px; background: #333;width:99.3%; float:left; height:12px; 
					...
					<div id="men_pagar" style="font-size:10px; background: #333;width:99.3%; float:left; height:33px; 
						text-align: left; padding:1px 0px 0px 3px; color: #FFF;border-bottom: 1px black solid;">
						<?php include("ventas_ver_ultimo.php");?>
					</div><!-- end .men_pagar --> 
					<div id="men_pagar" style="font-size:15px; background: #333;width:99.3%; float:left; height:20px; 
						text-align:center; padding:15px 0px 0px 3px; color: #FFF">
						PAGAR/ELIMINAR APUESTA
					</div><!-- end .men_pagar -->


                    <div id="pagarapuesta" style="font-size:16px; width:99.3%; height:40px; float:left; text-align:center; 
                        padding:5px 0px 0px 3px;">
                        <form method="post" id="form2">
							<div id="pagTicket" style="height:40px; width:97%; float:left; padding:0px 0px 0px 0px ">
							...
							<div id="eliTicket" style="height:15px; width:97%; float:left; padding:0px 0px 0px 0px "><br>
 ...
 <div id="mensajeChat" style="font-size:16px; height:177px; width:100%; float:left; 
                    ...
                    font-size:13px; line-height:10px;">
                        ...
                        <div id="Chat" style="font-size:11px; height:90px; width:45.85%; float:left; text-align:left; 
						...
						<div id="enviarChat" style="font-size:18px; height:260px; width:90%; float:left; text-align:left; 
								...
								<input name="enviarChatBoton" type="button" id="enviarChatBoton" 
                                    style="height:45px; background: #CCC; border-color:#CCC; color: #333; font-size:14px; height:50px; border-top: 1px solid #888;"
                                    tabindex="<?php echo $x;?>" 
                                    value="ENVIAR"/>
                            </div><!-- end .Chat -->
