...
function pizActualame(carrera) {
	if (carrera.value>0){
		...
		$.ajax({ data:parametros, url:'pizarra_actual_ame_prueba.php', type:'post', cache: 'false', global : false,
 ...
 <?php
                ...
                <div id="derecha" style="font-size:16px;width:39%;float:left; background:#e0e0e0;height:386px;
                    ...
                    <div id="impPiza" style="width:100%; height:300px">
                    	<?php include("pizarra_actual_ame_prueba.php");?>
					</div>
					</div><!-- diego pizzarra --> 
                    ...
                    <div id="pagarapuesta" style="font-size:16px; width:99.3%; height:50px; float:left; text-align:center; 
                        padding:5px 0px 0px 3px;">
                        <form method="post" id="form2">
							<div id="pagTicket" style="height:15px; width:97%; float:left; padding:5px 0px 0px 0px ">
							...
							<div id="eliTicket" style="height:15px; width:97%; float:left; padding:20px 0px 0px 0px "><br>
