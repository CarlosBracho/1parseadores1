...
if (isset($_POST["MM_insert12"]) && isset($_POST["MM_insert12"])) {
    if (isset($_POST["aceptar"]) or isset($_POST["generar"])) {
        ...
        $query_Recordset19 = sprintf(
            "/* PARSEADORES1 ventasmie\rapuesta_codigo_clientes.php - QUERY 1 */ SELECT can_caballos, hor_carrera, fec_carrera, est_carrera, pau_ventas, 
        ...
        if ((isset($_POST["cod_cliente"])&&$_POST["cod_cliente"]!="") or (isset($_POST["generar"])&&$_POST["tra_codigo"]==2)
            ...
            if ($fueHor==1 && $fueFec==1) {
                ...
                foreach ($apuesta as $apta) {
                    $yu=$f+1;
                    $insertSQL = sprintf(
                        "/* PARSEADORES1 ventasmie\rapuesta_codigo_clientes.php - QUERY 2 */ INSERT INTO venta (ser_venta, ticket, cod_cliente, cod_taquilla, fec_venta, hor_venta,
                    ...
                    $query_Recordset55 = sprintf(
                        "
/* PARSEADORES1 ventasmie\rapuesta_codigo_clientes.php - QUERY 3 */ SELECT 
...
tasadecambio.Idtasadecambio = %s",
                    ...
                    if ($tipo_pago==1) {
                        $insertSQL15 = sprintf(
                            "/* PARSEADORES1 ventasmie\rapuesta_codigo_clientes.php - QUERY 4 */ UPDATE taquilla 
				SET
				...
				cod_taquilla=%s",
                    ...
                    if ($tipo_pagoa==1) {
                        $insertSQL15 = sprintf(
                            "/* PARSEADORES1 ventasmie\rapuesta_codigo_clientes.php - QUERY 5 */ UPDATE agencia 
				SET
    ...
    function ObtenerMontoEjeTaq($codT, $fecV, $numE, $codC, $codA)
    {
        ...
        $query_Recordset20 = sprintf(
            "/* PARSEADORES1 ventasmie\rapuesta_codigo_clientes.php - QUERY 6 */ SELECT 
    ...
    if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1" && isset($_POST["cod_carrera"]) && $_POST["cod_carrera"]!=-1 &&
        ...
        $numerotiket2="";
        $query_Recordset19 = sprintf(
            "/* PARSEADORES1 ventasmie\rapuesta_codigo_clientes.php - QUERY 7 */ SELECT can_caballos, hor_carrera, fec_carrera, est_carrera, pau_ventas, 
				num_carrera, nom_hipodromo, cod_carrera
				FROM carrera
				WHERE cod_carrera = %s 
				 LIMIT 1",
    ...
    //****************************************************************************************************************************
        if ($exito==1 && $maxCa!=1 && $pau_ventas==0) {// guarda e imprime ticket
            ...
            $query_Recordset18 = sprintf(
                "/* PARSEADORES1 ventasmie\rapuesta_codigo_clientes.php - QUERY 8 */ SELECT
            ...
            if ($valida==1) {
                ...
                foreach ($apuesta as $busca) {  //busca exceso o minimos de montos
                    ...
                    $query_Recordset55 = sprintf(
                        "
/* PARSEADORES1 ventasmie\rapuesta_codigo_clientes.php - QUERY 9 */ SELECT 
tasadecambio.usdabss, tasadecambio.copabss, tasadecambio.solabss, 
agencia.tipo_pagoa, agencia.saldoactuala,
taquilla.tipo_pago, taquilla.saldoactual
FROM 
...
tasadecambio.Idtasadecambio = %s",
                ...
                $query_Recordset55 = sprintf(
                    "
/* PARSEADORES1 ventasmie\rapuesta_codigo_clientes.php - QUERY 10 */ SELECT 
tasadecambio.usdabss, tasadecambio.copabss, tasadecambio.solabss, 
agencia.tipo_pagoa, agencia.saldoactuala,
taquilla.tipo_pago, taquilla.saldoactual
FROM 
...
$query_Recordset115 = sprintf(
    "/* PARSEADORES1 ventasmie\rapuesta_codigo_clientes.php - QUERY 11 */ SELECT ve.cod_cliente 
		FROM 
			usuario us, 
			taquilla ta, 
			venta ve 
