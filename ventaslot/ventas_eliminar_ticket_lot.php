...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 ventaslot\ventas_eliminar_ticket_lot.php - QUERY 1 */ SELECT ve.ticket_lot, ve.ser_ticket_lot, tp.pag_codigo_lot
	FROM 
		venta_lot ve, 
		usuario us,
		taquilla ta, 
...
if (isset($_POST["MM_update"]) && $_POST["MM_update"] == "form1" && isset($_POST["ticket"]) && isset($_POST["uVenta"])) {
    ...
    if ($totalRows_Recordset1>0) {
        $query_Recordset1 = sprintf("/* PARSEADORES1 ventaslot\ventas_eliminar_ticket_lot.php - QUERY 2 */ SELECT us.tic_eliminados, us.cod_taquilla, tp.pag_codigo_lot
        ...
        if (BuscarTicketEliminadosLOT($_POST["uVenta"], fechaactualbd())<$row_Recordset1['tic_eliminados']) {
            $query_Recordset2 = sprintf(
                "/* PARSEADORES1 ventaslot\ventas_eliminar_ticket_lot.php - QUERY 3 */ SELECT 
				ve.est_ticket_lot, 
				ve.id_usuario,
				ve.ticket_lot, 
				ve.ser_ticket_lot,
                    ...
                    if (isset($_POST["ser_ticket_lot"]) && $_POST["ser_ticket_lot"]==$serial) {
                        if ($row_Recordset2['est_ticket_lot']==1) {
                            if ($row_Recordset2['est_cierre']==0) {
                                ...
                                $query_Recordset3 = sprintf("/* PARSEADORES1 ventaslot\ventas_eliminar_ticket_lot.php - QUERY 4 */ SELECT num_ticket_lot 
									FROM venta_lot ve 
                                ...
                                if ($totalRows_Recordset3>0) {
                                    ...
                                    do {
                                        ...
                                        $updateSQL = sprintf(
                                            "/* PARSEADORES1 ventaslot\ventas_eliminar_ticket_lot.php - QUERY 5 */ UPDATE venta_lot 
