...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 ventaslot\lista_loterias.php - QUERY 1 */ SELECT 
	lo.nom_loteria, 
	lo.tip_loteria, 
	lo.id_loteria,
	lo.let_loteria,
...
$query_Recordset3 = sprintf(
    "/* PARSEADORES1 ventaslot\lista_loterias.php - QUERY 2 */ SELECT 
...
$query_Recordset2 = "/* PARSEADORES1 ventaslot\lista_loterias.php - QUERY 3 */ SELECT id_signo, nom_corto, nom_signo FROM signos";
