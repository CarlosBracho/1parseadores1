...
$query_Recordset2 = sprintf("/* PARSEADORES1 ventaslot\ventas_reporte_resultados_lot.php - QUERY 1 */ SELECT us.nom_usuario, us.id_usuario, ta.nom_taquilla, ag.cod_agencia, ba.cod_banca, ba.mod_resultado FROM usuario us, taquilla ta, agencia ag, banca ba 
...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 ventaslot\ventas_reporte_resultados_lot.php - QUERY 2 */ SELECT 
	so.nom_sorteo, tip_loteria,
	CASE lo.tip_loteria  
		WHEN 3 THEN (/* PARSEADORES1 ventaslot\ventas_reporte_resultados_lot.php - QUERY 3 */ SELECT sor.nom_corto FROM signos sor WHERE sor.id_signo = rs.sig_resultado LIMIT 1)
		WHEN 4 THEN (/* PARSEADORES1 ventaslot\ventas_reporte_resultados_lot.php - QUERY 4 */ SELECT ani.nom_animal FROM animales ani WHERE ani.num_animal = rs.num_resultado LIMIT 1)
		WHEN 5 THEN (/* PARSEADORES1 ventaslot\ventas_reporte_resultados_lot.php - QUERY 5 */ SELECT fru.nom_fruta FROM frutas fru WHERE fru.id_fruta = rs.num_resultado LIMIT 1)
		WHEN 6 THEN (/* PARSEADORES1 ventaslot\ventas_reporte_resultados_lot.php - QUERY 6 */ SELECT pal.nom_palo FROM palos_cartas pal WHERE pal.id_palo = rs.sig_resultado LIMIT 1)
		ELSE ''
	END AS nom_signo,
	CASE lo.tip_loteria
