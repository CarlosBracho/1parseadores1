...
if (isset($_GET["id_pfijo"])) {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 agente_hnac\agente_quitarPrecioFijo.php - QUERY 1 */ SELECT
		id_pfijo_hnac 
    ...
    if ($totalRows_Recordset1>0) {
        $insertSQL1 = sprintf(
            "/* PARSEADORES1 agente_hnac\agente_quitarPrecioFijo.php - QUERY 2 */ DELETE FROM precio_fijo_hnac WHERE id_pfijo_hnac = %s",
            GetSQLValueString($_GET["id_pfijo"], "int")
        );
