...
$query_Recordset4 = sprintf("/* PARSEADORES1 agente_hnac\agente_reporte_venta_carrera_hnac.php - QUERY 1 */ SELECT cod_banca FROM agencia 
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    if (isset($_POST['fecha_inicio'])) {
        if ($_POST['fecha_inicio']!="") {
            ...
            $query_Recordset1 = sprintf(
                "/* PARSEADORES1 agente_hnac\agente_reporte_venta_carrera_hnac.php - QUERY 2 */ SELECT *
			FROM 
				carrera_hnac,
				hipodromo_hnac
			WHERE 
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 agente_hnac\agente_reporte_venta_carrera_hnac.php - QUERY 3 */ SELECT *
	FROM 
		carrera_hnac,
		hipodromo_hnac
	WHERE 
...
$query_Recordset2 = sprintf("/* PARSEADORES1 agente_hnac\agente_reporte_venta_carrera_hnac.php - QUERY 4 */ SELECT * FROM taquilla 
