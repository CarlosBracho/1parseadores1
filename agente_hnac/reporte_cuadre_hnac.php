...
$query_Recordset2 = sprintf("/* PARSEADORES1 agente_hnac\reporte_cuadre_hnac.php - QUERY 1 */ SELECT usuario.nom_usuario, usuario.id_usuario, taquilla.nom_taquilla 
    FROM usuario, taquilla, agencia, banca
	WHERE agencia.cod_agencia = %s AND tip_usuario='U' 
    AND usuario.cod_taquilla = taquilla.cod_taquilla AND
    banca.cod_banca = agencia.cod_banca AND
    taquilla.cod_agencia = agencia.cod_agencia
	ORDER BY usuario.nom_usuario", GetSQLValueString($codigoAgente, "int"));
...
$taquillaV=$row_Recordset2['nom_taquilla'];
    ...
    $query_Recordset3 = sprintf("/* PARSEADORES1 agente_hnac\reporte_cuadre_hnac.php - QUERY 2 */ SELECT nom_usuario, nom_taquilla 
    FROM usuario, taquilla, agencia 
    WHERE usuario.id_usuario = %s AND tip_usuario='U'
    AND usuario.cod_taquilla = taquilla.cod_taquilla AND
    taquilla.cod_agencia = agencia.cod_agencia
    ...
    $taquilla=$row_Recordset3['nom_taquilla'];
...
<script language="JavaScript">document.write("Microsoft Internet Explorer"==navigator.appName||GetIEVersion()>0?'<body onload="javascript:document.all.cmdPrint.focus();">':"<body>");</script>
   ...
   <div style="background:#0E5157; width:100%;float:left; padding:5px 0px 5px 0px;" id="noprint4">
		<a href="../agente/reporte_cuadre_americana.php" style="font-size:11px;margin:0px 10px 0px 0px;line-height:12px;" 
        class="btn btn-info" id="americana">Ver Cuadre de Caja <br/>Internacionales</a>   
...
<br/>DEVOLUCIONES PAGADAS:
<br/><?php echo number_format($row_Recordset81['tot_eliminad'], 2, ",", ".");?>
<br/>DINERO EN CAJA:
<br/><strong>***<?php echo number_format($NenCaja, 2, ",", ".");?>***</strong>
<?php
                  if ($row_Recordset81['ver_porpagar_hnac']==1) {?>
<br/>INVALIDADOS x PAGAR:
<br/><?php echo number_format($row_Recordset81['ret_porpagar'], 2, ",", ".");?>
<br/>CANCELADOS x PAGAR:
<br/><?php echo number_format($row_Recordset81['inv_porpagar'], 2, ",", ".");?>
<br/>PREMIOS x PAGAR:
<br/><?php echo number_format($row_Recordset81['pre_porpagar'], 2, ",", ".");?>
<?php
                  }?>
<br/>COSTO DEL SISTEMA:
<br/><?php echo number_format($NpagoSistema, 2, ",", ".");?>
<br/>PORCENTAJE A PAGAR AL:
<br/><?php echo $row_Recordset81['taq_cob_hnac']?>
<br/>TOTAL A PAGAR AL SISTEMA:
<br/><?php
$Porcentaje= 100;
 echo number_format  (($row_Recordset81['total_venta'] / $Porcentaje) * $row_Recordset900['taq_cob_hnac'], 2,",", ".") ?>
<?php }?>

<?php if ($row_Recordset900['total_venta']<>0 or $NenCaja900<>0) { ?>
...
<br/>EFECTIVO EN CAJA:
<br/><strong>***<?php echo number_format($NenCaja900, 2, ",", ".");?>***</strong>
<br/>PORCENTAJE A PAGAR AL:
<br/><?php echo $row_Recordset900['taq_cob_hnac']?>
<br/>TOTAL A PAGAR AL SISTEMA:
<br/><?php
$Porcentaje= 100;
 echo number_format  (($row_Recordset900['total_venta'] / $Porcentaje) * $row_Recordset900['taq_cob_hnac'], 2,",", ".") ?>
<?php $sihayventasn=1; } ?>

<?php if ($row_Recordset901['total_venta']<>0 or $NenCaja901<>0) { ?>
...
<br/>DEBITO EN CAJA:
<br/><strong>***<?php echo number_format($NenCaja901, 2, ",", ".");?>***</strong>
<br/>PORCENTAJE A PAGAR AL:
<br/><?php echo $row_Recordset901['taq_cob_hnac']?>
<br/>TOTAL A PAGAR AL SISTEMA:
<br/><?php
$Porcentaje= 100;
 echo number_format  (($row_Recordset901['total_venta'] / $Porcentaje) * $row_Recordset901['taq_cob_hnac'], 2,",", ".") ?>
<?php $sihayventasn=1; } ?>

<?php if ($row_Recordset902['total_venta']<>0 or $NenCaja902<>0) { ?>
...
<br/><strong>***<?php echo number_format($NenCaja902, 2, ",", ".");?>***</strong>
<br/>PORCENTAJE A PAGAR AL:
<br/><?php echo $row_Recordset902['taq_cob_hnac']?>
<br/>TOTAL A PAGAR AL SISTEMA:
<br/><?php
$Porcentaje= 100;
 echo number_format  (($row_Recordset902['total_venta'] / $Porcentaje) * $row_Recordset902['taq_cob_hnac'], 2,",", ".") ?>
<?php $sihayventasn=1; } ?>

<?php if ($row_Recordset903['total_venta']<>0 or $NenCaja903<>0) { ?>
...
<br/>DOLARES EN CAJA:
<br/><strong>***<?php echo number_format($NenCaja903, 2, ",", ".");?>***</strong>
<br/>PORCENTAJE A PAGAR AL:
<br/><?php echo $row_Recordset903['taq_cob_hnac']?>
<br/>TOTAL A PAGAR AL SISTEMA:
<br/><?php
$Porcentaje= 100;
 echo number_format  (($row_Recordset903['total_venta'] / $Porcentaje) * $row_Recordset903['taq_cob_hnac'], 2,",", ".") ?>
<?php $sihayventasn=1; } ?>

<?php if ($row_Recordset904['total_venta']<>0 or $NenCaja904<>0) { ?>
...
<br/><strong>***<?php echo number_format($NenCaja904, 2, ",", ".");?>***</strong>
<br/>PORCENTAJE A PAGAR AL:
<br/><?php echo $row_Recordset904['taq_cob_hnac']?>
<br/>TOTAL A PAGAR AL SISTEMA:
<br/><?php
$Porcentaje= 100;
 echo number_format  (($row_Recordset904['total_venta'] / $Porcentaje) * $row_Recordset904['taq_cob_hnac'], 2,",", ".") ?>
<?php $sihayventasn=1; } ?>

<?php if ($row_Recordset905['total_venta']<>0 or $NenCaja905<>0) { ?>
...
<br/>SOLES EN CAJA:
<br/><strong>***<?php echo number_format($NenCaja905, 2, ",", ".");?>***</strong>
<br/>PORCENTAJE A PAGAR AL:
<br/><?php echo $row_Recordset905['taq_cob_hnac']?>
<br/>TOTAL A PAGAR AL SISTEMA:
<br/><?php
$Porcentaje= 100;
 echo number_format  (($row_Recordset905['total_venta'] / $Porcentaje) * $row_Recordset905['taq_cob_hnac'], 2,",", ".") ?>
<?php $sihayventasn=1; } ?>

<?php if ($sihayventasn==0) { ?>
...
<?php } ?>
     ...
     <div style="background:#0E5157; width:98%; float:left; color:#FFF; text-align:right; font-size:16px; 
