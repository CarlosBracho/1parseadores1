        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_distribuidor']!="todos") {
                $query_Recordset10 = sprintf(
                    "/* PARSEADORES1 agente_hnac\admin_reporte_cobranza_hnac.php - QUERY 1 */ SELECT cod_banca, nom_banca, tel_banca, cor_banca, por_banca_hnac 
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && $_POST['id_distribuidor']=="todos") ||
    ...
    $query_Recordset10 = sprintf("/* PARSEADORES1 agente_hnac\admin_reporte_cobranza_hnac.php - QUERY 2 */ SELECT cod_banca, nom_banca, tel_banca, cor_banca, por_banca_hnac FROM banca");
    $v=0;
}
...
$query_Recordset2 = sprintf("/* PARSEADORES1 agente_hnac\admin_reporte_cobranza_hnac.php - QUERY 3 */ SELECT cod_taquilla, nom_taquilla FROM taquilla ORDER BY nom_taquilla ASC");
           ...
           if ($totalRows_Recordset10>0) {
               do {
                   ...
                   $query_Recordset3 = sprintf(
                       "/* PARSEADORES1 agente_hnac\admin_reporte_cobranza_hnac.php - QUERY 4 */ SELECT cod_agencia, nom_agencia, por_agencia_hnac
                   ...
                   if ($totalRows_Recordset3>0) {
                       do {
                           ...
                           $query_Recordset1 = sprintf(
                               "/* PARSEADORES1 agente_hnac\admin_reporte_cobranza_hnac.php - QUERY 5 */ SELECT
							por_agencia_hnac,
