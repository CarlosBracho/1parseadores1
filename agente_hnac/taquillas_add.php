...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($graba==31) {
        $insertSQL = sprintf(
            "/* PARSEADORES1 agente_hnac\taquillas_add.php - QUERY 1 */ INSERT 
				INTO taquilla 
        ...
        $query_RecT = "/* PARSEADORES1 agente_hnac\taquillas_add.php - QUERY 2 */ SELECT cod_taquilla FROM taquilla ORDER BY cod_taquilla DESC LIMIT 1";
        ...
        $insertSQL2 = sprintf(
            "/* PARSEADORES1 agente_hnac\taquillas_add.php - QUERY 3 */ INSERT 
		INTO 
		taquilla_opc_ame 
        ...
        $insertSQL3 = sprintf(
            "/* PARSEADORES1 agente_hnac\taquillas_add.php - QUERY 4 */ INSERT 
		INTO usuario 
