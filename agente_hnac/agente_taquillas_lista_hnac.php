...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 agente_hnac\agente_taquillas_lista_hnac.php - QUERY 1 */ SELECT ta.nom_taquilla, ta.nom_representante, ta.est_taquilla, ta.cod_taquilla, ta.nom_representante 
	FROM 
	taquilla ta,
	agencia ag
