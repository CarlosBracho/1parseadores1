...
$query_Recordset1 = sprintf(
    "/* PARSEADORES1 agente_hnac\taquillas_lista.php - QUERY 1 */ SELECT taquilla.nom_taquilla, taquilla.nom_representante, taquilla.est_taquilla, taquilla.cod_taquilla 
	FROM 
	taquilla,
	agencia
