...
if (isset($_POST["MM_insert"]) && $_POST["MM_insert"]=="form1" && isset($_POST["cod_carrera"]) && $_POST["cod_carrera"]!=-1) {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 Templates\t_grabajugadahipicoticket.php - QUERY 1 */ SELECT can_caballos, hor_carrera, fec_carrera, est_carrera
								 FROM carrera
								 WHERE cod_carrera = %s 
								 LIMIT 1",
    ...
    if ($exito==1) {// guarda e imprime ticket
        ...
        if ($valida==1) {
            ...
            foreach ($apuesta as $apta) {
                $yu=$f+1;
                $insertSQL = sprintf(
                    "/* PARSEADORES1 Templates\t_grabajugadahipicoticket.php - QUERY 2 */ INSERT INTO venta (ser_venta, ticket, cod_taquilla, fec_venta, hor_venta, cod_tventa,
