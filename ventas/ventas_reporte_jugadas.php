        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_usuario']!="todos") {
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 ventas\ventas_reporte_jugadas.php - QUERY 1 */ SELECT 
...
USE INDEX(id_us_fe_fe)
                ...
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 ventas\ventas_reporte_jugadas.php - QUERY 2 */ SELECT 
					ve.ip_venta, ve.ticket, ve.can_ticket, ve.fec_venta, ve.hor_venta, ve.num_caballo, ve.cod_tventa, ve.mon_venta,
					ve.est_ticket, ve.fec_pago, ve.hor_pago, ve.pag_premio, ca.nom_hipodromo, ca.num_carrera, ta.nom_taquilla,
					us.nom_usuario, ve.cod_cliente, ve.tra_codigo, ve.efectivoO
				FROM 
    ...
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 ventas\ventas_reporte_jugadas.php - QUERY 3 */ SELECT  
		ve.ip_venta, ve.ticket, ve.can_ticket, ve.fec_venta, ve.hor_venta, ve.num_caballo, ve.cod_tventa, ve.mon_venta,
...
$query_Recordset2 = sprintf("/* PARSEADORES1 ventas\ventas_reporte_jugadas.php - QUERY 4 */ SELECT id_usuario, nom_usuario FROM usuario us 
