...
$query_Recordset6 = sprintf("/* PARSEADORES1 ventas\index_prueba.php - QUERY 1 */ SELECT 
	tp.est_venta_ame
...
$query_Recordset4 = "/* PARSEADORES1 ventas\index_prueba.php - QUERY 2 */ SELECT * FROM mensaje WHERE cod_mensaje = 1";
...
$query_Recordset5 = sprintf(
    "
/* PARSEADORES1 ventas\index_prueba.php - QUERY 3 */ SELECT * FROM usuario, taquilla, taquilla_opc_ame, agencia,
			banca
...
$query_Recordset7 = sprintf("/* PARSEADORES1 ventas\index_prueba.php - QUERY 4 */ SELECT * FROM ctrol_ventpag_global_ame WHERE cod_ctrol_ventpag_global_ame =1");
...
$query_Recordset44 = sprintf("/* PARSEADORES1 ventas\index_prueba.php - QUERY 5 */ SELECT 
	me.mensaje
...
$query_Recordset51 = sprintf(
    "/* PARSEADORES1 ventas\index_prueba.php - QUERY 6 */ SELECT 
...
<script>
	...
	function Recargar() {
		clearInterval(refreshIdD); 
	}
	function pizActualame(carrera) {
		refreshIdD = setInterval(function(){
	if (carrera.value>0){
...
<?php
	...
	<div id="hipodromo" style="font-size:16px; float:left; width:51%; margin:-20px 0px 0px -20px; height:76px;"
                        ...
                        <div id="jugada" style="font-size:16px;float:left;width:100%;background:#e0e0e0;
                            ...
                            <div style="background: #e0e0e0; margin:-20px 0px 0px 0px; width:203px; color:black; float:left;height:18px;
                            padding:2px 0px 0px 30px; text-align:center">
                                EJEMPLARES
                            </div>
                            <div style="background:#e0e0e0;margin:-170px 0px 0px 270px;width:227px; color:black; float:left; height:18px;  
                                word-spacing:45px; padding:2px 0px 0px 25px; text-align:left">
                                GAN PLA SHW
                            </div>
                            <?php
...
<div id="men_pagar" style="font-size:12px; background: #333;width:100%; float:left; height:150px; 
                    ...
                    <form method="post" id="form3">
                        <select name="carreraame" onchange="pizActualame(this);" id="carreraame" disabled
                    ...
                    <div id="impPiza" style="width:100%; height:200px" onmouseout="Recargar()" onmouseover="pizActualame(this);">
