                    ...
                    $query_Recordset2 = sprintf(
                        "/* PARSEADORES1 ventas\pizarra_actual_ame.php - QUERY 1 */ SELECT 
                    ...
                    $query_Recordset2d = sprintf(
                      "/* PARSEADORES1 ventas\pizarra_actual_ame.php - QUERY 2 */ SELECT 
                  ...
                  $totalRows_Recordset2d = mysqli_num_rows($Recordset2d);
                    ...
                    if ((isset($totalRows_Recordset2d) or isset($_POST["iD"])) && $totalRows_Recordset2d>0) {?>
                    	<div style="height:15px; float:left; width:100%">
                            <table width="100%" border="0" style="font-size:12px;border-bottom: 1px solid #C1BDBE;"cellpadding="0" 
                                cellspacing="0">
                                <tr>
                        ...
                        <div id="caballos" style="font-size:18px;width:100%;float:left;background:#e0e0e0;height:85px;
                        	background:#333;overflow: auto; text-align:center; 
                            font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif">
                          <table width="99%" border="0" style="font-size:11px;" cellpadding="0" cellspacing="0">  
                              <?php
                              $totCarr=0;
