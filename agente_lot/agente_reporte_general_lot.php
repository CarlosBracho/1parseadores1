...
$query_Recordset4 = sprintf("/* PARSEADORES1 agente_lot\agente_reporte_general_lot.php - QUERY 1 */ SELECT cod_banca, por_agencia_lot FROM agencia 
        ...
        if ($_POST['fecha_inicio']!="" && $_POST['fecha_fin']!="") {
            ...
            if ($_POST['id_usuario']!="todos") {
                $query_Recordset1 = sprintf(
                    "/* PARSEADORES1 agente_lot\agente_reporte_general_lot.php - QUERY 2 */ SELECT
...
if (((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1") && isset($_POST['id_usuario']) && $_POST['id_usuario']=="todos") || (!isset($_POST["MM_update"]))) {
    $query_Recordset1 = sprintf(
        "/* PARSEADORES1 agente_lot\agente_reporte_general_lot.php - QUERY 3 */ SELECT
					ta.cod_taquilla, ta.nom_taquilla, 
					tp.cob_sistema_lot,
					ag.por_agencia_lot,
						SUM(CASE WHEN ve.fec_venta_lot >= %s AND ve.fec_venta_lot <= %s AND 
...
$query_Recordset2 = sprintf("/* PARSEADORES1 agente_lot\agente_reporte_general_lot.php - QUERY 4 */ SELECT ta.cod_taquilla, ta.nom_taquilla 
...
$query_Recordset3 = sprintf("/* PARSEADORES1 agente_lot\agente_reporte_general_lot.php - QUERY 5 */ SELECT info1,info11,info2,info22,info3,info33,info4,info44,info5,info55 FROM banca 
